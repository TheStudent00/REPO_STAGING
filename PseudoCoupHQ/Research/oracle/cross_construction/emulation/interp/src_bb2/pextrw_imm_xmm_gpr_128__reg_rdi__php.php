...
// one named local per gate, over the term of pextrw_imm_xmm_gpr_128__reg_rdi__php.
// The term's layer-5 text, LITERAL:
//   Concat(0, Extract(31, 16, v0))
function emu_pextrw_imm_xmm_gpr_128__reg_rdi__php($a) {
    ...
    $w49 = ex_cat($w48, $x0_30, 1);
    $w50 = ex_cat($w49, $x0_29, 1);
    $w51 = ex_cat($w50, $x0_28, 1);
    $w52 = ex_cat($w51, $x0_27, 1);
    $w53 = ex_cat($w52, $x0_26, 1);
    $w54 = ex_cat($w53, $x0_25, 1);
    $w55 = ex_cat($w54, $x0_24, 1);
    $w56 = ex_cat($w55, $x0_23, 1);
    $w57 = ex_cat($w56, $x0_22, 1);
    $w58 = ex_cat($w57, $x0_21, 1);
    $w59 = ex_cat($w58, $x0_20, 1);
    $w60 = ex_cat($w59, $x0_19, 1);
    $w61 = ex_cat($w60, $x0_18, 1);
    $w62 = ex_cat($w61, $x0_17, 1);
    $w63 = ex_cat($w62, $x0_16, 1);
    return ex_m($w63, 64);
}
...
while (($line = fgets($handle)) !== false) {
    ...
    try {
        $answer = emu_pextrw_imm_xmm_gpr_128__reg_rdi__php(...$ints);
        if ($answer < 0) {
            echo sprintf("%s\n", sprintf("%u", $answer));
        } else {
            echo $answer . "\n";
