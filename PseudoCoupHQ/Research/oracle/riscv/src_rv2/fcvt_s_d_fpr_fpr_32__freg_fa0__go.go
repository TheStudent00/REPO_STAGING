...
// GoRenderer from the layer-4 term of fcvt_s_d_fpr_fpr_32__freg_fa0__go.
...
//go:noinline
func emu_fcvt_s_d_fpr_fpr_32__freg_fa0__go(a uint64) uint64 {
...
func main() {
	sink = emu_fcvt_s_d_fpr_fpr_32__freg_fa0__go(g0)
	_ = sink
}
