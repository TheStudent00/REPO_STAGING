...
# InterpRenderer from the layer-4 term of ucomiss_mem_xmm_32__flags__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(fp.to_ieee_bv(fpToFP(Extract(31, 0, v0))), fp.to_ieee_bv(fpToFP(Extract(31, 0, v1))))
def emu_ucomiss_mem_xmm_32__flags__ruby(a, b)
  m(cat(b, a, 32), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_ucomiss_mem_xmm_32__flags__ruby(*values)
