...
// intermediate per node of the term of lw_gpr_mem_32__reg_a0__rust__all_constructed.
...
#[no_mangle]
pub extern "C" fn emu_lw_gpr_mem_32__reg_a0__rust__all_constructed(a: u32) -> u64
{
    let v0: u32 = (a as u32);
