...
# InterpRenderer from the layer-4 term of test_imm_gpr_64__flags.low__ruby.
# The term's layer-5 text, LITERAL:
#   0
def emu_test_imm_gpr_64__flags.low__ruby()
  m(0, 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_test_imm_gpr_64__flags.low__ruby(*values)
