/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of xori_gpr_gpr_imm_64__reg_a0__c__all_constructed.  The term's text, LITERAL:
   Concat(Extract(63, 2, v0), ~Extract(1, 0, v0)) */
#include <stdint.h>

uint64_t
emu_xori_gpr_gpr_imm_64__reg_a0__c__all_constructed(uint64_t a)
{
