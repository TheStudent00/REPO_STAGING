...
# InterpRenderer from the layer-4 term of sar_cl_gpr_8__reg_rdi__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(0, Extract(7, 0, v0) >> Concat(0, Extract(4, 0, v1)))
def emu_sar_cl_gpr_8__reg_rdi__ruby(a, b)
  m(cat(0, ashr(a, cat(0, ext(b, 4, 0), 5), 8), 8), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_sar_cl_gpr_8__reg_rdi__ruby(*values)
