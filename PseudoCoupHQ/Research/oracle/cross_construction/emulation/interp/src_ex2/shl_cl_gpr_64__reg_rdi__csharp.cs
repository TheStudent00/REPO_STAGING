...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of shl_cl_gpr_64__reg_rdi__csharp.
    // The term's layer-5 text, LITERAL:
    //   v0 << Concat(0, Extract(5, 0, v1))
    public static long emu_shl_cl_gpr_64__reg_rdi__csharp(long a, long b) {
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_shl_cl_gpr_64__reg_rdi__csharp(values[0], values[1])).ToString());
                    answers.Append("\n");
