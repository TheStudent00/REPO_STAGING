...
/-- go single-opcode row 17, arch mnemonic 'or', example unit go/op_391, 7 members
...
theorem ModelCheck_go_17 (v0 : BitVec 64) (v1 : BitVec 64) :
    (v0 ||| v1)
  = (model_or_49 v0 v1) := by
  rfl

#print axioms ModelCheck_go_17
