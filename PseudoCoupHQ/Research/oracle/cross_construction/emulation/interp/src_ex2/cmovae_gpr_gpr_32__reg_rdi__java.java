...
public class Emu {
    ...
    // InterpRenderer from the layer-4 term of cmovae_gpr_gpr_32__reg_rdi__java.
    // The term's layer-5 text, LITERAL:
    //   Concat(0, If(ULE(Extract(31, 0, v0), Extract(31, 0, v1)), Extract(31, 0, v2), Extract(31, 0, v3)))
    static long emu_cmovae_gpr_gpr_32__reg_rdi__java(long a, long b, long c, long d) {
        return m(cat(0L, ((ule(b, a, 32)) ? (c) : (d)), 32), 64);
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_cmovae_gpr_gpr_32__reg_rdi__java(values[0], values[1], values[2], values[3])));
                    answers.append("\n");
