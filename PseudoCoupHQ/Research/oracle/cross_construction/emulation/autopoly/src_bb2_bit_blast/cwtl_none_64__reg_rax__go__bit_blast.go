...
// intermediate per node of the term of cwtl_none_64__reg_rax__go__bit_blast.
...
//go:noinline
func emu_cwtl_none_64__reg_rax__go__bit_blast(a uint16) uint64 {
...
func main() {
	sink = emu_cwtl_none_64__reg_rax__go__bit_blast(g0)
	_ = sink
}
