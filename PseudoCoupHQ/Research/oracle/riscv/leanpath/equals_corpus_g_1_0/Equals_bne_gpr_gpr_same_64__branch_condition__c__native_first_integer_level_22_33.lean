...
theorem bne_gpr_gpr_same_64__branch_condition__c__native_first_22_integer_level (a : BitVec 64) (b : BitVec 64) :
...
set_option maxHeartbeats 40000 in
theorem bne_gpr_gpr_same_64__branch_condition__c__native_first_23_integer_level (a : BitVec 64) (b : BitVec 64) :
...
set_option maxHeartbeats 40000 in
theorem bne_gpr_gpr_same_64__branch_condition__c__native_first_24_integer_level (a : BitVec 64) (b : BitVec 64) :
...
set_option maxHeartbeats 40000 in
theorem bne_gpr_gpr_same_64__branch_condition__c__native_first_25_integer_level (a : BitVec 64) (b : BitVec 64) :
...
set_option maxHeartbeats 40000 in
theorem bne_gpr_gpr_same_64__branch_condition__c__native_first_26_integer_level (a : BitVec 64) (b : BitVec 64) :
...
set_option maxHeartbeats 40000 in
theorem bne_gpr_gpr_same_64__branch_condition__c__native_first_27_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (zero_reg) ((pure_RTYPE (a) (b) (XOR))) (LeanIM.rop.SLTU))) = (pure_REM (a) (b) (true)) := by
  try simp only [pure_RTYPE, pure_REM, to_bits_truncate]
  grind

set_option maxHeartbeats 40000 in
theorem bne_gpr_gpr_same_64__branch_condition__c__native_first_28_integer_level (a : BitVec 64) (b : BitVec 64) :
...
set_option maxHeartbeats 40000 in
theorem bne_gpr_gpr_same_64__branch_condition__c__native_first_29_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (zero_reg) ((pure_RTYPE (a) (b) (XOR))) (LeanIM.rop.SLTU))) = (pure_REMW (a) (b) (true)) := by
  try simp only [pure_RTYPE, pure_REMW, sign_extend, to_bits_truncate, Sail.BitVec.signExtend]
  grind

set_option maxHeartbeats 40000 in
theorem bne_gpr_gpr_same_64__branch_condition__c__native_first_30_integer_level (a : BitVec 64) (b : BitVec 64) :
...
set_option maxHeartbeats 40000 in
theorem bne_gpr_gpr_same_64__branch_condition__c__native_first_31_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (zero_reg) ((pure_RTYPE (a) (b) (XOR))) (LeanIM.rop.SLTU))) = (pure_RTYPEW (a) (b) (ropw.SUBW)) := by
  try simp only [pure_RTYPE, pure_RTYPEW, shift_bits_right_arith, sign_extend, Sail.BitVec.signExtend]
  grind

set_option maxHeartbeats 40000 in
theorem bne_gpr_gpr_same_64__branch_condition__c__native_first_32_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (zero_reg) ((pure_RTYPE (a) (b) (XOR))) (LeanIM.rop.SLTU))) = (pure_RTYPEW (a) (b) (ropw.SLLW)) := by
  try simp only [pure_RTYPE, pure_RTYPEW, shift_bits_right_arith, sign_extend, Sail.BitVec.signExtend]
  grind

set_option maxHeartbeats 40000 in
theorem bne_gpr_gpr_same_64__branch_condition__c__native_first_33_integer_level (a : BitVec 64) (b : BitVec 64) :
