...
// InterpRenderer from the layer-4 term of fcvt_s_w_fpr_gpr_32__freg_fa0__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(4294967295, fp.to_ieee_bv(fpToFP(RNE(), Extract(31, 0, v0))))
function emu_fcvt_s_w_fpr_gpr_32__freg_fa0__javascript(a) {
    return m(cat(4294967295n, i2f(a, 32, 32), 32), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_fcvt_s_w_fpr_gpr_32__freg_fa0__javascript(...values).toString());
    } catch (problem) {
