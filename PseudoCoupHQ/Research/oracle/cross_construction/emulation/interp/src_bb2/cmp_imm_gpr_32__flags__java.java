...
public class Emu {
    ...
    // one named local per gate, over the term of cmp_imm_gpr_32__flags__java.
    // The term's layer-5 text, LITERAL:
    //   Concat(Extract(31, 0, v0), Extract(31, 0, v1))
    static long emu_cmp_imm_gpr_32__flags__java(long a, long b) {
        long x1_0 = ext(b, 0, 0);
        long x1_1 = ext(b, 1, 1);
        long x1_2 = ext(b, 2, 2);
        long x1_3 = ext(b, 3, 3);
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_cmp_imm_gpr_32__flags__java(values[0], values[1])));
                    answers.append("\n");
