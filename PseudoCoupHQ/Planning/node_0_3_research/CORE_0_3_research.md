...
Each is recorded in full in `~/Programming/PseudoCoupHQ/AgentMemory.md`;
...
- Planning: this tree conforms to `~/Programming/PlanPlan/framework/PROTOCOL.md`;
...
- Artifacts: `~/Programming/PseudoCoupHQ/Research/<project or line>/`
  (`kind_signature_clustering/`, `dominant_intentions/`,
  `kind_fuzz_clustering/`, `data_representation/`, `op_pipeline/`,
  `compiler_graph/`, `oracle/`; graphs in `~/Programming/PseudoCoupGraphs/`).
- The record of what was learned: `~/Programming/PseudoCoupHQ/DevComms/`,
