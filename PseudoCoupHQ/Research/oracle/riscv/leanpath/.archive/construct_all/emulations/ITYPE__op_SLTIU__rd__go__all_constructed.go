...
// intermediate per node of the term of ITYPE__op_SLTIU__rd__go__all_constructed.
//   
package main
...
//go:noinline
func emu_ITYPE__op_SLTIU__rd__go__all_constructed(a uint64, b uint16) uint64 {
	...
	var v57 uint64 = (uint64(^(uint64(v55))))
	var v58 uint64 = (uint64((uint64(uint64(a))) ^ (uint64(v57))))
	var v59 uint64 = (uint64((uint64(v58)) & (uint64(v56))))
	var v60 uint64 = (uint64((uint64(uint64(a))) & (uint64(v57))))
	...
	var v92 bool = (!(v91))
	var v93 uint32 = sel32(v92, uint32(uint32(0x0)), uint32(uint32(0x1)))
	var v94 uint32 = v93
	var v95 uint64 = uint64(0x0)
	var v96 uint64 = (uint64(((uint64(v95)) << 1) | (uint64(v94))))
	return uint64(v96)
}
...
func main() {
	sink = emu_ITYPE__op_SLTIU__rd__go__all_constructed(g0, g1)
	_ = sink
}
