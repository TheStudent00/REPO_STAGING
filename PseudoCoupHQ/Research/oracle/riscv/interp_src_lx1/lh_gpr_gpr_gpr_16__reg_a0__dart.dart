...
// InterpRenderer from the layer-4 term of lh_gpr_gpr_gpr_16__reg_a0__dart.
...
int emu_lh_gpr_gpr_gpr_16__reg_a0__dart(int a) {
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_lh_gpr_gpr_gpr_16__reg_a0__dart(values[0]);
