...
// intermediate per node of the term of xorps_xmm_same_128__reg_xmm0_high__rust__bit_blast.
//   0
#[no_mangle]
pub extern "C" fn emu_xorps_xmm_same_128__reg_xmm0_high__rust__bit_blast() -> f64
{
    let k0: u64 = 0;
    let w0: u64 = (k0 << 0);
    let w1: u64 = w0 | (k0 << 1);
