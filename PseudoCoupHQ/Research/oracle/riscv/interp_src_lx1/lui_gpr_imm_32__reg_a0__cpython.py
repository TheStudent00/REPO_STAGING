...
# InterpRenderer from the layer-4 term of lui_gpr_imm_32__reg_a0__cpython.
# The term's layer-5 text, LITERAL:
#   12288
def emu_lui_gpr_imm_32__reg_a0__cpython():
    return m(12288, 64)
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_lui_gpr_imm_32__reg_a0__cpython(*values)
            sys.stdout.write("%d\n" % answer)
