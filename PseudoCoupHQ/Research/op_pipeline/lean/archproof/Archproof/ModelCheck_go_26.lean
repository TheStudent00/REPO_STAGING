...
/-- go single-opcode row 26, arch mnemonic 'xor', example unit go/op_427, 7 members
...
theorem ModelCheck_go_26 (v0 : BitVec 64) (v1 : BitVec 64) :
    (v0 ^^^ v1)
  = (model_xor_52 v0 v1) := by
  rfl

#print axioms ModelCheck_go_26
