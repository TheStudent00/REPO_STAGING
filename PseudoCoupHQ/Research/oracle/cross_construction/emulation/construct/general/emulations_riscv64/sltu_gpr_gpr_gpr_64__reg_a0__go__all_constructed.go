...
// intermediate per node of the term of sltu_gpr_gpr_gpr_64__reg_a0__go__all_constructed.
//   If(ULE(v0, v1), 0, 1)
package main
...
//go:noinline
func emu_sltu_gpr_gpr_gpr_64__reg_a0__go__all_constructed(a uint64, b uint64) uint64 {
...
func main() {
	sink = emu_sltu_gpr_gpr_gpr_64__reg_a0__go__all_constructed(g0, g1)
	_ = sink
}
