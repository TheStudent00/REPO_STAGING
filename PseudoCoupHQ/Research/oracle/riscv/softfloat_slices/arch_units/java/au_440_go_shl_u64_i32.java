...
public final class au_440_go_shl_u64_i32 {

    public static long au_440_go_shl_u64_i32(long p0, long p1) {
    ...
    public static long au_440_go_shl_u64_i32_trap(long p0, long p1) {
        // a0: operand `a` (uint64) arrives in a0
        final long v1 = p0;
        // a1: operand `b` (int32) sign-extended to XLEN, as the ABI presents it
        final long v2 = AuInt.au_sext32(p1);
