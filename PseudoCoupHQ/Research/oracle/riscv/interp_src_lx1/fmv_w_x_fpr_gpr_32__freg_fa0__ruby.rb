...
# InterpRenderer from the layer-4 term of fmv_w_x_fpr_gpr_32__freg_fa0__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(4294967295, Extract(31, 0, v0))
def emu_fmv_w_x_fpr_gpr_32__freg_fa0__ruby(a)
  m(cat(4294967295, a, 32), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_fmv_w_x_fpr_gpr_32__freg_fa0__ruby(*values)
