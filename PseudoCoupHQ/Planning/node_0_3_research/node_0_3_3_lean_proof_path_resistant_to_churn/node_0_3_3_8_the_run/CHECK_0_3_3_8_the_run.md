---
id: hq.research.lean_proof_path_resistant_to_churn.the_run.check
---

# CHECK — 0_3_3_8_the_run

Node `hq.research.lean_proof_path_resistant_to_churn.the_run`. Status `draft`.
...
- `handful` — not settled
- `everything` — not settled
- `churn_tests` — not settled
- `speed_measured` — not settled
- `retire_drifted_code` — not settled
