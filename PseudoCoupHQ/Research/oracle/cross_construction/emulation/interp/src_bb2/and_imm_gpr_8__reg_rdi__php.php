...
// one named local per gate, over the term of and_imm_gpr_8__reg_rdi__php.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(63, 8, v1), ~(~Extract(7, 0, v0) | ~Extract(7, 0, v1)))
function emu_and_imm_gpr_8__reg_rdi__php($a, $b) {
    $x1_0 = ex_ext($a, 0, 0);
    $x0_0 = ex_ext($b, 0, 0);
    $x1_1 = ex_ext($a, 1, 1);
    $x0_1 = ex_ext($b, 1, 1);
    ...
    $w48 = ex_cat($w47, $x1_15, 1);
    $w49 = ex_cat($w48, $x1_14, 1);
    $w50 = ex_cat($w49, $x1_13, 1);
    $w51 = ex_cat($w50, $x1_12, 1);
    $w52 = ex_cat($w51, $x1_11, 1);
    $w53 = ex_cat($w52, $x1_10, 1);
    $w54 = ex_cat($w53, $x1_9, 1);
    $w55 = ex_cat($w54, $x1_8, 1);
    $w56 = ex_cat($w55, $g7, 1);
    $w57 = ex_cat($w56, $g6, 1);
    $w58 = ex_cat($w57, $g5, 1);
    $w59 = ex_cat($w58, $g4, 1);
...
while (($line = fgets($handle)) !== false) {
    ...
    try {
        $answer = emu_and_imm_gpr_8__reg_rdi__php(...$ints);
        if ($answer < 0) {
            echo sprintf("%s\n", sprintf("%u", $answer));
        } else {
            echo $answer . "\n";
