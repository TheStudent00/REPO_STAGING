...
// InterpRenderer from the layer-4 term of test_imm_gpr_64__flags.low__dart.
// The term's layer-5 text, LITERAL:
//   0
int emu_test_imm_gpr_64__flags.low__dart() {
  return m(0, 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_test_imm_gpr_64__flags.low__dart();
