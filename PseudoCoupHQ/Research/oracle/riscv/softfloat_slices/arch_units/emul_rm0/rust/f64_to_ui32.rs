...
pub fn f64_to_ui32_rm0(v_arg: u64) -> u32 {
    ...
    let v_i38: bool = (v_i37 != 0x0u32);
    let v_i39: bool = (v_i27 & v_i38);
    let v_i41: bool = (v_i27 ^ true);
    let v_i42: u32 = (0u32.wrapping_sub((v_i41) as u32));
    let v__c24: bool = (v_i30 & v_i39);
    let v__n29: bool = (v_i39 ^ true);
    let v__c30: bool = (v_i30 & v__n29);
    let v__n25: bool = (v_i30 ^ true);
    let v__c26: bool = (v__c24 | v__n25);
    let v__m27: u32 = (0u32.wrapping_sub((v__c26) as u32));
    let v__a28: u32 = (v_i42 & v__m27);
