...
// one named local per gate, over the term of test_imm_gpr_64__flags_low__dart.
// The term's layer-5 text, LITERAL:
//   0
int emu_test_imm_gpr_64__flags_low__dart() {
  int k0 = 0;
  int w0 = k0;
  int w1 = cat(w0, k0, 1);
  int w2 = cat(w1, k0, 1);
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_test_imm_gpr_64__flags_low__dart();
