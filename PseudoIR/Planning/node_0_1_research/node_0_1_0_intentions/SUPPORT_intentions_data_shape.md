...
- Sources (provenance: PCv5 `Designing/`): `pc_verdicts.json`,
  ...
  `R1 report` (`<WORKSPACE_DIR>/PseudoCoup_v6/Research/r1_intentions_validation/REPORT.md`).
...
*(These were in `<WORKSPACE_DIR>/PseudoCoup_v5/Designing/` (historical),
...
now lives in `<WORKSPACE_DIR>/PseudoIR/Tools/intentions/`; the
...
- Whether the extended artifact is written back into
  `<WORKSPACE_DIR>/PseudoCoup_v5/Designing/` (historical) or copied
  ...
  `<WORKSPACE_DIR>/PseudoIR/Tools/intentions/` (2026-07-31), which is
