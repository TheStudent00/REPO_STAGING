#!/usr/bin/env bash
# lp1 lane 11 -- THIRD launch, brief §5 lane 11: the emit, no network. The
...
echo "  the two earlier cache folders, NOT touched: $(ls -d $LP/cache/sail-riscv_3243f93* | tr '\n' ' ')"
...
peak
echo "lane lp1_l11 done at $(date -u +%FT%TZ)"
}
