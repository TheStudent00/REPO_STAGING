/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of rust_4__rust_op_670.  The term's layer-5 text, LITERAL:
...
double
emu_rust_4__rust_op_670(double a, double b)
{
