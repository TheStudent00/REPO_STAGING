...
// intermediate per node of the term of LOAD__is_unsigned_True__width_8__mem_addr__go__native_first.
//   
package main

//go:noinline
func emu_LOAD__is_unsigned_True__width_8__mem_addr__go__native_first(a uint64, b uint16) uint64 {
...
func main() {
	sink = emu_LOAD__is_unsigned_True__width_8__mem_addr__go__native_first(g0, g1)
	_ = sink
}
