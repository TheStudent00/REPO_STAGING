...
// one named local per gate, over the term of cwtl_none_64__reg_rax__javascript.
...
function emu_cwtl_none_64__reg_rax__javascript(a) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_cwtl_none_64__reg_rax__javascript(...values).toString());
    } catch (problem) {
