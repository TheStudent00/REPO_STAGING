/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of E01800__swift_regen_2110.  The term's layer-5 text, LITERAL:
...
uint64_t
emu_E01800__swift_regen_2110(uint64_t a, uint64_t b, uint16_t c)
{
