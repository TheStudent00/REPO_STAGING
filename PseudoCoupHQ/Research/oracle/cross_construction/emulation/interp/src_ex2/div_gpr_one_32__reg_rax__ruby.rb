...
# InterpRenderer from the layer-4 term of div_gpr_one_32__reg_rax__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(0, Extract(31, 0, bvudiv_i(Concat(Extract(31, 0, v0), Extract(31, 0, v1)), Concat(0, Extract(31, 0, v2)))))
def emu_div_gpr_one_32__reg_rax__ruby(a, b, c)
  m(cat(0, ext(udiv(cat(a, b, 32), cat(0, c, 32), 64), 31, 0), 32), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_div_gpr_one_32__reg_rax__ruby(*values)
