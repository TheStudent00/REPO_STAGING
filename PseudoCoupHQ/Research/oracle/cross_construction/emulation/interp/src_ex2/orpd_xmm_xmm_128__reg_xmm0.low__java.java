...
public class Emu {
    ...
    // InterpRenderer from the layer-4 term of orpd_xmm_xmm_128__reg_xmm0.low__java.
    // The term's layer-5 text, LITERAL:
    //   Extract(63, 0, v0) | Extract(63, 0, v1)
    static long emu_orpd_xmm_xmm_128__reg_xmm0.low__java(long a, long b) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_orpd_xmm_xmm_128__reg_xmm0.low__java(values[0], values[1])));
                    answers.append("\n");
