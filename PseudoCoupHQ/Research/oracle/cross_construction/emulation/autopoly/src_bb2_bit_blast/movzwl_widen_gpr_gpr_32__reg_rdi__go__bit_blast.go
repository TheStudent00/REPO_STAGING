...
// intermediate per node of the term of movzwl_widen_gpr_gpr_32__reg_rdi__go__bit_blast.
//   Concat(0, Extract(15, 0, v0))
package main

//go:noinline
func emu_movzwl_widen_gpr_gpr_32__reg_rdi__go__bit_blast(a uint16) uint64 {
...
func main() {
	sink = emu_movzwl_widen_gpr_gpr_32__reg_rdi__go__bit_blast(g0)
	_ = sink
}
