...
/-- Type quantifiers: k_ex475865_ : Bool -/
...
/-- Type quantifiers: k_ex475868_ : Bool, k_ex475867_ : Bool, k_ex475866_ : Bool, width : Nat, width
...
/-- Type quantifiers: k_ex475874_ : Bool, k_ex475873_ : Bool, k_ex475872_ : Bool, width : Nat, width
...
/-- Type quantifiers: k_ex475879_ : Bool, k_ex475878_ : Bool, k_ex475877_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex475885_ : Bool, k_ex475884_ : Bool, k_ex475883_ : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex475894_ : Bool, k_ex475893_ : Bool, k_ex475892_ : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex475902_ : Bool, k_ex475901_ : Bool, k_ex475900_ : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
