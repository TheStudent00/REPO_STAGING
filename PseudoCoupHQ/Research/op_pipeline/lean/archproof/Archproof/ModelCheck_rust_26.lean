...
/-- rust single-opcode row 26, arch mnemonic 'or', example unit rust/op_181, 6 members
...
theorem ModelCheck_rust_26 (v0 : BitVec 64) (v1 : BitVec 64) :
    (v0 ||| v1)
  = (model_or_52 (model_mov_19 v0) v1) := by
  rfl

#print axioms ModelCheck_rust_26
