...
// InterpRenderer from the layer-4 term of fcvt_s_d_fpr_fpr_32__freg_fa0__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(4294967295, fp.to_ieee_bv(fpToFP(RNE(), fpToFP(v0))))
function emu_fcvt_s_d_fpr_fpr_32__freg_fa0__javascript(a) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_fcvt_s_d_fpr_fpr_32__freg_fa0__javascript(...values).toString());
    } catch (problem) {
