...
// intermediate per node of the term of czero_eqz_gpr_gpr_same_64__reg_a0__go__all_constructed.
//   If(v0 == 0, 0, v0)
package main
...
//go:noinline
func emu_czero_eqz_gpr_gpr_same_64__reg_a0__go__all_constructed(a uint64) uint64 {
	...
	var v15 bool = (!(v14))
	var v16 uint64 = sel64(v15, uint64(uint64(0x0)), uint64(uint64(a)))
	return uint64(v16)
}
...
func main() {
	sink = emu_czero_eqz_gpr_gpr_same_64__reg_a0__go__all_constructed(g0)
	_ = sink
}
