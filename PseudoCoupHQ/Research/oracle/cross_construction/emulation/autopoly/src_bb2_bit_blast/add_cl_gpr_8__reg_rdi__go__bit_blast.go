...
// intermediate per node of the term of add_cl_gpr_8__reg_rdi__go__bit_blast.
//   Concat(Extract(63, 8, v0), Extract(7, 0, v0) + Extract(7, 0, v1))
package main

//go:noinline
func emu_add_cl_gpr_8__reg_rdi__go__bit_blast(a uint64, b uint8) uint64 {
...
func main() {
	sink = emu_add_cl_gpr_8__reg_rdi__go__bit_blast(g0, g1)
	_ = sink
}
