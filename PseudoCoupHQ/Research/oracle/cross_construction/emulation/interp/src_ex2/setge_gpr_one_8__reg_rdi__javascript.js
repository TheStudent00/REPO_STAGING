...
// InterpRenderer from the layer-4 term of setge_gpr_one_8__reg_rdi__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(0, If(Extract(7, 0, v0) <= Extract(7, 0, v1), 1, 0))
function emu_setge_gpr_one_8__reg_rdi__javascript(a, b) {
    return m(cat(0n, ((sle(b, a, 8)) ? (1n) : (0n)), 8), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_setge_gpr_one_8__reg_rdi__javascript(...values).toString());
    } catch (problem) {
