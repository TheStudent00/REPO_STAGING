...
theorem rust__op_361_61_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_ITYPE ((pure_RTYPE (b) (a) (LeanIM.rop.SLT))) (0x001#12) (LeanIM.iop.XORI))) = ((zero_extend (m := 64) (bool_to_bit (zopz0zI_s a b)))) := by
