...
// intermediate per node of the term of andi_gpr_gpr_imm_64__reg_a0__rust__bit_blast.
//   Concat(0, Extract(1, 0, v0))
#[no_mangle]
pub extern "C" fn emu_andi_gpr_gpr_imm_64__reg_a0__rust__bit_blast(a: u8) -> u64
{
