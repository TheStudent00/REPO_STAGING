...
/-- rust single-opcode row 41, arch mnemonic 'sub', example unit rust/regen_1043, 2 members
...
theorem ModelCheck_rust_41 (v0 : BitVec 64) (v1 : BitVec 64) :
    (((v0.extractLsb 7 0) * (255#8)) + (v1.extractLsb 7 0))
  = ((model_sub_0 (model_mov_16 v1) v0).extractLsb 7 0) := by
  simp only [model_mov_16, model_sub_0]
  bv_decide

#print axioms ModelCheck_rust_41
