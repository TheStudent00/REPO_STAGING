/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of fcvt_s_d_fpr_fpr_fpr_32__freg_fa0__c.  The term's layer-5 text, LITERAL:
...
uint64_t
emu_fcvt_s_d_fpr_fpr_fpr_32__freg_fa0__c(uint64_t a)
{
