...
/-- cpp single-opcode row 78, arch mnemonic 'xor', example unit cpp/op_421, 116 members
...
theorem ModelCheck_cpp_78 (v0 : BitVec 64) (v1 : BitVec 64) :
    ((v0.extractLsb 63 32) ++ ((v0.extractLsb 31 0) ^^^ (v1.extractLsb 31 0)))
  = (model_xor_49 (model_mov_16 v1) v0) := by
  simp only [model_mov_16, model_xor_49]
  bv_decide

#print axioms ModelCheck_cpp_78
