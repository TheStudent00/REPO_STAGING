/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of ITYPE__op_SLTI__rd__cpp__all_constructed.  The term's text, LITERAL:
    */
#include <cstdint>

extern "C"
uint64_t
emu_ITYPE__op_SLTI__rd__cpp__all_constructed(uint64_t a, uint16_t b)
{
    ...
    uint64_t v57 = (uint64_t)((uint64_t)(v55) ^ (uint64_t)(UINT64_C(0x8000000000000000)));
    uint64_t v58 = (uint64_t)(~(uint64_t)(v57));
    uint64_t v59 = (uint64_t)((uint64_t)((uint64_t)a) ^ (uint64_t)(UINT64_C(0x8000000000000000)));
    uint64_t v60 = (uint64_t)((uint64_t)(v59) ^ (uint64_t)(v58));
    uint64_t v61 = (uint64_t)((uint64_t)(v60) & (uint64_t)(v56));
    uint64_t v62 = (uint64_t)((uint64_t)(v59) & (uint64_t)(v58));
    uint64_t v63 = (uint64_t)((uint64_t)(v62) | (uint64_t)(v61));
    uint64_t v64 = (uint64_t)((uint64_t)(v63) << (unsigned)(uint64_t)(UINT64_C(0x1)));
    uint64_t v65 = (uint64_t)((uint64_t)(v60) & (uint64_t)(v64));
    uint64_t v66 = (uint64_t)((uint64_t)(v63) | (uint64_t)(v65));
    uint64_t v67 = (uint64_t)((uint64_t)(v66) << (unsigned)(uint64_t)(UINT64_C(0x2)));
    uint64_t v68 = (uint64_t)((uint64_t)(v60) << (unsigned)(uint64_t)(UINT64_C(0x1)));
    uint64_t v69 = (uint64_t)((uint64_t)(v60) & (uint64_t)(v68));
    uint64_t v70 = (uint64_t)((uint64_t)(v69) & (uint64_t)(v67));
    uint64_t v71 = (uint64_t)((uint64_t)(v66) | (uint64_t)(v70));
    uint64_t v72 = (uint64_t)((uint64_t)(v71) << (unsigned)(uint64_t)(UINT64_C(0x4)));
    uint64_t v73 = (uint64_t)((uint64_t)(v69) << (unsigned)(uint64_t)(UINT64_C(0x2)));
    ...
    uint64_t v77 = (uint64_t)((uint64_t)(v76) << (unsigned)(uint64_t)(UINT64_C(0x8)));
    uint64_t v78 = (uint64_t)((uint64_t)(v74) << (unsigned)(uint64_t)(UINT64_C(0x4)));
    ...
    uint64_t v82 = (uint64_t)((uint64_t)(v81) << (unsigned)(uint64_t)(UINT64_C(0x10)));
    uint64_t v83 = (uint64_t)((uint64_t)(v79) << (unsigned)(uint64_t)(UINT64_C(0x8)));
    ...
    uint64_t v87 = (uint64_t)((uint64_t)(v86) << (unsigned)(uint64_t)(UINT64_C(0x20)));
    uint64_t v88 = (uint64_t)((uint64_t)(v84) << (unsigned)(uint64_t)(UINT64_C(0x10)));
    ...
    uint32_t v92 = ((uint32_t)((uint64_t)(v91) >> 63) & UINT32_C(0x1));
    int v93 = (((uint32_t)(UINT32_C(0x0)) == (uint32_t)(v92))) ? 1 : 0;
    int v94 = ((!(v93))) ? 1 : 0;
    uint32_t v95 = ((v94) ? (uint32_t)(UINT32_C(0x0)) : (uint32_t)(UINT32_C(0x1)));
    uint32_t v96 = v95;
    uint64_t v97 = UINT64_C(0x0);
    uint64_t v98 = (uint64_t)(((uint64_t)(v97) << 1) | (uint64_t)(v96));
    return (uint64_t)(v98);
}
