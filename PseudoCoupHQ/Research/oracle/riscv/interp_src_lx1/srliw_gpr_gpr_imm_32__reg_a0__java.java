...
public class Emu {
    ...
    // InterpRenderer from the layer-4 term of srliw_gpr_gpr_imm_32__reg_a0__java.
    // The term's layer-5 text, LITERAL:
    //   Concat(0, Extract(31, 3, v0))
    static long emu_srliw_gpr_gpr_imm_32__reg_a0__java(long a) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_srliw_gpr_gpr_imm_32__reg_a0__java(values[0])));
                    answers.append("\n");
