...
// InterpRenderer from the layer-4 term of pand_xmm_xmm_128__reg_xmm0_low__javascript.
// The term's layer-5 text, LITERAL:
//   ~(~Extract(63, 0, v0) | ~Extract(63, 0, v1))
function emu_pand_xmm_xmm_128__reg_xmm0_low__javascript(a, b) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_pand_xmm_xmm_128__reg_xmm0_low__javascript(...values).toString());
    } catch (problem) {
