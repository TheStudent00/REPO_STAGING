/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of fcvt_s_lu_fpr_gpr_32__freg_fa0__cpp__native_first.  The term's text, LITERAL:
...
extern "C"
uint64_t
emu_fcvt_s_lu_fpr_gpr_32__freg_fa0__cpp__native_first(uint64_t a)
{
