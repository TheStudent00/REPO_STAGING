#!/bin/bash
# lp3_l73_c_corpus_operator_for_unfold_own.sh -- plan node
...
# l73: l68 again, with the proof stages unfolding the unit's own definitions (the immediate-carrying forms).
set -uo pipefail
