/* task ex1 emulation -- rendered by cpp_render.py CppRenderer from the layer-4 term of subsd_xmm_xmm_64__reg_xmm0__cpp.  The term's layer-5 text, LITERAL:
...
extern "C"
double
emu_subsd_xmm_xmm_64__reg_xmm0__cpp(double a, double b)
{
