...
# InterpRenderer from the layer-4 term of cqto_none_64__reg_rdx__cpython.
# The term's layer-5 text, LITERAL:
#   v0 >> 63
def emu_cqto_none_64__reg_rdx__cpython(a):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_cqto_none_64__reg_rdx__cpython(*values)
            sys.stdout.write("%d\n" % answer)
