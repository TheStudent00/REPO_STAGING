...
// InterpRenderer from the layer-4 term of test_imm_gpr_64__flags.low__javascript.
// The term's layer-5 text, LITERAL:
//   0
function emu_test_imm_gpr_64__flags.low__javascript() {
    return m(0n, 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_test_imm_gpr_64__flags.low__javascript(...values).toString());
    } catch (problem) {
