...
// intermediate per node of the term of fsd_fpr_mem_64__mem_MEM_0x0_a1___go__bit_blast.
//   v0
package main

//go:noinline
func emu_fsd_fpr_mem_64__mem_MEM_0x0_a1___go__bit_blast(a uint64) uint64 {
...
func main() {
	sink = emu_fsd_fpr_mem_64__mem_MEM_0x0_a1___go__bit_blast(g0)
	_ = sink
}
