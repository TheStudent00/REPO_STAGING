---
id: hq.research.arch_unit_oracle.simplification.synthesis.cegis.check
---

# CHECK — 0_3_2_4_3_1_cegis

Node `hq.research.arch_unit_oracle.simplification.synthesis.cegis`. Status `draft`.
