...
// intermediate per node of the term of sbb_imm_gpr_64__flags_high__go__bit_blast.
//   v0
package main

//go:noinline
func emu_sbb_imm_gpr_64__flags_high__go__bit_blast(a uint64) uint64 {
...
func main() {
	sink = emu_sbb_imm_gpr_64__flags_high__go__bit_blast(g0)
	_ = sink
}
