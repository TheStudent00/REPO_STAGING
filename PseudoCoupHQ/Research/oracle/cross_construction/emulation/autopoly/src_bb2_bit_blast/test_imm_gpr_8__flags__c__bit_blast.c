/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of test_imm_gpr_8__flags__c__bit_blast.  The term's text, LITERAL:
   Concat(~(~Extract(7, 0, v0) | ~Extract(7, 0, v1)), 0) */
#include <stdint.h>

uint16_t
emu_test_imm_gpr_8__flags__c__bit_blast(uint8_t a, uint8_t b)
{
