...
// intermediate per node of the term of or_gpr_gpr_32__flags__go__bit_blast.
//   Concat(Extract(31, 0, v0) | Extract(31, 0, v1), 0)
package main

//go:noinline
func emu_or_gpr_gpr_32__flags__go__bit_blast(a uint32, b uint32) uint64 {
...
func main() {
	sink = emu_or_gpr_gpr_32__flags__go__bit_blast(g0, g1)
	_ = sink
}
