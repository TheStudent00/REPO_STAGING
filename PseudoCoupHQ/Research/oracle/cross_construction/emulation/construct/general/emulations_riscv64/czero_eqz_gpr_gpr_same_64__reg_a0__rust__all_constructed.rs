...
// intermediate per node of the term of czero_eqz_gpr_gpr_same_64__reg_a0__rust__all_constructed.
//   If(v0 == 0, 0, v0)
#[no_mangle]
pub extern "C" fn emu_czero_eqz_gpr_gpr_same_64__reg_a0__rust__all_constructed(a: u64) -> u64
{
    ...
    let v15: bool = (!(v14));
    let v16: u64 = (if (v15) { ((0x0u64) as u64) } else { (((a as u64)) as u64) });
    ((v16) as u64)
}
