/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of JALR__one__pc__cpp__all_constructed.  The term's text, LITERAL:
    */
#include <cstdint>

extern "C"
uint64_t
emu_JALR__one__pc__cpp__all_constructed(uint64_t a, uint16_t b)
{
    ...
    uint64_t v56 = (uint64_t)((uint64_t)(v55) & (uint64_t)((uint64_t)a));
    uint64_t v57 = (uint64_t)((uint64_t)(v56) << (unsigned)(uint64_t)(UINT64_C(0x1)));
    uint64_t v58 = (uint64_t)((uint64_t)(v55) ^ (uint64_t)((uint64_t)a));
    uint64_t v59 = (uint64_t)((uint64_t)(v58) & (uint64_t)(v57));
    uint64_t v60 = (uint64_t)((uint64_t)(v56) | (uint64_t)(v59));
    uint64_t v61 = (uint64_t)((uint64_t)(v60) << (unsigned)(uint64_t)(UINT64_C(0x2)));
    uint64_t v62 = (uint64_t)((uint64_t)(v58) << (unsigned)(uint64_t)(UINT64_C(0x1)));
    ...
    uint64_t v86 = (uint64_t)((uint64_t)(v85) << (unsigned)(uint64_t)(UINT64_C(0x1)));
    uint64_t v87 = (uint64_t)((uint64_t)(v58) ^ (uint64_t)(v86));
    uint64_t v88 = ((uint64_t)((uint64_t)(v87) >> 1) & UINT64_C(0x7fffffffffffffff));
    uint32_t v89 = UINT32_C(0x0);
    uint64_t v90 = v88;
    uint64_t v91 = (uint64_t)(((uint64_t)(v90) << 1) | (uint64_t)(v89));
    return (uint64_t)(v91);
}
