...
# InterpRenderer from the layer-4 term of sub_gpr_gpr_16__reg_rdi__cpython.
# The term's layer-5 text, LITERAL:
#   Concat(0, Extract(15, 0, v0)*65535 + Extract(15, 0, v1))
def emu_sub_gpr_gpr_16__reg_rdi__cpython(a, b):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_sub_gpr_gpr_16__reg_rdi__cpython(*values)
            sys.stdout.write("%d\n" % answer)
