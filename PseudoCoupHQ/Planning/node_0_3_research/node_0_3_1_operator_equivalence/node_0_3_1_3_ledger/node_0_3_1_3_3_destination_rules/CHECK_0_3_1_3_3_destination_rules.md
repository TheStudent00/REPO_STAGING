---
id: hq.research.compiler_graph.ledger.destination_rules.check
---

# CHECK — 0_3_1_3_3_destination_rules

Node `hq.research.compiler_graph.ledger.destination_rules`. Status `draft`.
