...
public final class au_446_go_shr_i64_i32 {

    public static long au_446_go_shr_i64_i32(long p0, long p1) {
        ...
        final long v6 = AuInt.au_sltu(v5, 0x40L);
        final long v7 = AuInt.au_add(v6, 0xffffffffffffffffL);
        final long v8 = AuInt.au_or(v2, v7);
        final long v9 = AuInt.au_sra(v1, v8);
        // the answer is int64, 64 bits
        return v9;
    }

    public static long au_446_go_shr_i64_i32_trap(long p0, long p1) {
        // a0: operand `a` (int64) arrives in a0
        final long v1 = p0;
        // a1: operand `b` (int32) sign-extended to XLEN, as the ABI presents it
        final long v2 = AuInt.au_sext32(p1);
