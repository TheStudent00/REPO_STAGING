...
// intermediate per node of the term of sllw_gpr_gpr_same_32__reg_a0__go__native_first.
...
//go:noinline
func emu_sllw_gpr_gpr_same_32__reg_a0__go__native_first(a uint32) uint64 {
...
func main() {
	sink = emu_sllw_gpr_gpr_same_32__reg_a0__go__native_first(g0)
	_ = sink
}
