...
// InterpRenderer from the layer-4 term of auipc_gpr_imm_32__reg_a0__dart.
// The term's layer-5 text, LITERAL:
//   v0 + 12288
int emu_auipc_gpr_imm_32__reg_a0__dart(int a) {
  return m(add(a, 12288, 64), 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_auipc_gpr_imm_32__reg_a0__dart(values[0]);
