...
// InterpRenderer from the layer-4 term of push_gpr_one_64__stack_-8__javascript.
// The term's layer-5 text, LITERAL:
//   v0
function emu_push_gpr_one_64__stack_-8__javascript(a) {
    return m(a, 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_push_gpr_one_64__stack_-8__javascript(...values).toString());
    } catch (problem) {
