---
id: hq.research.arch_unit_oracle.simplification.learned_proposal.dataset.check
---

# CHECK — 0_3_2_4_4_0_dataset

Node `hq.research.arch_unit_oracle.simplification.learned_proposal.dataset`. Status `draft`.
