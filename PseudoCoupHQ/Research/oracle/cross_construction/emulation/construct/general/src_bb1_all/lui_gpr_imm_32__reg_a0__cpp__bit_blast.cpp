/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of lui_gpr_imm_32__reg_a0__cpp__bit_blast.  The term's text, LITERAL:
   12288 */
#include <cstdint>

extern "C"
uint64_t
emu_lui_gpr_imm_32__reg_a0__cpp__bit_blast(void)
{
    uint64_t k0 = 0;
    uint64_t k1 = 1;
    uint64_t w0 = (k0 << 0);
    ...
    uint64_t w12 = w11 | (k1 << 12);
    uint64_t w13 = w12 | (k1 << 13);
