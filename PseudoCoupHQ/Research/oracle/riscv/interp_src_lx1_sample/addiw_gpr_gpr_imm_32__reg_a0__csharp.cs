...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of addiw_gpr_gpr_imm_32__reg_a0__csharp.
    ...
    public static long emu_addiw_gpr_gpr_imm_32__reg_a0__csharp(long a) {
        return m(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(ext(add(a, 3L, 32), 31, 31), ext(add(a, 3L, 32), 31, 31), 1), ext(add(a, 3L, 32), 31, 31), 1), ext(add(a, 3L, 32), 31, 31), 1), ext(add(a, 3L, 32), 31, 31), 1), ext(add(a, 3L, 32), 31, 31), 1), ext(add(a, 3L, 32), 31, 31), 1), ext(add(a, 3L, 32), 31, 31), 1), ext(add(a, 3L, 32), 31, 31), 1), ext(add(a, 3L, 32), 31, 31), 1), ext(add(a, 3L, 32), 31, 31), 1), ext(add(a, 3L, 32), 31, 31), 1), ext(add(a, 3L, 32), 31, 31), 1), ext(add(a, 3L, 32), 31, 31), 1), ext(add(a, 3L, 32), 31, 31), 1), ext(add(a, 3L, 32), 31, 31), 1), ext(add(a, 3L, 32), 31, 31), 1), ext(add(a, 3L, 32), 31, 31), 1), ext(add(a, 3L, 32), 31, 31), 1), ext(add(a, 3L, 32), 31, 31), 1), ext(add(a, 3L, 32), 31, 31), 1), ext(add(a, 3L, 32), 31, 31), 1), ext(add(a, 3L, 32), 31, 31), 1), ext(add(a, 3L, 32), 31, 31), 1), ext(add(a, 3L, 32), 31, 31), 1), ext(add(a, 3L, 32), 31, 31), 1), ext(add(a, 3L, 32), 31, 31), 1), ext(add(a, 3L, 32), 31, 31), 1), ext(add(a, 3L, 32), 31, 31), 1), ext(add(a, 3L, 32), 31, 31), 1), ext(add(a, 3L, 32), 31, 31), 1), ext(add(a, 3L, 32), 31, 31), 1), add(a, 3L, 32), 32), 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_addiw_gpr_gpr_imm_32__reg_a0__csharp(values[0])).ToString());
                    answers.Append("\n");
