...
theorem au_252_c_add_bool_i64_abi_integer_level (a : BitVec 64) (b : BitVec 64) :
    (((fun (a : BitVec 64) (b : BitVec 64) => ((pure_RTYPE (a) (b) (ADD)))) (((a) &&& 0x1#64)) (b))) = (((fun (a : BitVec 64) (b : BitVec 64) => ((pure_RTYPE ((pure_ITYPE (a) ((sign_extend (m := 12) (0x01#6))) (ANDI))) (b) (ADD)))) (((a) &&& 0x1#64)) (b))) := by
