...
/-- cpp single-opcode row 50, arch mnemonic 'or', example unit cpp/op_361, 88 members
...
theorem ModelCheck_cpp_50 (v0 : BitVec 64) (v1 : BitVec 64) :
    (v0 ||| v1)
  = (model_or_52 (model_mov_19 v0) v1) := by
  rfl

#print axioms ModelCheck_cpp_50
