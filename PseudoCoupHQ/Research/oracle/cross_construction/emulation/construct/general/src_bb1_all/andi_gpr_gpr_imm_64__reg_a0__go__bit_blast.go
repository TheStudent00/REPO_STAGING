...
// intermediate per node of the term of andi_gpr_gpr_imm_64__reg_a0__go__bit_blast.
//   Concat(0, Extract(1, 0, v0))
package main

//go:noinline
func emu_andi_gpr_gpr_imm_64__reg_a0__go__bit_blast(a uint8) uint64 {
...
func main() {
	sink = emu_andi_gpr_gpr_imm_64__reg_a0__go__bit_blast(g0)
	_ = sink
}
