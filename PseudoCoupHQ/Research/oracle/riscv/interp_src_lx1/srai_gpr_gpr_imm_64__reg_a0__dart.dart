...
// InterpRenderer from the layer-4 term of srai_gpr_gpr_imm_64__reg_a0__dart.
// The term's layer-5 text, LITERAL:
//   v0 >> 3
int emu_srai_gpr_gpr_imm_64__reg_a0__dart(int a) {
  return m(ashr(a, 3, 64), 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_srai_gpr_gpr_imm_64__reg_a0__dart(values[0]);
