...
public class Emu {
    ...
    // InterpRenderer from the layer-4 term of fadd_d_fpr_fpr_fpr_64__freg_fa0__java.
    // The term's layer-5 text, LITERAL:
    //   fp.to_ieee_bv(fpToFP(v0) + fpToFP(v1))
    static long emu_fadd_d_fpr_fpr_fpr_64__freg_fa0__java(long a, long b) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_fadd_d_fpr_fpr_fpr_64__freg_fa0__java(values[0], values[1])));
                    answers.append("\n");
