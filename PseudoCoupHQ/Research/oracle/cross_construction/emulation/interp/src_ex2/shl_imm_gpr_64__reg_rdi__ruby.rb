...
# InterpRenderer from the layer-4 term of shl_imm_gpr_64__reg_rdi__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(Extract(60, 0, v0), 0)
def emu_shl_imm_gpr_64__reg_rdi__ruby(a)
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_shl_imm_gpr_64__reg_rdi__ruby(*values)
