...
// intermediate per node of the term of unpckhpd_xmm_xmm_128__reg_xmm0_low__go__bit_blast.
//   v0
package main
...
//go:noinline
func emu_unpckhpd_xmm_xmm_128__reg_xmm0_low__go__bit_blast(a uint64) float64 {
...
func main() {
	sink = emu_unpckhpd_xmm_xmm_128__reg_xmm0_low__go__bit_blast(g0)
	_ = sink
}
