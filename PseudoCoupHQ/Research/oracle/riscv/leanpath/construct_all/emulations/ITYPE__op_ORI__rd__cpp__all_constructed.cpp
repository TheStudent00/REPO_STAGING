/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of ITYPE__op_ORI__rd__cpp__all_constructed.  The term's text, LITERAL:
    */
#include <cstdint>

extern "C"
uint64_t
emu_ITYPE__op_ORI__rd__cpp__all_constructed(uint64_t a, uint16_t b)
{
    ...
    uint64_t v36 = ((uint64_t)(((uint64_t)(v35) << 1) | (uint64_t)(v4)) & UINT64_C(0x1ffffffff));
    uint64_t v37 = ((uint64_t)(((uint64_t)(v36) << 1) | (uint64_t)(v4)) & UINT64_C(0x3ffffffff));
    uint64_t v38 = ((uint64_t)(((uint64_t)(v37) << 1) | (uint64_t)(v4)) & UINT64_C(0x7ffffffff));
    uint64_t v39 = ((uint64_t)(((uint64_t)(v38) << 1) | (uint64_t)(v4)) & UINT64_C(0xfffffffff));
    uint64_t v40 = ((uint64_t)(((uint64_t)(v39) << 1) | (uint64_t)(v4)) & UINT64_C(0x1fffffffff));
    uint64_t v41 = ((uint64_t)(((uint64_t)(v40) << 1) | (uint64_t)(v4)) & UINT64_C(0x3fffffffff));
    uint64_t v42 = ((uint64_t)(((uint64_t)(v41) << 1) | (uint64_t)(v4)) & UINT64_C(0x7fffffffff));
    uint64_t v43 = ((uint64_t)(((uint64_t)(v42) << 1) | (uint64_t)(v4)) & UINT64_C(0xffffffffff));
    uint64_t v44 = ((uint64_t)(((uint64_t)(v43) << 1) | (uint64_t)(v4)) & UINT64_C(0x1ffffffffff));
    uint64_t v45 = ((uint64_t)(((uint64_t)(v44) << 1) | (uint64_t)(v4)) & UINT64_C(0x3ffffffffff));
    uint64_t v46 = ((uint64_t)(((uint64_t)(v45) << 1) | (uint64_t)(v4)) & UINT64_C(0x7ffffffffff));
    uint64_t v47 = ((uint64_t)(((uint64_t)(v46) << 1) | (uint64_t)(v4)) & UINT64_C(0xfffffffffff));
    uint64_t v48 = ((uint64_t)(((uint64_t)(v47) << 1) | (uint64_t)(v4)) & UINT64_C(0x1fffffffffff));
    uint64_t v49 = ((uint64_t)(((uint64_t)(v48) << 1) | (uint64_t)(v4)) & UINT64_C(0x3fffffffffff));
    uint64_t v50 = ((uint64_t)(((uint64_t)(v49) << 1) | (uint64_t)(v4)) & UINT64_C(0x7fffffffffff));
    uint64_t v51 = ((uint64_t)(((uint64_t)(v50) << 1) | (uint64_t)(v4)) & UINT64_C(0xffffffffffff));
    uint64_t v52 = ((uint64_t)(((uint64_t)(v51) << 1) | (uint64_t)(v4)) & UINT64_C(0x1ffffffffffff));
    uint64_t v53 = ((uint64_t)(((uint64_t)(v52) << 1) | (uint64_t)(v4)) & UINT64_C(0x3ffffffffffff));
    uint64_t v54 = ((uint64_t)(((uint64_t)(v53) << 12) | (uint64_t)(v3)) & UINT64_C(0x3fffffffffffffff));
    uint64_t v55 = ((uint64_t)((uint64_t)(v54) | (uint64_t)(v0)) & UINT64_C(0x3fffffffffffffff));
    uint32_t v56 = ((uint32_t)((uint64_t)a >> 62) & UINT32_C(0x1));
    uint32_t v57 = ((uint32_t)((uint32_t)(v2) | (uint32_t)(v56)) & UINT32_C(0x1));
    uint32_t v58 = ((uint32_t)((uint64_t)a >> 63) & UINT32_C(0x1));
    uint32_t v59 = ((uint32_t)((uint32_t)(v2) | (uint32_t)(v58)) & UINT32_C(0x1));
    uint64_t v60 = v55;
    uint32_t v61 = v57;
    uint32_t v62 = v59;
    uint32_t v63 = ((uint32_t)(((uint32_t)(v62) << 1) | (uint32_t)(v61)) & UINT32_C(0x3));
    uint64_t v64 = (uint64_t)(((uint64_t)(v63) << 62) | (uint64_t)(v60));
    return (uint64_t)(v64);
}
