...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of unpckhpd_xmm_xmm_128__reg_xmm0.low__csharp.
    // The term's layer-5 text, LITERAL:
    //   v0
    public static long emu_unpckhpd_xmm_xmm_128__reg_xmm0.low__csharp(long a) {
        return m(a, 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_unpckhpd_xmm_xmm_128__reg_xmm0.low__csharp(values[0])).ToString());
                    answers.Append("\n");
