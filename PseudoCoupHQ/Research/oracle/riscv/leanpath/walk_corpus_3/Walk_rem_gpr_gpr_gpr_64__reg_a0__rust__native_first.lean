...
theorem meaning_rem_gpr_gpr_gpr_64__reg_a0__rust__native_first (s : St) (a : BitVec 64) (b : BitVec 64) (d : BitVec 64) (h10 : s.regs.get? .x10 = some a) (h11 : s.regs.get? .x11 = some b) (h13 : s.regs.get? .x13 = some d) (hk0 : ∀ {α : Type} (x0 : α) (s : St), (plat_term_write x0) s = EStateM.Result.ok () s) (hk1 : ∀ (x0 : Arch.pa) (x1 : Nat) (s : St), (load_reservation x0 x1) s = EStateM.Result.ok () s) (hk2 : ∀ (x0 : Unit) (s : St), (cancel_reservation x0) s = EStateM.Result.ok () s) :
    runsTo (walk [LeanIM.instruction.REM (LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0c#5, false), LeanIM.instruction.C_LI (0x3f#6, LeanIM.regidx.Regidx 0x0d#5), LeanIM.instruction.C_SLLI (0x3f#6, LeanIM.regidx.Regidx 0x0d#5), LeanIM.instruction.C_XOR (LeanIM.cregidx.Cregidx 0x3#3, LeanIM.cregidx.Cregidx 0x5#3), LeanIM.instruction.ITYPE (0xfff#12, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.iop.XORI), LeanIM.instruction.C_OR (LeanIM.cregidx.Cregidx 0x2#3, LeanIM.cregidx.Cregidx 0x3#3), LeanIM.instruction.ITYPE (0x001#12, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.iop.SLTIU), LeanIM.instruction.C_ADDI (0x3f#6, LeanIM.regidx.Regidx 0x0a#5), LeanIM.instruction.C_AND (LeanIM.cregidx.Cregidx 0x2#3, LeanIM.cregidx.Cregidx 0x4#3)]) s
      ((pure_RTYPE ((pure_ITYPE ((pure_ITYPE ((pure_RTYPE ((pure_ITYPE (a) (0xfff#12) (LeanIM.iop.XORI))) ((pure_RTYPE (b) ((pure_SHIFTIOP ((pure_ITYPE (zero_reg) (((sign_extend (m := 12) (0x3f#6)))) (ADDI))) ((0x3f#6)) (SLLI))) (XOR))) (OR))) (0x001#12) (LeanIM.iop.SLTIU))) (((sign_extend (m := 12) (0x3f#6)))) (ADDI))) ((pure_REM (b) (a) (false))) (AND))) := by
  simp (config := {decide := true}) [runsTo, walk, step, execute, strip_C_LI, strip_C_SLLI, strip_C_XOR, strip_C_OR, strip_C_ADDI, strip_C_AND, strip_REM, strip_ITYPE, strip_SHIFTIOP, strip_RTYPE, alias_C_LI, alias_C_SLLI, alias_C_XOR, alias_C_OR, alias_C_ADDI, alias_C_AND,
