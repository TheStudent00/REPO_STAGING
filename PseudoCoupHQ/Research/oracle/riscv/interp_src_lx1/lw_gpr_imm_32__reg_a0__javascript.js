...
// InterpRenderer from the layer-4 term of lw_gpr_imm_32__reg_a0__javascript.
...
function emu_lw_gpr_imm_32__reg_a0__javascript(a) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_lw_gpr_imm_32__reg_a0__javascript(...values).toString());
    } catch (problem) {
