...
// intermediate per node of the term of shr_cl_gpr_8__reg_rdi__go__bit_blast.
//   Concat(Extract(63, 8, v0), LShR(Extract(7, 0, v0), Concat(0, Extract(4, 0, v1))))
package main

//go:noinline
func emu_shr_cl_gpr_8__reg_rdi__go__bit_blast(a uint64, b uint8) uint64 {
	...
	var g0 uint64 = (x1_4 ^ 1)
	var g1 uint64 = (x1_3 ^ 1)
	var g2 uint64 = (x1_0 ^ 1)
	var g3 uint64 = (x1_0 & x0_1)
	var g4 uint64 = (g2 & x0_0)
	var g5 uint64 = (g3 | g4)
	var g6 uint64 = (x1_0 ^ 1)
	var g7 uint64 = (x1_0 & x0_3)
	var g8 uint64 = (g6 & x0_2)
	var g9 uint64 = (g7 | g8)
	var g10 uint64 = (x1_1 ^ 1)
	var g11 uint64 = (x1_1 & g9)
	var g12 uint64 = (g10 & g5)
	var g13 uint64 = (g11 | g12)
	var g14 uint64 = (x1_0 ^ 1)
	var g15 uint64 = (x1_0 & x0_5)
	var g16 uint64 = (g14 & x0_4)
	var g17 uint64 = (g15 | g16)
	var g18 uint64 = (x1_0 ^ 1)
	var g19 uint64 = (x1_0 & x0_7)
	var g20 uint64 = (g18 & x0_6)
	var g21 uint64 = (g19 | g20)
	var g22 uint64 = (x1_1 ^ 1)
	var g23 uint64 = (x1_1 & g21)
	var g24 uint64 = (g22 & g17)
	var g25 uint64 = (g23 | g24)
	var g26 uint64 = (x1_2 ^ 1)
	var g27 uint64 = (x1_2 & g25)
	var g28 uint64 = (g26 & g13)
	var g29 uint64 = (g27 | g28)
	var g30 uint64 = (g29 & g1)
	var g31 uint64 = (g30 & g0)
	var g32 uint64 = (x1_0 ^ 1)
	var g33 uint64 = (x1_0 & x0_2)
	var g34 uint64 = (g32 & x0_1)
	var g35 uint64 = (g33 | g34)
	var g36 uint64 = (x1_0 ^ 1)
	var g37 uint64 = (x1_0 & x0_4)
	var g38 uint64 = (g36 & x0_3)
	var g39 uint64 = (g37 | g38)
	var g40 uint64 = (x1_1 ^ 1)
	var g41 uint64 = (x1_1 & g39)
	var g42 uint64 = (g40 & g35)
	var g43 uint64 = (g41 | g42)
	var g44 uint64 = (x1_0 ^ 1)
	var g45 uint64 = (x1_0 & x0_6)
	var g46 uint64 = (g44 & x0_5)
	var g47 uint64 = (g45 | g46)
	var g48 uint64 = (x0_7 ^ 1)
	var g49 uint64 = (x1_0 | g48)
	var g50 uint64 = (g49 ^ 1)
	var g51 uint64 = (x1_1 ^ 1)
	var g52 uint64 = (x1_1 & g50)
	var g53 uint64 = (g51 & g47)
	var g54 uint64 = (g52 | g53)
	var g55 uint64 = (x1_2 ^ 1)
	var g56 uint64 = (x1_2 & g54)
	var g57 uint64 = (g55 & g43)
	var g58 uint64 = (g56 | g57)
	var g59 uint64 = (g58 & g1)
	var g60 uint64 = (g59 & g0)
	var g61 uint64 = (x1_1 ^ 1)
	var g62 uint64 = (x1_1 & g17)
	var g63 uint64 = (g61 & g9)
	var g64 uint64 = (g62 | g63)
	var g65 uint64 = (g21 ^ 1)
	var g66 uint64 = (x1_1 | g65)
	var g67 uint64 = (g66 ^ 1)
	var g68 uint64 = (x1_2 ^ 1)
	var g69 uint64 = (x1_2 & g67)
	var g70 uint64 = (g68 & g64)
	var g71 uint64 = (g69 | g70)
	var g72 uint64 = (g1 & g0)
	var g73 uint64 = (g72 & g71)
	var g74 uint64 = (x1_1 ^ 1)
	var g75 uint64 = (x1_1 & g47)
	var g76 uint64 = (g74 & g39)
	var g77 uint64 = (g75 | g76)
	var g78 uint64 = (x1_1 | g49)
	var g79 uint64 = (g78 ^ 1)
	var g80 uint64 = (x1_2 ^ 1)
	var g81 uint64 = (x1_2 & g79)
	var g82 uint64 = (g80 & g77)
	var g83 uint64 = (g81 | g82)
	var g84 uint64 = (g83 & g1)
	var g85 uint64 = (g84 & g0)
	var g86 uint64 = (x1_2 ^ 1)
	var g87 uint64 = (g1 & g0)
	var g88 uint64 = (g87 & g86)
	var g89 uint64 = (g88 & g25)
	var g90 uint64 = (g1 & g0)
	var g91 uint64 = (g90 & g86)
	var g92 uint64 = (g91 & g54)
	var g93 uint64 = (x1_1 ^ 1)
	var g94 uint64 = (g1 & g0)
	var g95 uint64 = (g94 & g86)
	var g96 uint64 = (g95 & g93)
	var g97 uint64 = (g96 & g21)
	var g98 uint64 = (x1_0 ^ 1)
	var g99 uint64 = (g1 & g0)
	var g100 uint64 = (g99 & g86)
	var g101 uint64 = (g100 & g93)
	var g102 uint64 = (g101 & g98)
	var g103 uint64 = (g102 & x0_7)
	var w0 uint64 = (g31 << 0)
	var w1 uint64 = w0 | (g60 << 1)
	var w2 uint64 = w1 | (g73 << 2)
	var w3 uint64 = w2 | (g85 << 3)
	var w4 uint64 = w3 | (g89 << 4)
	var w5 uint64 = w4 | (g92 << 5)
...
func main() {
	sink = emu_shr_cl_gpr_8__reg_rdi__go__bit_blast(g0, g1)
	_ = sink
}
