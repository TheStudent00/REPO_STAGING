/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of or_gpr_gpr_8__reg_rdi__cpp__all_constructed.  The term's text, LITERAL:
   Concat(Extract(63, 8, v0), Extract(7, 0, v0) | Extract(7, 0, v1)) */
#include <cstdint>

extern "C"
uint64_t
emu_or_gpr_gpr_8__reg_rdi__cpp__all_constructed(uint64_t a, uint8_t b)
{
