/* task ex1 emulation -- rendered by cpp_render.py CppRenderer from the layer-4 term of ucomiss_mem_xmm_32__flags__cpp.  The term's layer-5 text, LITERAL:
...
extern "C"
uint64_t
emu_ucomiss_mem_xmm_32__flags__cpp(uint32_t a, float b)
{
