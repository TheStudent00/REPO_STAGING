...
// one named local per gate, over the term of push_gpr_one_64__stack__8__javascript.
// The term's layer-5 text, LITERAL:
//   v0
function emu_push_gpr_one_64__stack__8__javascript(a) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_push_gpr_one_64__stack__8__javascript(...values).toString());
    } catch (problem) {
