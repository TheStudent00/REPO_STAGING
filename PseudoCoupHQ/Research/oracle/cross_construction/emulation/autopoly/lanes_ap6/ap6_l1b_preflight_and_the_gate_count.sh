#!/bin/bash
# ap6_l1b_preflight_and_the_gate_count.sh -- task ap6, lane 1b: lane 1 again, with the model table on the path bank.py reads the setter classifier from and with the two pipes into `head` replaced (a broken pipe stopped the producer).
#
