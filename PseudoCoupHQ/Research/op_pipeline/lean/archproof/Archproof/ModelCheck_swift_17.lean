...
/-- swift single-opcode row 17, arch mnemonic 'xor', example unit swift/op_661, 6 members
...
theorem ModelCheck_swift_17 (v0 : BitVec 64) (v1 : BitVec 64) :
    (v0 ^^^ v1)
  = (model_xor_52 (model_mov_19 v0) v1) := by
  rfl

#print axioms ModelCheck_swift_17
