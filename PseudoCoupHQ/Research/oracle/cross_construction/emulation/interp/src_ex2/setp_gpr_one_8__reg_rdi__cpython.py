...
# InterpRenderer from the layer-4 term of setp_gpr_one_8__reg_rdi__cpython.
...
def emu_setp_gpr_one_8__reg_rdi__cpython(a, b):
    return m(cat(0, ((1) if (eq(ext(add(mul(b, 255, 8), a, 8), 1, 1), ((1) if (eq(ext(add(mul(b, 255, 8), a, 8), 2, 2), ((1) if (eq(ext(add(mul(b, 255, 8), a, 8), 3, 3), ((1) if (eq(ext(add(mul(b, 255, 8), a, 8), 4, 4), ((1) if (eq(ext(add(mul(b, 255, 8), a, 8), 5, 5), ((1) if (eq(ext(add(mul(b, 255, 8), a, 8), 6, 6), ((1) if (eq(ext(add(mul(b, 255, 8), a, 8), 7, 7), ((1) if (eq(add(ext(a, 0, 0), 1, 1), ext(b, 0, 0), 1)) else (0)), 1)) else (0)), 1)) else (0)), 1)) else (0)), 1)) else (0)), 1)) else (0)), 1)) else (0)), 1)) else (0)), 8), 64)
