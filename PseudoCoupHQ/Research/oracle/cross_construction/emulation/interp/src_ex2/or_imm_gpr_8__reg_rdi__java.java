...
public class Emu {
    ...
    // InterpRenderer from the layer-4 term of or_imm_gpr_8__reg_rdi__java.
    // The term's layer-5 text, LITERAL:
    //   Concat(0, Extract(7, 0, v0) | Extract(7, 0, v1))
    static long emu_or_imm_gpr_8__reg_rdi__java(long a, long b) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_or_imm_gpr_8__reg_rdi__java(values[0], values[1])));
                    answers.append("\n");
