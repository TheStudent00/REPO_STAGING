/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of swift_0__swift_op_250.  The term's layer-5 text, LITERAL:
...
double
emu_swift_0__swift_op_250(double a, double b)
{
