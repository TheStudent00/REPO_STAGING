...
**LITERAL** — `PRIVATE/PseudoCoupHQ/Research/op_pipeline/probe_gen.py`,
...
instance trickle  runner trickle-runner  cpus 6  agent PUBLIC/Airlock/instances/trickle/agent
dropped PUBLIC/Airlock/instances/trickle/agent/drop/cdecl_swift.sh
...
$ git -C PRIVATE/PseudoCoupHQ status --porcelain Research/op_pipeline/probe_gen.py Research/op_pipeline/trickle_store
(no output)
```
