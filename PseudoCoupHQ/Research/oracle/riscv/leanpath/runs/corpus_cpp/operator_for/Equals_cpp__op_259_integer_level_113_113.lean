...
theorem cpp__op_259_113_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_REM (a) (b) (true))) = ((to_bits_truncate (l := 64) (if (((BitVec.toNatInt b) == 0) : Bool) then (BitVec.toNatInt a) else (Int.tmod (BitVec.toNatInt a) (BitVec.toNatInt b))))) := by
  try simp only [pure_REM, to_bits_truncate, Sail.get_slice_int]
  all_goals grind
