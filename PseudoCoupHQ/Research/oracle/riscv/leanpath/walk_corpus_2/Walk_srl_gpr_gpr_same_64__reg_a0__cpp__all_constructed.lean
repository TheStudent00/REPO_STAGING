...
theorem meaning_srl_gpr_gpr_same_64__reg_a0__cpp__all_constructed (s : St) (a : BitVec 64) (h10 : s.regs.get? .x10 = some a) (hk0 : ∀ {α : Type} (x0 : α) (s : St), (plat_term_write x0) s = EStateM.Result.ok () s) (hk1 : ∀ (x0 : Arch.pa) (x1 : Nat) (s : St), (load_reservation x0 x1) s = EStateM.Result.ok () s) (hk2 : ∀ (x0 : Unit) (s : St), (cancel_reservation x0) s = EStateM.Result.ok () s) :
    runsTo (walk [LeanIM.instruction.ITYPE (0x001#12, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0b#5, LeanIM.iop.ANDI), LeanIM.instruction.ITYPE (0x002#12, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0c#5, LeanIM.iop.ANDI), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0b#5, LeanIM.rop.SRL), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0c#5, LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0b#5, LeanIM.rop.SRL), LeanIM.instruction.ITYPE (0x004#12, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0c#5, LeanIM.iop.ANDI), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0c#5, LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0b#5, LeanIM.rop.SRL), LeanIM.instruction.ITYPE (0x008#12, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0c#5, LeanIM.iop.ANDI), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0c#5, LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0b#5, LeanIM.rop.SRL), LeanIM.instruction.ITYPE (0x010#12, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0c#5, LeanIM.iop.ANDI), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0c#5, LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0b#5, LeanIM.rop.SRL), LeanIM.instruction.ITYPE (0x020#12, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.iop.ANDI), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.rop.SRL)]) s
      ((pure_RTYPE ((pure_RTYPE ((pure_RTYPE ((pure_RTYPE ((pure_RTYPE ((pure_RTYPE (a) ((pure_ITYPE (a) (0x001#12) (LeanIM.iop.ANDI))) (LeanIM.rop.SRL))) ((pure_ITYPE (a) (0x002#12) (LeanIM.iop.ANDI))) (LeanIM.rop.SRL))) ((pure_ITYPE (a) (0x004#12) (LeanIM.iop.ANDI))) (LeanIM.rop.SRL))) ((pure_ITYPE (a) (0x008#12) (LeanIM.iop.ANDI))) (LeanIM.rop.SRL))) ((pure_ITYPE (a) (0x010#12) (LeanIM.iop.ANDI))) (LeanIM.rop.SRL))) ((pure_ITYPE (a) (0x020#12) (LeanIM.iop.ANDI))) (LeanIM.rop.SRL))) := by
