...
// intermediate per node of the term of sete_gpr_one_8__reg_rdi__swift__native_first.
//   Concat(Extract(63, 8, v0), If(Extract(7, 0, v1) == 0, 1, 0))
@_cdecl("emu_sete_gpr_one_8__reg_rdi__swift__native_first")
public func emu_sete_gpr_one_8__reg_rdi__swift__native_first(_ a: UInt8, _ b: UInt64) -> UInt64
{
    let v0: UInt32 = (UInt32(a))
    let v1: Bool = ((UInt32(truncatingIfNeeded: v0)) == (UInt32(truncatingIfNeeded: UInt32(0x0))))
    let v2: UInt32 = ((v1) ? (UInt32(0x1)) : (UInt32(0x0)))
