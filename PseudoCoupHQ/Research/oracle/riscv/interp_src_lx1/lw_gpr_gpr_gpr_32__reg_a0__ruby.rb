...
# InterpRenderer from the layer-4 term of lw_gpr_gpr_gpr_32__reg_a0__ruby.
...
def emu_lw_gpr_gpr_gpr_32__reg_a0__ruby(a)
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_lw_gpr_gpr_gpr_32__reg_a0__ruby(*values)
