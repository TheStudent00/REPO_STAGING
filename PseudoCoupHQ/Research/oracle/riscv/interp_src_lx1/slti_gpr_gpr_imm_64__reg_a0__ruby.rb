...
# InterpRenderer from the layer-4 term of slti_gpr_gpr_imm_64__reg_a0__ruby.
# The term's layer-5 text, LITERAL:
#   If(3 <= v0, 0, 1)
def emu_slti_gpr_gpr_imm_64__reg_a0__ruby(a)
  m(((sle(3, a, 64)) ? (0) : (1)), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_slti_gpr_gpr_imm_64__reg_a0__ruby(*values)
