...
/-- rust single-opcode row 23, arch mnemonic 'not', example unit rust/op_13, 6 members
...
theorem ModelCheck_rust_23 (v0 : BitVec 64) :
    (~~~v0)
  = (model_not_9 (model_mov_19 v0)) := by
  rfl

#print axioms ModelCheck_rust_23
