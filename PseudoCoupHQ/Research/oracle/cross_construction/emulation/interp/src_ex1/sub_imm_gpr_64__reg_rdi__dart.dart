...
// InterpRenderer from the layer-4 term of sub_imm_gpr_64__reg_rdi__dart.
// The term's layer-5 text, LITERAL:
//   v0 + 18446744073709551613
int emu_sub_imm_gpr_64__reg_rdi__dart(int a) {
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_sub_imm_gpr_64__reg_rdi__dart(values[0]);
