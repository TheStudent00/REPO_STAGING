/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of fcvt_s_w_fpr_gpr_32__freg_fa0__c__native_first.  The term's text, LITERAL:
...
uint64_t
emu_fcvt_s_w_fpr_gpr_32__freg_fa0__c__native_first(uint32_t a)
{
