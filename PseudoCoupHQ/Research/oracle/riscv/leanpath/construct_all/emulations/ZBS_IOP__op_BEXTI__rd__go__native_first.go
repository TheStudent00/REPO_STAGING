...
// intermediate per node of the term of ZBS_IOP__op_BEXTI__rd__go__native_first.
//   
package main
...
//go:noinline
func emu_ZBS_IOP__op_BEXTI__rd__go__native_first(a uint64, b uint8) uint64 {
...
func main() {
	sink = emu_ZBS_IOP__op_BEXTI__rd__go__native_first(g0, g1)
	_ = sink
}
