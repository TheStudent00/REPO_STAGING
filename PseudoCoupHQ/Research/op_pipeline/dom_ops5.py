#!/usr/bin/env python3
"""dom_ops5.py -- the dom_op construction over dominant_table7,
the table with the compound-assignment units folded in.
...
RENAME = [
    ("dom_ops.json", "dom_ops5.json"),
    ("dom_ops.md", "dom_ops5.md"),
    ("dom_ops_digest.md", "dom_ops5_digest.md"),
    ("dom_ops_digest_shape.json", "dom_ops5_digest_shape.json"),
]

STAGE_INPUTS = ["verdicts3b.json"]

SOURCE_TABLE = "dominant_table7.json"
...
def main():
    ...
    stage = os.path.join(outdir, "stage_dom_ops5")
    ...
    doc = json.load(open(os.path.join(outdir, "dom_ops5.json")))
