...
public class Emu {
    ...
    // one named local per gate, over the term of setge_gpr_one_8__reg_rdi__java.
    ...
    static long emu_setge_gpr_one_8__reg_rdi__java(long a, long b, long c) {
        long x0_7 = ext(b, 7, 7);
        long x0_1 = ext(b, 1, 1);
        long x0_0 = ext(b, 0, 0);
        long x0_2 = ext(b, 2, 2);
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_setge_gpr_one_8__reg_rdi__java(values[0], values[1], values[2])));
                    answers.append("\n");
