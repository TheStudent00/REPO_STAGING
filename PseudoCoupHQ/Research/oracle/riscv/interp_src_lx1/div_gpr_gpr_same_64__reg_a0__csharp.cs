...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of div_gpr_gpr_same_64__reg_a0__csharp.
    ...
    public static long emu_div_gpr_gpr_same_64__reg_a0__csharp(long a) {
        return m(((eq(a, 0L, 64)) ? (-1L) : (((((eq(a, -1L, 64)) && (eq(a, -9223372036854775808L, 64)))) ? (-9223372036854775808L) : (sdiv(a, a, 64))))), 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_div_gpr_gpr_same_64__reg_a0__csharp(values[0])).ToString());
                    answers.Append("\n");
