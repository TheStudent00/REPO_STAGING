...
// InterpRenderer from the layer-4 term of ld_gpr_fpr_fpr_64__reg_a0__javascript.
// The term's layer-5 text, LITERAL:
//   v0
function emu_ld_gpr_fpr_fpr_64__reg_a0__javascript(a) {
    return m(a, 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_ld_gpr_fpr_fpr_64__reg_a0__javascript(...values).toString());
    } catch (problem) {
