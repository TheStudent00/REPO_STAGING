...
(`~/Programming/PlanPlan/framework/PROTOCOL.md`):

- `~/Programming/PseudoCoupHQ/Planning` — this one. the frame.
- `~/Programming/PseudoCoup_v5/Planning` — the Frankenstein rebuild;
  the turn of the cycle where the hub is still empty. founded
  2026-07-31 (the section below records the gap it closed).
- `~/Programming/PseudoCoup_v6/Planning` — the transpiler into the
  hub.
- `~/Programming/PseudoIR/Planning` — the system the hub is
  constructed with.
...
- `~/Programming/DevComms/` governs all of them and is under none of
...
`~/Programming/PseudoCoup_v5/Planning/` (verified 2026-08-01: CORE_0
...
`~/Programming/PseudoCoup_v5/` contained no `Planning/` folder —
