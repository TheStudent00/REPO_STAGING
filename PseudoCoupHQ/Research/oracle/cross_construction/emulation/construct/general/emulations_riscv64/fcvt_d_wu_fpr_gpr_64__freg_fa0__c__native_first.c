/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of fcvt_d_wu_fpr_gpr_64__freg_fa0__c__native_first.  The term's text, LITERAL:
...
uint64_t
emu_fcvt_d_wu_fpr_gpr_64__freg_fa0__c__native_first(uint32_t a)
{
