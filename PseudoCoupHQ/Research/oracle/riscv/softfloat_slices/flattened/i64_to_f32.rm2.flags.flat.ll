; ModuleID = '<scratch>/fl/run/i64_to_f32.rm2.flags/i64_to_f32.rm2.flags.rv.flat.ll'
source_filename = "llvm-link"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128"
target triple = "riscv64-unknown-unknown-elf"

define dso_local i64 @i64_to_f32_rm2_flags_flat(i64 noundef %arg) {
  ...
  %.o13 = or i32 %.a9, %.a12
  %.n14 = xor i1 %i6, true
  %.m27 = sext i1 %i6 to i32
  %.a28 = and i32 %i18, %.m27
  %.c16 = and i1 %.n14, %.n15
  %.m29 = sext i1 %.n14 to i32
  %.m32 = sext i1 %.n15 to i32
  %.m17 = sext i1 %.c16 to i32
  %.a18 = and i32 %.o13, %.m17
  %.m25 = sext i1 %.c16 to i64
  %.m19 = sext i1 %i to i32
  %i39 = and i32 127, %.m19
  %i40 = add i32 %.a18, %i39
  %i42 = and i32 %.a18, 127
  %i43 = icmp ne i32 %i42, 0
  %i45 = and i32 -2147483648, %.m19
  %i51 = zext i1 %i43 to i64
  %.a26 = and i64 %i51, %.m25
  %.sh20 = lshr i32 %i40, 7
  %i41 = freeze i32 %.sh20
  %i49 = or i32 %i41, %i45
  %i44 = icmp ult i32 %i40, 128
  %.m23 = sext i1 %i44 to i32
  %.n24 = xor i32 %.m23, -1
  %i48 = and i32 %i47, %.n24
  %i50 = add i32 %i49, %i48
  %.a30 = and i32 %i50, %.m29
