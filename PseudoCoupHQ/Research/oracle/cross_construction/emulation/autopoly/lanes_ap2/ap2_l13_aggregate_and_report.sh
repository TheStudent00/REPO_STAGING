...
python3 PseudoCoupHQ/Research/op_pipeline/check_no_spelling_keys.py \
    PseudoCoupHQ/Research/oracle/cross_construction/emulation/autopoly/autopoly2_cells.json \
    PseudoCoupHQ/Research/oracle/cross_construction/emulation/autopoly/autopoly2.json

echo "[5/6] no exemption anywhere in what this task wrote"
grep -c exempt \
    PseudoCoupHQ/Research/oracle/cross_construction/emulation/autopoly/autopoly2.py \
    PseudoCoupHQ/Research/oracle/cross_construction/emulation/autopoly/lanes_ap2/ap2_l4_cells.sh \
    PseudoCoupHQ/Research/oracle/cross_construction/emulation/autopoly/lanes_ap2/ap2_l12_run.sh || true
