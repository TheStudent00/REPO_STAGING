#!/usr/bin/env python3
"""build_union_table2.py -- TASK 34 part (d): THE UNION VIEW,
...
three views:
  ...
  * `views.union_by_relations` -- the connected components of the graph
                           ...
                           from `interp_join2.json`.  A component is a
...
OUT = os.path.join(HERE, "union_table2.json")
...
def main():
    ...
    for edge in join.get("interpreter_to_interpreter_edges", []):
        ...
        edges.append({
            ...
            "source_artifact": "interp_join2.json",
        })
    ...
    out = {
        ...
        "views": {
            ...
            "union_by_relations": {
                "source": "interp_join2.json's PROVED_EQUAL rows",
