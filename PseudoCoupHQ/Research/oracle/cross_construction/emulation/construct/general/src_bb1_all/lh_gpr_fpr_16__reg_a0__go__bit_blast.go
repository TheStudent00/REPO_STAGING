...
// intermediate per node of the term of lh_gpr_fpr_16__reg_a0__go__bit_blast.
...
//go:noinline
func emu_lh_gpr_fpr_16__reg_a0__go__bit_blast(a uint16) uint64 {
...
func main() {
	sink = emu_lh_gpr_fpr_16__reg_a0__go__bit_blast(g0)
	_ = sink
}
