...
# InterpRenderer from the layer-4 term of div_gpr_gpr_same_64__reg_a0__cpython.
...
def emu_div_gpr_gpr_same_64__reg_a0__cpython(a):
    return m(((18446744073709551615) if (eq(a, 0, 64)) else (((9223372036854775808) if (((eq(a, 18446744073709551615, 64)) and (eq(a, 9223372036854775808, 64)))) else (sdiv(a, a, 64))))), 64)
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_div_gpr_gpr_same_64__reg_a0__cpython(*values)
            sys.stdout.write("%d\n" % answer)
