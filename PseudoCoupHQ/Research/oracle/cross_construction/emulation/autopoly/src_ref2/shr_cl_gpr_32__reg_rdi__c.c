/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of shr_cl_gpr_32__reg_rdi__c.  The term's layer-5 text, LITERAL:
   Concat(0, LShR(Extract(31, 0, v0), Concat(0, Extract(4, 0, v1)))) */
#include <stdint.h>

uint64_t
emu_shr_cl_gpr_32__reg_rdi__c(uint32_t a, uint8_t b)
{
