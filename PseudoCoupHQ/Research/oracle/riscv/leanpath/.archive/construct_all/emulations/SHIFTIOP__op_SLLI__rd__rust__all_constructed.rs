...
// intermediate per node of the term of SHIFTIOP__op_SLLI__rd__rust__all_constructed.
//   
#[no_mangle]
pub extern "C" fn emu_SHIFTIOP__op_SLLI__rd__rust__all_constructed(a: u64, b: u8) -> u64
{
