import LeanIM.Classify
import LeanIM.Prelude
import LeanIM.Flen
import LeanIM.Vlen
import LeanIM.FdextRegs
import LeanIM.VextRegs
import LeanIM.FextInsts
import LeanIM.DextInsts
import LeanIM.ZfhInsts
import LeanIM.VextUtilsInsts
...
/-- Type quantifiers: k_ex1290208_ : Bool, k_m : Nat, k_m ≥ 0, k_m ∈ {16, 32, 64} -/
...
/-- Type quantifiers: k_ex1290209_ : Bool, k_m : Nat, k_m ≥ 0, k_m ∈ {16, 32, 64} -/
