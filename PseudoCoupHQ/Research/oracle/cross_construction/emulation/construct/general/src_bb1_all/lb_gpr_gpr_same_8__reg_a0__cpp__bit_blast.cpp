/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of lb_gpr_gpr_same_8__reg_a0__cpp__bit_blast.  The term's text, LITERAL:
...
extern "C"
uint64_t
emu_lb_gpr_gpr_same_8__reg_a0__cpp__bit_blast(uint8_t a)
{
