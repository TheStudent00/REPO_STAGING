...
/-- swift single-opcode row 12, arch mnemonic 'or', example unit swift/op_625, 6 members
...
theorem ModelCheck_swift_12 (v0 : BitVec 64) (v1 : BitVec 64) :
    (v0 ||| v1)
  = (model_or_52 (model_mov_19 v0) v1) := by
  rfl

#print axioms ModelCheck_swift_12
