...
echo "=== layer-3 EXECUTION -- kotlin -- chunks 0..1 ==="
...

//gW0eWpEk1Gs8r5r/j1BQWpEpe5CAAA
R_EOF
...
for ci, rows in enumerate(chunks):
    ...
    for c in cmds:
        ...
        if r.returncode != 0:
            ...
            sys.stdout.flush()
            open("/out/xs_kotlin.compilefail.%d.txt" % (LO + ci), "w").write(
                src[:400000] + "\n\n===STDERR===\n" + (r.stderr or "")
                + "\n===STDOUT===\n" + (r.stdout or ""))
            break
    tbuild = time.time() - tb
