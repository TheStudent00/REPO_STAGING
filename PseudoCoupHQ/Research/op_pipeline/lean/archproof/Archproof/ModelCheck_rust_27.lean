...
/-- rust single-opcode row 27, arch mnemonic 'sar', example unit rust/op_498, 7 members
...
theorem ModelCheck_rust_27 (v0 : BitVec 64) (v1 : BitVec 64) :
    ((v0.extractLsb 31 0).sshiftRight' ((0#27) ++ (v1.extractLsb 4 0)))
  = ((model_sar_8 (model_mov_16 v0) (model_mov_16 v1)).extractLsb 31 0) := by
  simp only [model_mov_16, model_sar_8]
  bv_decide

#print axioms ModelCheck_rust_27
