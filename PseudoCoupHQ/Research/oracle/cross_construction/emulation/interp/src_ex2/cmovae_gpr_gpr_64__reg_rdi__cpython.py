...
# InterpRenderer from the layer-4 term of cmovae_gpr_gpr_64__reg_rdi__cpython.
# The term's layer-5 text, LITERAL:
#   If(ULE(v0, v1), v2, v3)
def emu_cmovae_gpr_gpr_64__reg_rdi__cpython(a, b, c, d):
    return m(((c) if (ule(b, a, 64)) else (d)), 64)
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_cmovae_gpr_gpr_64__reg_rdi__cpython(*values)
            sys.stdout.write("%d\n" % answer)
