/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of remu_gpr_gpr_gpr_64__reg_a0__c__native_first.  The term's text, LITERAL:
   If(v0 == 0, v1, bvurem_i(v1, v0)) */
#include <stdint.h>

uint64_t
emu_remu_gpr_gpr_gpr_64__reg_a0__c__native_first(uint64_t a, uint64_t b)
{
