...
// one named local per gate, over the term of xorps_xmm_same_128__reg_xmm0_low__dart.
// The term's layer-5 text, LITERAL:
//   0
int emu_xorps_xmm_same_128__reg_xmm0_low__dart() {
  int k0 = 0;
  int w0 = k0;
  int w1 = cat(w0, k0, 1);
  int w2 = cat(w1, k0, 1);
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_xorps_xmm_same_128__reg_xmm0_low__dart();
