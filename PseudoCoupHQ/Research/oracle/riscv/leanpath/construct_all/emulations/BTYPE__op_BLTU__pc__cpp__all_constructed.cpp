/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of BTYPE__op_BLTU__pc__cpp__all_constructed.  The term's text, LITERAL:
    */
#include <cstdint>

extern "C"
uint64_t
emu_BTYPE__op_BLTU__pc__cpp__all_constructed(uint64_t a, uint16_t b)
{
    uint32_t v0 = ((uint32_t)((uint32_t)b >> 0) & UINT32_C(0x1fff));
    uint32_t v1 = ((uint32_t)((uint32_t)b >> 12) & UINT32_C(0x1));
    uint32_t v2 = v0;
    uint32_t v3 = v1;
    ...
    uint64_t v54 = (uint64_t)(((uint64_t)(v53) << 13) | (uint64_t)(v2));
    uint64_t v55 = (uint64_t)((uint64_t)(v54) & (uint64_t)((uint64_t)a));
    uint64_t v56 = (uint64_t)((uint64_t)(v55) << (unsigned)(uint64_t)(UINT64_C(0x1)));
    uint64_t v57 = (uint64_t)((uint64_t)(v54) ^ (uint64_t)((uint64_t)a));
    uint64_t v58 = (uint64_t)((uint64_t)(v57) & (uint64_t)(v56));
    uint64_t v59 = (uint64_t)((uint64_t)(v55) | (uint64_t)(v58));
    uint64_t v60 = (uint64_t)((uint64_t)(v59) << (unsigned)(uint64_t)(UINT64_C(0x2)));
    uint64_t v61 = (uint64_t)((uint64_t)(v57) << (unsigned)(uint64_t)(UINT64_C(0x1)));
    uint64_t v62 = (uint64_t)((uint64_t)(v57) & (uint64_t)(v61));
    uint64_t v63 = (uint64_t)((uint64_t)(v62) & (uint64_t)(v60));
    uint64_t v64 = (uint64_t)((uint64_t)(v59) | (uint64_t)(v63));
    uint64_t v65 = (uint64_t)((uint64_t)(v64) << (unsigned)(uint64_t)(UINT64_C(0x4)));
    uint64_t v66 = (uint64_t)((uint64_t)(v62) << (unsigned)(uint64_t)(UINT64_C(0x2)));
    ...
    uint64_t v70 = (uint64_t)((uint64_t)(v69) << (unsigned)(uint64_t)(UINT64_C(0x8)));
    uint64_t v71 = (uint64_t)((uint64_t)(v67) << (unsigned)(uint64_t)(UINT64_C(0x4)));
    ...
    uint64_t v75 = (uint64_t)((uint64_t)(v74) << (unsigned)(uint64_t)(UINT64_C(0x10)));
    uint64_t v76 = (uint64_t)((uint64_t)(v72) << (unsigned)(uint64_t)(UINT64_C(0x8)));
    ...
    uint64_t v80 = (uint64_t)((uint64_t)(v79) << (unsigned)(uint64_t)(UINT64_C(0x20)));
    uint64_t v81 = (uint64_t)((uint64_t)(v77) << (unsigned)(uint64_t)(UINT64_C(0x10)));
    ...
    uint64_t v85 = (uint64_t)((uint64_t)(v84) << (unsigned)(uint64_t)(UINT64_C(0x1)));
    uint64_t v86 = (uint64_t)((uint64_t)(v57) ^ (uint64_t)(v85));
    return (uint64_t)(v86);
}
