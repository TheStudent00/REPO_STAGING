...
// InterpRenderer from the layer-4 term of neg_gpr_one_16__reg_rdi__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(0, Extract(15, 0, v0)*65535)
function emu_neg_gpr_one_16__reg_rdi__javascript(a) {
    return m(cat(0n, mul(a, 65535n, 16), 16), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_neg_gpr_one_16__reg_rdi__javascript(...values).toString());
    } catch (problem) {
