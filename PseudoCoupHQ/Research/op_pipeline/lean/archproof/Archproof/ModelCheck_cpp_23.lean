...
/-- cpp single-opcode row 23, arch mnemonic 'imul', example unit cpp/regen_8966, 36 members
...
theorem ModelCheck_cpp_23 (v0 : BitVec 64) (v1 : BitVec 64) :
    (((0#32) ++ (v0.extractLsb 31 0)) * v1)
  = (model_imul_52 (model_mov_15 v1) v0) := by
  simp only [model_mov_15, model_imul_52]
  bv_decide

#print axioms ModelCheck_cpp_23
