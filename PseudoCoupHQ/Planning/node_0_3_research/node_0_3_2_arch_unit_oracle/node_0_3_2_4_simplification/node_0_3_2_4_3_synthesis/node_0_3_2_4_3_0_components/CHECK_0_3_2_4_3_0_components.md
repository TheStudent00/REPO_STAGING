---
id: hq.research.arch_unit_oracle.simplification.synthesis.components.check
---

# CHECK — 0_3_2_4_3_0_components

Node `hq.research.arch_unit_oracle.simplification.synthesis.components`. Status `draft`.
