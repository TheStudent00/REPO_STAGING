...
`PRIVATE/PseudoCoupHQ/DevComms/log_083_claude_code_task_briefs.md`,
against the six findings of
`PRIVATE/PseudoCoupHQ/DevComms/log_082_state_of_research_and_parallel_branch.md`
...
`PUBLIC/Airlock/agent/out/interp_ruby_b/` (bytecode.txt,
...
- `PRIVATE/PseudoCoupHQ/Research/op_pipeline/langs.py`
- `PRIVATE/PseudoCoupHQ/Research/op_pipeline/reconnect_parallel.py`
- `PRIVATE/PseudoCoupHQ/Research/op_pipeline/op_units_java2.json`
- `PRIVATE/PseudoCoupHQ/Research/op_pipeline/op_units_cpython2.json`
- `PRIVATE/PseudoCoupHQ/Research/op_pipeline/sem_anchored_java2.json`
- `PRIVATE/PseudoCoupHQ/Research/op_pipeline/sem_anchored_cpython2.json`
- `PRIVATE/PseudoCoupHQ/Research/op_pipeline/sem_anchored_spill_java2.json`
- `PRIVATE/PseudoCoupHQ/Research/op_pipeline/sem_anchored_spill_cpython2.json`
- `PRIVATE/PseudoCoupHQ/Research/op_pipeline/tree_units3_parallel.json`
- `PRIVATE/PseudoCoupHQ/Research/op_pipeline/tree_matches3_parallel.json`
- `PRIVATE/PseudoCoupHQ/Research/op_pipeline/core_modes_java2.json`
- `PRIVATE/PseudoCoupHQ/Research/op_pipeline/guards2_parallel.py`
- `PRIVATE/PseudoCoupHQ/Research/op_pipeline/guards2_parallel.json`
- `PRIVATE/PseudoCoupHQ/Research/op_pipeline/fold_interp_ruby.py`
- `PRIVATE/PseudoCoupHQ/Research/op_pipeline/interp_ruby.json`
- `PRIVATE/PseudoCoupHQ/Research/op_pipeline/interp_ruby.md`
- `PRIVATE/PseudoCoupHQ/Research/op_pipeline/fold_interp_php.py`
- `PRIVATE/PseudoCoupHQ/Research/op_pipeline/interp_php.json`
- `PRIVATE/PseudoCoupHQ/Research/op_pipeline/interp_php.md`
