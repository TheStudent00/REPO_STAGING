...
theorem bge_gpr_gpr_same_64__branch_condition__cpp__native_first_00_integer_level (a : BitVec 64) (b : BitVec 64) :
...
set_option maxHeartbeats 40000 in
theorem bge_gpr_gpr_same_64__branch_condition__cpp__native_first_01_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_ITYPE ((pure_RTYPE (a) (b) (LeanIM.rop.SLT))) (0x001#12) (LeanIM.iop.XORI))) = (pure_RTYPE (a) (b) (rop.SUB)) := by
  try simp only [pure_ITYPE, pure_RTYPE, pure_RTYPE, bool_to_bit, log2_xlen, shift_bits_right_arith, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.zeroExtend]
  grind

set_option maxHeartbeats 40000 in
theorem bge_gpr_gpr_same_64__branch_condition__cpp__native_first_02_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_ITYPE ((pure_RTYPE (a) (b) (LeanIM.rop.SLT))) (0x001#12) (LeanIM.iop.XORI))) = (pure_RTYPE (a) (b) (rop.SLL)) := by
  try simp only [pure_ITYPE, pure_RTYPE, pure_RTYPE, bool_to_bit, log2_xlen, shift_bits_right_arith, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.zeroExtend]
  grind

set_option maxHeartbeats 40000 in
theorem bge_gpr_gpr_same_64__branch_condition__cpp__native_first_03_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_ITYPE ((pure_RTYPE (a) (b) (LeanIM.rop.SLT))) (0x001#12) (LeanIM.iop.XORI))) = (pure_RTYPE (a) (b) (rop.SLT)) := by
  try simp only [pure_ITYPE, pure_RTYPE, pure_RTYPE, bool_to_bit, log2_xlen, shift_bits_right_arith, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.zeroExtend]
  grind

set_option maxHeartbeats 40000 in
theorem bge_gpr_gpr_same_64__branch_condition__cpp__native_first_04_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_ITYPE ((pure_RTYPE (a) (b) (LeanIM.rop.SLT))) (0x001#12) (LeanIM.iop.XORI))) = (pure_RTYPE (a) (b) (rop.SLTU)) := by
  try simp only [pure_ITYPE, pure_RTYPE, pure_RTYPE, bool_to_bit, log2_xlen, shift_bits_right_arith, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.zeroExtend]
  grind

set_option maxHeartbeats 40000 in
theorem bge_gpr_gpr_same_64__branch_condition__cpp__native_first_05_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_ITYPE ((pure_RTYPE (a) (b) (LeanIM.rop.SLT))) (0x001#12) (LeanIM.iop.XORI))) = (pure_RTYPE (a) (b) (rop.XOR)) := by
  try simp only [pure_ITYPE, pure_RTYPE, pure_RTYPE, bool_to_bit, log2_xlen, shift_bits_right_arith, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.zeroExtend]
  grind

set_option maxHeartbeats 40000 in
theorem bge_gpr_gpr_same_64__branch_condition__cpp__native_first_06_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_ITYPE ((pure_RTYPE (a) (b) (LeanIM.rop.SLT))) (0x001#12) (LeanIM.iop.XORI))) = (pure_RTYPE (a) (b) (rop.SRL)) := by
  try simp only [pure_ITYPE, pure_RTYPE, pure_RTYPE, bool_to_bit, log2_xlen, shift_bits_right_arith, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.zeroExtend]
  grind

set_option maxHeartbeats 40000 in
theorem bge_gpr_gpr_same_64__branch_condition__cpp__native_first_07_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_ITYPE ((pure_RTYPE (a) (b) (LeanIM.rop.SLT))) (0x001#12) (LeanIM.iop.XORI))) = (pure_RTYPE (a) (b) (rop.SRA)) := by
  try simp only [pure_ITYPE, pure_RTYPE, pure_RTYPE, bool_to_bit, log2_xlen, shift_bits_right_arith, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.zeroExtend]
  grind

set_option maxHeartbeats 40000 in
theorem bge_gpr_gpr_same_64__branch_condition__cpp__native_first_08_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_ITYPE ((pure_RTYPE (a) (b) (LeanIM.rop.SLT))) (0x001#12) (LeanIM.iop.XORI))) = (pure_RTYPE (a) (b) (rop.OR)) := by
  try simp only [pure_ITYPE, pure_RTYPE, pure_RTYPE, bool_to_bit, log2_xlen, shift_bits_right_arith, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.zeroExtend]
  grind

set_option maxHeartbeats 40000 in
theorem bge_gpr_gpr_same_64__branch_condition__cpp__native_first_09_integer_level (a : BitVec 64) (b : BitVec 64) :
