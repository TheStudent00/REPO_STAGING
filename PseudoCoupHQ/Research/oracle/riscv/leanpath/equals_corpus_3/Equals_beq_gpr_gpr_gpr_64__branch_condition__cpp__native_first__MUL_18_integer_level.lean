...
theorem beq_gpr_gpr_gpr_64__branch_condition__cpp__native_first__MUL_18_integer_level (a : BitVec 64) (b : BitVec 64) :
  ...
  try simp only [pure_ITYPE, pure_RTYPE, pure_MUL, bool_to_bit, log2_xlen, mult_to_bits_half, shift_bits_right_arith, sign_extend, xlen, xlenbits, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, to_bits_truncate, Sail.BitVec.extractLsb, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend]
  grind
