...
/-- cpp single-opcode row 31, arch mnemonic 'lea', example unit cpp/op_48, 14 members
...
theorem ModelCheck_cpp_31 (v0 : BitVec 64) :
    ((v0.extractLsb 31 0) + (1#32))
  = ((model_lea_7 v0).extractLsb 31 0) := by
  simp only [model_lea_7]
  bv_decide

#print axioms ModelCheck_cpp_31
