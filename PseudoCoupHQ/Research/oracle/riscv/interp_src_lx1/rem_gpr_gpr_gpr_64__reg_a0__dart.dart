...
// InterpRenderer from the layer-4 term of rem_gpr_gpr_gpr_64__reg_a0__dart.
// The term's layer-5 text, LITERAL:
//   If(v0 == 0, v1, If(And(v0 == 18446744073709551615, v1 == 9223372036854775808), 0, bvsrem_i(v1, v0)))
int emu_rem_gpr_gpr_gpr_64__reg_a0__dart(int a, int b) {
  return m(((eq(a, 0, 64)) ? (b) : (((((eq(a, -1, 64)) && (eq(b, -9223372036854775808, 64)))) ? (0) : (srem(b, a, 64))))), 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_rem_gpr_gpr_gpr_64__reg_a0__dart(values[0], values[1]);
