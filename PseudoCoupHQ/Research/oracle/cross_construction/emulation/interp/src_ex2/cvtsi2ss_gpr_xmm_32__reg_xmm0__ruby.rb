...
# InterpRenderer from the layer-4 term of cvtsi2ss_gpr_xmm_32__reg_xmm0__ruby.
# The term's layer-5 text, LITERAL:
#   fp.to_ieee_bv(fpToFP(RNE(), Extract(31, 0, v0)))
def emu_cvtsi2ss_gpr_xmm_32__reg_xmm0__ruby(a)
  m(i2f(a, 32, 32), 32)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_cvtsi2ss_gpr_xmm_32__reg_xmm0__ruby(*values)
