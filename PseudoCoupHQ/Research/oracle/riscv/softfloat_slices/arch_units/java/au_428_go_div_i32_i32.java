...
public final class au_428_go_div_i32_i32 {

    public static long au_428_go_div_i32_i32(long p0, long p1) {
        ...
        final long v4 = AuInt.au_divw(v1, v2);
        // the answer is int32, 32 bits
        return ((v4) & 0xffffffffL);
    }

    public static long au_428_go_div_i32_i32_trap(long p0, long p1) {
        // a0: operand `a` (int32) sign-extended to XLEN, as the ABI presents it
        final long v1 = AuInt.au_sext32(p0);
        // a1: operand `b` (int32) sign-extended to XLEN, as the ABI presents it
        final long v2 = AuInt.au_sext32(p1);
        final long v3 = AuInt.au_addw(v2, 0x0L);
        return AuInt.au_eqz(v3);
    }
}
