...
// intermediate per node of the term of movswl_widen_gpr_gpr_32__reg_rdi__go__bit_blast.
...
//go:noinline
func emu_movswl_widen_gpr_gpr_32__reg_rdi__go__bit_blast(a uint16) uint64 {
...
func main() {
	sink = emu_movswl_widen_gpr_gpr_32__reg_rdi__go__bit_blast(g0)
	_ = sink
}
