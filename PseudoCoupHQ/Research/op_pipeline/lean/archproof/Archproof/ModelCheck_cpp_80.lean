...
/-- cpp single-opcode row 80, arch mnemonic 'xor', example unit cpp/regen_24912, 8 members
...
theorem ModelCheck_cpp_80 (v0 : BitVec 64) (v1 : BitVec 64) (v2 : BitVec 64) :
    (v0 ^^^ v1)
  = (model_xor_52 (model_mov_19 v0) v1) := by
  rfl

#print axioms ModelCheck_cpp_80
