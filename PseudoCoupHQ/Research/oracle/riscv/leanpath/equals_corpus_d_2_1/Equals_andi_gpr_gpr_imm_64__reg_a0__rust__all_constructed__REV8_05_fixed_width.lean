...
theorem andi_gpr_gpr_imm_64__reg_a0__rust__all_constructed__REV8_05_fixed_width (a : BitVec 64) :
    ((pure_ITYPE (a) ((sign_extend (m := 12) (0x03#6))) (ANDI))) = (pure_REV8 (a) ) := by
  try simp only [pure_ITYPE, pure_REV8, bool_to_bit, rev8, sign_extend, xlenbits, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, zeros, Sail.BitVec.length, Sail.BitVec.updateSubrange, Sail.BitVec.extractLsb, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend]
  bv_decide
