...
theorem meaning_c_op_726 (s : St) (a : BitVec 64) (b : BitVec 64) (h10 : s.regs.get? .x10 = some a) (h11 : s.regs.get? .x11 = some b) :
  ...
  simp (config := {decide := true}) only [runsTo, walk, step, execute, strip_RTYPE,
