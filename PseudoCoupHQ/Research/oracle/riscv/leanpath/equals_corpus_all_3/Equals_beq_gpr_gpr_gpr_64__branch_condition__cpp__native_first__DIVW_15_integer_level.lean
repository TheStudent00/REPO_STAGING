...
theorem beq_gpr_gpr_gpr_64__branch_condition__cpp__native_first__DIVW_15_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_ITYPE ((pure_RTYPE (a) (b) (XOR))) (0x001#12) (LeanIM.iop.SLTIU))) = (pure_DIVW (a) (b) (false)) := by
  try simp only [pure_RTYPE, pure_ITYPE, pure_DIVW, bool_to_bit, log2_xlen, not, shift_bits_right_arith, sign_extend, to_bits_truncate, xlenbits, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend]
  grind
