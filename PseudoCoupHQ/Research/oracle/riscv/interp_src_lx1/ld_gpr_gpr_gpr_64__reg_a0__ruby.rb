...
# InterpRenderer from the layer-4 term of ld_gpr_gpr_gpr_64__reg_a0__ruby.
# The term's layer-5 text, LITERAL:
#   v0
def emu_ld_gpr_gpr_gpr_64__reg_a0__ruby(a)
  m(a, 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_ld_gpr_gpr_gpr_64__reg_a0__ruby(*values)
