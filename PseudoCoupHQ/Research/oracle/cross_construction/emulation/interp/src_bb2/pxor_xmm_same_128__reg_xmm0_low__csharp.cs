...
public static class Emu {
    ...
    // one named local per gate, over the term of pxor_xmm_same_128__reg_xmm0_low__csharp.
    // The term's layer-5 text, LITERAL:
    //   0
    public static long emu_pxor_xmm_same_128__reg_xmm0_low__csharp() {
        long k0 = 0L;
        long w0 = k0;
        long w1 = cat(w0, k0, 1);
        long w2 = cat(w1, k0, 1);
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_pxor_xmm_same_128__reg_xmm0_low__csharp()).ToString());
                    answers.Append("\n");
