...
# InterpRenderer from the layer-4 term of bltu_gpr_gpr_same_64__branch_condition__cpython.
# The term's layer-5 text, LITERAL:
#   If(ULE(v0, v1), 0, 1)
def emu_bltu_gpr_gpr_same_64__branch_condition__cpython(a, b):
    return m(((0) if (ule(b, a, 64)) else (1)), 64)
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_bltu_gpr_gpr_same_64__branch_condition__cpython(*values)
            sys.stdout.write("%d\n" % answer)
