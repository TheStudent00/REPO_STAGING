---
id: hq.research.arch_unit_oracle.cross_construction.length_one.check
---

# CHECK — 0_3_2_2_0_length_one

Node `hq.research.arch_unit_oracle.cross_construction.length_one`. Status `draft`.
