...
/-- cpp single-opcode row 76, arch mnemonic 'xor', example unit cpp/op_397, 88 members
...
theorem ModelCheck_cpp_76 (v0 : BitVec 64) (v1 : BitVec 64) :
    (v0 ^^^ v1)
  = (model_xor_49 (model_mov_22 v0) v1) := by
  rfl

#print axioms ModelCheck_cpp_76
