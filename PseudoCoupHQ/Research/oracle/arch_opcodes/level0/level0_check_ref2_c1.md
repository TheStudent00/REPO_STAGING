...
| places that AGREE (`unsat`) | 876 |
| places that DISAGREE (`sat`) | 267 |
...
|---|---|---|---|---|---|---|---|---|
| `adc` | 19 | 133 | 15 | 95 | 0 | 0 | 23 | 520 |
| `sbb` | 19 | 133 | 15 | 95 | 0 | 0 | 23 | 2510 |
...
`negb_r8` -- our line `neg %dil`, shape `gpr_one` at width 8, the place `flags:SF`:

| reading | term, LITERAL (z3's printing of the simplified term, the register symbols keeping our reference's names) | its value at the counterexample |
|---|---|---|
| ours | `If(0 <= Extract(7, 0, seed_rdi), 0, 1)` | 0x0 |
| theirs | `Extract(7, 7, 1 + ~Extract(7, 0, seed_rdi))` | 0x1 |

the counterexample, LITERAL: `seed_rdi` = `0x40`
...
the counterexample, LITERAL: `seed_MEM__rax_` = `0x7c`, `seed_rsi` = `0x6a`

`negb_r8` -- our line `neg %dil`, shape `gpr_one` at width 8, the place `flags:PF`:
...
| theirs | `If((((((((~Extract(0, 0, seed_rdi) == 0) == (Extract(1, 1, 1 + ~Extract(7, 0, seed_rdi)) == 1)) == (Extract(2, 2, 1 + ~Extract(7, 0, seed_rdi)) == 1)) == (Extract(3, 3, 1 + ~Extract(7, 0, seed_rdi)) == 1)) == (Extract(4, 4, 1 + ~Extract(7, 0, seed_rdi)) == 1)) == (Extract(5, 5, 1 + ~Extract(7, 0, seed_rdi)) == 1)) == (Extract(6, 6, 1 + ~Extract(7, 0, seed_rdi)) == 1)) == (Extract(7, 7, 1 + ~Extract(7, 0, seed_rdi)) == 1), 1, 0)` | 0x1 |

the counterexample, LITERAL: `seed_rdi` = `0x7f`
...
the counterexample, LITERAL: `seed_MEM__rax_` = `0x7fffffff`, `seed_rsi` = `0x800000f1`
...
the counterexample, LITERAL: `seed_MEM__rax_` = `0x4000013e`, `seed_rsi` = `0x280`
...
Wall clock 4.5 s; peak resident memory 64.0 MB against the stated 6144 MB ceiling and the named abort `ABORT_MEMORY_REF1`.
