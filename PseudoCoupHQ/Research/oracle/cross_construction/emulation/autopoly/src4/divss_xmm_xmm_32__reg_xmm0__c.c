/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of divss_xmm_xmm_32__reg_xmm0__c.  The term's layer-5 text, LITERAL:
...
float
emu_divss_xmm_xmm_32__reg_xmm0__c(float a, float b)
{
