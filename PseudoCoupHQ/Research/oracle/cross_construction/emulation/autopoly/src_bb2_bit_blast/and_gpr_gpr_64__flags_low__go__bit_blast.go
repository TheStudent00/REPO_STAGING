...
// intermediate per node of the term of and_gpr_gpr_64__flags_low__go__bit_blast.
//   0
package main

//go:noinline
func emu_and_gpr_gpr_64__flags_low__go__bit_blast() uint64 {
	var k0 uint64 = 0
	var w0 uint64 = (k0 << 0)
...
func main() {
	sink = emu_and_gpr_gpr_64__flags_low__go__bit_blast()
	_ = sink
}
