...
- **`PRIVATE/DevComms` version control** — ruled its own thing,
...
`PRIVATE/DevComms` is a third thing again: very high level, for
...
been written there. Moved to `PRIVATE/PseudoCoupHQ/` 2026-07-31
...
`PRIVATE/PseudoCoup_v6/AgentMemory/` still holds line-wide
...
`PRIVATE/PseudoIR/Agent_Memory.md` §5 has flagged this as
