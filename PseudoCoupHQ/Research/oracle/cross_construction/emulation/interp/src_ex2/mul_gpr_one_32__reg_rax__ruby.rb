...
# InterpRenderer from the layer-4 term of mul_gpr_one_32__reg_rax__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(0, Extract(31, 0, v0)*Extract(31, 0, v1))
def emu_mul_gpr_one_32__reg_rax__ruby(a, b)
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_mul_gpr_one_32__reg_rax__ruby(*values)
