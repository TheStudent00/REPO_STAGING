/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of shr_imm_gpr_32__reg_rdi__c__bit_blast.  The term's text, LITERAL:
   Concat(0, Extract(31, 3, v0)) */
#include <stdint.h>

uint64_t
emu_shr_imm_gpr_32__reg_rdi__c__bit_blast(uint32_t a)
{
