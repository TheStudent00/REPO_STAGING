...
# InterpRenderer from the layer-4 term of remu_gpr_gpr_gpr_64__reg_a0__ruby.
# The term's layer-5 text, LITERAL:
#   If(v0 == 0, v1, bvurem_i(v1, v0))
def emu_remu_gpr_gpr_gpr_64__reg_a0__ruby(a, b)
  m(((eq(a, 0, 64)) ? (b) : (urem(b, a, 64))), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_remu_gpr_gpr_gpr_64__reg_a0__ruby(*values)
