...
// intermediate per node of the term of bgeu_gpr_gpr_same_64__branch_condition__rust__all_constructed.
//   If(ULE(v0, v1), 1, 0)
#[no_mangle]
pub extern "C" fn emu_bgeu_gpr_gpr_same_64__branch_condition__rust__all_constructed(a: u64, b: u64) -> u64
{
    ...
    let v36: bool = (!(v35));
    let v37: u64 = (if (v36) { ((0x1u64) as u64) } else { ((0x0u64) as u64) });
    ((v37) as u64)
}
