...
# InterpRenderer from the layer-4 term of div_gpr_one_64__reg_rax__ruby.
# The term's layer-5 text, LITERAL:
#   Extract(63, 0, bvudiv_i(Concat(v0, v1), Concat(0, v2)))
def emu_div_gpr_one_64__reg_rax__ruby(a, b, c)
  m(ext(udiv(cat(a, b, 64), cat(0, c, 64), 128), 63, 0), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_div_gpr_one_64__reg_rax__ruby(*values)
