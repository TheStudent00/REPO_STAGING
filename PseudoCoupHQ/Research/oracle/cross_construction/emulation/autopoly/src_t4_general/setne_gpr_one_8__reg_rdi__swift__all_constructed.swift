...
// intermediate per node of the term of setne_gpr_one_8__reg_rdi__swift__all_constructed.
//   Concat(Extract(63, 8, v0), If(Extract(7, 0, v1) == 0, 0, 1))
@_cdecl("emu_setne_gpr_one_8__reg_rdi__swift__all_constructed")
public func emu_setne_gpr_one_8__reg_rdi__swift__all_constructed(_ a: UInt8, _ b: UInt64) -> UInt64
{
    ...
    let v10: Bool = (!(v9))
    let v11: UInt32 = ((v10) ? (UInt32(0x0)) : (UInt32(0x1)))
