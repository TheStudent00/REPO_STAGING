...
#eval IO.println ("arch_au_182_c_pos_i32#0\t" ++ ((match (encdec_compressed_backwards (0x8082#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_409_go_pos_i32#0\t" ++ ((match (encdec_backwards (0x00008067#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_205_c_alignof_gnu2_u64#0\t" ++ ((match (encdec_compressed_backwards (0x4521#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_252_c_add_bool_i64#0\t" ++ ((match (encdec_compressed_backwards (0x952e#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_281_c_div_i32_u64#0\t" ++ ((match (encdec_backwards (0x02b55533#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_344_c_bor_i32_i64#0\t" ++ ((match (encdec_compressed_backwards (0x8d4d#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_372_c_bxor_bool_i64#0\t" ++ ((match (encdec_compressed_backwards (0x8d2d#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_452_go_band_i32_i32#0\t" ++ ((match (encdec_compressed_backwards (0x8d6d#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_319_c_lor_u64_i32#1\t" ++ ((match (encdec_backwards (0x00a03533#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_445_go_shr_i32_u64#0\t" ++ ((match (encdec_backwards (0x0205b293#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_445_go_shr_i32_u64#1\t" ++ ((match (encdec_compressed_backwards (0x12fd#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_445_go_shr_i32_u64#2\t" ++ ((match (encdec_backwards (0x0055e2b3#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_445_go_shr_i32_u64#3\t" ++ ((match (encdec_backwards (0x4055553b#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_449_go_shr_u64_i32#0\t" ++ ((match (encdec_backwards (0x010db303#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_449_go_shr_u64_i32#1\t" ++ ((match (encdec_backwards (0x00236a63#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_449_go_shr_u64_i32#2\t" ++ ((match (encdec_compressed_backwards (0xe42a#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_449_go_shr_u64_i32#3\t" ++ ((match (encdec_compressed_backwards (0xc82e#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_449_go_shr_u64_i32#4\t" ++ ((match (encdec_backwards (0x864fe2ef#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_449_go_shr_u64_i32#5\t" ++ ((match (encdec_compressed_backwards (0x6522#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_449_go_shr_u64_i32#6\t" ++ ((match (encdec_compressed_backwards (0x45c2#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_449_go_shr_u64_i32#7\t" ++ ((match (encdec_backwards (0xfedff06f#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_449_go_shr_u64_i32#8\t" ++ ((match (encdec_backwards (0xfe113c23#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_449_go_shr_u64_i32#9\t" ++ ((match (encdec_compressed_backwards (0x1161#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_449_go_shr_u64_i32#10\t" ++ ((match (encdec_compressed_backwards (0xe006#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_449_go_shr_u64_i32#11\t" ++ ((match (encdec_backwards (0x0005829b#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_449_go_shr_u64_i32#12\t" ++ ((match (encdec_backwards (0x0202c263#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
...
#eval IO.println ("arch_au_449_go_shr_u64_i32#14\t" ++ ((match (encdec_backwards (0x02059313#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_449_go_shr_u64_i32#15\t" ++ ((match (encdec_backwards (0x02035313#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_449_go_shr_u64_i32#16\t" ++ ((match (encdec_backwards (0x04033313#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_449_go_shr_u64_i32#17\t" ++ ((match (encdec_backwards (0x40600333#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_449_go_shr_u64_i32#18\t" ++ ((match (encdec_backwards (0x0062f533#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_449_go_shr_u64_i32#19\t" ++ ((match (encdec_compressed_backwards (0x6082#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_449_go_shr_u64_i32#20\t" ++ ((match (encdec_compressed_backwards (0x0121#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_449_go_shr_u64_i32#22\t" ++ ((match (encdec_backwards (0x8c8d40ef#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("arch_au_449_go_shr_u64_i32#23\t" ++ ((match (encdec_compressed_backwards (0x0001#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
