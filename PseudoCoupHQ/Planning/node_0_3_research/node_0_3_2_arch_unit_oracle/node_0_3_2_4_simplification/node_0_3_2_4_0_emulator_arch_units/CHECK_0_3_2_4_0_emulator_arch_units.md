---
id: hq.research.arch_unit_oracle.simplification.emulator_arch_units.check
---

# CHECK — 0_3_2_4_0_emulator_arch_units

Node `hq.research.arch_unit_oracle.simplification.emulator_arch_units`. Status `draft`.
