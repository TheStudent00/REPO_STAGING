/* task ex1 emulation -- rendered by cpp_render.py CppRenderer from the layer-4 term of div_gpr_one_16__reg_rax__cpp.  The term's layer-5 text, LITERAL:
   Concat(Extract(63, 16, v1), Extract(15, 0, bvudiv_i(Concat(Extract(15, 0, v0), Extract(15, 0, v1)), Concat(0, Extract(15, 0, v2))))) */
#include <cstdint>

extern "C"
uint64_t
emu_div_gpr_one_16__reg_rax__cpp(uint16_t a, uint64_t b, uint16_t c)
{
