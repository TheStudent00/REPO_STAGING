---
id: hq.research.arch_unit_oracle.hub_compiler.dictionary.check
---

# CHECK — 0_3_2_1_1_dictionary

Node `hq.research.arch_unit_oracle.hub_compiler.dictionary`. Status `draft`.
