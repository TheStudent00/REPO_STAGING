#!/bin/bash
# t4_l3_the_constructions_smoke_again.sh -- task t4, lane 3: the constructions
...
i=1
echo "[$i/$total] THE CONSTRUCTIONS AT TINY WIDTHS"
python3 "$G/check_constructions.py" smoke
echo "  exit: $?"
