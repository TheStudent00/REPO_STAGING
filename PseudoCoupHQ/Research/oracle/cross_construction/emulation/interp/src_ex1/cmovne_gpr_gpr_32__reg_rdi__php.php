...
// InterpRenderer from the layer-4 term of cmovne_gpr_gpr_32__reg_rdi__php.
...
function emu_cmovne_gpr_gpr_32__reg_rdi__php($a, $b, $c, $d) {
    return ex_m(ex_cat(0, ((ex_eq(ex_bnot(ex_bor(ex_bnot($b, 32), ex_bnot($a, 32), 32), 32), 0, 32)) ? ($d) : ($c)), 32), 64);
}
