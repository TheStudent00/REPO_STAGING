...
theorem c_op_498__REM_26_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (zero_reg) ((pure_RTYPE (a) (b) (XOR))) (LeanIM.rop.SLTU))) = (pure_REM (a) (b) (false)) := by
  try simp only [pure_RTYPE, pure_REM, bool_to_bit, log2_xlen, shift_bits_right_arith, to_bits_truncate, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.zeroExtend]
  grind
