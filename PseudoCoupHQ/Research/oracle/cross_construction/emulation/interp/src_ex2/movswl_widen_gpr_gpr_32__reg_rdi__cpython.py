...
# InterpRenderer from the layer-4 term of movswl_widen_gpr_gpr_32__reg_rdi__cpython.
...
def emu_movswl_widen_gpr_gpr_32__reg_rdi__cpython(a):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_movswl_widen_gpr_gpr_32__reg_rdi__cpython(*values)
            sys.stdout.write("%d\n" % answer)
