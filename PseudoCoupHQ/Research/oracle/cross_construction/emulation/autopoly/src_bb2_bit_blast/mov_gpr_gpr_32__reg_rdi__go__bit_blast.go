...
// intermediate per node of the term of mov_gpr_gpr_32__reg_rdi__go__bit_blast.
//   Concat(0, Extract(31, 0, v0))
package main

//go:noinline
func emu_mov_gpr_gpr_32__reg_rdi__go__bit_blast(a uint32) uint64 {
...
func main() {
	sink = emu_mov_gpr_gpr_32__reg_rdi__go__bit_blast(g0)
	_ = sink
}
