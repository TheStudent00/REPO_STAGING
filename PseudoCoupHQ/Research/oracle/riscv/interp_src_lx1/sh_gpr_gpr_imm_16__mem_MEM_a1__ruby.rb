...
# InterpRenderer from the layer-4 term of sh_gpr_gpr_imm_16__mem_MEM_a1__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(Extract(63, 16, v0), Extract(15, 0, v1))
def emu_sh_gpr_gpr_imm_16__mem_MEM_a1__ruby(a, b)
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_sh_gpr_gpr_imm_16__mem_MEM_a1__ruby(*values)
