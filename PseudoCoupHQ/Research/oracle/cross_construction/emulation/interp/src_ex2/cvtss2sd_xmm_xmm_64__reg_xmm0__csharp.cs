...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of cvtss2sd_xmm_xmm_64__reg_xmm0__csharp.
    // The term's layer-5 text, LITERAL:
    //   fp.to_ieee_bv(fpToFP(RNE(), fpToFP(Extract(31, 0, v0))))
    public static long emu_cvtss2sd_xmm_xmm_64__reg_xmm0__csharp(long a) {
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_cvtss2sd_xmm_xmm_64__reg_xmm0__csharp(values[0])).ToString());
                    answers.Append("\n");
