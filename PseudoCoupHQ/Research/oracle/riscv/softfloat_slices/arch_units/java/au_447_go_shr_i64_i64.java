...
public final class au_447_go_shr_i64_i64 {

    public static long au_447_go_shr_i64_i64(long p0, long p1) {
        // a0: operand `a` (int64) arrives in a0
        final long v1 = p0;
        // a1: operand `b` (int64) arrives in a1
        final long v2 = p1;
        final long v3 = AuInt.au_sltu(v2, 0x40L);
        final long v4 = AuInt.au_add(v3, 0xffffffffffffffffL);
        final long v5 = AuInt.au_or(v2, v4);
        final long v6 = AuInt.au_sra(v1, v5);
        // the answer is int64, 64 bits
        return v6;
    }

    public static long au_447_go_shr_i64_i64_trap(long p0, long p1) {
        // a0: operand `a` (int64) arrives in a0
        final long v1 = p0;
        // a1: operand `b` (int64) arrives in a1
        final long v2 = p1;
