/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of BTYPE__op_BEQ__branch_condition__c__all_constructed.  The term's text, LITERAL:
    */
#include <stdint.h>

uint64_t
emu_BTYPE__op_BEQ__branch_condition__c__all_constructed(uint64_t a, uint64_t b)
{
