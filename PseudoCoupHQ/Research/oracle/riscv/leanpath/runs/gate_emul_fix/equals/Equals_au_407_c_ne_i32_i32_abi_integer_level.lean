...
theorem au_407_c_ne_i32_i32_abi_integer_level (a : BitVec 64) (b : BitVec 64) :
    (((((fun (a : BitVec 64) (b : BitVec 64) => ((pure_RTYPE (zero_reg) ((pure_RTYPE (a) (b) (XOR))) (LeanIM.rop.SLTU)))) (((((a) &&& 0xffffffff#64) ^^^ 0x80000000#64) - 0x80000000#64)) (((((b) &&& 0xffffffff#64) ^^^ 0x80000000#64) - 0x80000000#64)))) &&& 0xffffffff#64)) = (((((fun (a : BitVec 64) (b : BitVec 64) => ((pure_RTYPE (zero_reg) ((pure_ADDIW ((pure_RTYPE (a) (b) (XOR))) ((sign_extend (m := 12) (0x00#6))))) (LeanIM.rop.SLTU)))) (((((a) &&& 0xffffffff#64) ^^^ 0x80000000#64) - 0x80000000#64)) (((((b) &&& 0xffffffff#64) ^^^ 0x80000000#64) - 0x80000000#64)))) &&& 0xffffffff#64)) := by
  try simp only [pure_ADDIW, pure_RTYPE, bool_to_bit, log2_xlen, shift_bits_right_arith, sign_extend, zero_extend, zero_reg, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, regtype, zeros, xlenbits, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend, Sail.BitVec.extractLsb, Sail.shift_bits_left, Sail.shift_bits_right]
  all_goals grind
