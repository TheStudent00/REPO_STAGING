/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of cvtss2sd_xmm_same_64__reg_xmm0__c.  The term's layer-5 text, LITERAL:
...
double
emu_cvtss2sd_xmm_same_64__reg_xmm0__c(float a)
{
