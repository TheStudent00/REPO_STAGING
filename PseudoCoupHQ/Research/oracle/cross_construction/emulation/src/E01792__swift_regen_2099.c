/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of E01792__swift_regen_2099.  The term's layer-5 text, LITERAL:
   If(Or(Not(Extract(31, 7, v0) == 0), ULE(64, Extract(6, 0, v0))), 0, LShR(v1, Concat(0, Extract(5, 0, v0)))) */
#include <stdint.h>

uint64_t
emu_E01792__swift_regen_2099(uint64_t a, uint32_t b)
{
