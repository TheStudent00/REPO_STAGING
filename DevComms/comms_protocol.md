...
Renamed 2026-09-15 at the owner's request, from `LLM_communication_protocol.md` to `comms_protocol.md`. A link under the old name stays beside it, so the dated logs that cite the old path still open.
