...
uint32_t f64_to_ui32_rm1(uint64_t v_arg)
{
    ...
    const bool v_i28 = (v__o18 == UINT64_C(0x0));
    const bool v_or_cond = (v_i27 && v_i28);
    const bool v__n20 = (v_or_cond != true);
    const bool v_i30 = (v__o18 < UINT64_C(0x100000000000));
    const uint64_t v__sh19 = (uint64_t)((uint64_t)(v__o18) >> ((UINT64_C(0xc)) & 63));
    const uint64_t v_i32 = v__sh19;
    const uint32_t v_i33 = (uint32_t)(v_i32);
    const bool v_i34 = (v__o18 > UINT64_C(0xfff));
    const bool v_i35 = (v_i27 && v_i34);
    const bool v_i37 = (v_i27 != true);
    const uint32_t v_i38 = (uint32_t)((v_i37) ? ~(uint32_t)0 : (uint32_t)0);
    const bool v__c21 = (v_i30 && v__n20);
    const bool v__c22 = (v__c21 && v_i35);
    const bool v__n28 = (v_i35 != true);
    const bool v__n23 = (v_i30 != true);
    const bool v__c25 = (v__c22 || v__n23);
    const bool v__c30 = (v__c21 && v__n28);
    const uint32_t v__m26 = (uint32_t)((v__c25) ? ~(uint32_t)0 : (uint32_t)0);
    const uint32_t v__a27 = (uint32_t)(v_i38 & v__m26);
    const uint32_t v__m31 = (uint32_t)((v__c30) ? ~(uint32_t)0 : (uint32_t)0);
    const uint32_t v__a32 = (uint32_t)(v_i33 & v__m31);
