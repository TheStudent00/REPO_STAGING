...
// InterpRenderer from the layer-4 term of lw_gpr_mem_32__reg_a0__dart.
...
int emu_lw_gpr_mem_32__reg_a0__dart(int a) {
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_lw_gpr_mem_32__reg_a0__dart(values[0]);
