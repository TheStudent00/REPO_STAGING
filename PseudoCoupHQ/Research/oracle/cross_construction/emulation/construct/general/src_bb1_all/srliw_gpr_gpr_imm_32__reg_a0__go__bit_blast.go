...
// intermediate per node of the term of srliw_gpr_gpr_imm_32__reg_a0__go__bit_blast.
//   Concat(0, Extract(31, 3, v0))
package main

//go:noinline
func emu_srliw_gpr_gpr_imm_32__reg_a0__go__bit_blast(a uint32) uint64 {
...
func main() {
	sink = emu_srliw_gpr_gpr_imm_32__reg_a0__go__bit_blast(g0)
	_ = sink
}
