...
// intermediate per node of the term of test_gpr_gpr_8__flags__go__bit_blast.
//   Concat(~(~Extract(7, 0, v0) | ~Extract(7, 0, v1)), 0)
package main

//go:noinline
func emu_test_gpr_gpr_8__flags__go__bit_blast(a uint8, b uint8) uint16 {
	...
	var w8 uint32 = w7 | (g0 << 8)
	var w9 uint32 = w8 | (g1 << 9)
	var w10 uint32 = w9 | (g2 << 10)
	var w11 uint32 = w10 | (g3 << 11)
	var w12 uint32 = w11 | (g4 << 12)
	var w13 uint32 = w12 | (g5 << 13)
	var w14 uint32 = w13 | (g6 << 14)
	var w15 uint32 = w14 | (g7 << 15)
	return uint16(w15)
}
...
func main() {
	sink = emu_test_gpr_gpr_8__flags__go__bit_blast(g0, g1)
	_ = sink
}
