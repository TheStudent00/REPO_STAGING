/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of cpp_44__cpp_op_195.  The term's layer-5 text, LITERAL:
...
float
emu_cpp_44__cpp_op_195(double a, float b)
{
