...
public class Emu {
    ...
    // InterpRenderer from the layer-4 term of czero_nez_gpr_gpr_gpr_64__reg_a0__java.
    // The term's layer-5 text, LITERAL:
    //   If(v0 == 0, v1, 0)
    static long emu_czero_nez_gpr_gpr_gpr_64__reg_a0__java(long a, long b) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_czero_nez_gpr_gpr_gpr_64__reg_a0__java(values[0], values[1])));
                    answers.append("\n");
