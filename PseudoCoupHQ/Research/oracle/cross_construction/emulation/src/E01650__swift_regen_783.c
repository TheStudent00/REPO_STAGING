/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of E01650__swift_regen_783.  The term's layer-5 text, LITERAL:
   ~(If(0 <= Extract(7, 0, v0), 254, 255) | If(ULE(Extract(31, 0, v1), Extract(31, 0, v0)), 254, 255)) */
#include <stdint.h>

uint8_t
emu_E01650__swift_regen_783(uint32_t a, uint32_t b, uint64_t c)
{
