...
// intermediate per node of the term of pxor_xmm_same_128__reg_xmm0_low__go__bit_blast.
//   0
package main
...
//go:noinline
func emu_pxor_xmm_same_128__reg_xmm0_low__go__bit_blast() float64 {
	var k0 uint64 = 0
	var w0 uint64 = (k0 << 0)
...
func main() {
	sink = emu_pxor_xmm_same_128__reg_xmm0_low__go__bit_blast()
	_ = sink
}
