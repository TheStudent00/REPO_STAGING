...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of idiv_gpr_one_16__reg_rax__csharp.
    ...
    public static long emu_idiv_gpr_one_16__reg_rax__csharp(long a, long b, long c) {
        return m(cat(ext(b, 63, 16), ext(sdiv(cat(a, ext(b, 15, 0), 16), cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(ext(c, 15, 15), ext(c, 15, 15), 1), ext(c, 15, 15), 1), ext(c, 15, 15), 1), ext(c, 15, 15), 1), ext(c, 15, 15), 1), ext(c, 15, 15), 1), ext(c, 15, 15), 1), ext(c, 15, 15), 1), ext(c, 15, 15), 1), ext(c, 15, 15), 1), ext(c, 15, 15), 1), ext(c, 15, 15), 1), ext(c, 15, 15), 1), ext(c, 15, 15), 1), ext(c, 15, 15), 1), c, 16), 32), 15, 0), 16), 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_idiv_gpr_one_16__reg_rax__csharp(values[0], values[1], values[2])).ToString());
                    answers.Append("\n");
