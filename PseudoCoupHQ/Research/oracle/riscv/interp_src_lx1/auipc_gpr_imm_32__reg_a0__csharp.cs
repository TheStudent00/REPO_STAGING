...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of auipc_gpr_imm_32__reg_a0__csharp.
    // The term's layer-5 text, LITERAL:
    //   v0 + 12288
    public static long emu_auipc_gpr_imm_32__reg_a0__csharp(long a) {
        return m(add(a, 12288L, 64), 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_auipc_gpr_imm_32__reg_a0__csharp(values[0])).ToString());
                    answers.Append("\n");
