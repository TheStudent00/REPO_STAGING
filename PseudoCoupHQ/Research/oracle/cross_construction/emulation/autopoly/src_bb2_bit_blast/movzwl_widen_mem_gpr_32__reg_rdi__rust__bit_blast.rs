...
// intermediate per node of the term of movzwl_widen_mem_gpr_32__reg_rdi__rust__bit_blast.
//   Concat(0, Extract(15, 0, v0))
#[no_mangle]
pub extern "C" fn emu_movzwl_widen_mem_gpr_32__reg_rdi__rust__bit_blast(a: u16) -> u64
{
