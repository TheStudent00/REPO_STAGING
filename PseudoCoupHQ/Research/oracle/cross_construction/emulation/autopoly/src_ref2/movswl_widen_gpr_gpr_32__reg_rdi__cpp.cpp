/* task ex1 emulation -- rendered by cpp_render.py CppRenderer from the layer-4 term of movswl_widen_gpr_gpr_32__reg_rdi__cpp.  The term's layer-5 text, LITERAL:
...
extern "C"
uint64_t
emu_movswl_widen_gpr_gpr_32__reg_rdi__cpp(uint16_t a)
{
