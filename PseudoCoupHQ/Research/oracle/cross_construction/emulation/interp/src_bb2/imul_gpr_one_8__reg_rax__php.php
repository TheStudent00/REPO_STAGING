...
// one named local per gate, over the term of imul_gpr_one_8__reg_rax__php.
...
function emu_imul_gpr_one_8__reg_rax__php($a, $b) {
    ...
    $w48 = ex_cat($w47, $g1153, 1);
    $w49 = ex_cat($w48, $g1045, 1);
    $w50 = ex_cat($w49, $g936, 1);
    $w51 = ex_cat($w50, $g826, 1);
    $w52 = ex_cat($w51, $g715, 1);
    $w53 = ex_cat($w52, $g603, 1);
    $w54 = ex_cat($w53, $g491, 1);
    $w55 = ex_cat($w54, $g387, 1);
