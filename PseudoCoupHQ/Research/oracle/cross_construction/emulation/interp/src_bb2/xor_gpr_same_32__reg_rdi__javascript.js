...
// one named local per gate, over the term of xor_gpr_same_32__reg_rdi__javascript.
// The term's layer-5 text, LITERAL:
//   0
function emu_xor_gpr_same_32__reg_rdi__javascript(a) {
    const k0 = 0n;
    const w0 = k0;
...
for (const line of lines) {
    ...
    try {
        out.push(emu_xor_gpr_same_32__reg_rdi__javascript(...values).toString());
    } catch (problem) {
