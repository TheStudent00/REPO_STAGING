...
// InterpRenderer from the layer-4 term of pxor_xmm_same_128__reg_xmm0.low__javascript.
// The term's layer-5 text, LITERAL:
//   0
function emu_pxor_xmm_same_128__reg_xmm0.low__javascript() {
    return m(0n, 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_pxor_xmm_same_128__reg_xmm0.low__javascript(...values).toString());
    } catch (problem) {
