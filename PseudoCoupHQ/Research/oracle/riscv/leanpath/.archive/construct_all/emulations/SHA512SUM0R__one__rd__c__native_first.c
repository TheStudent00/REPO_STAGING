/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of SHA512SUM0R__one__rd__c__native_first.  The term's text, LITERAL:
    */
#include <stdint.h>

uint64_t
emu_SHA512SUM0R__one__rd__c__native_first(uint64_t a, uint64_t b)
{
