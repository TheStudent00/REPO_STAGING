...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of div_gpr_one_32__reg_rax__csharp.
    // The term's layer-5 text, LITERAL:
    //   Concat(0, Extract(31, 0, bvudiv_i(Concat(Extract(31, 0, v0), Extract(31, 0, v1)), Concat(0, Extract(31, 0, v2)))))
    public static long emu_div_gpr_one_32__reg_rax__csharp(long a, long b, long c) {
        return m(cat(0L, ext(udiv(cat(a, b, 32), cat(0L, c, 32), 64), 31, 0), 32), 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_div_gpr_one_32__reg_rax__csharp(values[0], values[1], values[2])).ToString());
                    answers.Append("\n");
