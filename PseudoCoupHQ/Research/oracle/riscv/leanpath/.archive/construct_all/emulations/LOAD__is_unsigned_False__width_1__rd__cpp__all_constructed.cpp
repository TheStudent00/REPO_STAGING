/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of LOAD__is_unsigned_False__width_1__rd__cpp__all_constructed.  The term's text, LITERAL:
    */
#include <cstdint>

extern "C"
uint64_t
emu_LOAD__is_unsigned_False__width_1__rd__cpp__all_constructed(uint8_t a)
{
    ...
    uint64_t v55 = ((uint64_t)(((uint64_t)(v54) << 1) | (uint64_t)(v3)) & UINT64_C(0x1fffffffffffff));
    uint64_t v56 = ((uint64_t)(((uint64_t)(v55) << 1) | (uint64_t)(v3)) & UINT64_C(0x3fffffffffffff));
    uint64_t v57 = ((uint64_t)(((uint64_t)(v56) << 1) | (uint64_t)(v3)) & UINT64_C(0x7fffffffffffff));
    uint64_t v58 = ((uint64_t)(((uint64_t)(v57) << 1) | (uint64_t)(v3)) & UINT64_C(0xffffffffffffff));
    uint64_t v59 = (uint64_t)(((uint64_t)(v58) << 8) | (uint64_t)(v2));
    return (uint64_t)(v59);
}
