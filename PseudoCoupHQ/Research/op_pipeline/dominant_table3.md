...
| --- | --- |
| 216 | the two result types are answered in different registers (ymm0 and rax), so the result register is not one projection |
| 128 | not equal on the projection: z3 counterexample on the projection (low 8 bits): fp.to_ieee_bv = [else -> fp.to_ieee_bv(Va |
| 120 | this result type has no derived projection: the projection table does not name 'partial_ordering', and reading it as a b |
| 98 | not equal on the projection: z3 counterexample on the projection (low 8 bits): MACHINE_sseround_64 = 1, fp.to_ieee_bv =  |
| 61 | not equal on the projection: z3 counterexample on the projection (low 8 bits): MACHINE_sseround_64 = 0, fp.to_ieee_bv =  |
| 42 | not equal on the projection: z3 counterexample on the projection (low 8 bits):  |
| 40 | not equal on the projection: z3 counterexample on the projection (low 8 bits): MACHINE_sseround_64 = 2, fp.to_ieee_bv =  |
| 17 | not equal on the projection: z3 counterexample on the projection (low 8 bits): MACHINE_sseround_64 = 3, fp.to_ieee_bv =  |
| 5 | not equal on the projection: z3 counterexample on the projection (low 8 bits): in0_64 = 0, in1_64 = 0 |
...
| 1 | not equal on the projection: z3 counterexample on the projection (low 8 bits): fp.to_ieee_bv = [NaN -> 92188684373103497 |
| 1 | not equal on the projection: z3 counterexample on the projection (low 8 bits): fp.to_ieee_bv = [NaN -> 92188706545254155 |
| 1 | not equal on the projection: z3 counterexample on the projection (low 8 bits): fp.to_ieee_bv = [NaN -> 92188684372274058 |
| 1 | not equal on the projection: z3 counterexample on the projection (low 8 bits): fp.to_ieee_bv = [NaN -> 92217997926358277 |
| 1 | not equal on the projection: z3 counterexample on the projection (low 8 bits): fp.to_ieee_bv = [NaN -> 92197744725296913 |
| 1 | not equal on the projection: z3 counterexample on the projection (low 8 bits): fp.to_ieee_bv = [NaN -> 18442240475658826 |
| 1 | this result type has no derived projection: the projection table does not name 'strong_ordering', and reading it as a bi |
| 1 | not equal on the projection: z3 counterexample on the projection (low 8 bits): fp.to_ieee_bv = [NaN -> 18446744073702836 |
| 1 | not equal on the projection: z3 counterexample on the projection (low 8 bits): fp.to_ieee_bv = [NaN -> 92222115823322138 |
| 1 | not equal on the projection: z3 counterexample on the projection (low 8 bits): fp.to_ieee_bv = [NaN -> 92210641633270225 |
| 1 | not equal on the projection: z3 counterexample on the projection (low 8 bits): fp.to_ieee_bv = [NaN -> 92191499128757329 |
| 1 | not equal on the projection: z3 counterexample on the projection (low 8 bits): fp.to_ieee_bv = [NaN -> 18442708103366752 |
| 1 | not equal on the projection: z3 counterexample on the projection (low 8 bits): fp.to_ieee_bv = [NaN -> 92199943371258593 |
| 1 | not equal on the projection: z3 counterexample on the projection (low 8 bits): fp.to_ieee_bv = [NaN -> 92221548508333231 |
| 1 | not equal on the projection: z3 counterexample on the projection (low 8 bits): fp.to_ieee_bv = [NaN -> 18442240474082181 |
| 1 | not equal on the projection: z3 counterexample on the projection (low 8 bits): fp.to_ieee_bv = [NaN -> 18445086665523976 |
| 1 | not equal on the projection: z3 counterexample on the projection (low 8 bits): fp.to_ieee_bv = [NaN -> 92207575535664497 |
| 1 | not equal on the projection: z3 counterexample on the projection (low 8 bits): fp.to_ieee_bv = [NaN -> 18445846876026445 |
