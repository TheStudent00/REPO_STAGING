...
theorem cpp__op_721_73_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (LeanIM.rop.SRA))) = ((shift_bits_right_arith a (Sail.BitVec.extractLsb b (log2_xlen -i 1) 0))) := by
  try simp only [pure_RTYPE, bool_to_bit, log2_xlen, shift_bits_right_arith, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.zeroExtend, Sail.BitVec.extractLsb, Sail.shift_bits_left, Sail.shift_bits_right]
  all_goals grind
