...
import LeanIMZ.RangeUtil
import LeanIMZ.VmemTypes
import LeanIMZ.MemUtils
...
/-- Type quantifiers: k_ex512897_ : Bool -/
...
/-- Type quantifiers: k_ex512898_ : Bool, width : Nat, 0 < width ∧ width ≤ max_mem_access -/
