...
// InterpRenderer from the layer-4 term of srliw_gpr_gpr_imm_32__reg_a0__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(0, Extract(31, 3, v0))
function emu_srliw_gpr_gpr_imm_32__reg_a0__javascript(a) {
    return m(cat(0n, ext(a, 31, 3), 29), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_srliw_gpr_gpr_imm_32__reg_a0__javascript(...values).toString());
    } catch (problem) {
