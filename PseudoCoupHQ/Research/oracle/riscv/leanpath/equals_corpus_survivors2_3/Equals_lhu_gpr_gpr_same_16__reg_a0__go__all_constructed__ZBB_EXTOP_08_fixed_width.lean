...
theorem lhu_gpr_gpr_same_16__reg_a0__go__all_constructed__ZBB_EXTOP_08_fixed_width (a : BitVec 64) :
  ...
  try simp only [pure_SHIFTIOP, pure_ZBB_EXTOP, log2_xlen, shift_bits_right_arith, sign_extend, xlenbits, zero_extend, xlen, Sail.BitVec.toNatInt, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend]
  bv_decide
