...
public static class Emu {
    ...
    // one named local per gate, over the term of sar_imm_gpr_64__reg_rdi__csharp.
    // The term's layer-5 text, LITERAL:
    //   v0 >> 3
    public static long emu_sar_imm_gpr_64__reg_rdi__csharp(long a) {
        long x0_3 = ext(a, 3, 3);
        long x0_4 = ext(a, 4, 4);
        long x0_5 = ext(a, 5, 5);
        long x0_6 = ext(a, 6, 6);
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_sar_imm_gpr_64__reg_rdi__csharp(values[0])).ToString());
                    answers.Append("\n");
