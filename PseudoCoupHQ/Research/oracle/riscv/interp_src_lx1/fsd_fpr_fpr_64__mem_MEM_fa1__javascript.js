...
// InterpRenderer from the layer-4 term of fsd_fpr_fpr_64__mem_MEM_fa1__javascript.
// The term's layer-5 text, LITERAL:
//   v0
function emu_fsd_fpr_fpr_64__mem_MEM_fa1__javascript(a) {
    return m(a, 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_fsd_fpr_fpr_64__mem_MEM_fa1__javascript(...values).toString());
    } catch (problem) {
