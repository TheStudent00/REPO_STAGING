...
/-- c single-opcode row 21, arch mnemonic 'imul', example unit c/op_181, 40 members
...
theorem ModelCheck_c_21 (v0 : BitVec 64) (v1 : BitVec 64) :
    (v0 * v1)
  = (model_imul_54 (model_mov_22 v0) v1) := by
  rfl

#print axioms ModelCheck_c_21
