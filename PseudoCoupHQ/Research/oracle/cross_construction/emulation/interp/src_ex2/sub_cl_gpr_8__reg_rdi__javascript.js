...
// InterpRenderer from the layer-4 term of sub_cl_gpr_8__reg_rdi__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(0, Extract(7, 0, v0)*255 + Extract(7, 0, v1))
function emu_sub_cl_gpr_8__reg_rdi__javascript(a, b) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_sub_cl_gpr_8__reg_rdi__javascript(...values).toString());
    } catch (problem) {
