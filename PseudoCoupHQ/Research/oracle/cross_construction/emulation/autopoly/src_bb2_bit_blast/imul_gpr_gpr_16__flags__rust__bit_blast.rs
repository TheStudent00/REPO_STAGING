...
// intermediate per node of the term of imul_gpr_gpr_16__flags__rust__bit_blast.
//   Concat(Extract(15, 0, v0), Extract(15, 0, v1))
#[no_mangle]
pub extern "C" fn emu_imul_gpr_gpr_16__flags__rust__bit_blast(a: u16, b: u16) -> u32
{
