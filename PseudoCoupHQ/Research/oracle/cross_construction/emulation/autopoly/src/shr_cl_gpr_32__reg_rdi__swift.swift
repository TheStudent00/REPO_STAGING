...
// SwiftRenderer from the layer-4 term of shr_cl_gpr_32__reg_rdi__swift.
// EVERY SPELLING IN THIS SOURCE IS UNMEASURED: there is no swiftc in
// the image, so nothing here has been compiled or carved.
// The term's layer-5 text, LITERAL:
//   Concat(0, LShR(Extract(31, 0, v0), Concat(0, Extract(4, 0, v1))))
@_cdecl("emu_shr_cl_gpr_32__reg_rdi__swift")
public func emu_shr_cl_gpr_32__reg_rdi__swift(_ a: UInt32, _ b: UInt8) -> UInt64
{
