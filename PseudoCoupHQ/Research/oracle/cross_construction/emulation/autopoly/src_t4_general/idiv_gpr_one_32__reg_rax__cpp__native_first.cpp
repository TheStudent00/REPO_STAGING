/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of idiv_gpr_one_32__reg_rax__cpp__native_first.  The term's text, LITERAL:
...
extern "C"
uint64_t
emu_idiv_gpr_one_32__reg_rax__cpp__native_first(uint32_t a, uint32_t b, uint32_t c)
{
