...
// one named local per gate, over the term of movaps_xmm_xmm_128__reg_xmm0_low__javascript.
// The term's layer-5 text, LITERAL:
//   Extract(63, 0, v0)
function emu_movaps_xmm_xmm_128__reg_xmm0_low__javascript(a) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_movaps_xmm_xmm_128__reg_xmm0_low__javascript(...values).toString());
    } catch (problem) {
