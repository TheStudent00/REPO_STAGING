...
// InterpRenderer from the layer-4 term of not_gpr_one_64__reg_rdi__dart.
// The term's layer-5 text, LITERAL:
//   ~v0
int emu_not_gpr_one_64__reg_rdi__dart(int a) {
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_not_gpr_one_64__reg_rdi__dart(values[0]);
