...
# InterpRenderer from the layer-4 term of and_gpr_gpr_gpr_64__reg_a0__ruby.
# The term's layer-5 text, LITERAL:
#   ~(~v0 | ~v1)
def emu_and_gpr_gpr_gpr_64__reg_a0__ruby(a, b)
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_and_gpr_gpr_gpr_64__reg_a0__ruby(*values)
