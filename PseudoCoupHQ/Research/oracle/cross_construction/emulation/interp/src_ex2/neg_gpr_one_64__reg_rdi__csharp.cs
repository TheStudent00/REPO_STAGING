...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of neg_gpr_one_64__reg_rdi__csharp.
    // The term's layer-5 text, LITERAL:
    //   v0*18446744073709551615
    public static long emu_neg_gpr_one_64__reg_rdi__csharp(long a) {
        return m(mul(a, -1L, 64), 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_neg_gpr_one_64__reg_rdi__csharp(values[0])).ToString());
                    answers.Append("\n");
