...
// InterpRenderer from the layer-4 term of sbb_imm_gpr_8__reg_rdi__php.
...
function emu_sbb_imm_gpr_8__reg_rdi__php($a, $b, $c, $d) {
    return ex_m(ex_cat(0, ex_add(ex_add(ex_mul($d, 255, 8), ex_mul(((ex_eq(ex_ext(ex_add(ex_cat(0, $b, 8), ex_cat(0, $a, 8), 9), 8, 8), 1, 1)) ? (1) : (0)), 255, 8), 8), $c, 8), 8), 64);
}
