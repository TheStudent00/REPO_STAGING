...
wrote PRIVATE/PseudoCoupHQ/Research/op_pipeline/op_units_cpython_reextracted.json
```
...
wrote PRIVATE/PseudoCoupHQ/Research/op_pipeline/op_units_cpython2_reextracted.json
```
...
- `PRIVATE/PseudoCoupHQ/DevComms/log_104_task20_block_cutter.md`
  -- this report.
