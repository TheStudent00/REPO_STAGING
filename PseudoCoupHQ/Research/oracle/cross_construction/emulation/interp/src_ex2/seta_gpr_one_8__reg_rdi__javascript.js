...
// InterpRenderer from the layer-4 term of seta_gpr_one_8__reg_rdi__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(0, If(ULE(Extract(7, 0, v0), Extract(7, 0, v1)), 0, 1))
function emu_seta_gpr_one_8__reg_rdi__javascript(a, b) {
    return m(cat(0n, ((ule(a, b, 8)) ? (0n) : (1n)), 8), 64);
}
