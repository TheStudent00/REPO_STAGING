...
// InterpRenderer from the layer-4 term of divu_gpr_gpr_same_64__reg_a0__javascript.
// The term's layer-5 text, LITERAL:
//   If(v0 == 0, 18446744073709551615, bvudiv_i(v0, v0))
function emu_divu_gpr_gpr_same_64__reg_a0__javascript(a) {
    return m(((eq(a, 0n, 64)) ? (18446744073709551615n) : (udiv(a, a, 64))), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_divu_gpr_gpr_same_64__reg_a0__javascript(...values).toString());
    } catch (problem) {
