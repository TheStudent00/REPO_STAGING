...
# InterpRenderer from the layer-4 term of movsbl_widen_gpr_gpr_32__reg_rdi__ruby.
...
def emu_movsbl_widen_gpr_gpr_32__reg_rdi__ruby(a)
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_movsbl_widen_gpr_gpr_32__reg_rdi__ruby(*values)
