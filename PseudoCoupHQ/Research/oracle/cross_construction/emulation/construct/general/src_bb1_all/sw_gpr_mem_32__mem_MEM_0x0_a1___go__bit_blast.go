...
// intermediate per node of the term of sw_gpr_mem_32__mem_MEM_0x0_a1___go__bit_blast.
//   Concat(Extract(63, 32, v0), Extract(31, 0, v1))
package main

//go:noinline
func emu_sw_gpr_mem_32__mem_MEM_0x0_a1___go__bit_blast(a uint64, b uint32) uint64 {
...
func main() {
	sink = emu_sw_gpr_mem_32__mem_MEM_0x0_a1___go__bit_blast(g0, g1)
	_ = sink
}
