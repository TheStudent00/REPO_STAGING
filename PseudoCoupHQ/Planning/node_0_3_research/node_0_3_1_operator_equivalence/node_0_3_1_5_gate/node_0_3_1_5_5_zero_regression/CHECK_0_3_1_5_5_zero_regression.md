---
id: hq.research.compiler_graph.gate.zero_regression.check
---

# CHECK — 0_3_1_5_5_zero_regression

Node `hq.research.compiler_graph.gate.zero_regression`. Status `draft`.
