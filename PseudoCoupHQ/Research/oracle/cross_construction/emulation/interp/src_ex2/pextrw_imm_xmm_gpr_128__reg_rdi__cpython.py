...
# InterpRenderer from the layer-4 term of pextrw_imm_xmm_gpr_128__reg_rdi__cpython.
# The term's layer-5 text, LITERAL:
#   Concat(0, Extract(31, 16, v0))
def emu_pextrw_imm_xmm_gpr_128__reg_rdi__cpython(a):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_pextrw_imm_xmm_gpr_128__reg_rdi__cpython(*values)
            sys.stdout.write("%d\n" % answer)
