...
// intermediate per node of the term of setl_gpr_one_8__reg_rdi__rust__native_first.
...
#[no_mangle]
pub extern "C" fn emu_setl_gpr_one_8__reg_rdi__rust__native_first(a: u8, b: u8, c: u64) -> u64
{
    let v0: u32 = (a as u32);
    ...
    let v11: u32 = (if (v10) { ((0x1u32) as u32) } else { ((0x0u32) as u32) });
