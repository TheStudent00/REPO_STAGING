...
import LeanIM.RangeUtil
import LeanIM.VmemTypes
import LeanIM.MemUtils
...
/-- Type quantifiers: k_ex561039_ : Bool -/
...
/-- Type quantifiers: k_ex561045_ : Bool, width : Nat, 0 < width ∧ width ≤ max_mem_access -/
