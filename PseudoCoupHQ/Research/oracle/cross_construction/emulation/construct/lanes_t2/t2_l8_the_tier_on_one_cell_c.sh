#!/bin/bash
# t2_l8_the_tier_on_one_cell_c.sh -- task t2, lane 8: lane 7 again, with the equality posed on the pipeline's own normalised terms and the size guard moved BEFORE the normaliser.
