---
id: hq.research.compiler_graph.gate.lean.certificates.check
---

# CHECK — 0_3_1_5_6_1_certificates

Node `hq.research.compiler_graph.gate.lean.certificates`. Status `draft`.
