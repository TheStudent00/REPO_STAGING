...
// one named local per gate, over the term of mov_mem_gpr_64__reg_rdi__javascript.
// The term's layer-5 text, LITERAL:
//   v0
function emu_mov_mem_gpr_64__reg_rdi__javascript(a) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_mov_mem_gpr_64__reg_rdi__javascript(...values).toString());
    } catch (problem) {
