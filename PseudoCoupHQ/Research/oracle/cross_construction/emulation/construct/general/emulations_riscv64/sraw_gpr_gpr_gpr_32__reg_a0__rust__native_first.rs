...
// intermediate per node of the term of sraw_gpr_gpr_gpr_32__reg_a0__rust__native_first.
...
#[no_mangle]
pub extern "C" fn emu_sraw_gpr_gpr_gpr_32__reg_a0__rust__native_first(a: u32, b: u8) -> u64
{
    let v0: u32 = (((((b as u32)) >> 0) as u32) & 0x1fu32);
    let v1: u32 = (((((0x0u32) as u32) << 5) | ((v0) as u32)) as u32);
    let v2: u32 = (a as u32);
    let v3: u32 = (((((v2) as i32)).wrapping_shr((((v1) as u32) as u32))) as u32);
