# CHECK — 0_2_1_assembly

Node `pir.assembly`. Status `draft`.
...
- [ ] `node_0_2_1_0_intention_objects` — see its own CHECK
- [ ] `node_0_2_1_1_borders` — see its own CHECK
- [ ] `node_0_2_1_2_surface` — see its own CHECK
