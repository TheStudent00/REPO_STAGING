/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of bne_gpr_gpr_same_64__branch_condition__cpp__all_constructed.  The term's text, LITERAL:
   If(v0 == v1, 0, 1) */
#include <cstdint>

extern "C"
uint64_t
emu_bne_gpr_gpr_same_64__branch_condition__cpp__all_constructed(uint64_t a, uint64_t b)
{
    ...
    int v15 = ((!(v14))) ? 1 : 0;
    uint64_t v16 = ((v15) ? (uint64_t)(UINT64_C(0x0)) : (uint64_t)(UINT64_C(0x1)));
    return (uint64_t)(v16);
}
