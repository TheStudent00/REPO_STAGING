...
# InterpRenderer from the layer-4 term of xor_gpr_gpr_gpr_64__reg_a0__ruby.
# The term's layer-5 text, LITERAL:
#   v0 ^ v1
def emu_xor_gpr_gpr_gpr_64__reg_a0__ruby(a, b)
  m(bxor(a, b, 64), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_xor_gpr_gpr_gpr_64__reg_a0__ruby(*values)
