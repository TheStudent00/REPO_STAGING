/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of ITYPE__op_ADDI__rd__cpp__all_constructed.  The term's text, LITERAL:
    */
#include <cstdint>

extern "C"
uint64_t
emu_ITYPE__op_ADDI__rd__cpp__all_constructed(uint64_t a, uint16_t b)
{
