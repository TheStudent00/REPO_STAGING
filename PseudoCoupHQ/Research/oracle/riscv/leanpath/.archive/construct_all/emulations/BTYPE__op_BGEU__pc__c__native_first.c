/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of BTYPE__op_BGEU__pc__c__native_first.  The term's text, LITERAL:
    */
#include <stdint.h>

uint64_t
emu_BTYPE__op_BGEU__pc__c__native_first(uint64_t a, uint16_t b)
{
