...
theorem c_op_174__ZBB_RTYPE_brop_zbbXNOR_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_MULW (b) (a))) = (pure_ZBB_RTYPE (a) (b) (brop_zbb.XNOR)) := by
  simp only [pure_MULW, pure_ZBB_RTYPE]
  grind
