...
// intermediate per node of the term of fmv_x_w_gpr_fpr_fpr_32__reg_a0__go__all_constructed.
...
//go:noinline
func emu_fmv_x_w_gpr_fpr_fpr_32__reg_a0__go__all_constructed(a uint32) uint64 {
...
func main() {
	sink = emu_fmv_x_w_gpr_fpr_fpr_32__reg_a0__go__all_constructed(g0)
	_ = sink
}
