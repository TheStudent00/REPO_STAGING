...
theorem c_op_498__DIV_13_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (zero_reg) ((pure_RTYPE (a) (b) (XOR))) (LeanIM.rop.SLTU))) = (pure_DIV (a) (b) (false)) := by
  try simp only [pure_RTYPE, pure_DIV, bool_to_bit, log2_xlen, not, shift_bits_right_arith, to_bits_truncate, xlen, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, Sail.BitVec.zeroExtend]
  grind
