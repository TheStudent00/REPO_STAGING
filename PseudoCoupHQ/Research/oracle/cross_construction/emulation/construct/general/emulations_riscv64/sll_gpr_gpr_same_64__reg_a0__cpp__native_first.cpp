/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of sll_gpr_gpr_same_64__reg_a0__cpp__native_first.  The term's text, LITERAL:
   v0 << Concat(0, Extract(5, 0, v0)) */
#include <cstdint>

extern "C"
uint64_t
emu_sll_gpr_gpr_same_64__reg_a0__cpp__native_first(uint64_t a)
{
