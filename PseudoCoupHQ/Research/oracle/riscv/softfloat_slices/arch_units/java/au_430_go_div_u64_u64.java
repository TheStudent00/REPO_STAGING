// arch-unit 430  --  go  `a / b`  lhs=uint64 rhs=uint64
// symbol main.op_110   outcome LIFTED   18 arch-opcodes
//
// the arch-unit, arch-opcode by arch-opcode:
//   ld t1, 0x10(s11)                     prologue   stack-growth check -> elided
//   bltu t1, sp, 0x6c738 <main.op_110+0x18> prologue   stack-growth check -> elided
...
//   jal zero, 0x6c720 <main.op_110>      prologue   stack-growth call / restart / panic tail -> elided
...
//   beq a1, zero, 0x6c750 <main.op_110+0x30> guard      guard branch -> a `_trap` predicate
...
public final class au_430_go_div_u64_u64 {

    public static long au_430_go_div_u64_u64(long p0, long p1) {
    ...
    public static long au_430_go_div_u64_u64_trap(long p0, long p1) {
        // a0: operand `a` (uint64) arrives in a0
        final long v1 = p0;
        // a1: operand `b` (uint64) arrives in a1
        final long v2 = p1;
