...
// InterpRenderer from the layer-4 term of bne_gpr_gpr_same_64__branch_condition__javascript.
// The term's layer-5 text, LITERAL:
//   If(v0 == v1, 0, 1)
function emu_bne_gpr_gpr_same_64__branch_condition__javascript(a, b) {
    return m(((eq(a, b, 64)) ? (0n) : (1n)), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_bne_gpr_gpr_same_64__branch_condition__javascript(...values).toString());
    } catch (problem) {
