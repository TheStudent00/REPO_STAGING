/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of cpp_51__cpp_op_365.  The term's layer-5 text, LITERAL:
   Concat(Extract(63, 32, v0), Extract(31, 0, v0) | Extract(31, 0, v1)) */
#include <stdint.h>

uint64_t
emu_cpp_51__cpp_op_365(uint64_t a, uint32_t b)
{
