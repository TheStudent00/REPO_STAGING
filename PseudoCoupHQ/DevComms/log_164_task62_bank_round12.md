...
| `Sources/llvm-` (truncated) | 79 | 2026-08-31 17:16 |
| `SandboxDesign/allow.sh` | 73 (dominant_intentions) | 2026-08-14 14:00 |
...
```
$ bash PRIVATE/PseudoCoupHQ/hq.sh dashboard
...
- `PRIVATE/PseudoCoupHQ/DevComms/next_commit_message.txt` —
  written (§5).
- `PRIVATE/PseudoCoupHQ/DevComms/log_164_task62_bank_round12.md`
  — this file.
