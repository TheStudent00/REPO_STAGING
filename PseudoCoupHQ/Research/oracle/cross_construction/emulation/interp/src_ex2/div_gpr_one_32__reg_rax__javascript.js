...
// InterpRenderer from the layer-4 term of div_gpr_one_32__reg_rax__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(0, Extract(31, 0, bvudiv_i(Concat(Extract(31, 0, v0), Extract(31, 0, v1)), Concat(0, Extract(31, 0, v2)))))
function emu_div_gpr_one_32__reg_rax__javascript(a, b, c) {
    return m(cat(0n, ext(udiv(cat(a, b, 32), cat(0n, c, 32), 64), 31, 0), 32), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_div_gpr_one_32__reg_rax__javascript(...values).toString());
    } catch (problem) {
