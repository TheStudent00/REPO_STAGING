...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of addi_gpr_gpr_imm_64__reg_a0__csharp.
    // The term's layer-5 text, LITERAL:
    //   v0 + 3
    public static long emu_addi_gpr_gpr_imm_64__reg_a0__csharp(long a) {
        return m(add(a, 3L, 64), 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_addi_gpr_gpr_imm_64__reg_a0__csharp(values[0])).ToString());
                    answers.Append("\n");
