...
// InterpRenderer from the layer-4 term of mul_gpr_one_32__reg_rax__dart.
// The term's layer-5 text, LITERAL:
//   Concat(0, Extract(31, 0, v0)*Extract(31, 0, v1))
int emu_mul_gpr_one_32__reg_rax__dart(int a, int b) {
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_mul_gpr_one_32__reg_rax__dart(values[0], values[1]);
