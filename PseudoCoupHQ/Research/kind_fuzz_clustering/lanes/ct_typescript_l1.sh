#!/bin/sh
# layer-3 CARTESIAN lane -- typescript -- level 1  --
...
# the census's own acceptance_typescript_A1.json.  A value the holder cannot represent is
...
echo "=== layer-3 CARTESIAN -- typescript -- level 1 -- 16238 probes ==="
date -u +%Y-%m-%dT%H:%M:%SZ
# refuse in seconds rather than in an hour if the toolchain is not here
if ! node -e 'require("/persist/tv/ts5/node_modules/typescript/lib/typescript.js")' >/dev/null 2>&1; then
  echo "!! REFUSING TO START: node + the typescript checker is not runnable in this container."
  echo "!! tried: node -e 'require("/persist/tv/ts5/node_modules/typescript/lib/typescript.js")'"
  echo "!! node is in the image; the typescript checker lives in the sandbox-persist volume at /persist/tv/ts5"
  exit 4
fi
node --version 2>&1 | head -2
ROOT=/work/ct_typescript_l1
...

IQAA
T_EOF
...
date -u +%Y-%m-%dT%H:%M:%SZ
echo "=== cartesian typescript level 1 done ==="
