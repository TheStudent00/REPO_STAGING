...
# InterpRenderer from the layer-4 term of jal_gpr_fpr_64__reg_a0__cpython.
# The term's layer-5 text, LITERAL:
#   v0 + 4
def emu_jal_gpr_fpr_64__reg_a0__cpython(a):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_jal_gpr_fpr_64__reg_a0__cpython(*values)
            sys.stdout.write("%d\n" % answer)
