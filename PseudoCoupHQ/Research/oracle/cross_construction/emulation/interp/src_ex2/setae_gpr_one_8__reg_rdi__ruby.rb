...
# InterpRenderer from the layer-4 term of setae_gpr_one_8__reg_rdi__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(0, If(Extract(8, 8, Concat(0, Extract(7, 0, v0)) + Concat(0, Extract(7, 0, v1))) == 1, 0, 1))
def emu_setae_gpr_one_8__reg_rdi__ruby(a, b)
  m(cat(0, ((eq(ext(add(cat(0, a, 8), cat(0, b, 8), 9), 8, 8), 1, 1)) ? (0) : (1)), 8), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_setae_gpr_one_8__reg_rdi__ruby(*values)
