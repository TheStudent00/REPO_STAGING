...
# InterpRenderer from the layer-4 term of add_gpr_gpr_same_64__reg_a0__cpython.
# The term's layer-5 text, LITERAL:
#   v0*2
def emu_add_gpr_gpr_same_64__reg_a0__cpython(a):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_add_gpr_gpr_same_64__reg_a0__cpython(*values)
            sys.stdout.write("%d\n" % answer)
