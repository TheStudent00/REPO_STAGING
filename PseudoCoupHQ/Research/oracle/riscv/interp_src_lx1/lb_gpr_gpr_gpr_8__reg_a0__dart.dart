...
// InterpRenderer from the layer-4 term of lb_gpr_gpr_gpr_8__reg_a0__dart.
...
int emu_lb_gpr_gpr_gpr_8__reg_a0__dart(int a) {
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_lb_gpr_gpr_gpr_8__reg_a0__dart(values[0]);
