...
// InterpRenderer from the layer-4 term of movslq_widen_gpr_gpr_64__reg_rdi__php.
...
function emu_movslq_widen_gpr_gpr_64__reg_rdi__php($a) {
    return ex_m(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_ext($a, 31, 31), ex_ext($a, 31, 31), 1), ex_ext($a, 31, 31), 1), ex_ext($a, 31, 31), 1), ex_ext($a, 31, 31), 1), ex_ext($a, 31, 31), 1), ex_ext($a, 31, 31), 1), ex_ext($a, 31, 31), 1), ex_ext($a, 31, 31), 1), ex_ext($a, 31, 31), 1), ex_ext($a, 31, 31), 1), ex_ext($a, 31, 31), 1), ex_ext($a, 31, 31), 1), ex_ext($a, 31, 31), 1), ex_ext($a, 31, 31), 1), ex_ext($a, 31, 31), 1), ex_ext($a, 31, 31), 1), ex_ext($a, 31, 31), 1), ex_ext($a, 31, 31), 1), ex_ext($a, 31, 31), 1), ex_ext($a, 31, 31), 1), ex_ext($a, 31, 31), 1), ex_ext($a, 31, 31), 1), ex_ext($a, 31, 31), 1), ex_ext($a, 31, 31), 1), ex_ext($a, 31, 31), 1), ex_ext($a, 31, 31), 1), ex_ext($a, 31, 31), 1), ex_ext($a, 31, 31), 1), ex_ext($a, 31, 31), 1), ex_ext($a, 31, 31), 1), ex_ext($a, 31, 31), 1), $a, 32), 64);
}
