/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of swift_4__swift_op_178.  The term's layer-5 text, LITERAL:
...
double
emu_swift_4__swift_op_178(double a, double b)
{
