...
// InterpRenderer from the layer-4 term of or_gpr_gpr_gpr_64__reg_a0__dart.
// The term's layer-5 text, LITERAL:
//   v0 | v1
int emu_or_gpr_gpr_gpr_64__reg_a0__dart(int a, int b) {
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_or_gpr_gpr_gpr_64__reg_a0__dart(values[0], values[1]);
