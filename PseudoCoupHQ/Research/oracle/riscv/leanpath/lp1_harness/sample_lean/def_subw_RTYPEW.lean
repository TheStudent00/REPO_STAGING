...
theorem def_subw_RTYPEW (h_plat_term_write : ∀ x0  (s : Leanpath.St), (plat_term_write x0) s = EStateM.Result.ok () s) (h_load_reservation : ∀ x0 x1  (s : Leanpath.St), (load_reservation x0 x1) s = EStateM.Result.ok () s) (h_cancel_reservation : ∀ x0  (s : Leanpath.St), (cancel_reservation x0) s = EStateM.Result.ok () s) (a0 : BitVec 64) (a1 : BitVec 64) (a2 : BitVec 64) (a3 : BitVec 64) (a4 : BitVec 64) (a5 : BitVec 64) (a6 : BitVec 64) (a7 : BitVec 64)  : (results (execute (RTYPEW (Regidx 11#5, Regidx 10#5, Regidx 10#5, .SUBW))) (withRegs S0 [⟨Register.x10, a0⟩, ⟨Register.x11, a1⟩, ⟨Register.x12, a2⟩, ⟨Register.x13, a3⟩, ⟨Register.x14, a4⟩, ⟨Register.x15, a5⟩, ⟨Register.x16, a6⟩, ⟨Register.x17, a7⟩]), answer (execute (RTYPEW (Regidx 11#5, Regidx 10#5, Regidx 10#5, .SUBW))) (withRegs S0 [⟨Register.x10, a0⟩, ⟨Register.x11, a1⟩, ⟨Register.x12, a2⟩, ⟨Register.x13, a3⟩, ⟨Register.x14, a4⟩, ⟨Register.x15, a5⟩, ⟨Register.x16, a6⟩, ⟨Register.x17, a7⟩]) Register.x10) = (results (execute (RTYPEW (Regidx 11#5, Regidx 10#5, Regidx 10#5, .SUBW))) (withRegs S0 [⟨Register.x10, a0⟩, ⟨Register.x11, a1⟩, ⟨Register.x12, a2⟩, ⟨Register.x13, a3⟩, ⟨Register.x14, a4⟩, ⟨Register.x15, a5⟩, ⟨Register.x16, a6⟩, ⟨Register.x17, a7⟩]), answer (execute (RTYPEW (Regidx 11#5, Regidx 10#5, Regidx 10#5, .SUBW))) (withRegs S0 [⟨Register.x10, a0⟩, ⟨Register.x11, a1⟩, ⟨Register.x12, a2⟩, ⟨Register.x13, a3⟩, ⟨Register.x14, a4⟩, ⟨Register.x15, a5⟩, ⟨Register.x16, a6⟩, ⟨Register.x17, a7⟩]) Register.x10) := by
