...
| D0009 | `+` unary_prefix + `++` unary_postfix + `--` unary_postfix + `__extension__` unary_prefix | `+` unary_prefix + `++` unary_postfix + `--` unary_postfix | `+` unary_prefix | -- refused/absent | `+` unary_prefix | -- refused/absent | 7 | 1 | 0 | tree-exact |
...
| D0016 | `_Alignof` unary_prefix + `__alignof` unary_prefix + `__alignof__` unary_prefix + `sizeof` unary_prefix | `sizeof` unary_prefix | -- refused/absent | -- refused/absent | -- refused/absent | -- refused/absent | 6 | 0 | 0 | canon-byte |
