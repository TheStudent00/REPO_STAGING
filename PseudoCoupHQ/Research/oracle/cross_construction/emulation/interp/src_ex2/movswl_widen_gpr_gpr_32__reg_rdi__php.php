...
// InterpRenderer from the layer-4 term of movswl_widen_gpr_gpr_32__reg_rdi__php.
...
function emu_movswl_widen_gpr_gpr_32__reg_rdi__php($a) {
    return ex_m(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(0, ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), $a, 16), 64);
}
