; ModuleID = '<scratch>/fl/run/i32_to_f32.rm1.flags/i32_to_f32.rm1.flags.rv.flat.ll'
source_filename = "llvm-link"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128"
target triple = "riscv64-unknown-unknown-elf"

define dso_local i64 @i32_to_f32_rm1_flags_flat(i32 noundef signext %arg) {
  ...
  %i31 = icmp ult i32 %i27, 128
  %.m20 = sext i1 %i31 to i32
  %.n21 = xor i32 %.m20, -1
  %i35 = and i32 %i21, %.n21
  %i38 = zext i1 %i30 to i64
  %i36 = or i32 %.sh18, %i20
  %i37 = add i32 %i36, %i35
  %.n22 = xor i1 %i17, true
