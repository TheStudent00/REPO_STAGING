...
# InterpRenderer from the layer-4 term of pextrw_imm_xmm_gpr_128__reg_rdi__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(0, Extract(31, 16, v0))
def emu_pextrw_imm_xmm_gpr_128__reg_rdi__ruby(a)
  m(cat(0, ext(a, 31, 16), 16), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_pextrw_imm_xmm_gpr_128__reg_rdi__ruby(*values)
