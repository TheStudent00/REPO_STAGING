...
# InterpRenderer from the layer-4 term of addi_gpr_gpr_imm_64__reg_a0__ruby.
# The term's layer-5 text, LITERAL:
#   v0 + 3
def emu_addi_gpr_gpr_imm_64__reg_a0__ruby(a)
  m(add(a, 3, 64), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_addi_gpr_gpr_imm_64__reg_a0__ruby(*values)
