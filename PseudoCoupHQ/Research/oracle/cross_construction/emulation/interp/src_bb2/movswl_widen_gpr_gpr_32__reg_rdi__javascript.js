...
// one named local per gate, over the term of movswl_widen_gpr_gpr_32__reg_rdi__javascript.
...
function emu_movswl_widen_gpr_gpr_32__reg_rdi__javascript(a) {
    ...
    const w32 = cat(w31, x0_15, 1);
    const w33 = cat(w32, x0_15, 1);
    const w34 = cat(w33, x0_15, 1);
    const w35 = cat(w34, x0_15, 1);
    const w36 = cat(w35, x0_15, 1);
    const w37 = cat(w36, x0_15, 1);
    const w38 = cat(w37, x0_15, 1);
    const w39 = cat(w38, x0_15, 1);
    const w40 = cat(w39, x0_15, 1);
    const w41 = cat(w40, x0_15, 1);
    const w42 = cat(w41, x0_15, 1);
    const w43 = cat(w42, x0_15, 1);
    const w44 = cat(w43, x0_15, 1);
    const w45 = cat(w44, x0_15, 1);
    const w46 = cat(w45, x0_15, 1);
    const w47 = cat(w46, x0_15, 1);
...
for (const line of lines) {
    ...
    try {
        out.push(emu_movswl_widen_gpr_gpr_32__reg_rdi__javascript(...values).toString());
    } catch (problem) {
