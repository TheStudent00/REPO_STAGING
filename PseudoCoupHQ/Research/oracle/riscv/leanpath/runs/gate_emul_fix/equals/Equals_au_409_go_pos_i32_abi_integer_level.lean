...
theorem au_409_go_pos_i32_abi_integer_level (a : BitVec 64) :
    (((((fun (a : BitVec 64) => (a)) (((((a) &&& 0xffffffff#64) ^^^ 0x80000000#64) - 0x80000000#64)))) &&& 0xffffffff#64)) = (((((fun (a : BitVec 64) => ((pure_ZBA_RTYPEUW (a) (zero_reg) (0b00#2)))) (((((a) &&& 0xffffffff#64) ^^^ 0x80000000#64) - 0x80000000#64)))) &&& 0xffffffff#64)) := by
  try simp only [pure_ZBA_RTYPEUW, zero_extend, zero_reg, regtype, zeros, xlenbits, Sail.BitVec.zeroExtend, Sail.BitVec.extractLsb, Sail.shift_bits_left]
  all_goals grind
