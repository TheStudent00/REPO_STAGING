...
// intermediate per node of the term of bltu_gpr_gpr_gpr_64__branch_condition__rust__all_constructed.
//   If(ULE(v0, v1), 0, 1)
#[no_mangle]
pub extern "C" fn emu_bltu_gpr_gpr_gpr_64__branch_condition__rust__all_constructed(a: u64, b: u64) -> u64
{
