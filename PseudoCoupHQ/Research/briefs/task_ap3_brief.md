...
Law: `PRIVATE/PseudoCoupHQ/Research/LAW.md`, ALL of it including the
...
`ap3.conf` (copy from `PUBLIC/Airlock/instances/ap3.conf`; mounts
...
`<runs>/` or `PUBLIC/Airlock/` on either machine — a lane
