...
// InterpRenderer from the layer-4 term of movdqa_xmm_xmm_128__reg_xmm0.low__javascript.
// The term's layer-5 text, LITERAL:
//   Extract(63, 0, v0)
function emu_movdqa_xmm_xmm_128__reg_xmm0.low__javascript(a) {
    return m(a, 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_movdqa_xmm_xmm_128__reg_xmm0.low__javascript(...values).toString());
    } catch (problem) {
