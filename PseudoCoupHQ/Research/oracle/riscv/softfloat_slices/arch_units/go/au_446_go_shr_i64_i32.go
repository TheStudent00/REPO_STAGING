...
func Au_446_go_shr_i64_i32(p0 uint64, p1 uint64) uint64 {
	...
	var v6 uint64 = au_sltu(v5, uint64(0x40)); _ = v6
	var v7 uint64 = au_add(v6, uint64(0xffffffffffffffff)); _ = v7
	var v8 uint64 = au_or(v2, v7); _ = v8
	var v9 uint64 = au_sra(v1, v8); _ = v9
	// the answer is int64, 64 bits
	return v9
}

func Au_446_go_shr_i64_i32_trap(p0 uint64, p1 uint64) uint64 {
	// a0: operand `a` (int64) arrives in a0
	var v1 uint64 = p0; _ = v1
	// a1: operand `b` (int32) sign-extended to XLEN, as the ABI presents it
	var v2 uint64 = au_sext32(p1); _ = v2
