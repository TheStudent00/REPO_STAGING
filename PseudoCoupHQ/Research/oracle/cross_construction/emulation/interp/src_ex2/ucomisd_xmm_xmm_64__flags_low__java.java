...
public class Emu {
    ...
    // InterpRenderer from the layer-4 term of ucomisd_xmm_xmm_64__flags_low__java.
    // The term's layer-5 text, LITERAL:
    //   fp.to_ieee_bv(fpToFP(Extract(63, 0, v0)))
    static long emu_ucomisd_xmm_xmm_64__flags_low__java(long a) {
        return m(a, 64);
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_ucomisd_xmm_xmm_64__flags_low__java(values[0])));
                    answers.append("\n");
