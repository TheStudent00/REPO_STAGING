...
# InterpRenderer from the layer-4 term of divu_gpr_gpr_gpr_64__reg_a0__cpython.
# The term's layer-5 text, LITERAL:
#   If(v0 == 0, 18446744073709551615, bvudiv_i(v1, v0))
def emu_divu_gpr_gpr_gpr_64__reg_a0__cpython(a, b):
    return m(((18446744073709551615) if (eq(a, 0, 64)) else (udiv(b, a, 64))), 64)
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_divu_gpr_gpr_gpr_64__reg_a0__cpython(*values)
            sys.stdout.write("%d\n" % answer)
