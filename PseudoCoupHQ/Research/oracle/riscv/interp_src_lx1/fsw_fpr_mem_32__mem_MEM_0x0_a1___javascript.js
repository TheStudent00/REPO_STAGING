...
// InterpRenderer from the layer-4 term of fsw_fpr_mem_32__mem_MEM_0x0_a1___javascript.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(63, 32, v0), Extract(31, 0, v1))
function emu_fsw_fpr_mem_32__mem_MEM_0x0_a1___javascript(a, b) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_fsw_fpr_mem_32__mem_MEM_0x0_a1___javascript(...values).toString());
    } catch (problem) {
