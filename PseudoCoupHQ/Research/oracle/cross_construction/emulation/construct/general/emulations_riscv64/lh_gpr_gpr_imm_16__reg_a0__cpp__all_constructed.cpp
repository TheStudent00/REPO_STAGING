/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of lh_gpr_gpr_imm_16__reg_a0__cpp__all_constructed.  The term's text, LITERAL:
...
extern "C"
uint64_t
emu_lh_gpr_gpr_imm_16__reg_a0__cpp__all_constructed(uint16_t a)
{
