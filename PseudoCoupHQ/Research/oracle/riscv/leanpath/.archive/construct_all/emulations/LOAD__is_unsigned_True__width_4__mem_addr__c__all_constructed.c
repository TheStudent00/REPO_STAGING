/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of LOAD__is_unsigned_True__width_4__mem_addr__c__all_constructed.  The term's text, LITERAL:
    */
#include <stdint.h>

uint64_t
emu_LOAD__is_unsigned_True__width_4__mem_addr__c__all_constructed(uint64_t a, uint16_t b)
{
