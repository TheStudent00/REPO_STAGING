...
// intermediate per node of the term of lbu_gpr_gpr_same_8__reg_a0__rust__bit_blast.
//   Concat(0, Extract(7, 0, v0))
#[no_mangle]
pub extern "C" fn emu_lbu_gpr_gpr_same_8__reg_a0__rust__bit_blast(a: u8) -> u64
{
