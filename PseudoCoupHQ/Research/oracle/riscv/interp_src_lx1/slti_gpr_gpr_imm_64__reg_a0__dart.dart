...
// InterpRenderer from the layer-4 term of slti_gpr_gpr_imm_64__reg_a0__dart.
// The term's layer-5 text, LITERAL:
//   If(3 <= v0, 0, 1)
int emu_slti_gpr_gpr_imm_64__reg_a0__dart(int a) {
  return m(((sle(3, a, 64)) ? (0) : (1)), 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_slti_gpr_gpr_imm_64__reg_a0__dart(values[0]);
