---
id: hq.research.lean_proof_path_resistant_to_churn.lean_expr.primitives.check
---

# CHECK — 0_3_3_2_4_primitives

Node `hq.research.lean_proof_path_resistant_to_churn.lean_expr.primitives`. Status `draft`.
