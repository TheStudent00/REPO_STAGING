---
id: hq.research.lean_proof_path_resistant_to_churn.arch_unit.check
---

# CHECK — 0_3_3_3_arch_unit

Node `hq.research.lean_proof_path_resistant_to_churn.arch_unit`. Status `draft`.
