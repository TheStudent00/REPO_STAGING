...
/-- rust single-opcode row 19, arch mnemonic 'neg', example unit rust/op_0, 3 members
...
theorem ModelCheck_rust_19 (v0 : BitVec 64) :
    ((v0.extractLsb 31 0) * (4294967295#32))
  = ((model_neg_14 (model_mov_18 v0)).extractLsb 31 0) := by
  simp only [model_mov_18, model_neg_14]
  bv_decide

#print axioms ModelCheck_rust_19
