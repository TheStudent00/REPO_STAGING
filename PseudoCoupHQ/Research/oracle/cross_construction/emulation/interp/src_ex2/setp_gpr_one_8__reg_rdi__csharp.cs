...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of setp_gpr_one_8__reg_rdi__csharp.
    ...
    public static long emu_setp_gpr_one_8__reg_rdi__csharp(long a, long b) {
        return m(cat(0L, ((eq(ext(add(mul(b, 255L, 8), a, 8), 1, 1), ((eq(ext(add(mul(b, 255L, 8), a, 8), 2, 2), ((eq(ext(add(mul(b, 255L, 8), a, 8), 3, 3), ((eq(ext(add(mul(b, 255L, 8), a, 8), 4, 4), ((eq(ext(add(mul(b, 255L, 8), a, 8), 5, 5), ((eq(ext(add(mul(b, 255L, 8), a, 8), 6, 6), ((eq(ext(add(mul(b, 255L, 8), a, 8), 7, 7), ((eq(add(ext(a, 0, 0), 1L, 1), ext(b, 0, 0), 1)) ? (1L) : (0L)), 1)) ? (1L) : (0L)), 1)) ? (1L) : (0L)), 1)) ? (1L) : (0L)), 1)) ? (1L) : (0L)), 1)) ? (1L) : (0L)), 1)) ? (1L) : (0L)), 1)) ? (1L) : (0L)), 8), 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_setp_gpr_one_8__reg_rdi__csharp(values[0], values[1])).ToString());
                    answers.Append("\n");
