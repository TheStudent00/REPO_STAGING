...
# InterpRenderer from the layer-4 term of ucomisd_mem_xmm_64__flags_low__ruby.
# The term's layer-5 text, LITERAL:
#   fp.to_ieee_bv(fpToFP(v0))
def emu_ucomisd_mem_xmm_64__flags_low__ruby(a)
  m(a, 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_ucomisd_mem_xmm_64__flags_low__ruby(*values)
