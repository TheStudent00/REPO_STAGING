/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of addw_gpr_gpr_gpr_32__reg_a0__cpp__all_constructed.  The term's text, LITERAL:
...
extern "C"
uint64_t
emu_addw_gpr_gpr_gpr_32__reg_a0__cpp__all_constructed(uint32_t a, uint32_t b)
{
