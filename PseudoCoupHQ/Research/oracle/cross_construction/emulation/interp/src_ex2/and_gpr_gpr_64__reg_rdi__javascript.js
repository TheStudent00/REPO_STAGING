...
// InterpRenderer from the layer-4 term of and_gpr_gpr_64__reg_rdi__javascript.
// The term's layer-5 text, LITERAL:
//   ~(~v0 | ~v1)
function emu_and_gpr_gpr_64__reg_rdi__javascript(a, b) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_and_gpr_gpr_64__reg_rdi__javascript(...values).toString());
    } catch (problem) {
