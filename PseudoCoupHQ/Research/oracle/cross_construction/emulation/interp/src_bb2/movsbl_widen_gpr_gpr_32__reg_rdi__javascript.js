...
// one named local per gate, over the term of movsbl_widen_gpr_gpr_32__reg_rdi__javascript.
...
function emu_movsbl_widen_gpr_gpr_32__reg_rdi__javascript(a) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_movsbl_widen_gpr_gpr_32__reg_rdi__javascript(...values).toString());
    } catch (problem) {
