---
id: hq.research.arch_unit_oracle.cross_construction.length_two.check
---

# CHECK — 0_3_2_2_1_length_two

Node `hq.research.arch_unit_oracle.cross_construction.length_two`. Status `draft`.
