...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of andi_gpr_gpr_imm_64__reg_a0__csharp.
    // The term's layer-5 text, LITERAL:
    //   Concat(0, Extract(1, 0, v0))
    public static long emu_andi_gpr_gpr_imm_64__reg_a0__csharp(long a) {
        return m(cat(0L, ext(a, 1, 0), 2), 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_andi_gpr_gpr_imm_64__reg_a0__csharp(values[0])).ToString());
                    answers.Append("\n");
