...
// intermediate per node of the term of punpckldq_mem_xmm_128__reg_xmm0_low__go__bit_blast.
...
//go:noinline
func emu_punpckldq_mem_xmm_128__reg_xmm0_low__go__bit_blast(a uint32, b float32) float64 {
...
func main() {
	sink = emu_punpckldq_mem_xmm_128__reg_xmm0_low__go__bit_blast(g0, g1)
	_ = sink
}
