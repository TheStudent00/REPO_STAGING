/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of ZBKB_RTYPE__op_PACKH__rd__c__all_constructed.  The term's text, LITERAL:
    */
#include <stdint.h>

uint64_t
emu_ZBKB_RTYPE__op_PACKH__rd__c__all_constructed(uint8_t a, uint8_t b)
{
