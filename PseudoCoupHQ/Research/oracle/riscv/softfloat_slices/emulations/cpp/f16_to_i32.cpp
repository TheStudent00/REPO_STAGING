...
uint32_t f16_to_i32_rm1(uint64_t v_arg)
{
    ...
    const bool v__n11 = (v_i17 != true);
    const bool v__n12 = (v_i14 != true);
    ...
    const uint32_t v__m42 = (uint32_t)((v_i7) ? ~(uint32_t)0 : (uint32_t)0);
    const uint32_t v__a43 = (uint32_t)(v_i11 & v__m42);
    const bool v__c44 = (v__n26 && v_i17);
    const uint32_t v__m46 = (uint32_t)((v__c44) ? ~(uint32_t)0 : (uint32_t)0);
    const uint32_t v__a47 = (uint32_t)(v_i23 & v__m46);
    ...
    const uint32_t v__m53 = (uint32_t)((v__n11) ? ~(uint32_t)0 : (uint32_t)0);
    ...
    const uint32_t v_spec_select = (uint32_t)(v__a39 | v__a41);
    const uint32_t v__a54 = (uint32_t)(v_spec_select & v__m53);
    const uint32_t v__o55 = (uint32_t)(v__o48 | v__a54);
    return v__o55;
}
