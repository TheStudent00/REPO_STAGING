---
id: hq.research.arch_unit_oracle.cross_construction.check
---

# CHECK — 0_3_2_2_cross_construction

Node `hq.research.arch_unit_oracle.cross_construction`. Status `draft`.
