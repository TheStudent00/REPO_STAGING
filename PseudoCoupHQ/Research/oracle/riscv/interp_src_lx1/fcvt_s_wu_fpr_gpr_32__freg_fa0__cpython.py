...
# InterpRenderer from the layer-4 term of fcvt_s_wu_fpr_gpr_32__freg_fa0__cpython.
# The term's layer-5 text, LITERAL:
#   Concat(4294967295, fp.to_ieee_bv(fpToFPUnsigned(RNE(), Extract(31, 0, v0))))
def emu_fcvt_s_wu_fpr_gpr_32__freg_fa0__cpython(a):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_fcvt_s_wu_fpr_gpr_32__freg_fa0__cpython(*values)
            sys.stdout.write("%d\n" % answer)
