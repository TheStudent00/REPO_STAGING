...
public class Emu {
    ...
    // one named local per gate, over the term of test_imm_gpr_64__flags_low__java.
    // The term's layer-5 text, LITERAL:
    //   0
    static long emu_test_imm_gpr_64__flags_low__java() {
        long k0 = 0L;
        long w0 = k0;
        long w1 = cat(w0, k0, 1);
        long w2 = cat(w1, k0, 1);
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_test_imm_gpr_64__flags_low__java()));
                    answers.append("\n");
