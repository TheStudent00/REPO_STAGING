...
// InterpRenderer from the layer-4 term of jalr_gpr_fpr_fpr_64__reg_a0__javascript.
// The term's layer-5 text, LITERAL:
//   v0 + 4
function emu_jalr_gpr_fpr_fpr_64__reg_a0__javascript(a) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_jalr_gpr_fpr_fpr_64__reg_a0__javascript(...values).toString());
    } catch (problem) {
