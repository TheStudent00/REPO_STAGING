...
// InterpRenderer from the layer-4 term of addi_gpr_gpr_imm_64__reg_a0__javascript.
// The term's layer-5 text, LITERAL:
//   v0 + 3
function emu_addi_gpr_gpr_imm_64__reg_a0__javascript(a) {
    return m(add(a, 3n, 64), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_addi_gpr_gpr_imm_64__reg_a0__javascript(...values).toString());
    } catch (problem) {
