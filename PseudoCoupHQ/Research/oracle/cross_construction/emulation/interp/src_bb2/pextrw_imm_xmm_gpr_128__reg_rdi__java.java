...
public class Emu {
    ...
    // one named local per gate, over the term of pextrw_imm_xmm_gpr_128__reg_rdi__java.
    // The term's layer-5 text, LITERAL:
    //   Concat(0, Extract(31, 16, v0))
    static long emu_pextrw_imm_xmm_gpr_128__reg_rdi__java(long a) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_pextrw_imm_xmm_gpr_128__reg_rdi__java(values[0])));
                    answers.append("\n");
