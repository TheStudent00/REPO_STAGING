...
// one named local per gate, over the term of cmovge_gpr_gpr_32__reg_rdi__php.
...
function emu_cmovge_gpr_gpr_32__reg_rdi__php($a, $b, $c, $d) {
    $x3_0 = ex_ext($d, 0, 0);
    ...
    $w30 = ex_cat($w29, $k0, 1);
    $w31 = ex_cat($w30, $k0, 1);
    $w32 = ex_cat($w31, $g515, 1);
    $w33 = ex_cat($w32, $g512, 1);
    $w34 = ex_cat($w33, $g509, 1);
    $w35 = ex_cat($w34, $g506, 1);
    $w36 = ex_cat($w35, $g503, 1);
    $w37 = ex_cat($w36, $g500, 1);
    $w38 = ex_cat($w37, $g497, 1);
    $w39 = ex_cat($w38, $g494, 1);
    $w40 = ex_cat($w39, $g491, 1);
    $w41 = ex_cat($w40, $g488, 1);
    $w42 = ex_cat($w41, $g485, 1);
    $w43 = ex_cat($w42, $g482, 1);
    $w44 = ex_cat($w43, $g479, 1);
    $w45 = ex_cat($w44, $g476, 1);
    $w46 = ex_cat($w45, $g473, 1);
    $w47 = ex_cat($w46, $g470, 1);
    $w48 = ex_cat($w47, $g467, 1);
    $w49 = ex_cat($w48, $g464, 1);
    $w50 = ex_cat($w49, $g461, 1);
    $w51 = ex_cat($w50, $g458, 1);
    $w52 = ex_cat($w51, $g455, 1);
    $w53 = ex_cat($w52, $g452, 1);
    $w54 = ex_cat($w53, $g449, 1);
    $w55 = ex_cat($w54, $g446, 1);
    $w56 = ex_cat($w55, $g443, 1);
    $w57 = ex_cat($w56, $g440, 1);
    $w58 = ex_cat($w57, $g437, 1);
    $w59 = ex_cat($w58, $g434, 1);
    $w60 = ex_cat($w59, $g431, 1);
    $w61 = ex_cat($w60, $g428, 1);
    $w62 = ex_cat($w61, $g425, 1);
    $w63 = ex_cat($w62, $g422, 1);
    return ex_m($w63, 64);
}
...
while (($line = fgets($handle)) !== false) {
    ...
    try {
        $answer = emu_cmovge_gpr_gpr_32__reg_rdi__php(...$ints);
        if ($answer < 0) {
            echo sprintf("%s\n", sprintf("%u", $answer));
        } else {
            echo $answer . "\n";
