...
public class Emu {
    ...
    // one named local per gate, over the term of sar_imm_gpr_64__reg_rdi__java.
    // The term's layer-5 text, LITERAL:
    //   v0 >> 3
    static long emu_sar_imm_gpr_64__reg_rdi__java(long a) {
        long x0_3 = ext(a, 3, 3);
        long x0_4 = ext(a, 4, 4);
        long x0_5 = ext(a, 5, 5);
        long x0_6 = ext(a, 6, 6);
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_sar_imm_gpr_64__reg_rdi__java(values[0])));
                    answers.append("\n");
