...
// InterpRenderer from the layer-4 term of idiv_gpr_one_32__reg_rax__dart.
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_idiv_gpr_one_32__reg_rax__dart(values[0], values[1], values[2]);
