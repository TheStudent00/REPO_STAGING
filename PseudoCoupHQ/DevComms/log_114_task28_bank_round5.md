...
`PRIVATE/PseudoCoupHQ/AgentMemory.md` in full;
`PRIVATE/DevComms/LLM_communication_protocol.md` -- **named
...
```
$ ls PRIVATE/DevComms/ | grep -i protocol
...
- `PRIVATE/PseudoCoupHQ/DevComms/log_114_task28_bank_round5.md`
  -- this report.
...
```
$ cd PRIVATE/PseudoCoupHQ && git status --short
