...
// intermediate per node of the term of movq_gpr_xmm_64__reg_xmm0__go__bit_blast.
//   v0
package main
...
//go:noinline
func emu_movq_gpr_xmm_64__reg_xmm0__go__bit_blast(a uint64) float64 {
...
func main() {
	sink = emu_movq_gpr_xmm_64__reg_xmm0__go__bit_blast(g0)
	_ = sink
}
