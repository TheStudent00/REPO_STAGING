...
# InterpRenderer from the layer-4 term of andi_gpr_gpr_imm_64__reg_a0__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(0, Extract(1, 0, v0))
def emu_andi_gpr_gpr_imm_64__reg_a0__ruby(a)
  m(cat(0, ext(a, 1, 0), 2), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_andi_gpr_gpr_imm_64__reg_a0__ruby(*values)
