...
theorem meaning_ZBS_RTYPE__op_BCLR__rd__c__all_constructed (s : St) (a : BitVec 64) (b : BitVec 64) (d : BitVec 64) (h10 : s.regs.get? .x10 = some a) (h11 : s.regs.get? .x11 = some b) (h13 : s.regs.get? .x13 = some d) (hk0 : ∀ {α : Type} (x0 : α) (s : St), (plat_term_write x0) s = EStateM.Result.ok () s) (hk1 : ∀ (x0 : Arch.pa) (x1 : Nat) (s : St), (load_reservation x0 x1) s = EStateM.Result.ok () s) (hk2 : ∀ (x0 : Unit) (s : St), (cancel_reservation x0) s = EStateM.Result.ok () s) :
    runsTo (walk [LeanIM.instruction.ITYPE (0x001#12, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0c#5, LeanIM.iop.ANDI), LeanIM.instruction.ITYPE (0x002#12, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0d#5, LeanIM.iop.ANDI), LeanIM.instruction.C_ADDI (0x01#6, LeanIM.regidx.Regidx 0x0c#5), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0d#5, LeanIM.regidx.Regidx 0x0c#5, LeanIM.regidx.Regidx 0x0c#5, LeanIM.rop.SLL), LeanIM.instruction.ITYPE (0x004#12, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0d#5, LeanIM.iop.ANDI), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0d#5, LeanIM.regidx.Regidx 0x0c#5, LeanIM.regidx.Regidx 0x0c#5, LeanIM.rop.SLL), LeanIM.instruction.ITYPE (0x008#12, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0d#5, LeanIM.iop.ANDI), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0d#5, LeanIM.regidx.Regidx 0x0c#5, LeanIM.regidx.Regidx 0x0c#5, LeanIM.rop.SLL), LeanIM.instruction.ITYPE (0x010#12, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0d#5, LeanIM.iop.ANDI), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0d#5, LeanIM.regidx.Regidx 0x0c#5, LeanIM.regidx.Regidx 0x0c#5, LeanIM.rop.SLL), LeanIM.instruction.ITYPE (0x020#12, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.iop.ANDI), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0c#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.rop.SLL), LeanIM.instruction.ZBB_RTYPE (LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.brop_zbb.ANDN)]) s
      ((pure_ZBB_RTYPE (b) ((pure_RTYPE ((pure_RTYPE ((pure_RTYPE ((pure_RTYPE ((pure_RTYPE ((pure_ITYPE ((pure_ITYPE (a) (0x001#12) (LeanIM.iop.ANDI))) (((sign_extend (m := 12) (0x01#6)))) (ADDI))) ((pure_ITYPE (a) (0x002#12) (LeanIM.iop.ANDI))) (LeanIM.rop.SLL))) ((pure_ITYPE (a) (0x004#12) (LeanIM.iop.ANDI))) (LeanIM.rop.SLL))) ((pure_ITYPE (a) (0x008#12) (LeanIM.iop.ANDI))) (LeanIM.rop.SLL))) ((pure_ITYPE (a) (0x010#12) (LeanIM.iop.ANDI))) (LeanIM.rop.SLL))) ((pure_ITYPE (a) (0x020#12) (LeanIM.iop.ANDI))) (LeanIM.rop.SLL))) (LeanIM.brop_zbb.ANDN))) := by
  simp (config := {decide := true}) [runsTo, walk, step, execute, strip_C_ADDI, strip_ITYPE, strip_RTYPE, strip_ZBB_RTYPE, alias_C_ADDI,
