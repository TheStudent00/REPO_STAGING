...
// InterpRenderer from the layer-4 term of slliw_gpr_gpr_imm_32__reg_a0__php.
...
function emu_slliw_gpr_gpr_imm_32__reg_a0__php($a) {
    return ex_m(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_ext($a, 28, 28), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 28), 1), ex_ext($a, 28, 0), 29), 0, 3), 64);
}
...
while (($line = fgets($handle)) !== false) {
    ...
    try {
        $answer = emu_slliw_gpr_gpr_imm_32__reg_a0__php(...$ints);
        if ($answer < 0) {
            echo sprintf("%s\n", sprintf("%u", $answer));
        } else {
            echo $answer . "\n";
