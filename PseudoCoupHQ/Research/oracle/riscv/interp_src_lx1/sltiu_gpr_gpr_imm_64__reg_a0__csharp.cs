...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of sltiu_gpr_gpr_imm_64__reg_a0__csharp.
    // The term's layer-5 text, LITERAL:
    //   If(Or(Extract(1, 0, v0) == 3, Not(Extract(63, 2, v0) == 0)), 0, 1)
    public static long emu_sltiu_gpr_gpr_imm_64__reg_a0__csharp(long a) {
        return m(((((eq(ext(a, 1, 0), 3L, 2)) || ((!(eq(ext(a, 63, 2), 0L, 62)))))) ? (0L) : (1L)), 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_sltiu_gpr_gpr_imm_64__reg_a0__csharp(values[0])).ToString());
                    answers.Append("\n");
