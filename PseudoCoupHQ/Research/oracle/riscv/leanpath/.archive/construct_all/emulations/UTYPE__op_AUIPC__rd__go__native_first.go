...
// intermediate per node of the term of UTYPE__op_AUIPC__rd__go__native_first.
//   
package main

//go:noinline
func emu_UTYPE__op_AUIPC__rd__go__native_first(a uint64, b uint32) uint64 {
...
func main() {
	sink = emu_UTYPE__op_AUIPC__rd__go__native_first(g0, g1)
	_ = sink
}
