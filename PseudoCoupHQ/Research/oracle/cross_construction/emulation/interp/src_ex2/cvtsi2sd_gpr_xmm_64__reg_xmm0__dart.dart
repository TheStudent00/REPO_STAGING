...
// InterpRenderer from the layer-4 term of cvtsi2sd_gpr_xmm_64__reg_xmm0__dart.
// The term's layer-5 text, LITERAL:
//   fp.to_ieee_bv(fpToFP(RNE(), v0))
int emu_cvtsi2sd_gpr_xmm_64__reg_xmm0__dart(int a) {
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_cvtsi2sd_gpr_xmm_64__reg_xmm0__dart(values[0]);
