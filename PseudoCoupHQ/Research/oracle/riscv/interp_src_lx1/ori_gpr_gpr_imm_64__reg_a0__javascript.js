...
// InterpRenderer from the layer-4 term of ori_gpr_gpr_imm_64__reg_a0__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(63, 2, v0), 3)
function emu_ori_gpr_gpr_imm_64__reg_a0__javascript(a) {
    return m(cat(ext(a, 63, 2), 3n, 2), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_ori_gpr_gpr_imm_64__reg_a0__javascript(...values).toString());
    } catch (problem) {
