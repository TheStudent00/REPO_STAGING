...
// intermediate per node of the term of srai_gpr_gpr_imm_64__reg_a0__go__bit_blast.
//   v0 >> 3
package main

//go:noinline
func emu_srai_gpr_gpr_imm_64__reg_a0__go__bit_blast(a uint64) uint64 {
...
func main() {
	sink = emu_srai_gpr_gpr_imm_64__reg_a0__go__bit_blast(g0)
	_ = sink
}
