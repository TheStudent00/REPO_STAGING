/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of rust_0__rust_op_562.  The term's layer-5 text, LITERAL:
...
double
emu_rust_0__rust_op_562(double a, double b)
{
