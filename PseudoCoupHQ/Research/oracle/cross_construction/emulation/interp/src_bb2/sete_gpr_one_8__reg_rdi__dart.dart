...
// one named local per gate, over the term of sete_gpr_one_8__reg_rdi__dart.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(63, 8, v0), If(Extract(7, 0, v1) == Extract(7, 0, v2), 1, 0))
int emu_sete_gpr_one_8__reg_rdi__dart(int a, int b, int c) {
  int x1_7 = ext(b, 7, 7);
  int x2_7 = ext(a, 7, 7);
  int x1_6 = ext(b, 6, 6);
  int x2_6 = ext(a, 6, 6);
  ...
  int x0_8 = ext(c, 8, 8);
  int x0_9 = ext(c, 9, 9);
  int x0_10 = ext(c, 10, 10);
  int x0_11 = ext(c, 11, 11);
  int x0_12 = ext(c, 12, 12);
  int x0_13 = ext(c, 13, 13);
  int x0_14 = ext(c, 14, 14);
  int x0_15 = ext(c, 15, 15);
  int x0_16 = ext(c, 16, 16);
  int x0_17 = ext(c, 17, 17);
  int x0_18 = ext(c, 18, 18);
  int x0_19 = ext(c, 19, 19);
  int x0_20 = ext(c, 20, 20);
  int x0_21 = ext(c, 21, 21);
  int x0_22 = ext(c, 22, 22);
  int x0_23 = ext(c, 23, 23);
  int x0_24 = ext(c, 24, 24);
  int x0_25 = ext(c, 25, 25);
  int x0_26 = ext(c, 26, 26);
  int x0_27 = ext(c, 27, 27);
  int x0_28 = ext(c, 28, 28);
  int x0_29 = ext(c, 29, 29);
  int x0_30 = ext(c, 30, 30);
  int x0_31 = ext(c, 31, 31);
  int x0_32 = ext(c, 32, 32);
  int x0_33 = ext(c, 33, 33);
  int x0_34 = ext(c, 34, 34);
  int x0_35 = ext(c, 35, 35);
  int x0_36 = ext(c, 36, 36);
  int x0_37 = ext(c, 37, 37);
  int x0_38 = ext(c, 38, 38);
  int x0_39 = ext(c, 39, 39);
  int x0_40 = ext(c, 40, 40);
  int x0_41 = ext(c, 41, 41);
  int x0_42 = ext(c, 42, 42);
  int x0_43 = ext(c, 43, 43);
  int x0_44 = ext(c, 44, 44);
  int x0_45 = ext(c, 45, 45);
  int x0_46 = ext(c, 46, 46);
  int x0_47 = ext(c, 47, 47);
  int x0_48 = ext(c, 48, 48);
  int x0_49 = ext(c, 49, 49);
  int x0_50 = ext(c, 50, 50);
  int x0_51 = ext(c, 51, 51);
  int x0_52 = ext(c, 52, 52);
  int x0_53 = ext(c, 53, 53);
  int x0_54 = ext(c, 54, 54);
  int x0_55 = ext(c, 55, 55);
  int x0_56 = ext(c, 56, 56);
  int x0_57 = ext(c, 57, 57);
  int x0_58 = ext(c, 58, 58);
  int x0_59 = ext(c, 59, 59);
  int x0_60 = ext(c, 60, 60);
  int x0_61 = ext(c, 61, 61);
  int x0_62 = ext(c, 62, 62);
  int x0_63 = ext(c, 63, 63);
  int g0 = (x2_7 ^ 1);
  int g1 = (g0 | x1_7);
  int g2 = (x1_7 ^ 1);
  int g3 = (x2_7 | g2);
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_sete_gpr_one_8__reg_rdi__dart(values[0], values[1], values[2]);
