...
**Done. `PRIVATE/PseudoCoup_v5/` went from 550 MB to 55 MB.**
...
`PRIVATE/PseudoCoup_v5/` is 550 MB on disk. Its `.git` is 54 MB.
...
`PRIVATE/PseudoCoup_v6/AgentMemory/02_decisions.md`, PCv6
