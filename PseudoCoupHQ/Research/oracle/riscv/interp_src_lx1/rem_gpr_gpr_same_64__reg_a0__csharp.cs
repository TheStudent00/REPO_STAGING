...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of rem_gpr_gpr_same_64__reg_a0__csharp.
    // The term's layer-5 text, LITERAL:
    //   If(v0 == 0, v0, If(And(v0 == 18446744073709551615, v0 == 9223372036854775808), 0, bvsrem_i(v0, v0)))
    public static long emu_rem_gpr_gpr_same_64__reg_a0__csharp(long a) {
        return m(((eq(a, 0L, 64)) ? (a) : (((((eq(a, -1L, 64)) && (eq(a, -9223372036854775808L, 64)))) ? (0L) : (srem(a, a, 64))))), 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_rem_gpr_gpr_same_64__reg_a0__csharp(values[0])).ToString());
                    answers.Append("\n");
