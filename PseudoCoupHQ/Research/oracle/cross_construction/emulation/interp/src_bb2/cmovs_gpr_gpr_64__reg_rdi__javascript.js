...
// one named local per gate, over the term of cmovs_gpr_gpr_64__reg_rdi__javascript.
// The term's layer-5 text, LITERAL:
//   If(Or(Extract(63, 63, v0) == 0, Extract(63, 63, v1) == 0), v2, v3)
function emu_cmovs_gpr_gpr_64__reg_rdi__javascript(a, b, c, d) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_cmovs_gpr_gpr_64__reg_rdi__javascript(...values).toString());
    } catch (problem) {
