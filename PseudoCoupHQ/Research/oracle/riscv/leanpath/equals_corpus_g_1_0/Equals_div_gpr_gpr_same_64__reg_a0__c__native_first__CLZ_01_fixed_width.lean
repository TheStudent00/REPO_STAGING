...
theorem div_gpr_gpr_same_64__reg_a0__c__native_first__CLZ_01_fixed_width (a : BitVec 64) :
  ...
  try simp only [pure_RTYPE, pure_ITYPE, pure_CLZ, bool_to_bit, log2_xlen, shift_bits_right_arith, sign_extend, to_bits, xlenbits, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend]
  bv_decide
