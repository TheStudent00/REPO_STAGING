/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of JAL__one__pc__cpp__all_constructed.  The term's text, LITERAL:
    */
#include <cstdint>

extern "C"
uint64_t
emu_JAL__one__pc__cpp__all_constructed(uint64_t a, uint32_t b)
{
    uint32_t v0 = ((uint32_t)((uint32_t)b >> 0) & UINT32_C(0x1fffff));
    uint32_t v1 = ((uint32_t)((uint32_t)b >> 20) & UINT32_C(0x1));
    uint32_t v2 = v0;
    uint32_t v3 = v1;
    ...
    uint64_t v46 = (uint64_t)(((uint64_t)(v45) << 21) | (uint64_t)(v2));
    uint64_t v47 = (uint64_t)((uint64_t)(v46) & (uint64_t)((uint64_t)a));
    uint64_t v48 = (uint64_t)((uint64_t)(v47) << (unsigned)(uint64_t)(UINT64_C(0x1)));
    uint64_t v49 = (uint64_t)((uint64_t)(v46) ^ (uint64_t)((uint64_t)a));
    uint64_t v50 = (uint64_t)((uint64_t)(v49) & (uint64_t)(v48));
    uint64_t v51 = (uint64_t)((uint64_t)(v47) | (uint64_t)(v50));
    uint64_t v52 = (uint64_t)((uint64_t)(v51) << (unsigned)(uint64_t)(UINT64_C(0x2)));
    uint64_t v53 = (uint64_t)((uint64_t)(v49) << (unsigned)(uint64_t)(UINT64_C(0x1)));
    uint64_t v54 = (uint64_t)((uint64_t)(v49) & (uint64_t)(v53));
    uint64_t v55 = (uint64_t)((uint64_t)(v54) & (uint64_t)(v52));
    uint64_t v56 = (uint64_t)((uint64_t)(v51) | (uint64_t)(v55));
    uint64_t v57 = (uint64_t)((uint64_t)(v56) << (unsigned)(uint64_t)(UINT64_C(0x4)));
    uint64_t v58 = (uint64_t)((uint64_t)(v54) << (unsigned)(uint64_t)(UINT64_C(0x2)));
    uint64_t v59 = (uint64_t)((uint64_t)(v54) & (uint64_t)(v58));
    uint64_t v60 = (uint64_t)((uint64_t)(v59) & (uint64_t)(v57));
    uint64_t v61 = (uint64_t)((uint64_t)(v56) | (uint64_t)(v60));
    uint64_t v62 = (uint64_t)((uint64_t)(v61) << (unsigned)(uint64_t)(UINT64_C(0x8)));
    uint64_t v63 = (uint64_t)((uint64_t)(v59) << (unsigned)(uint64_t)(UINT64_C(0x4)));
    ...
    uint64_t v67 = (uint64_t)((uint64_t)(v66) << (unsigned)(uint64_t)(UINT64_C(0x10)));
    uint64_t v68 = (uint64_t)((uint64_t)(v64) << (unsigned)(uint64_t)(UINT64_C(0x8)));
    ...
    uint64_t v72 = (uint64_t)((uint64_t)(v71) << (unsigned)(uint64_t)(UINT64_C(0x20)));
    uint64_t v73 = (uint64_t)((uint64_t)(v69) << (unsigned)(uint64_t)(UINT64_C(0x10)));
    ...
    uint64_t v77 = (uint64_t)((uint64_t)(v76) << (unsigned)(uint64_t)(UINT64_C(0x1)));
    uint64_t v78 = (uint64_t)((uint64_t)(v49) ^ (uint64_t)(v77));
    return (uint64_t)(v78);
}
