// arch-unit 152  --  go  `&a`  lhs=float32 rhs=None
// symbol main.op_33   outcome LIFTED
//
// the arch-unit, arch-opcode by arch-opcode:
//   ld t1, 0x10(s11)                   integer  address/stack/runtime -- not a bit function
//   bltu t1, sp, 0x6c6d8 <main.op_33+0x18> integer  address/stack/runtime -- not a bit function
//   fsw fa0, 0x8(sp)                   float    bit-manipulation
//   jal t0, 0x6a730 <runtime.morestack_noctxt.abi0> integer  address/stack/runtime -- not a bit function
//   flw fa0, 0x8(sp)                   float    bit-manipulation
//   jal zero, 0x6c6c0 <main.op_33>     integer  address/stack/runtime -- not a bit function
...
//   fsw fa0, 0x28(sp)                  float    bit-manipulation
//   auipc a0, 0xa                      integer  address/stack/runtime -- not a bit function
//   addi a0, a0, -0x304                integer  address/stack/runtime -- not a bit function
//   jal ra, 0x23b60 <runtime.newobject> integer  address/stack/runtime -- not a bit function
//   c.lwsp t0, 0x28(sp)                integer  address/stack/runtime -- not a bit function
//   sw t0, 0x0(a0)                     integer  address/stack/runtime -- not a bit function
...
public final class au_152_go_addr_f32 {
    public static long au_152_go_addr_f32(long p0) {
        return ((p0) & 0xffffffffL);
    }
}
