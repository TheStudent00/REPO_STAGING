...
// InterpRenderer from the layer-4 term of fsw_fpr_gpr_32__mem_MEM_a1__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(63, 32, v0), Extract(31, 0, v1))
function emu_fsw_fpr_gpr_32__mem_MEM_a1__javascript(a, b) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_fsw_fpr_gpr_32__mem_MEM_a1__javascript(...values).toString());
    } catch (problem) {
