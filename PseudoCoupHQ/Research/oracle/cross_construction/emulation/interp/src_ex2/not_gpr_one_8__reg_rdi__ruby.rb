...
# InterpRenderer from the layer-4 term of not_gpr_one_8__reg_rdi__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(0, ~Extract(7, 0, v0))
def emu_not_gpr_one_8__reg_rdi__ruby(a)
  m(cat(0, bnot(a, 8), 8), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_not_gpr_one_8__reg_rdi__ruby(*values)
