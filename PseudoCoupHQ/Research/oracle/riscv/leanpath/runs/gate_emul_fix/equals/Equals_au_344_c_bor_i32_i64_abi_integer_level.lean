...
theorem au_344_c_bor_i32_i64_abi_integer_level (a : BitVec 64) (b : BitVec 64) :
    (((fun (a : BitVec 64) (b : BitVec 64) => ((pure_RTYPE (a) (b) (OR)))) (((((a) &&& 0xffffffff#64) ^^^ 0x80000000#64) - 0x80000000#64)) (b))) = (((fun (a : BitVec 64) (b : BitVec 64) => ((pure_RTYPE ((pure_ADDIW (a) ((sign_extend (m := 12) (0x00#6))))) (b) (OR)))) (((((a) &&& 0xffffffff#64) ^^^ 0x80000000#64) - 0x80000000#64)) (b))) := by
  try simp only [pure_ADDIW, pure_RTYPE, bool_to_bit, log2_xlen, shift_bits_right_arith, sign_extend, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend, Sail.BitVec.extractLsb, Sail.shift_bits_left, Sail.shift_bits_right]
  all_goals grind
