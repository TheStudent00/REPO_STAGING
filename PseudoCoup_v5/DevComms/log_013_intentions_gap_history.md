...
`PRIVATE/PseudoCoup_v5/DevComms/log_011_uncertain_families_evidence.md`
...
`PRIVATE/PseudoCoup_v5/Designing/` folder (four commits, all nine
files reconstructed and grepped); the git history of
`PRIVATE/PseudoIR/Tools/intentions` (three commits);
`PRIVATE/PseudoCoup_v5/DevComms/language_divergence_study_log.md`,
`dev_plan_log.md`, `open_issues.md`, `project_state.md`, `log_008`;
`PRIVATE/PseudoCoup_v6/Research/r1_intentions_validation/REPORT.md`;
...
`PRIVATE/PseudoIR/Tools/intentions/intentions_data.py`, lines
...
(`PRIVATE/PseudoIR/Tools/intentions/README.md`):

> - minimum_set: `PRIVATE/PseudoCoup_v5/Designing/minimum_intention_set.md`
...
| 2026-07-24 15:57 -0400 | `Designing/minimum_intention_set.md` first appears in PCv5 git | `git -C PRIVATE/PseudoCoup_v5 show 866ee4d` ("PCv5 initial: migrate theory docs…") |
...
| 2026-07-28 | R1 verification; copy-forward into PseudoIR | `PRIVATE/PseudoCoup_v6/Research/r1_intentions_validation/REPORT.md` (dated in its own header); `intentions_data.py` header "Copied forward: 2026-07-28" |
| 2026-07-31 11:44 -0400 | first PseudoIR commit containing `Tools/intentions/intentions_data.py` | `git -C PRIVATE/PseudoIR show 9abc927` |
| 2026-08-01 07:51 -0400 | `Designing/` deleted | `git -C PRIVATE/PseudoCoup_v5 show 21cef81` ("Gutting: 550 MB -> 55 MB.") — note the commit timestamp is 08-01, not 07-31 as the gutting is usually dated |
...
| S9 | 2026-08-05 | `PRIVATE/PseudoCoup_v5/DevComms/log_008_kinds_coarse_tagging_draft.md:337` | "Sum types are not in the minimum set. the owner to rule whether `record` stretches to cover them or an object is missing." |
...
| E4 | 2026-07-22 | `PRIVATE/PseudoCoup_v5/DevComms/language_divergence_study_log.md:182` | "Are there classes not yet listed? Candidates to investigate: exception semantics (what is catchable), recursion limits, integer hashing, default float formatting in print." |
...
| first version without it | `git show 9abc927:Tools/intentions/intentions_data.py` in `PRIVATE/PseudoIR` (2026-07-31 11:44 -0400), `MINIMUM_SET`, 11 dicts, no `exception` entry; and its build product `PRIVATE/PseudoIR/Tools/intentions/pc_intentions.json` `minimum_set` |
...
R1 report (`PRIVATE/PseudoCoup_v6/Research/r1_intentions_validation/REPORT.md`,
...
| A2 | 2026-07-22 | `PRIVATE/PseudoCoup_v5/DevComms/language_divergence_study_log.md:287` | "\| 2 copy-model \| Discipline rule: one aliasing convention (Python's) + explicit `.copy()` at borders \|" |
...
- `PRIVATE/PseudoIR/Tools/intentions/intentions_data.py` (provenance
  header lines 1–22; `MINIMUM_SET` comment lines 588–591) and
  `README.md`.
- `git -C PRIVATE/PseudoIR log --oneline -- Tools/intentions` →
  9abc927 (2026-07-31), 2682a16 (2026-08-01), 049a8e3 (2026-08-05); all
  three inspected.
- `git -C PRIVATE/PseudoCoup_v5 log --oneline --all -- Designing/`
