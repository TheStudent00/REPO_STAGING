...
// InterpRenderer from the layer-4 term of bltu_gpr_gpr_imm_64__branch_condition__javascript.
// The term's layer-5 text, LITERAL:
//   If(ULE(v0, v1), 0, 1)
function emu_bltu_gpr_gpr_imm_64__branch_condition__javascript(a, b) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_bltu_gpr_gpr_imm_64__branch_condition__javascript(...values).toString());
    } catch (problem) {
