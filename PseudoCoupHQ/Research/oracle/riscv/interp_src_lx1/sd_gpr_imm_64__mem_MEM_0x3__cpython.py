...
# InterpRenderer from the layer-4 term of sd_gpr_imm_64__mem_MEM_0x3__cpython.
# The term's layer-5 text, LITERAL:
#   v0
def emu_sd_gpr_imm_64__mem_MEM_0x3__cpython(a):
    return m(a, 64)
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_sd_gpr_imm_64__mem_MEM_0x3__cpython(*values)
            sys.stdout.write("%d\n" % answer)
