...
// intermediate per node of the term of lb_gpr_gpr_8__reg_a0__go__bit_blast.
...
//go:noinline
func emu_lb_gpr_gpr_8__reg_a0__go__bit_blast(a uint8) uint64 {
...
func main() {
	sink = emu_lb_gpr_gpr_8__reg_a0__go__bit_blast(g0)
	_ = sink
}
