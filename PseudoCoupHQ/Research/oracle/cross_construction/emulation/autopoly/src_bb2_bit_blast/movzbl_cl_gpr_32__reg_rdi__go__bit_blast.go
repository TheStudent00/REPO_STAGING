...
// intermediate per node of the term of movzbl_cl_gpr_32__reg_rdi__go__bit_blast.
//   Concat(0, Extract(7, 0, v0))
package main

//go:noinline
func emu_movzbl_cl_gpr_32__reg_rdi__go__bit_blast(a uint8) uint64 {
...
func main() {
	sink = emu_movzbl_cl_gpr_32__reg_rdi__go__bit_blast(g0)
	_ = sink
}
