...
# InterpRenderer from the layer-4 term of cvtsi2ss_gpr_xmm_32__reg_xmm0__cpython.
# The term's layer-5 text, LITERAL:
#   fp.to_ieee_bv(fpToFP(RNE(), Extract(31, 0, v0)))
def emu_cvtsi2ss_gpr_xmm_32__reg_xmm0__cpython(a):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_cvtsi2ss_gpr_xmm_32__reg_xmm0__cpython(*values)
            sys.stdout.write("%d\n" % answer)
