...
// InterpRenderer from the layer-4 term of czero_eqz_gpr_gpr_same_64__reg_a0__javascript.
// The term's layer-5 text, LITERAL:
//   If(v0 == 0, 0, v0)
function emu_czero_eqz_gpr_gpr_same_64__reg_a0__javascript(a) {
    return m(((eq(a, 0n, 64)) ? (0n) : (a)), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_czero_eqz_gpr_gpr_same_64__reg_a0__javascript(...values).toString());
    } catch (problem) {
