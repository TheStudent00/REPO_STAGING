/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of divsd_xmm_xmm_64__reg_xmm0__c.  The term's layer-5 text, LITERAL:
...
double
emu_divsd_xmm_xmm_64__reg_xmm0__c(double a, double b)
{
