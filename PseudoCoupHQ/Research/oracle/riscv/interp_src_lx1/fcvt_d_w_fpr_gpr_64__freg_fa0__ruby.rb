...
# InterpRenderer from the layer-4 term of fcvt_d_w_fpr_gpr_64__freg_fa0__ruby.
# The term's layer-5 text, LITERAL:
#   fp.to_ieee_bv(fpToFP(RNE(), Extract(31, 0, v0)))
def emu_fcvt_d_w_fpr_gpr_64__freg_fa0__ruby(a)
  m(i2f(a, 32, 64), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_fcvt_d_w_fpr_gpr_64__freg_fa0__ruby(*values)
