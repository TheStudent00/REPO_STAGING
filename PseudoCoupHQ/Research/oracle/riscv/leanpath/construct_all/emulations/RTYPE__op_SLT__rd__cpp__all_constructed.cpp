/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of RTYPE__op_SLT__rd__cpp__all_constructed.  The term's text, LITERAL:
    */
#include <cstdint>

extern "C"
uint64_t
emu_RTYPE__op_SLT__rd__cpp__all_constructed(uint64_t a, uint64_t b)
{
    ...
    int v38 = ((!(v37))) ? 1 : 0;
    uint32_t v39 = ((v38) ? (uint32_t)(UINT32_C(0x0)) : (uint32_t)(UINT32_C(0x1)));
    uint32_t v40 = v39;
    uint64_t v41 = UINT64_C(0x0);
    uint64_t v42 = (uint64_t)(((uint64_t)(v41) << 1) | (uint64_t)(v40));
    return (uint64_t)(v42);
}
