...
public final class au_435_go_shl_i32_i64 {

    public static long au_435_go_shl_i32_i64(long p0, long p1) {
    ...
    public static long au_435_go_shl_i32_i64_trap(long p0, long p1) {
        // a0: operand `a` (int32) sign-extended to XLEN, as the ABI presents it
        final long v1 = AuInt.au_sext32(p0);
        // a1: operand `b` (int64) arrives in a1
        final long v2 = p1;
