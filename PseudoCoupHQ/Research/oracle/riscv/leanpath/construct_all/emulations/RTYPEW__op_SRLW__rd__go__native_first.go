...
// intermediate per node of the term of RTYPEW__op_SRLW__rd__go__native_first.
//   
package main

//go:noinline
func emu_RTYPEW__op_SRLW__rd__go__native_first(a uint32, b uint8) uint64 {
...
func main() {
	sink = emu_RTYPEW__op_SRLW__rd__go__native_first(g0, g1)
	_ = sink
}
