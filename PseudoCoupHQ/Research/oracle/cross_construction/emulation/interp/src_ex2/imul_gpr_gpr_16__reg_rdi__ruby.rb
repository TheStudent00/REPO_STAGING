...
# InterpRenderer from the layer-4 term of imul_gpr_gpr_16__reg_rdi__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(0, Extract(15, 0, v0)*Extract(15, 0, v1))
def emu_imul_gpr_gpr_16__reg_rdi__ruby(a, b)
  m(cat(0, mul(a, b, 16), 16), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_imul_gpr_gpr_16__reg_rdi__ruby(*values)
