...
theorem au_445_go_shr_i32_u64_abi_integer_level (a : BitVec 64) (b : BitVec 64) :
    (((((fun (a : BitVec 64) (b : BitVec 64) => ((pure_RTYPEW (a) ((pure_RTYPE (b) ((pure_ITYPE ((pure_ITYPE (b) (0x020#12) (LeanIM.iop.SLTIU))) (((sign_extend (m := 12) (0x3f#6)))) (ADDI))) (LeanIM.rop.OR))) (LeanIM.ropw.SRAW)))) (((((a) &&& 0xffffffff#64) ^^^ 0x80000000#64) - 0x80000000#64)) (b))) &&& 0xffffffff#64)) = (((((fun (a : BitVec 64) (b : BitVec 64) => ((pure_RTYPE ((pure_SHIFTIOP ((pure_SHIFTIOP ((pure_RTYPE ((pure_SHIFTIWOP (a) (0x1f#5) (LeanIM.sopw.SRAIW))) ((pure_ITYPE ((pure_ZBB_RTYPE (b) ((pure_ITYPE (zero_reg) (((sign_extend (m := 12) (0x1f#6)))) (ADDI))) (LeanIM.brop_zbb.MINU))) (0x01f#12) (LeanIM.iop.XORI))) (LeanIM.rop.SLL))) ((0x21#6)) (SLLI))) ((0x20#6)) (SRLI))) ((pure_RTYPE ((pure_ZBA_RTYPEUW (a) (zero_reg) (0x0#2))) ((pure_ZBB_RTYPE (b) ((pure_ITYPE (zero_reg) (((sign_extend (m := 12) (0x1f#6)))) (ADDI))) (LeanIM.brop_zbb.MINU))) (LeanIM.rop.SRL))) (OR)))) (((((a) &&& 0xffffffff#64) ^^^ 0x80000000#64) - 0x80000000#64)) (b))) &&& 0xffffffff#64)) := by
  try simp only [pure_ITYPE, pure_RTYPE, pure_RTYPEW, pure_SHIFTIOP, pure_SHIFTIWOP, pure_ZBA_RTYPEUW, pure_ZBB_RTYPE, bool_to_bit, log2_xlen, rotate_bits_left, rotate_bits_right, shift_bits_right_arith, sign_extend, xlenbits, zero_extend, zero_reg, zopz0zI_s, zopz0zI_u, zopz0zK_s, zopz0zK_u, bool_bit_forwards, xlen, rotatel, rotater, regtype, zeros, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend, Sail.BitVec.length, Sail.BitVec.extractLsb, Sail.shift_bits_left, Sail.shift_bits_right]
  all_goals grind
