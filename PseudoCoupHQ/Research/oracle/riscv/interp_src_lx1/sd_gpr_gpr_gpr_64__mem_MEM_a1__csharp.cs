...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of sd_gpr_gpr_gpr_64__mem_MEM_a1__csharp.
    // The term's layer-5 text, LITERAL:
    //   v0
    public static long emu_sd_gpr_gpr_gpr_64__mem_MEM_a1__csharp(long a) {
        return m(a, 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_sd_gpr_gpr_gpr_64__mem_MEM_a1__csharp(values[0])).ToString());
                    answers.Append("\n");
