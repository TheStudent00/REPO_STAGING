...
theorem lhu_gpr_gpr_same_16__reg_a0__go__all_constructed_08_integer_level (a : BitVec 64) :
    ((pure_SHIFTIOP ((pure_SHIFTIOP (a) ((0x30#6)) (SLLI))) ((0x30#6)) (SRLI))) = (pure_ZBB_EXTOP (a) (extop_zbb.ZEXTH)) := by
  try simp only [pure_SHIFTIOP, pure_ZBB_EXTOP, sign_extend, xlenbits, zero_extend, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend, Sail.BitVec.extractLsb]
  grind
