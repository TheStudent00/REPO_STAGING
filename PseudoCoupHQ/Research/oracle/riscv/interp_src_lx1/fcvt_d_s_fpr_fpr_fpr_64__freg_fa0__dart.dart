...
// InterpRenderer from the layer-4 term of fcvt_d_s_fpr_fpr_fpr_64__freg_fa0__dart.
// The term's layer-5 text, LITERAL:
//   fp.to_ieee_bv(fpToFP(RNE(), fpToFP(Extract(31, 0, v0))))
int emu_fcvt_d_s_fpr_fpr_fpr_64__freg_fa0__dart(int a) {
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_fcvt_d_s_fpr_fpr_fpr_64__freg_fa0__dart(values[0]);
