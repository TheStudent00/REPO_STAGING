...
theorem addw_gpr_gpr_same_32__reg_a0__rust__all_constructed__CLZ_01_fixed_width (a : BitVec 64) :
  ...
  try simp only [pure_ITYPE, pure_RTYPE, pure_SHIFTIWOP, pure_SHIFTIOP, pure_CLZ, bool_to_bit, log2_xlen, shift_bits_right_arith, sign_extend, to_bits, xlenbits, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend]
  bv_decide
