...
// one named local per gate, over the term of setae_gpr_one_8__reg_rdi__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(63, 8, v2), If(Extract(8, 8, Concat(0, Extract(7, 0, v0)) + Concat(0, Extract(7, 0, v1))) == 1, 0, 1))
function emu_setae_gpr_one_8__reg_rdi__javascript(a, b, c) {
