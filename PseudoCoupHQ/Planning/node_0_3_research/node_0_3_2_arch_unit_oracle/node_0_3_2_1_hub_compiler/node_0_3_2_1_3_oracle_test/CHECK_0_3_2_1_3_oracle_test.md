---
id: hq.research.arch_unit_oracle.hub_compiler.oracle_test.check
---

# CHECK — 0_3_2_1_3_oracle_test

Node `hq.research.arch_unit_oracle.hub_compiler.oracle_test`. Status `draft`.
