...
// InterpRenderer from the layer-4 term of ucomisd_mem_xmm_64__flags.low__dart.
// The term's layer-5 text, LITERAL:
//   fp.to_ieee_bv(fpToFP(v0))
int emu_ucomisd_mem_xmm_64__flags.low__dart(int a) {
  return m(a, 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_ucomisd_mem_xmm_64__flags.low__dart(values[0]);
