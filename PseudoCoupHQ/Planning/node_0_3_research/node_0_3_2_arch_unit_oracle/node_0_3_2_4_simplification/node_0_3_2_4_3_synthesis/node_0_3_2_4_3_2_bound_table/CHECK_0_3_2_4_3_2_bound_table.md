---
id: hq.research.arch_unit_oracle.simplification.synthesis.bound_table.check
---

# CHECK — 0_3_2_4_3_2_bound_table

Node `hq.research.arch_unit_oracle.simplification.synthesis.bound_table`. Status `draft`.
