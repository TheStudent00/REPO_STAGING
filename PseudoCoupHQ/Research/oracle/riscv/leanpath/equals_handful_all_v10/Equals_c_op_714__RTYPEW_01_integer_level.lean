...
theorem c_op_714__RTYPEW_01_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPEW (a) (b) (LeanIM.ropw.SRAW))) = (pure_RTYPEW (a) (b) (ropw.SUBW)) := by
  try simp only [pure_RTYPEW, pure_RTYPEW, shift_bits_right_arith, sign_extend, Sail.BitVec.signExtend]
  grind
