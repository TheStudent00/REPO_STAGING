/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of fsub_s_fpr_fpr_fpr_32__freg_fa0__cpp__native_first.  The term's text, LITERAL:
...
extern "C"
uint64_t
emu_fsub_s_fpr_fpr_fpr_32__freg_fa0__cpp__native_first(uint32_t a, uint32_t b)
{
    ...
    float v4 = (-(v3));
    float v5 = ((float)((v4) + (v1)));
    uint32_t v6 = (uint32_t)f32_to_bits(v5);
    uint64_t v7 = (uint64_t)(((uint64_t)(UINT32_C(0xffffffff)) << 32) | (uint64_t)(v6));
    return (uint64_t)(v7);
}
