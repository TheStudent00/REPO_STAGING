...
theorem rust__op_499_110_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPEW (a) (b) (LeanIM.ropw.SRAW))) = ((sign_extend (m := 64) (shift_bits_right_arith (Sail.BitVec.extractLsb a 31 0) (Sail.BitVec.extractLsb (Sail.BitVec.extractLsb b 31 0) 4 0)))) := by
