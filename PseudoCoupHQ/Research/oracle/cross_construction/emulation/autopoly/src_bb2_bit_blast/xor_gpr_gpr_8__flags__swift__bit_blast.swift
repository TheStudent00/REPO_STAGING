...
// intermediate per node of the term of xor_gpr_gpr_8__flags__swift__bit_blast.
//   Concat(Extract(7, 0, v0) ^ Extract(7, 0, v1), 0)
@_cdecl("emu_xor_gpr_gpr_8__flags__swift__bit_blast")
public func emu_xor_gpr_gpr_8__flags__swift__bit_blast(_ a: UInt8, _ b: UInt8) -> UInt16
{
    ...
    let g1: UInt32 = (g0 ^ 1)
    let g2: UInt32 = (g1 ^ 1)
    let g3: UInt32 = (x0_1 ^ x1_1)
    let g4: UInt32 = (g3 ^ 1)
    let g5: UInt32 = (g4 ^ 1)
    let g6: UInt32 = (x0_2 ^ x1_2)
    let g7: UInt32 = (g6 ^ 1)
    let g8: UInt32 = (g7 ^ 1)
    let g9: UInt32 = (x0_3 ^ x1_3)
    let g10: UInt32 = (g9 ^ 1)
    let g11: UInt32 = (g10 ^ 1)
    let g12: UInt32 = (x0_4 ^ x1_4)
    let g13: UInt32 = (g12 ^ 1)
    let g14: UInt32 = (g13 ^ 1)
    let g15: UInt32 = (x0_5 ^ x1_5)
    let g16: UInt32 = (g15 ^ 1)
    let g17: UInt32 = (g16 ^ 1)
    let g18: UInt32 = (x0_6 ^ x1_6)
    let g19: UInt32 = (g18 ^ 1)
    let g20: UInt32 = (g19 ^ 1)
    let g21: UInt32 = (x0_7 ^ x1_7)
    let g22: UInt32 = (g21 ^ 1)
    let g23: UInt32 = (g22 ^ 1)
    let w0: UInt32 = (k0 << 0)
    ...
    let w8: UInt32 = w7 | (g2 << 8)
    let w9: UInt32 = w8 | (g5 << 9)
    let w10: UInt32 = w9 | (g8 << 10)
    let w11: UInt32 = w10 | (g11 << 11)
    let w12: UInt32 = w11 | (g14 << 12)
    let w13: UInt32 = w12 | (g17 << 13)
    let w14: UInt32 = w13 | (g20 << 14)
    let w15: UInt32 = w14 | (g23 << 15)
