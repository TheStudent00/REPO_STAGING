...
// InterpRenderer from the layer-4 term of sh_gpr_gpr_gpr_16__mem_MEM_a1__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(63, 16, v0), Extract(15, 0, v1))
function emu_sh_gpr_gpr_gpr_16__mem_MEM_a1__javascript(a, b) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_sh_gpr_gpr_gpr_16__mem_MEM_a1__javascript(...values).toString());
    } catch (problem) {
