...
// intermediate per node of the term of lw_gpr_gpr_32__reg_a0__go__native_first.
...
//go:noinline
func emu_lw_gpr_gpr_32__reg_a0__go__native_first(a uint32) uint64 {
...
func main() {
	sink = emu_lw_gpr_gpr_32__reg_a0__go__native_first(g0)
	_ = sink
}
