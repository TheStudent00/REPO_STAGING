...
// one named local per gate, over the term of setne_gpr_one_8__reg_rdi__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(63, 8, v2), If(~(~Extract(7, 0, v0) | ~Extract(7, 0, v1)) == 0, 0, 1))
function emu_setne_gpr_one_8__reg_rdi__javascript(a, b, c) {
