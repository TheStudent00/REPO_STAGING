...
# InterpRenderer from the layer-4 term of sltu_gpr_gpr_gpr_64__reg_a0__ruby.
# The term's layer-5 text, LITERAL:
#   If(ULE(v0, v1), 0, 1)
def emu_sltu_gpr_gpr_gpr_64__reg_a0__ruby(a, b)
  m(((ule(b, a, 64)) ? (0) : (1)), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_sltu_gpr_gpr_gpr_64__reg_a0__ruby(*values)
