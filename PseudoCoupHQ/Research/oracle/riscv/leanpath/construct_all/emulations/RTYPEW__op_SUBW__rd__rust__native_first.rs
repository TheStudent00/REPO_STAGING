...
// intermediate per node of the term of RTYPEW__op_SUBW__rd__rust__native_first.
//   
#[no_mangle]
pub extern "C" fn emu_RTYPEW__op_SUBW__rd__rust__native_first(a: u32, b: u32) -> u64
{
    let v0: u32 = (a as u32);
    let v1: u32 = (b as u32);
