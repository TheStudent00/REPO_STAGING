...
// intermediate per node of the term of sll_gpr_gpr_same_64__reg_a0__go__all_constructed.
...
//go:noinline
func emu_sll_gpr_gpr_same_64__reg_a0__go__all_constructed(a uint64) uint64 {
...
func main() {
	sink = emu_sll_gpr_gpr_same_64__reg_a0__go__all_constructed(g0)
	_ = sink
}
