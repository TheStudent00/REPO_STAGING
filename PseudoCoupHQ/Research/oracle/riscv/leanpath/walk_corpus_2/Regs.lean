...
#eval IO.println ("r0\t" ++ ((toString (repr ((((creg2reg_idx (LeanIMPrExecutable.cregidx.Cregidx 0x2#3)))))))))
#eval IO.println ("r1\t" ++ ((toString (repr ((((creg2reg_idx (LeanIMPrExecutable.cregidx.Cregidx 0x3#3)))))))))
#eval IO.println ("r2\t" ++ ((toString (repr ((((creg2reg_idx (LeanIMPrExecutable.cregidx.Cregidx 0x4#3)))))))))
#eval IO.println ("r3\t" ++ ((toString (repr ((((creg2reg_idx (LeanIMPrExecutable.cregidx.Cregidx 0x5#3)))))))))
#eval IO.println ("r4\t" ++ ((toString (repr ((((creg2reg_idx (LeanIMPrExecutable.cregidx.Cregidx 0x6#3)))))))))
#eval IO.println ("r5\t" ++ ((toString (repr ((((creg2reg_idx (LeanIMPrExecutable.cregidx.Cregidx 0x7#3)))))))))
#eval IO.println ("r6\t" ++ ((toString (repr ((zreg))))))
#eval IO.println ("r7\t" ++ ((toString (repr (r)))))
