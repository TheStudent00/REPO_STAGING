/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of fle_s_gpr_fpr_fpr_32__reg_a0__c.  The term's layer-5 text, LITERAL:
...
uint64_t
emu_fle_s_gpr_fpr_fpr_32__reg_a0__c(uint32_t a, uint32_t b)
{
