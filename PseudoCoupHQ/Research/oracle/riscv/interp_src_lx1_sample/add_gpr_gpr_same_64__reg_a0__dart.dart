...
// InterpRenderer from the layer-4 term of add_gpr_gpr_same_64__reg_a0__dart.
// The term's layer-5 text, LITERAL:
//   v0*2
int emu_add_gpr_gpr_same_64__reg_a0__dart(int a) {
  return m(mul(a, 2, 64), 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_add_gpr_gpr_same_64__reg_a0__dart(values[0]);
