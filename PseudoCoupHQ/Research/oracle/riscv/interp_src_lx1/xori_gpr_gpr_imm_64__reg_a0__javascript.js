...
// InterpRenderer from the layer-4 term of xori_gpr_gpr_imm_64__reg_a0__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(63, 2, v0), ~Extract(1, 0, v0))
function emu_xori_gpr_gpr_imm_64__reg_a0__javascript(a) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_xori_gpr_gpr_imm_64__reg_a0__javascript(...values).toString());
    } catch (problem) {
