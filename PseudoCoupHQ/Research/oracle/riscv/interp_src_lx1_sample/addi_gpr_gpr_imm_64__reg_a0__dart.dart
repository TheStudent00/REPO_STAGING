...
// InterpRenderer from the layer-4 term of addi_gpr_gpr_imm_64__reg_a0__dart.
// The term's layer-5 text, LITERAL:
//   v0 + 3
int emu_addi_gpr_gpr_imm_64__reg_a0__dart(int a) {
  return m(add(a, 3, 64), 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_addi_gpr_gpr_imm_64__reg_a0__dart(values[0]);
