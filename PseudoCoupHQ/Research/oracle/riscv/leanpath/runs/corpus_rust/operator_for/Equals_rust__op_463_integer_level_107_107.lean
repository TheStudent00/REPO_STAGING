...
theorem rust__op_463_107_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPEW (a) (b) (LeanIM.ropw.SLLW))) = ((sign_extend (m := 64) (shift_bits_left (Sail.BitVec.extractLsb a 31 0) (Sail.BitVec.extractLsb (Sail.BitVec.extractLsb b 31 0) 4 0)))) := by
