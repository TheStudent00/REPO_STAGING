/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of lh_gpr_imm_16__reg_a0__c__native_first.  The term's text, LITERAL:
...
uint64_t
emu_lh_gpr_imm_16__reg_a0__c__native_first(uint16_t a)
{
