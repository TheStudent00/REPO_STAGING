...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of cvtsi2ss_gpr_xmm_32__reg_xmm0__csharp.
    // The term's layer-5 text, LITERAL:
    //   fp.to_ieee_bv(fpToFP(RNE(), Extract(31, 0, v0)))
    public static long emu_cvtsi2ss_gpr_xmm_32__reg_xmm0__csharp(long a) {
        return m(i2f(a, 32, 32), 32);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_cvtsi2ss_gpr_xmm_32__reg_xmm0__csharp(values[0])).ToString());
                    answers.Append("\n");
