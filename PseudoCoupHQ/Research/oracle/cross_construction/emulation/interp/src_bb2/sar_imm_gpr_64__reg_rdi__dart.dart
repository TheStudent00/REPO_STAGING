...
// one named local per gate, over the term of sar_imm_gpr_64__reg_rdi__dart.
// The term's layer-5 text, LITERAL:
//   v0 >> 3
int emu_sar_imm_gpr_64__reg_rdi__dart(int a) {
  int x0_3 = ext(a, 3, 3);
  int x0_4 = ext(a, 4, 4);
  int x0_5 = ext(a, 5, 5);
  int x0_6 = ext(a, 6, 6);
  ...
  int w4 = cat(w3, x0_62, 1);
  int w5 = cat(w4, x0_61, 1);
  int w6 = cat(w5, x0_60, 1);
  int w7 = cat(w6, x0_59, 1);
  int w8 = cat(w7, x0_58, 1);
  int w9 = cat(w8, x0_57, 1);
  int w10 = cat(w9, x0_56, 1);
  int w11 = cat(w10, x0_55, 1);
  int w12 = cat(w11, x0_54, 1);
  int w13 = cat(w12, x0_53, 1);
  int w14 = cat(w13, x0_52, 1);
  int w15 = cat(w14, x0_51, 1);
  int w16 = cat(w15, x0_50, 1);
  int w17 = cat(w16, x0_49, 1);
  int w18 = cat(w17, x0_48, 1);
  int w19 = cat(w18, x0_47, 1);
  int w20 = cat(w19, x0_46, 1);
  int w21 = cat(w20, x0_45, 1);
  int w22 = cat(w21, x0_44, 1);
  int w23 = cat(w22, x0_43, 1);
  int w24 = cat(w23, x0_42, 1);
  int w25 = cat(w24, x0_41, 1);
  int w26 = cat(w25, x0_40, 1);
  int w27 = cat(w26, x0_39, 1);
  int w28 = cat(w27, x0_38, 1);
  int w29 = cat(w28, x0_37, 1);
  int w30 = cat(w29, x0_36, 1);
  int w31 = cat(w30, x0_35, 1);
  int w32 = cat(w31, x0_34, 1);
  int w33 = cat(w32, x0_33, 1);
  int w34 = cat(w33, x0_32, 1);
  int w35 = cat(w34, x0_31, 1);
  int w36 = cat(w35, x0_30, 1);
  int w37 = cat(w36, x0_29, 1);
  int w38 = cat(w37, x0_28, 1);
  int w39 = cat(w38, x0_27, 1);
  int w40 = cat(w39, x0_26, 1);
  int w41 = cat(w40, x0_25, 1);
  int w42 = cat(w41, x0_24, 1);
  int w43 = cat(w42, x0_23, 1);
  int w44 = cat(w43, x0_22, 1);
  int w45 = cat(w44, x0_21, 1);
  int w46 = cat(w45, x0_20, 1);
  int w47 = cat(w46, x0_19, 1);
  int w48 = cat(w47, x0_18, 1);
  int w49 = cat(w48, x0_17, 1);
  int w50 = cat(w49, x0_16, 1);
  int w51 = cat(w50, x0_15, 1);
  int w52 = cat(w51, x0_14, 1);
  int w53 = cat(w52, x0_13, 1);
  int w54 = cat(w53, x0_12, 1);
  int w55 = cat(w54, x0_11, 1);
  int w56 = cat(w55, x0_10, 1);
  int w57 = cat(w56, x0_9, 1);
  int w58 = cat(w57, x0_8, 1);
  int w59 = cat(w58, x0_7, 1);
  int w60 = cat(w59, x0_6, 1);
  int w61 = cat(w60, x0_5, 1);
  int w62 = cat(w61, x0_4, 1);
  int w63 = cat(w62, x0_3, 1);
  return m(w63, 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_sar_imm_gpr_64__reg_rdi__dart(values[0]);
