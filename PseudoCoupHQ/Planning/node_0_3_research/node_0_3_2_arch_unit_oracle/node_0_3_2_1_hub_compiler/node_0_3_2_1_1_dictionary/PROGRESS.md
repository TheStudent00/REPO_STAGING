...
- 2026-09-10: **task hub1 — first form standing** (step 4 of the master
  order). `PRIVATE/PseudoCoupHQ/Research/oracle/hub/dictionary.json`:
  ...
  Report: `PRIVATE/PseudoCoupHQ/DevComms/log_252_task_hub1_hub_v1_first_form.md` §2.
...
- 2026-09-10: **task hub2 — the dictionary is now READ FROM THE BANK and
  ...
  `PRIVATE/PseudoCoupHQ/Research/oracle/hub/dictionary2.json`.
  ...
  its cause.
  Report: `PRIVATE/PseudoCoupHQ/DevComms/log_254_task_hub2_the_dictionary_at_two_levels.md` §3, §4, §5.
