/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of sraiw_gpr_gpr_imm_32__reg_a0__cpp__native_first.  The term's text, LITERAL:
...
extern "C"
uint64_t
emu_sraiw_gpr_gpr_imm_32__reg_a0__cpp__native_first(uint32_t a)
{
    uint32_t v0 = (uint32_t)a;
    uint32_t v1 = (uint32_t)((int32_t)(v0) >> (unsigned)(uint32_t)(UINT32_C(0x3)));
