...
/-- c single-opcode row 61, arch mnemonic 'shl', example unit c/op_679, 92 members
...
theorem ModelCheck_c_61 (v0 : BitVec 64) (v1 : BitVec 64) :
    ((v0.extractLsb 31 0) <<< ((0#27) ++ (v1.extractLsb 4 0)))
  = ((model_shl_8 (model_mov_18 v0) (model_mov_22 v1)).extractLsb 31 0) := by
  simp only [model_mov_22, model_mov_18, model_shl_8]
  bv_decide

#print axioms ModelCheck_c_61
