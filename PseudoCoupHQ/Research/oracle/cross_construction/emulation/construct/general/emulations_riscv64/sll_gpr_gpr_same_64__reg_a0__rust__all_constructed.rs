...
// intermediate per node of the term of sll_gpr_gpr_same_64__reg_a0__rust__all_constructed.
//   v0 << Concat(0, Extract(5, 0, v0))
#[no_mangle]
pub extern "C" fn emu_sll_gpr_gpr_same_64__reg_a0__rust__all_constructed(a: u64) -> u64
{
