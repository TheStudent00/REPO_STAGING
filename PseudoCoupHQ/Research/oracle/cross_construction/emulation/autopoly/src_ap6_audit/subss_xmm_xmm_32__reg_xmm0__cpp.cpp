/* task ex1 emulation -- rendered by cpp_render.py CppRenderer from the layer-4 term of subss_xmm_xmm_32__reg_xmm0__cpp.  The term's layer-5 text, LITERAL:
...
extern "C"
float
emu_subss_xmm_xmm_32__reg_xmm0__cpp(float a, float b)
{
