#!/bin/bash
# ref2 lane 7 (lane 6 stopped at its first import: a state loaded out of
# `ref2_originals/` imports `canon` by bare name and the pipeline was not yet
# on the path.  Lane 6 is kept; this is a NEW name, nothing overwritten) -- the model table swept at all FIVE states of the reference
