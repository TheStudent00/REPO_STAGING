...
theorem sllw_gpr_gpr_gpr_32__reg_a0__cpp__all_constructed_12_integer_level (a : BitVec 64) (b : BitVec 64) :
  ...
  try simp only [pure_RTYPE, pure_SHIFTIOP, pure_ZBA_RTYPE, pure_RTYPEW, pure_ITYPE, pure_SHIFTIWOP, pure_ZBA_RTYPEUW, pure_RTYPEW, shift_bits_right_arith, sign_extend, Sail.BitVec.toNatInt, Sail.BitVec.signExtend, Sail.BitVec.extractLsb, Sail.shift_bits_right, Sail.shift_bits_left]
  grind
