; ModuleID = '<scratch>/fl/run/ui64_to_f32.rm4.flags/ui64_to_f32.rm4.flags.rv.flat.ll'
source_filename = "llvm-link"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128"
target triple = "riscv64-unknown-unknown-elf"

define dso_local i64 @ui64_to_f32_rm4_flags_flat(i64 noundef %arg) {
  %i = icmp eq i64 %arg, 0
  ...
  %i44 = zext i1 %i38 to i64
  %.a31 = and i64 %i44, %.m30
  %.sh26 = lshr i32 %i35, 7
  %i36 = freeze i32 %.sh26
  %i39 = icmp ult i32 %i35, 128
  %.m28 = sext i1 %i39 to i32
  %.n29 = xor i32 %.m28, -1
  %i42 = and i32 %i41, %.n29
  %i43 = add i32 %i36, %i42
  %.a35 = and i32 %i43, %.m24
  %.o36 = or i32 %.a34, %.a35
  %i46 = zext i32 %.o36 to i64
  %i47 = shl i64 %i46, 32
  %i48 = or i64 %i47, %.a31
  ret i64 %i48
}
