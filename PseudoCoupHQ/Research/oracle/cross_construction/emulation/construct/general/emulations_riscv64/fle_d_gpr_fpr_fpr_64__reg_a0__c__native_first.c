/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of fle_d_gpr_fpr_fpr_64__reg_a0__c__native_first.  The term's text, LITERAL:
...
uint64_t
emu_fle_d_gpr_fpr_fpr_64__reg_a0__c__native_first(uint64_t a, uint64_t b)
{
