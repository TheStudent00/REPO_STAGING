...
theorem go__op_60_114_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_MULW (a) (b))) = ((sign_extend (m := 64) (to_bits_truncate (l := 32) ((BitVec.toInt (Sail.BitVec.extractLsb a 31 0)) *i (BitVec.toInt (Sail.BitVec.extractLsb b 31 0)))))) := by
