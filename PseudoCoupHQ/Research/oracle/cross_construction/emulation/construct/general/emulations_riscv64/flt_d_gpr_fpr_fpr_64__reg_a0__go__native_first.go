...
// intermediate per node of the term of flt_d_gpr_fpr_fpr_64__reg_a0__go__native_first.
...
//go:noinline
func emu_flt_d_gpr_fpr_fpr_64__reg_a0__go__native_first(a uint64, b uint64) uint64 {
...
func main() {
	sink = emu_flt_d_gpr_fpr_fpr_64__reg_a0__go__native_first(g0, g1)
	_ = sink
}
