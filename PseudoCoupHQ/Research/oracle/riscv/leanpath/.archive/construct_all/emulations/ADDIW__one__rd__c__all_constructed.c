/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of ADDIW__one__rd__c__all_constructed.  The term's text, LITERAL:
    */
#include <stdint.h>

uint64_t
emu_ADDIW__one__rd__c__all_constructed(uint32_t a, uint16_t b)
{
