...
// intermediate per node of the term of lb_gpr_fpr_8__reg_a0__go__native_first.
...
//go:noinline
func emu_lb_gpr_fpr_8__reg_a0__go__native_first(a uint8) uint64 {
...
func main() {
	sink = emu_lb_gpr_fpr_8__reg_a0__go__native_first(g0)
	_ = sink
}
