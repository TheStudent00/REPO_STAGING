; ModuleID = '<scratch>/fl/run/ui64_to_f32.rm2.flags/ui64_to_f32.rm2.flags.rv.flat.ll'
source_filename = "llvm-link"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128"
target triple = "riscv64-unknown-unknown-elf"

define dso_local i64 @ui64_to_f32_rm2_flags_flat(i64 noundef %arg) {
  %i = icmp eq i64 %arg, 0
  ...
  %i35 = freeze i32 %.sh26
  %i36 = and i32 %.a25, 127
  %i37 = icmp ne i32 %i36, 0
  %i38 = icmp ult i32 %.a25, 128
  ...
  %.a35 = and i32 %i42, %.m24
  %.o36 = or i32 %.a34, %.a35
  %i43 = zext i1 %i37 to i64
  %.a31 = and i64 %i43, %.m30
  %i45 = zext i32 %.o36 to i64
  %i46 = shl i64 %i45, 32
  %i47 = or i64 %i46, %.a31
  ret i64 %i47
}
