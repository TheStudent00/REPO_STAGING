...
// intermediate per node of the term of mulhu_gpr_gpr_gpr_64__reg_a0__rust__native_first.
//   Extract(127, 64, Concat(0, v0)*Concat(0, v1))
#[no_mangle]
pub extern "C" fn emu_mulhu_gpr_gpr_gpr_64__reg_a0__rust__native_first(a: u64, b: u64) -> u64
{
