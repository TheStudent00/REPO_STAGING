#!/usr/bin/env bash
# t96_l17_verify_final.sh -- TASK 90, generated by check_conventions_log_claims.py --emit-lane.
#
...
echo "[1/1] the final pass over log_201"
python3 check_conventions_log_claims.py --verify \
  --timeout 120 \
  --json /out/t96_l17_verify_final.json \
