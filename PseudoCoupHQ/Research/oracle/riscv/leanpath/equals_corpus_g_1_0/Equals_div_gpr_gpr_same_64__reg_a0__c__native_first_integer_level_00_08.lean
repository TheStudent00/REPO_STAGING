...
theorem div_gpr_gpr_same_64__reg_a0__c__native_first_00_integer_level (a : BitVec 64) :
    ((pure_ITYPE ((pure_ITYPE ((pure_RTYPE (zero_reg) (a) (LeanIM.rop.SLTU))) (((sign_extend (m := 12) (0x3f#6)))) (ADDI))) (0x001#12) (LeanIM.iop.ORI))) = (pure_BREV8 (a) ) := by
  try simp only [pure_RTYPE, pure_ITYPE, pure_BREV8, brev8, reverse_bits, zeros, Sail.BitVec.length, Sail.BitVec.updateSubrange, Sail.BitVec.extractLsb]
  grind

set_option maxHeartbeats 40000 in
theorem div_gpr_gpr_same_64__reg_a0__c__native_first_01_integer_level (a : BitVec 64) :
    ((pure_ITYPE ((pure_ITYPE ((pure_RTYPE (zero_reg) (a) (LeanIM.rop.SLTU))) (((sign_extend (m := 12) (0x3f#6)))) (ADDI))) (0x001#12) (LeanIM.iop.ORI))) = (pure_CLZ (a) ) := by
  try simp only [pure_RTYPE, pure_ITYPE, pure_CLZ, to_bits]
  grind

set_option maxHeartbeats 40000 in
theorem div_gpr_gpr_same_64__reg_a0__c__native_first_02_integer_level (a : BitVec 64) :
    ((pure_ITYPE ((pure_ITYPE ((pure_RTYPE (zero_reg) (a) (LeanIM.rop.SLTU))) (((sign_extend (m := 12) (0x3f#6)))) (ADDI))) (0x001#12) (LeanIM.iop.ORI))) = (pure_CLZW (a) ) := by
  try simp only [pure_RTYPE, pure_ITYPE, pure_CLZW, to_bits]
  grind

set_option maxHeartbeats 40000 in
theorem div_gpr_gpr_same_64__reg_a0__c__native_first_03_integer_level (a : BitVec 64) :
    ((pure_ITYPE ((pure_ITYPE ((pure_RTYPE (zero_reg) (a) (LeanIM.rop.SLTU))) (((sign_extend (m := 12) (0x3f#6)))) (ADDI))) (0x001#12) (LeanIM.iop.ORI))) = (pure_CTZ (a) ) := by
  try simp only [pure_RTYPE, pure_ITYPE, pure_CTZ, to_bits]
  grind

set_option maxHeartbeats 40000 in
theorem div_gpr_gpr_same_64__reg_a0__c__native_first_04_integer_level (a : BitVec 64) :
    ((pure_ITYPE ((pure_ITYPE ((pure_RTYPE (zero_reg) (a) (LeanIM.rop.SLTU))) (((sign_extend (m := 12) (0x3f#6)))) (ADDI))) (0x001#12) (LeanIM.iop.ORI))) = (pure_CTZW (a) ) := by
  try simp only [pure_RTYPE, pure_ITYPE, pure_CTZW, to_bits]
  grind

set_option maxHeartbeats 40000 in
theorem div_gpr_gpr_same_64__reg_a0__c__native_first_05_integer_level (a : BitVec 64) :
    ((pure_ITYPE ((pure_ITYPE ((pure_RTYPE (zero_reg) (a) (LeanIM.rop.SLTU))) (((sign_extend (m := 12) (0x3f#6)))) (ADDI))) (0x001#12) (LeanIM.iop.ORI))) = (pure_REV8 (a) ) := by
  try simp only [pure_RTYPE, pure_ITYPE, pure_REV8, rev8, zeros, Sail.BitVec.length, Sail.BitVec.updateSubrange, Sail.BitVec.extractLsb]
  grind

set_option maxHeartbeats 40000 in
theorem div_gpr_gpr_same_64__reg_a0__c__native_first_06_integer_level (a : BitVec 64) :
    ((pure_ITYPE ((pure_ITYPE ((pure_RTYPE (zero_reg) (a) (LeanIM.rop.SLTU))) (((sign_extend (m := 12) (0x3f#6)))) (ADDI))) (0x001#12) (LeanIM.iop.ORI))) = (pure_ZBB_EXTOP (a) (extop_zbb.SEXTB)) := by
  try simp only [pure_RTYPE, pure_ITYPE, pure_ZBB_EXTOP, sign_extend, xlenbits, zero_extend, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend]
  grind

set_option maxHeartbeats 40000 in
theorem div_gpr_gpr_same_64__reg_a0__c__native_first_07_integer_level (a : BitVec 64) :
    ((pure_ITYPE ((pure_ITYPE ((pure_RTYPE (zero_reg) (a) (LeanIM.rop.SLTU))) (((sign_extend (m := 12) (0x3f#6)))) (ADDI))) (0x001#12) (LeanIM.iop.ORI))) = (pure_ZBB_EXTOP (a) (extop_zbb.SEXTH)) := by
  try simp only [pure_RTYPE, pure_ITYPE, pure_ZBB_EXTOP, sign_extend, xlenbits, zero_extend, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend]
  grind

set_option maxHeartbeats 40000 in
theorem div_gpr_gpr_same_64__reg_a0__c__native_first_08_integer_level (a : BitVec 64) :
    ((pure_ITYPE ((pure_ITYPE ((pure_RTYPE (zero_reg) (a) (LeanIM.rop.SLTU))) (((sign_extend (m := 12) (0x3f#6)))) (ADDI))) (0x001#12) (LeanIM.iop.ORI))) = (pure_ZBB_EXTOP (a) (extop_zbb.ZEXTH)) := by
  try simp only [pure_RTYPE, pure_ITYPE, pure_ZBB_EXTOP, sign_extend, xlenbits, zero_extend, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend]
  grind
