...
// one named local per gate, over the term of cmovle_gpr_gpr_32__reg_rdi__dart.
...
int emu_cmovle_gpr_gpr_32__reg_rdi__dart(int a, int b, int c, int d) {
  int x3_0 = ext(d, 0, 0);
  ...
  int w32 = cat(w31, g257, 1);
  int w33 = cat(w32, g254, 1);
  int w34 = cat(w33, g251, 1);
  int w35 = cat(w34, g248, 1);
  int w36 = cat(w35, g245, 1);
  int w37 = cat(w36, g242, 1);
  int w38 = cat(w37, g239, 1);
  int w39 = cat(w38, g236, 1);
  int w40 = cat(w39, g233, 1);
  int w41 = cat(w40, g230, 1);
  int w42 = cat(w41, g227, 1);
  int w43 = cat(w42, g224, 1);
  int w44 = cat(w43, g221, 1);
  int w45 = cat(w44, g218, 1);
  int w46 = cat(w45, g215, 1);
  int w47 = cat(w46, g212, 1);
  int w48 = cat(w47, g209, 1);
  int w49 = cat(w48, g206, 1);
  int w50 = cat(w49, g203, 1);
  int w51 = cat(w50, g200, 1);
  int w52 = cat(w51, g197, 1);
  int w53 = cat(w52, g194, 1);
  int w54 = cat(w53, g191, 1);
  int w55 = cat(w54, g188, 1);
  int w56 = cat(w55, g185, 1);
  int w57 = cat(w56, g182, 1);
  int w58 = cat(w57, g179, 1);
  int w59 = cat(w58, g176, 1);
  int w60 = cat(w59, g173, 1);
  int w61 = cat(w60, g170, 1);
  int w62 = cat(w61, g167, 1);
  int w63 = cat(w62, g164, 1);
  return m(w63, 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_cmovle_gpr_gpr_32__reg_rdi__dart(values[0], values[1], values[2], values[3]);
