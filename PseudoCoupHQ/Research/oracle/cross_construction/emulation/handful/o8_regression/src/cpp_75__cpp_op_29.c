/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of cpp_75__cpp_op_29.  The term's layer-5 text, LITERAL:
   Concat(Extract(7, 1, v0), ~Extract(0, 0, v0)) */
#include <stdint.h>

uint8_t
emu_cpp_75__cpp_op_29(uint8_t a)
{
