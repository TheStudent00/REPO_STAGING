...
theorem divu_gpr_gpr_gpr_64__reg_a0__c__native_first_00_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_DIV (b) (a) (true))) = (pure_DIV (a) (b) (false)) := by
  try simp only [pure_DIV, pure_DIV, not, to_bits_truncate, xlen]
  grind

set_option maxHeartbeats 40000 in
theorem divu_gpr_gpr_gpr_64__reg_a0__c__native_first_01_integer_level (a : BitVec 64) (b : BitVec 64) :
