...
// one named local per gate, over the term of movsd_mem_xmm_64__reg_xmm0__javascript.
// The term's layer-5 text, LITERAL:
//   v0
function emu_movsd_mem_xmm_64__reg_xmm0__javascript(a) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_movsd_mem_xmm_64__reg_xmm0__javascript(...values).toString());
    } catch (problem) {
