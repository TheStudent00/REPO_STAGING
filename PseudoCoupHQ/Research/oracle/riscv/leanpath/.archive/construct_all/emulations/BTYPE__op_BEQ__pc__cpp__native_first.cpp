/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of BTYPE__op_BEQ__pc__cpp__native_first.  The term's text, LITERAL:
    */
#include <cstdint>

extern "C"
uint64_t
emu_BTYPE__op_BEQ__pc__cpp__native_first(uint64_t a, uint16_t b)
{
