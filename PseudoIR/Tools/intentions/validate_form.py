...
PRIVATE/PseudoCoup_v5, the archived research tree whose
...
PRIVATE/PseudoCoup_v6/Tools/ledgerer/tree_sitter/parse_source.py
...
Run:
    python3 PRIVATE/PseudoIR/Tools/intentions/validate_form.py FORM.json --root PRIVATE/PseudoCoup_v5
"""
