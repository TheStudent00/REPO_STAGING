/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of E01593__swift_regen_325.  The term's layer-5 text, LITERAL:
...
uint32_t
emu_E01593__swift_regen_325(uint8_t a, uint8_t b)
{
