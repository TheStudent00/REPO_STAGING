...
// InterpRenderer from the layer-4 term of setp_gpr_one_8__reg_rdi__javascript.
...
function emu_setp_gpr_one_8__reg_rdi__javascript(a, b) {
    return m(cat(0n, ((eq(ext(add(mul(b, 255n, 8), a, 8), 1, 1), ((eq(ext(add(mul(b, 255n, 8), a, 8), 2, 2), ((eq(ext(add(mul(b, 255n, 8), a, 8), 3, 3), ((eq(ext(add(mul(b, 255n, 8), a, 8), 4, 4), ((eq(ext(add(mul(b, 255n, 8), a, 8), 5, 5), ((eq(ext(add(mul(b, 255n, 8), a, 8), 6, 6), ((eq(ext(add(mul(b, 255n, 8), a, 8), 7, 7), ((eq(add(ext(a, 0, 0), 1n, 1), ext(b, 0, 0), 1)) ? (1n) : (0n)), 1)) ? (1n) : (0n)), 1)) ? (1n) : (0n)), 1)) ? (1n) : (0n)), 1)) ? (1n) : (0n)), 1)) ? (1n) : (0n)), 1)) ? (1n) : (0n)), 1)) ? (1n) : (0n)), 8), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_setp_gpr_one_8__reg_rdi__javascript(...values).toString());
    } catch (problem) {
