/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of go_2__go_op_340.  The term's layer-5 text, LITERAL:
...
double
emu_go_2__go_op_340(double a, double b)
{
