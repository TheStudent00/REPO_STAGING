/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of rust_1__rust_op_555.  The term's layer-5 text, LITERAL:
...
float
emu_rust_1__rust_op_555(double a, float b)
{
