...
// one named local per gate, over the term of add_gpr_same_8__reg_rdi__php.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(63, 8, v0), Extract(7, 0, v0)*2)
function emu_add_gpr_same_8__reg_rdi__php($a) {
    $x0_0 = ex_ext($a, 0, 0);
    $x0_1 = ex_ext($a, 1, 1);
    $x0_2 = ex_ext($a, 2, 2);
    $x0_3 = ex_ext($a, 3, 3);
    ...
    $w56 = ex_cat($w55, $x0_6, 1);
    $w57 = ex_cat($w56, $x0_5, 1);
    $w58 = ex_cat($w57, $x0_4, 1);
    $w59 = ex_cat($w58, $x0_3, 1);
    $w60 = ex_cat($w59, $x0_2, 1);
    $w61 = ex_cat($w60, $x0_1, 1);
    $w62 = ex_cat($w61, $x0_0, 1);
    $w63 = ex_cat($w62, $k0, 1);
    return ex_m($w63, 64);
}
...
while (($line = fgets($handle)) !== false) {
    ...
    try {
        $answer = emu_add_gpr_same_8__reg_rdi__php(...$ints);
        if ($answer < 0) {
            echo sprintf("%s\n", sprintf("%u", $answer));
        } else {
            echo $answer . "\n";
