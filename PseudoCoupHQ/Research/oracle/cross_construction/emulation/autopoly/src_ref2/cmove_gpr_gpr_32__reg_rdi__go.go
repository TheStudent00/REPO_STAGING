...
func emu_cmove_gpr_gpr_32__reg_rdi__go(a uint32, b uint32, c uint32, d uint32) uint64 {
	return uint64((uint64(((uint64(uint32(0x0))) << 32) | (uint64(sel32(((uint32((uint32((uint32(uint32(b))) ^ (uint32(uint32(a))))))) == (uint32(uint32(0x0)))), uint32(uint32(c)), uint32(uint32(d))))))))
}
