...
// intermediate per node of the term of div_gpr_gpr_same_64__reg_a0__rust__native_first.
//   If(v0 == 0, 18446744073709551615, If(And(v0 == 18446744073709551615, v0 == 9223372036854775808), 9223372036854775808, bvsdiv_i(v0, v0)))
#[no_mangle]
pub extern "C" fn emu_div_gpr_gpr_same_64__reg_a0__rust__native_first(a: u64) -> u64
{
