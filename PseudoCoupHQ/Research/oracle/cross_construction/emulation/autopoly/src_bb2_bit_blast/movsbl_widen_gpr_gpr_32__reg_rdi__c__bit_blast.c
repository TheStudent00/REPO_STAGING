/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of movsbl_widen_gpr_gpr_32__reg_rdi__c__bit_blast.  The term's text, LITERAL:
...
uint64_t
emu_movsbl_widen_gpr_gpr_32__reg_rdi__c__bit_blast(uint8_t a)
{
