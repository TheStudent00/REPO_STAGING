...
// InterpRenderer from the layer-4 term of lh_gpr_gpr_same_16__reg_a0__php.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 15, v0), Extract(15, 0, v0))
function emu_lh_gpr_gpr_same_16__reg_a0__php($a) {
    return ex_m(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_ext($a, 15, 15), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), ex_ext($a, 15, 15), 1), $a, 16), 64);
}
...
while (($line = fgets($handle)) !== false) {
    ...
    try {
        $answer = emu_lh_gpr_gpr_same_16__reg_a0__php(...$ints);
        if ($answer < 0) {
            echo sprintf("%s\n", sprintf("%u", $answer));
        } else {
            echo $answer . "\n";
