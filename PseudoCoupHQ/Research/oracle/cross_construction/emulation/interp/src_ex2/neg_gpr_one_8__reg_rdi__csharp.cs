...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of neg_gpr_one_8__reg_rdi__csharp.
    // The term's layer-5 text, LITERAL:
    //   Concat(0, Extract(7, 0, v0)*255)
    public static long emu_neg_gpr_one_8__reg_rdi__csharp(long a) {
        return m(cat(0L, mul(a, 255L, 8), 8), 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_neg_gpr_one_8__reg_rdi__csharp(values[0])).ToString());
                    answers.Append("\n");
