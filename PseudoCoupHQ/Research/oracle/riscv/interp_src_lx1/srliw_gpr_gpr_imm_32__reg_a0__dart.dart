...
// InterpRenderer from the layer-4 term of srliw_gpr_gpr_imm_32__reg_a0__dart.
// The term's layer-5 text, LITERAL:
//   Concat(0, Extract(31, 3, v0))
int emu_srliw_gpr_gpr_imm_32__reg_a0__dart(int a) {
  return m(cat(0, ext(a, 31, 3), 29), 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_srliw_gpr_gpr_imm_32__reg_a0__dart(values[0]);
