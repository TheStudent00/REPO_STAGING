...
public class Emu {
    ...
    // InterpRenderer from the layer-4 term of addw_gpr_gpr_gpr_32__reg_a0__java.
    ...
    static long emu_addw_gpr_gpr_gpr_32__reg_a0__java(long a, long b) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_addw_gpr_gpr_gpr_32__reg_a0__java(values[0], values[1])));
                    answers.append("\n");
