...
// InterpRenderer from the layer-4 term of fsw_fpr_fpr_32__mem_MEM_fa1__dart.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(63, 32, v0), Extract(31, 0, v1))
int emu_fsw_fpr_fpr_32__mem_MEM_fa1__dart(int a, int b) {
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_fsw_fpr_fpr_32__mem_MEM_fa1__dart(values[0], values[1]);
