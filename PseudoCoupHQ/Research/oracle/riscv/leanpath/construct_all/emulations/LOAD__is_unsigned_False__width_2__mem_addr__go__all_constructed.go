...
// intermediate per node of the term of LOAD__is_unsigned_False__width_2__mem_addr__go__all_constructed.
//   
package main

//go:noinline
func emu_LOAD__is_unsigned_False__width_2__mem_addr__go__all_constructed(a uint64, b uint16) uint64 {
...
func main() {
	sink = emu_LOAD__is_unsigned_False__width_2__mem_addr__go__all_constructed(g0, g1)
	_ = sink
}
