/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of DIV__is_unsigned_True__rd__c__native_first.  The term's text, LITERAL:
    */
#include <stdint.h>

uint64_t
emu_DIV__is_unsigned_True__rd__c__native_first(uint64_t a, uint64_t b)
{
