...
theorem au_452_go_band_i32_i32_abi_integer_level (a : BitVec 64) (b : BitVec 64) :
    (((((fun (a : BitVec 64) (b : BitVec 64) => ((pure_RTYPE (a) (b) (AND)))) (((((a) &&& 0xffffffff#64) ^^^ 0x80000000#64) - 0x80000000#64)) (((((b) &&& 0xffffffff#64) ^^^ 0x80000000#64) - 0x80000000#64)))) &&& 0xffffffff#64)) = (((((fun (a : BitVec 64) (b : BitVec 64) => ((pure_ZBA_RTYPEUW ((pure_RTYPE (a) (b) (AND))) (zero_reg) (0b00#2)))) (((((a) &&& 0xffffffff#64) ^^^ 0x80000000#64) - 0x80000000#64)) (((((b) &&& 0xffffffff#64) ^^^ 0x80000000#64) - 0x80000000#64)))) &&& 0xffffffff#64)) := by
  try simp only [pure_RTYPE, pure_ZBA_RTYPEUW, bool_to_bit, log2_xlen, shift_bits_right_arith, zero_extend, zero_reg, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, regtype, zeros, xlenbits, Sail.BitVec.zeroExtend, Sail.BitVec.extractLsb, Sail.shift_bits_left, Sail.shift_bits_right]
  all_goals grind
