...
/-- rust single-opcode row 31, arch mnemonic 'shl', example unit rust/op_462, 13 members
...
theorem ModelCheck_rust_31 (v0 : BitVec 64) (v1 : BitVec 64) :
    ((v0.extractLsb 31 0) <<< ((0#27) ++ (v1.extractLsb 4 0)))
  = ((model_shl_8 (model_mov_15 v0) (model_mov_15 v1)).extractLsb 31 0) := by
  simp only [model_mov_15, model_shl_8]
  bv_decide

#print axioms ModelCheck_rust_31
