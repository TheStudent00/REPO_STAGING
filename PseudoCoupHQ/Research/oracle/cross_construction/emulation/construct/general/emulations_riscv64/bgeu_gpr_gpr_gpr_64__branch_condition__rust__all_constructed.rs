...
// intermediate per node of the term of bgeu_gpr_gpr_gpr_64__branch_condition__rust__all_constructed.
//   If(ULE(v0, v1), 1, 0)
#[no_mangle]
pub extern "C" fn emu_bgeu_gpr_gpr_gpr_64__branch_condition__rust__all_constructed(a: u64, b: u64) -> u64
{
