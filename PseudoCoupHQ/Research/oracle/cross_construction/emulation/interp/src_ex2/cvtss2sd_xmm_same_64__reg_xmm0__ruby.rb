...
# InterpRenderer from the layer-4 term of cvtss2sd_xmm_same_64__reg_xmm0__ruby.
# The term's layer-5 text, LITERAL:
#   fp.to_ieee_bv(fpToFP(RNE(), fpToFP(Extract(31, 0, v0))))
def emu_cvtss2sd_xmm_same_64__reg_xmm0__ruby(a)
  m(fwiden(a, 32, 64), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_cvtss2sd_xmm_same_64__reg_xmm0__ruby(*values)
