...
// intermediate per node of the term of neg_gpr_one_8__flags__go__bit_blast.
//   Concat(Extract(7, 0, v0), 0)
package main

//go:noinline
func emu_neg_gpr_one_8__flags__go__bit_blast(a uint8) uint16 {
...
func main() {
	sink = emu_neg_gpr_one_8__flags__go__bit_blast(g0)
	_ = sink
}
