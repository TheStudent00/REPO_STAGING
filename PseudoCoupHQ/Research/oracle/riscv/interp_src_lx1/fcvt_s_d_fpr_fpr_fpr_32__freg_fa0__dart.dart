...
// InterpRenderer from the layer-4 term of fcvt_s_d_fpr_fpr_fpr_32__freg_fa0__dart.
// The term's layer-5 text, LITERAL:
//   Concat(4294967295, fp.to_ieee_bv(fpToFP(RNE(), fpToFP(v0))))
int emu_fcvt_s_d_fpr_fpr_fpr_32__freg_fa0__dart(int a) {
  return m(cat(4294967295, fwiden(a, 64, 32), 32), 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_fcvt_s_d_fpr_fpr_fpr_32__freg_fa0__dart(values[0]);
