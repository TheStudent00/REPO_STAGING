...
// intermediate per node of the term of movaps_xmm_xmm_128__reg_xmm0_low__go__bit_blast.
//   Extract(63, 0, v0)
package main
...
//go:noinline
func emu_movaps_xmm_xmm_128__reg_xmm0_low__go__bit_blast(a float64) float64 {
...
func main() {
	sink = emu_movaps_xmm_xmm_128__reg_xmm0_low__go__bit_blast(g0)
	_ = sink
}
