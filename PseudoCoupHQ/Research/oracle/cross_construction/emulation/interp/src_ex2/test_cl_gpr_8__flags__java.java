...
public class Emu {
    ...
    // InterpRenderer from the layer-4 term of test_cl_gpr_8__flags__java.
    // The term's layer-5 text, LITERAL:
    //   Concat(~(~Extract(7, 0, v0) | ~Extract(7, 0, v1)), 0)
    static long emu_test_cl_gpr_8__flags__java(long a, long b) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_test_cl_gpr_8__flags__java(values[0], values[1])));
                    answers.append("\n");
