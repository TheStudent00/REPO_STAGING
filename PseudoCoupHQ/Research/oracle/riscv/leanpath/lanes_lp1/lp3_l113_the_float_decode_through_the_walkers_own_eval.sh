#!/bin/bash
# lp3_l113_the_float_decode_through_the_walkers_own_eval.sh
#
...
#
# Writes $A/runs/float_decode2 only. Budget: fifteen minutes.
set -uo pipefail
...
D=$A/runs/float_decode2; mkdir -p $D
t0=$(date +%s)
...
X, PLIB = "/work/Lean_IM_pr_exec", "LeanIM"
D = "PseudoCoupHQ/Research/oracle/riscv/leanpath/runs/float_decode2"
