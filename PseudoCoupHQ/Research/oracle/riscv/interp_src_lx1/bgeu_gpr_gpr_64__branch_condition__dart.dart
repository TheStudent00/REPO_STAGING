...
// InterpRenderer from the layer-4 term of bgeu_gpr_gpr_64__branch_condition__dart.
// The term's layer-5 text, LITERAL:
//   If(ULE(v0, v1), 1, 0)
int emu_bgeu_gpr_gpr_64__branch_condition__dart(int a, int b) {
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_bgeu_gpr_gpr_64__branch_condition__dart(values[0], values[1]);
