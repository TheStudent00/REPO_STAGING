; ModuleID = '<scratch>/fl/run/ui64_to_f64.rm0.value/ui64_to_f64.rm0.value.rv.flat.ll'
source_filename = "llvm-link"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128"
target triple = "riscv64-unknown-unknown-elf"

define dso_local i64 @ui64_to_f64_rm0_value_flat(i64 noundef %arg) {
  %i = icmp eq i64 %arg, 0
  %.n25 = xor i1 %i, true
  %.m26 = sext i1 %.n25 to i64
  ...
  %i47 = add i64 %i42, %i46
  %.n13 = xor i1 %i2, true
  %.m14 = sext i1 %.n13 to i64
  %.a15 = and i64 %i17, %.m14
  %.m17 = sext i1 %i24 to i64
  %.a18 = and i64 %i31, %.m17
  %.o19 = or i64 %.a15, %.a18
  %.n20 = xor i1 %i24, true
  %.c21 = and i1 %.n20, %i2
