...
// InterpRenderer from the layer-4 term of lui_gpr_imm_32__reg_a0__dart.
// The term's layer-5 text, LITERAL:
//   12288
int emu_lui_gpr_imm_32__reg_a0__dart() {
  return m(12288, 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_lui_gpr_imm_32__reg_a0__dart();
