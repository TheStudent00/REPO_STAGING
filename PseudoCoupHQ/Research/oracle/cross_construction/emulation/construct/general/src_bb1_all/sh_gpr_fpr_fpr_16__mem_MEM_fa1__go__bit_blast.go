...
// intermediate per node of the term of sh_gpr_fpr_fpr_16__mem_MEM_fa1__go__bit_blast.
//   Concat(Extract(63, 16, v0), Extract(15, 0, v1))
package main

//go:noinline
func emu_sh_gpr_fpr_fpr_16__mem_MEM_fa1__go__bit_blast(a uint64, b uint16) uint64 {
...
func main() {
	sink = emu_sh_gpr_fpr_fpr_16__mem_MEM_fa1__go__bit_blast(g0, g1)
	_ = sink
}
