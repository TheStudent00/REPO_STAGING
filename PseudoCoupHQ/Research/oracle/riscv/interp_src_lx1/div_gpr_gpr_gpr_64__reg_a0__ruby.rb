...
# InterpRenderer from the layer-4 term of div_gpr_gpr_gpr_64__reg_a0__ruby.
...
def emu_div_gpr_gpr_gpr_64__reg_a0__ruby(a, b)
  m(((eq(a, 0, 64)) ? (18446744073709551615) : (((((eq(a, 18446744073709551615, 64)) && (eq(b, 9223372036854775808, 64)))) ? (9223372036854775808) : (sdiv(b, a, 64))))), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_div_gpr_gpr_gpr_64__reg_a0__ruby(*values)
