---
id: hq.research.arch_unit_oracle.simplification.learned_proposal.model.check
---

# CHECK — 0_3_2_4_4_1_model

Node `hq.research.arch_unit_oracle.simplification.learned_proposal.model`. Status `draft`.
