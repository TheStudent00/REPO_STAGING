...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of fsw_fpr_fpr_32__mem_MEM_fa1__csharp.
    // The term's layer-5 text, LITERAL:
    //   Concat(Extract(63, 32, v0), Extract(31, 0, v1))
    public static long emu_fsw_fpr_fpr_32__mem_MEM_fa1__csharp(long a, long b) {
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_fsw_fpr_fpr_32__mem_MEM_fa1__csharp(values[0], values[1])).ToString());
                    answers.Append("\n");
