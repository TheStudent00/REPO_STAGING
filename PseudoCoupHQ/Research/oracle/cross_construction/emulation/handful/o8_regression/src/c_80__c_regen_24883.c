/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of c_80__c_regen_24883.  The term's layer-5 text, LITERAL:
   Concat(Extract(63, 32, v0), Extract(31, 0, v0) ^ Extract(31, 0, v1)) */
#include <stdint.h>

uint64_t
emu_c_80__c_regen_24883(uint64_t a, uint64_t b, uint32_t c)
{
