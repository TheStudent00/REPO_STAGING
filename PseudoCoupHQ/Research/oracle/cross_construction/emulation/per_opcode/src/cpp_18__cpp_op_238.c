/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of cpp_18__cpp_op_238.  The term's layer-5 text, LITERAL:
...
double
emu_cpp_18__cpp_op_238(double a, double b)
{
