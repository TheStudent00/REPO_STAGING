...
// InterpRenderer from the layer-4 term of setb_gpr_one_8__reg_rdi__php.
// The term's layer-5 text, LITERAL:
//   Concat(0, If(ULE(Extract(7, 0, v0), Extract(7, 0, v1)), 0, 1))
function emu_setb_gpr_one_8__reg_rdi__php($a, $b) {
    return ex_m(ex_cat(0, ((ex_ule($b, $a, 8)) ? (0) : (1)), 8), 64);
}
