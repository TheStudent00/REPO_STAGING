...
# InterpRenderer from the layer-4 term of cmp_imm_gpr_16__flags__cpython.
# The term's layer-5 text, LITERAL:
#   Concat(Extract(15, 0, v0), Extract(15, 0, v1))
def emu_cmp_imm_gpr_16__flags__cpython(a, b):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_cmp_imm_gpr_16__flags__cpython(*values)
            sys.stdout.write("%d\n" % answer)
