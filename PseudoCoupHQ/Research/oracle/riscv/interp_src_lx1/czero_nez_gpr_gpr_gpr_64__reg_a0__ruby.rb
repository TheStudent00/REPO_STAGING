...
# InterpRenderer from the layer-4 term of czero_nez_gpr_gpr_gpr_64__reg_a0__ruby.
# The term's layer-5 text, LITERAL:
#   If(v0 == 0, v1, 0)
def emu_czero_nez_gpr_gpr_gpr_64__reg_a0__ruby(a, b)
  m(((eq(a, 0, 64)) ? (b) : (0)), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_czero_nez_gpr_gpr_gpr_64__reg_a0__ruby(*values)
