...
/-- go single-opcode row 14, arch mnemonic 'not', example unit go/op_18, 7 members
...
theorem ModelCheck_go_14 (v0 : BitVec 64) :
    (~~~(v0.extractLsb 31 0))
  = ((model_not_7 v0).extractLsb 31 0) := by
  simp only [model_not_7]
  bv_decide

#print axioms ModelCheck_go_14
