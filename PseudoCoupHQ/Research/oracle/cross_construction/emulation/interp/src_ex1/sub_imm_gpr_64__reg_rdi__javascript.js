...
// InterpRenderer from the layer-4 term of sub_imm_gpr_64__reg_rdi__javascript.
// The term's layer-5 text, LITERAL:
//   v0 + 18446744073709551613
function emu_sub_imm_gpr_64__reg_rdi__javascript(a) {
    return m(add(a, 18446744073709551613n, 64), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_sub_imm_gpr_64__reg_rdi__javascript(...values).toString());
    } catch (problem) {
