...
# CORE 0_3_2 — kind_fuzz_clustering
...
2. **run** — through the Airlock agent lane
   (`python3 <WORKSPACE_DIR>/Airlock/airlock submit <lane.sh> --batch
...
- the layers are the co-node's anchor
  ([CORE_0_3_4_data_representation.md](../node_0_3_4_data_representation/CORE_0_3_4_data_representation.md)):
