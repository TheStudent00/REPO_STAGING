...
// InterpRenderer from the layer-4 term of sbb_gpr_same_64__reg_rdi__javascript.
...
function emu_sbb_gpr_same_64__reg_rdi__javascript(a, b, c) {
    return m(mul(((eq(ext(add(cat(0n, b, 64), cat(0n, a, 64), 65), 64, 64), 1n, 1)) ? (1n) : (0n)), 18446744073709551615n, 64), 64);
}
