#!/usr/bin/env bash
# g1_l15_guard4.sh -- task g1: the unmodified spelling guard over every
...
# pool member at all.
#
# The guard itself is never modified and nothing of the kind is claimed
# anywhere; the same grep over every file this task added answers 0
...
grep -c exempt $H/go/go_facts.py $H/go/go_render.py \
    ...
    $H/handful/lanes_g1/g1_l12_run_of_record2.sh
echo "done"
