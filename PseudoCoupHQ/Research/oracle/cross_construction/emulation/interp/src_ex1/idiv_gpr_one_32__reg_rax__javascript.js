...
// InterpRenderer from the layer-4 term of idiv_gpr_one_32__reg_rax__javascript.
...
for (const line of lines) {
    ...
    try {
        out.push(emu_idiv_gpr_one_32__reg_rax__javascript(...values).toString());
    } catch (problem) {
