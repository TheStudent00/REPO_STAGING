...
theorem meaning_emul_au_448_go_shr_i64_u64 (s : St) (a : BitVec 64) (b : BitVec 64) (h10 : s.regs.get? .x10 = some a) (h11 : s.regs.get? .x11 = some b) (hk0 : ∀ {α : Type} (x0 : α) (s : St), (plat_term_write x0) s = EStateM.Result.ok () s) (hk1 : ∀ (x0 : Arch.pa) (x1 : Nat) (s : St), (load_reservation x0 x1) s = EStateM.Result.ok () s) (hk2 : ∀ (x0 : Unit) (s : St), (cancel_reservation x0) s = EStateM.Result.ok () s) :
    runsTo (walk [LeanIM.instruction.ITYPE (0x03f#12, LeanIM.regidx.Regidx 0x00#5, LeanIM.regidx.Regidx 0x0c#5, LeanIM.iop.ADDI), LeanIM.instruction.ZBB_RTYPE (LeanIM.regidx.Regidx 0x0c#5, LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0b#5, LeanIM.brop_zbb.MINU), LeanIM.instruction.SHIFTIOP (0x3f#6, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0c#5, LeanIM.sop.SRAI), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.rop.SRL), LeanIM.instruction.ITYPE (0x03f#12, LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0b#5, LeanIM.iop.XORI), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0c#5, LeanIM.regidx.Regidx 0x0b#5, LeanIM.rop.SLL), LeanIM.instruction.C_SLLI (0x01#6, LeanIM.regidx.Regidx 0x0b#5), LeanIM.instruction.C_OR (LeanIM.cregidx.Cregidx 0x2#3, LeanIM.cregidx.Cregidx 0x3#3)]) s
      ((pure_RTYPE ((pure_RTYPE (a) ((pure_ZBB_RTYPE (b) ((pure_ITYPE (zero_reg) (0x03f#12) (LeanIM.iop.ADDI))) (LeanIM.brop_zbb.MINU))) (LeanIM.rop.SRL))) ((pure_SHIFTIOP ((pure_RTYPE ((pure_SHIFTIOP (a) (0x3f#6) (LeanIM.sop.SRAI))) ((pure_ITYPE ((pure_ZBB_RTYPE (b) ((pure_ITYPE (zero_reg) (0x03f#12) (LeanIM.iop.ADDI))) (LeanIM.brop_zbb.MINU))) (0x03f#12) (LeanIM.iop.XORI))) (LeanIM.rop.SLL))) ((0x01#6)) (SLLI))) (OR))) := by
  simp (config := {decide := true}) [runsTo, walk, step, execute, strip_C_SLLI, strip_C_OR, strip_ITYPE, strip_ZBB_RTYPE, strip_SHIFTIOP, strip_RTYPE, alias_C_SLLI, alias_C_OR,
