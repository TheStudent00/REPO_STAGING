...
// one named local per gate, over the term of sete_gpr_one_8__reg_rdi__php.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(63, 8, v0), If(Extract(7, 0, v1) == Extract(7, 0, v2), 1, 0))
function emu_sete_gpr_one_8__reg_rdi__php($a, $b, $c) {
    $x1_7 = ex_ext($b, 7, 7);
    $x2_7 = ex_ext($a, 7, 7);
    $x2_6 = ex_ext($a, 6, 6);
    $x1_6 = ex_ext($b, 6, 6);
    ...
    $x0_8 = ex_ext($c, 8, 8);
    $x0_9 = ex_ext($c, 9, 9);
    $x0_10 = ex_ext($c, 10, 10);
    $x0_11 = ex_ext($c, 11, 11);
    $x0_12 = ex_ext($c, 12, 12);
    $x0_13 = ex_ext($c, 13, 13);
    $x0_14 = ex_ext($c, 14, 14);
    $x0_15 = ex_ext($c, 15, 15);
    $x0_16 = ex_ext($c, 16, 16);
    $x0_17 = ex_ext($c, 17, 17);
    $x0_18 = ex_ext($c, 18, 18);
    $x0_19 = ex_ext($c, 19, 19);
    $x0_20 = ex_ext($c, 20, 20);
    $x0_21 = ex_ext($c, 21, 21);
    $x0_22 = ex_ext($c, 22, 22);
    $x0_23 = ex_ext($c, 23, 23);
    $x0_24 = ex_ext($c, 24, 24);
    $x0_25 = ex_ext($c, 25, 25);
    $x0_26 = ex_ext($c, 26, 26);
    $x0_27 = ex_ext($c, 27, 27);
    $x0_28 = ex_ext($c, 28, 28);
    $x0_29 = ex_ext($c, 29, 29);
    $x0_30 = ex_ext($c, 30, 30);
    $x0_31 = ex_ext($c, 31, 31);
    $x0_32 = ex_ext($c, 32, 32);
    $x0_33 = ex_ext($c, 33, 33);
    $x0_34 = ex_ext($c, 34, 34);
    $x0_35 = ex_ext($c, 35, 35);
    $x0_36 = ex_ext($c, 36, 36);
    $x0_37 = ex_ext($c, 37, 37);
    $x0_38 = ex_ext($c, 38, 38);
    $x0_39 = ex_ext($c, 39, 39);
    $x0_40 = ex_ext($c, 40, 40);
    $x0_41 = ex_ext($c, 41, 41);
    $x0_42 = ex_ext($c, 42, 42);
    $x0_43 = ex_ext($c, 43, 43);
    $x0_44 = ex_ext($c, 44, 44);
    $x0_45 = ex_ext($c, 45, 45);
    $x0_46 = ex_ext($c, 46, 46);
    $x0_47 = ex_ext($c, 47, 47);
    $x0_48 = ex_ext($c, 48, 48);
    $x0_49 = ex_ext($c, 49, 49);
    $x0_50 = ex_ext($c, 50, 50);
    $x0_51 = ex_ext($c, 51, 51);
    $x0_52 = ex_ext($c, 52, 52);
    $x0_53 = ex_ext($c, 53, 53);
    $x0_54 = ex_ext($c, 54, 54);
    $x0_55 = ex_ext($c, 55, 55);
    $x0_56 = ex_ext($c, 56, 56);
    $x0_57 = ex_ext($c, 57, 57);
    $x0_58 = ex_ext($c, 58, 58);
    $x0_59 = ex_ext($c, 59, 59);
    $x0_60 = ex_ext($c, 60, 60);
    $x0_61 = ex_ext($c, 61, 61);
    $x0_62 = ex_ext($c, 62, 62);
    $x0_63 = ex_ext($c, 63, 63);
    $g0 = ($x2_7 ^ 1);
    $g1 = ($g0 | $x1_7);
    $g2 = ($x1_7 ^ 1);
    $g3 = ($x2_7 | $g2);
    ...
    $w49 = ex_cat($w48, $x0_14, 1);
    $w50 = ex_cat($w49, $x0_13, 1);
    $w51 = ex_cat($w50, $x0_12, 1);
    $w52 = ex_cat($w51, $x0_11, 1);
    $w53 = ex_cat($w52, $x0_10, 1);
    $w54 = ex_cat($w53, $x0_9, 1);
    $w55 = ex_cat($w54, $x0_8, 1);
    $w56 = ex_cat($w55, $k0, 1);
    $w57 = ex_cat($w56, $k0, 1);
    $w58 = ex_cat($w57, $k0, 1);
    $w59 = ex_cat($w58, $k0, 1);
...
while (($line = fgets($handle)) !== false) {
    ...
    try {
        $answer = emu_sete_gpr_one_8__reg_rdi__php(...$ints);
        if ($answer < 0) {
            echo sprintf("%s\n", sprintf("%u", $answer));
        } else {
            echo $answer . "\n";
