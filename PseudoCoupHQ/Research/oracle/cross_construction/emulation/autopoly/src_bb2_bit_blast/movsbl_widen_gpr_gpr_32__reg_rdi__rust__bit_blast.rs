...
// intermediate per node of the term of movsbl_widen_gpr_gpr_32__reg_rdi__rust__bit_blast.
...
#[no_mangle]
pub extern "C" fn emu_movsbl_widen_gpr_gpr_32__reg_rdi__rust__bit_blast(a: u8) -> u64
{
