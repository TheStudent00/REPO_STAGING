...
theorem meaning_xori_gpr_gpr_imm_64__reg_a0__go__all_constructed (s : St) (a : BitVec 64) (c : BitVec 64) (h10 : s.regs.get? .x10 = some a) (h12 : s.regs.get? .x12 = some c) (hk0 : ∀ {α : Type} (x0 : α) (s : St), (plat_term_write x0) s = EStateM.Result.ok () s) (hk1 : ∀ (x0 : Arch.pa) (x1 : Nat) (s : St), (load_reservation x0 x1) s = EStateM.Result.ok () s) (hk2 : ∀ (x0 : Unit) (s : St), (cancel_reservation x0) s = EStateM.Result.ok () s) :
    runsTo (walk [LeanIM.instruction.ITYPE (0x003#12, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x05#5, LeanIM.iop.ANDI), LeanIM.instruction.ITYPE (0xfff#12, LeanIM.regidx.Regidx 0x05#5, LeanIM.regidx.Regidx 0x05#5, LeanIM.iop.XORI), LeanIM.instruction.ITYPE (0x003#12, LeanIM.regidx.Regidx 0x05#5, LeanIM.regidx.Regidx 0x05#5, LeanIM.iop.ANDI), LeanIM.instruction.ITYPE (0xffc#12, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x06#5, LeanIM.iop.ANDI), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x05#5, LeanIM.regidx.Regidx 0x06#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.rop.OR)]) s
      ((pure_RTYPE ((pure_ITYPE (a) (0xffc#12) (LeanIM.iop.ANDI))) ((pure_ITYPE ((pure_ITYPE ((pure_ITYPE (a) (0x003#12) (LeanIM.iop.ANDI))) (0xfff#12) (LeanIM.iop.XORI))) (0x003#12) (LeanIM.iop.ANDI))) (LeanIM.rop.OR))) := by
