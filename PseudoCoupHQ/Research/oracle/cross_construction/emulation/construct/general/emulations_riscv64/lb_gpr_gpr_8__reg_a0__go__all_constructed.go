...
// intermediate per node of the term of lb_gpr_gpr_8__reg_a0__go__all_constructed.
...
//go:noinline
func emu_lb_gpr_gpr_8__reg_a0__go__all_constructed(a uint8) uint64 {
...
func main() {
	sink = emu_lb_gpr_gpr_8__reg_a0__go__all_constructed(g0)
	_ = sink
}
