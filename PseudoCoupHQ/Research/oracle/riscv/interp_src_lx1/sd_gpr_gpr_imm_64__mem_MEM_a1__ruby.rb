...
# InterpRenderer from the layer-4 term of sd_gpr_gpr_imm_64__mem_MEM_a1__ruby.
# The term's layer-5 text, LITERAL:
#   v0
def emu_sd_gpr_gpr_imm_64__mem_MEM_a1__ruby(a)
  m(a, 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_sd_gpr_gpr_imm_64__mem_MEM_a1__ruby(*values)
