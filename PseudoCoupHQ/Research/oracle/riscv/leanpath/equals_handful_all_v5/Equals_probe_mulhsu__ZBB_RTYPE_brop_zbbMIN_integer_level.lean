...
theorem probe_mulhsu__ZBB_RTYPE_brop_zbbMIN_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_MUL (a) (b) ({ result_part := LeanIM.VectorHalf.High, signed_rs1 := LeanIM.Signedness.Signed, signed_rs2 := LeanIM.Signedness.Unsigned }))) = (pure_ZBB_RTYPE (a) (b) (brop_zbb.MIN)) := by
