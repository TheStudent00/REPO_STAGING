...
// SwiftRenderer from the layer-4 term of pand_xmm_xmm_128__reg_xmm0_low__swift.
// EVERY SPELLING IN THIS SOURCE IS UNMEASURED: there is no swiftc in
// the image, so nothing here has been compiled or carved.
// The term's layer-5 text, LITERAL:
//   ~(~Extract(63, 0, v0) | ~Extract(63, 0, v1))
@_cdecl("emu_pand_xmm_xmm_128__reg_xmm0_low__swift")
public func emu_pand_xmm_xmm_128__reg_xmm0_low__swift(_ a: Double, _ b: Double) -> Double
{
