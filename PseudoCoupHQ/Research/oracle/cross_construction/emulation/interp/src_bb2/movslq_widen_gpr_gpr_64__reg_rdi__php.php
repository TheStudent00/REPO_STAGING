...
// one named local per gate, over the term of movslq_widen_gpr_gpr_64__reg_rdi__php.
...
function emu_movslq_widen_gpr_gpr_64__reg_rdi__php($a) {
    $x0_0 = ex_ext($a, 0, 0);
    $x0_1 = ex_ext($a, 1, 1);
    $x0_2 = ex_ext($a, 2, 2);
    $x0_3 = ex_ext($a, 3, 3);
    ...
    $w0 = $x0_31;
    $w1 = ex_cat($w0, $x0_31, 1);
    $w2 = ex_cat($w1, $x0_31, 1);
    $w3 = ex_cat($w2, $x0_31, 1);
    $w4 = ex_cat($w3, $x0_31, 1);
    $w5 = ex_cat($w4, $x0_31, 1);
    $w6 = ex_cat($w5, $x0_31, 1);
    $w7 = ex_cat($w6, $x0_31, 1);
    $w8 = ex_cat($w7, $x0_31, 1);
    $w9 = ex_cat($w8, $x0_31, 1);
    $w10 = ex_cat($w9, $x0_31, 1);
    $w11 = ex_cat($w10, $x0_31, 1);
    $w12 = ex_cat($w11, $x0_31, 1);
    $w13 = ex_cat($w12, $x0_31, 1);
    $w14 = ex_cat($w13, $x0_31, 1);
    $w15 = ex_cat($w14, $x0_31, 1);
    $w16 = ex_cat($w15, $x0_31, 1);
    $w17 = ex_cat($w16, $x0_31, 1);
    $w18 = ex_cat($w17, $x0_31, 1);
    $w19 = ex_cat($w18, $x0_31, 1);
    $w20 = ex_cat($w19, $x0_31, 1);
    $w21 = ex_cat($w20, $x0_31, 1);
    $w22 = ex_cat($w21, $x0_31, 1);
    $w23 = ex_cat($w22, $x0_31, 1);
    $w24 = ex_cat($w23, $x0_31, 1);
    $w25 = ex_cat($w24, $x0_31, 1);
    $w26 = ex_cat($w25, $x0_31, 1);
    $w27 = ex_cat($w26, $x0_31, 1);
    $w28 = ex_cat($w27, $x0_31, 1);
    $w29 = ex_cat($w28, $x0_31, 1);
    $w30 = ex_cat($w29, $x0_31, 1);
    $w31 = ex_cat($w30, $x0_31, 1);
...
while (($line = fgets($handle)) !== false) {
    ...
    try {
        $answer = emu_movslq_widen_gpr_gpr_64__reg_rdi__php(...$ints);
        if ($answer < 0) {
            echo sprintf("%s\n", sprintf("%u", $answer));
        } else {
            echo $answer . "\n";
