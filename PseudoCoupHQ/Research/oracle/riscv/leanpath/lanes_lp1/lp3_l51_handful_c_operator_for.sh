#!/bin/bash
# lp3_l51_handful_c_operator_for.sh -- plan node
...
# Lean; every certified unit of the l50 walk is proved against every
...
export EQUALS_UNIT_BUDGET_S=120 EQUALS_CHUNK=12; start=$(date +%s)
