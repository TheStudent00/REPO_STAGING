/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of movss_mem_xmm_32__reg_xmm0__cpp__bit_blast.  The term's text, LITERAL:
   Extract(31, 0, v0) */
#include <cstdint>
#include <cstring>
...
extern "C"
float
emu_movss_mem_xmm_32__reg_xmm0__cpp__bit_blast(uint32_t a)
{
