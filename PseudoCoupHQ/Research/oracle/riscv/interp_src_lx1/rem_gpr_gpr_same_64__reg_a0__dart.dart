...
// InterpRenderer from the layer-4 term of rem_gpr_gpr_same_64__reg_a0__dart.
// The term's layer-5 text, LITERAL:
//   If(v0 == 0, v0, If(And(v0 == 18446744073709551615, v0 == 9223372036854775808), 0, bvsrem_i(v0, v0)))
int emu_rem_gpr_gpr_same_64__reg_a0__dart(int a) {
  return m(((eq(a, 0, 64)) ? (a) : (((((eq(a, -1, 64)) && (eq(a, -9223372036854775808, 64)))) ? (0) : (srem(a, a, 64))))), 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_rem_gpr_gpr_same_64__reg_a0__dart(values[0]);
