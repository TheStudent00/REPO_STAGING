...
// GoRenderer from the layer-4 term of div_gpr_one_32__reg_rdx__go.
// The term's layer-5 text, LITERAL:
//   Concat(0, Extract(31, 0, bvurem_i(Concat(Extract(31, 0, v0), Extract(31, 0, v1)), Concat(0, Extract(31, 0, v2)))))
package main

//go:noinline
func emu_div_gpr_one_32__reg_rdx__go(a uint32, b uint32, c uint32) uint64 {
...
func main() {
	sink = emu_div_gpr_one_32__reg_rdx__go(g0, g1, g2)
	_ = sink
}
