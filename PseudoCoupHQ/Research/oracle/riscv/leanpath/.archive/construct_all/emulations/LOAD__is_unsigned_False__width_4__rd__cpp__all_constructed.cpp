/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of LOAD__is_unsigned_False__width_4__rd__cpp__all_constructed.  The term's text, LITERAL:
    */
#include <cstdint>

extern "C"
uint64_t
emu_LOAD__is_unsigned_False__width_4__rd__cpp__all_constructed(uint32_t a)
{
    ...
    uint64_t v35 = (uint64_t)(((uint64_t)(v34) << 32) | (uint64_t)(v2));
    return (uint64_t)(v35);
}
