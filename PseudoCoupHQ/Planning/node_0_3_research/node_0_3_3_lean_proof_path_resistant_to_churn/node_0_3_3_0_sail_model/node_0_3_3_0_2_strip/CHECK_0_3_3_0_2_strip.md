---
id: hq.research.lean_proof_path_resistant_to_churn.sail_model.strip.check
---

# CHECK — 0_3_3_0_2_strip

Node `hq.research.lean_proof_path_resistant_to_churn.sail_model.strip`. Status `draft`.
