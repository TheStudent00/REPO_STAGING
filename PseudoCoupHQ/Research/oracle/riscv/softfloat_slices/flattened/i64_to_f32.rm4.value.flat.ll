; ModuleID = '<scratch>/fl/run/i64_to_f32.rm4.value/i64_to_f32.rm4.value.rv.flat.ll'
source_filename = "llvm-link"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128"
target triple = "riscv64-unknown-unknown-elf"

define dso_local i64 @i64_to_f32_rm4_value_flat(i64 noundef %arg) {
  %i = icmp slt i64 %arg, 0
  %.m20 = sext i1 %i to i32
  %i44 = and i32 -2147483648, %.m20
  ...
  %.a18 = and i32 %.o13, %.m17
  %i39 = add i32 %.a18, 64
  %.m24 = sext i1 %.n14 to i32
  %.m29 = sext i1 %.n15 to i32
  %.sh19 = lshr i32 %i39, 7
  %i40 = freeze i32 %.sh19
  %i48 = or i32 %i40, %i44
  %i43 = icmp ult i32 %i39, 128
  %.m22 = sext i1 %i43 to i32
  %.n23 = xor i32 %.m22, -1
  %i47 = and i32 %i46, %.n23
  %i49 = add i32 %i48, %i47
  %.a25 = and i32 %i49, %.m24
