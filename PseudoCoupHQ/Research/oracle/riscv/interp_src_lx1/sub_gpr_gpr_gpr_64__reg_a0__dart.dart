...
// InterpRenderer from the layer-4 term of sub_gpr_gpr_gpr_64__reg_a0__dart.
// The term's layer-5 text, LITERAL:
//   v0*18446744073709551615 + v1
int emu_sub_gpr_gpr_gpr_64__reg_a0__dart(int a, int b) {
  return m(add(mul(b, -1, 64), a, 64), 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_sub_gpr_gpr_gpr_64__reg_a0__dart(values[0], values[1]);
