...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of movsbq_widen_gpr_gpr_64__reg_rdi__csharp.
    ...
    public static long emu_movsbq_widen_gpr_gpr_64__reg_rdi__csharp(long a) {
        return m(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(ext(a, 7, 7), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), a, 8), 64);
    }
