...
// intermediate per node of the term of LOAD__is_unsigned_False__width_2__rd__rust__native_first.
//   
#[no_mangle]
pub extern "C" fn emu_LOAD__is_unsigned_False__width_2__rd__rust__native_first(a: u16) -> u64
{
    let v0: u32 = (a as u32);
