...
theorem c_op_174__ZBB_RTYPEW_bropw_zbbROR_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_MULW (b) (a))) = (pure_ZBB_RTYPEW (a) (b) (bropw_zbb.RORW)) := by
  simp only [pure_MULW, pure_ZBB_RTYPEW]
  grind
