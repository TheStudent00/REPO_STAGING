...
theorem au_407_c_ne_i32_i32_plain_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (zero_reg) ((pure_RTYPE (a) (b) (XOR))) (LeanIM.rop.SLTU))) = ((pure_RTYPE (zero_reg) ((pure_ADDIW ((pure_RTYPE (a) (b) (XOR))) ((sign_extend (m := 12) (0x00#6))))) (LeanIM.rop.SLTU))) := by
