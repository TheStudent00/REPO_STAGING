...
// one named local per gate, over the term of sub_gpr_gpr_8__reg_rdi__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(63, 8, v0), Extract(7, 0, v1)*255 + Extract(7, 0, v0))
function emu_sub_gpr_gpr_8__reg_rdi__javascript(a, b) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_sub_gpr_gpr_8__reg_rdi__javascript(...values).toString());
    } catch (problem) {
