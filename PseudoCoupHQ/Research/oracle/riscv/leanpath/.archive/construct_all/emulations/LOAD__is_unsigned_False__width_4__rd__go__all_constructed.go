...
// intermediate per node of the term of LOAD__is_unsigned_False__width_4__rd__go__all_constructed.
//   
package main

//go:noinline
func emu_LOAD__is_unsigned_False__width_4__rd__go__all_constructed(a uint32) uint64 {
...
func main() {
	sink = emu_LOAD__is_unsigned_False__width_4__rd__go__all_constructed(g0)
	_ = sink
}
