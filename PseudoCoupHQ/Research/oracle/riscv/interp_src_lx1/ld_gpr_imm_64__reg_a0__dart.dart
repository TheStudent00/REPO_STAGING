...
// InterpRenderer from the layer-4 term of ld_gpr_imm_64__reg_a0__dart.
// The term's layer-5 text, LITERAL:
//   v0
int emu_ld_gpr_imm_64__reg_a0__dart(int a) {
  return m(a, 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_ld_gpr_imm_64__reg_a0__dart(values[0]);
