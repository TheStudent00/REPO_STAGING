...
# InterpRenderer from the layer-4 term of setns_gpr_one_8__reg_rdi__cpython.
# The term's layer-5 text, LITERAL:
#   Concat(0, If(0 <= ~(~Extract(7, 0, v0) | ~Extract(7, 0, v1)), 1, 0))
def emu_setns_gpr_one_8__reg_rdi__cpython(a, b):
    return m(cat(0, ((1) if (sle(0, bnot(bor(bnot(a, 8), bnot(b, 8), 8), 8), 8)) else (0)), 8), 64)
