...
(`~/Programming/Airlock/agent/logs/20260901T154246Z__t27_php_clean_build2.sh.log`):
...
wrote ~/Programming/PseudoCoupHQ/Research/op_pipeline/op_units_ruby.json
...
wrote ~/Programming/PseudoCoupHQ/Research/op_pipeline/op_units_php.json
...
wrote ~/Programming/PseudoCoupHQ/Research/op_pipeline/lineage_carve.json
...
wrote ~/Programming/PseudoCoupHQ/Research/op_pipeline/prove_interp_computation.json
...
wrote ~/Programming/PseudoCoupHQ/Research/op_pipeline/proposal_representation_dimension3.json
summary: {
...
```
$ cd ~/Programming/PseudoCoupHQ && git status --porcelain Research/op_pipeline/
...
- `~/Programming/PseudoCoupHQ/Research/op_pipeline/t27_ruby_dump.sh` —
  the Airlock lane that disassembled ruby's handlers out of both pinned
  builds. 1311 bytes.
- `~/Programming/PseudoCoupHQ/Research/op_pipeline/t27_php_clean_build.sh`
...
- `~/Programming/PseudoCoupHQ/Research/op_pipeline/t27_php_clean_build2.sh`
  — the lane that built the clean php pair (adds `-std=gnu17`) and
  dumped ruby's `rb_fix_plus_fix`. 2832 bytes.
- `~/Programming/PseudoCoupHQ/Research/op_pipeline/build_op_units_ruby.py`
  — ruby slice builder. 11137 bytes.
- `~/Programming/PseudoCoupHQ/Research/op_pipeline/op_units_ruby.json`
  — ruby slices, op_units shape. 75171 bytes.
- `~/Programming/PseudoCoupHQ/Research/op_pipeline/build_op_units_php.py`
  — php slice builder. 11935 bytes.
- `~/Programming/PseudoCoupHQ/Research/op_pipeline/op_units_php.json`
  — php slices, op_units shape, from the clean pair. 52470 bytes.
- `~/Programming/PseudoCoupHQ/Research/op_pipeline/dwarf_typed_key_t27.py`
  — the typed-key read over the binaries this task carves. 5950 bytes.
- `~/Programming/PseudoCoupHQ/Research/op_pipeline/dwarf_typed_key_t27.json`
  — its output, 20 records. 19433 bytes.
- `~/Programming/PseudoCoupHQ/Research/op_pipeline/lineage_carve.py` —
  the lineage-confluence carve. 31128 bytes.
- `~/Programming/PseudoCoupHQ/Research/op_pipeline/lineage_carve.json`
  — its output, 20 records. 290208 bytes.
- `~/Programming/PseudoCoupHQ/Research/op_pipeline/prove_interp_computation.py`
  — the computation-part prover driver. 13496 bytes.
- `~/Programming/PseudoCoupHQ/Research/op_pipeline/prove_interp_computation.json`
  — its output, 11 records. 18567 bytes.
- `~/Programming/PseudoCoupHQ/Research/op_pipeline/build_proposal_representation_dimension3.py`
  — the proposal extender. 14382 bytes.
- `~/Programming/PseudoCoupHQ/Research/op_pipeline/proposal_representation_dimension3.json`
...
the lane products under `~/Programming/Airlock/agent/out/t27/`.
