...
# InterpRenderer from the layer-4 term of fadd_s_fpr_fpr_fpr_32__freg_fa0__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(4294967295, fp.to_ieee_bv(fpToFP(Extract(31, 0, v0)) + fpToFP(Extract(31, 0, v1))))
def emu_fadd_s_fpr_fpr_fpr_32__freg_fa0__ruby(a, b)
  m(cat(4294967295, fadd(a, b, 32), 32), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_fadd_s_fpr_fpr_fpr_32__freg_fa0__ruby(*values)
