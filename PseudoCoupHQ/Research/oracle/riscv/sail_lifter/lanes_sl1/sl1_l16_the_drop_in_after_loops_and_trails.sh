#!/bin/bash
# sl1 lane 16 -- lane 15 again after the reader gained loops, mutable variables, a statement-wise tolerant reset and call trails on refusals. The drop-in riscv_reference.py (its walk now the model's
