...
public class Emu {
    ...
    // InterpRenderer from the layer-4 term of remu_gpr_gpr_same_64__reg_a0__java.
    // The term's layer-5 text, LITERAL:
    //   If(v0 == 0, v0, bvurem_i(v0, v0))
    static long emu_remu_gpr_gpr_same_64__reg_a0__java(long a) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_remu_gpr_gpr_same_64__reg_a0__java(values[0])));
                    answers.append("\n");
