...
// intermediate per node of the term of flw_fpr_fpr_fpr_32__freg_fa0__go__bit_blast.
//   Concat(4294967295, Extract(31, 0, v0))
package main

//go:noinline
func emu_flw_fpr_fpr_fpr_32__freg_fa0__go__bit_blast(a uint32) uint64 {
...
func main() {
	sink = emu_flw_fpr_fpr_fpr_32__freg_fa0__go__bit_blast(g0)
	_ = sink
}
