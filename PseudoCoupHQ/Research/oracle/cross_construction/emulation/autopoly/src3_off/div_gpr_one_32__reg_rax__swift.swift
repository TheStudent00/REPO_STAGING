...
// SwiftRenderer from the layer-4 term of div_gpr_one_32__reg_rax__swift.
...
@_cdecl("emu_div_gpr_one_32__reg_rax__swift")
public func emu_div_gpr_one_32__reg_rax__swift(_ a: UInt32, _ b: UInt32, _ c: UInt32) -> UInt64
{
