/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of swift_13__swift_op_286.  The term's layer-5 text, LITERAL:
...
double
emu_swift_13__swift_op_286(double a, double b)
{
