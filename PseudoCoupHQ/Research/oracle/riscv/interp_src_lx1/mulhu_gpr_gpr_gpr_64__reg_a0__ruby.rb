...
# InterpRenderer from the layer-4 term of mulhu_gpr_gpr_gpr_64__reg_a0__ruby.
# The term's layer-5 text, LITERAL:
#   Extract(127, 64, Concat(0, v0)*Concat(0, v1))
def emu_mulhu_gpr_gpr_gpr_64__reg_a0__ruby(a, b)
  m(ext(mul(cat(0, a, 64), cat(0, b, 64), 128), 127, 64), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_mulhu_gpr_gpr_gpr_64__reg_a0__ruby(*values)
