...
theorem C_NOT__one__rust_00_same_text (a : BitVec 64) :
    ((pure_ITYPE (a) (0xfff#12) (LeanIM.iop.XORI))) = (pure_BREV8 (a) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem C_NOT__one__rust_01_same_text (a : BitVec 64) :
    ((pure_ITYPE (a) (0xfff#12) (LeanIM.iop.XORI))) = (pure_CLZ (a) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem C_NOT__one__rust_02_same_text (a : BitVec 64) :
    ((pure_ITYPE (a) (0xfff#12) (LeanIM.iop.XORI))) = (pure_CLZW (a) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem C_NOT__one__rust_03_same_text (a : BitVec 64) :
    ((pure_ITYPE (a) (0xfff#12) (LeanIM.iop.XORI))) = (pure_CTZ (a) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem C_NOT__one__rust_04_same_text (a : BitVec 64) :
    ((pure_ITYPE (a) (0xfff#12) (LeanIM.iop.XORI))) = (pure_CTZW (a) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem C_NOT__one__rust_05_same_text (a : BitVec 64) :
    ((pure_ITYPE (a) (0xfff#12) (LeanIM.iop.XORI))) = (pure_REV8 (a) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem C_NOT__one__rust_06_same_text (a : BitVec 64) :
    ((pure_ITYPE (a) (0xfff#12) (LeanIM.iop.XORI))) = (pure_ZBB_EXTOP (a) (extop_zbb.SEXTB)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem C_NOT__one__rust_07_same_text (a : BitVec 64) :
    ((pure_ITYPE (a) (0xfff#12) (LeanIM.iop.XORI))) = (pure_ZBB_EXTOP (a) (extop_zbb.SEXTH)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem C_NOT__one__rust_08_same_text (a : BitVec 64) :
    ((pure_ITYPE (a) (0xfff#12) (LeanIM.iop.XORI))) = (pure_ZBB_EXTOP (a) (extop_zbb.ZEXTH)) := by
  with_reducible rfl
