...
// InterpRenderer from the layer-4 term of ucomiss_xmm_xmm_32__flags__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(fp.to_ieee_bv(fpToFP(Extract(31, 0, v0))), fp.to_ieee_bv(fpToFP(Extract(31, 0, v1))))
function emu_ucomiss_xmm_xmm_32__flags__javascript(a, b) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_ucomiss_xmm_xmm_32__flags__javascript(...values).toString());
    } catch (problem) {
