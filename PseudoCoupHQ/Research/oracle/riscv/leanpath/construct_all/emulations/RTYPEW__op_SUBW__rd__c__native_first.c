/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of RTYPEW__op_SUBW__rd__c__native_first.  The term's text, LITERAL:
    */
#include <stdint.h>

uint64_t
emu_RTYPEW__op_SUBW__rd__c__native_first(uint32_t a, uint32_t b)
{
