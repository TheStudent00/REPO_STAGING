...
$ cd PRIVATE/PseudoCoupHQ/Research/op_pipeline && grep -c exempt guard64_transcript.txt
0
```
...
- `PRIVATE/PseudoCoupHQ/Research/op_pipeline/gate.py`
- `PRIVATE/PseudoCoupHQ/Research/op_pipeline/term.py` (one loop
