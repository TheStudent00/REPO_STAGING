...
public class Emu {
    ...
    // InterpRenderer from the layer-4 term of sra_gpr_gpr_same_64__reg_a0__java.
    // The term's layer-5 text, LITERAL:
    //   v0 >> Concat(0, Extract(5, 0, v0))
    static long emu_sra_gpr_gpr_same_64__reg_a0__java(long a) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_sra_gpr_gpr_same_64__reg_a0__java(values[0])));
                    answers.append("\n");
