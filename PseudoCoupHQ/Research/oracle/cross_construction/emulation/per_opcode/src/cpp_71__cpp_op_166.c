/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of cpp_71__cpp_op_166.  The term's layer-5 text, LITERAL:
...
double
emu_cpp_71__cpp_op_166(double a, double b)
{
