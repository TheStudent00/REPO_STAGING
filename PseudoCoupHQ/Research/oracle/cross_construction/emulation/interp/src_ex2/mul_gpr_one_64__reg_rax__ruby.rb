...
# InterpRenderer from the layer-4 term of mul_gpr_one_64__reg_rax__ruby.
# The term's layer-5 text, LITERAL:
#   v0*v1
def emu_mul_gpr_one_64__reg_rax__ruby(a, b)
  m(mul(a, b, 64), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_mul_gpr_one_64__reg_rax__ruby(*values)
