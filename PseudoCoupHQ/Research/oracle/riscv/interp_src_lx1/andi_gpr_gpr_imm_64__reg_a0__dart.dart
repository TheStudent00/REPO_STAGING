...
// InterpRenderer from the layer-4 term of andi_gpr_gpr_imm_64__reg_a0__dart.
// The term's layer-5 text, LITERAL:
//   Concat(0, Extract(1, 0, v0))
int emu_andi_gpr_gpr_imm_64__reg_a0__dart(int a) {
  return m(cat(0, ext(a, 1, 0), 2), 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_andi_gpr_gpr_imm_64__reg_a0__dart(values[0]);
