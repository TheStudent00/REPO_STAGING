...
// intermediate per node of the term of ZBA_RTYPE__one__rd__go__all_constructed.
//   
package main
...
//go:noinline
func emu_ZBA_RTYPE__one__rd__go__all_constructed(a uint64, b uint8, c uint64) uint64 {
	...
	var v90 uint64 = (uint64((uint64(v89)) & (uint64(uint64(c)))))
	var v91 uint64 = (uint64((uint64(v90)) << ((uint64(uint64(0x1))) & uint64(0x3f))))
	var v92 uint64 = (uint64((uint64(v89)) ^ (uint64(uint64(c)))))
	var v93 uint64 = (uint64((uint64(v92)) & (uint64(v91))))
	var v94 uint64 = (uint64((uint64(v90)) | (uint64(v93))))
	var v95 uint64 = (uint64((uint64(v94)) << ((uint64(uint64(0x2))) & uint64(0x3f))))
	var v96 uint64 = (uint64((uint64(v92)) << ((uint64(uint64(0x1))) & uint64(0x3f))))
	var v97 uint64 = (uint64((uint64(v92)) & (uint64(v96))))
	var v98 uint64 = (uint64((uint64(v97)) & (uint64(v95))))
	var v99 uint64 = (uint64((uint64(v94)) | (uint64(v98))))
	var v100 uint64 = (uint64((uint64(v99)) << ((uint64(uint64(0x4))) & uint64(0x3f))))
	var v101 uint64 = (uint64((uint64(v97)) << ((uint64(uint64(0x2))) & uint64(0x3f))))
	var v102 uint64 = (uint64((uint64(v97)) & (uint64(v101))))
	var v103 uint64 = (uint64((uint64(v102)) & (uint64(v100))))
	var v104 uint64 = (uint64((uint64(v99)) | (uint64(v103))))
	var v105 uint64 = (uint64((uint64(v104)) << ((uint64(uint64(0x8))) & uint64(0x3f))))
	var v106 uint64 = (uint64((uint64(v102)) << ((uint64(uint64(0x4))) & uint64(0x3f))))
	var v107 uint64 = (uint64((uint64(v102)) & (uint64(v106))))
	var v108 uint64 = (uint64((uint64(v107)) & (uint64(v105))))
	var v109 uint64 = (uint64((uint64(v104)) | (uint64(v108))))
	var v110 uint64 = (uint64((uint64(v109)) << ((uint64(uint64(0x10))) & uint64(0x3f))))
	var v111 uint64 = (uint64((uint64(v107)) << ((uint64(uint64(0x8))) & uint64(0x3f))))
	var v112 uint64 = (uint64((uint64(v107)) & (uint64(v111))))
	var v113 uint64 = (uint64((uint64(v112)) & (uint64(v110))))
	var v114 uint64 = (uint64((uint64(v109)) | (uint64(v113))))
	var v115 uint64 = (uint64((uint64(v114)) << ((uint64(uint64(0x20))) & uint64(0x3f))))
	var v116 uint64 = (uint64((uint64(v112)) << ((uint64(uint64(0x10))) & uint64(0x3f))))
	var v117 uint64 = (uint64((uint64(v112)) & (uint64(v116))))
	var v118 uint64 = (uint64((uint64(v117)) & (uint64(v115))))
	var v119 uint64 = (uint64((uint64(v114)) | (uint64(v118))))
	var v120 uint64 = (uint64((uint64(v119)) << ((uint64(uint64(0x1))) & uint64(0x3f))))
	var v121 uint64 = (uint64((uint64(v92)) ^ (uint64(v120))))
	return uint64(v121)
}
...
func main() {
	sink = emu_ZBA_RTYPE__one__rd__go__all_constructed(g0, g1, g2)
	_ = sink
}
