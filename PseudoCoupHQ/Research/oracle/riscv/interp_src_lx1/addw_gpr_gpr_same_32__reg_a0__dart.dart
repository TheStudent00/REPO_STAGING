...
// InterpRenderer from the layer-4 term of addw_gpr_gpr_same_32__reg_a0__dart.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 0, v0)*2)
int emu_addw_gpr_gpr_same_32__reg_a0__dart(int a) {
  return m(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(ext(mul(a, 2, 32), 31, 31), ext(mul(a, 2, 32), 31, 31), 1), ext(mul(a, 2, 32), 31, 31), 1), ext(mul(a, 2, 32), 31, 31), 1), ext(mul(a, 2, 32), 31, 31), 1), ext(mul(a, 2, 32), 31, 31), 1), ext(mul(a, 2, 32), 31, 31), 1), ext(mul(a, 2, 32), 31, 31), 1), ext(mul(a, 2, 32), 31, 31), 1), ext(mul(a, 2, 32), 31, 31), 1), ext(mul(a, 2, 32), 31, 31), 1), ext(mul(a, 2, 32), 31, 31), 1), ext(mul(a, 2, 32), 31, 31), 1), ext(mul(a, 2, 32), 31, 31), 1), ext(mul(a, 2, 32), 31, 31), 1), ext(mul(a, 2, 32), 31, 31), 1), ext(mul(a, 2, 32), 31, 31), 1), ext(mul(a, 2, 32), 31, 31), 1), ext(mul(a, 2, 32), 31, 31), 1), ext(mul(a, 2, 32), 31, 31), 1), ext(mul(a, 2, 32), 31, 31), 1), ext(mul(a, 2, 32), 31, 31), 1), ext(mul(a, 2, 32), 31, 31), 1), ext(mul(a, 2, 32), 31, 31), 1), ext(mul(a, 2, 32), 31, 31), 1), ext(mul(a, 2, 32), 31, 31), 1), ext(mul(a, 2, 32), 31, 31), 1), ext(mul(a, 2, 32), 31, 31), 1), ext(mul(a, 2, 32), 31, 31), 1), ext(mul(a, 2, 32), 31, 31), 1), ext(mul(a, 2, 32), 31, 31), 1), ext(mul(a, 2, 32), 31, 31), 1), mul(a, 2, 32), 32), 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_addw_gpr_gpr_same_32__reg_a0__dart(values[0]);
