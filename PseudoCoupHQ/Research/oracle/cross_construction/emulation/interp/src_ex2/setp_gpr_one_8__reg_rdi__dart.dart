...
// InterpRenderer from the layer-4 term of setp_gpr_one_8__reg_rdi__dart.
...
int emu_setp_gpr_one_8__reg_rdi__dart(int a, int b) {
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_setp_gpr_one_8__reg_rdi__dart(values[0], values[1]);
