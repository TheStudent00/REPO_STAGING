...
theorem rust__op_570_92_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPEW (a) (b) (SUBW))) = ((sign_extend (m := 64) ((Sail.BitVec.extractLsb a 31 0) - (Sail.BitVec.extractLsb b 31 0)))) := by
