...
theorem rust__op_606_114_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_MULW (b) (a))) = ((sign_extend (m := 64) (to_bits_truncate (l := 32) ((BitVec.toInt (Sail.BitVec.extractLsb a 31 0)) *i (BitVec.toInt (Sail.BitVec.extractLsb b 31 0)))))) := by
  try simp only [pure_MULW, sign_extend, to_bits_truncate, Sail.BitVec.signExtend, Sail.get_slice_int, Sail.BitVec.extractLsb]
  all_goals grind
