...
public class Emu {
    ...
    // one named local per gate, over the term of movapd_xmm_xmm_128__reg_xmm0_low__java.
    // The term's layer-5 text, LITERAL:
    //   Extract(63, 0, v0)
    static long emu_movapd_xmm_xmm_128__reg_xmm0_low__java(long a) {
        long x0_0 = ext(a, 0, 0);
        long x0_1 = ext(a, 1, 1);
        long x0_2 = ext(a, 2, 2);
        long x0_3 = ext(a, 3, 3);
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_movapd_xmm_xmm_128__reg_xmm0_low__java(values[0])));
                    answers.append("\n");
