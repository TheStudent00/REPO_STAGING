...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of flw_fpr_mem_32__freg_fa0__csharp.
    // The term's layer-5 text, LITERAL:
    //   Concat(4294967295, Extract(31, 0, v0))
    public static long emu_flw_fpr_mem_32__freg_fa0__csharp(long a) {
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_flw_fpr_mem_32__freg_fa0__csharp(values[0])).ToString());
                    answers.Append("\n");
