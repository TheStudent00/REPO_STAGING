...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of idiv_gpr_one_8__reg_rax__csharp.
    ...
    public static long emu_idiv_gpr_one_8__reg_rax__csharp(long a, long b) {
        return m(cat(cat(ext(a, 63, 16), ext(srem(ext(a, 15, 0), cat(cat(cat(cat(cat(cat(cat(cat(ext(b, 7, 7), ext(b, 7, 7), 1), ext(b, 7, 7), 1), ext(b, 7, 7), 1), ext(b, 7, 7), 1), ext(b, 7, 7), 1), ext(b, 7, 7), 1), ext(b, 7, 7), 1), b, 8), 16), 7, 0), 8), ext(sdiv(ext(a, 15, 0), cat(cat(cat(cat(cat(cat(cat(cat(ext(b, 7, 7), ext(b, 7, 7), 1), ext(b, 7, 7), 1), ext(b, 7, 7), 1), ext(b, 7, 7), 1), ext(b, 7, 7), 1), ext(b, 7, 7), 1), ext(b, 7, 7), 1), b, 8), 16), 7, 0), 8), 64);
    }
