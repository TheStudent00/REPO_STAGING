...
// intermediate per node of the term of setne_gpr_one_8__reg_rdi__rust__all_constructed.
//   Concat(Extract(63, 8, v2), If(Extract(7, 0, v0) | Extract(7, 0, v1) == 0, 0, 1))
#[no_mangle]
pub extern "C" fn emu_setne_gpr_one_8__reg_rdi__rust__all_constructed(a: u8, b: u8, c: u64) -> u64
{
    let v0: u32 = (a as u32);
    let v1: u32 = (b as u32);
