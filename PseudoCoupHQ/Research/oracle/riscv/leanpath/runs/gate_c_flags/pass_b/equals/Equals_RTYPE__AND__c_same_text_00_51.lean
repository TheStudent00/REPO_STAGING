...
theorem RTYPE__AND__c_00_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_RTYPE (a) (b) (rop.ADD)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_01_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_RTYPE (a) (b) (rop.SUB)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_02_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_RTYPE (a) (b) (rop.SLL)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_03_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_RTYPE (a) (b) (rop.SLT)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_04_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_RTYPE (a) (b) (rop.SLTU)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_05_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_RTYPE (a) (b) (rop.XOR)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_06_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_RTYPE (a) (b) (rop.SRL)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_07_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_RTYPE (a) (b) (rop.SRA)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_08_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_RTYPE (a) (b) (rop.OR)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_09_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_RTYPE (a) (b) (rop.AND)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_10_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_CLMUL (a) (b) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_11_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_CLMULH (a) (b) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_12_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_CLMULR (a) (b) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_13_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_DIV (a) (b) (false)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_14_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_DIV (a) (b) (true)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_15_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_DIVW (a) (b) (false)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_16_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_DIVW (a) (b) (true)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_17_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_MUL (a) (b) ({ result_part := VectorHalf.High, signed_rs1 := Signedness.Signed, signed_rs2 := Signedness.Signed })) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_18_same_text (a : BitVec 64) (b : BitVec 64) :
...
set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_19_same_text (a : BitVec 64) (b : BitVec 64) :
...
set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_20_same_text (a : BitVec 64) (b : BitVec 64) :
...
set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_23_same_text (a : BitVec 64) (b : BitVec 64) :
...
set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_24_same_text (a : BitVec 64) (b : BitVec 64) :
...
set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_25_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_MULW (a) (b) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_26_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_REM (a) (b) (false)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_27_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_REM (a) (b) (true)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_28_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_REMW (a) (b) (false)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_29_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_REMW (a) (b) (true)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_30_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_RTYPEW (a) (b) (ropw.ADDW)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_31_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_RTYPEW (a) (b) (ropw.SUBW)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_32_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_RTYPEW (a) (b) (ropw.SLLW)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_33_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_RTYPEW (a) (b) (ropw.SRLW)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_34_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_RTYPEW (a) (b) (ropw.SRAW)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_35_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_ZBB_RTYPE (a) (b) (brop_zbb.ANDN)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_36_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_ZBB_RTYPE (a) (b) (brop_zbb.ORN)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_37_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_ZBB_RTYPE (a) (b) (brop_zbb.XNOR)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_38_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_ZBB_RTYPE (a) (b) (brop_zbb.MAX)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_39_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_ZBB_RTYPE (a) (b) (brop_zbb.MAXU)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_40_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_ZBB_RTYPE (a) (b) (brop_zbb.MIN)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_41_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_ZBB_RTYPE (a) (b) (brop_zbb.MINU)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_42_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_ZBB_RTYPE (a) (b) (brop_zbb.ROL)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_43_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_ZBB_RTYPE (a) (b) (brop_zbb.ROR)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_44_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_ZBB_RTYPEW (a) (b) (bropw_zbb.ROLW)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_45_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_ZBB_RTYPEW (a) (b) (bropw_zbb.RORW)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_46_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_ZBKB_RTYPE (a) (b) (brop_zbkb.PACK)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_47_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_ZBKB_RTYPE (a) (b) (brop_zbkb.PACKH)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_48_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_ZBS_RTYPE (a) (b) (brop_zbs.BCLR)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_49_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_ZBS_RTYPE (a) (b) (brop_zbs.BEXT)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_50_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (AND))) = (pure_ZBS_RTYPE (a) (b) (brop_zbs.BINV)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__AND__c_51_same_text (a : BitVec 64) (b : BitVec 64) :
