...
// intermediate per node of the term of LOAD__is_unsigned_False__width_4__rd__rust__all_constructed.
//   
#[no_mangle]
pub extern "C" fn emu_LOAD__is_unsigned_False__width_4__rd__rust__all_constructed(a: u32) -> u64
{
    let v0: u32 = (a as u32);
    let v1: u32 = (((((a as u32)) >> 31) as u32) & 0x1u32);
    let v2: u32 = v0;
    let v3: u32 = v1;
    ...
    let v35: u64 = (((((v34) as u64) << 32) | ((v2) as u64)) as u64);
    ((v35) as u64)
}
