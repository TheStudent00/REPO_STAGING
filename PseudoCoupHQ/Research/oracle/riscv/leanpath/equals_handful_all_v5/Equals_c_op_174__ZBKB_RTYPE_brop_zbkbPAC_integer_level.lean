...
theorem c_op_174__ZBKB_RTYPE_brop_zbkbPAC_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_MULW (b) (a))) = (pure_ZBKB_RTYPE (a) (b) (brop_zbkb.PACKH)) := by
  simp only [pure_MULW, pure_ZBKB_RTYPE]
  grind
