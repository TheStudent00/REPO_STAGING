...
// intermediate per node of the term of STORE__width_1__mem_addr__go__all_constructed.
//   
package main

//go:noinline
func emu_STORE__width_1__mem_addr__go__all_constructed(a uint64, b uint16) uint64 {
...
func main() {
	sink = emu_STORE__width_1__mem_addr__go__all_constructed(g0, g1)
	_ = sink
}
