...
// one named local per gate, over the term of lea_lea_mem_32__reg_rdi__php.
...
function emu_lea_lea_mem_32__reg_rdi__php($a, $b) {
    ...
    $w8 = ex_cat($w7, $g819, 1);
    $w9 = ex_cat($w8, $g804, 1);
    $w10 = ex_cat($w9, $g789, 1);
    $w11 = ex_cat($w10, $g774, 1);
    $w12 = ex_cat($w11, $g759, 1);
    $w13 = ex_cat($w12, $g744, 1);
    $w14 = ex_cat($w13, $g729, 1);
    $w15 = ex_cat($w14, $g714, 1);
    $w16 = ex_cat($w15, $g699, 1);
    $w17 = ex_cat($w16, $g684, 1);
    $w18 = ex_cat($w17, $g669, 1);
    $w19 = ex_cat($w18, $g654, 1);
    $w20 = ex_cat($w19, $g639, 1);
    $w21 = ex_cat($w20, $g624, 1);
    $w22 = ex_cat($w21, $g609, 1);
    $w23 = ex_cat($w22, $g594, 1);
    $w24 = ex_cat($w23, $g579, 1);
    $w25 = ex_cat($w24, $g564, 1);
    $w26 = ex_cat($w25, $g549, 1);
    $w27 = ex_cat($w26, $g534, 1);
    $w28 = ex_cat($w27, $g519, 1);
    $w29 = ex_cat($w28, $g504, 1);
    $w30 = ex_cat($w29, $g489, 1);
    $w31 = ex_cat($w30, $g474, 1);
