---
id: hq.research.lean_proof_path_resistant_to_churn.the_run.handful.check
---

# CHECK — 0_3_3_8_0_handful

Node `hq.research.lean_proof_path_resistant_to_churn.the_run.handful`. Status `draft`.
