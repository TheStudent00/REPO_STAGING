...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of divu_gpr_gpr_same_64__reg_a0__csharp.
    // The term's layer-5 text, LITERAL:
    //   If(v0 == 0, 18446744073709551615, bvudiv_i(v0, v0))
    public static long emu_divu_gpr_gpr_same_64__reg_a0__csharp(long a) {
        return m(((eq(a, 0L, 64)) ? (-1L) : (udiv(a, a, 64))), 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_divu_gpr_gpr_same_64__reg_a0__csharp(values[0])).ToString());
                    answers.Append("\n");
