/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of REM__is_unsigned_True__rd__cpp__native_first.  The term's text, LITERAL:
    */
#include <cstdint>

extern "C"
uint64_t
emu_REM__is_unsigned_True__rd__cpp__native_first(uint64_t a, uint64_t b)
{
