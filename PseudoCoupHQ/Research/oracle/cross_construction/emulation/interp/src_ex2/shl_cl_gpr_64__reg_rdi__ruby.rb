...
# InterpRenderer from the layer-4 term of shl_cl_gpr_64__reg_rdi__ruby.
# The term's layer-5 text, LITERAL:
#   v0 << Concat(0, Extract(5, 0, v1))
def emu_shl_cl_gpr_64__reg_rdi__ruby(a, b)
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_shl_cl_gpr_64__reg_rdi__ruby(*values)
