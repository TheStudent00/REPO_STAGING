/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of cpp_19__cpp_op_231.  The term's layer-5 text, LITERAL:
...
float
emu_cpp_19__cpp_op_231(double a, float b)
{
