...
// one named local per gate, over the term of andpd_xmm_xmm_128__reg_xmm0_low__php.
// The term's layer-5 text, LITERAL:
//   ~(~Extract(63, 0, v0) | ~Extract(63, 0, v1))
function emu_andpd_xmm_xmm_128__reg_xmm0_low__php($a, $b) {
    $x1_0 = ex_ext($b, 0, 0);
    $x0_0 = ex_ext($a, 0, 0);
    $x1_1 = ex_ext($b, 1, 1);
    $x0_1 = ex_ext($a, 1, 1);
    ...
    $w9 = ex_cat($w8, $g54, 1);
    $w10 = ex_cat($w9, $g53, 1);
    $w11 = ex_cat($w10, $g52, 1);
    $w12 = ex_cat($w11, $g51, 1);
    $w13 = ex_cat($w12, $g50, 1);
    $w14 = ex_cat($w13, $g49, 1);
    $w15 = ex_cat($w14, $g48, 1);
    $w16 = ex_cat($w15, $g47, 1);
    $w17 = ex_cat($w16, $g46, 1);
    $w18 = ex_cat($w17, $g45, 1);
    $w19 = ex_cat($w18, $g44, 1);
    $w20 = ex_cat($w19, $g43, 1);
    $w21 = ex_cat($w20, $g42, 1);
    $w22 = ex_cat($w21, $g41, 1);
    $w23 = ex_cat($w22, $g40, 1);
    $w24 = ex_cat($w23, $g39, 1);
    $w25 = ex_cat($w24, $g38, 1);
    $w26 = ex_cat($w25, $g37, 1);
    $w27 = ex_cat($w26, $g36, 1);
    $w28 = ex_cat($w27, $g35, 1);
    $w29 = ex_cat($w28, $g34, 1);
    $w30 = ex_cat($w29, $g33, 1);
    $w31 = ex_cat($w30, $g32, 1);
    $w32 = ex_cat($w31, $g31, 1);
    $w33 = ex_cat($w32, $g30, 1);
    $w34 = ex_cat($w33, $g29, 1);
    $w35 = ex_cat($w34, $g28, 1);
    $w36 = ex_cat($w35, $g27, 1);
    $w37 = ex_cat($w36, $g26, 1);
    $w38 = ex_cat($w37, $g25, 1);
    $w39 = ex_cat($w38, $g24, 1);
    $w40 = ex_cat($w39, $g23, 1);
    $w41 = ex_cat($w40, $g22, 1);
    $w42 = ex_cat($w41, $g21, 1);
    $w43 = ex_cat($w42, $g20, 1);
    $w44 = ex_cat($w43, $g19, 1);
    $w45 = ex_cat($w44, $g18, 1);
    $w46 = ex_cat($w45, $g17, 1);
    $w47 = ex_cat($w46, $g16, 1);
    $w48 = ex_cat($w47, $g15, 1);
    $w49 = ex_cat($w48, $g14, 1);
    $w50 = ex_cat($w49, $g13, 1);
    $w51 = ex_cat($w50, $g12, 1);
    $w52 = ex_cat($w51, $g11, 1);
    $w53 = ex_cat($w52, $g10, 1);
    $w54 = ex_cat($w53, $g9, 1);
    $w55 = ex_cat($w54, $g8, 1);
    $w56 = ex_cat($w55, $g7, 1);
    $w57 = ex_cat($w56, $g6, 1);
...
while (($line = fgets($handle)) !== false) {
    ...
    try {
        $answer = emu_andpd_xmm_xmm_128__reg_xmm0_low__php(...$ints);
        if ($answer < 0) {
            echo sprintf("%s\n", sprintf("%u", $answer));
        } else {
            echo $answer . "\n";
