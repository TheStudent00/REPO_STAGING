...
theorem au_452_go_band_i32_i32_abi_integer_level (a : BitVec 64) (b : BitVec 64) :
  ...
  try simp only [pure_RTYPE, pure_ZBA_RTYPEUW, bool_to_bit, log2_xlen, shift_bits_right_arith, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.zeroExtend, Sail.BitVec.extractLsb]
  all_goals grind
