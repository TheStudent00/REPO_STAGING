...
// intermediate per node of the term of czero_nez_gpr_gpr_same_64__reg_a0__go__bit_blast.
//   If(v0 == 0, v0, 0)
package main

//go:noinline
func emu_czero_nez_gpr_gpr_same_64__reg_a0__go__bit_blast(a uint64) uint64 {
	var k0 uint64 = 0
	var w0 uint64 = (k0 << 0)
...
func main() {
	sink = emu_czero_nez_gpr_gpr_same_64__reg_a0__go__bit_blast(g0)
	_ = sink
}
