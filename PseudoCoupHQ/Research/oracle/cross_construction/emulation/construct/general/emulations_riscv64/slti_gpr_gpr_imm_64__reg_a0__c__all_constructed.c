/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of slti_gpr_gpr_imm_64__reg_a0__c__all_constructed.  The term's text, LITERAL:
   If(3 <= v0, 0, 1) */
#include <stdint.h>

uint64_t
emu_slti_gpr_gpr_imm_64__reg_a0__c__all_constructed(uint64_t a)
{
