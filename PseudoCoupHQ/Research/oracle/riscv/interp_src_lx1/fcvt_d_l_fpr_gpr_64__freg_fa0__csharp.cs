...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of fcvt_d_l_fpr_gpr_64__freg_fa0__csharp.
    // The term's layer-5 text, LITERAL:
    //   fp.to_ieee_bv(fpToFP(RNE(), v0))
    public static long emu_fcvt_d_l_fpr_gpr_64__freg_fa0__csharp(long a) {
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_fcvt_d_l_fpr_gpr_64__freg_fa0__csharp(values[0])).ToString());
                    answers.Append("\n");
