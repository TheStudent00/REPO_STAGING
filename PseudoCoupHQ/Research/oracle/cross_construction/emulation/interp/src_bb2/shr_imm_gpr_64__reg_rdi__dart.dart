...
// one named local per gate, over the term of shr_imm_gpr_64__reg_rdi__dart.
// The term's layer-5 text, LITERAL:
//   Concat(0, Extract(63, 3, v0))
int emu_shr_imm_gpr_64__reg_rdi__dart(int a) {
  int x0_3 = ext(a, 3, 3);
  int x0_4 = ext(a, 4, 4);
  int x0_5 = ext(a, 5, 5);
  int x0_6 = ext(a, 6, 6);
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_shr_imm_gpr_64__reg_rdi__dart(values[0]);
