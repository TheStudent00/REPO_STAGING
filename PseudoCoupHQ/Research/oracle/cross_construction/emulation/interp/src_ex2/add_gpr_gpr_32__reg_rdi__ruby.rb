...
# InterpRenderer from the layer-4 term of add_gpr_gpr_32__reg_rdi__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(0, Extract(31, 0, v0) + Extract(31, 0, v1))
def emu_add_gpr_gpr_32__reg_rdi__ruby(a, b)
  m(cat(0, add(a, b, 32), 32), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_add_gpr_gpr_32__reg_rdi__ruby(*values)
