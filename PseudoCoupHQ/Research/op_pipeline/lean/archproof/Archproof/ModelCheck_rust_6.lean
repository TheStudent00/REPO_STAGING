...
/-- rust single-opcode row 6, arch mnemonic 'imul', example unit rust/op_606, 5 members
...
theorem ModelCheck_rust_6 (v0 : BitVec 64) (v1 : BitVec 64) :
...
#print axioms ModelCheck_rust_6
