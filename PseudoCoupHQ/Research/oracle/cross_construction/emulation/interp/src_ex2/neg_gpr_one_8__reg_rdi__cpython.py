...
# InterpRenderer from the layer-4 term of neg_gpr_one_8__reg_rdi__cpython.
# The term's layer-5 text, LITERAL:
#   Concat(0, Extract(7, 0, v0)*255)
def emu_neg_gpr_one_8__reg_rdi__cpython(a):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_neg_gpr_one_8__reg_rdi__cpython(*values)
            sys.stdout.write("%d\n" % answer)
