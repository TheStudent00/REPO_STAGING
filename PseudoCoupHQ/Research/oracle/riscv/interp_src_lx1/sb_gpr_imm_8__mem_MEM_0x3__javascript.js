...
// InterpRenderer from the layer-4 term of sb_gpr_imm_8__mem_MEM_0x3__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(63, 8, v0), Extract(7, 0, v1))
function emu_sb_gpr_imm_8__mem_MEM_0x3__javascript(a, b) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_sb_gpr_imm_8__mem_MEM_0x3__javascript(...values).toString());
    } catch (problem) {
