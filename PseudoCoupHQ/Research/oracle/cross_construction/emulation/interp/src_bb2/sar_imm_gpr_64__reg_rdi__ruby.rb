...
# one named local per gate, over the term of sar_imm_gpr_64__reg_rdi__ruby.
# The term's layer-5 text, LITERAL:
#   v0 >> 3
def emu_sar_imm_gpr_64__reg_rdi__ruby(a)
  x0_3 = ext(a, 3, 3)
  x0_4 = ext(a, 4, 4)
  x0_5 = ext(a, 5, 5)
  x0_6 = ext(a, 6, 6)
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_sar_imm_gpr_64__reg_rdi__ruby(*values)
