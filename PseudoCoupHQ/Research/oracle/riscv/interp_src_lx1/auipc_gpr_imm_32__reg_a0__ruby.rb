...
# InterpRenderer from the layer-4 term of auipc_gpr_imm_32__reg_a0__ruby.
# The term's layer-5 text, LITERAL:
#   v0 + 12288
def emu_auipc_gpr_imm_32__reg_a0__ruby(a)
  m(add(a, 12288, 64), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_auipc_gpr_imm_32__reg_a0__ruby(*values)
