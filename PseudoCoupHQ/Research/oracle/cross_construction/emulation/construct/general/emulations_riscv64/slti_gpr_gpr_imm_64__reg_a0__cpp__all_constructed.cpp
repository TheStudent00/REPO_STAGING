/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of slti_gpr_gpr_imm_64__reg_a0__cpp__all_constructed.  The term's text, LITERAL:
   If(3 <= v0, 0, 1) */
#include <cstdint>

extern "C"
uint64_t
emu_slti_gpr_gpr_imm_64__reg_a0__cpp__all_constructed(uint64_t a)
{
    uint64_t v0 = (uint64_t)(UINT32_C(0x1));
    uint64_t v1 = (uint64_t)((uint64_t)(UINT64_C(0x3)) ^ (uint64_t)(UINT64_C(0x8000000000000000)));
