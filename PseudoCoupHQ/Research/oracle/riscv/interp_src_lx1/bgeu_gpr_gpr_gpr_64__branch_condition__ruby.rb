...
# InterpRenderer from the layer-4 term of bgeu_gpr_gpr_gpr_64__branch_condition__ruby.
# The term's layer-5 text, LITERAL:
#   If(ULE(v0, v1), 1, 0)
def emu_bgeu_gpr_gpr_gpr_64__branch_condition__ruby(a, b)
  m(((ule(b, a, 64)) ? (1) : (0)), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_bgeu_gpr_gpr_gpr_64__branch_condition__ruby(*values)
