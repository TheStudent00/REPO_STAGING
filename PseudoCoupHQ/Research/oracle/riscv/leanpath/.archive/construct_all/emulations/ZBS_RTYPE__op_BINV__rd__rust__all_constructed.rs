...
// intermediate per node of the term of ZBS_RTYPE__op_BINV__rd__rust__all_constructed.
//   
#[no_mangle]
pub extern "C" fn emu_ZBS_RTYPE__op_BINV__rd__rust__all_constructed(a: u64, b: u8) -> u64
{
