...
public class Emu {
    ...
    // InterpRenderer from the layer-4 term of test_gpr_same_16__flags__java.
    // The term's layer-5 text, LITERAL:
    //   Concat(Extract(15, 0, v0), 0)
    static long emu_test_gpr_same_16__flags__java(long a) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_test_gpr_same_16__flags__java(values[0])));
                    answers.append("\n");
