...
#eval IO.println ("rust__op_1#0\t" ++ ((match (encdec_backwards (0x40a00533#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_1#1\t" ++ ((match (encdec_compressed_backwards (0x8082#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_13#0\t" ++ ((match (encdec_backwards (0xfff54513#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_17#0\t" ++ ((match (encdec_backwards (0x00154513#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_101#0\t" ++ ((match (encdec_compressed_backwards (0x8d6d#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_137#0\t" ++ ((match (encdec_compressed_backwards (0x8d4d#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_217#0\t" ++ ((match (encdec_compressed_backwards (0x8d2d#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_253#1\t" ++ ((match (encdec_backwards (0x00153513#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_289#1\t" ++ ((match (encdec_backwards (0x00a03533#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_325#0\t" ++ ((match (encdec_backwards (0x00b52533#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_361#0\t" ++ ((match (encdec_backwards (0x00a5a533#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_425#0\t" ++ ((match (encdec_backwards (0x0015c593#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_469#0\t" ++ ((match (encdec_backwards (0x00b51533#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_505#0\t" ++ ((match (encdec_backwards (0x40b55533#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_541#0\t" ++ ((match (encdec_compressed_backwards (0x952e#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_577#0\t" ++ ((match (encdec_compressed_backwards (0x8d0d#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_613#0\t" ++ ((match (encdec_backwards (0x02a58533#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_649#0\t" ++ ((match (encdec_compressed_backwards (0x1141#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_649#1\t" ++ ((match (encdec_compressed_backwards (0xe406#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_649#2\t" ++ ((match (encdec_compressed_backwards (0xcd89#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_649#3\t" ++ ((match (encdec_compressed_backwards (0x567d#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_649#4\t" ++ ((match (encdec_backwards (0x03f61693#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_649#5\t" ++ ((match (encdec_backwards (0x00d51463#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_649#6\t" ++ ((match (encdec_backwards (0x00c58f63#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_649#7\t" ++ ((match (encdec_backwards (0x02b54533#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_649#8\t" ++ ((match (encdec_compressed_backwards (0x60a2#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_649#9\t" ++ ((match (encdec_compressed_backwards (0x0141#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_685#7\t" ++ ((match (encdec_backwards (0x02b56533#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_793#0\t" ++ ((match (encdec_compressed_backwards (0xe10c#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_793#1\t" ++ ((match (encdec_compressed_backwards (0xe510#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_793#2\t" ++ ((match (encdec_backwards (0x00050823#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_821#0\t" ++ ((match (encdec_compressed_backwards (0x05a2#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
