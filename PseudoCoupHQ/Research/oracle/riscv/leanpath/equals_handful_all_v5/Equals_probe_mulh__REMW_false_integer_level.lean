...
theorem probe_mulh__REMW_false_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_MUL (b) (a) ({ result_part := LeanIM.VectorHalf.High, signed_rs1 := LeanIM.Signedness.Signed, signed_rs2 := LeanIM.Signedness.Signed }))) = (pure_REMW (a) (b) (false)) := by
