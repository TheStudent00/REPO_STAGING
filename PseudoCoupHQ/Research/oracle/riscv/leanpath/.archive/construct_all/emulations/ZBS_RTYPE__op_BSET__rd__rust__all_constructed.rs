...
// intermediate per node of the term of ZBS_RTYPE__op_BSET__rd__rust__all_constructed.
//   
#[no_mangle]
pub extern "C" fn emu_ZBS_RTYPE__op_BSET__rd__rust__all_constructed(a: u64, b: u8) -> u64
{
    ...
    let v90: u64 = ((((v89) as u64) | (((a as u64)) as u64)) as u64);
    ((v90) as u64)
}
