...
theorem cpp__op_252_109_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_REM (a) (b) (false))) = ((to_bits_truncate (l := 64) (if (((BitVec.toInt b) == 0) : Bool) then (BitVec.toInt a) else (Int.tmod (BitVec.toInt a) (BitVec.toInt b))))) := by
