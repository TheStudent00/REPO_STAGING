...
// InterpRenderer from the layer-4 term of fcvt_s_l_fpr_gpr_32__freg_fa0__dart.
// The term's layer-5 text, LITERAL:
//   Concat(4294967295, fp.to_ieee_bv(fpToFP(RNE(), v0)))
int emu_fcvt_s_l_fpr_gpr_32__freg_fa0__dart(int a) {
  return m(cat(4294967295, i2f(a, 64, 32), 32), 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_fcvt_s_l_fpr_gpr_32__freg_fa0__dart(values[0]);
