---
id: hq.research.lean_proof_path_resistant_to_churn.lean_expr.widen.check
---

# CHECK — 0_3_3_2_1_widen

Node `hq.research.lean_proof_path_resistant_to_churn.lean_expr.widen`. Status `draft`.
