...
theorem meaning_sltiu_gpr_gpr_imm_64__reg_a0__go__native_first (s : St) (a : BitVec 64) (d : BitVec 64) (h10 : s.regs.get? .x10 = some a) (h13 : s.regs.get? .x13 = some d) (hk0 : ∀ {α : Type} (x0 : α) (s : St), (plat_term_write x0) s = EStateM.Result.ok () s) (hk1 : ∀ (x0 : Arch.pa) (x1 : Nat) (s : St), (load_reservation x0 x1) s = EStateM.Result.ok () s) (hk2 : ∀ (x0 : Unit) (s : St), (cancel_reservation x0) s = EStateM.Result.ok () s) :
    runsTo (walk [LeanIM.instruction.SHIFTIOP (0x02#6, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x05#5, LeanIM.sop.SRLI), LeanIM.instruction.C_LI (0x3f#6, LeanIM.regidx.Regidx 0x06#5), LeanIM.instruction.SHIFTIOP (0x02#6, LeanIM.regidx.Regidx 0x06#5, LeanIM.regidx.Regidx 0x06#5, LeanIM.sop.SRLI), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x06#5, LeanIM.regidx.Regidx 0x05#5, LeanIM.regidx.Regidx 0x05#5, LeanIM.rop.AND), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x05#5, LeanIM.regidx.Regidx 0x00#5, LeanIM.regidx.Regidx 0x05#5, LeanIM.rop.SLTU), LeanIM.instruction.ITYPE (0x003#12, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x06#5, LeanIM.iop.ANDI), LeanIM.instruction.C_ADDI (0x3d#6, LeanIM.regidx.Regidx 0x06#5), LeanIM.instruction.ITYPE (0x001#12, LeanIM.regidx.Regidx 0x06#5, LeanIM.regidx.Regidx 0x06#5, LeanIM.iop.SLTIU), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x05#5, LeanIM.regidx.Regidx 0x06#5, LeanIM.regidx.Regidx 0x05#5, LeanIM.rop.OR), LeanIM.instruction.ITYPE (0x001#12, LeanIM.regidx.Regidx 0x05#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.iop.SLTIU)]) s
      ((pure_ITYPE ((pure_RTYPE ((pure_ITYPE ((pure_ITYPE ((pure_ITYPE (a) (0x003#12) (LeanIM.iop.ANDI))) (((sign_extend (m := 12) (0x3d#6)))) (ADDI))) (0x001#12) (LeanIM.iop.SLTIU))) ((pure_RTYPE (zero_reg) ((pure_RTYPE ((pure_SHIFTIOP (a) (0x02#6) (LeanIM.sop.SRLI))) ((pure_SHIFTIOP ((pure_ITYPE (zero_reg) (((sign_extend (m := 12) (0x3f#6)))) (ADDI))) (0x02#6) (LeanIM.sop.SRLI))) (LeanIM.rop.AND))) (LeanIM.rop.SLTU))) (LeanIM.rop.OR))) (0x001#12) (LeanIM.iop.SLTIU))) := by
  simp (config := {decide := true}) [runsTo, walk, step, execute, strip_C_LI, strip_C_ADDI, strip_SHIFTIOP, strip_ITYPE, strip_RTYPE, alias_C_LI, alias_C_ADDI,
