...
// intermediate per node of the term of fmv_s_fpr_fpr_fpr_32__freg_fa0__go__bit_blast.
//   v0
package main

//go:noinline
func emu_fmv_s_fpr_fpr_fpr_32__freg_fa0__go__bit_blast(a uint64) uint64 {
...
func main() {
	sink = emu_fmv_s_fpr_fpr_fpr_32__freg_fa0__go__bit_blast(g0)
	_ = sink
}
