...
// intermediate per node of the term of RTYPE__op_SLTU__rd__go__all_constructed.
//   
package main
...
//go:noinline
func emu_RTYPE__op_SLTU__rd__go__all_constructed(a uint64, b uint64) uint64 {
	...
	var v36 bool = (!(v35))
	var v37 uint32 = sel32(v36, uint32(uint32(0x0)), uint32(uint32(0x1)))
	var v38 uint32 = v37
	var v39 uint64 = uint64(0x0)
	var v40 uint64 = (uint64(((uint64(v39)) << 1) | (uint64(v38))))
	return uint64(v40)
}
...
func main() {
	sink = emu_RTYPE__op_SLTU__rd__go__all_constructed(g0, g1)
	_ = sink
}
