...
public class Emu {
    ...
    // one named local per gate, over the term of mov_imm_gpr_16__reg_rdi__java.
    // The term's layer-5 text, LITERAL:
    //   Concat(Extract(63, 16, v0), Extract(15, 0, v1))
    static long emu_mov_imm_gpr_16__reg_rdi__java(long a, long b) {
        long x1_0 = ext(b, 0, 0);
        long x1_1 = ext(b, 1, 1);
        long x1_2 = ext(b, 2, 2);
        long x1_3 = ext(b, 3, 3);
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_mov_imm_gpr_16__reg_rdi__java(values[0], values[1])));
                    answers.append("\n");
