...
// InterpRenderer from the layer-4 term of sw_gpr_gpr_32__mem_MEM_a1__dart.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(63, 32, v0), Extract(31, 0, v1))
int emu_sw_gpr_gpr_32__mem_MEM_a1__dart(int a, int b) {
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_sw_gpr_gpr_32__mem_MEM_a1__dart(values[0], values[1]);
