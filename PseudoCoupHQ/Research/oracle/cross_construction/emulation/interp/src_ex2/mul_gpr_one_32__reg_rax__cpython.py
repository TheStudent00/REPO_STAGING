...
# InterpRenderer from the layer-4 term of mul_gpr_one_32__reg_rax__cpython.
# The term's layer-5 text, LITERAL:
#   Concat(0, Extract(31, 0, v0)*Extract(31, 0, v1))
def emu_mul_gpr_one_32__reg_rax__cpython(a, b):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_mul_gpr_one_32__reg_rax__cpython(*values)
            sys.stdout.write("%d\n" % answer)
