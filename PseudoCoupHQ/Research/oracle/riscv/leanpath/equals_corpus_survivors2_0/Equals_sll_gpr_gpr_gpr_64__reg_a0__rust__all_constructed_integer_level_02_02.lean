...
theorem sll_gpr_gpr_gpr_64__reg_a0__rust__all_constructed_02_integer_level (a : BitVec 64) (b : BitVec 64) :
  ...
  try simp only [pure_ITYPE, pure_RTYPE, pure_RTYPE, bool_to_bit, log2_xlen, shift_bits_right_arith, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.toNatInt, Sail.BitVec.zeroExtend]
  grind
