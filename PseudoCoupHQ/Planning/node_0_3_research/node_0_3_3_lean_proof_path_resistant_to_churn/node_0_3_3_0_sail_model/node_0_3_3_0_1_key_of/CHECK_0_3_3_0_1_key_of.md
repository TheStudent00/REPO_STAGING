---
id: hq.research.lean_proof_path_resistant_to_churn.sail_model.key_of.check
---

# CHECK — 0_3_3_0_1_key_of

Node `hq.research.lean_proof_path_resistant_to_churn.sail_model.key_of`. Status `draft`.
