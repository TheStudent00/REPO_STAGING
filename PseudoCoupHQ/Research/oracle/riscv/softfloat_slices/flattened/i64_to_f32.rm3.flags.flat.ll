; ModuleID = '<scratch>/fl/run/i64_to_f32.rm3.flags/i64_to_f32.rm3.flags.rv.flat.ll'
source_filename = "llvm-link"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128"
target triple = "riscv64-unknown-unknown-elf"

define dso_local i64 @i64_to_f32_rm3_flags_flat(i64 noundef %arg) {
  ...
  %.a29 = and i32 %i18, %.m28
  %.c16 = and i1 %.n14, %.n15
  %.m30 = sext i1 %.n14 to i32
  %.m33 = sext i1 %.n15 to i32
  %.m17 = sext i1 %.c16 to i32
  %.a18 = and i32 %.o13, %.m17
  %.m26 = sext i1 %.c16 to i64
