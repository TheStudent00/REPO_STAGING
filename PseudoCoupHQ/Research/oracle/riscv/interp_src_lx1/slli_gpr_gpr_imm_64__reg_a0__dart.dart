...
// InterpRenderer from the layer-4 term of slli_gpr_gpr_imm_64__reg_a0__dart.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(60, 0, v0), 0)
int emu_slli_gpr_gpr_imm_64__reg_a0__dart(int a) {
  return m(cat(ext(a, 60, 0), 0, 3), 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_slli_gpr_gpr_imm_64__reg_a0__dart(values[0]);
