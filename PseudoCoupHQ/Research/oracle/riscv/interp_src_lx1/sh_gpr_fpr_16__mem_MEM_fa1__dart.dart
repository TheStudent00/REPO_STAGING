...
// InterpRenderer from the layer-4 term of sh_gpr_fpr_16__mem_MEM_fa1__dart.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(63, 16, v0), Extract(15, 0, v1))
int emu_sh_gpr_fpr_16__mem_MEM_fa1__dart(int a, int b) {
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_sh_gpr_fpr_16__mem_MEM_fa1__dart(values[0], values[1]);
