...
*(These were in `PRIVATE/PseudoCoup_v5/Designing/` (historical),
...
now lives in `PRIVATE/PseudoIR/Tools/intentions/`; the
...
- Whether the extended artifact is written back into
  `PRIVATE/PseudoCoup_v5/Designing/` (historical) or copied
  ...
  `PRIVATE/PseudoIR/Tools/intentions/` (2026-07-31), which is
