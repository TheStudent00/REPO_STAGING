; ModuleID = '<scratch>/fl/run/ui32_to_f16.rm0.flags/ui32_to_f16.rm0.flags.rv.flat.ll'
source_filename = "llvm-link"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128"
target triple = "riscv64-unknown-unknown-elf"

define dso_local i64 @ui32_to_f16_rm0_flags_flat(i32 noundef signext %arg) {
  %i = icmp eq i32 %arg, 0
  %.n13 = xor i1 %i, true
  ...
  %.sh30 = shl i32 %.a26, 10
  %i46 = freeze i32 %.sh30
  %i40 = icmp eq i8 %i36, 0
  %.m28 = sext i1 %i40 to i64
  %.n29 = xor i64 %.m28, -1
