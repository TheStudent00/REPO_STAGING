...
// InterpRenderer from the layer-4 term of div_gpr_one_8__reg_rax__javascript.
...
function emu_div_gpr_one_8__reg_rax__javascript(a, b) {
    return m(cat(cat(ext(a, 63, 16), ext(urem(ext(a, 15, 0), cat(0n, b, 8), 16), 7, 0), 8), ext(udiv(ext(a, 15, 0), cat(0n, b, 8), 16), 7, 0), 8), 64);
}
