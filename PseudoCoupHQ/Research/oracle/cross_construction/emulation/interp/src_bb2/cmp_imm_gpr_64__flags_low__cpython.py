...
# one named local per gate, over the term of cmp_imm_gpr_64__flags_low__cpython.
# The term's layer-5 text, LITERAL:
#   v0
def emu_cmp_imm_gpr_64__flags_low__cpython(a):
    x0_0 = ext(a, 0, 0)
    x0_1 = ext(a, 1, 1)
    x0_2 = ext(a, 2, 2)
    x0_3 = ext(a, 3, 3)
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_cmp_imm_gpr_64__flags_low__cpython(*values)
            sys.stdout.write("%d\n" % answer)
