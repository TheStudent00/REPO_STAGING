...
public class Emu {
    ...
    // one named local per gate, over the term of cltd_none_64__reg_rdx__java.
    // The term's layer-5 text, LITERAL:
    //   Concat(0, Extract(31, 0, v0) >> 31)
    static long emu_cltd_none_64__reg_rdx__java(long a) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_cltd_none_64__reg_rdx__java(values[0])));
                    answers.append("\n");
