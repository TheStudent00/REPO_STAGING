...
// intermediate per node of the term of SHIFTIWOP__op_SRAIW__rd__rust__native_first.
//   
#[no_mangle]
pub extern "C" fn emu_SHIFTIWOP__op_SRAIW__rd__rust__native_first(a: u32, b: u8) -> u64
{
