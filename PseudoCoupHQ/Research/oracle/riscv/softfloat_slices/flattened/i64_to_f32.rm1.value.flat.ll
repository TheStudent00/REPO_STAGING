; ModuleID = '<scratch>/fl/run/i64_to_f32.rm1.value/i64_to_f32.rm1.value.rv.flat.ll'
source_filename = "llvm-link"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128"
target triple = "riscv64-unknown-unknown-elf"

define dso_local i64 @i64_to_f32_rm1_value_flat(i64 noundef %arg) {
  %i = icmp slt i64 %arg, 0
  %.m20 = sext i1 %i to i32
  %i43 = and i32 -2147483648, %.m20
  ...
  %i39 = freeze i32 %.sh19
  %i47 = or i32 %i39, %i43
  %i42 = icmp ult i32 %.a18, 128
  %.m22 = sext i1 %i42 to i32
  %.n23 = xor i32 %.m22, -1
  %i46 = and i32 %i45, %.n23
  %i48 = add i32 %i47, %i46
  %.a25 = and i32 %i48, %.m24
