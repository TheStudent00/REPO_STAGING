...
// InterpRenderer from the layer-4 term of ori_gpr_gpr_imm_64__reg_a0__dart.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(63, 2, v0), 3)
int emu_ori_gpr_gpr_imm_64__reg_a0__dart(int a) {
  return m(cat(ext(a, 63, 2), 3, 2), 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_ori_gpr_gpr_imm_64__reg_a0__dart(values[0]);
