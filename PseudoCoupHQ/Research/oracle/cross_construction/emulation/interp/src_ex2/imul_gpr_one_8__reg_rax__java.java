...
public class Emu {
    ...
    // InterpRenderer from the layer-4 term of imul_gpr_one_8__reg_rax__java.
    ...
    static long emu_imul_gpr_one_8__reg_rax__java(long a, long b) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_imul_gpr_one_8__reg_rax__java(values[0], values[1])));
                    answers.append("\n");
