...
// InterpRenderer from the layer-4 term of sraiw_gpr_gpr_imm_32__reg_a0__dart.
...
int emu_sraiw_gpr_gpr_imm_32__reg_a0__dart(int a) {
  return m(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(ext(ashr(a, 3, 32), 31, 31), ext(ashr(a, 3, 32), 31, 31), 1), ext(ashr(a, 3, 32), 31, 31), 1), ext(ashr(a, 3, 32), 31, 31), 1), ext(ashr(a, 3, 32), 31, 31), 1), ext(ashr(a, 3, 32), 31, 31), 1), ext(ashr(a, 3, 32), 31, 31), 1), ext(ashr(a, 3, 32), 31, 31), 1), ext(ashr(a, 3, 32), 31, 31), 1), ext(ashr(a, 3, 32), 31, 31), 1), ext(ashr(a, 3, 32), 31, 31), 1), ext(ashr(a, 3, 32), 31, 31), 1), ext(ashr(a, 3, 32), 31, 31), 1), ext(ashr(a, 3, 32), 31, 31), 1), ext(ashr(a, 3, 32), 31, 31), 1), ext(ashr(a, 3, 32), 31, 31), 1), ext(ashr(a, 3, 32), 31, 31), 1), ext(ashr(a, 3, 32), 31, 31), 1), ext(ashr(a, 3, 32), 31, 31), 1), ext(ashr(a, 3, 32), 31, 31), 1), ext(ashr(a, 3, 32), 31, 31), 1), ext(ashr(a, 3, 32), 31, 31), 1), ext(ashr(a, 3, 32), 31, 31), 1), ext(ashr(a, 3, 32), 31, 31), 1), ext(ashr(a, 3, 32), 31, 31), 1), ext(ashr(a, 3, 32), 31, 31), 1), ext(ashr(a, 3, 32), 31, 31), 1), ext(ashr(a, 3, 32), 31, 31), 1), ext(ashr(a, 3, 32), 31, 31), 1), ext(ashr(a, 3, 32), 31, 31), 1), ext(ashr(a, 3, 32), 31, 31), 1), ext(ashr(a, 3, 32), 31, 31), 1), ashr(a, 3, 32), 32), 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_sraiw_gpr_gpr_imm_32__reg_a0__dart(values[0]);
