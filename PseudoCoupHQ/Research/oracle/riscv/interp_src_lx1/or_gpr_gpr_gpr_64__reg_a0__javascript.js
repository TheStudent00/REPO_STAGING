...
// InterpRenderer from the layer-4 term of or_gpr_gpr_gpr_64__reg_a0__javascript.
// The term's layer-5 text, LITERAL:
//   v0 | v1
function emu_or_gpr_gpr_gpr_64__reg_a0__javascript(a, b) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_or_gpr_gpr_gpr_64__reg_a0__javascript(...values).toString());
    } catch (problem) {
