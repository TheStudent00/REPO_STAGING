...
// one named local per gate, over the term of cmp_imm_gpr_16__flags__php.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(15, 0, v0), Extract(15, 0, v1))
function emu_cmp_imm_gpr_16__flags__php($a, $b) {
    $x1_0 = ex_ext($b, 0, 0);
    $x1_1 = ex_ext($b, 1, 1);
    $x1_2 = ex_ext($b, 2, 2);
    $x1_3 = ex_ext($b, 3, 3);
    ...
    $w0 = $x0_15;
    $w1 = ex_cat($w0, $x0_14, 1);
    $w2 = ex_cat($w1, $x0_13, 1);
    $w3 = ex_cat($w2, $x0_12, 1);
    $w4 = ex_cat($w3, $x0_11, 1);
    $w5 = ex_cat($w4, $x0_10, 1);
    $w6 = ex_cat($w5, $x0_9, 1);
    $w7 = ex_cat($w6, $x0_8, 1);
    $w8 = ex_cat($w7, $x0_7, 1);
    $w9 = ex_cat($w8, $x0_6, 1);
    $w10 = ex_cat($w9, $x0_5, 1);
    $w11 = ex_cat($w10, $x0_4, 1);
    $w12 = ex_cat($w11, $x0_3, 1);
    $w13 = ex_cat($w12, $x0_2, 1);
    $w14 = ex_cat($w13, $x0_1, 1);
    $w15 = ex_cat($w14, $x0_0, 1);
    $w16 = ex_cat($w15, $x1_15, 1);
    $w17 = ex_cat($w16, $x1_14, 1);
    $w18 = ex_cat($w17, $x1_13, 1);
    $w19 = ex_cat($w18, $x1_12, 1);
    $w20 = ex_cat($w19, $x1_11, 1);
    $w21 = ex_cat($w20, $x1_10, 1);
    $w22 = ex_cat($w21, $x1_9, 1);
    $w23 = ex_cat($w22, $x1_8, 1);
    $w24 = ex_cat($w23, $x1_7, 1);
    $w25 = ex_cat($w24, $x1_6, 1);
    $w26 = ex_cat($w25, $x1_5, 1);
    $w27 = ex_cat($w26, $x1_4, 1);
    $w28 = ex_cat($w27, $x1_3, 1);
    $w29 = ex_cat($w28, $x1_2, 1);
    $w30 = ex_cat($w29, $x1_1, 1);
    $w31 = ex_cat($w30, $x1_0, 1);
    return ex_m($w31, 32);
}
...
while (($line = fgets($handle)) !== false) {
    ...
    try {
        $answer = emu_cmp_imm_gpr_16__flags__php(...$ints);
        if ($answer < 0) {
            echo sprintf("%s\n", sprintf("%u", $answer));
        } else {
            echo $answer . "\n";
