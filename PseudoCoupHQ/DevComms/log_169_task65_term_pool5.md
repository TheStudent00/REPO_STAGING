...
```
$ git -C PRIVATE/PseudoCoupHQ status --porcelain Research/op_pipeline/check_no_spelling_keys.py
(no output)
...
```
$ git -C PRIVATE/PseudoCoupHQ status --porcelain Research/op_pipeline/term.py Research/op_pipeline/pool.py Research/op_pipeline/gate.py Research/op_pipeline/reference.py
(no output)
```
...
All under `PRIVATE/PseudoCoupHQ/Research/op_pipeline/`.
