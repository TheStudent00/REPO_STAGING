/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of subss_mem_xmm_32__reg_xmm0__c.  The term's layer-5 text, LITERAL:
...
float
emu_subss_mem_xmm_32__reg_xmm0__c(uint32_t a, float b)
{
