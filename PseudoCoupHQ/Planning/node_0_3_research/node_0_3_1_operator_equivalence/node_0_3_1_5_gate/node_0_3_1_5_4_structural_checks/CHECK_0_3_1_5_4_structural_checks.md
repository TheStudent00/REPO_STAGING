---
id: hq.research.compiler_graph.gate.structural_checks.check
---

# CHECK — 0_3_1_5_4_structural_checks

Node `hq.research.compiler_graph.gate.structural_checks`. Status `draft`.
