...
theorem rust__op_510_71_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (LeanIM.rop.SRL))) = ((shift_bits_right a (Sail.BitVec.extractLsb b (log2_xlen -i 1) 0))) := by
