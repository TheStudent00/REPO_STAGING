/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of go_10__go_op_88.  The term's layer-5 text, LITERAL:
...
double
emu_go_10__go_op_88(double a, double b)
{
