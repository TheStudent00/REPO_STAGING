...
# InterpRenderer from the layer-4 term of setne_gpr_one_8__reg_rdi__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(0, If(~(~Extract(7, 0, v0) | ~Extract(7, 0, v1)) == 0, 0, 1))
def emu_setne_gpr_one_8__reg_rdi__ruby(a, b)
  m(cat(0, ((eq(bnot(bor(bnot(a, 8), bnot(b, 8), 8), 8), 0, 8)) ? (0) : (1)), 8), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_setne_gpr_one_8__reg_rdi__ruby(*values)
