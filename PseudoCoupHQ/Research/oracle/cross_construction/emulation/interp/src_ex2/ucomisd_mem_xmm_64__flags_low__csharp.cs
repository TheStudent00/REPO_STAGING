...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of ucomisd_mem_xmm_64__flags_low__csharp.
    // The term's layer-5 text, LITERAL:
    //   fp.to_ieee_bv(fpToFP(v0))
    public static long emu_ucomisd_mem_xmm_64__flags_low__csharp(long a) {
        return m(a, 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_ucomisd_mem_xmm_64__flags_low__csharp(values[0])).ToString());
                    answers.Append("\n");
