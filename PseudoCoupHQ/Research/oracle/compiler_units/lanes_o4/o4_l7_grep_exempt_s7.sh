...
grep -c exempt \
  ...
  /projects/PseudoCoupHQ/Research/oracle/compiler_units/lanes_o4/o4_l4_nested_operands_regen.sh \
  /projects/PseudoCoupHQ/Research/oracle/compiler_units/lanes_o4/o4_l5_spelling_guard.sh
echo "[1/1] done"
