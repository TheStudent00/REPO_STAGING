...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of seto_gpr_one_8__reg_rdi__csharp.
    ...
    public static long emu_seto_gpr_one_8__reg_rdi__csharp(long a, long b) {
        return m(cat(0L, ((eq(ext(add(cat(ext(a, 7, 7), a, 8), cat(ext(b, 7, 7), b, 8), 9), 7, 7), ext(add(cat(ext(a, 7, 7), a, 8), cat(ext(b, 7, 7), b, 8), 9), 8, 8), 1)) ? (0L) : (1L)), 8), 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_seto_gpr_one_8__reg_rdi__csharp(values[0], values[1])).ToString());
                    answers.Append("\n");
