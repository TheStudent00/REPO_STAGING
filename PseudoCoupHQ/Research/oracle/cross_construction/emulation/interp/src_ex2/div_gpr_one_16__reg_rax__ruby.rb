...
# InterpRenderer from the layer-4 term of div_gpr_one_16__reg_rax__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(Extract(63, 16, v1), Extract(15, 0, bvudiv_i(Concat(Extract(15, 0, v0), Extract(15, 0, v1)), Concat(0, Extract(15, 0, v2)))))
def emu_div_gpr_one_16__reg_rax__ruby(a, b, c)
  m(cat(ext(b, 63, 16), ext(udiv(cat(a, ext(b, 15, 0), 16), cat(0, c, 16), 32), 15, 0), 16), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_div_gpr_one_16__reg_rax__ruby(*values)
