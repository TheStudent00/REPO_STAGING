...
# InterpRenderer from the layer-4 term of addss_xmm_same_32__reg_xmm0__ruby.
# The term's layer-5 text, LITERAL:
#   fp.to_ieee_bv(fpToFP(Extract(31, 0, v0)) + fpToFP(Extract(31, 0, v0)))
def emu_addss_xmm_same_32__reg_xmm0__ruby(a)
  m(fadd(a, a, 32), 32)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_addss_xmm_same_32__reg_xmm0__ruby(*values)
