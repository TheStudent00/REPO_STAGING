...
public class Emu {
    ...
    // one named local per gate, over the term of setg_gpr_one_8__reg_rdi__java.
    ...
    static long emu_setg_gpr_one_8__reg_rdi__java(long a, long b, long c) {
        long x0_7 = ext(b, 7, 7);
        long x1_7 = ext(a, 7, 7);
        long x1_6 = ext(a, 6, 6);
        long x0_6 = ext(b, 6, 6);
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_setg_gpr_one_8__reg_rdi__java(values[0], values[1], values[2])));
                    answers.append("\n");
