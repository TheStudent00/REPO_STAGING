...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of sd_gpr_mem_64__mem_MEM_0x0_a1___csharp.
    // The term's layer-5 text, LITERAL:
    //   v0
    public static long emu_sd_gpr_mem_64__mem_MEM_0x0_a1___csharp(long a) {
        return m(a, 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_sd_gpr_mem_64__mem_MEM_0x0_a1___csharp(values[0])).ToString());
                    answers.Append("\n");
