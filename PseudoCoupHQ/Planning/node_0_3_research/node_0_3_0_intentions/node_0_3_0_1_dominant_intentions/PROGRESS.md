...
- 2026-08-13: basis lists drafted
  ...
  `~/Programming/PseudoCoupHQ/Research/dominant_intentions/census_boolean_float.md`
...
- 2026-08-14: WP1 container toolchain installs DONE. 11/11 target
  ...
  awaiting the owner's `bash ~/Programming/SandboxDesign/allow.sh sync`
...
- 2026-08-14: WP2 CALIBRATION RUN DONE (phase 1 first light) —
  ...
  **CONFIRMED 109 / REFUTED 1 / SKIPPED 20** (csharp deliberate,
  ...
  `~/Programming/PseudoCoupHQ/DevComms/log_019_calibration_run.md`.
- 2026-08-14: WP2 FULL CENSUS RUN DONE (phase 1 complete) — the
  ...
  `~/Programming/PseudoCoupHQ/DevComms/log_020_full_census_run.md`.
...
- 2026-08-29 — LANGUAGE-UPDATE DRILL, rust 1.98.0 (shipped 2026-08-20,
  ...
  Record: `~/Programming/PseudoCoupHQ/DevComms/log_076_rust_198_update_drill.md`.
