...
// intermediate per node of the term of lb_gpr_mem_8__reg_a0__rust__all_constructed.
...
#[no_mangle]
pub extern "C" fn emu_lb_gpr_mem_8__reg_a0__rust__all_constructed(a: u8) -> u64
{
    let v0: u32 = (a as u32);
