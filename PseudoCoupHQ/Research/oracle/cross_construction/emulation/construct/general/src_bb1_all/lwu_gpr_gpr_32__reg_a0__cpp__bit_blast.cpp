/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of lwu_gpr_gpr_32__reg_a0__cpp__bit_blast.  The term's text, LITERAL:
   Concat(0, Extract(31, 0, v0)) */
#include <cstdint>

extern "C"
uint64_t
emu_lwu_gpr_gpr_32__reg_a0__cpp__bit_blast(uint32_t a)
{
