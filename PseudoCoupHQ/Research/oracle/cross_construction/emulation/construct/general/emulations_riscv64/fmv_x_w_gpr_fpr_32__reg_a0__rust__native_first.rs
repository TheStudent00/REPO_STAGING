...
// intermediate per node of the term of fmv_x_w_gpr_fpr_32__reg_a0__rust__native_first.
...
#[no_mangle]
pub extern "C" fn emu_fmv_x_w_gpr_fpr_32__reg_a0__rust__native_first(a: u32) -> u64
{
    let v0: u32 = (a as u32);
