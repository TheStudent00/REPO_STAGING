...
/-- rust single-opcode row 28, arch mnemonic 'sar', example unit rust/op_499, 8 members
...
theorem ModelCheck_rust_28 (v0 : BitVec 64) (v1 : BitVec 64) :
    ((v0.extractLsb 31 0).sshiftRight' ((0#27) ++ (v1.extractLsb 4 0)))
  = ((model_sar_8 (model_mov_18 v0) (model_mov_22 v1)).extractLsb 31 0) := by
  simp only [model_mov_22, model_mov_18, model_sar_8]
  bv_decide

#print axioms ModelCheck_rust_28
