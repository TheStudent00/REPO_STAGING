; ModuleID = '<scratch>/fl/run/i32_to_f32.rm2.flags/i32_to_f32.rm2.flags.rv.flat.ll'
source_filename = "llvm-link"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128"
target triple = "riscv64-unknown-unknown-elf"

define dso_local i64 @i32_to_f32_rm2_flags_flat(i32 noundef signext %arg) {
  ...
  %i39 = add i32 %i38, %i37
  %.n23 = xor i1 %i17, true
  %.m27 = sext i1 %i17 to i32
  %.a28 = and i32 %i26, %.m27
  %.c24 = and i1 %.n23, %.n10
  %.m25 = sext i1 %.c24 to i64
  %.a26 = and i64 %i40, %.m25
  %.m29 = sext i1 %.n23 to i32
  %.a30 = and i32 %i39, %.m29
  %.o31 = or i32 %.a28, %.a30
  %.m32 = sext i1 %.n10 to i32
  %.a33 = and i32 %.o31, %.m32
  %i42 = zext i32 %.a33 to i64
  %.m34 = sext i1 %.n10 to i64
  %.a35 = and i64 %.a26, %.m34
  %.a38 = and i64 %i42, %.m34
  %.o39 = or i64 %.a37, %.a38
  %i44 = shl i64 %.o39, 32
