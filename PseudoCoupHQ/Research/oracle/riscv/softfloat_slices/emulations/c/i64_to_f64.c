...
uint64_t i64_to_f64_rm1(uint64_t v_arg)
{
    ...
    const uint64_t v__sh18 = (uint64_t)((uint64_t)(v_i29) >> ((UINT64_C(0xa)) & 63));
    const bool v_i33 = (v_i29 < UINT64_C(0x400));
    const uint64_t v__m20 = (uint64_t)((v_i33) ? ~(uint64_t)0 : (uint64_t)0);
    const uint64_t v__n21 = (uint64_t)(v__m20 ^ UINT64_C(0xffffffffffffffff));
    const uint64_t v_i37 = (uint64_t)(v_i21 & v__n21);
    const uint64_t v_i38 = (uint64_t)(v__sh18 | v_i20);
    const uint64_t v_i39 = (uint64_t)(v_i38 + v_i37);
