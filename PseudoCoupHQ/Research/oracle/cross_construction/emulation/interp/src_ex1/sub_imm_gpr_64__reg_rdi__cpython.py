...
# InterpRenderer from the layer-4 term of sub_imm_gpr_64__reg_rdi__cpython.
# The term's layer-5 text, LITERAL:
#   v0 + 18446744073709551613
def emu_sub_imm_gpr_64__reg_rdi__cpython(a):
    return m(add(a, 18446744073709551613, 64), 64)
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_sub_imm_gpr_64__reg_rdi__cpython(*values)
            sys.stdout.write("%d\n" % answer)
