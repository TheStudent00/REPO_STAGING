...
theorem mulhu_gpr_gpr_same_64__reg_a0__rust__native_first_00_same_text (a : BitVec 64) :
    ((pure_MUL (a) (a) ({ result_part := LeanIM.VectorHalf.High, signed_rs1 := LeanIM.Signedness.Unsigned, signed_rs2 := LeanIM.Signedness.Unsigned }))) = (pure_BREV8 (a) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem mulhu_gpr_gpr_same_64__reg_a0__rust__native_first_01_same_text (a : BitVec 64) :
    ((pure_MUL (a) (a) ({ result_part := LeanIM.VectorHalf.High, signed_rs1 := LeanIM.Signedness.Unsigned, signed_rs2 := LeanIM.Signedness.Unsigned }))) = (pure_CLZ (a) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem mulhu_gpr_gpr_same_64__reg_a0__rust__native_first_02_same_text (a : BitVec 64) :
    ((pure_MUL (a) (a) ({ result_part := LeanIM.VectorHalf.High, signed_rs1 := LeanIM.Signedness.Unsigned, signed_rs2 := LeanIM.Signedness.Unsigned }))) = (pure_CLZW (a) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem mulhu_gpr_gpr_same_64__reg_a0__rust__native_first_03_same_text (a : BitVec 64) :
    ((pure_MUL (a) (a) ({ result_part := LeanIM.VectorHalf.High, signed_rs1 := LeanIM.Signedness.Unsigned, signed_rs2 := LeanIM.Signedness.Unsigned }))) = (pure_CTZ (a) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem mulhu_gpr_gpr_same_64__reg_a0__rust__native_first_04_same_text (a : BitVec 64) :
    ((pure_MUL (a) (a) ({ result_part := LeanIM.VectorHalf.High, signed_rs1 := LeanIM.Signedness.Unsigned, signed_rs2 := LeanIM.Signedness.Unsigned }))) = (pure_CTZW (a) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem mulhu_gpr_gpr_same_64__reg_a0__rust__native_first_05_same_text (a : BitVec 64) :
    ((pure_MUL (a) (a) ({ result_part := LeanIM.VectorHalf.High, signed_rs1 := LeanIM.Signedness.Unsigned, signed_rs2 := LeanIM.Signedness.Unsigned }))) = (pure_REV8 (a) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem mulhu_gpr_gpr_same_64__reg_a0__rust__native_first_06_same_text (a : BitVec 64) :
    ((pure_MUL (a) (a) ({ result_part := LeanIM.VectorHalf.High, signed_rs1 := LeanIM.Signedness.Unsigned, signed_rs2 := LeanIM.Signedness.Unsigned }))) = (pure_ZBB_EXTOP (a) (extop_zbb.SEXTB)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem mulhu_gpr_gpr_same_64__reg_a0__rust__native_first_07_same_text (a : BitVec 64) :
    ((pure_MUL (a) (a) ({ result_part := LeanIM.VectorHalf.High, signed_rs1 := LeanIM.Signedness.Unsigned, signed_rs2 := LeanIM.Signedness.Unsigned }))) = (pure_ZBB_EXTOP (a) (extop_zbb.SEXTH)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem mulhu_gpr_gpr_same_64__reg_a0__rust__native_first_08_same_text (a : BitVec 64) :
    ((pure_MUL (a) (a) ({ result_part := LeanIM.VectorHalf.High, signed_rs1 := LeanIM.Signedness.Unsigned, signed_rs2 := LeanIM.Signedness.Unsigned }))) = (pure_ZBB_EXTOP (a) (extop_zbb.ZEXTH)) := by
  with_reducible rfl
