...
# InterpRenderer from the layer-4 term of or_gpr_gpr_same_64__reg_a0__ruby.
# The term's layer-5 text, LITERAL:
#   v0
def emu_or_gpr_gpr_same_64__reg_a0__ruby(a)
  m(a, 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_or_gpr_gpr_same_64__reg_a0__ruby(*values)
