...
// one named local per gate, over the term of shl_imm_gpr_64__reg_rdi__php.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(60, 0, v0), 0)
function emu_shl_imm_gpr_64__reg_rdi__php($a) {
    $x0_0 = ex_ext($a, 0, 0);
    $x0_1 = ex_ext($a, 1, 1);
    $x0_2 = ex_ext($a, 2, 2);
    $x0_3 = ex_ext($a, 3, 3);
    ...
    $k0 = 0;
    $w0 = $x0_60;
    $w1 = ex_cat($w0, $x0_59, 1);
    $w2 = ex_cat($w1, $x0_58, 1);
    $w3 = ex_cat($w2, $x0_57, 1);
    $w4 = ex_cat($w3, $x0_56, 1);
    $w5 = ex_cat($w4, $x0_55, 1);
    $w6 = ex_cat($w5, $x0_54, 1);
    $w7 = ex_cat($w6, $x0_53, 1);
    $w8 = ex_cat($w7, $x0_52, 1);
    $w9 = ex_cat($w8, $x0_51, 1);
    $w10 = ex_cat($w9, $x0_50, 1);
    $w11 = ex_cat($w10, $x0_49, 1);
    $w12 = ex_cat($w11, $x0_48, 1);
    $w13 = ex_cat($w12, $x0_47, 1);
    $w14 = ex_cat($w13, $x0_46, 1);
    $w15 = ex_cat($w14, $x0_45, 1);
    $w16 = ex_cat($w15, $x0_44, 1);
    $w17 = ex_cat($w16, $x0_43, 1);
    $w18 = ex_cat($w17, $x0_42, 1);
    $w19 = ex_cat($w18, $x0_41, 1);
    $w20 = ex_cat($w19, $x0_40, 1);
    $w21 = ex_cat($w20, $x0_39, 1);
    $w22 = ex_cat($w21, $x0_38, 1);
    $w23 = ex_cat($w22, $x0_37, 1);
    $w24 = ex_cat($w23, $x0_36, 1);
    $w25 = ex_cat($w24, $x0_35, 1);
    $w26 = ex_cat($w25, $x0_34, 1);
    $w27 = ex_cat($w26, $x0_33, 1);
    $w28 = ex_cat($w27, $x0_32, 1);
    $w29 = ex_cat($w28, $x0_31, 1);
    $w30 = ex_cat($w29, $x0_30, 1);
    $w31 = ex_cat($w30, $x0_29, 1);
    $w32 = ex_cat($w31, $x0_28, 1);
    $w33 = ex_cat($w32, $x0_27, 1);
    $w34 = ex_cat($w33, $x0_26, 1);
    $w35 = ex_cat($w34, $x0_25, 1);
    $w36 = ex_cat($w35, $x0_24, 1);
    $w37 = ex_cat($w36, $x0_23, 1);
    $w38 = ex_cat($w37, $x0_22, 1);
    $w39 = ex_cat($w38, $x0_21, 1);
    $w40 = ex_cat($w39, $x0_20, 1);
    $w41 = ex_cat($w40, $x0_19, 1);
    $w42 = ex_cat($w41, $x0_18, 1);
    $w43 = ex_cat($w42, $x0_17, 1);
    $w44 = ex_cat($w43, $x0_16, 1);
    $w45 = ex_cat($w44, $x0_15, 1);
    $w46 = ex_cat($w45, $x0_14, 1);
    $w47 = ex_cat($w46, $x0_13, 1);
    $w48 = ex_cat($w47, $x0_12, 1);
    $w49 = ex_cat($w48, $x0_11, 1);
    $w50 = ex_cat($w49, $x0_10, 1);
    $w51 = ex_cat($w50, $x0_9, 1);
    $w52 = ex_cat($w51, $x0_8, 1);
    $w53 = ex_cat($w52, $x0_7, 1);
    $w54 = ex_cat($w53, $x0_6, 1);
    $w55 = ex_cat($w54, $x0_5, 1);
    $w56 = ex_cat($w55, $x0_4, 1);
    $w57 = ex_cat($w56, $x0_3, 1);
    $w58 = ex_cat($w57, $x0_2, 1);
    $w59 = ex_cat($w58, $x0_1, 1);
    $w60 = ex_cat($w59, $x0_0, 1);
    $w61 = ex_cat($w60, $k0, 1);
    $w62 = ex_cat($w61, $k0, 1);
    $w63 = ex_cat($w62, $k0, 1);
    return ex_m($w63, 64);
...
while (($line = fgets($handle)) !== false) {
    ...
    try {
        $answer = emu_shl_imm_gpr_64__reg_rdi__php(...$ints);
        if ($answer < 0) {
            echo sprintf("%s\n", sprintf("%u", $answer));
        } else {
            echo $answer . "\n";
