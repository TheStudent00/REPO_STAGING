...
// intermediate per node of the term of LOAD__is_unsigned_False__width_4__mem_addr__rust__native_first.
//   
#[no_mangle]
pub extern "C" fn emu_LOAD__is_unsigned_False__width_4__mem_addr__rust__native_first(a: u64, b: u16) -> u64
{
