---
id: hq.research.arch_unit_oracle.cross_construction.autopoly.check
---

# CHECK — 0_3_2_2_3_autopoly

Node `hq.research.arch_unit_oracle.cross_construction.autopoly`. Status `draft`.
