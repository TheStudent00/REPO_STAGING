...
# InterpRenderer from the layer-4 term of fdiv_d_fpr_fpr_fpr_64__freg_fa0__ruby.
# The term's layer-5 text, LITERAL:
#   fp.to_ieee_bv(fpToFP(v0) / fpToFP(v1))
def emu_fdiv_d_fpr_fpr_fpr_64__freg_fa0__ruby(a, b)
  m(fdiv(a, b, 64), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_fdiv_d_fpr_fpr_fpr_64__freg_fa0__ruby(*values)
