...
# InterpRenderer from the layer-4 term of fsw_fpr_mem_32__mem_MEM_0x0_a1___ruby.
# The term's layer-5 text, LITERAL:
#   Concat(Extract(63, 32, v0), Extract(31, 0, v1))
def emu_fsw_fpr_mem_32__mem_MEM_0x0_a1___ruby(a, b)
  m(cat(ext(a, 63, 32), b, 32), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_fsw_fpr_mem_32__mem_MEM_0x0_a1___ruby(*values)
