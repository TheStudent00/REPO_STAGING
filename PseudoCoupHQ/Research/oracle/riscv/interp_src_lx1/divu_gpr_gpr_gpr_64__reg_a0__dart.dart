...
// InterpRenderer from the layer-4 term of divu_gpr_gpr_gpr_64__reg_a0__dart.
// The term's layer-5 text, LITERAL:
//   If(v0 == 0, 18446744073709551615, bvudiv_i(v1, v0))
int emu_divu_gpr_gpr_gpr_64__reg_a0__dart(int a, int b) {
  return m(((eq(a, 0, 64)) ? (-1) : (udiv(b, a, 64))), 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_divu_gpr_gpr_gpr_64__reg_a0__dart(values[0], values[1]);
