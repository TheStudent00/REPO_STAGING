...
// intermediate per node of the term of MULW__one__rd__go__native_first.
//   
package main

//go:noinline
func emu_MULW__one__rd__go__native_first(a uint32, b uint32) uint64 {
...
func main() {
	sink = emu_MULW__one__rd__go__native_first(g0, g1)
	_ = sink
}
