...
public class Emu {
    ...
    // InterpRenderer from the layer-4 term of sw_gpr_gpr_imm_32__mem_MEM_a1__java.
    // The term's layer-5 text, LITERAL:
    //   Concat(Extract(63, 32, v0), Extract(31, 0, v1))
    static long emu_sw_gpr_gpr_imm_32__mem_MEM_a1__java(long a, long b) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_sw_gpr_gpr_imm_32__mem_MEM_a1__java(values[0], values[1])));
                    answers.append("\n");
