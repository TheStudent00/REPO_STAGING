...
theorem au_445_go_shr_i32_u64_abi_integer_level (a : BitVec 64) (b : BitVec 64) :
  ...
  try simp only [pure_ITYPE, pure_RTYPE, pure_RTYPEW, pure_SHIFTIOP, pure_SHIFTIWOP, pure_ZBA_RTYPEUW, pure_ZBB_RTYPE, bool_to_bit, log2_xlen, rotate_bits_left, rotate_bits_right, shift_bits_right_arith, sign_extend, xlenbits, zero_extend, zopz0zI_s, zopz0zI_u, zopz0zK_s, zopz0zK_u, bool_bit_forwards, xlen, rotatel, rotater, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend, Sail.BitVec.length, Sail.BitVec.extractLsb]
  all_goals grind
