...
theorem rust__op_469_69_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (LeanIM.rop.SLL))) = ((shift_bits_left a (Sail.BitVec.extractLsb b (log2_xlen -i 1) 0))) := by
