...
#eval IO.println s!"E {0} [{String.intercalate ", " (([(fun  => ((pure_ITYPE (zero_reg) (((sign_extend (m := 12) (0x00#6)))) (ADDI)))) ] : List (BitVec 64)).map (fun x => toString x.toNat))}]"
#eval IO.println s!"E {1} [{String.intercalate ", " (([(fun  => ((pure_ITYPE (zero_reg) (((sign_extend (m := 12) (0x00#6)))) (ADDI)))) ] : List (BitVec 64)).map (fun x => toString x.toNat))}]"
#eval IO.println s!"E {2} [{String.intercalate ", " (([(fun  => ((pure_ITYPE (zero_reg) (((sign_extend (m := 12) (0x00#6)))) (ADDI)))) ] : List (BitVec 64)).map (fun x => toString x.toNat))}]"
#eval IO.println s!"E {3} [{String.intercalate ", " (([(fun  => ((pure_ITYPE (zero_reg) (((sign_extend (m := 12) (0x00#6)))) (ADDI)))) ] : List (BitVec 64)).map (fun x => toString x.toNat))}]"
end Functions
end LeanIM
end
