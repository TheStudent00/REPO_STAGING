...
theorem andi_gpr_gpr_imm_64__reg_a0__rust__all_constructed__CLZW_02_fixed_width (a : BitVec 64) :
    ((pure_ITYPE (a) ((sign_extend (m := 12) (0x03#6))) (ANDI))) = (pure_CLZW (a) ) := by
  try simp only [pure_ITYPE, pure_CLZW, bool_to_bit, sign_extend, to_bits, xlenbits, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend]
  bv_decide
