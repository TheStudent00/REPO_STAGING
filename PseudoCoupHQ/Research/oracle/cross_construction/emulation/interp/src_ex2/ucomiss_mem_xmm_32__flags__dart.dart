...
// InterpRenderer from the layer-4 term of ucomiss_mem_xmm_32__flags__dart.
// The term's layer-5 text, LITERAL:
//   Concat(fp.to_ieee_bv(fpToFP(Extract(31, 0, v0))), fp.to_ieee_bv(fpToFP(Extract(31, 0, v1))))
int emu_ucomiss_mem_xmm_32__flags__dart(int a, int b) {
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_ucomiss_mem_xmm_32__flags__dart(values[0], values[1]);
