/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of lhu_gpr_fpr_fpr_16__reg_a0__cpp__bit_blast.  The term's text, LITERAL:
   Concat(0, Extract(15, 0, v0)) */
#include <cstdint>

extern "C"
uint64_t
emu_lhu_gpr_fpr_fpr_16__reg_a0__cpp__bit_blast(uint16_t a)
{
