...
function au_446_go_shr_i64_i32(p0, p1) {
  ...
  const v6 = AU.au_sltu(v5, 0x40n);
  const v7 = AU.au_add(v6, 0xffffffffffffffffn);
  const v8 = AU.au_or(v2, v7);
  const v9 = AU.au_sra(v1, v8);
  // the answer is int64, 64 bits
  return v9;
}

function au_446_go_shr_i64_i32_trap(p0, p1) {
  // a0: operand `a` (int64) arrives in a0
  const v1 = p0;
  // a1: operand `b` (int32) sign-extended to XLEN, as the ABI presents it
  const v2 = AU.au_sext32(p1);
...
module.exports = { au_446_go_shr_i64_i32, au_446_go_shr_i64_i32_trap };
