...
/-- rust single-opcode row 10, arch mnemonic 'lea', example unit rust/regen_1029, 2 members
...
theorem ModelCheck_rust_10 (v0 : BitVec 64) (v1 : BitVec 64) :
    ((v0.extractLsb 31 0) + (v1.extractLsb 31 0))
  = ((model_lea_6 v1 v0).extractLsb 31 0) := by
  simp only [model_lea_6]
  bv_decide

#print axioms ModelCheck_rust_10
