...
// InterpRenderer from the layer-4 term of div_gpr_one_32__reg_rax__dart.
// The term's layer-5 text, LITERAL:
//   Concat(0, Extract(31, 0, bvudiv_i(Concat(Extract(31, 0, v0), Extract(31, 0, v1)), Concat(0, Extract(31, 0, v2)))))
int emu_div_gpr_one_32__reg_rax__dart(int a, int b, int c) {
  return m(cat(0, ext(udiv(cat(a, b, 32), cat(0, c, 32), 64), 31, 0), 32), 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_div_gpr_one_32__reg_rax__dart(values[0], values[1], values[2]);
