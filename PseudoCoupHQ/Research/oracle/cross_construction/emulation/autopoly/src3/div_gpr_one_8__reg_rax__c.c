/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of div_gpr_one_8__reg_rax__c.  The term's layer-5 text, LITERAL:
...
uint64_t
emu_div_gpr_one_8__reg_rax__c(uint64_t a, uint8_t b)
{
