...
// intermediate per node of the term of sar_imm_gpr_64__reg_rdi__go__bit_blast.
//   v0 >> 3
package main

//go:noinline
func emu_sar_imm_gpr_64__reg_rdi__go__bit_blast(a uint64) uint64 {
...
func main() {
	sink = emu_sar_imm_gpr_64__reg_rdi__go__bit_blast(g0)
	_ = sink
}
