...
# InterpRenderer from the layer-4 term of srai_gpr_gpr_imm_64__reg_a0__ruby.
# The term's layer-5 text, LITERAL:
#   v0 >> 3
def emu_srai_gpr_gpr_imm_64__reg_a0__ruby(a)
  m(ashr(a, 3, 64), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_srai_gpr_gpr_imm_64__reg_a0__ruby(*values)
