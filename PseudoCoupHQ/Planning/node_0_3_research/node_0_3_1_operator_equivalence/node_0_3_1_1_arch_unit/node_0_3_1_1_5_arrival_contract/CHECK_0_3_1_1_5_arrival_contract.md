---
id: hq.research.compiler_graph.arch_unit.arrival_contract.check
---

# CHECK — 0_3_1_1_5_arrival_contract

Node `hq.research.compiler_graph.arch_unit.arrival_contract`. Status `draft`.
