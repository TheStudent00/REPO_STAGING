...
// intermediate per node of the term of movq_xmm_gpr_64__reg_rdi__go__bit_blast.
//   Extract(63, 0, v0)
package main

//go:noinline
func emu_movq_xmm_gpr_64__reg_rdi__go__bit_blast(a float64) uint64 {
...
func main() {
	sink = emu_movq_xmm_gpr_64__reg_rdi__go__bit_blast(g0)
	_ = sink
}
