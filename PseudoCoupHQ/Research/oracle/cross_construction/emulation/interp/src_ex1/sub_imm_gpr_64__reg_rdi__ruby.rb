...
# InterpRenderer from the layer-4 term of sub_imm_gpr_64__reg_rdi__ruby.
# The term's layer-5 text, LITERAL:
#   v0 + 18446744073709551613
def emu_sub_imm_gpr_64__reg_rdi__ruby(a)
  m(add(a, 18446744073709551613, 64), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_sub_imm_gpr_64__reg_rdi__ruby(*values)
