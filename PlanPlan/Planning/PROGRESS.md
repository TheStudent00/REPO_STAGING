...
- 2026-08-02 **done** (the owner's instruction): the repo was renamed from
  ...
  - **Quoted speech carries the new name too, on the owner's ruling.**
    ...
    `PRIVATE/PlanPlan/Planning/CORE_0.md`,
    `PRIVATE/PlanPlan/framework/generate_nodes.py`,
    `PRIVATE/PseudoCoupHQ/DevComms/log_005_session_state_2026_08_01.md`
    and
    `PRIVATE/DevComms/proposal_2026-08-01_communication_protocol.md`.
...
- 2026-08-01: the tree was founded THROUGH the framework's own tools,
  ...
  created by
  `python3 PRIVATE/PlanPlan/framework/generate_nodes.py PRIVATE/PlanPlan/Planning --apply`.
...
- 2026-08-15 **done**: new tool `framework/rename_node.py` — renames a
  ...
  `PRIVATE/PseudoCoupHQ/Planning/node_0_3_research/node_0_3_0_kind_signature_clustering/PROGRESS.md`),
