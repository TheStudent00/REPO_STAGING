...
# InterpRenderer from the layer-4 term of neg_gpr_one_16__reg_rdi__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(0, Extract(15, 0, v0)*65535)
def emu_neg_gpr_one_16__reg_rdi__ruby(a)
  m(cat(0, mul(a, 65535, 16), 16), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_neg_gpr_one_16__reg_rdi__ruby(*values)
