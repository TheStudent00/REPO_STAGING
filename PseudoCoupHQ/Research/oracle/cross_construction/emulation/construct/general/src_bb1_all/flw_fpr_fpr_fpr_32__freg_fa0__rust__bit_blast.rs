...
// intermediate per node of the term of flw_fpr_fpr_fpr_32__freg_fa0__rust__bit_blast.
//   Concat(4294967295, Extract(31, 0, v0))
#[no_mangle]
pub extern "C" fn emu_flw_fpr_fpr_fpr_32__freg_fa0__rust__bit_blast(a: u32) -> u64
{
    ...
    let w32: u64 = w31 | (k1 << 32);
    let w33: u64 = w32 | (k1 << 33);
    let w34: u64 = w33 | (k1 << 34);
    let w35: u64 = w34 | (k1 << 35);
    let w36: u64 = w35 | (k1 << 36);
    let w37: u64 = w36 | (k1 << 37);
    let w38: u64 = w37 | (k1 << 38);
    let w39: u64 = w38 | (k1 << 39);
    let w40: u64 = w39 | (k1 << 40);
    let w41: u64 = w40 | (k1 << 41);
    let w42: u64 = w41 | (k1 << 42);
    let w43: u64 = w42 | (k1 << 43);
    let w44: u64 = w43 | (k1 << 44);
    let w45: u64 = w44 | (k1 << 45);
    let w46: u64 = w45 | (k1 << 46);
    let w47: u64 = w46 | (k1 << 47);
    let w48: u64 = w47 | (k1 << 48);
    let w49: u64 = w48 | (k1 << 49);
    let w50: u64 = w49 | (k1 << 50);
    let w51: u64 = w50 | (k1 << 51);
    let w52: u64 = w51 | (k1 << 52);
    let w53: u64 = w52 | (k1 << 53);
    let w54: u64 = w53 | (k1 << 54);
    let w55: u64 = w54 | (k1 << 55);
    let w56: u64 = w55 | (k1 << 56);
    let w57: u64 = w56 | (k1 << 57);
    let w58: u64 = w57 | (k1 << 58);
    let w59: u64 = w58 | (k1 << 59);
    let w60: u64 = w59 | (k1 << 60);
    let w61: u64 = w60 | (k1 << 61);
    let w62: u64 = w61 | (k1 << 62);
    let w63: u64 = w62 | (k1 << 63);
    ((w63) as u64)
}
