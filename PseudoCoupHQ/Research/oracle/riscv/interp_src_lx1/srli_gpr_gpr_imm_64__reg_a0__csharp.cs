...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of srli_gpr_gpr_imm_64__reg_a0__csharp.
    // The term's layer-5 text, LITERAL:
    //   Concat(0, Extract(63, 3, v0))
    public static long emu_srli_gpr_gpr_imm_64__reg_a0__csharp(long a) {
        return m(cat(0L, ext(a, 63, 3), 61), 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_srli_gpr_gpr_imm_64__reg_a0__csharp(values[0])).ToString());
                    answers.Append("\n");
