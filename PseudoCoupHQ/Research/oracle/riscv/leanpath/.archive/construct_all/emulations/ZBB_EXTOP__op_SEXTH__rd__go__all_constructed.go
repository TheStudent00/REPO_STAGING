...
// intermediate per node of the term of ZBB_EXTOP__op_SEXTH__rd__go__all_constructed.
//   
package main

//go:noinline
func emu_ZBB_EXTOP__op_SEXTH__rd__go__all_constructed(a uint16) uint64 {
...
func main() {
	sink = emu_ZBB_EXTOP__op_SEXTH__rd__go__all_constructed(g0)
	_ = sink
}
