...
// one named local per gate, over the term of sar_imm_gpr_8__reg_rdi__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(63, 8, v0), Extract(7, 0, v0) >> 3)
function emu_sar_imm_gpr_8__reg_rdi__javascript(a) {
    ...
    const w57 = cat(w56, x0_7, 1);
    const w58 = cat(w57, x0_7, 1);
...
for (const line of lines) {
    ...
    try {
        out.push(emu_sar_imm_gpr_8__reg_rdi__javascript(...values).toString());
    } catch (problem) {
