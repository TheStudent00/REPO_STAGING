...
// intermediate per node of the term of ZBB_RTYPE__op_MAXU__rd__rust__all_constructed.
//   
#[no_mangle]
pub extern "C" fn emu_ZBB_RTYPE__op_MAXU__rd__rust__all_constructed(a: u64, b: u64) -> u64
{
    let v0: u64 = ((0x1u32) as u64);
    let v1: u64 = ((!(((a as u64)) as u64)) as u64);
    let v2: u64 = (((((b as u64)) as u64) ^ ((v1) as u64)) as u64);
    let v3: u64 = ((((v2) as u64) & ((v0) as u64)) as u64);
    let v4: u64 = (((((b as u64)) as u64) & ((v1) as u64)) as u64);
    ...
    let v36: bool = (!(v35));
    let v37: u64 = (if (v36) { (((b as u64)) as u64) } else { (((a as u64)) as u64) });
    ((v37) as u64)
}
