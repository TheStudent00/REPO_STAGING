...
// intermediate per node of the term of and_gpr_gpr_same_64__reg_a0__go__bit_blast.
//   v0
package main

//go:noinline
func emu_and_gpr_gpr_same_64__reg_a0__go__bit_blast(a uint64) uint64 {
...
func main() {
	sink = emu_and_gpr_gpr_same_64__reg_a0__go__bit_blast(g0)
	_ = sink
}
