...
// SwiftRenderer from the layer-4 term of mul_gpr_one_32__reg_rax__swift.
// EVERY SPELLING IN THIS SOURCE IS UNMEASURED: there is no swiftc in
// the image, so nothing here has been compiled or carved.
// The term's layer-5 text, LITERAL:
//   Concat(0, Extract(31, 0, v0)*Extract(31, 0, v1))
@_cdecl("emu_mul_gpr_one_32__reg_rax__swift")
public func emu_mul_gpr_one_32__reg_rax__swift(_ a: UInt32, _ b: UInt32) -> UInt64
{
