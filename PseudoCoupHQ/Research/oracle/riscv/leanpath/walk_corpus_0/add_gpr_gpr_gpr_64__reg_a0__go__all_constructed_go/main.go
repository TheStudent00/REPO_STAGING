...
// intermediate per node of the term of add_gpr_gpr_gpr_64__reg_a0__go__all_constructed.
//   v0 + v1
package main

//go:noinline
func emu_add_gpr_gpr_gpr_64__reg_a0__go__all_constructed(a uint64, b uint64) uint64 {
...
func main() {
	sink = emu_add_gpr_gpr_gpr_64__reg_a0__go__all_constructed(g0, g1)
	_ = sink
}
