...
public static class Emu {
    ...
    // one named local per gate, over the term of setl_gpr_one_8__reg_rdi__csharp.
    ...
    public static long emu_setl_gpr_one_8__reg_rdi__csharp(long a, long b, long c) {
        long x0_7 = ext(b, 7, 7);
        long x0_1 = ext(b, 1, 1);
        long x0_0 = ext(b, 0, 0);
        long x0_2 = ext(b, 2, 2);
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_setl_gpr_one_8__reg_rdi__csharp(values[0], values[1], values[2])).ToString());
                    answers.Append("\n");
