...
// intermediate per node of the term of ZBS_RTYPE__op_BCLR__rd__rust__all_constructed.
//   
#[no_mangle]
pub extern "C" fn emu_ZBS_RTYPE__op_BCLR__rd__rust__all_constructed(a: u8, b: u64) -> u64
{
    let v0: u32 = (((((a as u32)) >> 0) as u32) & 0x3fu32);
    let v1: u32 = v0;
    let v2: u64 = 0x0u64;
    ...
    let v28: u64 = ((((0x1u64) as u64) & ((v27) as u64)) as u64);
    let v29: u64 = ((((0x1u64) as u64).wrapping_shl((((0x1u64) as u64) as u32))) as u64);
    ...
    let v90: u64 = ((!(((b as u64)) as u64)) as u64);
    let v91: u64 = ((((v90) as u64) | ((v89) as u64)) as u64);
    let v92: u64 = ((!((v91) as u64)) as u64);
    ((v92) as u64)
}
