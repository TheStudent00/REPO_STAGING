...
// InterpRenderer from the layer-4 term of cmovae_gpr_gpr_64__reg_rdi__javascript.
// The term's layer-5 text, LITERAL:
//   If(ULE(v0, v1), v2, v3)
function emu_cmovae_gpr_gpr_64__reg_rdi__javascript(a, b, c, d) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_cmovae_gpr_gpr_64__reg_rdi__javascript(...values).toString());
    } catch (problem) {
