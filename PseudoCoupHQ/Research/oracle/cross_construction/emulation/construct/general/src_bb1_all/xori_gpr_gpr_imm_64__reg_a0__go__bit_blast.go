...
// intermediate per node of the term of xori_gpr_gpr_imm_64__reg_a0__go__bit_blast.
//   Concat(Extract(63, 2, v0), ~Extract(1, 0, v0))
package main

//go:noinline
func emu_xori_gpr_gpr_imm_64__reg_a0__go__bit_blast(a uint64) uint64 {
...
func main() {
	sink = emu_xori_gpr_gpr_imm_64__reg_a0__go__bit_blast(g0)
	_ = sink
}
