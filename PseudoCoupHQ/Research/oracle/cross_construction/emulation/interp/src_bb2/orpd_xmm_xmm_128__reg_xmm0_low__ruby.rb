...
# one named local per gate, over the term of orpd_xmm_xmm_128__reg_xmm0_low__ruby.
# The term's layer-5 text, LITERAL:
#   Extract(63, 0, v0) | Extract(63, 0, v1)
def emu_orpd_xmm_xmm_128__reg_xmm0_low__ruby(a, b)
  x1_0 = ext(b, 0, 0)
  x0_0 = ext(a, 0, 0)
  x1_1 = ext(b, 1, 1)
  x0_1 = ext(a, 1, 1)
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_orpd_xmm_xmm_128__reg_xmm0_low__ruby(*values)
