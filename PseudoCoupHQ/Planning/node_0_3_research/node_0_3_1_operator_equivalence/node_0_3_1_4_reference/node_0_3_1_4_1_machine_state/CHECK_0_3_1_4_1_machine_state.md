---
id: hq.research.compiler_graph.reference.machine_state.check
---

# CHECK — 0_3_1_4_1_machine_state

Node `hq.research.compiler_graph.reference.machine_state`. Status `draft`.
