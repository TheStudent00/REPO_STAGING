/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of movd_gpr_xmm_32__reg_xmm0__c__bit_blast.  The term's text, LITERAL:
   Extract(31, 0, v0) */
#include <stdint.h>
#include <string.h>
...
float
emu_movd_gpr_xmm_32__reg_xmm0__c__bit_blast(uint32_t a)
{
