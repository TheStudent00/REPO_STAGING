...
# InterpRenderer from the layer-4 term of cwtl_none_64__reg_rax__cpython.
...
def emu_cwtl_none_64__reg_rax__cpython(a):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_cwtl_none_64__reg_rax__cpython(*values)
            sys.stdout.write("%d\n" % answer)
