...
theorem rust__op_534_46_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPEW (a) (b) (ADDW))) = ((a + b)) := by
  try simp only [pure_RTYPEW, shift_bits_right_arith, sign_extend, Sail.BitVec.signExtend, Sail.BitVec.extractLsb, Sail.shift_bits_right, Sail.shift_bits_left]
  all_goals grind

set_option maxHeartbeats 40000 in
theorem rust__op_534_91_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPEW (a) (b) (ADDW))) = ((sign_extend (m := 64) ((Sail.BitVec.extractLsb a 31 0) + (Sail.BitVec.extractLsb b 31 0)))) := by
  try simp only [pure_RTYPEW, shift_bits_right_arith, sign_extend, Sail.BitVec.signExtend, Sail.BitVec.extractLsb, Sail.shift_bits_right, Sail.shift_bits_left]
  all_goals grind
