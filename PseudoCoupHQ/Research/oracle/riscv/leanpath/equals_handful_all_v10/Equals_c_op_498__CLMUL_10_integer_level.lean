...
theorem c_op_498__CLMUL_10_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (zero_reg) ((pure_RTYPE (a) (b) (XOR))) (LeanIM.rop.SLTU))) = (pure_CLMUL (a) (b) ) := by
  try simp only [pure_RTYPE, pure_CLMUL, bool_to_bit, carryless_mul, log2_xlen, shift_bits_right_arith, xlen, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, zeros, Sail.BitVec.length, Sail.BitVec.zeroExtend]
  grind
