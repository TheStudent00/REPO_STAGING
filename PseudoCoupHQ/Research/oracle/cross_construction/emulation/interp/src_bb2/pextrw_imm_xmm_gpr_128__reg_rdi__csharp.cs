...
public static class Emu {
    ...
    // one named local per gate, over the term of pextrw_imm_xmm_gpr_128__reg_rdi__csharp.
    // The term's layer-5 text, LITERAL:
    //   Concat(0, Extract(31, 16, v0))
    public static long emu_pextrw_imm_xmm_gpr_128__reg_rdi__csharp(long a) {
        ...
        long w49 = cat(w48, x0_30, 1);
        long w50 = cat(w49, x0_29, 1);
        long w51 = cat(w50, x0_28, 1);
        long w52 = cat(w51, x0_27, 1);
        long w53 = cat(w52, x0_26, 1);
        long w54 = cat(w53, x0_25, 1);
        long w55 = cat(w54, x0_24, 1);
        long w56 = cat(w55, x0_23, 1);
        long w57 = cat(w56, x0_22, 1);
        long w58 = cat(w57, x0_21, 1);
        long w59 = cat(w58, x0_20, 1);
        long w60 = cat(w59, x0_19, 1);
        long w61 = cat(w60, x0_18, 1);
        long w62 = cat(w61, x0_17, 1);
        long w63 = cat(w62, x0_16, 1);
        return m(w63, 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_pextrw_imm_xmm_gpr_128__reg_rdi__csharp(values[0])).ToString());
                    answers.Append("\n");
