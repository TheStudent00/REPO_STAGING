...
public func emu_setne_gpr_one_8__reg_rdi__swift(_ a: UInt8, _ b: UInt8, _ c: UInt64) -> UInt64
{
    return UInt64(truncatingIfNeeded: (UInt64(truncatingIfNeeded: ((UInt64(truncatingIfNeeded: ((UInt64(truncatingIfNeeded: ((UInt64(c))) &>> 8)) & UInt64(0xffffffffffffff)))) &<< 8) | (UInt64(truncatingIfNeeded: ((((UInt32(truncatingIfNeeded: ((UInt32(truncatingIfNeeded: (UInt32(truncatingIfNeeded: (UInt32(b)))) | (UInt32(truncatingIfNeeded: (UInt32(a)))))) & UInt32(0xff)))) == (UInt32(truncatingIfNeeded: UInt32(0x0))))) ? (UInt32(0x0)) : (UInt32(0x1))))))))
}
