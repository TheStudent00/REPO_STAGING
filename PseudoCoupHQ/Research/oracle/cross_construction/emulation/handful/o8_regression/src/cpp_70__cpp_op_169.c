/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of cpp_70__cpp_op_169.  The term's layer-5 text, LITERAL:
   v0*18446744073709551615 + Concat(0, Extract(31, 0, v1)) */
#include <stdint.h>

uint64_t
emu_cpp_70__cpp_op_169(uint32_t a, uint64_t b)
{
