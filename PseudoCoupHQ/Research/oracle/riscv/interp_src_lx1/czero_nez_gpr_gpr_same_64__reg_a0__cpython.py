...
# InterpRenderer from the layer-4 term of czero_nez_gpr_gpr_same_64__reg_a0__cpython.
# The term's layer-5 text, LITERAL:
#   If(v0 == 0, v0, 0)
def emu_czero_nez_gpr_gpr_same_64__reg_a0__cpython(a):
    return m(((a) if (eq(a, 0, 64)) else (0)), 64)
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_czero_nez_gpr_gpr_same_64__reg_a0__cpython(*values)
            sys.stdout.write("%d\n" % answer)
