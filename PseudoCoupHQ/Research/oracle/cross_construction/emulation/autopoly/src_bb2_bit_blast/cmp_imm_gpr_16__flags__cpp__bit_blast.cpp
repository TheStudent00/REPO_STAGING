/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of cmp_imm_gpr_16__flags__cpp__bit_blast.  The term's text, LITERAL:
   Concat(Extract(15, 0, v0), Extract(15, 0, v1)) */
#include <cstdint>

extern "C"
uint32_t
emu_cmp_imm_gpr_16__flags__cpp__bit_blast(uint16_t a, uint16_t b)
{
