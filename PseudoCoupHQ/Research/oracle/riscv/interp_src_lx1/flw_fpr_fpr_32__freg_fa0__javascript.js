...
// InterpRenderer from the layer-4 term of flw_fpr_fpr_32__freg_fa0__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(4294967295, Extract(31, 0, v0))
function emu_flw_fpr_fpr_32__freg_fa0__javascript(a) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_flw_fpr_fpr_32__freg_fa0__javascript(...values).toString());
    } catch (problem) {
