#!/usr/bin/env bash
# o2 lane 9 (final, after removing cd-based commands and relocating referenced lane logs into the mounted repo) -- final verifier pass: check_conventions_log_claims.py
...
python3 check_conventions_log_claims.py --verify \
  --timeout 120 \
  --json /projects/PseudoCoupHQ/Research/oracle/arch_opcodes/log_208_claims_final.json \
