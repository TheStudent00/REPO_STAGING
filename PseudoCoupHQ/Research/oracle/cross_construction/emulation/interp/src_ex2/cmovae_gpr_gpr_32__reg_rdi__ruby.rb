...
# InterpRenderer from the layer-4 term of cmovae_gpr_gpr_32__reg_rdi__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(0, If(ULE(Extract(31, 0, v0), Extract(31, 0, v1)), Extract(31, 0, v2), Extract(31, 0, v3)))
def emu_cmovae_gpr_gpr_32__reg_rdi__ruby(a, b, c, d)
  m(cat(0, ((ule(b, a, 32)) ? (c) : (d)), 32), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_cmovae_gpr_gpr_32__reg_rdi__ruby(*values)
