...
// intermediate per node of the term of sraiw_gpr_gpr_imm_32__reg_a0__rust__bit_blast.
...
#[no_mangle]
pub extern "C" fn emu_sraiw_gpr_gpr_imm_32__reg_a0__rust__bit_blast(a: u32) -> u64
{
    ...
    let w0: u64 = (x0_3 << 0);
    let w1: u64 = w0 | (x0_4 << 1);
    let w2: u64 = w1 | (x0_5 << 2);
    let w3: u64 = w2 | (x0_6 << 3);
    let w4: u64 = w3 | (x0_7 << 4);
    let w5: u64 = w4 | (x0_8 << 5);
    let w6: u64 = w5 | (x0_9 << 6);
    let w7: u64 = w6 | (x0_10 << 7);
    let w8: u64 = w7 | (x0_11 << 8);
    let w9: u64 = w8 | (x0_12 << 9);
    let w10: u64 = w9 | (x0_13 << 10);
    let w11: u64 = w10 | (x0_14 << 11);
    let w12: u64 = w11 | (x0_15 << 12);
    let w13: u64 = w12 | (x0_16 << 13);
    let w14: u64 = w13 | (x0_17 << 14);
    let w15: u64 = w14 | (x0_18 << 15);
    let w16: u64 = w15 | (x0_19 << 16);
    let w17: u64 = w16 | (x0_20 << 17);
    let w18: u64 = w17 | (x0_21 << 18);
    let w19: u64 = w18 | (x0_22 << 19);
    let w20: u64 = w19 | (x0_23 << 20);
    let w21: u64 = w20 | (x0_24 << 21);
    let w22: u64 = w21 | (x0_25 << 22);
    let w23: u64 = w22 | (x0_26 << 23);
    let w24: u64 = w23 | (x0_27 << 24);
    let w25: u64 = w24 | (x0_28 << 25);
    let w26: u64 = w25 | (x0_29 << 26);
    let w27: u64 = w26 | (x0_30 << 27);
    let w28: u64 = w27 | (x0_31 << 28);
    let w29: u64 = w28 | (x0_31 << 29);
    let w30: u64 = w29 | (x0_31 << 30);
