...
# InterpRenderer from the layer-4 term of cvtsi2sd_gpr_xmm_64__reg_xmm0__ruby.
# The term's layer-5 text, LITERAL:
#   fp.to_ieee_bv(fpToFP(RNE(), v0))
def emu_cvtsi2sd_gpr_xmm_64__reg_xmm0__ruby(a)
  m(i2f(a, 64, 64), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_cvtsi2sd_gpr_xmm_64__reg_xmm0__ruby(*values)
