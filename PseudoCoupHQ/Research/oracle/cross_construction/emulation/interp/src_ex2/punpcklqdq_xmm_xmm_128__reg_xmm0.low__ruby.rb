...
# InterpRenderer from the layer-4 term of punpcklqdq_xmm_xmm_128__reg_xmm0.low__ruby.
# The term's layer-5 text, LITERAL:
#   Extract(63, 0, v0)
def emu_punpcklqdq_xmm_xmm_128__reg_xmm0.low__ruby(a)
  m(a, 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_punpcklqdq_xmm_xmm_128__reg_xmm0.low__ruby(*values)
