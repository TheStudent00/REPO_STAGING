...
public class Emu {
    ...
    // InterpRenderer from the layer-4 term of sbb_imm_gpr_8__reg_rdi__java.
    ...
    static long emu_sbb_imm_gpr_8__reg_rdi__java(long a, long b, long c, long d) {
        return m(cat(0L, add(add(mul(d, 255L, 8), mul(((eq(ext(add(cat(0L, b, 8), cat(0L, a, 8), 9), 8, 8), 1L, 1)) ? (1L) : (0L)), 255L, 8), 8), c, 8), 8), 64);
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_sbb_imm_gpr_8__reg_rdi__java(values[0], values[1], values[2], values[3])));
                    answers.append("\n");
