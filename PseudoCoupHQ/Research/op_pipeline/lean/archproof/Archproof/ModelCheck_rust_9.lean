...
/-- rust single-opcode row 9, arch mnemonic 'lea', example unit rust/op_541, 6 members
...
theorem ModelCheck_rust_9 (v0 : BitVec 64) (v1 : BitVec 64) :
    (v0 + v1)
  = (model_lea_1 v0 v1) := by
  simp only [model_lea_1]
  bv_decide

#print axioms ModelCheck_rust_9
