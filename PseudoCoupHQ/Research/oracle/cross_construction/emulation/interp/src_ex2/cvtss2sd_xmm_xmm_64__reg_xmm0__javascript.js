...
// InterpRenderer from the layer-4 term of cvtss2sd_xmm_xmm_64__reg_xmm0__javascript.
// The term's layer-5 text, LITERAL:
//   fp.to_ieee_bv(fpToFP(RNE(), fpToFP(Extract(31, 0, v0))))
function emu_cvtss2sd_xmm_xmm_64__reg_xmm0__javascript(a) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_cvtss2sd_xmm_xmm_64__reg_xmm0__javascript(...values).toString());
    } catch (problem) {
