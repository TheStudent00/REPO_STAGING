...
// InterpRenderer from the layer-4 term of addiw_gpr_gpr_imm_32__reg_a0__dart.
...
int emu_addiw_gpr_gpr_imm_32__reg_a0__dart(int a) {
  return m(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(ext(add(a, 3, 32), 31, 31), ext(add(a, 3, 32), 31, 31), 1), ext(add(a, 3, 32), 31, 31), 1), ext(add(a, 3, 32), 31, 31), 1), ext(add(a, 3, 32), 31, 31), 1), ext(add(a, 3, 32), 31, 31), 1), ext(add(a, 3, 32), 31, 31), 1), ext(add(a, 3, 32), 31, 31), 1), ext(add(a, 3, 32), 31, 31), 1), ext(add(a, 3, 32), 31, 31), 1), ext(add(a, 3, 32), 31, 31), 1), ext(add(a, 3, 32), 31, 31), 1), ext(add(a, 3, 32), 31, 31), 1), ext(add(a, 3, 32), 31, 31), 1), ext(add(a, 3, 32), 31, 31), 1), ext(add(a, 3, 32), 31, 31), 1), ext(add(a, 3, 32), 31, 31), 1), ext(add(a, 3, 32), 31, 31), 1), ext(add(a, 3, 32), 31, 31), 1), ext(add(a, 3, 32), 31, 31), 1), ext(add(a, 3, 32), 31, 31), 1), ext(add(a, 3, 32), 31, 31), 1), ext(add(a, 3, 32), 31, 31), 1), ext(add(a, 3, 32), 31, 31), 1), ext(add(a, 3, 32), 31, 31), 1), ext(add(a, 3, 32), 31, 31), 1), ext(add(a, 3, 32), 31, 31), 1), ext(add(a, 3, 32), 31, 31), 1), ext(add(a, 3, 32), 31, 31), 1), ext(add(a, 3, 32), 31, 31), 1), ext(add(a, 3, 32), 31, 31), 1), ext(add(a, 3, 32), 31, 31), 1), add(a, 3, 32), 32), 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_addiw_gpr_gpr_imm_32__reg_a0__dart(values[0]);
