/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of pxor_xmm_same_128__reg_xmm0_low__c__bit_blast.  The term's text, LITERAL:
   0 */
#include <stdint.h>
#include <string.h>
...
double
emu_pxor_xmm_same_128__reg_xmm0_low__c__bit_blast(void)
{
    uint64_t k0 = 0;
    uint64_t w0 = (k0 << 0);
    uint64_t w1 = w0 | (k0 << 1);
