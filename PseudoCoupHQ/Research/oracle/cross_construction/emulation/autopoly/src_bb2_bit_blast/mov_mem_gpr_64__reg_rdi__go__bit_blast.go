...
// intermediate per node of the term of mov_mem_gpr_64__reg_rdi__go__bit_blast.
//   v0
package main

//go:noinline
func emu_mov_mem_gpr_64__reg_rdi__go__bit_blast(a uint64) uint64 {
...
func main() {
	sink = emu_mov_mem_gpr_64__reg_rdi__go__bit_blast(g0)
	_ = sink
}
