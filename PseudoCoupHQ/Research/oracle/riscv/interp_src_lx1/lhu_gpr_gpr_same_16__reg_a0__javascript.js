...
// InterpRenderer from the layer-4 term of lhu_gpr_gpr_same_16__reg_a0__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(0, Extract(15, 0, v0))
function emu_lhu_gpr_gpr_same_16__reg_a0__javascript(a) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_lhu_gpr_gpr_same_16__reg_a0__javascript(...values).toString());
    } catch (problem) {
