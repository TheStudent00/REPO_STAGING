...
theorem addw_gpr_gpr_same_32__reg_a0__c__all_constructed__REV8_05_integer_level (a : BitVec 64) :
  ...
  try simp only [pure_SHIFTIWOP, pure_SHIFTIOP, pure_ZBA_RTYPEUW, pure_ITYPE, pure_RTYPE, pure_ZBA_RTYPE, pure_REV8, bool_to_bit, log2_xlen, rev8, shift_bits_right_arith, sign_extend, xlenbits, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, zeros, Sail.BitVec.length, Sail.BitVec.updateSubrange, Sail.BitVec.extractLsb, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend]
  grind
