...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of sll_gpr_gpr_gpr_64__reg_a0__csharp.
    // The term's layer-5 text, LITERAL:
    //   v0 << Concat(0, Extract(5, 0, v1))
    public static long emu_sll_gpr_gpr_gpr_64__reg_a0__csharp(long a, long b) {
        return m(shl(a, cat(0L, ext(b, 5, 0), 6), 64), 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_sll_gpr_gpr_gpr_64__reg_a0__csharp(values[0], values[1])).ToString());
                    answers.Append("\n");
