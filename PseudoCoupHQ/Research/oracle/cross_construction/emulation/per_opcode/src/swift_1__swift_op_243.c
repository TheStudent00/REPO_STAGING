/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of swift_1__swift_op_243.  The term's layer-5 text, LITERAL:
...
float
emu_swift_1__swift_op_243(double a, float b)
{
