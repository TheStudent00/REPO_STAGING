...
// intermediate per node of the term of slli_gpr_gpr_imm_64__reg_a0__go__bit_blast.
//   Concat(Extract(60, 0, v0), 0)
package main

//go:noinline
func emu_slli_gpr_gpr_imm_64__reg_a0__go__bit_blast(a uint64) uint64 {
	...
	var w32 uint64 = w31 | (x0_29 << 32)
	var w33 uint64 = w32 | (x0_30 << 33)
	var w34 uint64 = w33 | (x0_31 << 34)
	var w35 uint64 = w34 | (x0_32 << 35)
	var w36 uint64 = w35 | (x0_33 << 36)
	var w37 uint64 = w36 | (x0_34 << 37)
	var w38 uint64 = w37 | (x0_35 << 38)
	var w39 uint64 = w38 | (x0_36 << 39)
	var w40 uint64 = w39 | (x0_37 << 40)
	var w41 uint64 = w40 | (x0_38 << 41)
	var w42 uint64 = w41 | (x0_39 << 42)
	var w43 uint64 = w42 | (x0_40 << 43)
	var w44 uint64 = w43 | (x0_41 << 44)
	var w45 uint64 = w44 | (x0_42 << 45)
	var w46 uint64 = w45 | (x0_43 << 46)
	var w47 uint64 = w46 | (x0_44 << 47)
	var w48 uint64 = w47 | (x0_45 << 48)
	var w49 uint64 = w48 | (x0_46 << 49)
	var w50 uint64 = w49 | (x0_47 << 50)
	var w51 uint64 = w50 | (x0_48 << 51)
	var w52 uint64 = w51 | (x0_49 << 52)
	var w53 uint64 = w52 | (x0_50 << 53)
	var w54 uint64 = w53 | (x0_51 << 54)
	var w55 uint64 = w54 | (x0_52 << 55)
	var w56 uint64 = w55 | (x0_53 << 56)
	var w57 uint64 = w56 | (x0_54 << 57)
	var w58 uint64 = w57 | (x0_55 << 58)
	var w59 uint64 = w58 | (x0_56 << 59)
	var w60 uint64 = w59 | (x0_57 << 60)
	var w61 uint64 = w60 | (x0_58 << 61)
	var w62 uint64 = w61 | (x0_59 << 62)
	var w63 uint64 = w62 | (x0_60 << 63)
	return uint64(w63)
}
...
func main() {
	sink = emu_slli_gpr_gpr_imm_64__reg_a0__go__bit_blast(g0)
	_ = sink
}
