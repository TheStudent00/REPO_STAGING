...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of movslq_widen_gpr_gpr_64__reg_rdi__csharp.
    ...
    public static long emu_movslq_widen_gpr_gpr_64__reg_rdi__csharp(long a) {
        return m(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(ext(a, 31, 31), ext(a, 31, 31), 1), ext(a, 31, 31), 1), ext(a, 31, 31), 1), ext(a, 31, 31), 1), ext(a, 31, 31), 1), ext(a, 31, 31), 1), ext(a, 31, 31), 1), ext(a, 31, 31), 1), ext(a, 31, 31), 1), ext(a, 31, 31), 1), ext(a, 31, 31), 1), ext(a, 31, 31), 1), ext(a, 31, 31), 1), ext(a, 31, 31), 1), ext(a, 31, 31), 1), ext(a, 31, 31), 1), ext(a, 31, 31), 1), ext(a, 31, 31), 1), ext(a, 31, 31), 1), ext(a, 31, 31), 1), ext(a, 31, 31), 1), ext(a, 31, 31), 1), ext(a, 31, 31), 1), ext(a, 31, 31), 1), ext(a, 31, 31), 1), ext(a, 31, 31), 1), ext(a, 31, 31), 1), ext(a, 31, 31), 1), ext(a, 31, 31), 1), ext(a, 31, 31), 1), ext(a, 31, 31), 1), a, 32), 64);
    }
