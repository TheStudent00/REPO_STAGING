...
/-- rust single-opcode row 40, arch mnemonic 'sub', example unit rust/op_577, 6 members
...
theorem ModelCheck_rust_40 (v0 : BitVec 64) (v1 : BitVec 64) :
    ((v0 * (18446744073709551615#64)) + v1)
  = (model_sub_51 (model_mov_19 v0) v1) := by
  simp only [model_mov_19, model_sub_51]
  bv_decide

#print axioms ModelCheck_rust_40
