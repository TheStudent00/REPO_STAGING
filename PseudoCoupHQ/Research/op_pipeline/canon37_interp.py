#!/usr/bin/env python3
"""canon37_interp.py -- TASK 47, the INTERPRETER/JIT population (11
units) put through the memory-wrapped form.

THE FORM is ledger47.py's and THE GATE is canon37_gate.py's.
...
OUT = os.path.join(HERE, "canon37_interp.json")
...
def run():
    ...
    for rec in source["records"]:
        ...
        body_lines = L47.split_lines(body_text)
    ...
    document = {
        "meta": {
            ...
            "generated_by": "canon37_interp.py",
