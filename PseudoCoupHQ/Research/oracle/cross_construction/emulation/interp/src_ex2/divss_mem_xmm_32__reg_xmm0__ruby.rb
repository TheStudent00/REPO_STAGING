...
# InterpRenderer from the layer-4 term of divss_mem_xmm_32__reg_xmm0__ruby.
# The term's layer-5 text, LITERAL:
#   fp.to_ieee_bv(fpToFP(Extract(31, 0, v0)) / fpToFP(Extract(31, 0, v1)))
def emu_divss_mem_xmm_32__reg_xmm0__ruby(a, b)
  m(fdiv(b, a, 32), 32)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_divss_mem_xmm_32__reg_xmm0__ruby(*values)
