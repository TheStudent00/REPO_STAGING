...
# InterpRenderer from the layer-4 term of xor_imm_gpr_8__reg_rdi__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(0, Extract(7, 0, v0) ^ Extract(7, 0, v1))
def emu_xor_imm_gpr_8__reg_rdi__ruby(a, b)
  m(cat(0, bxor(b, a, 8), 8), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_xor_imm_gpr_8__reg_rdi__ruby(*values)
