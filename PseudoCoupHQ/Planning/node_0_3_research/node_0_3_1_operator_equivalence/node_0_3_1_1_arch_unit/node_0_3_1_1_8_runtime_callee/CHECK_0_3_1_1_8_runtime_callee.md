---
id: hq.research.compiler_graph.arch_unit.runtime_callee.check
---

# CHECK — 0_3_1_1_8_runtime_callee

Node `hq.research.compiler_graph.arch_unit.runtime_callee`. Status `draft`.
