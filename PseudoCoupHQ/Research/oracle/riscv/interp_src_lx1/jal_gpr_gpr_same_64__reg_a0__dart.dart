...
// InterpRenderer from the layer-4 term of jal_gpr_gpr_same_64__reg_a0__dart.
// The term's layer-5 text, LITERAL:
//   v0 + 4
int emu_jal_gpr_gpr_same_64__reg_a0__dart(int a) {
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_jal_gpr_gpr_same_64__reg_a0__dart(values[0]);
