/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of c_44__c_op_202.  The term's layer-5 text, LITERAL:
...
double
emu_c_44__c_op_202(double a, double b)
{
