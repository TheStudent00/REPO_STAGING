...
// InterpRenderer from the layer-4 term of cmp_mem_gpr_64__flags.low__javascript.
// The term's layer-5 text, LITERAL:
//   v0
function emu_cmp_mem_gpr_64__flags.low__javascript(a) {
    return m(a, 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_cmp_mem_gpr_64__flags.low__javascript(...values).toString());
    } catch (problem) {
