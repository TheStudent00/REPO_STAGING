...
# InterpRenderer from the layer-4 term of fsd_fpr_fpr_fpr_64__mem_MEM_fa1__ruby.
# The term's layer-5 text, LITERAL:
#   v0
def emu_fsd_fpr_fpr_fpr_64__mem_MEM_fa1__ruby(a)
  m(a, 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_fsd_fpr_fpr_fpr_64__mem_MEM_fa1__ruby(*values)
