...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of lui_gpr_imm_32__reg_a0__csharp.
    // The term's layer-5 text, LITERAL:
    //   12288
    public static long emu_lui_gpr_imm_32__reg_a0__csharp() {
        return m(12288L, 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_lui_gpr_imm_32__reg_a0__csharp()).ToString());
                    answers.Append("\n");
