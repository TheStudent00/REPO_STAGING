/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of rust_42__rust_op_598.  The term's layer-5 text, LITERAL:
...
double
emu_rust_42__rust_op_598(double a, double b)
{
