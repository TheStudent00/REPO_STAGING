...
theorem flw_fpr_fpr_fpr_32__freg_fa0__rust__all_constructed_00_same_text (a : BitVec 64) :
    ((pure_RTYPE (a) ((pure_SHIFTIOP ((pure_ITYPE (zero_reg) (((sign_extend (m := 12) (0x3f#6)))) (ADDI))) ((0x20#6)) (SLLI))) (OR))) = (pure_BREV8 (a) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem flw_fpr_fpr_fpr_32__freg_fa0__rust__all_constructed_01_same_text (a : BitVec 64) :
    ((pure_RTYPE (a) ((pure_SHIFTIOP ((pure_ITYPE (zero_reg) (((sign_extend (m := 12) (0x3f#6)))) (ADDI))) ((0x20#6)) (SLLI))) (OR))) = (pure_CLZ (a) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem flw_fpr_fpr_fpr_32__freg_fa0__rust__all_constructed_02_same_text (a : BitVec 64) :
    ((pure_RTYPE (a) ((pure_SHIFTIOP ((pure_ITYPE (zero_reg) (((sign_extend (m := 12) (0x3f#6)))) (ADDI))) ((0x20#6)) (SLLI))) (OR))) = (pure_CLZW (a) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem flw_fpr_fpr_fpr_32__freg_fa0__rust__all_constructed_03_same_text (a : BitVec 64) :
    ((pure_RTYPE (a) ((pure_SHIFTIOP ((pure_ITYPE (zero_reg) (((sign_extend (m := 12) (0x3f#6)))) (ADDI))) ((0x20#6)) (SLLI))) (OR))) = (pure_CTZ (a) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem flw_fpr_fpr_fpr_32__freg_fa0__rust__all_constructed_04_same_text (a : BitVec 64) :
    ((pure_RTYPE (a) ((pure_SHIFTIOP ((pure_ITYPE (zero_reg) (((sign_extend (m := 12) (0x3f#6)))) (ADDI))) ((0x20#6)) (SLLI))) (OR))) = (pure_CTZW (a) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem flw_fpr_fpr_fpr_32__freg_fa0__rust__all_constructed_05_same_text (a : BitVec 64) :
    ((pure_RTYPE (a) ((pure_SHIFTIOP ((pure_ITYPE (zero_reg) (((sign_extend (m := 12) (0x3f#6)))) (ADDI))) ((0x20#6)) (SLLI))) (OR))) = (pure_REV8 (a) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem flw_fpr_fpr_fpr_32__freg_fa0__rust__all_constructed_06_same_text (a : BitVec 64) :
    ((pure_RTYPE (a) ((pure_SHIFTIOP ((pure_ITYPE (zero_reg) (((sign_extend (m := 12) (0x3f#6)))) (ADDI))) ((0x20#6)) (SLLI))) (OR))) = (pure_ZBB_EXTOP (a) (extop_zbb.SEXTB)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem flw_fpr_fpr_fpr_32__freg_fa0__rust__all_constructed_07_same_text (a : BitVec 64) :
    ((pure_RTYPE (a) ((pure_SHIFTIOP ((pure_ITYPE (zero_reg) (((sign_extend (m := 12) (0x3f#6)))) (ADDI))) ((0x20#6)) (SLLI))) (OR))) = (pure_ZBB_EXTOP (a) (extop_zbb.SEXTH)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem flw_fpr_fpr_fpr_32__freg_fa0__rust__all_constructed_08_same_text (a : BitVec 64) :
    ((pure_RTYPE (a) ((pure_SHIFTIOP ((pure_ITYPE (zero_reg) (((sign_extend (m := 12) (0x3f#6)))) (ADDI))) ((0x20#6)) (SLLI))) (OR))) = (pure_ZBB_EXTOP (a) (extop_zbb.ZEXTH)) := by
  with_reducible rfl
