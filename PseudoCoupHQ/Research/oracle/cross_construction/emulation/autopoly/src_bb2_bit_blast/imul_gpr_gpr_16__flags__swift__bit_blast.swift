...
// intermediate per node of the term of imul_gpr_gpr_16__flags__swift__bit_blast.
//   Concat(Extract(15, 0, v0), Extract(15, 0, v1))
@_cdecl("emu_imul_gpr_gpr_16__flags__swift__bit_blast")
public func emu_imul_gpr_gpr_16__flags__swift__bit_blast(_ a: UInt16, _ b: UInt16) -> UInt32
{
    ...
    let w8: UInt32 = w7 | (x1_8 << 8)
    let w9: UInt32 = w8 | (x1_9 << 9)
    let w10: UInt32 = w9 | (x1_10 << 10)
    let w11: UInt32 = w10 | (x1_11 << 11)
    let w12: UInt32 = w11 | (x1_12 << 12)
    let w13: UInt32 = w12 | (x1_13 << 13)
    let w14: UInt32 = w13 | (x1_14 << 14)
    let w15: UInt32 = w14 | (x1_15 << 15)
