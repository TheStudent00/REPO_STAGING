...
// intermediate per node of the term of remuw_gpr_gpr_gpr_32__reg_a0__rust__native_first.
...
#[no_mangle]
pub extern "C" fn emu_remuw_gpr_gpr_gpr_32__reg_a0__rust__native_first(a: u32, b: u32) -> u64
{
    let v0: u32 = (a as u32);
    let v1: u32 = (b as u32);
    ...
    let v4: u32 = (if (v3) { ((v1) as u32) } else { ((v2) as u32) });
    let v5: u32 = (((((v2) as u32) >> 31) as u32) & 0x1u32);
    let v6: u32 = (((((b as u32)) >> 31) as u32) & 0x1u32);
    let v7: u32 = (if (v3) { ((v6) as u32) } else { ((v5) as u32) });
    let v8: u64 = (((((v7) as u64) << 63) | (((v7) as u64) << 62) | (((v7) as u64) << 61) | (((v7) as u64) << 60) | (((v7) as u64) << 59) | (((v7) as u64) << 58) | (((v7) as u64) << 57) | (((v7) as u64) << 56) | (((v7) as u64) << 55) | (((v7) as u64) << 54) | (((v7) as u64) << 53) | (((v7) as u64) << 52) | (((v7) as u64) << 51) | (((v7) as u64) << 50) | (((v7) as u64) << 49) | (((v7) as u64) << 48) | (((v7) as u64) << 47) | (((v7) as u64) << 46) | (((v7) as u64) << 45) | (((v7) as u64) << 44) | (((v7) as u64) << 43) | (((v7) as u64) << 42) | (((v7) as u64) << 41) | (((v7) as u64) << 40) | (((v7) as u64) << 39) | (((v7) as u64) << 38) | (((v7) as u64) << 37) | (((v7) as u64) << 36) | (((v7) as u64) << 35) | (((v7) as u64) << 34) | (((v7) as u64) << 33) | (((v7) as u64) << 32) | ((v4) as u64)) as u64);
    ((v8) as u64)
}
