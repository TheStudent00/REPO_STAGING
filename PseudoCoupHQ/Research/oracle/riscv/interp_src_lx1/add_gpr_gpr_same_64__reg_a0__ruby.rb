...
# InterpRenderer from the layer-4 term of add_gpr_gpr_same_64__reg_a0__ruby.
# The term's layer-5 text, LITERAL:
#   v0*2
def emu_add_gpr_gpr_same_64__reg_a0__ruby(a)
  m(mul(a, 2, 64), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_add_gpr_gpr_same_64__reg_a0__ruby(*values)
