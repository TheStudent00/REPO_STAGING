...
// intermediate per node of the term of ZBS_IOP__op_BINVI__rd__rust__native_first.
//   
#[no_mangle]
pub extern "C" fn emu_ZBS_IOP__op_BINVI__rd__rust__native_first(a: u64, b: u8) -> u64
{
