...
// intermediate per node of the term of movsbq_widen_gpr_gpr_64__reg_rdi__go__bit_blast.
...
//go:noinline
func emu_movsbq_widen_gpr_gpr_64__reg_rdi__go__bit_blast(a uint8) uint64 {
...
func main() {
	sink = emu_movsbq_widen_gpr_gpr_64__reg_rdi__go__bit_blast(g0)
	_ = sink
}
