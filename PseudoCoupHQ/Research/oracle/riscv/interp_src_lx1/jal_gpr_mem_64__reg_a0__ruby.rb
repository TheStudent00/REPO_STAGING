...
# InterpRenderer from the layer-4 term of jal_gpr_mem_64__reg_a0__ruby.
# The term's layer-5 text, LITERAL:
#   v0 + 4
def emu_jal_gpr_mem_64__reg_a0__ruby(a)
  m(add(a, 4, 64), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_jal_gpr_mem_64__reg_a0__ruby(*values)
