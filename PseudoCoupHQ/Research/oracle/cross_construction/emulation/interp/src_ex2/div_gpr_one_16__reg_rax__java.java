...
public class Emu {
    ...
    // InterpRenderer from the layer-4 term of div_gpr_one_16__reg_rax__java.
    // The term's layer-5 text, LITERAL:
    //   Concat(Extract(63, 16, v1), Extract(15, 0, bvudiv_i(Concat(Extract(15, 0, v0), Extract(15, 0, v1)), Concat(0, Extract(15, 0, v2)))))
    static long emu_div_gpr_one_16__reg_rax__java(long a, long b, long c) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_div_gpr_one_16__reg_rax__java(values[0], values[1], values[2])));
                    answers.append("\n");
