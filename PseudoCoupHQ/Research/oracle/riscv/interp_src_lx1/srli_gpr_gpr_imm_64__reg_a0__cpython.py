...
# InterpRenderer from the layer-4 term of srli_gpr_gpr_imm_64__reg_a0__cpython.
# The term's layer-5 text, LITERAL:
#   Concat(0, Extract(63, 3, v0))
def emu_srli_gpr_gpr_imm_64__reg_a0__cpython(a):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_srli_gpr_gpr_imm_64__reg_a0__cpython(*values)
            sys.stdout.write("%d\n" % answer)
