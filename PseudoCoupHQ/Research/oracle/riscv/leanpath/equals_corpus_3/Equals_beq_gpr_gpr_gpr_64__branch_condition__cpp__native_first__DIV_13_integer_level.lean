...
theorem beq_gpr_gpr_gpr_64__branch_condition__cpp__native_first__DIV_13_integer_level (a : BitVec 64) (b : BitVec 64) :
  ...
  try simp only [pure_ITYPE, pure_RTYPE, pure_DIV, bool_to_bit, log2_xlen, not, shift_bits_right_arith, sign_extend, to_bits_truncate, xlen, xlenbits, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend]
  grind
