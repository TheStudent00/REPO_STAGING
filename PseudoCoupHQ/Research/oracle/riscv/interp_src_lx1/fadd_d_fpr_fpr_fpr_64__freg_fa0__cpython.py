...
# InterpRenderer from the layer-4 term of fadd_d_fpr_fpr_fpr_64__freg_fa0__cpython.
# The term's layer-5 text, LITERAL:
#   fp.to_ieee_bv(fpToFP(v0) + fpToFP(v1))
def emu_fadd_d_fpr_fpr_fpr_64__freg_fa0__cpython(a, b):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_fadd_d_fpr_fpr_fpr_64__freg_fa0__cpython(*values)
            sys.stdout.write("%d\n" % answer)
