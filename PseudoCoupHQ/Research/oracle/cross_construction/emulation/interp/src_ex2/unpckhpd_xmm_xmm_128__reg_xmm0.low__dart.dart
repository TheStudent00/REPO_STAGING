...
// InterpRenderer from the layer-4 term of unpckhpd_xmm_xmm_128__reg_xmm0.low__dart.
// The term's layer-5 text, LITERAL:
//   v0
int emu_unpckhpd_xmm_xmm_128__reg_xmm0.low__dart(int a) {
  return m(a, 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_unpckhpd_xmm_xmm_128__reg_xmm0.low__dart(values[0]);
