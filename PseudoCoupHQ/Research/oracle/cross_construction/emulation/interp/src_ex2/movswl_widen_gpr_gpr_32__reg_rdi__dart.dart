...
// InterpRenderer from the layer-4 term of movswl_widen_gpr_gpr_32__reg_rdi__dart.
...
int emu_movswl_widen_gpr_gpr_32__reg_rdi__dart(int a) {
  return m(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(0, ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), a, 16), 64);
}
