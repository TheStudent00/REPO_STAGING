...
- 2026-09-10: **task hub1 — first form standing, and it PROVES** (step 5
  ...
  Report: `PRIVATE/PseudoCoupHQ/DevComms/log_252_task_hub1_hub_v1_first_form.md` §5, §6.
...
- 2026-09-10: **task hub2 — the same handful and the same measure, at
  ...
  Report: `PRIVATE/PseudoCoupHQ/DevComms/log_254_task_hub2_the_dictionary_at_two_levels.md` §6, §7, §8.
