...
2. **C# CoreCLR and Dart VM Build Toolchains**: We will utilize the local clones at `~/Programming/Sources/runtime` (C# CoreCLR) and `~/Programming/Sources/sdk` (Dart) to build the runtimes inside the Airlock, leveraging their respective native build scripts (e.g., `build.sh` for .NET, `tools/build.py` for Dart).
...
#### [NEW] [interp_ruby_build.sh](file://~/Programming/Airlock/agent/drop/interp_ruby_build.sh)
...
#### [NEW] [interp_ruby_dispatch.sh](file://~/Programming/Airlock/agent/drop/interp_ruby_dispatch.sh)
...
#### [NEW] [fold_interp_ruby.py](file://~/Programming/PseudoCoupHQ/Research/op_pipeline/fold_interp_ruby.py)
...
#### [NEW] [interp_php_build.sh](file://~/Programming/Airlock/agent/drop/interp_php_build.sh)
...
#### [NEW] [interp_php_dispatch.sh](file://~/Programming/Airlock/agent/drop/interp_php_dispatch.sh)
...
#### [NEW] [fold_interp_php.py](file://~/Programming/PseudoCoupHQ/Research/op_pipeline/fold_interp_php.py)
...
#### [NEW] [interp_js_build.sh](file://~/Programming/Airlock/agent/drop/interp_js_build.sh)
...
#### [NEW] [interp_js_dispatch.sh](file://~/Programming/Airlock/agent/drop/interp_js_dispatch.sh)
...
#### [NEW] [fold_interp_js.py](file://~/Programming/PseudoCoupHQ/Research/op_pipeline/fold_interp_js.py)
...
#### [NEW] [interp_cs_build.sh](file://~/Programming/Airlock/agent/drop/interp_cs_build.sh)
...
#### [NEW] [interp_cs_dispatch.sh](file://~/Programming/Airlock/agent/drop/interp_cs_dispatch.sh)
...
#### [NEW] [fold_interp_cs.py](file://~/Programming/PseudoCoupHQ/Research/op_pipeline/fold_interp_cs.py)
...
#### [NEW] [interp_dart_build.sh](file://~/Programming/Airlock/agent/drop/interp_dart_build.sh)
...
#### [NEW] [interp_dart_dispatch.sh](file://~/Programming/Airlock/agent/drop/interp_dart_dispatch.sh)
...
#### [NEW] [fold_interp_dart.py](file://~/Programming/PseudoCoupHQ/Research/op_pipeline/fold_interp_dart.py)
...
#### [MODIFY] [interp_feeder.py](file://~/Programming/PseudoCoupHQ/Research/op_pipeline/interp_feeder.py)
...
#### [MODIFY] [sem_anchored.py](file://~/Programming/PseudoCoupHQ/Research/op_pipeline/sem_anchored.py)
