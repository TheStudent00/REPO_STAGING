...
// InterpRenderer from the layer-4 term of sete_gpr_one_8__reg_rdi__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(0, If(Extract(7, 0, v0) == Extract(7, 0, v1), 1, 0))
function emu_sete_gpr_one_8__reg_rdi__javascript(a, b) {
    return m(cat(0n, ((eq(a, b, 8)) ? (1n) : (0n)), 8), 64);
}
