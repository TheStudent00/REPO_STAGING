#!/usr/bin/env bash
# t85_l7_all_moments3.sh -- TASK 85, lane 7: THE FULL PASS, FINAL.
#
# Run against the code as it stands after the spelling guard FAILED on a
# literal path separator in a membership test and TREE_SEPARATOR was
# named.  This is the run of record for every count in log_191.
#
...
#   lane cap:      6000 MB, abort T85_FULL_MEMORY_ABORT3, checked after
#                  every render.
...
# different.
#
# Product: /out/t85_all_moments3.json
set -uo pipefail
...
LANE_CAP_MB = 6000
LANE_ABORT = "T85_FULL_MEMORY_ABORT3"
...
with open("/out/t85_all_moments3.json", "w") as fh:
...
with open("/out/t85_one_moment_proof2.json", "w") as fh:
