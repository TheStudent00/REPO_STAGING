...
// intermediate per node of the term of and_cl_gpr_8__reg_rdi__swift__native_first.
//   Concat(Extract(63, 8, v1), ~(~Extract(7, 0, v0) | ~Extract(7, 0, v1)))
@_cdecl("emu_and_cl_gpr_8__reg_rdi__swift__native_first")
public func emu_and_cl_gpr_8__reg_rdi__swift__native_first(_ a: UInt64, _ b: UInt8) -> UInt64
{
    let v0: UInt32 = ((UInt32(truncatingIfNeeded: ((UInt64(a))) &>> 0)) & UInt32(0xff))
    let v1: UInt32 = ((UInt32(truncatingIfNeeded: ~(UInt32(truncatingIfNeeded: v0)))) & UInt32(0xff))
    let v2: UInt32 = (UInt32(b))
    ...
    let v7: UInt64 = (UInt64(truncatingIfNeeded: ((UInt64(truncatingIfNeeded: v6)) &<< 8) | (UInt64(truncatingIfNeeded: v5))))
    return UInt64(truncatingIfNeeded: v7)
}
