...
// InterpRenderer from the layer-4 term of cvtsi2sd_gpr_xmm_64__reg_xmm0__javascript.
// The term's layer-5 text, LITERAL:
//   fp.to_ieee_bv(fpToFP(RNE(), v0))
function emu_cvtsi2sd_gpr_xmm_64__reg_xmm0__javascript(a) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_cvtsi2sd_gpr_xmm_64__reg_xmm0__javascript(...values).toString());
    } catch (problem) {
