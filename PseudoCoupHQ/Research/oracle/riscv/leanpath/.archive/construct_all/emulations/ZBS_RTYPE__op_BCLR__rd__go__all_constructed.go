...
// intermediate per node of the term of ZBS_RTYPE__op_BCLR__rd__go__all_constructed.
//   
package main
...
//go:noinline
func emu_ZBS_RTYPE__op_BCLR__rd__go__all_constructed(a uint8, b uint64) uint64 {
	...
	var v28 uint64 = (uint64((uint64(uint64(0x1))) & (uint64(v27))))
	var v29 uint64 = (uint64((uint64(uint64(0x1))) << ((uint64(uint64(0x1))) & uint64(0x3f))))
	...
	var v90 uint64 = (uint64(^(uint64(uint64(b)))))
	var v91 uint64 = (uint64((uint64(v90)) | (uint64(v89))))
	var v92 uint64 = (uint64(^(uint64(v91))))
	return uint64(v92)
}
...
func main() {
	sink = emu_ZBS_RTYPE__op_BCLR__rd__go__all_constructed(g0, g1)
	_ = sink
}
