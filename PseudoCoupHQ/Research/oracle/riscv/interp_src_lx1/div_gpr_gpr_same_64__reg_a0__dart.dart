...
// InterpRenderer from the layer-4 term of div_gpr_gpr_same_64__reg_a0__dart.
...
int emu_div_gpr_gpr_same_64__reg_a0__dart(int a) {
  return m(((eq(a, 0, 64)) ? (-1) : (((((eq(a, -1, 64)) && (eq(a, -9223372036854775808, 64)))) ? (-9223372036854775808) : (sdiv(a, a, 64))))), 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_div_gpr_gpr_same_64__reg_a0__dart(values[0]);
