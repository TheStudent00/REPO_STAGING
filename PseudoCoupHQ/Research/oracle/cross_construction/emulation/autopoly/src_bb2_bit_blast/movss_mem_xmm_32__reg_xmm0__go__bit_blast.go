...
// intermediate per node of the term of movss_mem_xmm_32__reg_xmm0__go__bit_blast.
//   Extract(31, 0, v0)
package main
...
//go:noinline
func emu_movss_mem_xmm_32__reg_xmm0__go__bit_blast(a uint32) float32 {
...
func main() {
	sink = emu_movss_mem_xmm_32__reg_xmm0__go__bit_blast(g0)
	_ = sink
}
