...
# InterpRenderer from the layer-4 term of shl_imm_gpr_32__reg_rdi__cpython.
# The term's layer-5 text, LITERAL:
#   Concat(0, Extract(28, 0, v0), 0)
def emu_shl_imm_gpr_32__reg_rdi__cpython(a):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_shl_imm_gpr_32__reg_rdi__cpython(*values)
            sys.stdout.write("%d\n" % answer)
