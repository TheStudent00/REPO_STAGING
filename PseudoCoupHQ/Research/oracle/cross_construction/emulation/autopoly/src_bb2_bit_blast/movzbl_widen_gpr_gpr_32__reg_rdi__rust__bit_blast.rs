...
// intermediate per node of the term of movzbl_widen_gpr_gpr_32__reg_rdi__rust__bit_blast.
//   Concat(0, Extract(7, 0, v0))
#[no_mangle]
pub extern "C" fn emu_movzbl_widen_gpr_gpr_32__reg_rdi__rust__bit_blast(a: u8) -> u64
{
