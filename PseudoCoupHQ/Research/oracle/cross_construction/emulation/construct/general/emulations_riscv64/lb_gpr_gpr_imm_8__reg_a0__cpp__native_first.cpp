/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of lb_gpr_gpr_imm_8__reg_a0__cpp__native_first.  The term's text, LITERAL:
...
extern "C"
uint64_t
emu_lb_gpr_gpr_imm_8__reg_a0__cpp__native_first(uint8_t a)
{
