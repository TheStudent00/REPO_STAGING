...
/-- rust single-opcode row 7, arch mnemonic 'imul', example unit rust/op_613, 6 members
...
theorem ModelCheck_rust_7 (v0 : BitVec 64) (v1 : BitVec 64) :
    (v0 * v1)
  = (model_imul_54 (model_mov_20 v0) v1) := by
  rfl

#print axioms ModelCheck_rust_7
