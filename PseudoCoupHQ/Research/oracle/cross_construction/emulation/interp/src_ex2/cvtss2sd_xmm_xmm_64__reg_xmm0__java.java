...
public class Emu {
    ...
    // InterpRenderer from the layer-4 term of cvtss2sd_xmm_xmm_64__reg_xmm0__java.
    // The term's layer-5 text, LITERAL:
    //   fp.to_ieee_bv(fpToFP(RNE(), fpToFP(Extract(31, 0, v0))))
    static long emu_cvtss2sd_xmm_xmm_64__reg_xmm0__java(long a) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_cvtss2sd_xmm_xmm_64__reg_xmm0__java(values[0])));
                    answers.append("\n");
