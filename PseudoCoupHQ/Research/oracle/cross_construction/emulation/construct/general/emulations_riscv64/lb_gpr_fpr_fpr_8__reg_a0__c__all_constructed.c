/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of lb_gpr_fpr_fpr_8__reg_a0__c__all_constructed.  The term's text, LITERAL:
...
uint64_t
emu_lb_gpr_fpr_fpr_8__reg_a0__c__all_constructed(uint8_t a)
{
