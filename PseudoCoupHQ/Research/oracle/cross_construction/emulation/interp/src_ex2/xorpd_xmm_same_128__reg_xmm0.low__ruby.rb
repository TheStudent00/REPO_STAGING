...
# InterpRenderer from the layer-4 term of xorpd_xmm_same_128__reg_xmm0.low__ruby.
# The term's layer-5 text, LITERAL:
#   0
def emu_xorpd_xmm_same_128__reg_xmm0.low__ruby()
  m(0, 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_xorpd_xmm_same_128__reg_xmm0.low__ruby(*values)
