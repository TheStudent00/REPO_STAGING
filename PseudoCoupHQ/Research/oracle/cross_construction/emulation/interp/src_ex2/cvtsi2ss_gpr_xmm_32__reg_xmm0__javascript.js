...
// InterpRenderer from the layer-4 term of cvtsi2ss_gpr_xmm_32__reg_xmm0__javascript.
// The term's layer-5 text, LITERAL:
//   fp.to_ieee_bv(fpToFP(RNE(), Extract(31, 0, v0)))
function emu_cvtsi2ss_gpr_xmm_32__reg_xmm0__javascript(a) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_cvtsi2ss_gpr_xmm_32__reg_xmm0__javascript(...values).toString());
    } catch (problem) {
