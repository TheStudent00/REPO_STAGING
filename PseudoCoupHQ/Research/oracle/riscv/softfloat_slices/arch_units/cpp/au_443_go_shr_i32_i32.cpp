...
uint64_t au_443_go_shr_i32_i32(uint64_t p0, uint64_t p1)
{
    ...
    const uint64_t v4 = au_sll(v2, UINT64_C(0x20));
    const uint64_t v5 = au_srl(v4, UINT64_C(0x20));
    const uint64_t v6 = au_sltu(v5, UINT64_C(0x20));
    const uint64_t v7 = au_add(v6, UINT64_C(0xffffffffffffffff));
    const uint64_t v8 = au_or(v2, v7);
    const uint64_t v9 = au_sraw(v1, v8);
    /* the answer is int32, 32 bits */
    return ((v9) & UINT64_C(0xffffffff));
}

uint64_t au_443_go_shr_i32_i32_trap(uint64_t p0, uint64_t p1)
{
    /* a0: operand `a` (int32) sign-extended to XLEN, as the ABI presents it */
    const uint64_t v1 = au_sext32(p0);
    /* a1: operand `b` (int32) sign-extended to XLEN, as the ABI presents it */
