...
// intermediate per node of the term of ZBS_IOP__op_BCLRI__rd__rust__all_constructed.
//   
#[no_mangle]
pub extern "C" fn emu_ZBS_IOP__op_BCLRI__rd__rust__all_constructed(a: u8, b: u64) -> u64
{
