/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of c_60__c_op_678.  The term's layer-5 text, LITERAL:
   Extract(31, 0, v0) << Concat(0, Extract(4, 0, v1)) */
#include <stdint.h>

uint32_t
emu_c_60__c_op_678(uint32_t a, uint8_t b)
{
