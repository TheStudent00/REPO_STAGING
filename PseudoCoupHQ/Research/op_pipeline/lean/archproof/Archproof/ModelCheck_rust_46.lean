...
/-- rust single-opcode row 46, arch mnemonic 'xor', example unit rust/op_217, 6 members
...
theorem ModelCheck_rust_46 (v0 : BitVec 64) (v1 : BitVec 64) :
    (v0 ^^^ v1)
  = (model_xor_49 (model_mov_22 v0) v1) := by
  rfl

#print axioms ModelCheck_rust_46
