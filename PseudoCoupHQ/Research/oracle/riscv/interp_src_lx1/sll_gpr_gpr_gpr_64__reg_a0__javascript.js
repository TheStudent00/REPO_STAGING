...
// InterpRenderer from the layer-4 term of sll_gpr_gpr_gpr_64__reg_a0__javascript.
// The term's layer-5 text, LITERAL:
//   v0 << Concat(0, Extract(5, 0, v1))
function emu_sll_gpr_gpr_gpr_64__reg_a0__javascript(a, b) {
    return m(shl(a, cat(0n, ext(b, 5, 0), 6), 64), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_sll_gpr_gpr_gpr_64__reg_a0__javascript(...values).toString());
    } catch (problem) {
