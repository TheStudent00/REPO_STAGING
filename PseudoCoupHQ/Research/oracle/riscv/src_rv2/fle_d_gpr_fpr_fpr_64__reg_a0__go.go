...
// GoRenderer from the layer-4 term of fle_d_gpr_fpr_fpr_64__reg_a0__go.
...
//go:noinline
func emu_fle_d_gpr_fpr_fpr_64__reg_a0__go(a uint64, b uint64) uint64 {
...
func main() {
	sink = emu_fle_d_gpr_fpr_fpr_64__reg_a0__go(g0, g1)
	_ = sink
}
