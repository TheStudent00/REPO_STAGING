...
// intermediate per node of the term of and_imm_gpr_8__flags__swift__bit_blast.
//   Concat(~(~Extract(7, 0, v0) | ~Extract(7, 0, v1)), 0)
@_cdecl("emu_and_imm_gpr_8__flags__swift__bit_blast")
public func emu_and_imm_gpr_8__flags__swift__bit_blast(_ a: UInt8, _ b: UInt8) -> UInt16
{
