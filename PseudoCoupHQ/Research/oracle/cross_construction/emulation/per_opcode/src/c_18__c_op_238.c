/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of c_18__c_op_238.  The term's layer-5 text, LITERAL:
...
double
emu_c_18__c_op_238(double a, double b)
{
