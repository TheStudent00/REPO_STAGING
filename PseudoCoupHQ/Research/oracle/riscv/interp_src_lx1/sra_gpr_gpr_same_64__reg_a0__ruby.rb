...
# InterpRenderer from the layer-4 term of sra_gpr_gpr_same_64__reg_a0__ruby.
# The term's layer-5 text, LITERAL:
#   v0 >> Concat(0, Extract(5, 0, v0))
def emu_sra_gpr_gpr_same_64__reg_a0__ruby(a)
  m(ashr(a, cat(0, ext(a, 5, 0), 6), 64), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_sra_gpr_gpr_same_64__reg_a0__ruby(*values)
