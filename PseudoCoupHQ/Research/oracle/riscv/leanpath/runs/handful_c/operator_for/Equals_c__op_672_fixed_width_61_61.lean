...
theorem c__op_672_61_fixed_width (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (LeanIM.rop.SLT))) = ((zero_extend (m := 64) (bool_to_bit (zopz0zI_s a b)))) := by
  try simp only [pure_RTYPE, bool_to_bit, zero_extend, zopz0zI_s, bool_bit_forwards, Sail.BitVec.zeroExtend]
  bv_decide
