...
python3 /projects/PseudoCoupHQ/Research/op_pipeline/check_no_spelling_keys.py \
  /projects/PseudoCoupHQ/Research/oracle/cross_construction/emulation/per_opcode/per_opcode_population.json || true
echo "[2/3] task mn1: spelling guard over per_opcode_held.json"
python3 /projects/PseudoCoupHQ/Research/op_pipeline/check_no_spelling_keys.py \
  /projects/PseudoCoupHQ/Research/oracle/cross_construction/emulation/per_opcode/per_opcode_held.json || true
