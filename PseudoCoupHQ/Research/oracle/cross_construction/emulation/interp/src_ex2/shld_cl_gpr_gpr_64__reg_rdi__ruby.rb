...
# InterpRenderer from the layer-4 term of shld_cl_gpr_gpr_64__reg_rdi__ruby.
# The term's layer-5 text, LITERAL:
#   Extract(127, 64, Concat(v0, v1) << Concat(0, Extract(5, 0, v2)))
def emu_shld_cl_gpr_gpr_64__reg_rdi__ruby(a, b, c)
  m(ext(shl(cat(a, b, 64), cat(0, ext(c, 5, 0), 6), 128), 127, 64), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_shld_cl_gpr_gpr_64__reg_rdi__ruby(*values)
