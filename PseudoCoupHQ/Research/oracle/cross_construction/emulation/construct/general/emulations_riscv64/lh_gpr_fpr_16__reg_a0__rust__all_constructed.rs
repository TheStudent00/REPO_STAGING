...
// intermediate per node of the term of lh_gpr_fpr_16__reg_a0__rust__all_constructed.
...
#[no_mangle]
pub extern "C" fn emu_lh_gpr_fpr_16__reg_a0__rust__all_constructed(a: u16) -> u64
{
    let v0: u32 = (a as u32);
