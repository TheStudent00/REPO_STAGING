---
id: hq.research.arch_unit_oracle.compiler_units.operators_used.check
---

# CHECK — 0_3_2_0_0_operators_used

Node `hq.research.arch_unit_oracle.compiler_units.operators_used`. Status `draft`.
