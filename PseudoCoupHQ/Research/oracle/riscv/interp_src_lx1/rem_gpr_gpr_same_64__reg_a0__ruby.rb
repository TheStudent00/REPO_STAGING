...
# InterpRenderer from the layer-4 term of rem_gpr_gpr_same_64__reg_a0__ruby.
# The term's layer-5 text, LITERAL:
#   If(v0 == 0, v0, If(And(v0 == 18446744073709551615, v0 == 9223372036854775808), 0, bvsrem_i(v0, v0)))
def emu_rem_gpr_gpr_same_64__reg_a0__ruby(a)
  m(((eq(a, 0, 64)) ? (a) : (((((eq(a, 18446744073709551615, 64)) && (eq(a, 9223372036854775808, 64)))) ? (0) : (srem(a, a, 64))))), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_rem_gpr_gpr_same_64__reg_a0__ruby(*values)
