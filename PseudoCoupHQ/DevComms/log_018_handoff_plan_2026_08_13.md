...
1. `PRIVATE/PseudoCoupHQ/AgentMemory.md` — the 12 languages,
   the vision, standing rulings, where things are. Load-bearing.
2. `PRIVATE/DevComms/LLM_communication_protocol.md` — the owner's
...
3. The two research nodes' PROGRESS files:
   `PRIVATE/PseudoCoupHQ/Planning/node_0_3_research/node_0_3_0_kind_clustering/PROGRESS.md`
...
Walk `PRIVATE/PseudoCoup_v5/DevComms/log_021_rust_kind_map_proposal.md`
...
- checks: `bash PRIVATE/PseudoCoupHQ/hq.sh check` should
