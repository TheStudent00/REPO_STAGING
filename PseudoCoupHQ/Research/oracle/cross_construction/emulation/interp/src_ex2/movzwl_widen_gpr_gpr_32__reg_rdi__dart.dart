...
// InterpRenderer from the layer-4 term of movzwl_widen_gpr_gpr_32__reg_rdi__dart.
// The term's layer-5 text, LITERAL:
//   Concat(0, Extract(15, 0, v0))
int emu_movzwl_widen_gpr_gpr_32__reg_rdi__dart(int a) {
  return m(cat(0, a, 16), 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_movzwl_widen_gpr_gpr_32__reg_rdi__dart(values[0]);
