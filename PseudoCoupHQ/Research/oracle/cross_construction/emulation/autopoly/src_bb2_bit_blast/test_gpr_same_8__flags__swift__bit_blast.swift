...
// intermediate per node of the term of test_gpr_same_8__flags__swift__bit_blast.
//   Concat(Extract(7, 0, v0), 0)
@_cdecl("emu_test_gpr_same_8__flags__swift__bit_blast")
public func emu_test_gpr_same_8__flags__swift__bit_blast(_ a: UInt8) -> UInt16
{
