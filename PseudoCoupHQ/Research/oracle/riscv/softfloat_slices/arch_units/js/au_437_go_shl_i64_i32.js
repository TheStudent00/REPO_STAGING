// arch-unit 437  --  go  `a << b`  lhs=int64 rhs=int32
// symbol main.op_174   outcome LIFTED   24 arch-opcodes
//
// the arch-unit, arch-opcode by arch-opcode:
//   ld t1, 0x10(s11)                     prologue   stack-growth check -> elided
//   bltu t1, sp, 0x6c738 <main.op_174+0x18> prologue   stack-growth check -> elided
...
//   jal zero, 0x6c720 <main.op_174>      prologue   stack-growth call / restart / panic tail -> elided
...
//   blt t0, zero, 0x6c768 <main.op_174+0x48> guard      guard branch -> a `_trap` predicate
...
function au_437_go_shl_i64_i32_trap(p0, p1) {
  // a0: operand `a` (int64) arrives in a0
  const v1 = p0;
  // a1: operand `b` (int32) sign-extended to XLEN, as the ABI presents it
  const v2 = AU.au_sext32(p1);
...
module.exports = { au_437_go_shl_i64_i32, au_437_go_shl_i64_i32_trap };
