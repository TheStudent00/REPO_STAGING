...
# InterpRenderer from the layer-4 term of jalr_gpr_gpr_imm_64__reg_a0__cpython.
# The term's layer-5 text, LITERAL:
#   v0 + 4
def emu_jalr_gpr_gpr_imm_64__reg_a0__cpython(a):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_jalr_gpr_gpr_imm_64__reg_a0__cpython(*values)
            sys.stdout.write("%d\n" % answer)
