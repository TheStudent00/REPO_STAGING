...
// InterpRenderer from the layer-4 term of mul_gpr_one_8__reg_rax__php.
...
function emu_mul_gpr_one_8__reg_rax__php($a, $b) {
    return ex_m(ex_cat(ex_ext($a, 63, 16), ex_mul(ex_cat(0, ex_ext($a, 7, 0), 8), ex_cat(0, $b, 8), 16), 16), 64);
}
