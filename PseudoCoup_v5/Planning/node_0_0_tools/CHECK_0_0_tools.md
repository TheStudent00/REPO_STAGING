...
- [ ] `node_0_0_0_ledgerer` — see its own CHECK
- [ ] `node_0_0_1_transpiler` — see its own CHECK
- [ ] `node_0_0_2_polyfill` — see its own CHECK
- [ ] `node_0_0_3_tracer` — see its own CHECK
