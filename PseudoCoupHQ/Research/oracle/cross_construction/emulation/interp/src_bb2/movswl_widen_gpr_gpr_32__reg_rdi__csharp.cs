...
public static class Emu {
    ...
    // one named local per gate, over the term of movswl_widen_gpr_gpr_32__reg_rdi__csharp.
    ...
    public static long emu_movswl_widen_gpr_gpr_32__reg_rdi__csharp(long a) {
        long x0_0 = ext(a, 0, 0);
        long x0_1 = ext(a, 1, 1);
        long x0_2 = ext(a, 2, 2);
        long x0_3 = ext(a, 3, 3);
        ...
        long w32 = cat(w31, x0_15, 1);
        long w33 = cat(w32, x0_15, 1);
        long w34 = cat(w33, x0_15, 1);
        long w35 = cat(w34, x0_15, 1);
        long w36 = cat(w35, x0_15, 1);
        long w37 = cat(w36, x0_15, 1);
        long w38 = cat(w37, x0_15, 1);
        long w39 = cat(w38, x0_15, 1);
        long w40 = cat(w39, x0_15, 1);
        long w41 = cat(w40, x0_15, 1);
        long w42 = cat(w41, x0_15, 1);
        long w43 = cat(w42, x0_15, 1);
        long w44 = cat(w43, x0_15, 1);
        long w45 = cat(w44, x0_15, 1);
        long w46 = cat(w45, x0_15, 1);
        long w47 = cat(w46, x0_15, 1);
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_movswl_widen_gpr_gpr_32__reg_rdi__csharp(values[0])).ToString());
                    answers.Append("\n");
