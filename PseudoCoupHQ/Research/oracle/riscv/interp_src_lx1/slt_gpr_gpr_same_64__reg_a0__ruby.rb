...
# InterpRenderer from the layer-4 term of slt_gpr_gpr_same_64__reg_a0__ruby.
# The term's layer-5 text, LITERAL:
#   0
def emu_slt_gpr_gpr_same_64__reg_a0__ruby(a)
  m(0, 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_slt_gpr_gpr_same_64__reg_a0__ruby(*values)
