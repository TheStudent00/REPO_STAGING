...
/-- swift single-opcode row 8, arch mnemonic 'not', example unit swift/op_36, 5 members
...
theorem ModelCheck_swift_8 (v0 : BitVec 64) :
    (~~~(v0.extractLsb 31 0))
  = ((model_not_7 (model_mov_15 v0)).extractLsb 31 0) := by
  simp only [model_mov_15, model_not_7]
  bv_decide

#print axioms ModelCheck_swift_8
