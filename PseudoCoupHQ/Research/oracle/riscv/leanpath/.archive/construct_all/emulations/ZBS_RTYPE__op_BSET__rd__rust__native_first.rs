...
// intermediate per node of the term of ZBS_RTYPE__op_BSET__rd__rust__native_first.
//   
#[no_mangle]
pub extern "C" fn emu_ZBS_RTYPE__op_BSET__rd__rust__native_first(a: u64, b: u8) -> u64
{
