...
// InterpRenderer from the layer-4 term of movsbq_widen_gpr_gpr_64__reg_rdi__php.
...
function emu_movsbq_widen_gpr_gpr_64__reg_rdi__php($a) {
    return ex_m(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_ext($a, 7, 7), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), $a, 8), 64);
}
...
while (($line = fgets($handle)) !== false) {
    ...
    try {
        $answer = emu_movsbq_widen_gpr_gpr_64__reg_rdi__php(...$ints);
        if ($answer < 0) {
            echo sprintf("%s\n", sprintf("%u", $answer));
        } else {
            echo $answer . "\n";
