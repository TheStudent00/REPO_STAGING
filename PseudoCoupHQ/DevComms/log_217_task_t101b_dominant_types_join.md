...
```
$ python3 ~/Programming/Airlock/airlock --instance t101b status
```
...
**Fix, one line**, `~/Programming/PseudoCoupHQ/Research/op_pipeline/types101_join.py`:
...
```
$ python3 ~/Programming/Airlock/airlock --instance t101b submit ~/Programming/PseudoCoupHQ/Research/op_pipeline/types101_lanes/t101b_l5_join.sh --batch t101b --weight 1
```
...
(`~/Programming/PseudoCoupHQ/Research/op_pipeline/types101_holders.json`)
is the LITERAL source for every row in that table.

## 6. The spelling-ban guard

```
$ python3 ~/Programming/Airlock/airlock --instance t101b submit ~/Programming/PseudoCoupHQ/Research/op_pipeline/types101_lanes/t101b_l6_guard.sh --batch t101b --weight 1
```
...
(`~/Programming/PseudoCoupHQ/...`), which does not resolve
...
`~/Programming/Airlock` and `~/AirlockRuns` are not Airlock-mounted
...
- `~/Programming/PseudoCoupHQ/Research/op_pipeline/types101_join.py`
  — the join, both fixes.
- `~/Programming/PseudoCoupHQ/Research/op_pipeline/types101_anchor_dwarf.py`
  — the DWARF re-read (not changed this session).
- `~/Programming/PseudoCoupHQ/Research/op_pipeline/types101_holders.json`,
  `types101_spellings.json`, `types101_entry_holders.json` — the three
  artifacts.
- `~/Programming/PseudoCoupHQ/DevComms/log_213_task_t101_dominant_types_dwarf_flag.md`
  — task t101's flag, closed by this task.
- `/tmp/claude-1000/-home-<user>-Programming-PseudoCoup/862ba4e5-5d7e-4363-a0d7-62a9ccce2435/scratchpad/close_t101b.md`
