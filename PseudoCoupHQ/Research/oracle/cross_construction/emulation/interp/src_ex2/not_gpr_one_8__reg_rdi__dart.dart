...
// InterpRenderer from the layer-4 term of not_gpr_one_8__reg_rdi__dart.
// The term's layer-5 text, LITERAL:
//   Concat(0, ~Extract(7, 0, v0))
int emu_not_gpr_one_8__reg_rdi__dart(int a) {
  return m(cat(0, bnot(a, 8), 8), 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_not_gpr_one_8__reg_rdi__dart(values[0]);
