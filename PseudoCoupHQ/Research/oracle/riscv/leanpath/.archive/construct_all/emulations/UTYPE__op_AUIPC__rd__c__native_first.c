/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of UTYPE__op_AUIPC__rd__c__native_first.  The term's text, LITERAL:
    */
#include <stdint.h>

uint64_t
emu_UTYPE__op_AUIPC__rd__c__native_first(uint64_t a, uint32_t b)
{
