...
# InterpRenderer from the layer-4 term of movsbq_widen_gpr_gpr_64__reg_rdi__ruby.
...
def emu_movsbq_widen_gpr_gpr_64__reg_rdi__ruby(a)
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_movsbq_widen_gpr_gpr_64__reg_rdi__ruby(*values)
