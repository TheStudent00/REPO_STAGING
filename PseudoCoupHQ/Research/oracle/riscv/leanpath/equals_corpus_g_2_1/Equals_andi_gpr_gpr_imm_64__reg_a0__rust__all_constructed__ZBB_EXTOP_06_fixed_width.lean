...
theorem andi_gpr_gpr_imm_64__reg_a0__rust__all_constructed__ZBB_EXTOP_06_fixed_width (a : BitVec 64) :
    ((pure_ITYPE (a) ((sign_extend (m := 12) (0x03#6))) (ANDI))) = (pure_ZBB_EXTOP (a) (extop_zbb.SEXTB)) := by
  try simp only [pure_ITYPE, pure_ZBB_EXTOP, bool_to_bit, sign_extend, xlenbits, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend]
  bv_decide
