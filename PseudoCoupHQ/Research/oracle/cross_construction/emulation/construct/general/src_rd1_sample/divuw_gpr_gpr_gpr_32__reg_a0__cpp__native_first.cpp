/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of divuw_gpr_gpr_gpr_32__reg_a0__cpp__native_first.  The term's text, LITERAL:
...
extern "C"
uint64_t
emu_divuw_gpr_gpr_gpr_32__reg_a0__cpp__native_first(uint32_t a, uint32_t b)
{
    ...
    uint32_t v4 = ((v3) ? (uint32_t)(UINT32_C(0xffffffff)) : (uint32_t)(v2));
    uint32_t v5 = ((uint32_t)((uint32_t)(v2) >> 31) & UINT32_C(0x1));
    uint32_t v6 = ((v3) ? (uint32_t)(UINT32_C(0x1)) : (uint32_t)(v5));
