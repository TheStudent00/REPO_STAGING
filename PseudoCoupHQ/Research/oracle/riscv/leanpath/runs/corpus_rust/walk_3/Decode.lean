...
#eval IO.println ("rust__op_3#0\t" ++ ((match (encdec_backwards (0x20a51553#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_3#1\t" ++ ((match (encdec_compressed_backwards (0x8082#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_267#0\t" ++ ((match (encdec_backwards (0xa0b52553#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_303#1\t" ++ ((match (encdec_backwards (0x00154513#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_339#0\t" ++ ((match (encdec_backwards (0xa0b51553#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_375#0\t" ++ ((match (encdec_backwards (0xa0b50553#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_411#0\t" ++ ((match (encdec_backwards (0xa0a59553#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_447#0\t" ++ ((match (encdec_backwards (0xa0a58553#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_463#0\t" ++ ((match (encdec_backwards (0x00b5153b#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_475#0\t" ++ ((match (encdec_backwards (0x00b51533#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_499#0\t" ++ ((match (encdec_backwards (0x40b5553b#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_511#0\t" ++ ((match (encdec_backwards (0x00b55533#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_555#0\t" ++ ((match (encdec_backwards (0x00b57553#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_591#0\t" ++ ((match (encdec_backwards (0x08b57553#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_627#0\t" ++ ((match (encdec_backwards (0x10b57553#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_663#0\t" ++ ((match (encdec_backwards (0x18b57553#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_699#0\t" ++ ((match (encdec_backwards (0x00000317#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_699#1\t" ++ ((match (encdec_backwards (0x00030067#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_807#0\t" ++ ((match (encdec_backwards (0x00a52027#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_807#1\t" ++ ((match (encdec_backwards (0x00b52227#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("rust__op_807#2\t" ++ ((match (encdec_backwards (0x00050423#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
