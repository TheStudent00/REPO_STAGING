...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of div_gpr_one_8__reg_rax__csharp.
    ...
    public static long emu_div_gpr_one_8__reg_rax__csharp(long a, long b) {
        return m(cat(cat(ext(a, 63, 16), ext(urem(ext(a, 15, 0), cat(0L, b, 8), 16), 7, 0), 8), ext(udiv(ext(a, 15, 0), cat(0L, b, 8), 16), 7, 0), 8), 64);
    }
