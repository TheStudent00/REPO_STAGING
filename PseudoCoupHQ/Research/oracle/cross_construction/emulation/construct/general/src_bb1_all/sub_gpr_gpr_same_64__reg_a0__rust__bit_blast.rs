...
// intermediate per node of the term of sub_gpr_gpr_same_64__reg_a0__rust__bit_blast.
//   0
#[no_mangle]
pub extern "C" fn emu_sub_gpr_gpr_same_64__reg_a0__rust__bit_blast(a: u64) -> u64
{
    let k0: u64 = 0;
    let w0: u64 = (k0 << 0);
    let w1: u64 = w0 | (k0 << 1);
