...
# InterpRenderer from the layer-4 term of sar_imm_gpr_8__reg_rdi__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(0, Extract(7, 0, v0) >> 3)
def emu_sar_imm_gpr_8__reg_rdi__ruby(a)
  m(cat(0, ashr(a, 3, 8), 8), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_sar_imm_gpr_8__reg_rdi__ruby(*values)
