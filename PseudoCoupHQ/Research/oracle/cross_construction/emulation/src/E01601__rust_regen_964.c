/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of E01601__rust_regen_964.  The term's layer-5 text, LITERAL:
   LShR(Concat(0, Extract(15, 0, v0)), Concat(0, Extract(3, 0, v1))) */
#include <stdint.h>

uint32_t
emu_E01601__rust_regen_964(uint16_t a, uint8_t b)
{
