...
// intermediate per node of the term of ZBS_RTYPE__op_BSET__rd__go__all_constructed.
//   
package main
...
//go:noinline
func emu_ZBS_RTYPE__op_BSET__rd__go__all_constructed(a uint64, b uint8) uint64 {
	...
	var v90 uint64 = (uint64((uint64(v89)) | (uint64(uint64(a)))))
	return uint64(v90)
}
...
func main() {
	sink = emu_ZBS_RTYPE__op_BSET__rd__go__all_constructed(g0, g1)
	_ = sink
}
