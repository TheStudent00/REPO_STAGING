/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of c_72__c_op_166.  The term's layer-5 text, LITERAL:
...
double
emu_c_72__c_op_166(double a, double b)
{
