...
mutual
/-- Type quantifiers: k_ex586619_ : Bool, level : Nat, k_ex586617_ : Bool, k_ex586616_ : Bool, sv_width
...
level).toNat
/-- Type quantifiers: k_ex586610_ : Bool, k_ex586609_ : Bool, sv_width : Nat, is_sv_or_svx4_mode(sv_width) -/
...
1000).toNat
/-- Type quantifiers: tlb_index : Nat, k_ex586603_ : Bool, k_ex586602_ : Bool, sv_width : Nat, is_sv_or_svx4_mode(sv_width), 0
...
1000).toNat
/-- Type quantifiers: k_ex586597_ : Bool, k_ex586596_ : Bool, sv_width : Nat, is_sv_or_svx4_mode(sv_width) -/
