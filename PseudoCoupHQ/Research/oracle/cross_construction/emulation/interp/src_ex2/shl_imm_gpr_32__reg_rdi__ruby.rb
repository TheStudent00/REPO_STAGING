...
# InterpRenderer from the layer-4 term of shl_imm_gpr_32__reg_rdi__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(0, Extract(28, 0, v0), 0)
def emu_shl_imm_gpr_32__reg_rdi__ruby(a)
  m(cat(cat(0, ext(a, 28, 0), 29), 0, 3), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_shl_imm_gpr_32__reg_rdi__ruby(*values)
