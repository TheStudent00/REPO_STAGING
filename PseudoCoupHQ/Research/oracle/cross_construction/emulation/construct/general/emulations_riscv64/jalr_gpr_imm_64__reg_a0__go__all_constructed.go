...
// intermediate per node of the term of jalr_gpr_imm_64__reg_a0__go__all_constructed.
//   v0 + 4
package main

//go:noinline
func emu_jalr_gpr_imm_64__reg_a0__go__all_constructed(a uint64) uint64 {
...
func main() {
	sink = emu_jalr_gpr_imm_64__reg_a0__go__all_constructed(g0)
	_ = sink
}
