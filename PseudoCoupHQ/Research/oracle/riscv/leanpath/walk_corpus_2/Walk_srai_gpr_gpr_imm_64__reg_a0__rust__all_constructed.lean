...
theorem meaning_srai_gpr_gpr_imm_64__reg_a0__rust__all_constructed (s : St) (a : BitVec 64) (d : BitVec 64) (h10 : s.regs.get? .x10 = some a) (h13 : s.regs.get? .x13 = some d) (hk0 : ∀ {α : Type} (x0 : α) (s : St), (plat_term_write x0) s = EStateM.Result.ok () s) (hk1 : ∀ (x0 : Arch.pa) (x1 : Nat) (s : St), (load_reservation x0 x1) s = EStateM.Result.ok () s) (hk2 : ∀ (x0 : Unit) (s : St), (cancel_reservation x0) s = EStateM.Result.ok () s) :
    runsTo (walk [LeanIM.instruction.SHIFTIOP (0x01#6, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0b#5, LeanIM.sop.SRAI), LeanIM.instruction.SHIFTIOP (0x03#6, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0c#5, LeanIM.sop.SRLI), LeanIM.instruction.C_SRLI (0x3f#6, LeanIM.cregidx.Cregidx 0x2#3), LeanIM.instruction.C_SRLI (0x3e#6, LeanIM.cregidx.Cregidx 0x3#3), LeanIM.instruction.C_SLLI (0x3d#6, LeanIM.regidx.Regidx 0x0a#5), LeanIM.instruction.C_SLLI (0x3e#6, LeanIM.regidx.Regidx 0x0b#5), LeanIM.instruction.C_OR (LeanIM.cregidx.Cregidx 0x2#3, LeanIM.cregidx.Cregidx 0x4#3), LeanIM.instruction.C_OR (LeanIM.cregidx.Cregidx 0x2#3, LeanIM.cregidx.Cregidx 0x3#3)]) s
      ((pure_RTYPE ((pure_RTYPE ((pure_SHIFTIOP ((pure_SHIFTIOP (a) ((0x3f#6)) (SRLI))) ((0x3d#6)) (SLLI))) ((pure_SHIFTIOP (a) (0x03#6) (LeanIM.sop.SRLI))) (OR))) ((pure_SHIFTIOP ((pure_SHIFTIOP ((pure_SHIFTIOP (a) (0x01#6) (LeanIM.sop.SRAI))) ((0x3e#6)) (SRLI))) ((0x3e#6)) (SLLI))) (OR))) := by
  simp (config := {decide := true}) [runsTo, walk, step, execute, strip_C_SRLI, strip_C_SLLI, strip_C_OR, strip_SHIFTIOP, strip_RTYPE, alias_C_SRLI, alias_C_SLLI, alias_C_OR,
