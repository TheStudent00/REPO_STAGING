...
theorem srlw_gpr_gpr_gpr_32__reg_a0__rust__all_constructed__RTYPEW_13_fixed_width (a : BitVec 64) (b : BitVec 64) :
  ...
  try simp only [pure_ITYPE, pure_RTYPE, pure_RTYPEW, pure_SHIFTIWOP, pure_SHIFTIOP, pure_RTYPEW, bool_to_bit, log2_xlen, shift_bits_right_arith, sign_extend, xlenbits, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend]
  bv_decide
