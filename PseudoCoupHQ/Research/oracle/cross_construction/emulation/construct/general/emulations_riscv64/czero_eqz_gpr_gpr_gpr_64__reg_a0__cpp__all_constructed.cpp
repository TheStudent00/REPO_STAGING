/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of czero_eqz_gpr_gpr_gpr_64__reg_a0__cpp__all_constructed.  The term's text, LITERAL:
   If(v0 == 0, 0, v1) */
#include <cstdint>

extern "C"
uint64_t
emu_czero_eqz_gpr_gpr_gpr_64__reg_a0__cpp__all_constructed(uint64_t a, uint64_t b)
{
    ...
    int v15 = ((!(v14))) ? 1 : 0;
    uint64_t v16 = ((v15) ? (uint64_t)(UINT64_C(0x0)) : (uint64_t)((uint64_t)b));
    return (uint64_t)(v16);
}
