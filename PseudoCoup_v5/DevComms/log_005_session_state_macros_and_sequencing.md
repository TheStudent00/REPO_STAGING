...
`~/Programming/PseudoCoup_v5/Research/syn_shim/`): a syn-shaped API
...
- The kind-one engine (pattern/template expansion,
  `~/Programming/PseudoCoup_v5/Research/macro_engine.py`) is pulled
...
- The prohibition recorded in
  `~/Programming/PseudoCoupHQ/CRANELIFT_IS_BANNED.md` stands; the
