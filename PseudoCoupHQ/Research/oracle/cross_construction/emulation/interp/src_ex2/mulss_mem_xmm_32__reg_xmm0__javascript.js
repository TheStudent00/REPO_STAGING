...
// InterpRenderer from the layer-4 term of mulss_mem_xmm_32__reg_xmm0__javascript.
// The term's layer-5 text, LITERAL:
//   fp.to_ieee_bv(fpToFP(Extract(31, 0, v0)) * fpToFP(Extract(31, 0, v1)))
function emu_mulss_mem_xmm_32__reg_xmm0__javascript(a, b) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_mulss_mem_xmm_32__reg_xmm0__javascript(...values).toString());
    } catch (problem) {
