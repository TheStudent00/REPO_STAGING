...
/-- go single-opcode row 13, arch mnemonic 'neg', example unit go/op_7, 7 members
...
theorem ModelCheck_go_13 (v0 : BitVec 64) :
    (v0 * (18446744073709551615#64))
  = (model_neg_18 v0) := by
  simp only [model_neg_18]
  bv_decide

#print axioms ModelCheck_go_13
