...
theorem addw_gpr_gpr_same_32__reg_a0__c__all_constructed__CTZ_03_fixed_width (a : BitVec 64) :
  ...
  try simp only [pure_SHIFTIWOP, pure_ZBA_RTYPE, pure_ITYPE, pure_RTYPE, pure_SHIFTIOP, pure_ZBA_RTYPEUW, pure_CTZ, bool_to_bit, log2_xlen, shift_bits_right_arith, sign_extend, to_bits, xlenbits, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend]
  bv_decide
