...
theorem bne_gpr_gpr_same_64__branch_condition__c__native_first_34_integer_level (a : BitVec 64) (b : BitVec 64) :
...
set_option maxHeartbeats 40000 in
theorem bne_gpr_gpr_same_64__branch_condition__c__native_first_35_integer_level (a : BitVec 64) (b : BitVec 64) :
...
set_option maxHeartbeats 40000 in
theorem bne_gpr_gpr_same_64__branch_condition__c__native_first_36_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (zero_reg) ((pure_RTYPE (a) (b) (XOR))) (LeanIM.rop.SLTU))) = (pure_ZBB_RTYPE (a) (b) (brop_zbb.ORN)) := by
  try simp only [pure_RTYPE, pure_ZBB_RTYPE, log2_xlen, rotate_bits_left, rotate_bits_right, xlenbits, zopz0zI_s, zopz0zI_u, zopz0zK_s, zopz0zK_u, xlen, rotatel, rotater, Sail.BitVec.length]
  grind

set_option maxHeartbeats 40000 in
theorem bne_gpr_gpr_same_64__branch_condition__c__native_first_37_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (zero_reg) ((pure_RTYPE (a) (b) (XOR))) (LeanIM.rop.SLTU))) = (pure_ZBB_RTYPE (a) (b) (brop_zbb.XNOR)) := by
  try simp only [pure_RTYPE, pure_ZBB_RTYPE, log2_xlen, rotate_bits_left, rotate_bits_right, xlenbits, zopz0zI_s, zopz0zI_u, zopz0zK_s, zopz0zK_u, xlen, rotatel, rotater, Sail.BitVec.length]
  grind

set_option maxHeartbeats 40000 in
theorem bne_gpr_gpr_same_64__branch_condition__c__native_first_38_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (zero_reg) ((pure_RTYPE (a) (b) (XOR))) (LeanIM.rop.SLTU))) = (pure_ZBB_RTYPE (a) (b) (brop_zbb.MAX)) := by
  try simp only [pure_RTYPE, pure_ZBB_RTYPE, log2_xlen, rotate_bits_left, rotate_bits_right, xlenbits, zopz0zI_s, zopz0zI_u, zopz0zK_s, zopz0zK_u, xlen, rotatel, rotater, Sail.BitVec.length]
  grind

set_option maxHeartbeats 40000 in
theorem bne_gpr_gpr_same_64__branch_condition__c__native_first_39_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (zero_reg) ((pure_RTYPE (a) (b) (XOR))) (LeanIM.rop.SLTU))) = (pure_ZBB_RTYPE (a) (b) (brop_zbb.MAXU)) := by
  try simp only [pure_RTYPE, pure_ZBB_RTYPE, log2_xlen, rotate_bits_left, rotate_bits_right, xlenbits, zopz0zI_s, zopz0zI_u, zopz0zK_s, zopz0zK_u, xlen, rotatel, rotater, Sail.BitVec.length]
  grind

set_option maxHeartbeats 40000 in
theorem bne_gpr_gpr_same_64__branch_condition__c__native_first_40_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (zero_reg) ((pure_RTYPE (a) (b) (XOR))) (LeanIM.rop.SLTU))) = (pure_ZBB_RTYPE (a) (b) (brop_zbb.MIN)) := by
  try simp only [pure_RTYPE, pure_ZBB_RTYPE, log2_xlen, rotate_bits_left, rotate_bits_right, xlenbits, zopz0zI_s, zopz0zI_u, zopz0zK_s, zopz0zK_u, xlen, rotatel, rotater, Sail.BitVec.length]
  grind

set_option maxHeartbeats 40000 in
theorem bne_gpr_gpr_same_64__branch_condition__c__native_first_41_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (zero_reg) ((pure_RTYPE (a) (b) (XOR))) (LeanIM.rop.SLTU))) = (pure_ZBB_RTYPE (a) (b) (brop_zbb.MINU)) := by
  try simp only [pure_RTYPE, pure_ZBB_RTYPE, log2_xlen, rotate_bits_left, rotate_bits_right, xlenbits, zopz0zI_s, zopz0zI_u, zopz0zK_s, zopz0zK_u, xlen, rotatel, rotater, Sail.BitVec.length]
  grind

set_option maxHeartbeats 40000 in
theorem bne_gpr_gpr_same_64__branch_condition__c__native_first_42_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (zero_reg) ((pure_RTYPE (a) (b) (XOR))) (LeanIM.rop.SLTU))) = (pure_ZBB_RTYPE (a) (b) (brop_zbb.ROL)) := by
  try simp only [pure_RTYPE, pure_ZBB_RTYPE, log2_xlen, rotate_bits_left, rotate_bits_right, xlenbits, zopz0zI_s, zopz0zI_u, zopz0zK_s, zopz0zK_u, xlen, rotatel, rotater, Sail.BitVec.length]
  grind

set_option maxHeartbeats 40000 in
theorem bne_gpr_gpr_same_64__branch_condition__c__native_first_43_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (zero_reg) ((pure_RTYPE (a) (b) (XOR))) (LeanIM.rop.SLTU))) = (pure_ZBB_RTYPE (a) (b) (brop_zbb.ROR)) := by
  try simp only [pure_RTYPE, pure_ZBB_RTYPE, log2_xlen, rotate_bits_left, rotate_bits_right, xlenbits, zopz0zI_s, zopz0zI_u, zopz0zK_s, zopz0zK_u, xlen, rotatel, rotater, Sail.BitVec.length]
  grind

set_option maxHeartbeats 40000 in
theorem bne_gpr_gpr_same_64__branch_condition__c__native_first_44_integer_level (a : BitVec 64) (b : BitVec 64) :
...
set_option maxHeartbeats 40000 in
theorem bne_gpr_gpr_same_64__branch_condition__c__native_first_45_integer_level (a : BitVec 64) (b : BitVec 64) :
