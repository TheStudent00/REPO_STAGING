...
import LeanIM.TypesExt
import LeanIM.Types
import LeanIM.VmemTypes
import LeanIM.SysRegs
import LeanIM.SyncException
import LeanIM.Mem
import LeanIM.VmemPte
import LeanIM.VmemPtw
import LeanIM.Callbacks0
import LeanIM.VmemTlb
...
mutual
/-- Type quantifiers: k_ex555633_ : Bool, level : Nat, k_ex555631_ : Bool, k_ex555630_ : Bool, sv_width
...
level).toNat
/-- Type quantifiers: k_ex555624_ : Bool, k_ex555623_ : Bool, sv_width : Nat, is_sv_or_svx4_mode(sv_width) -/
...
1000).toNat
/-- Type quantifiers: tlb_index : Nat, k_ex555617_ : Bool, k_ex555616_ : Bool, sv_width : Nat, is_sv_or_svx4_mode(sv_width), 0
...
1000).toNat
/-- Type quantifiers: k_ex555611_ : Bool, k_ex555610_ : Bool, sv_width : Nat, is_sv_or_svx4_mode(sv_width) -/
