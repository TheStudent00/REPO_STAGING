...
# one named local per gate, over the term of xorps_xmm_same_128__reg_xmm0_low__cpython.
# The term's layer-5 text, LITERAL:
#   0
def emu_xorps_xmm_same_128__reg_xmm0_low__cpython():
    k0 = 0
    w0 = k0
    w1 = cat(w0, k0, 1)
    w2 = cat(w1, k0, 1)
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_xorps_xmm_same_128__reg_xmm0_low__cpython(*values)
            sys.stdout.write("%d\n" % answer)
