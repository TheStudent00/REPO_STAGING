...
// InterpRenderer from the layer-4 term of div_gpr_one_64__reg_rax__javascript.
// The term's layer-5 text, LITERAL:
//   Extract(63, 0, bvudiv_i(Concat(v0, v1), Concat(0, v2)))
function emu_div_gpr_one_64__reg_rax__javascript(a, b, c) {
    return m(ext(udiv(cat(a, b, 64), cat(0n, c, 64), 128), 63, 0), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_div_gpr_one_64__reg_rax__javascript(...values).toString());
    } catch (problem) {
