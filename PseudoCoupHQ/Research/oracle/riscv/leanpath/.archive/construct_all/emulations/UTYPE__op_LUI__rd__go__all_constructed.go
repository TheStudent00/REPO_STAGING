...
// intermediate per node of the term of UTYPE__op_LUI__rd__go__all_constructed.
//   
package main

//go:noinline
func emu_UTYPE__op_LUI__rd__go__all_constructed(a uint32) uint64 {
...
func main() {
	sink = emu_UTYPE__op_LUI__rd__go__all_constructed(g0)
	_ = sink
}
