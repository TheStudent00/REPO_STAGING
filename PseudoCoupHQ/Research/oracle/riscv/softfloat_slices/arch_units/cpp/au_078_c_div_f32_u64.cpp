// arch-unit 78  --  c  `a / b`  lhs=float rhs=uint64_t
// symbol op_230   outcome LIFTED
//
...
uint64_t au_078_c_div_f32_u64(uint64_t p0, uint64_t p1)
{
    /* fa0: operand `a` (float) arrives in fa0 */
    const uint64_t v1 = ((p0) & UINT64_C(0xffffffff));
    /* a0: operand `b` (uint64_t) arrives in a0 */
    const uint64_t v2 = p1;
    const uint64_t v3 = sfemul::ui64_to_f32_rm0(v2);
