...
// intermediate per node of the term of idiv_gpr_one_32__reg_rdx__go__native_first.
...
//go:noinline
func emu_idiv_gpr_one_32__reg_rdx__go__native_first(a uint32, b uint32, c uint32) uint64 {
...
func main() {
	sink = emu_idiv_gpr_one_32__reg_rdx__go__native_first(g0, g1, g2)
	_ = sink
}
