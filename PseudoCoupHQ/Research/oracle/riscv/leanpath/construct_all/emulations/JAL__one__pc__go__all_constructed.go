...
// intermediate per node of the term of JAL__one__pc__go__all_constructed.
//   
package main

//go:noinline
func emu_JAL__one__pc__go__all_constructed(a uint64, b uint32) uint64 {
	...
	var v46 uint64 = (uint64(((uint64(v45)) << 21) | (uint64(v2))))
	var v47 uint64 = (uint64((uint64(v46)) & (uint64(uint64(a)))))
	var v48 uint64 = (uint64((uint64(v47)) << ((uint64(uint64(0x1))) & uint64(0x3f))))
	var v49 uint64 = (uint64((uint64(v46)) ^ (uint64(uint64(a)))))
	var v50 uint64 = (uint64((uint64(v49)) & (uint64(v48))))
	var v51 uint64 = (uint64((uint64(v47)) | (uint64(v50))))
	var v52 uint64 = (uint64((uint64(v51)) << ((uint64(uint64(0x2))) & uint64(0x3f))))
	var v53 uint64 = (uint64((uint64(v49)) << ((uint64(uint64(0x1))) & uint64(0x3f))))
	var v54 uint64 = (uint64((uint64(v49)) & (uint64(v53))))
	var v55 uint64 = (uint64((uint64(v54)) & (uint64(v52))))
	var v56 uint64 = (uint64((uint64(v51)) | (uint64(v55))))
	var v57 uint64 = (uint64((uint64(v56)) << ((uint64(uint64(0x4))) & uint64(0x3f))))
	var v58 uint64 = (uint64((uint64(v54)) << ((uint64(uint64(0x2))) & uint64(0x3f))))
	var v59 uint64 = (uint64((uint64(v54)) & (uint64(v58))))
	var v60 uint64 = (uint64((uint64(v59)) & (uint64(v57))))
	var v61 uint64 = (uint64((uint64(v56)) | (uint64(v60))))
	var v62 uint64 = (uint64((uint64(v61)) << ((uint64(uint64(0x8))) & uint64(0x3f))))
	var v63 uint64 = (uint64((uint64(v59)) << ((uint64(uint64(0x4))) & uint64(0x3f))))
	...
	var v67 uint64 = (uint64((uint64(v66)) << ((uint64(uint64(0x10))) & uint64(0x3f))))
	var v68 uint64 = (uint64((uint64(v64)) << ((uint64(uint64(0x8))) & uint64(0x3f))))
	...
	var v72 uint64 = (uint64((uint64(v71)) << ((uint64(uint64(0x20))) & uint64(0x3f))))
	var v73 uint64 = (uint64((uint64(v69)) << ((uint64(uint64(0x10))) & uint64(0x3f))))
	...
	var v77 uint64 = (uint64((uint64(v76)) << ((uint64(uint64(0x1))) & uint64(0x3f))))
	var v78 uint64 = (uint64((uint64(v49)) ^ (uint64(v77))))
	return uint64(v78)
}
...
func main() {
	sink = emu_JAL__one__pc__go__all_constructed(g0, g1)
	_ = sink
}
