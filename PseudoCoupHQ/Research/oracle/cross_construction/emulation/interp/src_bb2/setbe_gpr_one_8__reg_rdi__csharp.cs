...
public static class Emu {
    ...
    // one named local per gate, over the term of setbe_gpr_one_8__reg_rdi__csharp.
    // The term's layer-5 text, LITERAL:
    //   Concat(Extract(63, 8, v2), If(Or(Extract(7, 0, v0) == Extract(7, 0, v1), Not(ULE(Extract(7, 0, v0), Extract(7, 0, v1)))), 1, 0))
    public static long emu_setbe_gpr_one_8__reg_rdi__csharp(long a, long b, long c) {
        long x1_7 = ext(a, 7, 7);
        long x0_7 = ext(b, 7, 7);
        long x1_6 = ext(a, 6, 6);
        long x0_6 = ext(b, 6, 6);
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_setbe_gpr_one_8__reg_rdi__csharp(values[0], values[1], values[2])).ToString());
                    answers.Append("\n");
