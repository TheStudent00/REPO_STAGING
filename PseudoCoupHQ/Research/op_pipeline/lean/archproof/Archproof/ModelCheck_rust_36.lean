...
/-- rust single-opcode row 36, arch mnemonic 'shr', example unit rust/op_511, 14 members
...
theorem ModelCheck_rust_36 (v0 : BitVec 64) (v1 : BitVec 64) :
    (v0 >>> ((0#58) ++ (v1.extractLsb 5 0)))
  = (model_shr_11 (model_mov_22 v0) (model_mov_22 v1)) := by
  simp only [model_mov_22, model_shr_11]
  bv_decide

#print axioms ModelCheck_rust_36
