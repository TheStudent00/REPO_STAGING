...
// one named local per gate, over the term of movslq_widen_gpr_gpr_64__reg_rdi__dart.
...
int emu_movslq_widen_gpr_gpr_64__reg_rdi__dart(int a) {
  int x0_0 = ext(a, 0, 0);
  int x0_1 = ext(a, 1, 1);
  int x0_2 = ext(a, 2, 2);
  int x0_3 = ext(a, 3, 3);
  ...
  int w0 = x0_31;
  int w1 = cat(w0, x0_31, 1);
  int w2 = cat(w1, x0_31, 1);
  int w3 = cat(w2, x0_31, 1);
  int w4 = cat(w3, x0_31, 1);
  int w5 = cat(w4, x0_31, 1);
  int w6 = cat(w5, x0_31, 1);
  int w7 = cat(w6, x0_31, 1);
  int w8 = cat(w7, x0_31, 1);
  int w9 = cat(w8, x0_31, 1);
  int w10 = cat(w9, x0_31, 1);
  int w11 = cat(w10, x0_31, 1);
  int w12 = cat(w11, x0_31, 1);
  int w13 = cat(w12, x0_31, 1);
  int w14 = cat(w13, x0_31, 1);
  int w15 = cat(w14, x0_31, 1);
  int w16 = cat(w15, x0_31, 1);
  int w17 = cat(w16, x0_31, 1);
  int w18 = cat(w17, x0_31, 1);
  int w19 = cat(w18, x0_31, 1);
  int w20 = cat(w19, x0_31, 1);
  int w21 = cat(w20, x0_31, 1);
  int w22 = cat(w21, x0_31, 1);
  int w23 = cat(w22, x0_31, 1);
  int w24 = cat(w23, x0_31, 1);
  int w25 = cat(w24, x0_31, 1);
  int w26 = cat(w25, x0_31, 1);
  int w27 = cat(w26, x0_31, 1);
  int w28 = cat(w27, x0_31, 1);
  int w29 = cat(w28, x0_31, 1);
  int w30 = cat(w29, x0_31, 1);
  int w31 = cat(w30, x0_31, 1);
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_movslq_widen_gpr_gpr_64__reg_rdi__dart(values[0]);
