...
// InterpRenderer from the layer-4 term of mulw_gpr_gpr_gpr_32__reg_a0__php.
...
function emu_mulw_gpr_gpr_gpr_32__reg_a0__php($a, $b) {
    return ex_m(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_ext(ex_mul($a, $b, 32), 31, 31), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_ext(ex_mul($a, $b, 32), 31, 31), 1), ex_mul($a, $b, 32), 32), 64);
}
...
while (($line = fgets($handle)) !== false) {
    ...
    try {
        $answer = emu_mulw_gpr_gpr_gpr_32__reg_a0__php(...$ints);
        if ($answer < 0) {
            echo sprintf("%s\n", sprintf("%u", $answer));
        } else {
            echo $answer . "\n";
