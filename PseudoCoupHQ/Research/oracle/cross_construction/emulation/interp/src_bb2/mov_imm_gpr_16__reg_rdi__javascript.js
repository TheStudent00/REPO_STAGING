...
// one named local per gate, over the term of mov_imm_gpr_16__reg_rdi__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(63, 16, v0), Extract(15, 0, v1))
function emu_mov_imm_gpr_16__reg_rdi__javascript(a, b) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_mov_imm_gpr_16__reg_rdi__javascript(...values).toString());
    } catch (problem) {
