---
id: hq.research.compiler_graph.pool.exception_families.check
---

# CHECK — 0_3_1_7_6_exception_families

Node `hq.research.compiler_graph.pool.exception_families`. Status `draft`.
