...
the gutting happened 2026-07-31. `~/Programming/PseudoCoup_v5/`
...
- **vendored upstream compiler source, ~430 MB** — rustc and
  ...
  `~/Programming/PseudoCoup_v6/Tools/ledgerer/fixtures/upstream/` and
  `~/Programming/PseudoCoup_v6/Tools/transpiler/fixtures/upstream/`.
...
- **`Designing/` and three unreferenced research folders** (historical)
  ...
  long ago and lives in `~/Programming/PseudoIR/Tools/intentions/`.
...
`~/Programming/PseudoCoup_v5/DevComms/` carry line-cited evidence for
