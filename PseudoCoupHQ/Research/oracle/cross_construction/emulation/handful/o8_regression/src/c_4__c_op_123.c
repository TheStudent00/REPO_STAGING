/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of c_4__c_op_123.  The term's layer-5 text, LITERAL:
...
float
emu_c_4__c_op_123(double a, float b)
{
