...
// InterpRenderer from the layer-4 term of slti_gpr_gpr_imm_64__reg_a0__javascript.
// The term's layer-5 text, LITERAL:
//   If(3 <= v0, 0, 1)
function emu_slti_gpr_gpr_imm_64__reg_a0__javascript(a) {
    return m(((sle(3n, a, 64)) ? (0n) : (1n)), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_slti_gpr_gpr_imm_64__reg_a0__javascript(...values).toString());
    } catch (problem) {
