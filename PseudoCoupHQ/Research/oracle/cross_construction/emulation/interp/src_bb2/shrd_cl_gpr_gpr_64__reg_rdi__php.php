...
// one named local per gate, over the term of shrd_cl_gpr_gpr_64__reg_rdi__php.
// The term's layer-5 text, LITERAL:
//   Extract(63, 0, LShR(Concat(v0, v1), Concat(0, Extract(5, 0, v2))))
function emu_shrd_cl_gpr_gpr_64__reg_rdi__php($a, $b, $c) {
    $x1_0 = ex_ext($b, 0, 0);
    $x1_1 = ex_ext($b, 1, 1);
    $x2_0 = ex_ext($c, 0, 0);
    $x1_2 = ex_ext($b, 2, 2);
...
while (($line = fgets($handle)) !== false) {
    ...
    try {
        $answer = emu_shrd_cl_gpr_gpr_64__reg_rdi__php(...$ints);
        if ($answer < 0) {
            echo sprintf("%s\n", sprintf("%u", $answer));
        } else {
            echo $answer . "\n";
