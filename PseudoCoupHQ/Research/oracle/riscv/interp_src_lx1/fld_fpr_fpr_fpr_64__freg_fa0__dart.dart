...
// InterpRenderer from the layer-4 term of fld_fpr_fpr_fpr_64__freg_fa0__dart.
// The term's layer-5 text, LITERAL:
//   v0
int emu_fld_fpr_fpr_fpr_64__freg_fa0__dart(int a) {
  return m(a, 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_fld_fpr_fpr_fpr_64__freg_fa0__dart(values[0]);
