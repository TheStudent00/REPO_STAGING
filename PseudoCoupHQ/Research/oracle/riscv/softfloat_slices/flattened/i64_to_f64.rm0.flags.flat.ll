; ModuleID = '<scratch>/fl/run/i64_to_f64.rm0.flags/i64_to_f64.rm0.flags.rv.flat.ll'
source_filename = "llvm-link"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128"
target triple = "riscv64-unknown-unknown-elf"

define dso_local [2 x i64] @i64_to_f64_rm0_flags_flat(i64 noundef %arg) {
  ...
  %.o31 = or i64 %.a27, %.a30
  %.o33 = or i64 %.o31, %.a32
  %i48 = insertvalue [2 x i64] poison, i64 %.a25, 0
  %i49 = insertvalue [2 x i64] %i48, i64 %.o33, 1
  ret [2 x i64] %i49
}
