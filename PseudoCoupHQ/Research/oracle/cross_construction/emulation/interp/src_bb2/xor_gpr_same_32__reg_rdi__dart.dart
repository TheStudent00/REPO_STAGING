...
// one named local per gate, over the term of xor_gpr_same_32__reg_rdi__dart.
// The term's layer-5 text, LITERAL:
//   0
int emu_xor_gpr_same_32__reg_rdi__dart(int a) {
  int k0 = 0;
  int w0 = k0;
  int w1 = cat(w0, k0, 1);
  int w2 = cat(w1, k0, 1);
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_xor_gpr_same_32__reg_rdi__dart(values[0]);
