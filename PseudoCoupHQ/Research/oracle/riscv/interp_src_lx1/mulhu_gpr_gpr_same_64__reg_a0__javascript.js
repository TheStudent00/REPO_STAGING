...
// InterpRenderer from the layer-4 term of mulhu_gpr_gpr_same_64__reg_a0__javascript.
// The term's layer-5 text, LITERAL:
//   Extract(127, 64, Concat(0, v0)*Concat(0, v0))
function emu_mulhu_gpr_gpr_same_64__reg_a0__javascript(a) {
    return m(ext(mul(cat(0n, a, 64), cat(0n, a, 64), 128), 127, 64), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_mulhu_gpr_gpr_same_64__reg_a0__javascript(...values).toString());
    } catch (problem) {
