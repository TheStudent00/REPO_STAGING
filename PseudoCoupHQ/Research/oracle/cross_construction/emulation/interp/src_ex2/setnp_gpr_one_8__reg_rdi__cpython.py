...
# InterpRenderer from the layer-4 term of setnp_gpr_one_8__reg_rdi__cpython.
...
def emu_setnp_gpr_one_8__reg_rdi__cpython(a, b):
    return m(cat(0, ((0) if (eq(ext(add(mul(b, 255, 8), a, 8), 1, 1), ((1) if (eq(ext(add(mul(b, 255, 8), a, 8), 2, 2), ((1) if (eq(ext(add(mul(b, 255, 8), a, 8), 3, 3), ((1) if (eq(ext(add(mul(b, 255, 8), a, 8), 4, 4), ((1) if (eq(ext(add(mul(b, 255, 8), a, 8), 5, 5), ((1) if (eq(ext(add(mul(b, 255, 8), a, 8), 6, 6), ((1) if (eq(ext(add(mul(b, 255, 8), a, 8), 7, 7), ((1) if (eq(add(ext(a, 0, 0), 1, 1), ext(b, 0, 0), 1)) else (0)), 1)) else (0)), 1)) else (0)), 1)) else (0)), 1)) else (0)), 1)) else (0)), 1)) else (0)), 1)) else (1)), 8), 64)
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_setnp_gpr_one_8__reg_rdi__cpython(*values)
            sys.stdout.write("%d\n" % answer)
