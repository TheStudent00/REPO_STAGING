---
id: hq.research.lean_proof_path_resistant_to_churn.lean_expr.check
---

# CHECK — 0_3_3_2_lean_expr

Node `hq.research.lean_proof_path_resistant_to_churn.lean_expr`. Status `draft`.
