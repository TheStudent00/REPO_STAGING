...
// intermediate per node of the term of ZBB_RTYPE__op_MINU__rd__go__all_constructed.
//   
package main
...
//go:noinline
func emu_ZBB_RTYPE__op_MINU__rd__go__all_constructed(a uint64, b uint64) uint64 {
...
func main() {
	sink = emu_ZBB_RTYPE__op_MINU__rd__go__all_constructed(g0, g1)
	_ = sink
}
