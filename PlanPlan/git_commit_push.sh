#!/usr/bin/env bash
# add-commit-push for PlanPlan. Run by the owner on the host machine;
...
#
# Usage:  bash <WORKSPACE_DIR>/PlanPlan/git_commit_push.sh ["commit message"]

set +e
REPO=<WORKSPACE_DIR>/PlanPlan
