// arch-unit 422  --  go  `&a`  lhs=int64 rhs=None
// symbol main.op_31   outcome LIFTED   18 arch-opcodes
//
// the arch-unit, arch-opcode by arch-opcode:
//   ld t1, 0x10(s11)                     memory     the store/load the reduction *(&a) reads
//   bltu t1, sp, 0x6c6d4 <main.op_31+0x14> integer    stack-growth check -> elided
...
//   jal zero, 0x6c6c0 <main.op_31>       address    a call into the go runtime
...
//   addi a0, a0, -0x4be                  integer    operator:+
...
public final class au_422_go_addr_i64 {

    public static long au_422_go_addr_i64(long p0) {
