...
// InterpRenderer from the layer-4 term of push_gpr_one_64__stack_-8__dart.
// The term's layer-5 text, LITERAL:
//   v0
int emu_push_gpr_one_64__stack_-8__dart(int a) {
  return m(a, 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_push_gpr_one_64__stack_-8__dart(values[0]);
