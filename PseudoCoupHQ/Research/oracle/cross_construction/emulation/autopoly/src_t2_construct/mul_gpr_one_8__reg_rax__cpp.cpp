/* task ex1 emulation -- rendered by cpp_render.py CppRenderer from the layer-4 term of mul_gpr_one_8__reg_rax__cpp.  The term's layer-5 text, LITERAL:
   Concat(Extract(63, 16, v0), Concat(0, Extract(7, 0, v0))*Concat(0, Extract(7, 0, v1))) */
#include <cstdint>

extern "C"
uint64_t
emu_mul_gpr_one_8__reg_rax__cpp(uint64_t a, uint8_t b)
{
