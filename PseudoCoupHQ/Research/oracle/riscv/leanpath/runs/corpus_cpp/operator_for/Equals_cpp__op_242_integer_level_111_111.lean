...
theorem cpp__op_242_111_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_DIV (a) (b) (true))) = ((to_bits_truncate (l := 64) (if (((BitVec.toNatInt b) == 0) : Bool) then (Neg.neg 1) else (Int.tdiv (BitVec.toNatInt a) (BitVec.toNatInt b))))) := by
