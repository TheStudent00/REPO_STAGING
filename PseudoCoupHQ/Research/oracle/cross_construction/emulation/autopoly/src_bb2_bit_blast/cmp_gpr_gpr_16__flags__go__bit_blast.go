...
// intermediate per node of the term of cmp_gpr_gpr_16__flags__go__bit_blast.
//   Concat(Extract(15, 0, v0), Extract(15, 0, v1))
package main

//go:noinline
func emu_cmp_gpr_gpr_16__flags__go__bit_blast(a uint16, b uint16) uint32 {
...
func main() {
	sink = emu_cmp_gpr_gpr_16__flags__go__bit_blast(g0, g1)
	_ = sink
}
