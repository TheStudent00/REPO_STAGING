...
/-- cpp single-opcode row 20, arch mnemonic 'imul', example unit cpp/op_174, 170 members
...
theorem ModelCheck_cpp_20 (v0 : BitVec 64) (v1 : BitVec 64) :
    ((v0.extractLsb 31 0) * (v1.extractLsb 31 0))
  = ((model_imul_38 (model_mov_15 v0) v1).extractLsb 31 0) := by
  simp only [model_mov_15, model_imul_38]
  bv_decide

#print axioms ModelCheck_cpp_20
