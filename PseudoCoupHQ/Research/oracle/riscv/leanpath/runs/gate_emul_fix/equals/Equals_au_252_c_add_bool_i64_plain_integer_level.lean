...
theorem au_252_c_add_bool_i64_plain_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (ADD))) = ((pure_RTYPE ((pure_ITYPE (a) ((sign_extend (m := 12) (0x01#6))) (ANDI))) (b) (ADD))) := by
