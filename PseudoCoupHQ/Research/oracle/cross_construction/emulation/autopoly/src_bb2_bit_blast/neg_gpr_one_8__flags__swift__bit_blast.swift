...
// intermediate per node of the term of neg_gpr_one_8__flags__swift__bit_blast.
//   Concat(Extract(7, 0, v0), 0)
@_cdecl("emu_neg_gpr_one_8__flags__swift__bit_blast")
public func emu_neg_gpr_one_8__flags__swift__bit_blast(_ a: UInt8) -> UInt16
{
