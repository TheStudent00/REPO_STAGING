...
// InterpRenderer from the layer-4 term of movdqa_xmm_xmm_128__reg_xmm0.low__dart.
// The term's layer-5 text, LITERAL:
//   Extract(63, 0, v0)
int emu_movdqa_xmm_xmm_128__reg_xmm0.low__dart(int a) {
  return m(a, 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_movdqa_xmm_xmm_128__reg_xmm0.low__dart(values[0]);
