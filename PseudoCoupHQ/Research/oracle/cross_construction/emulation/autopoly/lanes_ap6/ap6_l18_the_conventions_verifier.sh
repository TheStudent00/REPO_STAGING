#!/bin/bash
# ap6_l18_the_conventions_verifier.sh -- task ap6, lane 18: the verifier again,
# after two transcription errors in the log were corrected -- a blank
# first line of one paste and one cell that read 70 where the tool
# prints 0 -- and after lane 17 replaced lane 14.
#
