...
# one named local per gate, over the term of movd_gpr_xmm_32__reg_xmm0__cpython.
# The term's layer-5 text, LITERAL:
#   Extract(31, 0, v0)
def emu_movd_gpr_xmm_32__reg_xmm0__cpython(a):
    x0_0 = ext(a, 0, 0)
    x0_1 = ext(a, 1, 1)
    x0_2 = ext(a, 2, 2)
    x0_3 = ext(a, 3, 3)
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_movd_gpr_xmm_32__reg_xmm0__cpython(*values)
            sys.stdout.write("%d\n" % answer)
