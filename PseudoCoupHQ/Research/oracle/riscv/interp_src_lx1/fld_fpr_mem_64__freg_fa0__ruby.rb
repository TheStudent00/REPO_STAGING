...
# InterpRenderer from the layer-4 term of fld_fpr_mem_64__freg_fa0__ruby.
# The term's layer-5 text, LITERAL:
#   v0
def emu_fld_fpr_mem_64__freg_fa0__ruby(a)
  m(a, 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_fld_fpr_mem_64__freg_fa0__ruby(*values)
