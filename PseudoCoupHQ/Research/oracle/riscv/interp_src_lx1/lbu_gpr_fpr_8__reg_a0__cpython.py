...
# InterpRenderer from the layer-4 term of lbu_gpr_fpr_8__reg_a0__cpython.
# The term's layer-5 text, LITERAL:
#   Concat(0, Extract(7, 0, v0))
def emu_lbu_gpr_fpr_8__reg_a0__cpython(a):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_lbu_gpr_fpr_8__reg_a0__cpython(*values)
            sys.stdout.write("%d\n" % answer)
