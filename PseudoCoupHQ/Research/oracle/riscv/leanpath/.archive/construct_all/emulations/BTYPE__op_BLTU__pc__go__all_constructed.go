...
// intermediate per node of the term of BTYPE__op_BLTU__pc__go__all_constructed.
//   
package main

//go:noinline
func emu_BTYPE__op_BLTU__pc__go__all_constructed(a uint64, b uint16) uint64 {
...
func main() {
	sink = emu_BTYPE__op_BLTU__pc__go__all_constructed(g0, g1)
	_ = sink
}
