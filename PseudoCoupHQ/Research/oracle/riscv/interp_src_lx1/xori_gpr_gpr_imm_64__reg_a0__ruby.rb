...
# InterpRenderer from the layer-4 term of xori_gpr_gpr_imm_64__reg_a0__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(Extract(63, 2, v0), ~Extract(1, 0, v0))
def emu_xori_gpr_gpr_imm_64__reg_a0__ruby(a)
  m(cat(ext(a, 63, 2), bnot(ext(a, 1, 0), 2), 2), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_xori_gpr_gpr_imm_64__reg_a0__ruby(*values)
