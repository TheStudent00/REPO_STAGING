...
// intermediate per node of the term of BTYPE__op_BNE__pc__rust__all_constructed.
//   
#[no_mangle]
pub extern "C" fn emu_BTYPE__op_BNE__pc__rust__all_constructed(a: u64, b: u16) -> u64
{
