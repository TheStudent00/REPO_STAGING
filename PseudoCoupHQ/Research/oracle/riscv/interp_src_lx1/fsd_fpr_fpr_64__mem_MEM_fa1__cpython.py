...
# InterpRenderer from the layer-4 term of fsd_fpr_fpr_64__mem_MEM_fa1__cpython.
# The term's layer-5 text, LITERAL:
#   v0
def emu_fsd_fpr_fpr_64__mem_MEM_fa1__cpython(a):
    return m(a, 64)
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_fsd_fpr_fpr_64__mem_MEM_fa1__cpython(*values)
            sys.stdout.write("%d\n" % answer)
