...
// InterpRenderer from the layer-4 term of sub_gpr_gpr_same_64__reg_a0__dart.
// The term's layer-5 text, LITERAL:
//   0
int emu_sub_gpr_gpr_same_64__reg_a0__dart(int a) {
  return m(0, 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_sub_gpr_gpr_same_64__reg_a0__dart(values[0]);
