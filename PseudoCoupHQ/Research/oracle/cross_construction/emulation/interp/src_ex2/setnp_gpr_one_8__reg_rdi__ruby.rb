...
# InterpRenderer from the layer-4 term of setnp_gpr_one_8__reg_rdi__ruby.
...
def emu_setnp_gpr_one_8__reg_rdi__ruby(a, b)
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_setnp_gpr_one_8__reg_rdi__ruby(*values)
