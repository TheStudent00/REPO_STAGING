...
// InterpRenderer from the layer-4 term of slliw_gpr_gpr_imm_32__reg_a0__dart.
...
int emu_slliw_gpr_gpr_imm_32__reg_a0__dart(int a) {
  return m(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(ext(a, 28, 28), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 0), 29), 0, 3), 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_slliw_gpr_gpr_imm_32__reg_a0__dart(values[0]);
