...
# InterpRenderer from the layer-4 term of xor_imm_gpr_8__reg_rdi__cpython.
# The term's layer-5 text, LITERAL:
#   Concat(0, Extract(7, 0, v0) ^ Extract(7, 0, v1))
def emu_xor_imm_gpr_8__reg_rdi__cpython(a, b):
    return m(cat(0, bxor(b, a, 8), 8), 64)
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_xor_imm_gpr_8__reg_rdi__cpython(*values)
            sys.stdout.write("%d\n" % answer)
