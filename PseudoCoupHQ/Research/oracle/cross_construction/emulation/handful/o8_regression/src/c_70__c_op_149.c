/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of c_70__c_op_149.  The term's layer-5 text, LITERAL:
   Concat(0, Extract(31, 0, v0))*18446744073709551615 + v1 */
#include <stdint.h>

uint64_t
emu_c_70__c_op_149(uint64_t a, uint32_t b)
{
