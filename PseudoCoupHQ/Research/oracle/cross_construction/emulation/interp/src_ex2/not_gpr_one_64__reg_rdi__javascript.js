...
// InterpRenderer from the layer-4 term of not_gpr_one_64__reg_rdi__javascript.
// The term's layer-5 text, LITERAL:
//   ~v0
function emu_not_gpr_one_64__reg_rdi__javascript(a) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_not_gpr_one_64__reg_rdi__javascript(...values).toString());
    } catch (problem) {
