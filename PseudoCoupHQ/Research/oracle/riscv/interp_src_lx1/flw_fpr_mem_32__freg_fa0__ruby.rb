...
# InterpRenderer from the layer-4 term of flw_fpr_mem_32__freg_fa0__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(4294967295, Extract(31, 0, v0))
def emu_flw_fpr_mem_32__freg_fa0__ruby(a)
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_flw_fpr_mem_32__freg_fa0__ruby(*values)
