...
// intermediate per node of the term of RTYPEW__op_ADDW__rd__go__all_constructed.
//   
package main

//go:noinline
func emu_RTYPEW__op_ADDW__rd__go__all_constructed(a uint32, b uint32) uint64 {
...
func main() {
	sink = emu_RTYPEW__op_ADDW__rd__go__all_constructed(g0, g1)
	_ = sink
}
