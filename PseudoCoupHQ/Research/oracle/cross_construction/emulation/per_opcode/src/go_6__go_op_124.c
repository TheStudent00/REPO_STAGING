/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of go_6__go_op_124.  The term's layer-5 text, LITERAL:
...
double
emu_go_6__go_op_124(double a, double b)
{
