...
// intermediate per node of the term of LOAD__is_unsigned_True__width_8__mem_addr__rust__all_constructed.
//   
#[no_mangle]
pub extern "C" fn emu_LOAD__is_unsigned_True__width_8__mem_addr__rust__all_constructed(a: u64, b: u16) -> u64
{
