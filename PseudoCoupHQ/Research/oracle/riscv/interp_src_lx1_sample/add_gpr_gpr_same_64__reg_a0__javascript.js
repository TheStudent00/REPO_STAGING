...
// InterpRenderer from the layer-4 term of add_gpr_gpr_same_64__reg_a0__javascript.
// The term's layer-5 text, LITERAL:
//   v0*2
function emu_add_gpr_gpr_same_64__reg_a0__javascript(a) {
    return m(mul(a, 2n, 64), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_add_gpr_gpr_same_64__reg_a0__javascript(...values).toString());
    } catch (problem) {
