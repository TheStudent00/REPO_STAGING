...
// one named local per gate, over the term of seta_gpr_one_8__reg_rdi__javascript.
...
function emu_seta_gpr_one_8__reg_rdi__javascript(a, b, c) {
    ...
    const g102 = (g81 ^ x0_3);
    const g103 = (g102 ^ 1n);
    const g104 = (g103 ^ x1_3);
    const g105 = (g104 ^ 1n);
    const g106 = (g80 ^ x0_2);
    const g107 = (g106 ^ 1n);
    const g108 = (g107 ^ x1_2);
    const g109 = (g108 ^ 1n);
    const g110 = (x0_0 ^ x0_1);
    const g111 = (g110 ^ 1n);
    const g112 = (g111 ^ x1_1);
    const g113 = (g112 ^ 1n);
    const g114 = (x0_0 ^ x1_0);
    const g115 = (g114 ^ 1n);
    const g116 = (g115 ^ 1n);
    const g117 = (g116 | g113);
    const g118 = (g117 | g109);
    const g119 = (g118 | g105);
    const g120 = (g119 | g101);
    const g121 = (g120 | g97);
    const g122 = (g121 | g93);
    const g123 = (g122 | g89);
    const g124 = (g123 ^ 1n);
...
for (const line of lines) {
    ...
    try {
        out.push(emu_seta_gpr_one_8__reg_rdi__javascript(...values).toString());
    } catch (problem) {
