...
// intermediate per node of the term of sbb_gpr_same_32__flags__go__bit_blast.
//   Concat(Extract(31, 0, v0), Extract(31, 0, v0))
package main

//go:noinline
func emu_sbb_gpr_same_32__flags__go__bit_blast(a uint32) uint64 {
...
func main() {
	sink = emu_sbb_gpr_same_32__flags__go__bit_blast(g0)
	_ = sink
}
