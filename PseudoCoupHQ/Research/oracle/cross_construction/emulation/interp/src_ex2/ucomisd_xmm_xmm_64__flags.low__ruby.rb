...
# InterpRenderer from the layer-4 term of ucomisd_xmm_xmm_64__flags.low__ruby.
# The term's layer-5 text, LITERAL:
#   fp.to_ieee_bv(fpToFP(Extract(63, 0, v0)))
def emu_ucomisd_xmm_xmm_64__flags.low__ruby(a)
  m(a, 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_ucomisd_xmm_xmm_64__flags.low__ruby(*values)
