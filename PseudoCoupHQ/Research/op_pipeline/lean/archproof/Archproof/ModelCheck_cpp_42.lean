...
/-- cpp single-opcode row 42, arch mnemonic 'mov', example unit cpp/regen_559, 4 members
...
theorem ModelCheck_cpp_42  :
    (16#32)
  = (model_mov_29.extractLsb 31 0) := by
  rfl

#print axioms ModelCheck_cpp_42
