...
theorem c_op_174__MUL_result_partV_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_MULW (b) (a))) = (pure_MUL (a) (b) ({ result_part := VectorHalf.Low, signed_rs1 := Signedness.Unsigned, signed_rs2 := Signedness.Unsigned })) := by
  simp only [pure_MULW, pure_MUL]
  grind
