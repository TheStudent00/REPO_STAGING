/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of add_gpr_gpr_64__reg_rdi__c__all_constructed.  The term's text, LITERAL:
   v0 + v1 */
#include <stdint.h>

uint64_t
emu_add_gpr_gpr_64__reg_rdi__c__all_constructed(uint64_t a, uint64_t b)
{
