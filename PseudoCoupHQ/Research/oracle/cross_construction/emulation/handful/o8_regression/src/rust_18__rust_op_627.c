/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of rust_18__rust_op_627.  The term's layer-5 text, LITERAL:
...
float
emu_rust_18__rust_op_627(double a, float b)
{
