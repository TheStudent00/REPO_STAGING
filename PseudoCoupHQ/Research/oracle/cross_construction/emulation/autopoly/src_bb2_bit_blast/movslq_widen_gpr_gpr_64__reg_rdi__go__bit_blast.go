...
// intermediate per node of the term of movslq_widen_gpr_gpr_64__reg_rdi__go__bit_blast.
...
//go:noinline
func emu_movslq_widen_gpr_gpr_64__reg_rdi__go__bit_blast(a uint32) uint64 {
...
func main() {
	sink = emu_movslq_widen_gpr_gpr_64__reg_rdi__go__bit_blast(g0)
	_ = sink
}
