/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of sub_gpr_gpr_16__flags__c__bit_blast.  The term's text, LITERAL:
   Concat(Extract(15, 0, v0), Extract(15, 0, v1)) */
#include <stdint.h>

uint32_t
emu_sub_gpr_gpr_16__flags__c__bit_blast(uint16_t a, uint16_t b)
{
