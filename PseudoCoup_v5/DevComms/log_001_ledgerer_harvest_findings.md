...
`PRIVATE/PseudoCoup_v5/Planning/node_0_0_tools/node_0_0_0_ledgerer/`
...
- The **semantic family** — `PUBLIC/PseudoCoup/pseudocoup/core/ledger.py`,
...
- The **verification family** —
  `PRIVATE/StressBot/RelevantProjects/PseudoCoup_v0/tools/pseudokotlin/`.
...
- **Where.** `PUBLIC/PseudoCoup/pseudocoup/core/ledger.py`,
...
- **Where.** The schema specs at
  ...
  implementation at
  `PRIVATE/PseudoCoup_v5/Research/rust_routing/ledger.py`, 56 lines.
...
- **Where, and this is the part that is split three ways.**
  - In-code kinds: `classify_methods` in
    `PRIVATE/StressBot/RelevantProjects/PseudoCoup_v0/tools/pseudokotlin/ledger.py`,
...
- **Where.** `ui_ledger._norm`, in
  `PRIVATE/StressBot/RelevantProjects/PseudoCoup_v0/tools/pseudokotlin/ui_ledger.py`,
  518 lines.
...
- **The runtime tracer.** `WalkEmit` and its injector
  ...
  (recorded in `PRIVATE/PseudoCoupHQ/DevComms/log_003_harvest_reminder.md`
  §4), but the tracer was settled as a CO-NODE of the ledgerer on
  2026-08-01 — it is `pcv5.tools.tracer`, node `node_0_0_3_tracer`.
  (`PRIVATE/PseudoCoup_v5/Planning/node_0_0_tools/PROGRESS.md`
  ...
  - Hazards that come with the injector, which belong to the tracer
    ...
    counter drifts.
- **`PRIVATE/StressBot/StressBot/core/ledger.py`** — confirmed
...
| --- | --- | --- |
| `PUBLIC/PseudoCoup/pseudocoup/core/ledger.py` | 289 lines | 289 |
| `PRIVATE/StressBot/RelevantProjects/PseudoCoup_v0/tools/pseudokotlin/ledger.py` | 370 lines | 370 |
| `PRIVATE/StressBot/RelevantProjects/PseudoCoup_v0/tools/pseudokotlin/kit_ledger.py` | 374 lines | 374 |
| `PRIVATE/StressBot/RelevantProjects/PseudoCoup_v0/tools/pseudokotlin/idgen.py` | 294 lines | 294 |
| `PRIVATE/StressBot/RelevantProjects/PseudoCoup_v0/tools/pseudokotlin/ui_ledger.py` | 518 lines | 518 |
| `PRIVATE/StressBot/RelevantProjects/PseudoCoup_v0/tools/pseudokotlin/ledger_unified.py` | `check()` at L243–281 | present, 323 lines |
| `PRIVATE/StressBot/RelevantProjects/PseudoCoup_v0/tools/pseudokotlin/inject_emitid.py` | 837 lines | 837 |
| `PRIVATE/PseudoCoup_v5/Research/rust_routing/ledger.py` | 57 lines | **56** |
...
- **Seven of the nine sources live outside the three live repos**, under
  ...
  `PUBLIC/PseudoCoup/`, and `0_Archive/`. The
...
- **Settled framing** (survey §5, superseding the three-way seed
  choice in `PRIVATE/PseudoCoup_v5/DevComms/plan_llvm_rust_2026-07-27.md`
...
the 2026-07-31 split. `PRIVATE/PseudoCoupHQ/DevComms/log_003_harvest_reminder.md`
