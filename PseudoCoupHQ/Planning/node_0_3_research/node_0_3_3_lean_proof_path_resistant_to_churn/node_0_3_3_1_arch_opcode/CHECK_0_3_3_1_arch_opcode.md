---
id: hq.research.lean_proof_path_resistant_to_churn.arch_opcode.check
---

# CHECK — 0_3_3_1_arch_opcode

Node `hq.research.lean_proof_path_resistant_to_churn.arch_opcode`. Status `draft`.
