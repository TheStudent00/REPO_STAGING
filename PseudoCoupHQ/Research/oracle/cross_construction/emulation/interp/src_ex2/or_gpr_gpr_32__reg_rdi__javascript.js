...
// InterpRenderer from the layer-4 term of or_gpr_gpr_32__reg_rdi__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(0, Extract(31, 0, v0) | Extract(31, 0, v1))
function emu_or_gpr_gpr_32__reg_rdi__javascript(a, b) {
    return m(cat(0n, bor(a, b, 32), 32), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_or_gpr_gpr_32__reg_rdi__javascript(...values).toString());
    } catch (problem) {
