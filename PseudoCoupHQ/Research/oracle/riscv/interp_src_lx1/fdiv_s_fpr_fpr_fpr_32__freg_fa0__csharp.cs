...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of fdiv_s_fpr_fpr_fpr_32__freg_fa0__csharp.
    // The term's layer-5 text, LITERAL:
    //   Concat(4294967295, fp.to_ieee_bv(fpToFP(Extract(31, 0, v0)) / fpToFP(Extract(31, 0, v1))))
    public static long emu_fdiv_s_fpr_fpr_fpr_32__freg_fa0__csharp(long a, long b) {
        return m(cat(4294967295L, fdiv(a, b, 32), 32), 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_fdiv_s_fpr_fpr_fpr_32__freg_fa0__csharp(values[0], values[1])).ToString());
                    answers.Append("\n");
