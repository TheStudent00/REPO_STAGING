---
id: hq.research.lean_proof_path_resistant_to_churn.system.eye_check.check
---

# CHECK — 0_3_3_7_3_eye_check

Node `hq.research.lean_proof_path_resistant_to_churn.system.eye_check`. Status `draft`.
