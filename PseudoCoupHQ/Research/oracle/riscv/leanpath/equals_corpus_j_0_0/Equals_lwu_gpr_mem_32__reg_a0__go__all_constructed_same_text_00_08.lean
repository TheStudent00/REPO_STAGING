...
theorem lwu_gpr_mem_32__reg_a0__go__all_constructed_00_same_text (a : BitVec 64) :
    ((pure_SHIFTIOP ((pure_SHIFTIOP (a) ((0x20#6)) (SLLI))) ((0x20#6)) (SRLI))) = (pure_BREV8 (a) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem lwu_gpr_mem_32__reg_a0__go__all_constructed_01_same_text (a : BitVec 64) :
    ((pure_SHIFTIOP ((pure_SHIFTIOP (a) ((0x20#6)) (SLLI))) ((0x20#6)) (SRLI))) = (pure_CLZ (a) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem lwu_gpr_mem_32__reg_a0__go__all_constructed_02_same_text (a : BitVec 64) :
    ((pure_SHIFTIOP ((pure_SHIFTIOP (a) ((0x20#6)) (SLLI))) ((0x20#6)) (SRLI))) = (pure_CLZW (a) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem lwu_gpr_mem_32__reg_a0__go__all_constructed_03_same_text (a : BitVec 64) :
    ((pure_SHIFTIOP ((pure_SHIFTIOP (a) ((0x20#6)) (SLLI))) ((0x20#6)) (SRLI))) = (pure_CTZ (a) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem lwu_gpr_mem_32__reg_a0__go__all_constructed_04_same_text (a : BitVec 64) :
    ((pure_SHIFTIOP ((pure_SHIFTIOP (a) ((0x20#6)) (SLLI))) ((0x20#6)) (SRLI))) = (pure_CTZW (a) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem lwu_gpr_mem_32__reg_a0__go__all_constructed_05_same_text (a : BitVec 64) :
    ((pure_SHIFTIOP ((pure_SHIFTIOP (a) ((0x20#6)) (SLLI))) ((0x20#6)) (SRLI))) = (pure_REV8 (a) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem lwu_gpr_mem_32__reg_a0__go__all_constructed_06_same_text (a : BitVec 64) :
    ((pure_SHIFTIOP ((pure_SHIFTIOP (a) ((0x20#6)) (SLLI))) ((0x20#6)) (SRLI))) = (pure_ZBB_EXTOP (a) (extop_zbb.SEXTB)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem lwu_gpr_mem_32__reg_a0__go__all_constructed_07_same_text (a : BitVec 64) :
    ((pure_SHIFTIOP ((pure_SHIFTIOP (a) ((0x20#6)) (SLLI))) ((0x20#6)) (SRLI))) = (pure_ZBB_EXTOP (a) (extop_zbb.SEXTH)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem lwu_gpr_mem_32__reg_a0__go__all_constructed_08_same_text (a : BitVec 64) :
