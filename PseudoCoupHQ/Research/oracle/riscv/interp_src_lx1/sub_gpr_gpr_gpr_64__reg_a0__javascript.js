...
// InterpRenderer from the layer-4 term of sub_gpr_gpr_gpr_64__reg_a0__javascript.
// The term's layer-5 text, LITERAL:
//   v0*18446744073709551615 + v1
function emu_sub_gpr_gpr_gpr_64__reg_a0__javascript(a, b) {
    return m(add(mul(b, 18446744073709551615n, 64), a, 64), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_sub_gpr_gpr_gpr_64__reg_a0__javascript(...values).toString());
    } catch (problem) {
