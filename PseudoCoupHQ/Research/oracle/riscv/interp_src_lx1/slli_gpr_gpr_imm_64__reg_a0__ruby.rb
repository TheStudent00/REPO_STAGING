...
# InterpRenderer from the layer-4 term of slli_gpr_gpr_imm_64__reg_a0__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(Extract(60, 0, v0), 0)
def emu_slli_gpr_gpr_imm_64__reg_a0__ruby(a)
  m(cat(ext(a, 60, 0), 0, 3), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_slli_gpr_gpr_imm_64__reg_a0__ruby(*values)
