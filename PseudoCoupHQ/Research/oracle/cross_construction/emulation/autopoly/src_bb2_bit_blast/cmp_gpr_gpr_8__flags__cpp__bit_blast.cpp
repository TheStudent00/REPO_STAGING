/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of cmp_gpr_gpr_8__flags__cpp__bit_blast.  The term's text, LITERAL:
   Concat(Extract(7, 0, v0), Extract(7, 0, v1)) */
#include <cstdint>

extern "C"
uint16_t
emu_cmp_gpr_gpr_8__flags__cpp__bit_blast(uint8_t a, uint8_t b)
{
