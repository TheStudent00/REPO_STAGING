...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of lh_gpr_gpr_16__reg_a0__csharp.
    ...
    public static long emu_lh_gpr_gpr_16__reg_a0__csharp(long a) {
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_lh_gpr_gpr_16__reg_a0__csharp(values[0])).ToString());
                    answers.Append("\n");
