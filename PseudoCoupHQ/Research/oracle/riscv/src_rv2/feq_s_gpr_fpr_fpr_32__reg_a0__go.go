...
// GoRenderer from the layer-4 term of feq_s_gpr_fpr_fpr_32__reg_a0__go.
...
//go:noinline
func emu_feq_s_gpr_fpr_fpr_32__reg_a0__go(a uint32, b uint32) uint64 {
...
func main() {
	sink = emu_feq_s_gpr_fpr_fpr_32__reg_a0__go(g0, g1)
	_ = sink
}
