...
// intermediate per node of the term of orps_xmm_xmm_128__reg_xmm0_low__go__bit_blast.
...
//go:noinline
func emu_orps_xmm_xmm_128__reg_xmm0_low__go__bit_blast(a float64, b float64) float64 {
...
func main() {
	sink = emu_orps_xmm_xmm_128__reg_xmm0_low__go__bit_blast(g0, g1)
	_ = sink
}
