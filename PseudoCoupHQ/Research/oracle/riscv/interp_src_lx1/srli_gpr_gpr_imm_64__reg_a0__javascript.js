...
// InterpRenderer from the layer-4 term of srli_gpr_gpr_imm_64__reg_a0__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(0, Extract(63, 3, v0))
function emu_srli_gpr_gpr_imm_64__reg_a0__javascript(a) {
    return m(cat(0n, ext(a, 63, 3), 61), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_srli_gpr_gpr_imm_64__reg_a0__javascript(...values).toString());
    } catch (problem) {
