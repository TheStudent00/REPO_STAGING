#!/usr/bin/env bash
# lp1 lane 17 -- `lake build` of the ALL-MODULES emit (lane 16; the CI's own selection), as lane 12 did for the four-module one: the same toolchain and lean-sail v5 already under /persist; a NEW working copy /persist/lp1/Lean_IM_6266b40c_all. Otherwise as lane 12: `lake build` of the emit
...
echo "lane lp1_l17 done at $(date -u +%FT%TZ)"
