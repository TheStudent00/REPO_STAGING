...
public class Emu {
    ...
    // InterpRenderer from the layer-4 term of setp_gpr_one_8__reg_rdi__java.
    ...
    static long emu_setp_gpr_one_8__reg_rdi__java(long a, long b) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_setp_gpr_one_8__reg_rdi__java(values[0], values[1])));
                    answers.append("\n");
