...
# InterpRenderer from the layer-4 term of sbb_gpr_same_64__reg_rdi__ruby.
# The term's layer-5 text, LITERAL:
#   If(Extract(64, 64, Concat(0, v0) + Concat(0, v1)) == 1, 1, 0)*18446744073709551615
def emu_sbb_gpr_same_64__reg_rdi__ruby(a, b, c)
  m(mul(((eq(ext(add(cat(0, b, 64), cat(0, a, 64), 65), 64, 64), 1, 1)) ? (1) : (0)), 18446744073709551615, 64), 64)
end
