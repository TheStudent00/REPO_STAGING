...
# InterpRenderer from the layer-4 term of lhu_gpr_gpr_gpr_16__reg_a0__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(0, Extract(15, 0, v0))
def emu_lhu_gpr_gpr_gpr_16__reg_a0__ruby(a)
  m(cat(0, a, 16), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_lhu_gpr_gpr_gpr_16__reg_a0__ruby(*values)
