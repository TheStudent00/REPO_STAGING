/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of slliw_gpr_gpr_imm_32__reg_a0__cpp__native_first.  The term's text, LITERAL:
