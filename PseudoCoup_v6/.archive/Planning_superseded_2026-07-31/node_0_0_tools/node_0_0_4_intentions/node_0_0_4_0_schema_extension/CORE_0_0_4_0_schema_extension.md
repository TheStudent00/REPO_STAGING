...
## Subject artifacts (all in `PRIVATE/PseudoCoup_v5/Designing/`)
...
- Whether the extended artifact is written back into
  `PRIVATE/PseudoCoup_v5/Designing/` (PCv5 is archived
  research) or copied forward into
  `PRIVATE/PseudoCoup_v6/Tools/intentions/` and maintained
