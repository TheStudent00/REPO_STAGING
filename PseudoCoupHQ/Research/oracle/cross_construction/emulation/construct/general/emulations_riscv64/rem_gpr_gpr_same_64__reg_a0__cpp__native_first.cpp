/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of rem_gpr_gpr_same_64__reg_a0__cpp__native_first.  The term's text, LITERAL:
   If(v0 == 0, v0, If(And(v0 == 18446744073709551615, v0 == 9223372036854775808), 0, bvsrem_i(v0, v0))) */
#include <cstdint>

extern "C"
uint64_t
emu_rem_gpr_gpr_same_64__reg_a0__cpp__native_first(uint64_t a)
{
