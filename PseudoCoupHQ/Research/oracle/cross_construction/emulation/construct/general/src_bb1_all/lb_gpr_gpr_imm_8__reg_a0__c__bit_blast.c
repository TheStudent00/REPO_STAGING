/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of lb_gpr_gpr_imm_8__reg_a0__c__bit_blast.  The term's text, LITERAL:
...
uint64_t
emu_lb_gpr_gpr_imm_8__reg_a0__c__bit_blast(uint8_t a)
{
