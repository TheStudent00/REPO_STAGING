...
// intermediate per node of the term of or_gpr_gpr_64__flags_high__go__bit_blast.
//   v0 | v1
package main

//go:noinline
func emu_or_gpr_gpr_64__flags_high__go__bit_blast(a uint64, b uint64) uint64 {
...
func main() {
	sink = emu_or_gpr_gpr_64__flags_high__go__bit_blast(g0, g1)
	_ = sink
}
