...
# InterpRenderer from the layer-4 term of srli_gpr_gpr_imm_64__reg_a0__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(0, Extract(63, 3, v0))
def emu_srli_gpr_gpr_imm_64__reg_a0__ruby(a)
  m(cat(0, ext(a, 63, 3), 61), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_srli_gpr_gpr_imm_64__reg_a0__ruby(*values)
