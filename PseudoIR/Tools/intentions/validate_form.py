...
<WORKSPACE_DIR>/PseudoCoup_v5, the archived research tree whose
...
<WORKSPACE_DIR>/PseudoCoup_v6/Tools/ledgerer/tree_sitter/parse_source.py
...
Run:
    python3 <WORKSPACE_DIR>/PseudoIR/Tools/intentions/validate_form.py FORM.json --root <WORKSPACE_DIR>/PseudoCoup_v5
"""
...
PSEUDOCOUP = os.environ.get(
    "PSEUDOCOUP_ROOT", os.path.expanduser("<WORKSPACE_DIR>/PseudoCoup_v6"))
