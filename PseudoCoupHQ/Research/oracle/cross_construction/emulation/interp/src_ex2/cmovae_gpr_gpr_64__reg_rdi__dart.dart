...
// InterpRenderer from the layer-4 term of cmovae_gpr_gpr_64__reg_rdi__dart.
// The term's layer-5 text, LITERAL:
//   If(ULE(v0, v1), v2, v3)
int emu_cmovae_gpr_gpr_64__reg_rdi__dart(int a, int b, int c, int d) {
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_cmovae_gpr_gpr_64__reg_rdi__dart(values[0], values[1], values[2], values[3]);
