...
# InterpRenderer from the layer-4 term of lbu_gpr_gpr_gpr_8__reg_a0__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(0, Extract(7, 0, v0))
def emu_lbu_gpr_gpr_gpr_8__reg_a0__ruby(a)
  m(cat(0, a, 8), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_lbu_gpr_gpr_gpr_8__reg_a0__ruby(*values)
