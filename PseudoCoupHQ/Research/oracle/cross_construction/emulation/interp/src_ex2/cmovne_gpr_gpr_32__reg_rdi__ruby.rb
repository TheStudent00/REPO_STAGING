...
# InterpRenderer from the layer-4 term of cmovne_gpr_gpr_32__reg_rdi__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(0, If(~(~Extract(31, 0, v0) | ~Extract(31, 0, v1)) == 0, Extract(31, 0, v2), Extract(31, 0, v3)))
def emu_cmovne_gpr_gpr_32__reg_rdi__ruby(a, b, c, d)
  m(cat(0, ((eq(bnot(bor(bnot(b, 32), bnot(a, 32), 32), 32), 0, 32)) ? (d) : (c)), 32), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_cmovne_gpr_gpr_32__reg_rdi__ruby(*values)
