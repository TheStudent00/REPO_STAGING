...
theorem c_op_174__MULW_00_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_MULW (b) (a))) = (pure_MULW (a) (b) ) := by
  try simp only [pure_MULW, pure_MULW, sign_extend, to_bits_truncate, Sail.BitVec.signExtend]
  grind
