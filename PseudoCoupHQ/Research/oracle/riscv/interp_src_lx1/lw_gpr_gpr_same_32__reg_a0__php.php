...
// InterpRenderer from the layer-4 term of lw_gpr_gpr_same_32__reg_a0__php.
...
function emu_lw_gpr_gpr_same_32__reg_a0__php($a) {
...
while (($line = fgets($handle)) !== false) {
    ...
    try {
        $answer = emu_lw_gpr_gpr_same_32__reg_a0__php(...$ints);
        if ($answer < 0) {
            echo sprintf("%s\n", sprintf("%u", $answer));
        } else {
            echo $answer . "\n";
