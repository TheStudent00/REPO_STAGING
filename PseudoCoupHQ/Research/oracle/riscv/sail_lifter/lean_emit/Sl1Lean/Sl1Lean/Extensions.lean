import Sail
import Sl1Lean.Defs
import Sl1Lean.Specialization
import Sl1Lean.FakeReal
import Sl1Lean.RiscvExtras
...
def extensionName_forwards (arg_ : extension) : String :=
  ...
  | .Ext_H => "h"
  | .Ext_Sha => "sha"
  | .Ext_Shcounterenw => "shcounterenw"
  | .Ext_Shgatpa => "shgatpa"
  | .Ext_Shtvala => "shtvala"
  | .Ext_Shvsatpa => "shvsatpa"
  | .Ext_Shvstvala => "shvstvala"
  | .Ext_Shvstvecd => "shvstvecd"
  | .Ext_Zibi => "zibi"
  | .Ext_Zic64b => "zic64b"
  | .Ext_Zicbom => "zicbom"
  | .Ext_Zicbop => "zicbop"
...
def extensionName_backwards (arg_ : String) : SailM extension := do
  ...
  | "h" => (pure Ext_H)
  | "sha" => (pure Ext_Sha)
  | "shcounterenw" => (pure Ext_Shcounterenw)
  | "shgatpa" => (pure Ext_Shgatpa)
  | "shtvala" => (pure Ext_Shtvala)
  | "shvsatpa" => (pure Ext_Shvsatpa)
  | "shvstvala" => (pure Ext_Shvstvala)
  | "shvstvecd" => (pure Ext_Shvstvecd)
  | "zibi" => (pure Ext_Zibi)
...
def extensions_ordered_for_isa_string :=
  #v[Ext_Smstateen, Ext_Smnpm, Ext_Smmpm, Ext_Smcntrpmf, Ext_Shvstvecd, Ext_Shvstvala, Ext_Shvsatpa, Ext_Shtvala, Ext_Shgatpa, Ext_Shcounterenw, Ext_Sha, Ext_Svvptc, Ext_Svukte, Ext_Svrsw60t59b, Ext_Svpbmt, Ext_Svnapot, Ext_Svinval, Ext_Svadu, Ext_Svade, Ext_Supm, Ext_Ssu64xl, Ext_Sstvecd, Ext_Sstvala, Ext_Sstc, Ext_Ssstateen, Ext_Ssqosid, Ext_Sspm, Ext_Ssnpm, Ext_Sscounterenw, Ext_Sscofpmf, Ext_Ssccptr, Ext_Zvl1024b, Ext_Zvl512b, Ext_Zvl256b, Ext_Zvl128b, Ext_Zvl64b, Ext_Zvl32b, Ext_Zvkt, Ext_Zvksh, Ext_Zvksg, Ext_Zvksed, Ext_Zvksc, Ext_Zvks, Ext_Zvknhb, Ext_Zvknha, Ext_Zvkng, Ext_Zvkned, Ext_Zvknc, Ext_Zvkn, Ext_Zvkg, Ext_Zvkb, Ext_Zvfhmin, Ext_Zvfh, Ext_Zvfbfwma, Ext_Zvfbfmin, Ext_Zve64x, Ext_Zve64f, Ext_Zve64d, Ext_Zve32x, Ext_Zve32f, Ext_Zvbc, Ext_Zvbb, Ext_Zvabd, Ext_Zkt, Ext_Zksh, Ext_Zksed, Ext_Zkr, Ext_Zknh, Ext_Zkne, Ext_Zknd, Ext_Zbs, Ext_Zbkx, Ext_Zbkc, Ext_Zbkb, Ext_Zbc, Ext_Zbb, Ext_Zba, Ext_Zcmop, Ext_Zcf, Ext_Zcd, Ext_Zcb, Ext_Zca, Ext_Zhinxmin, Ext_Zhinx, Ext_Zdinx, Ext_Zfinx, Ext_Zfhmin, Ext_Zfh, Ext_Zfbfmin, Ext_Zfa, Ext_Zawrs, Ext_Zama16b, Ext_Zalrsc, Ext_Zacas, Ext_Zabha, Ext_Zaamo, Ext_Za64rs, Ext_Za128rs, Ext_Zmmul, Ext_Zimop, Ext_Zilx, Ext_Zihpm, Ext_Zihintpause, Ext_Zihintntl, Ext_Zifencei, Ext_Zicsr, Ext_Zicond, Ext_Zicntr, Ext_Zicfiss, Ext_Zicfilp, Ext_Ziccrse, Ext_Zicclsm, Ext_Ziccif, Ext_Ziccamoc, Ext_Ziccamoa, Ext_Zicboz, Ext_Zicbop, Ext_Zicbom, Ext_Zibi, Ext_Zic64b, Ext_H, Ext_V, Ext_B, Ext_C, Ext_D, Ext_F, Ext_A, Ext_M]
