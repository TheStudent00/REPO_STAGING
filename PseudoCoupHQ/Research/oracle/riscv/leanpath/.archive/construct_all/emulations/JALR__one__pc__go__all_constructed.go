...
// intermediate per node of the term of JALR__one__pc__go__all_constructed.
//   
package main

//go:noinline
func emu_JALR__one__pc__go__all_constructed(a uint64, b uint16) uint64 {
	...
	var v88 uint64 = ((uint64((uint64(v87)) >> 1)) & uint64(0x7fffffffffffffff))
	var v89 uint32 = uint32(0x0)
	var v90 uint64 = v88
	var v91 uint64 = (uint64(((uint64(v90)) << 1) | (uint64(v89))))
	return uint64(v91)
}
...
func main() {
	sink = emu_JALR__one__pc__go__all_constructed(g0, g1)
	_ = sink
}
