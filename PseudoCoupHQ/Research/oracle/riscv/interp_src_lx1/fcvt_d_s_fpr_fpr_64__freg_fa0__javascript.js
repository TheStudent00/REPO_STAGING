...
// InterpRenderer from the layer-4 term of fcvt_d_s_fpr_fpr_64__freg_fa0__javascript.
// The term's layer-5 text, LITERAL:
//   fp.to_ieee_bv(fpToFP(RNE(), fpToFP(Extract(31, 0, v0))))
function emu_fcvt_d_s_fpr_fpr_64__freg_fa0__javascript(a) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_fcvt_d_s_fpr_fpr_64__freg_fa0__javascript(...values).toString());
    } catch (problem) {
