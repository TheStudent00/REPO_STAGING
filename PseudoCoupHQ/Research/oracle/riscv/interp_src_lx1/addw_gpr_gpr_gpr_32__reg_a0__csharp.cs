...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of addw_gpr_gpr_gpr_32__reg_a0__csharp.
    ...
    public static long emu_addw_gpr_gpr_gpr_32__reg_a0__csharp(long a, long b) {
        return m(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(ext(add(a, b, 32), 31, 31), ext(add(a, b, 32), 31, 31), 1), ext(add(a, b, 32), 31, 31), 1), ext(add(a, b, 32), 31, 31), 1), ext(add(a, b, 32), 31, 31), 1), ext(add(a, b, 32), 31, 31), 1), ext(add(a, b, 32), 31, 31), 1), ext(add(a, b, 32), 31, 31), 1), ext(add(a, b, 32), 31, 31), 1), ext(add(a, b, 32), 31, 31), 1), ext(add(a, b, 32), 31, 31), 1), ext(add(a, b, 32), 31, 31), 1), ext(add(a, b, 32), 31, 31), 1), ext(add(a, b, 32), 31, 31), 1), ext(add(a, b, 32), 31, 31), 1), ext(add(a, b, 32), 31, 31), 1), ext(add(a, b, 32), 31, 31), 1), ext(add(a, b, 32), 31, 31), 1), ext(add(a, b, 32), 31, 31), 1), ext(add(a, b, 32), 31, 31), 1), ext(add(a, b, 32), 31, 31), 1), ext(add(a, b, 32), 31, 31), 1), ext(add(a, b, 32), 31, 31), 1), ext(add(a, b, 32), 31, 31), 1), ext(add(a, b, 32), 31, 31), 1), ext(add(a, b, 32), 31, 31), 1), ext(add(a, b, 32), 31, 31), 1), ext(add(a, b, 32), 31, 31), 1), ext(add(a, b, 32), 31, 31), 1), ext(add(a, b, 32), 31, 31), 1), ext(add(a, b, 32), 31, 31), 1), ext(add(a, b, 32), 31, 31), 1), add(a, b, 32), 32), 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_addw_gpr_gpr_gpr_32__reg_a0__csharp(values[0], values[1])).ToString());
                    answers.Append("\n");
