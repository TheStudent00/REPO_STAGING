...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of test_gpr_same_16__flags__csharp.
    // The term's layer-5 text, LITERAL:
    //   Concat(Extract(15, 0, v0), 0)
    public static long emu_test_gpr_same_16__flags__csharp(long a) {
        return m(cat(a, 0L, 16), 32);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_test_gpr_same_16__flags__csharp(values[0])).ToString());
                    answers.Append("\n");
