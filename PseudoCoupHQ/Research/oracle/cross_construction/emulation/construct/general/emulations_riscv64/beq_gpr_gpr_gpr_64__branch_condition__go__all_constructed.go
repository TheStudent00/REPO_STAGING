...
// intermediate per node of the term of beq_gpr_gpr_gpr_64__branch_condition__go__all_constructed.
//   If(v0 == v1, 1, 0)
package main
...
//go:noinline
func emu_beq_gpr_gpr_gpr_64__branch_condition__go__all_constructed(a uint64, b uint64) uint64 {
...
func main() {
	sink = emu_beq_gpr_gpr_gpr_64__branch_condition__go__all_constructed(g0, g1)
	_ = sink
}
