...
# InterpRenderer from the layer-4 term of mulsd_xmm_xmm_64__reg_xmm0__cpython.
# The term's layer-5 text, LITERAL:
#   fp.to_ieee_bv(fpToFP(Extract(63, 0, v0)) * fpToFP(Extract(63, 0, v1)))
def emu_mulsd_xmm_xmm_64__reg_xmm0__cpython(a, b):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_mulsd_xmm_xmm_64__reg_xmm0__cpython(*values)
            sys.stdout.write("%d\n" % answer)
