...
// InterpRenderer from the layer-4 term of sll_gpr_gpr_gpr_64__reg_a0__dart.
// The term's layer-5 text, LITERAL:
//   v0 << Concat(0, Extract(5, 0, v1))
int emu_sll_gpr_gpr_gpr_64__reg_a0__dart(int a, int b) {
  return m(shl(a, cat(0, ext(b, 5, 0), 6), 64), 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_sll_gpr_gpr_gpr_64__reg_a0__dart(values[0], values[1]);
