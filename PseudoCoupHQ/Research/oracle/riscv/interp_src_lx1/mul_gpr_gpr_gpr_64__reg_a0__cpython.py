...
# InterpRenderer from the layer-4 term of mul_gpr_gpr_gpr_64__reg_a0__cpython.
# The term's layer-5 text, LITERAL:
#   v0*v1
def emu_mul_gpr_gpr_gpr_64__reg_a0__cpython(a, b):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_mul_gpr_gpr_gpr_64__reg_a0__cpython(*values)
            sys.stdout.write("%d\n" % answer)
