# CHECK — 0_2_0_0_rust_llvm

Node `pir.rust_llvm`. Status `draft`.
...
- [ ] `node_0_2_0_0_0_transpile` — see its own CHECK
- [ ] `node_0_2_0_0_1_slice` — see its own CHECK
- [ ] `node_0_2_0_0_2_insert` — see its own CHECK
