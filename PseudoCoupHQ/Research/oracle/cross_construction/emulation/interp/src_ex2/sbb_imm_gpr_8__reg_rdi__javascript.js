...
// InterpRenderer from the layer-4 term of sbb_imm_gpr_8__reg_rdi__javascript.
...
function emu_sbb_imm_gpr_8__reg_rdi__javascript(a, b, c, d) {
    return m(cat(0n, add(add(mul(d, 255n, 8), mul(((eq(ext(add(cat(0n, b, 8), cat(0n, a, 8), 9), 8, 8), 1n, 1)) ? (1n) : (0n)), 255n, 8), 8), c, 8), 8), 64);
}
