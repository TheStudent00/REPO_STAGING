...
// GoRenderer from the layer-4 term of and_cl_gpr_8__flags__go.
// The term's layer-5 text, LITERAL:
//   Concat(~(~Extract(7, 0, v0) | ~Extract(7, 0, v1)), 0)
package main

//go:noinline
func emu_and_cl_gpr_8__flags__go(a uint8, b uint8) uint16 {
...
func main() {
	sink = emu_and_cl_gpr_8__flags__go(g0, g1)
	_ = sink
}
