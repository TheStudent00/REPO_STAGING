...
public class Emu {
    ...
    // InterpRenderer from the layer-4 term of idiv_gpr_one_16__reg_rax__java.
    ...
    static long emu_idiv_gpr_one_16__reg_rax__java(long a, long b, long c) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_idiv_gpr_one_16__reg_rax__java(values[0], values[1], values[2])));
                    answers.append("\n");
