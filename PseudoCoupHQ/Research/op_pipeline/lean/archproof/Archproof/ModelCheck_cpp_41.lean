...
/-- cpp single-opcode row 41, arch mnemonic 'mov', example unit cpp/regen_544, 6 members
...
theorem ModelCheck_cpp_41  :
    (2#32)
  = (model_mov_26.extractLsb 31 0) := by
  rfl

#print axioms ModelCheck_cpp_41
