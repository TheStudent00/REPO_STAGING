...
// InterpRenderer from the layer-4 term of movsbl_widen_gpr_gpr_32__reg_rdi__javascript.
...
function emu_movsbl_widen_gpr_gpr_32__reg_rdi__javascript(a) {
    return m(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(0n, ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), a, 8), 64);
}
