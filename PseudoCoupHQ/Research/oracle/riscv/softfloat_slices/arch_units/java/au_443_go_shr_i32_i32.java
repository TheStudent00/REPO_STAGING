...
public final class au_443_go_shr_i32_i32 {

    public static long au_443_go_shr_i32_i32(long p0, long p1) {
        ...
        final long v4 = AuInt.au_sll(v2, 0x20L);
        final long v5 = AuInt.au_srl(v4, 0x20L);
        final long v6 = AuInt.au_sltu(v5, 0x20L);
        final long v7 = AuInt.au_add(v6, 0xffffffffffffffffL);
        final long v8 = AuInt.au_or(v2, v7);
        final long v9 = AuInt.au_sraw(v1, v8);
        // the answer is int32, 32 bits
        return ((v9) & 0xffffffffL);
    }

    public static long au_443_go_shr_i32_i32_trap(long p0, long p1) {
        // a0: operand `a` (int32) sign-extended to XLEN, as the ABI presents it
        final long v1 = AuInt.au_sext32(p0);
        // a1: operand `b` (int32) sign-extended to XLEN, as the ABI presents it
        final long v2 = AuInt.au_sext32(p1);
