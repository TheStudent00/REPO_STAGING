...
// one named local per gate, over the term of setl_gpr_one_8__reg_rdi__javascript.
...
function emu_setl_gpr_one_8__reg_rdi__javascript(a, b, c) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_setl_gpr_one_8__reg_rdi__javascript(...values).toString());
    } catch (problem) {
