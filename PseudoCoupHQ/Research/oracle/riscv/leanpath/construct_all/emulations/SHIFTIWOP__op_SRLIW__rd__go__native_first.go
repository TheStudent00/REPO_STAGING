...
// intermediate per node of the term of SHIFTIWOP__op_SRLIW__rd__go__native_first.
//   
package main

//go:noinline
func emu_SHIFTIWOP__op_SRLIW__rd__go__native_first(a uint32, b uint8) uint64 {
...
func main() {
	sink = emu_SHIFTIWOP__op_SRLIW__rd__go__native_first(g0, g1)
	_ = sink
}
