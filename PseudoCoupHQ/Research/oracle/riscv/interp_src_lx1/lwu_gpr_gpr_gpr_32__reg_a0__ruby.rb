...
# InterpRenderer from the layer-4 term of lwu_gpr_gpr_gpr_32__reg_a0__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(0, Extract(31, 0, v0))
def emu_lwu_gpr_gpr_gpr_32__reg_a0__ruby(a)
  m(cat(0, a, 32), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_lwu_gpr_gpr_gpr_32__reg_a0__ruby(*values)
