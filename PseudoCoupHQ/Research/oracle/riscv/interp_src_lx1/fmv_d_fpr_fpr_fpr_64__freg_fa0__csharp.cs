...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of fmv_d_fpr_fpr_fpr_64__freg_fa0__csharp.
    // The term's layer-5 text, LITERAL:
    //   v0
    public static long emu_fmv_d_fpr_fpr_fpr_64__freg_fa0__csharp(long a) {
        return m(a, 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_fmv_d_fpr_fpr_fpr_64__freg_fa0__csharp(values[0])).ToString());
                    answers.Append("\n");
