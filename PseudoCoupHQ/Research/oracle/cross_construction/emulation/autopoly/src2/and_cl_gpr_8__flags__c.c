/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of and_cl_gpr_8__flags__c.  The term's layer-5 text, LITERAL:
   Concat(~(~Extract(7, 0, v0) | ~Extract(7, 0, v1)), 0) */
#include <stdint.h>

uint16_t
emu_and_cl_gpr_8__flags__c(uint8_t a, uint8_t b)
{
