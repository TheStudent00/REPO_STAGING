...
// intermediate per node of the term of ZBA_RTYPE__one__rd__rust__all_constructed.
//   
#[no_mangle]
pub extern "C" fn emu_ZBA_RTYPE__one__rd__rust__all_constructed(a: u64, b: u8, c: u64) -> u64
{
    ...
    let v90: u64 = ((((v89) as u64) & (((c as u64)) as u64)) as u64);
    let v91: u64 = ((((v90) as u64).wrapping_shl((((0x1u64) as u64) as u32))) as u64);
    let v92: u64 = ((((v89) as u64) ^ (((c as u64)) as u64)) as u64);
    let v93: u64 = ((((v92) as u64) & ((v91) as u64)) as u64);
    let v94: u64 = ((((v90) as u64) | ((v93) as u64)) as u64);
    let v95: u64 = ((((v94) as u64).wrapping_shl((((0x2u64) as u64) as u32))) as u64);
    let v96: u64 = ((((v92) as u64).wrapping_shl((((0x1u64) as u64) as u32))) as u64);
    let v97: u64 = ((((v92) as u64) & ((v96) as u64)) as u64);
    let v98: u64 = ((((v97) as u64) & ((v95) as u64)) as u64);
    let v99: u64 = ((((v94) as u64) | ((v98) as u64)) as u64);
    let v100: u64 = ((((v99) as u64).wrapping_shl((((0x4u64) as u64) as u32))) as u64);
    let v101: u64 = ((((v97) as u64).wrapping_shl((((0x2u64) as u64) as u32))) as u64);
    let v102: u64 = ((((v97) as u64) & ((v101) as u64)) as u64);
    let v103: u64 = ((((v102) as u64) & ((v100) as u64)) as u64);
    let v104: u64 = ((((v99) as u64) | ((v103) as u64)) as u64);
    let v105: u64 = ((((v104) as u64).wrapping_shl((((0x8u64) as u64) as u32))) as u64);
    let v106: u64 = ((((v102) as u64).wrapping_shl((((0x4u64) as u64) as u32))) as u64);
    let v107: u64 = ((((v102) as u64) & ((v106) as u64)) as u64);
    let v108: u64 = ((((v107) as u64) & ((v105) as u64)) as u64);
    let v109: u64 = ((((v104) as u64) | ((v108) as u64)) as u64);
    let v110: u64 = ((((v109) as u64).wrapping_shl((((0x10u64) as u64) as u32))) as u64);
    let v111: u64 = ((((v107) as u64).wrapping_shl((((0x8u64) as u64) as u32))) as u64);
    let v112: u64 = ((((v107) as u64) & ((v111) as u64)) as u64);
    let v113: u64 = ((((v112) as u64) & ((v110) as u64)) as u64);
    let v114: u64 = ((((v109) as u64) | ((v113) as u64)) as u64);
    let v115: u64 = ((((v114) as u64).wrapping_shl((((0x20u64) as u64) as u32))) as u64);
    let v116: u64 = ((((v112) as u64).wrapping_shl((((0x10u64) as u64) as u32))) as u64);
    let v117: u64 = ((((v112) as u64) & ((v116) as u64)) as u64);
    let v118: u64 = ((((v117) as u64) & ((v115) as u64)) as u64);
    let v119: u64 = ((((v114) as u64) | ((v118) as u64)) as u64);
    let v120: u64 = ((((v119) as u64).wrapping_shl((((0x1u64) as u64) as u32))) as u64);
    let v121: u64 = ((((v92) as u64) ^ ((v120) as u64)) as u64);
    ((v121) as u64)
}
