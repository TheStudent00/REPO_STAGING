---
id: hq.research.lean_proof_path_resistant_to_churn.arch_unit.compose.check
---

# CHECK — 0_3_3_3_2_compose

Node `hq.research.lean_proof_path_resistant_to_churn.arch_unit.compose`. Status `draft`.
