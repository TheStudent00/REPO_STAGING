/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of E01736__swift_regen_1988.  The term's layer-5 text, LITERAL:
   If(Or(Not(Extract(63, 6, v0) == 0), ULE(32, Extract(5, 0, v0))), 0, Extract(31, 0, v1) << Concat(0, Extract(4, 0, v0))) */
#include <stdint.h>

uint32_t
emu_E01736__swift_regen_1988(uint32_t a, uint64_t b)
{
