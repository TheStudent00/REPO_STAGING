/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of setge_gpr_one_8__reg_rdi__cpp__native_first.  The term's text, LITERAL:
...
extern "C"
uint64_t
emu_setge_gpr_one_8__reg_rdi__cpp__native_first(uint8_t a, uint8_t b, uint64_t c)
{
    ...
    uint32_t v11 = ((v10) ? (uint32_t)(UINT32_C(0x0)) : (uint32_t)(UINT32_C(0x1)));
