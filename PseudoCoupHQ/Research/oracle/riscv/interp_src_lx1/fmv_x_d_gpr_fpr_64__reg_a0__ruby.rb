...
# InterpRenderer from the layer-4 term of fmv_x_d_gpr_fpr_64__reg_a0__ruby.
# The term's layer-5 text, LITERAL:
#   v0
def emu_fmv_x_d_gpr_fpr_64__reg_a0__ruby(a)
  m(a, 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_fmv_x_d_gpr_fpr_64__reg_a0__ruby(*values)
