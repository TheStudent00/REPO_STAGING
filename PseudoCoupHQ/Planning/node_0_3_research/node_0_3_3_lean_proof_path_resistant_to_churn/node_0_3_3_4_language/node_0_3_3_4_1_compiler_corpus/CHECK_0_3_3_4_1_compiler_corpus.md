---
id: hq.research.lean_proof_path_resistant_to_churn.language.compiler_corpus.check
---

# CHECK — 0_3_3_4_1_compiler_corpus

Node `hq.research.lean_proof_path_resistant_to_churn.language.compiler_corpus`. Status `draft`.
