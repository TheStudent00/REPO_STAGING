...
# InterpRenderer from the layer-4 term of lb_gpr_gpr_imm_8__reg_a0__ruby.
...
def emu_lb_gpr_gpr_imm_8__reg_a0__ruby(a)
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_lb_gpr_gpr_imm_8__reg_a0__ruby(*values)
