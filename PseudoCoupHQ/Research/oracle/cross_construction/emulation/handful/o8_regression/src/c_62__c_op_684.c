/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of c_62__c_op_684.  The term's layer-5 text, LITERAL:
   v0 << Concat(0, Extract(5, 0, v1)) */
#include <stdint.h>

uint64_t
emu_c_62__c_op_684(uint64_t a, uint8_t b)
{
