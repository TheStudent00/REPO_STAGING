/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of rust_5__rust_op_663.  The term's layer-5 text, LITERAL:
...
float
emu_rust_5__rust_op_663(double a, float b)
{
