...
public class Emu {
    ...
    // InterpRenderer from the layer-4 term of add_gpr_gpr_32__reg_rdi__java.
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    out.append(Long.toUnsignedString(emu_add_gpr_gpr_32__reg_rdi__java(values[0], values[1])));
                    out.append("\n");
