---
id: hq.research.arch_unit_oracle.simplification.learned_proposal.check
---

# CHECK — 0_3_2_4_4_learned_proposal

Node `hq.research.arch_unit_oracle.simplification.learned_proposal`. Status `draft`.
