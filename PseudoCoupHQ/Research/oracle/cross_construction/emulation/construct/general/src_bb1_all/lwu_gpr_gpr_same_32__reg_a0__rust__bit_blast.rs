...
// intermediate per node of the term of lwu_gpr_gpr_same_32__reg_a0__rust__bit_blast.
//   Concat(0, Extract(31, 0, v0))
#[no_mangle]
pub extern "C" fn emu_lwu_gpr_gpr_same_32__reg_a0__rust__bit_blast(a: u32) -> u64
{
