...
// InterpRenderer from the layer-4 term of fdiv_s_fpr_fpr_fpr_32__freg_fa0__dart.
// The term's layer-5 text, LITERAL:
//   Concat(4294967295, fp.to_ieee_bv(fpToFP(Extract(31, 0, v0)) / fpToFP(Extract(31, 0, v1))))
int emu_fdiv_s_fpr_fpr_fpr_32__freg_fa0__dart(int a, int b) {
  return m(cat(4294967295, fdiv(a, b, 32), 32), 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_fdiv_s_fpr_fpr_fpr_32__freg_fa0__dart(values[0], values[1]);
