...
/-- cpp single-opcode row 39, arch mnemonic 'mov', example unit cpp/op_61, 10 members
...
theorem ModelCheck_cpp_39  :
    (8#32)
  = (model_mov_24.extractLsb 31 0) := by
  rfl

#print axioms ModelCheck_cpp_39
