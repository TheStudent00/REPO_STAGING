...
# InterpRenderer from the layer-4 term of fmv_x_d_gpr_fpr_fpr_64__reg_a0__cpython.
# The term's layer-5 text, LITERAL:
#   v0
def emu_fmv_x_d_gpr_fpr_fpr_64__reg_a0__cpython(a):
    return m(a, 64)
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_fmv_x_d_gpr_fpr_fpr_64__reg_a0__cpython(*values)
            sys.stdout.write("%d\n" % answer)
