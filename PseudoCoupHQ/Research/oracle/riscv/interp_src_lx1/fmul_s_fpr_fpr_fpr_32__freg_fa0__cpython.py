...
# InterpRenderer from the layer-4 term of fmul_s_fpr_fpr_fpr_32__freg_fa0__cpython.
# The term's layer-5 text, LITERAL:
#   Concat(4294967295, fp.to_ieee_bv(fpToFP(Extract(31, 0, v0)) * fpToFP(Extract(31, 0, v1))))
def emu_fmul_s_fpr_fpr_fpr_32__freg_fa0__cpython(a, b):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_fmul_s_fpr_fpr_fpr_32__freg_fa0__cpython(*values)
            sys.stdout.write("%d\n" % answer)
