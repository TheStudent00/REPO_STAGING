#!/bin/bash
# lp3_l108_the_undecided_thirtyfive_with_the_bridge.sh
#
...
G1=$A/runs/gate_bridge; mkdir -p $G1
t0=$(date +%s)
...
G0, G1 = A + "/runs/gate_classes", A + "/runs/gate_bridge"
...
for u in want:
    ...
    emit, names = bridge_for(P, PLIB, closure)
