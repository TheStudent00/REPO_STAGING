...
/-- c single-opcode row 76, arch mnemonic 'xor', example unit c/op_397, 44 members
...
theorem ModelCheck_c_76 (v0 : BitVec 64) (v1 : BitVec 64) :
    (v0 ^^^ v1)
  = (model_xor_49 (model_mov_22 v0) v1) := by
  rfl

#print axioms ModelCheck_c_76
