/* task ex1 emulation -- rendered by cpp_render.py CppRenderer from the layer-4 term of andps_xmm_xmm_128__reg_xmm0_low__cpp.  The term's layer-5 text, LITERAL:
...
extern "C"
double
emu_andps_xmm_xmm_128__reg_xmm0_low__cpp(double a, double b)
{
