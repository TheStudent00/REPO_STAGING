...
# InterpRenderer from the layer-4 term of cmovb_gpr_gpr_64__reg_rdi__ruby.
# The term's layer-5 text, LITERAL:
#   If(ULE(v0, v1), v2, v3)
def emu_cmovb_gpr_gpr_64__reg_rdi__ruby(a, b, c, d)
  m(((ule(b, a, 64)) ? (d) : (c)), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_cmovb_gpr_gpr_64__reg_rdi__ruby(*values)
