...
// InterpRenderer from the layer-4 term of mov_imm_gpr_32__reg_rdi__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(0, Extract(31, 0, v0))
function emu_mov_imm_gpr_32__reg_rdi__javascript(a) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_mov_imm_gpr_32__reg_rdi__javascript(...values).toString());
    } catch (problem) {
