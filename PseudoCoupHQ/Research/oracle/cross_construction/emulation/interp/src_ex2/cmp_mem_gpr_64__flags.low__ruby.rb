...
# InterpRenderer from the layer-4 term of cmp_mem_gpr_64__flags.low__ruby.
# The term's layer-5 text, LITERAL:
#   v0
def emu_cmp_mem_gpr_64__flags.low__ruby(a)
  m(a, 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_cmp_mem_gpr_64__flags.low__ruby(*values)
