...
# InterpRenderer from the layer-4 term of push_gpr_one_64__stack_-8__cpython.
# The term's layer-5 text, LITERAL:
#   v0
def emu_push_gpr_one_64__stack_-8__cpython(a):
    return m(a, 64)
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_push_gpr_one_64__stack_-8__cpython(*values)
            sys.stdout.write("%d\n" % answer)
