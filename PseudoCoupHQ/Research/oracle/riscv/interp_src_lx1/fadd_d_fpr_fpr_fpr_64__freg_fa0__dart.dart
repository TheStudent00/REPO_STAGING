...
// InterpRenderer from the layer-4 term of fadd_d_fpr_fpr_fpr_64__freg_fa0__dart.
// The term's layer-5 text, LITERAL:
//   fp.to_ieee_bv(fpToFP(v0) + fpToFP(v1))
int emu_fadd_d_fpr_fpr_fpr_64__freg_fa0__dart(int a, int b) {
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_fadd_d_fpr_fpr_fpr_64__freg_fa0__dart(values[0], values[1]);
