...
Raw data: `~/Programming/PseudoCoupHQ/Research/kind_signature_clustering/raw/`.
Re-runnable measurement script: `~/Programming/PseudoCoupHQ/Research/kind_signature_clustering/survey.py`.
