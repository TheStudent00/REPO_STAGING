...
theorem meaning_SHIFTIOP__op_SRLI__rd__rust__all_constructed (s : St) (a : BitVec 64) (b : BitVec 64) (h10 : s.regs.get? .x10 = some a) (h11 : s.regs.get? .x11 = some b) (hk0 : ∀ {α : Type} (x0 : α) (s : St), (plat_term_write x0) s = EStateM.Result.ok () s) (hk1 : ∀ (x0 : Arch.pa) (x1 : Nat) (s : St), (load_reservation x0 x1) s = EStateM.Result.ok () s) (hk2 : ∀ (x0 : Unit) (s : St), (cancel_reservation x0) s = EStateM.Result.ok () s) :
    runsTo (walk [LeanIM.instruction.ITYPE (0x001#12, LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0c#5, LeanIM.iop.ANDI), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0c#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.rop.SRL), LeanIM.instruction.ITYPE (0x002#12, LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0c#5, LeanIM.iop.ANDI), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0c#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.rop.SRL), LeanIM.instruction.ITYPE (0x004#12, LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0c#5, LeanIM.iop.ANDI), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0c#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.rop.SRL), LeanIM.instruction.ITYPE (0x008#12, LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0c#5, LeanIM.iop.ANDI), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0c#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.rop.SRL), LeanIM.instruction.ITYPE (0x010#12, LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0c#5, LeanIM.iop.ANDI), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0c#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.rop.SRL), LeanIM.instruction.ITYPE (0x020#12, LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0b#5, LeanIM.iop.ANDI), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.rop.SRL)]) s
      ((pure_RTYPE ((pure_RTYPE ((pure_RTYPE ((pure_RTYPE ((pure_RTYPE ((pure_RTYPE (a) ((pure_ITYPE (b) (0x001#12) (LeanIM.iop.ANDI))) (LeanIM.rop.SRL))) ((pure_ITYPE (b) (0x002#12) (LeanIM.iop.ANDI))) (LeanIM.rop.SRL))) ((pure_ITYPE (b) (0x004#12) (LeanIM.iop.ANDI))) (LeanIM.rop.SRL))) ((pure_ITYPE (b) (0x008#12) (LeanIM.iop.ANDI))) (LeanIM.rop.SRL))) ((pure_ITYPE (b) (0x010#12) (LeanIM.iop.ANDI))) (LeanIM.rop.SRL))) ((pure_ITYPE (b) (0x020#12) (LeanIM.iop.ANDI))) (LeanIM.rop.SRL))) := by
  simp (config := {decide := true}) [runsTo, walk, step, execute, strip_ITYPE, strip_RTYPE,
