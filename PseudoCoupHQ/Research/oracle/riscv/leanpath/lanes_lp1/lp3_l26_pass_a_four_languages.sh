#!/bin/bash
# lp3_l26_pass_a_four_languages.sh -- pass A over the rendered corpus in
...
export WALK_JOBS=4; W=$A/walk_handful_all_v9; start=$(date +%s)
...
start=$(date +%s); E=$A/equals_handful_all_v9
