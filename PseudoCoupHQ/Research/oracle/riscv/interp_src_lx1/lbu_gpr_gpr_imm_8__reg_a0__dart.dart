...
// InterpRenderer from the layer-4 term of lbu_gpr_gpr_imm_8__reg_a0__dart.
// The term's layer-5 text, LITERAL:
//   Concat(0, Extract(7, 0, v0))
int emu_lbu_gpr_gpr_imm_8__reg_a0__dart(int a) {
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_lbu_gpr_gpr_imm_8__reg_a0__dart(values[0]);
