...
# one named local per gate, over the term of xor_gpr_same_32__reg_rdi__ruby.
# The term's layer-5 text, LITERAL:
#   0
def emu_xor_gpr_same_32__reg_rdi__ruby(a)
  k0 = 0
  w0 = k0
  w1 = cat(w0, k0, 1)
  w2 = cat(w1, k0, 1)
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_xor_gpr_same_32__reg_rdi__ruby(*values)
