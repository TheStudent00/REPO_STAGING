...
/-- cpp single-opcode row 58, arch mnemonic 'sar', example unit cpp/op_721, 34 members
...
theorem ModelCheck_cpp_58 (v0 : BitVec 64) (v1 : BitVec 64) :
    (v0.sshiftRight' ((0#58) ++ (v1.extractLsb 5 0)))
  = (model_sar_11 (model_mov_20 v0) (model_mov_20 v1)) := by
  simp only [model_mov_20, model_sar_11]
  bv_decide

#print axioms ModelCheck_cpp_58
