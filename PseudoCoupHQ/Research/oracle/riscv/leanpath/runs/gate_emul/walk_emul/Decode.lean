...
#eval IO.println ("emul_au_182_c_pos_i32#1\t" ++ ((match (encdec_compressed_backwards (0x8082#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_205_c_alignof_gnu2_u64#0\t" ++ ((match (encdec_compressed_backwards (0x4521#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_252_c_add_bool_i64#0\t" ++ ((match (encdec_compressed_backwards (0x8905#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_252_c_add_bool_i64#1\t" ++ ((match (encdec_compressed_backwards (0x952e#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
...
#eval IO.println ("emul_au_281_c_div_i32_u64#2\t" ++ ((match (encdec_compressed_backwards (0x4501#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_281_c_div_i32_u64#3\t" ++ ((match (encdec_compressed_backwards (0x4781#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
...
#eval IO.println ("emul_au_281_c_div_i32_u64#5\t" ++ ((match (encdec_backwards (0x03f00693#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_281_c_div_i32_u64#6\t" ++ ((match (encdec_compressed_backwards (0x587d#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_281_c_div_i32_u64#7\t" ++ ((match (encdec_backwards (0x00d8d733#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_281_c_div_i32_u64#8\t" ++ ((match (encdec_backwards (0x0007a293#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_281_c_div_i32_u64#9\t" ++ ((match (encdec_backwards (0x28d01333#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_281_c_div_i32_u64#10\t" ++ ((match (encdec_compressed_backwards (0x16fd#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_281_c_div_i32_u64#11\t" ++ ((match (encdec_compressed_backwards (0x8b05#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_281_c_div_i32_u64#12\t" ++ ((match (encdec_backwards (0x20e7a733#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_281_c_div_i32_u64#13\t" ++ ((match (encdec_backwards (0x00b737b3#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_281_c_div_i32_u64#14\t" ++ ((match (encdec_backwards (0x4057f7b3#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_281_c_div_i32_u64#15\t" ++ ((match (encdec_backwards (0x0ef5f633#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_281_c_div_i32_u64#16\t" ++ ((match (encdec_backwards (0x0ef372b3#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_281_c_div_i32_u64#17\t" ++ ((match (encdec_backwards (0x40c707b3#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_281_c_div_i32_u64#18\t" ++ ((match (encdec_backwards (0x00a2e533#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_281_c_div_i32_u64#19\t" ++ ((match (encdec_backwards (0xfd069ae3#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_281_c_div_i32_u64#21\t" ++ ((match (encdec_compressed_backwards (0x557d#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_344_c_bor_i32_i64#0\t" ++ ((match (encdec_compressed_backwards (0x2501#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_344_c_bor_i32_i64#1\t" ++ ((match (encdec_compressed_backwards (0x8d4d#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_372_c_bxor_bool_i64#1\t" ++ ((match (encdec_compressed_backwards (0x8d2d#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_452_go_band_i32_i32#0\t" ++ ((match (encdec_compressed_backwards (0x8d6d#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_319_c_lor_u64_i32#0\t" ++ ((match (encdec_compressed_backwards (0x2581#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_319_c_lor_u64_i32#2\t" ++ ((match (encdec_backwards (0x00a03533#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_445_go_shr_i32_u64#0\t" ++ ((match (encdec_compressed_backwards (0x467d#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_445_go_shr_i32_u64#1\t" ++ ((match (encdec_backwards (0x0ac5d5b3#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_445_go_shr_i32_u64#2\t" ++ ((match (encdec_backwards (0x0805063b#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_445_go_shr_i32_u64#3\t" ++ ((match (encdec_backwards (0x41f5551b#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_445_go_shr_i32_u64#4\t" ++ ((match (encdec_backwards (0x00b65633#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_445_go_shr_i32_u64#5\t" ++ ((match (encdec_backwards (0x01f5c593#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_445_go_shr_i32_u64#6\t" ++ ((match (encdec_backwards (0x00b51533#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_445_go_shr_i32_u64#7\t" ++ ((match (encdec_compressed_backwards (0x1506#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_445_go_shr_i32_u64#8\t" ++ ((match (encdec_compressed_backwards (0x9101#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_445_go_shr_i32_u64#9\t" ++ ((match (encdec_compressed_backwards (0x8d51#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_449_go_shr_u64_i32#0\t" ++ ((match (encdec_backwards (0x0065d61b#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_449_go_shr_u64_i32#1\t" ++ ((match (encdec_compressed_backwards (0x061a#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_449_go_shr_u64_i32#2\t" ++ ((match (encdec_backwards (0x00b55533#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("emul_au_449_go_shr_u64_i32#3\t" ++ ((match (encdec_backwards (0x0ec57533#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
