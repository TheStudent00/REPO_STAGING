#!/usr/bin/env bash
# ap5_l19_guard_t100_edges_c.sh -- task ap5: the FOURTH guard the brief
...
# THE SECOND PASS, for the same reason ap5_l17 and ap5_l18 have one:
# `align_by_row`'s new branch was widened after ap5_l14 ran, so the
# tally of record is this one.
set -euo pipefail
