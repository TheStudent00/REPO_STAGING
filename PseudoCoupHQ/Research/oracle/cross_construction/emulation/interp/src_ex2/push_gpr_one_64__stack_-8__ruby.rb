...
# InterpRenderer from the layer-4 term of push_gpr_one_64__stack_-8__ruby.
# The term's layer-5 text, LITERAL:
#   v0
def emu_push_gpr_one_64__stack_-8__ruby(a)
  m(a, 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_push_gpr_one_64__stack_-8__ruby(*values)
