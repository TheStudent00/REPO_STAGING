/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of SHIFTIWOP__op_SRLIW__rd__cpp__native_first.  The term's text, LITERAL:
    */
#include <cstdint>

extern "C"
uint64_t
emu_SHIFTIWOP__op_SRLIW__rd__cpp__native_first(uint32_t a, uint8_t b)
{
