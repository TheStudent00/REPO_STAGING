...
# InterpRenderer from the layer-4 term of lea_lea_mem_32__reg_rdi__ruby.
# The term's layer-5 text, LITERAL:
#   v0 + v1
def emu_lea_lea_mem_32__reg_rdi__ruby(a, b)
  m(add(b, a, 64), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_lea_lea_mem_32__reg_rdi__ruby(*values)
