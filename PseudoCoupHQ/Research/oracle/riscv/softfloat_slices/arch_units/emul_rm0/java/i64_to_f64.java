...
public final class i64_to_f64 {
    public static long i64_to_f64_rm0(long v_arg) {
        ...
        final int v_i30 = (int)(v_i29 & 0xffffL);
        final int v_i31 = (v_i30 & 0x3ff);
        final long v_i32 = (v_i29 + 0x200L);
        final long v__sh18 = (v_i32 >>> (int)(0xaL & 63L));
        final boolean v_i35 = (v_i31 == 0x200);
        final long v_i36 = Sf.b2l(v_i35);
        final long v_i37 = (v_i36 ^ 0xffffffffffffffffL);
        final long v_i38 = (v__sh18 & v_i37);
        final boolean v_i39 = (v_i38 == 0x0L);
        final long v__m20 = Sf.sext1l(v_i39);
        final long v__n21 = (v__m20 ^ 0xffffffffffffffffL);
        final long v_i43 = (v_i21 & v__n21);
        final long v_i44 = (v_i38 | v_i20);
        final long v_i45 = (v_i44 + v_i43);
        ...
        final long v__a31 = (v_i45 & v__m30);
