...
// intermediate per node of the term of idiv_gpr_one_32__reg_rdx__rust__native_first.
...
#[no_mangle]
pub extern "C" fn emu_idiv_gpr_one_32__reg_rdx__rust__native_first(a: u32, b: u32, c: u32) -> u64
{
    let v0: u32 = (c as u32);
