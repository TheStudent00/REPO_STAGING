...
// InterpRenderer from the layer-4 term of sbb_imm_gpr_8__reg_rdi__dart.
...
int emu_sbb_imm_gpr_8__reg_rdi__dart(int a, int b, int c, int d) {
  return m(cat(0, add(add(mul(d, 255, 8), mul(((eq(ext(add(cat(0, b, 8), cat(0, a, 8), 9), 8, 8), 1, 1)) ? (1) : (0)), 255, 8), 8), c, 8), 8), 64);
}
