...
// intermediate per node of the term of lui_gpr_imm_32__reg_a0__go__bit_blast.
//   12288
package main

//go:noinline
func emu_lui_gpr_imm_32__reg_a0__go__bit_blast() uint64 {
	var k0 uint64 = 0
	var k1 uint64 = 1
	var w0 uint64 = (k0 << 0)
	...
	var w12 uint64 = w11 | (k1 << 12)
	var w13 uint64 = w12 | (k1 << 13)
...
func main() {
	sink = emu_lui_gpr_imm_32__reg_a0__go__bit_blast()
	_ = sink
}
