...
theorem sllw_gpr_gpr_gpr_32__reg_a0__c__all_constructed_12_integer_level (a : BitVec 64) (b : BitVec 64) :
  ...
  try simp only [pure_ZBA_RTYPEUW, pure_SHIFTIWOP, pure_SHIFTIOP, pure_RTYPEW, pure_RTYPE, pure_ITYPE, pure_ZBA_RTYPE, pure_RTYPEW, shift_bits_right_arith, sign_extend, Sail.BitVec.signExtend]
  grind
