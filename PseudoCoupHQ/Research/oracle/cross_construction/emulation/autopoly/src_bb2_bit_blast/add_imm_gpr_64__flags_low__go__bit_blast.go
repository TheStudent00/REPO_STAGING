...
// intermediate per node of the term of add_imm_gpr_64__flags_low__go__bit_blast.
//   v0
package main

//go:noinline
func emu_add_imm_gpr_64__flags_low__go__bit_blast(a uint64) uint64 {
...
func main() {
	sink = emu_add_imm_gpr_64__flags_low__go__bit_blast(g0)
	_ = sink
}
