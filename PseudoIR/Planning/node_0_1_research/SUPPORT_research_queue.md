...
- **R1 — intentions-data verification: COMPLETE (2026-07-28).**
  ...
  Report: `../../Research/r1_intentions_validation/REPORT.md` (`<WORKSPACE_DIR>/PseudoCoup_v6/Research/r1_intentions_validation/REPORT.md`).
...
- **R3 — harvest verification in place: COMPLETE (2026-07-28).**
  ...
  `../../Research/r3_harvest_verification/REPORT.md` (`<WORKSPACE_DIR>/PseudoCoup_v6/Research/r3_harvest_verification/REPORT.md`).
- **R4 — runtime-ledger/walker survey: COMPLETE (2026-07-28).**
  ...
  Report: `../../Research/r4_runtime_ledger_survey/REPORT.md` (`<WORKSPACE_DIR>/PseudoCoup_v6/Research/r4_runtime_ledger_survey/REPORT.md`).

## where those references went

- T5's work list — `<WORKSPACE_DIR>/PseudoIR/Planning/node_0_1_research/node_0_1_0_intentions/SUPPORT_intentions_data_shape.md`
