...
// intermediate per node of the term of and_cl_gpr_8__reg_rdi__swift__all_constructed.
//   Concat(Extract(63, 8, v1), ~(~Extract(7, 0, v0) | ~Extract(7, 0, v1)))
@_cdecl("emu_and_cl_gpr_8__reg_rdi__swift__all_constructed")
public func emu_and_cl_gpr_8__reg_rdi__swift__all_constructed(_ a: UInt64, _ b: UInt8) -> UInt64
{
