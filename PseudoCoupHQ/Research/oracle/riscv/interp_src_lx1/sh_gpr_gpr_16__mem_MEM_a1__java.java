...
public class Emu {
    ...
    // InterpRenderer from the layer-4 term of sh_gpr_gpr_16__mem_MEM_a1__java.
    // The term's layer-5 text, LITERAL:
    //   Concat(Extract(63, 16, v0), Extract(15, 0, v1))
    static long emu_sh_gpr_gpr_16__mem_MEM_a1__java(long a, long b) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_sh_gpr_gpr_16__mem_MEM_a1__java(values[0], values[1])));
                    answers.append("\n");
