/* task ex1 emulation -- rendered by cpp_render.py CppRenderer from the layer-4 term of and_cl_gpr_8__flags__cpp.  The term's layer-5 text, LITERAL:
   Concat(~(~Extract(7, 0, v0) | ~Extract(7, 0, v1)), 0) */
#include <cstdint>

extern "C"
uint16_t
emu_and_cl_gpr_8__flags__cpp(uint8_t a, uint8_t b)
{
