...
theorem c_op_498__MULW_25_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (zero_reg) ((pure_RTYPE (a) (b) (XOR))) (LeanIM.rop.SLTU))) = (pure_MULW (a) (b) ) := by
  try simp only [pure_RTYPE, pure_MULW, bool_to_bit, log2_xlen, shift_bits_right_arith, sign_extend, to_bits_truncate, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend]
  grind
