...
// intermediate per node of the term of setl_gpr_one_8__reg_rdi__go__bit_blast.
...
//go:noinline
func emu_setl_gpr_one_8__reg_rdi__go__bit_blast(a uint8, b uint8, c uint64) uint64 {
...
func main() {
	sink = emu_setl_gpr_one_8__reg_rdi__go__bit_blast(g0, g1, g2)
	_ = sink
}
