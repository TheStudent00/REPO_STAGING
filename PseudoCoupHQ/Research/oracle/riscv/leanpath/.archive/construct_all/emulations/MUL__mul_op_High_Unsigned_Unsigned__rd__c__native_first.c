/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of MUL__mul_op_High_Unsigned_Unsigned__rd__c__native_first.  The term's text, LITERAL:
    */
#include <stdint.h>

uint64_t
emu_MUL__mul_op_High_Unsigned_Unsigned__rd__c__native_first(uint64_t a, uint64_t b)
{
