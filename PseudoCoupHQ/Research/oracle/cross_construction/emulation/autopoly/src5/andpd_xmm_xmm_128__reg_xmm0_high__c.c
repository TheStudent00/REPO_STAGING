/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of andpd_xmm_xmm_128__reg_xmm0_high__c.  The term's layer-5 text, LITERAL:
   ~(~v0 | ~v1) */
#include <stdint.h>
#include <string.h>
...
double
emu_andpd_xmm_xmm_128__reg_xmm0_high__c(uint64_t a, uint64_t b)
{
