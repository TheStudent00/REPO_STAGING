...
theorem c_op_498__ZBB_RTYPEW_44_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (zero_reg) ((pure_RTYPE (a) (b) (XOR))) (LeanIM.rop.SLTU))) = (pure_ZBB_RTYPEW (a) (b) (bropw_zbb.ROLW)) := by
  try simp only [pure_RTYPE, pure_ZBB_RTYPEW, bool_to_bit, log2_xlen, rotate_bits_left, rotate_bits_right, shift_bits_right_arith, sign_extend, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, rotatel, rotater, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend, Sail.BitVec.length]
  grind
