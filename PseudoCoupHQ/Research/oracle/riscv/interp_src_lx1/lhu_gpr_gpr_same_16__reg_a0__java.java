...
public class Emu {
    ...
    // InterpRenderer from the layer-4 term of lhu_gpr_gpr_same_16__reg_a0__java.
    // The term's layer-5 text, LITERAL:
    //   Concat(0, Extract(15, 0, v0))
    static long emu_lhu_gpr_gpr_same_16__reg_a0__java(long a) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_lhu_gpr_gpr_same_16__reg_a0__java(values[0])));
                    answers.append("\n");
