...
// intermediate per node of the term of and_gpr_gpr_8__reg_rdi__swift__native_first.
//   Concat(Extract(63, 8, v0), ~(~Extract(7, 0, v0) | ~Extract(7, 0, v1)))
@_cdecl("emu_and_gpr_gpr_8__reg_rdi__swift__native_first")
public func emu_and_gpr_gpr_8__reg_rdi__swift__native_first(_ a: UInt64, _ b: UInt8) -> UInt64
{
