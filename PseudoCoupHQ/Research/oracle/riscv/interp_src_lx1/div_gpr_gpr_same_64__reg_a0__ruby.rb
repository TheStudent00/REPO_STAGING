...
# InterpRenderer from the layer-4 term of div_gpr_gpr_same_64__reg_a0__ruby.
...
def emu_div_gpr_gpr_same_64__reg_a0__ruby(a)
  m(((eq(a, 0, 64)) ? (18446744073709551615) : (((((eq(a, 18446744073709551615, 64)) && (eq(a, 9223372036854775808, 64)))) ? (9223372036854775808) : (sdiv(a, a, 64))))), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_div_gpr_gpr_same_64__reg_a0__ruby(*values)
