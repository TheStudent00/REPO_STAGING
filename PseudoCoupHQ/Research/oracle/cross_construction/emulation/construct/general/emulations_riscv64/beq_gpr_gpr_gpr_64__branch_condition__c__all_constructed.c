/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of beq_gpr_gpr_gpr_64__branch_condition__c__all_constructed.  The term's text, LITERAL:
   If(v0 == v1, 1, 0) */
#include <stdint.h>

uint64_t
emu_beq_gpr_gpr_gpr_64__branch_condition__c__all_constructed(uint64_t a, uint64_t b)
{
