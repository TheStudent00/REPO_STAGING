...
# InterpRenderer from the layer-4 term of movslq_widen_gpr_gpr_64__reg_rdi__cpython.
...
def emu_movslq_widen_gpr_gpr_64__reg_rdi__cpython(a):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_movslq_widen_gpr_gpr_64__reg_rdi__cpython(*values)
            sys.stdout.write("%d\n" % answer)
