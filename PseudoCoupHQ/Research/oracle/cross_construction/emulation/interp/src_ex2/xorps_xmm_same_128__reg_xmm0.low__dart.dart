...
// InterpRenderer from the layer-4 term of xorps_xmm_same_128__reg_xmm0.low__dart.
// The term's layer-5 text, LITERAL:
//   0
int emu_xorps_xmm_same_128__reg_xmm0.low__dart() {
  return m(0, 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_xorps_xmm_same_128__reg_xmm0.low__dart();
