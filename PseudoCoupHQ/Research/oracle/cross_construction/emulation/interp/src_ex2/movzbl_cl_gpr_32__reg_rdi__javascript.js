...
// InterpRenderer from the layer-4 term of movzbl_cl_gpr_32__reg_rdi__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(0, Extract(7, 0, v0))
function emu_movzbl_cl_gpr_32__reg_rdi__javascript(a) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_movzbl_cl_gpr_32__reg_rdi__javascript(...values).toString());
    } catch (problem) {
