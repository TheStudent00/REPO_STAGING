...
// InterpRenderer from the layer-4 term of lb_gpr_fpr_fpr_8__reg_a0__javascript.
...
function emu_lb_gpr_fpr_fpr_8__reg_a0__javascript(a) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_lb_gpr_fpr_fpr_8__reg_a0__javascript(...values).toString());
    } catch (problem) {
