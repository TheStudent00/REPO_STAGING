...
// intermediate per node of the term of ITYPE__op_SLTI__rd__go__all_constructed.
//   
package main
...
//go:noinline
func emu_ITYPE__op_SLTI__rd__go__all_constructed(a uint64, b uint16) uint64 {
	...
	var v57 uint64 = (uint64((uint64(v55)) ^ (uint64(uint64(0x8000000000000000)))))
	var v58 uint64 = (uint64(^(uint64(v57))))
	var v59 uint64 = (uint64((uint64(uint64(a))) ^ (uint64(uint64(0x8000000000000000)))))
	var v60 uint64 = (uint64((uint64(v59)) ^ (uint64(v58))))
	var v61 uint64 = (uint64((uint64(v60)) & (uint64(v56))))
	var v62 uint64 = (uint64((uint64(v59)) & (uint64(v58))))
	var v63 uint64 = (uint64((uint64(v62)) | (uint64(v61))))
	var v64 uint64 = (uint64((uint64(v63)) << ((uint64(uint64(0x1))) & uint64(0x3f))))
	var v65 uint64 = (uint64((uint64(v60)) & (uint64(v64))))
	var v66 uint64 = (uint64((uint64(v63)) | (uint64(v65))))
	var v67 uint64 = (uint64((uint64(v66)) << ((uint64(uint64(0x2))) & uint64(0x3f))))
	var v68 uint64 = (uint64((uint64(v60)) << ((uint64(uint64(0x1))) & uint64(0x3f))))
	var v69 uint64 = (uint64((uint64(v60)) & (uint64(v68))))
	var v70 uint64 = (uint64((uint64(v69)) & (uint64(v67))))
	var v71 uint64 = (uint64((uint64(v66)) | (uint64(v70))))
	var v72 uint64 = (uint64((uint64(v71)) << ((uint64(uint64(0x4))) & uint64(0x3f))))
	var v73 uint64 = (uint64((uint64(v69)) << ((uint64(uint64(0x2))) & uint64(0x3f))))
	...
	var v77 uint64 = (uint64((uint64(v76)) << ((uint64(uint64(0x8))) & uint64(0x3f))))
	var v78 uint64 = (uint64((uint64(v74)) << ((uint64(uint64(0x4))) & uint64(0x3f))))
	...
	var v82 uint64 = (uint64((uint64(v81)) << ((uint64(uint64(0x10))) & uint64(0x3f))))
	var v83 uint64 = (uint64((uint64(v79)) << ((uint64(uint64(0x8))) & uint64(0x3f))))
	...
	var v87 uint64 = (uint64((uint64(v86)) << ((uint64(uint64(0x20))) & uint64(0x3f))))
	var v88 uint64 = (uint64((uint64(v84)) << ((uint64(uint64(0x10))) & uint64(0x3f))))
	...
	var v92 uint32 = ((uint32((uint64(v91)) >> 63)) & uint32(0x1))
	var v93 bool = ((uint32(uint32(0x0))) == (uint32(v92)))
	var v94 bool = (!(v93))
	var v95 uint32 = sel32(v94, uint32(uint32(0x0)), uint32(uint32(0x1)))
	var v96 uint32 = v95
	var v97 uint64 = uint64(0x0)
	var v98 uint64 = (uint64(((uint64(v97)) << 1) | (uint64(v96))))
	return uint64(v98)
}
...
func main() {
	sink = emu_ITYPE__op_SLTI__rd__go__all_constructed(g0, g1)
	_ = sink
}
