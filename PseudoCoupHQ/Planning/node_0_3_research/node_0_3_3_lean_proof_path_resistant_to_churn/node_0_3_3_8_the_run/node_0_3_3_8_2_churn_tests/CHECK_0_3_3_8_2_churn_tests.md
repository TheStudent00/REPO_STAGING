---
id: hq.research.lean_proof_path_resistant_to_churn.the_run.churn_tests.check
---

# CHECK — 0_3_3_8_2_churn_tests

Node `hq.research.lean_proof_path_resistant_to_churn.the_run.churn_tests`. Status `draft`.
