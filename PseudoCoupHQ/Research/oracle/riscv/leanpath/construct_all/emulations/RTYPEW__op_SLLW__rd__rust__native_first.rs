...
// intermediate per node of the term of RTYPEW__op_SLLW__rd__rust__native_first.
//   
#[no_mangle]
pub extern "C" fn emu_RTYPEW__op_SLLW__rd__rust__native_first(a: u32, b: u8) -> u64
{
