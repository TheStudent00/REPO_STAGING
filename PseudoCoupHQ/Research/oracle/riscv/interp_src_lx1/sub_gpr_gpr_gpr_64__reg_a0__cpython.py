...
# InterpRenderer from the layer-4 term of sub_gpr_gpr_gpr_64__reg_a0__cpython.
# The term's layer-5 text, LITERAL:
#   v0*18446744073709551615 + v1
def emu_sub_gpr_gpr_gpr_64__reg_a0__cpython(a, b):
    return m(add(mul(b, 18446744073709551615, 64), a, 64), 64)
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_sub_gpr_gpr_gpr_64__reg_a0__cpython(*values)
            sys.stdout.write("%d\n" % answer)
