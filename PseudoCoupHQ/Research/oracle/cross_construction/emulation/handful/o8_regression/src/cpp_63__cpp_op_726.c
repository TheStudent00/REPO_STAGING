/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of cpp_63__cpp_op_726.  The term's layer-5 text, LITERAL:
   LShR(v0, Concat(0, Extract(5, 0, v1))) */
#include <stdint.h>

uint64_t
emu_cpp_63__cpp_op_726(uint64_t a, uint8_t b)
{
