...
// intermediate per node of the term of jal_gpr_fpr_fpr_64__reg_a0__go__all_constructed.
//   v0 + 4
package main

//go:noinline
func emu_jal_gpr_fpr_fpr_64__reg_a0__go__all_constructed(a uint64) uint64 {
...
func main() {
	sink = emu_jal_gpr_fpr_fpr_64__reg_a0__go__all_constructed(g0)
	_ = sink
}
