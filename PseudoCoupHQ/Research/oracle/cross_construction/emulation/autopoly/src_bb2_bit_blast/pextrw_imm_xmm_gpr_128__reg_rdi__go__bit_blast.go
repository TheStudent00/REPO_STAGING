...
// intermediate per node of the term of pextrw_imm_xmm_gpr_128__reg_rdi__go__bit_blast.
//   Concat(0, Extract(31, 16, v0))
package main

//go:noinline
func emu_pextrw_imm_xmm_gpr_128__reg_rdi__go__bit_blast(a float32) uint64 {
	...
	var k0 uint64 = 0
	var w0 uint64 = (x0_16 << 0)
	var w1 uint64 = w0 | (x0_17 << 1)
	var w2 uint64 = w1 | (x0_18 << 2)
	var w3 uint64 = w2 | (x0_19 << 3)
	var w4 uint64 = w3 | (x0_20 << 4)
	var w5 uint64 = w4 | (x0_21 << 5)
	var w6 uint64 = w5 | (x0_22 << 6)
	var w7 uint64 = w6 | (x0_23 << 7)
	var w8 uint64 = w7 | (x0_24 << 8)
	var w9 uint64 = w8 | (x0_25 << 9)
	var w10 uint64 = w9 | (x0_26 << 10)
	var w11 uint64 = w10 | (x0_27 << 11)
	var w12 uint64 = w11 | (x0_28 << 12)
	var w13 uint64 = w12 | (x0_29 << 13)
	var w14 uint64 = w13 | (x0_30 << 14)
...
func main() {
	sink = emu_pextrw_imm_xmm_gpr_128__reg_rdi__go__bit_blast(g0)
	_ = sink
}
