...
// one named local per gate, over the term of setns_gpr_one_8__reg_rdi__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(63, 8, v2), If(Or(Extract(7, 7, v0) == 0, Extract(7, 7, v1) == 0), 1, 0))
function emu_setns_gpr_one_8__reg_rdi__javascript(a, b, c) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_setns_gpr_one_8__reg_rdi__javascript(...values).toString());
    } catch (problem) {
