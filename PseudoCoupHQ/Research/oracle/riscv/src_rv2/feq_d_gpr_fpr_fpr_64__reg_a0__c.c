/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of feq_d_gpr_fpr_fpr_64__reg_a0__c.  The term's layer-5 text, LITERAL:
...
uint64_t
emu_feq_d_gpr_fpr_fpr_64__reg_a0__c(uint64_t a, uint64_t b)
{
