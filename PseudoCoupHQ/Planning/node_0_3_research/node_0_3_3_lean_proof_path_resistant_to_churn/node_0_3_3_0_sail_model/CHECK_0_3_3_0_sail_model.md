---
id: hq.research.lean_proof_path_resistant_to_churn.sail_model.check
---

# CHECK — 0_3_3_0_sail_model

Node `hq.research.lean_proof_path_resistant_to_churn.sail_model`. Status `draft`.
