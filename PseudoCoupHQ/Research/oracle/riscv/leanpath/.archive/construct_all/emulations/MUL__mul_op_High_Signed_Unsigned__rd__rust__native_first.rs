...
// intermediate per node of the term of MUL__mul_op_High_Signed_Unsigned__rd__rust__native_first.
//   
#[no_mangle]
pub extern "C" fn emu_MUL__mul_op_High_Signed_Unsigned__rd__rust__native_first(a: u64, b: u64) -> u64
{
