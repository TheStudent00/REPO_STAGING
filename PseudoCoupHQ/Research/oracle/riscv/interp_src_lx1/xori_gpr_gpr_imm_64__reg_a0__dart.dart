...
// InterpRenderer from the layer-4 term of xori_gpr_gpr_imm_64__reg_a0__dart.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(63, 2, v0), ~Extract(1, 0, v0))
int emu_xori_gpr_gpr_imm_64__reg_a0__dart(int a) {
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_xori_gpr_gpr_imm_64__reg_a0__dart(values[0]);
