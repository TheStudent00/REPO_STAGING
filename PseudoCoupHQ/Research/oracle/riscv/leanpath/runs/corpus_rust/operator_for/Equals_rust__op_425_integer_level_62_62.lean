...
theorem rust__op_425_62_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) ((pure_ITYPE (b) (0x001#12) (LeanIM.iop.XORI))) (AND))) = ((zero_extend (m := 64) (bool_to_bit (zopz0zI_u a b)))) := by
