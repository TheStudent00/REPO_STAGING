...
theorem addw_gpr_gpr_same_32__reg_a0__c__all_constructed__ZBB_EXTOP_08_integer_level (a : BitVec 64) :
  ...
  try simp only [pure_SHIFTIWOP, pure_SHIFTIOP, pure_ZBA_RTYPEUW, pure_ITYPE, pure_RTYPE, pure_ZBA_RTYPE, pure_ZBB_EXTOP, bool_to_bit, log2_xlen, shift_bits_right_arith, sign_extend, xlenbits, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend]
  grind
