...
// one named local per gate, over the term of test_gpr_same_16__flags__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(15, 0, v0), 0)
function emu_test_gpr_same_16__flags__javascript(a) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_test_gpr_same_16__flags__javascript(...values).toString());
    } catch (problem) {
