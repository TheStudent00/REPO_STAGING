/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of add_gpr_gpr_8__reg_rdi__c.  The term's layer-5 text, LITERAL:
   Concat(Extract(63, 8, v0), Extract(7, 0, v0) + Extract(7, 0, v1)) */
#include <stdint.h>

uint64_t
emu_add_gpr_gpr_8__reg_rdi__c(uint64_t a, uint8_t b)
{
