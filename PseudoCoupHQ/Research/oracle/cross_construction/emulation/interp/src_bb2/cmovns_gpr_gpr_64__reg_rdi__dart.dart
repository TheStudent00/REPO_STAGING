...
// one named local per gate, over the term of cmovns_gpr_gpr_64__reg_rdi__dart.
// The term's layer-5 text, LITERAL:
//   If(Or(Extract(63, 63, v0) == 0, Extract(63, 63, v1) == 0), v2, v3)
int emu_cmovns_gpr_gpr_64__reg_rdi__dart(int a, int b, int c, int d) {
  int x3_0 = ext(d, 0, 0);
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_cmovns_gpr_gpr_64__reg_rdi__dart(values[0], values[1], values[2], values[3]);
