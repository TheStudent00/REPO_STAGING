...
// intermediate per node of the term of BTYPE__op_BGEU__pc__go__all_constructed.
//   
package main

//go:noinline
func emu_BTYPE__op_BGEU__pc__go__all_constructed(a uint64, b uint16) uint64 {
	...
	var v54 uint64 = (uint64(((uint64(v53)) << 13) | (uint64(v2))))
	var v55 uint64 = (uint64((uint64(v54)) & (uint64(uint64(a)))))
	var v56 uint64 = (uint64((uint64(v55)) << ((uint64(uint64(0x1))) & uint64(0x3f))))
	var v57 uint64 = (uint64((uint64(v54)) ^ (uint64(uint64(a)))))
	var v58 uint64 = (uint64((uint64(v57)) & (uint64(v56))))
	var v59 uint64 = (uint64((uint64(v55)) | (uint64(v58))))
	var v60 uint64 = (uint64((uint64(v59)) << ((uint64(uint64(0x2))) & uint64(0x3f))))
	var v61 uint64 = (uint64((uint64(v57)) << ((uint64(uint64(0x1))) & uint64(0x3f))))
	...
	var v65 uint64 = (uint64((uint64(v64)) << ((uint64(uint64(0x4))) & uint64(0x3f))))
	var v66 uint64 = (uint64((uint64(v62)) << ((uint64(uint64(0x2))) & uint64(0x3f))))
	...
	var v70 uint64 = (uint64((uint64(v69)) << ((uint64(uint64(0x8))) & uint64(0x3f))))
	var v71 uint64 = (uint64((uint64(v67)) << ((uint64(uint64(0x4))) & uint64(0x3f))))
	...
	var v75 uint64 = (uint64((uint64(v74)) << ((uint64(uint64(0x10))) & uint64(0x3f))))
	var v76 uint64 = (uint64((uint64(v72)) << ((uint64(uint64(0x8))) & uint64(0x3f))))
	...
	var v80 uint64 = (uint64((uint64(v79)) << ((uint64(uint64(0x20))) & uint64(0x3f))))
	var v81 uint64 = (uint64((uint64(v77)) << ((uint64(uint64(0x10))) & uint64(0x3f))))
	...
	var v85 uint64 = (uint64((uint64(v84)) << ((uint64(uint64(0x1))) & uint64(0x3f))))
	var v86 uint64 = (uint64((uint64(v57)) ^ (uint64(v85))))
	return uint64(v86)
}
...
func main() {
	sink = emu_BTYPE__op_BGEU__pc__go__all_constructed(g0, g1)
	_ = sink
}
