...
SOURCE, unmodified, read only: `<WORKSPACE_DIR>/Airlock/agent/out/
...
AIRLOCK_OUT = os.path.expanduser("<WORKSPACE_DIR>/Airlock/agent/out")
AIRLOCK_LOGS = os.path.expanduser("<WORKSPACE_DIR>/Airlock/agent/logs")
...
def main():
    ...
    md_lines.append("Folded 2026-08-31 by `fold_interp_php.py`, task "
                     ...
                     "`<WORKSPACE_DIR>/Airlock/agent/out/interp_php_b/` "
