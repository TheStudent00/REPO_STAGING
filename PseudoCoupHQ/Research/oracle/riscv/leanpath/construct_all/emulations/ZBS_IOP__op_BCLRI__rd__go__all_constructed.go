...
// intermediate per node of the term of ZBS_IOP__op_BCLRI__rd__go__all_constructed.
//   
package main
...
//go:noinline
func emu_ZBS_IOP__op_BCLRI__rd__go__all_constructed(a uint8, b uint64) uint64 {
...
func main() {
	sink = emu_ZBS_IOP__op_BCLRI__rd__go__all_constructed(g0, g1)
	_ = sink
}
