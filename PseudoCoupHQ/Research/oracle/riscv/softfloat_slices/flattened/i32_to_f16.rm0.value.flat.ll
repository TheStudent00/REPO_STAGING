; ModuleID = '<scratch>/fl/run/i32_to_f16.rm0.value/i32_to_f16.rm0.value.rv.flat.ll'
source_filename = "llvm-link"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128"
target triple = "riscv64-unknown-unknown-elf"

define dso_local i64 @i32_to_f16_rm0_value_flat(i32 noundef signext %arg) {
  ...
  %i53 = and i32 32768, %.m33
  %i56 = or i32 %i51, %i53
  %i52 = icmp eq i32 %i51, 0
  %.m35 = sext i1 %i52 to i32
  %.n36 = xor i32 %.m35, -1
