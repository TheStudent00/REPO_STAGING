...
|---|---|---|---|---|
| ruby | interpreter | ruby 3.3.0 instrumented build (`~/Programming/Airlock/ruby-3.3.0.tar.gz`) | 4 (`rb_fix_plus`, `rb_int_plus` with bodies; `rb_big_plus`, `vm_opt_plus` without) | handler slices (logs 095, 113); operator set not generated |
