/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of sraw_gpr_gpr_gpr_32__reg_a0__cpp__native_first.  The term's text, LITERAL:
...
extern "C"
uint64_t
emu_sraw_gpr_gpr_gpr_32__reg_a0__cpp__native_first(uint32_t a, uint8_t b)
{
