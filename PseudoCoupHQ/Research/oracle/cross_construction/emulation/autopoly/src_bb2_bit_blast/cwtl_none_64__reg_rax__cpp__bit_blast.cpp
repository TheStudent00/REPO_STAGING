/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of cwtl_none_64__reg_rax__cpp__bit_blast.  The term's text, LITERAL:
...
extern "C"
uint64_t
emu_cwtl_none_64__reg_rax__cpp__bit_blast(uint16_t a)
{
