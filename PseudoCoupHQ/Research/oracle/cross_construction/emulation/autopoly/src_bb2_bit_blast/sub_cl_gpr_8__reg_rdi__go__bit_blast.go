...
// intermediate per node of the term of sub_cl_gpr_8__reg_rdi__go__bit_blast.
//   Concat(Extract(63, 8, v0), Extract(7, 0, v1)*255 + Extract(7, 0, v0))
package main

//go:noinline
func emu_sub_cl_gpr_8__reg_rdi__go__bit_blast(a uint64, b uint8) uint64 {
	...
	var g15 uint64 = (x0_1 ^ 1)
	var g16 uint64 = (g15 | g5)
	var g17 uint64 = (g16 ^ 1)
	var g18 uint64 = (g9 | g15)
	...
	var g87 uint64 = (x0_5 ^ 1)
	var g88 uint64 = (g87 | g86)
	var g89 uint64 = (g88 ^ 1)
	var g90 uint64 = (g67 | g86)
	var g91 uint64 = (g90 ^ 1)
	var g92 uint64 = (g67 | g87)
...
func main() {
	sink = emu_sub_cl_gpr_8__reg_rdi__go__bit_blast(g0, g1)
	_ = sink
}
