---
id: hq.research.arch_unit_oracle.simplification.equality_saturation.check
---

# CHECK — 0_3_2_4_2_equality_saturation

Node `hq.research.arch_unit_oracle.simplification.equality_saturation`. Status `draft`.
