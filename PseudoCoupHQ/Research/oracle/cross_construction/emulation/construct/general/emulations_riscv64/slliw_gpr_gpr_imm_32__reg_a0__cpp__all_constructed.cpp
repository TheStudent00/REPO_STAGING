/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of slliw_gpr_gpr_imm_32__reg_a0__cpp__all_constructed.  The term's text, LITERAL:
...
extern "C"
uint64_t
emu_slliw_gpr_gpr_imm_32__reg_a0__cpp__all_constructed(uint32_t a)
{
    uint32_t v0 = ((uint32_t)((uint32_t)a >> 0) & UINT32_C(0x1fffffff));
    uint32_t v1 = ((uint32_t)((uint32_t)a >> 28) & UINT32_C(0x1));
    ...
    uint64_t v36 = ((uint64_t)(((uint64_t)(v35) << 29) | (uint64_t)(v3)) & UINT64_C(0x1fffffffffffffff));
    uint64_t v37 = (uint64_t)(((uint64_t)(v36) << 3) | (uint64_t)(v2));
    return (uint64_t)(v37);
}
