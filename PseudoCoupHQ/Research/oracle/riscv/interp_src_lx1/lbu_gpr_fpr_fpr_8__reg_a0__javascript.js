...
// InterpRenderer from the layer-4 term of lbu_gpr_fpr_fpr_8__reg_a0__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(0, Extract(7, 0, v0))
function emu_lbu_gpr_fpr_fpr_8__reg_a0__javascript(a) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_lbu_gpr_fpr_fpr_8__reg_a0__javascript(...values).toString());
    } catch (problem) {
