...
# InterpRenderer from the layer-4 term of bne_gpr_gpr_gpr_64__branch_condition__ruby.
# The term's layer-5 text, LITERAL:
#   If(v0 == v1, 0, 1)
def emu_bne_gpr_gpr_gpr_64__branch_condition__ruby(a, b)
  m(((eq(a, b, 64)) ? (0) : (1)), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_bne_gpr_gpr_gpr_64__branch_condition__ruby(*values)
