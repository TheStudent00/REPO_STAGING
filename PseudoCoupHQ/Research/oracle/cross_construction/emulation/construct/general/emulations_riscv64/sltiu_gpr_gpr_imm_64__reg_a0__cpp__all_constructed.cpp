/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of sltiu_gpr_gpr_imm_64__reg_a0__cpp__all_constructed.  The term's text, LITERAL:
   If(Or(Extract(1, 0, v0) == 3, Not(Extract(63, 2, v0) == 0)), 0, 1) */
#include <cstdint>

extern "C"
uint64_t
emu_sltiu_gpr_gpr_imm_64__reg_a0__cpp__all_constructed(uint64_t a)
{
