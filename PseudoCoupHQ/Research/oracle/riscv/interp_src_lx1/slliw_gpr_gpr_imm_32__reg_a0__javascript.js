...
// InterpRenderer from the layer-4 term of slliw_gpr_gpr_imm_32__reg_a0__javascript.
...
function emu_slliw_gpr_gpr_imm_32__reg_a0__javascript(a) {
    return m(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(ext(a, 28, 28), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 0), 29), 0n, 3), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_slliw_gpr_gpr_imm_32__reg_a0__javascript(...values).toString());
    } catch (problem) {
