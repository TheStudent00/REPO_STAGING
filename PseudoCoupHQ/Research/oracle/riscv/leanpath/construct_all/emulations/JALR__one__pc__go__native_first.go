...
// intermediate per node of the term of JALR__one__pc__go__native_first.
//   
package main

//go:noinline
func emu_JALR__one__pc__go__native_first(a uint64, b uint16) uint64 {
	...
	var v4 uint64 = ((uint64((uint64(v3)) >> 1)) & uint64(0x7fffffffffffffff))
	var v5 uint64 = (uint64(((uint64(v4)) << 1) | (uint64(uint32(0x0)))))
	return uint64(v5)
}
...
func main() {
	sink = emu_JALR__one__pc__go__native_first(g0, g1)
	_ = sink
}
