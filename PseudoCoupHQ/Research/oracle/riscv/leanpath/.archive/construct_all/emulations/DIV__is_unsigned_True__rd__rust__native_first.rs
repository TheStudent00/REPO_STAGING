...
// intermediate per node of the term of DIV__is_unsigned_True__rd__rust__native_first.
//   
#[no_mangle]
pub extern "C" fn emu_DIV__is_unsigned_True__rd__rust__native_first(a: u64, b: u64) -> u64
{
    ...
    let v5: u64 = (if (v4) { ((0xffffffffffffffffu64) as u64) } else { ((v3) as u64) });
    ((v5) as u64)
}
