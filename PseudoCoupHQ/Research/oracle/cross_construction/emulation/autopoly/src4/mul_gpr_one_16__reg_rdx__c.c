/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of mul_gpr_one_16__reg_rdx__c.  The term's layer-5 text, LITERAL:
   Concat(Extract(63, 16, v2), Extract(31, 16, Concat(0, Extract(15, 0, v0))*Concat(0, Extract(15, 0, v1)))) */
#include <stdint.h>

uint64_t
emu_mul_gpr_one_16__reg_rdx__c(uint16_t a, uint16_t b, uint64_t c)
{
