...
// intermediate per node of the term of sets_gpr_one_8__reg_rdi__go__bit_blast.
//   Concat(Extract(63, 8, v2), If(Or(Extract(7, 7, v0) == 0, Extract(7, 7, v1) == 0), 0, 1))
package main

//go:noinline
func emu_sets_gpr_one_8__reg_rdi__go__bit_blast(a uint8, b uint8, c uint64) uint64 {
...
func main() {
	sink = emu_sets_gpr_one_8__reg_rdi__go__bit_blast(g0, g1, g2)
	_ = sink
}
