/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of ITYPE__op_SLTIU__rd__cpp__all_constructed.  The term's text, LITERAL:
    */
#include <cstdint>

extern "C"
uint64_t
emu_ITYPE__op_SLTIU__rd__cpp__all_constructed(uint64_t a, uint16_t b)
{
    uint32_t v0 = ((uint32_t)((uint32_t)b >> 0) & UINT32_C(0xfff));
    uint32_t v1 = ((uint32_t)((uint32_t)b >> 11) & UINT32_C(0x1));
    uint32_t v2 = v0;
    uint32_t v3 = v1;
    ...
    uint64_t v51 = ((uint64_t)(((uint64_t)(v50) << 1) | (uint64_t)(v3)) & UINT64_C(0x1ffffffffffff));
    uint64_t v52 = ((uint64_t)(((uint64_t)(v51) << 1) | (uint64_t)(v3)) & UINT64_C(0x3ffffffffffff));
    uint64_t v53 = ((uint64_t)(((uint64_t)(v52) << 1) | (uint64_t)(v3)) & UINT64_C(0x7ffffffffffff));
    uint64_t v54 = ((uint64_t)(((uint64_t)(v53) << 1) | (uint64_t)(v3)) & UINT64_C(0xfffffffffffff));
    uint64_t v55 = (uint64_t)(((uint64_t)(v54) << 12) | (uint64_t)(v2));
    uint64_t v56 = (uint64_t)(UINT32_C(0x1));
    uint64_t v57 = (uint64_t)(~(uint64_t)(v55));
    uint64_t v58 = (uint64_t)((uint64_t)((uint64_t)a) ^ (uint64_t)(v57));
    uint64_t v59 = (uint64_t)((uint64_t)(v58) & (uint64_t)(v56));
    uint64_t v60 = (uint64_t)((uint64_t)((uint64_t)a) & (uint64_t)(v57));
    ...
    int v92 = ((!(v91))) ? 1 : 0;
    uint32_t v93 = ((v92) ? (uint32_t)(UINT32_C(0x0)) : (uint32_t)(UINT32_C(0x1)));
    uint32_t v94 = v93;
    uint64_t v95 = UINT64_C(0x0);
    uint64_t v96 = (uint64_t)(((uint64_t)(v95) << 1) | (uint64_t)(v94));
    return (uint64_t)(v96);
}
