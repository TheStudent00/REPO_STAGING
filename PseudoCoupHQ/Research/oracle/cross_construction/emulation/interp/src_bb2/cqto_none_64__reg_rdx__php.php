...
// one named local per gate, over the term of cqto_none_64__reg_rdx__php.
// The term's layer-5 text, LITERAL:
//   v0 >> 63
function emu_cqto_none_64__reg_rdx__php($a) {
    $x0_63 = ex_ext($a, 63, 63);
    $w0 = $x0_63;
    $w1 = ex_cat($w0, $x0_63, 1);
    $w2 = ex_cat($w1, $x0_63, 1);
    $w3 = ex_cat($w2, $x0_63, 1);
    $w4 = ex_cat($w3, $x0_63, 1);
    $w5 = ex_cat($w4, $x0_63, 1);
    $w6 = ex_cat($w5, $x0_63, 1);
    $w7 = ex_cat($w6, $x0_63, 1);
    $w8 = ex_cat($w7, $x0_63, 1);
    $w9 = ex_cat($w8, $x0_63, 1);
    $w10 = ex_cat($w9, $x0_63, 1);
    $w11 = ex_cat($w10, $x0_63, 1);
    $w12 = ex_cat($w11, $x0_63, 1);
    $w13 = ex_cat($w12, $x0_63, 1);
    $w14 = ex_cat($w13, $x0_63, 1);
    $w15 = ex_cat($w14, $x0_63, 1);
    $w16 = ex_cat($w15, $x0_63, 1);
    $w17 = ex_cat($w16, $x0_63, 1);
    $w18 = ex_cat($w17, $x0_63, 1);
    $w19 = ex_cat($w18, $x0_63, 1);
    $w20 = ex_cat($w19, $x0_63, 1);
    $w21 = ex_cat($w20, $x0_63, 1);
    $w22 = ex_cat($w21, $x0_63, 1);
    $w23 = ex_cat($w22, $x0_63, 1);
    $w24 = ex_cat($w23, $x0_63, 1);
    $w25 = ex_cat($w24, $x0_63, 1);
    $w26 = ex_cat($w25, $x0_63, 1);
    $w27 = ex_cat($w26, $x0_63, 1);
    $w28 = ex_cat($w27, $x0_63, 1);
    $w29 = ex_cat($w28, $x0_63, 1);
    $w30 = ex_cat($w29, $x0_63, 1);
    $w31 = ex_cat($w30, $x0_63, 1);
    $w32 = ex_cat($w31, $x0_63, 1);
    $w33 = ex_cat($w32, $x0_63, 1);
    $w34 = ex_cat($w33, $x0_63, 1);
    $w35 = ex_cat($w34, $x0_63, 1);
    $w36 = ex_cat($w35, $x0_63, 1);
    $w37 = ex_cat($w36, $x0_63, 1);
    $w38 = ex_cat($w37, $x0_63, 1);
    $w39 = ex_cat($w38, $x0_63, 1);
    $w40 = ex_cat($w39, $x0_63, 1);
    $w41 = ex_cat($w40, $x0_63, 1);
    $w42 = ex_cat($w41, $x0_63, 1);
    $w43 = ex_cat($w42, $x0_63, 1);
    $w44 = ex_cat($w43, $x0_63, 1);
    $w45 = ex_cat($w44, $x0_63, 1);
    $w46 = ex_cat($w45, $x0_63, 1);
    $w47 = ex_cat($w46, $x0_63, 1);
    $w48 = ex_cat($w47, $x0_63, 1);
    $w49 = ex_cat($w48, $x0_63, 1);
    $w50 = ex_cat($w49, $x0_63, 1);
    $w51 = ex_cat($w50, $x0_63, 1);
    $w52 = ex_cat($w51, $x0_63, 1);
    $w53 = ex_cat($w52, $x0_63, 1);
    $w54 = ex_cat($w53, $x0_63, 1);
    $w55 = ex_cat($w54, $x0_63, 1);
    $w56 = ex_cat($w55, $x0_63, 1);
    $w57 = ex_cat($w56, $x0_63, 1);
    $w58 = ex_cat($w57, $x0_63, 1);
    $w59 = ex_cat($w58, $x0_63, 1);
    $w60 = ex_cat($w59, $x0_63, 1);
    $w61 = ex_cat($w60, $x0_63, 1);
    $w62 = ex_cat($w61, $x0_63, 1);
    $w63 = ex_cat($w62, $x0_63, 1);
    return ex_m($w63, 64);
}
...
while (($line = fgets($handle)) !== false) {
    ...
    try {
        $answer = emu_cqto_none_64__reg_rdx__php(...$ints);
        if ($answer < 0) {
            echo sprintf("%s\n", sprintf("%u", $answer));
        } else {
            echo $answer . "\n";
