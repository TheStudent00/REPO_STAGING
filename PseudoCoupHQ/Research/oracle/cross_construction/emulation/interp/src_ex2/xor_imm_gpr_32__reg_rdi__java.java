...
public class Emu {
    ...
    // InterpRenderer from the layer-4 term of xor_imm_gpr_32__reg_rdi__java.
    // The term's layer-5 text, LITERAL:
    //   Concat(0, Extract(31, 0, v0) ^ Extract(31, 0, v1))
    static long emu_xor_imm_gpr_32__reg_rdi__java(long a, long b) {
        return m(cat(0L, bxor(b, a, 32), 32), 64);
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_xor_imm_gpr_32__reg_rdi__java(values[0], values[1])));
                    answers.append("\n");
