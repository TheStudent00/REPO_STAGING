...
bool f64_le_quiet_rm1(uint64_t v_arg, uint64_t v_arg1)
{
    ...
    const uint64_t v_i17 = (uint64_t)(v_arg1 & UINT64_C(0x7fffffffffffffff));
    const uint64_t v_i18 = (uint64_t)(v_i17 | v_arg);
