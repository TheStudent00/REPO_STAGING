...
// one named local per gate, over the term of test_imm_gpr_64__flags_low__javascript.
// The term's layer-5 text, LITERAL:
//   0
function emu_test_imm_gpr_64__flags_low__javascript() {
    const k0 = 0n;
    const w0 = k0;
...
for (const line of lines) {
    ...
    try {
        out.push(emu_test_imm_gpr_64__flags_low__javascript(...values).toString());
    } catch (problem) {
