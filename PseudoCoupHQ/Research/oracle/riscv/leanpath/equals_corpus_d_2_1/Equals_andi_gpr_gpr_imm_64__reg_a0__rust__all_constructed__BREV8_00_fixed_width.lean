...
theorem andi_gpr_gpr_imm_64__reg_a0__rust__all_constructed__BREV8_00_fixed_width (a : BitVec 64) :
    ((pure_ITYPE (a) ((sign_extend (m := 12) (0x03#6))) (ANDI))) = (pure_BREV8 (a) ) := by
  try simp only [pure_ITYPE, pure_BREV8, bool_to_bit, brev8, sign_extend, xlenbits, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, reverse_bits, zeros, Sail.BitVec.length, Sail.BitVec.updateSubrange, Sail.BitVec.extractLsb, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend]
  bv_decide
