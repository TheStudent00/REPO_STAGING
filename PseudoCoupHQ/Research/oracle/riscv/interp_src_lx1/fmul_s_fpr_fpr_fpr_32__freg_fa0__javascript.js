...
// InterpRenderer from the layer-4 term of fmul_s_fpr_fpr_fpr_32__freg_fa0__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(4294967295, fp.to_ieee_bv(fpToFP(Extract(31, 0, v0)) * fpToFP(Extract(31, 0, v1))))
function emu_fmul_s_fpr_fpr_fpr_32__freg_fa0__javascript(a, b) {
    return m(cat(4294967295n, fmul(a, b, 32), 32), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_fmul_s_fpr_fpr_fpr_32__freg_fa0__javascript(...values).toString());
    } catch (problem) {
