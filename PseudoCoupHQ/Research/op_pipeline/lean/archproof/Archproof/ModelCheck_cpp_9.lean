...
/-- cpp single-opcode row 9, arch mnemonic 'and', example unit cpp/op_457, 88 members
...
theorem ModelCheck_cpp_9 (v0 : BitVec 64) (v1 : BitVec 64) :
    (~~~((~~~(v0.extractLsb 31 0)) ||| (~~~(v1.extractLsb 31 0))))
  = ((model_and_37 (model_mov_20 v1) v0).extractLsb 31 0) := by
  simp only [model_mov_20, model_and_37]
  bv_decide

#print axioms ModelCheck_cpp_9
