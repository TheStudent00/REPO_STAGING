/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of fcvt_s_w_fpr_gpr_32__freg_fa0__cpp__native_first.  The term's text, LITERAL:
...
extern "C"
uint64_t
emu_fcvt_s_w_fpr_gpr_32__freg_fa0__cpp__native_first(uint32_t a)
{
    uint32_t v0 = (uint32_t)a;
    float v1 = ((float)(int32_t)(v0));
