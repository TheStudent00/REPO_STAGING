...
// intermediate per node of the term of ZBB_RTYPE__op_MINU__rd__rust__all_constructed.
//   
#[no_mangle]
pub extern "C" fn emu_ZBB_RTYPE__op_MINU__rd__rust__all_constructed(a: u64, b: u64) -> u64
{
