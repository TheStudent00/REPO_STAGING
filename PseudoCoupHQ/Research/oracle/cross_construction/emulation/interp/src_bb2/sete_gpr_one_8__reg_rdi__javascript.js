...
// one named local per gate, over the term of sete_gpr_one_8__reg_rdi__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(63, 8, v0), If(Extract(7, 0, v1) == Extract(7, 0, v2), 1, 0))
function emu_sete_gpr_one_8__reg_rdi__javascript(a, b, c) {
    const x1_7 = ext(b, 7, 7);
    const x2_7 = ext(a, 7, 7);
    const x2_6 = ext(a, 6, 6);
    const x1_6 = ext(b, 6, 6);
    const x2_5 = ext(a, 5, 5);
    const x1_5 = ext(b, 5, 5);
    const x1_4 = ext(b, 4, 4);
    const x2_4 = ext(a, 4, 4);
    const x1_3 = ext(b, 3, 3);
    const x2_3 = ext(a, 3, 3);
    const x1_2 = ext(b, 2, 2);
    const x2_2 = ext(a, 2, 2);
    const x2_1 = ext(a, 1, 1);
    const x1_1 = ext(b, 1, 1);
    const x1_0 = ext(b, 0, 0);
    const x2_0 = ext(a, 0, 0);
    const x0_8 = ext(c, 8, 8);
    const x0_9 = ext(c, 9, 9);
    const x0_10 = ext(c, 10, 10);
    const x0_11 = ext(c, 11, 11);
    const x0_12 = ext(c, 12, 12);
    const x0_13 = ext(c, 13, 13);
    const x0_14 = ext(c, 14, 14);
    const x0_15 = ext(c, 15, 15);
    const x0_16 = ext(c, 16, 16);
    const x0_17 = ext(c, 17, 17);
    const x0_18 = ext(c, 18, 18);
    const x0_19 = ext(c, 19, 19);
    const x0_20 = ext(c, 20, 20);
    const x0_21 = ext(c, 21, 21);
    const x0_22 = ext(c, 22, 22);
    const x0_23 = ext(c, 23, 23);
    const x0_24 = ext(c, 24, 24);
    const x0_25 = ext(c, 25, 25);
    const x0_26 = ext(c, 26, 26);
    const x0_27 = ext(c, 27, 27);
    const x0_28 = ext(c, 28, 28);
    const x0_29 = ext(c, 29, 29);
    const x0_30 = ext(c, 30, 30);
    const x0_31 = ext(c, 31, 31);
    const x0_32 = ext(c, 32, 32);
    const x0_33 = ext(c, 33, 33);
    const x0_34 = ext(c, 34, 34);
    const x0_35 = ext(c, 35, 35);
    const x0_36 = ext(c, 36, 36);
    const x0_37 = ext(c, 37, 37);
    const x0_38 = ext(c, 38, 38);
    const x0_39 = ext(c, 39, 39);
    const x0_40 = ext(c, 40, 40);
    const x0_41 = ext(c, 41, 41);
    const x0_42 = ext(c, 42, 42);
    const x0_43 = ext(c, 43, 43);
    const x0_44 = ext(c, 44, 44);
    const x0_45 = ext(c, 45, 45);
    const x0_46 = ext(c, 46, 46);
    const x0_47 = ext(c, 47, 47);
    const x0_48 = ext(c, 48, 48);
    const x0_49 = ext(c, 49, 49);
    const x0_50 = ext(c, 50, 50);
    const x0_51 = ext(c, 51, 51);
    const x0_52 = ext(c, 52, 52);
    const x0_53 = ext(c, 53, 53);
    const x0_54 = ext(c, 54, 54);
    const x0_55 = ext(c, 55, 55);
    const x0_56 = ext(c, 56, 56);
    const x0_57 = ext(c, 57, 57);
    const x0_58 = ext(c, 58, 58);
    const x0_59 = ext(c, 59, 59);
    const x0_60 = ext(c, 60, 60);
    const x0_61 = ext(c, 61, 61);
    const x0_62 = ext(c, 62, 62);
    const x0_63 = ext(c, 63, 63);
    const g0 = (x2_7 ^ 1n);
    const g1 = (g0 | x1_7);
    const g2 = (x1_7 ^ 1n);
    const g3 = (x2_7 | g2);
...
for (const line of lines) {
    ...
    try {
        out.push(emu_sete_gpr_one_8__reg_rdi__javascript(...values).toString());
    } catch (problem) {
