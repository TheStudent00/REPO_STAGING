...
// intermediate per node of the term of ITYPE__op_SLTIU__rd__rust__all_constructed.
//   
#[no_mangle]
pub extern "C" fn emu_ITYPE__op_SLTIU__rd__rust__all_constructed(a: u64, b: u16) -> u64
{
    ...
    let v57: u64 = ((!((v55) as u64)) as u64);
    let v58: u64 = (((((a as u64)) as u64) ^ ((v57) as u64)) as u64);
    let v59: u64 = ((((v58) as u64) & ((v56) as u64)) as u64);
    let v60: u64 = (((((a as u64)) as u64) & ((v57) as u64)) as u64);
    ...
    let v92: bool = (!(v91));
    let v93: u32 = (if (v92) { ((0x0u32) as u32) } else { ((0x1u32) as u32) });
    let v94: u32 = v93;
    let v95: u64 = 0x0u64;
    let v96: u64 = (((((v95) as u64) << 1) | ((v94) as u64)) as u64);
    ((v96) as u64)
}
