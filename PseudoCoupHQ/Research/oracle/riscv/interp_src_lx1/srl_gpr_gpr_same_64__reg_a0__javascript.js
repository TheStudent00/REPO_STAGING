...
// InterpRenderer from the layer-4 term of srl_gpr_gpr_same_64__reg_a0__javascript.
// The term's layer-5 text, LITERAL:
//   LShR(v0, Concat(0, Extract(5, 0, v0)))
function emu_srl_gpr_gpr_same_64__reg_a0__javascript(a) {
    return m(lshr(a, cat(0n, ext(a, 5, 0), 6), 64), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_srl_gpr_gpr_same_64__reg_a0__javascript(...values).toString());
    } catch (problem) {
