...
// one named local per gate, over the term of sar_cl_gpr_8__reg_rdi__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(63, 8, v0), Extract(7, 0, v0) >> Concat(0, Extract(4, 0, v1)))
function emu_sar_cl_gpr_8__reg_rdi__javascript(a, b) {
    ...
    const w57 = cat(w56, g102, 1);
    const w58 = cat(w57, g96, 1);
    const w59 = cat(w58, g90, 1);
    const w60 = cat(w59, g86, 1);
    const w61 = cat(w60, g77, 1);
    const w62 = cat(w61, g60, 1);
    const w63 = cat(w62, g32, 1);
    return m(w63, 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_sar_cl_gpr_8__reg_rdi__javascript(...values).toString());
    } catch (problem) {
