...
theorem probe_mulh__ZBB_RTYPE_brop_zbbMINU_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_MUL (b) (a) ({ result_part := LeanIM.VectorHalf.High, signed_rs1 := LeanIM.Signedness.Signed, signed_rs2 := LeanIM.Signedness.Signed }))) = (pure_ZBB_RTYPE (a) (b) (brop_zbb.MINU)) := by
