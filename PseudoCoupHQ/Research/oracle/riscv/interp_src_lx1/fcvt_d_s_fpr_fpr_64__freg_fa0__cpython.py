...
# InterpRenderer from the layer-4 term of fcvt_d_s_fpr_fpr_64__freg_fa0__cpython.
# The term's layer-5 text, LITERAL:
#   fp.to_ieee_bv(fpToFP(RNE(), fpToFP(Extract(31, 0, v0))))
def emu_fcvt_d_s_fpr_fpr_64__freg_fa0__cpython(a):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_fcvt_d_s_fpr_fpr_64__freg_fa0__cpython(*values)
            sys.stdout.write("%d\n" % answer)
