...
# InterpRenderer from the layer-4 term of punpckldq_mem_xmm_128__reg_xmm0.low__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(Extract(31, 0, v0), Extract(31, 0, v1))
def emu_punpckldq_mem_xmm_128__reg_xmm0.low__ruby(a, b)
  m(cat(a, b, 32), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_punpckldq_mem_xmm_128__reg_xmm0.low__ruby(*values)
