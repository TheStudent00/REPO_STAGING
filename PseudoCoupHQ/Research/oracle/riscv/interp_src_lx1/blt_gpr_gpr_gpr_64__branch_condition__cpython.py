...
# InterpRenderer from the layer-4 term of blt_gpr_gpr_gpr_64__branch_condition__cpython.
# The term's layer-5 text, LITERAL:
#   If(v0 <= v1, 0, 1)
def emu_blt_gpr_gpr_gpr_64__branch_condition__cpython(a, b):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_blt_gpr_gpr_gpr_64__branch_condition__cpython(*values)
            sys.stdout.write("%d\n" % answer)
