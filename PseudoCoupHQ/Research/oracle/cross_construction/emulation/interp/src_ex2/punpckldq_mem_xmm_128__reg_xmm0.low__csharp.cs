...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of punpckldq_mem_xmm_128__reg_xmm0.low__csharp.
    // The term's layer-5 text, LITERAL:
    //   Concat(Extract(31, 0, v0), Extract(31, 0, v1))
    public static long emu_punpckldq_mem_xmm_128__reg_xmm0.low__csharp(long a, long b) {
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_punpckldq_mem_xmm_128__reg_xmm0.low__csharp(values[0], values[1])).ToString());
                    answers.Append("\n");
