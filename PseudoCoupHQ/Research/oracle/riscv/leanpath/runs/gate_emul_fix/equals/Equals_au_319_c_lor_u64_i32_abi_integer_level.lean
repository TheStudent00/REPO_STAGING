...
theorem au_319_c_lor_u64_i32_abi_integer_level (a : BitVec 64) (b : BitVec 64) :
    (((((fun (a : BitVec 64) (b : BitVec 64) => ((pure_RTYPE (zero_reg) ((pure_RTYPE (a) (b) (OR))) (LeanIM.rop.SLTU)))) (a) (((((b) &&& 0xffffffff#64) ^^^ 0x80000000#64) - 0x80000000#64)))) &&& 0xffffffff#64)) = (((((fun (a : BitVec 64) (b : BitVec 64) => ((pure_RTYPE (zero_reg) ((pure_RTYPE (a) ((pure_ADDIW (b) ((sign_extend (m := 12) (0x00#6))))) (OR))) (LeanIM.rop.SLTU)))) (a) (((((b) &&& 0xffffffff#64) ^^^ 0x80000000#64) - 0x80000000#64)))) &&& 0xffffffff#64)) := by
