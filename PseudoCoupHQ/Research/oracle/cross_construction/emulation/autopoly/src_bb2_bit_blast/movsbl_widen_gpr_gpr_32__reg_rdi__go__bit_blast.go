...
// intermediate per node of the term of movsbl_widen_gpr_gpr_32__reg_rdi__go__bit_blast.
...
//go:noinline
func emu_movsbl_widen_gpr_gpr_32__reg_rdi__go__bit_blast(a uint8) uint64 {
...
func main() {
	sink = emu_movsbl_widen_gpr_gpr_32__reg_rdi__go__bit_blast(g0)
	_ = sink
}
