...
uint64_t i64_to_f32_rm0(uint64_t v_arg)
{
    const bool v_i = ((int64_t)(v_arg) < INT64_C(0));
    const uint32_t v__m20 = (uint32_t)((v_i) ? ~(uint32_t)0 : (uint32_t)0);
    const uint32_t v_i48 = (uint32_t)(UINT32_C(0x80000000) & v__m20);
    ...
    const uint32_t v_i50 = (uint32_t)(UINT32_C(0x4e000000) - v__sh21);
    ...
    const uint32_t v_i39 = (uint32_t)(v__a18 + UINT32_C(0x40));
    const uint32_t v__sh19 = (uint32_t)((uint32_t)(v_i39) >> ((UINT32_C(0x7)) & 31));
    const uint32_t v_i40 = v__sh19;
    const uint32_t v_i41 = (uint32_t)(v__a18 & UINT32_C(0x7f));
    const bool v_i43 = (v_i41 == UINT32_C(0x40));
    const uint32_t v_i44 = (uint32_t)((v_i43) ? 1 : 0);
    const uint32_t v_i45 = (uint32_t)(v_i44 ^ UINT32_C(0xffffffff));
    const uint32_t v_i46 = (uint32_t)(v_i40 & v_i45);
    const uint32_t v_i52 = (uint32_t)(v_i46 | v_i48);
    const bool v_i47 = (v_i46 == UINT32_C(0x0));
    const uint32_t v__m22 = (uint32_t)((v_i47) ? ~(uint32_t)0 : (uint32_t)0);
    const uint32_t v__n23 = (uint32_t)(v__m22 ^ UINT32_C(0xffffffff));
    const uint32_t v_i51 = (uint32_t)(v_i50 & v__n23);
    const uint32_t v_i53 = (uint32_t)(v_i52 + v_i51);
    const uint32_t v__a25 = (uint32_t)(v_i53 & v__m24);
    const uint32_t v__o28 = (uint32_t)(v__a25 | v__a27);
    const uint32_t v__a30 = (uint32_t)(v__o28 & v__m29);
    const uint64_t v_i55 = (uint64_t)(v__a30);
    return v_i55;
}
