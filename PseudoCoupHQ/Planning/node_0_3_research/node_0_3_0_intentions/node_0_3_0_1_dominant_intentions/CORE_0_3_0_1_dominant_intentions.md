...
node:
    ...
    path: Planning/node_0_3_research/node_0_3_0_intentions/node_0_3_0_1_dominant_intentions/CORE_0_3_0_1_dominant_intentions.md
super_node:
    name: intentions
...
# CORE 0_3_0_1 — dominant_intentions
...
- **designed precedent, not from scratch**: PseudoIR's Tier-1
  registry (`PRIVATE/PseudoIR/pseudoir/registry/data/ops.json`
...
- **runner**: the Airlock agent lane
  (`python3 PUBLIC/Airlock/airlock submit ...`, `airlock status`);
  results as data.
