...
// InterpRenderer from the layer-4 term of rem_gpr_gpr_same_64__reg_a0__javascript.
// The term's layer-5 text, LITERAL:
//   If(v0 == 0, v0, If(And(v0 == 18446744073709551615, v0 == 9223372036854775808), 0, bvsrem_i(v0, v0)))
function emu_rem_gpr_gpr_same_64__reg_a0__javascript(a) {
    return m(((eq(a, 0n, 64)) ? (a) : (((((eq(a, 18446744073709551615n, 64)) && (eq(a, 9223372036854775808n, 64)))) ? (0n) : (srem(a, a, 64))))), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_rem_gpr_gpr_same_64__reg_a0__javascript(...values).toString());
    } catch (problem) {
