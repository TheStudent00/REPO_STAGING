...
theorem cpp__op_744_108_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPEW (a) (b) (LeanIM.ropw.SRLW))) = ((sign_extend (m := 64) (shift_bits_right (Sail.BitVec.extractLsb a 31 0) (Sail.BitVec.extractLsb (Sail.BitVec.extractLsb b 31 0) 4 0)))) := by
