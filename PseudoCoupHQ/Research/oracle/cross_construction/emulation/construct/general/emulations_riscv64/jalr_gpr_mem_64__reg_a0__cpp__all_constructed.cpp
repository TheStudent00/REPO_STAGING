/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of jalr_gpr_mem_64__reg_a0__cpp__all_constructed.  The term's text, LITERAL:
   v0 + 4 */
#include <cstdint>

extern "C"
uint64_t
emu_jalr_gpr_mem_64__reg_a0__cpp__all_constructed(uint64_t a)
{
