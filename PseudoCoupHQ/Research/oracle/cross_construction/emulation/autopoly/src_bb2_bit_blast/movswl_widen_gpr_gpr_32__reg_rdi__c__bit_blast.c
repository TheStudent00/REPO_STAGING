/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of movswl_widen_gpr_gpr_32__reg_rdi__c__bit_blast.  The term's text, LITERAL:
...
uint64_t
emu_movswl_widen_gpr_gpr_32__reg_rdi__c__bit_blast(uint16_t a)
{
