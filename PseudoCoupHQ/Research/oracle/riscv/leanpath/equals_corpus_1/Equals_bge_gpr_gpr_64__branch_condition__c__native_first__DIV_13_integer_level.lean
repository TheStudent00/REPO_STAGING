...
theorem bge_gpr_gpr_64__branch_condition__c__native_first__DIV_13_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_ITYPE ((pure_RTYPE (a) (b) (LeanIM.rop.SLT))) (0x001#12) (LeanIM.iop.XORI))) = (pure_DIV (a) (b) (false)) := by
  try simp only [pure_RTYPE, pure_ITYPE, pure_DIV, bool_to_bit, log2_xlen, not, shift_bits_right_arith, sign_extend, to_bits_truncate, xlen, xlenbits, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend]
  grind
