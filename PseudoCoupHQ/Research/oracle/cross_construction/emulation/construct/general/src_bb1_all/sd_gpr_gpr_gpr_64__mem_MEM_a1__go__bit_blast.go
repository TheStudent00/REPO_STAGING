...
// intermediate per node of the term of sd_gpr_gpr_gpr_64__mem_MEM_a1__go__bit_blast.
//   v0
package main

//go:noinline
func emu_sd_gpr_gpr_gpr_64__mem_MEM_a1__go__bit_blast(a uint64) uint64 {
...
func main() {
	sink = emu_sd_gpr_gpr_gpr_64__mem_MEM_a1__go__bit_blast(g0)
	_ = sink
}
