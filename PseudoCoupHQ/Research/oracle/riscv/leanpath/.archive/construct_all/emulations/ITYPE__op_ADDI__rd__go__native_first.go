...
// intermediate per node of the term of ITYPE__op_ADDI__rd__go__native_first.
//   
package main

//go:noinline
func emu_ITYPE__op_ADDI__rd__go__native_first(a uint64, b uint16) uint64 {
...
func main() {
	sink = emu_ITYPE__op_ADDI__rd__go__native_first(g0, g1)
	_ = sink
}
