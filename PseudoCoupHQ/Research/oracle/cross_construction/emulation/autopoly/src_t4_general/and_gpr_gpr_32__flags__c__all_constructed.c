/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of and_gpr_gpr_32__flags__c__all_constructed.  The term's text, LITERAL:
   Concat(~(~Extract(31, 0, v0) | ~Extract(31, 0, v1)), 0) */
#include <stdint.h>

uint64_t
emu_and_gpr_gpr_32__flags__c__all_constructed(uint32_t a, uint32_t b)
{
