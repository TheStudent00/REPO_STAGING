#!/bin/bash
# L2 lane 7 — the sweep once more with the two Lean options the generated
# text needs, then a clean `lake build` of Model.lean, then the census the
# report's translation table is made of.
set -u
