...
// one named local per gate, over the term of movswl_widen_gpr_gpr_32__reg_rdi__php.
...
function emu_movswl_widen_gpr_gpr_32__reg_rdi__php($a) {
    $x0_0 = ex_ext($a, 0, 0);
    $x0_1 = ex_ext($a, 1, 1);
    $x0_2 = ex_ext($a, 2, 2);
    $x0_3 = ex_ext($a, 3, 3);
    ...
    $w30 = ex_cat($w29, $k0, 1);
    $w31 = ex_cat($w30, $k0, 1);
    $w32 = ex_cat($w31, $x0_15, 1);
    $w33 = ex_cat($w32, $x0_15, 1);
    $w34 = ex_cat($w33, $x0_15, 1);
    $w35 = ex_cat($w34, $x0_15, 1);
    $w36 = ex_cat($w35, $x0_15, 1);
    $w37 = ex_cat($w36, $x0_15, 1);
    $w38 = ex_cat($w37, $x0_15, 1);
    $w39 = ex_cat($w38, $x0_15, 1);
    $w40 = ex_cat($w39, $x0_15, 1);
    $w41 = ex_cat($w40, $x0_15, 1);
    $w42 = ex_cat($w41, $x0_15, 1);
    $w43 = ex_cat($w42, $x0_15, 1);
    $w44 = ex_cat($w43, $x0_15, 1);
    $w45 = ex_cat($w44, $x0_15, 1);
    $w46 = ex_cat($w45, $x0_15, 1);
    $w47 = ex_cat($w46, $x0_15, 1);
...
while (($line = fgets($handle)) !== false) {
    ...
    try {
        $answer = emu_movswl_widen_gpr_gpr_32__reg_rdi__php(...$ints);
        if ($answer < 0) {
            echo sprintf("%s\n", sprintf("%u", $answer));
        } else {
            echo $answer . "\n";
