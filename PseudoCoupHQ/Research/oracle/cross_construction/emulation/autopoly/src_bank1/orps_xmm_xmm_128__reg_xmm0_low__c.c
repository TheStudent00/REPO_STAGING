/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of orps_xmm_xmm_128__reg_xmm0_low__c.  The term's layer-5 text, LITERAL:
...
double
emu_orps_xmm_xmm_128__reg_xmm0_low__c(double a, double b)
{
