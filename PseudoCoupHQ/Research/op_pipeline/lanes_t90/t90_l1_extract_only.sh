#!/usr/bin/env bash
# t90_l1_extract_only.sh -- TASK 90, generated by check_conventions_log_claims.py --emit-lane.
#
...
python3 check_conventions_log_claims.py --extract-only \
  --timeout 120 \
  --json /work/t90_l1_extract_only.json \
