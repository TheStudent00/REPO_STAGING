...
// one named local per gate, over the term of shl_imm_gpr_32__reg_rdi__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(0, Extract(28, 0, v0), 0)
function emu_shl_imm_gpr_32__reg_rdi__javascript(a) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_shl_imm_gpr_32__reg_rdi__javascript(...values).toString());
    } catch (problem) {
