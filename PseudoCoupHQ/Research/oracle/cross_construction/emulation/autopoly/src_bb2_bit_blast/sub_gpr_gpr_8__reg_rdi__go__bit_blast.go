...
// intermediate per node of the term of sub_gpr_gpr_8__reg_rdi__go__bit_blast.
//   Concat(Extract(63, 8, v0), Extract(7, 0, v1)*255 + Extract(7, 0, v0))
package main

//go:noinline
func emu_sub_gpr_gpr_8__reg_rdi__go__bit_blast(a uint64, b uint8) uint64 {
	...
	var g18 uint64 = (g17 | g9)
	var g19 uint64 = (g18 ^ 1)
	var g20 uint64 = (g17 | g5)
	...
	var g35 uint64 = (x0_2 ^ 1)
	var g36 uint64 = (g35 | g32)
	var g37 uint64 = (g36 ^ 1)
	var g38 uint64 = (g35 | g14)
...
func main() {
	sink = emu_sub_gpr_gpr_8__reg_rdi__go__bit_blast(g0, g1)
	_ = sink
}
