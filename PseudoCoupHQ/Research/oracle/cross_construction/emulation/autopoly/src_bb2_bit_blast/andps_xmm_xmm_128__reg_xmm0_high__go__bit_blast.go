...
// intermediate per node of the term of andps_xmm_xmm_128__reg_xmm0_high__go__bit_blast.
//   ~(~v0 | ~v1)
package main
...
//go:noinline
func emu_andps_xmm_xmm_128__reg_xmm0_high__go__bit_blast(a uint64, b uint64) float64 {
...
func main() {
	sink = emu_andps_xmm_xmm_128__reg_xmm0_high__go__bit_blast(g0, g1)
	_ = sink
}
