...
theorem andi_gpr_gpr_imm_64__reg_a0__cpp__all_constructed_00_same_text (a : BitVec 64) :
    ((pure_ITYPE (a) ((sign_extend (m := 12) (0x03#6))) (ANDI))) = (pure_BREV8 (a) ) := by
  rfl

set_option maxHeartbeats 10000 in
theorem andi_gpr_gpr_imm_64__reg_a0__cpp__all_constructed_01_same_text (a : BitVec 64) :
    ((pure_ITYPE (a) ((sign_extend (m := 12) (0x03#6))) (ANDI))) = (pure_CLZ (a) ) := by
  rfl

set_option maxHeartbeats 10000 in
theorem andi_gpr_gpr_imm_64__reg_a0__cpp__all_constructed_02_same_text (a : BitVec 64) :
    ((pure_ITYPE (a) ((sign_extend (m := 12) (0x03#6))) (ANDI))) = (pure_CLZW (a) ) := by
  rfl

set_option maxHeartbeats 10000 in
theorem andi_gpr_gpr_imm_64__reg_a0__cpp__all_constructed_03_same_text (a : BitVec 64) :
    ((pure_ITYPE (a) ((sign_extend (m := 12) (0x03#6))) (ANDI))) = (pure_CTZ (a) ) := by
  rfl

set_option maxHeartbeats 10000 in
theorem andi_gpr_gpr_imm_64__reg_a0__cpp__all_constructed_04_same_text (a : BitVec 64) :
    ((pure_ITYPE (a) ((sign_extend (m := 12) (0x03#6))) (ANDI))) = (pure_CTZW (a) ) := by
  rfl

set_option maxHeartbeats 10000 in
theorem andi_gpr_gpr_imm_64__reg_a0__cpp__all_constructed_05_same_text (a : BitVec 64) :
    ((pure_ITYPE (a) ((sign_extend (m := 12) (0x03#6))) (ANDI))) = (pure_REV8 (a) ) := by
  rfl

set_option maxHeartbeats 10000 in
theorem andi_gpr_gpr_imm_64__reg_a0__cpp__all_constructed_06_same_text (a : BitVec 64) :
    ((pure_ITYPE (a) ((sign_extend (m := 12) (0x03#6))) (ANDI))) = (pure_ZBB_EXTOP (a) (extop_zbb.SEXTB)) := by
  rfl

set_option maxHeartbeats 10000 in
theorem andi_gpr_gpr_imm_64__reg_a0__cpp__all_constructed_07_same_text (a : BitVec 64) :
    ((pure_ITYPE (a) ((sign_extend (m := 12) (0x03#6))) (ANDI))) = (pure_ZBB_EXTOP (a) (extop_zbb.SEXTH)) := by
  rfl

set_option maxHeartbeats 10000 in
theorem andi_gpr_gpr_imm_64__reg_a0__cpp__all_constructed_08_same_text (a : BitVec 64) :
