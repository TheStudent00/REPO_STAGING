...
// GoRenderer from the layer-4 term of cmovge_gpr_gpr_64__reg_rdi__go__constructed.
// The term's layer-5 text, LITERAL:
//   If(Extract(63, 63, v0 + 18446744073709551613) == If(Extract(63, 63, Concat(Extract(63, 63, v0), v0) + 36893488147419103229) == Extract(64, 64, Concat(Extract(63, 63, v0), v0) + 36893488147419103229), 0, 1), v1, v2)
package main
...
func main() {
	sink = emu_cmovge_gpr_gpr_64__reg_rdi__go__constructed(g0, g1, g2)
	_ = sink
}
