...
// SwiftRenderer from the layer-4 term of shl_cl_gpr_64__reg_rdi__swift.
// EVERY SPELLING IN THIS SOURCE IS UNMEASURED: there is no swiftc in
// the image, so nothing here has been compiled or carved.
// The term's layer-5 text, LITERAL:
//   v0 << Concat(0, Extract(5, 0, v1))
@_cdecl("emu_shl_cl_gpr_64__reg_rdi__swift")
public func emu_shl_cl_gpr_64__reg_rdi__swift(_ a: UInt64, _ b: UInt8) -> UInt64
{
