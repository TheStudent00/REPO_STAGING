...
# InterpRenderer from the layer-4 term of movapd_xmm_xmm_128__reg_xmm0.low__cpython.
# The term's layer-5 text, LITERAL:
#   Extract(63, 0, v0)
def emu_movapd_xmm_xmm_128__reg_xmm0.low__cpython(a):
    return m(a, 64)
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_movapd_xmm_xmm_128__reg_xmm0.low__cpython(*values)
            sys.stdout.write("%d\n" % answer)
