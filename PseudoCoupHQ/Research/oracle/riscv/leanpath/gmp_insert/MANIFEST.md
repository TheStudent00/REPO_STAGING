...
- modules handed to sail: `--all-modules` (the CI's selection, model/CMakeLists.txt:9),
  resolved to 163 source files, `base_insts.sail` and `mext_insts.sail`
  among them
...
- product: `LeanIM/*.lean`, 173614 lines; `execute_DIV` at
  `LeanIM/InstsEnd.lean:71434`; the lake project requires [[require]] name = "Sail" git = "https://github.com/rems-project/lean-sail" rev = "v5"  and toolchain
