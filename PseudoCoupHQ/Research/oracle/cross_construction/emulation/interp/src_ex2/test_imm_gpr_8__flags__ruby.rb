...
# InterpRenderer from the layer-4 term of test_imm_gpr_8__flags__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(~(~Extract(7, 0, v0) | ~Extract(7, 0, v1)), 0)
def emu_test_imm_gpr_8__flags__ruby(a, b)
  m(cat(bnot(bor(bnot(b, 8), bnot(a, 8), 8), 8), 0, 8), 16)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_test_imm_gpr_8__flags__ruby(*values)
