...
// InterpRenderer from the layer-4 term of not_gpr_one_8__reg_rdi__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(0, ~Extract(7, 0, v0))
function emu_not_gpr_one_8__reg_rdi__javascript(a) {
    return m(cat(0n, bnot(a, 8), 8), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_not_gpr_one_8__reg_rdi__javascript(...values).toString());
    } catch (problem) {
