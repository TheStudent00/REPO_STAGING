#!/bin/bash
# lp3_l47_survivors_widened_again_final_tally.sh -- the units whose
...
for q in range(4): json.dump({"summary":{}, "rows":rows[q::4]}, open("%s/walk_corpus_survivors3_%d.json" % (A,q),"w"))
