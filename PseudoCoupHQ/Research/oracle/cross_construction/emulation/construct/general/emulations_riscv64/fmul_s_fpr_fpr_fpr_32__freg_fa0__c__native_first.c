/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of fmul_s_fpr_fpr_fpr_32__freg_fa0__c__native_first.  The term's text, LITERAL:
...
uint64_t
emu_fmul_s_fpr_fpr_fpr_32__freg_fa0__c__native_first(uint32_t a, uint32_t b)
{
