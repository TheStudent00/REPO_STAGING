...
# InterpRenderer from the layer-4 term of mulhu_gpr_gpr_gpr_64__reg_a0__cpython.
# The term's layer-5 text, LITERAL:
#   Extract(127, 64, Concat(0, v0)*Concat(0, v1))
def emu_mulhu_gpr_gpr_gpr_64__reg_a0__cpython(a, b):
    return m(ext(mul(cat(0, a, 64), cat(0, b, 64), 128), 127, 64), 64)
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_mulhu_gpr_gpr_gpr_64__reg_a0__cpython(*values)
            sys.stdout.write("%d\n" % answer)
