...
// InterpRenderer from the layer-4 term of movzwl_widen_mem_gpr_32__reg_rdi__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(0, Extract(15, 0, v0))
function emu_movzwl_widen_mem_gpr_32__reg_rdi__javascript(a) {
    return m(cat(0n, a, 16), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_movzwl_widen_mem_gpr_32__reg_rdi__javascript(...values).toString());
    } catch (problem) {
