...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of mulw_gpr_gpr_gpr_32__reg_a0__csharp.
    ...
    public static long emu_mulw_gpr_gpr_gpr_32__reg_a0__csharp(long a, long b) {
        return m(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(ext(mul(a, b, 32), 31, 31), ext(mul(a, b, 32), 31, 31), 1), ext(mul(a, b, 32), 31, 31), 1), ext(mul(a, b, 32), 31, 31), 1), ext(mul(a, b, 32), 31, 31), 1), ext(mul(a, b, 32), 31, 31), 1), ext(mul(a, b, 32), 31, 31), 1), ext(mul(a, b, 32), 31, 31), 1), ext(mul(a, b, 32), 31, 31), 1), ext(mul(a, b, 32), 31, 31), 1), ext(mul(a, b, 32), 31, 31), 1), ext(mul(a, b, 32), 31, 31), 1), ext(mul(a, b, 32), 31, 31), 1), ext(mul(a, b, 32), 31, 31), 1), ext(mul(a, b, 32), 31, 31), 1), ext(mul(a, b, 32), 31, 31), 1), ext(mul(a, b, 32), 31, 31), 1), ext(mul(a, b, 32), 31, 31), 1), ext(mul(a, b, 32), 31, 31), 1), ext(mul(a, b, 32), 31, 31), 1), ext(mul(a, b, 32), 31, 31), 1), ext(mul(a, b, 32), 31, 31), 1), ext(mul(a, b, 32), 31, 31), 1), ext(mul(a, b, 32), 31, 31), 1), ext(mul(a, b, 32), 31, 31), 1), ext(mul(a, b, 32), 31, 31), 1), ext(mul(a, b, 32), 31, 31), 1), ext(mul(a, b, 32), 31, 31), 1), ext(mul(a, b, 32), 31, 31), 1), ext(mul(a, b, 32), 31, 31), 1), ext(mul(a, b, 32), 31, 31), 1), ext(mul(a, b, 32), 31, 31), 1), mul(a, b, 32), 32), 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_mulw_gpr_gpr_gpr_32__reg_a0__csharp(values[0], values[1])).ToString());
                    answers.Append("\n");
