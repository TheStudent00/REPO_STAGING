...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of divuw_gpr_gpr_gpr_32__reg_a0__csharp.
    ...
    public static long emu_divuw_gpr_gpr_gpr_32__reg_a0__csharp(long a, long b) {
        return m(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (1L) : (ext(udiv(b, a, 32), 31, 31))), 1), ((eq(a, 0L, 32)) ? (4294967295L) : (udiv(b, a, 32))), 32), 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_divuw_gpr_gpr_gpr_32__reg_a0__csharp(values[0], values[1])).ToString());
                    answers.Append("\n");
