...
// InterpRenderer from the layer-4 term of idiv_gpr_one_16__reg_rax__php.
...
function emu_idiv_gpr_one_16__reg_rax__php($a, $b, $c) {
    return ex_m(ex_cat(ex_ext($b, 63, 16), ex_ext(ex_sdiv(ex_cat($a, ex_ext($b, 15, 0), 16), ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_ext($c, 15, 15), ex_ext($c, 15, 15), 1), ex_ext($c, 15, 15), 1), ex_ext($c, 15, 15), 1), ex_ext($c, 15, 15), 1), ex_ext($c, 15, 15), 1), ex_ext($c, 15, 15), 1), ex_ext($c, 15, 15), 1), ex_ext($c, 15, 15), 1), ex_ext($c, 15, 15), 1), ex_ext($c, 15, 15), 1), ex_ext($c, 15, 15), 1), ex_ext($c, 15, 15), 1), ex_ext($c, 15, 15), 1), ex_ext($c, 15, 15), 1), ex_ext($c, 15, 15), 1), $c, 16), 32), 15, 0), 16), 64);
}
...
while (($line = fgets($handle)) !== false) {
    ...
    try {
        $answer = emu_idiv_gpr_one_16__reg_rax__php(...$ints);
        if ($answer < 0) {
            echo sprintf("%s\n", sprintf("%u", $answer));
        } else {
            echo $answer . "\n";
