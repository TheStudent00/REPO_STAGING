...
function au_443_go_shr_i32_i32(p0, p1) {
  ...
  const v4 = AU.au_sll(v2, 0x20n);
  const v5 = AU.au_srl(v4, 0x20n);
  const v6 = AU.au_sltu(v5, 0x20n);
  const v7 = AU.au_add(v6, 0xffffffffffffffffn);
  const v8 = AU.au_or(v2, v7);
  const v9 = AU.au_sraw(v1, v8);
  // the answer is int32, 32 bits
  return ((v9) & 0xffffffffn);
}

function au_443_go_shr_i32_i32_trap(p0, p1) {
  // a0: operand `a` (int32) sign-extended to XLEN, as the ABI presents it
  const v1 = AU.au_sext32(p0);
  // a1: operand `b` (int32) sign-extended to XLEN, as the ABI presents it
  const v2 = AU.au_sext32(p1);
...
module.exports = { au_443_go_shr_i32_i32, au_443_go_shr_i32_i32_trap };
