...
public class Emu {
    ...
    // one named local per gate, over the term of shr_cl_gpr_8__reg_rdi__java.
    // The term's layer-5 text, LITERAL:
    //   Concat(Extract(63, 8, v0), LShR(Extract(7, 0, v0), Concat(0, Extract(4, 0, v1))))
    static long emu_shr_cl_gpr_8__reg_rdi__java(long a, long b) {
        long x1_4 = ext(b, 4, 4);
        long x1_3 = ext(b, 3, 3);
        long x0_0 = ext(a, 0, 0);
        long x0_1 = ext(a, 1, 1);
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_shr_cl_gpr_8__reg_rdi__java(values[0], values[1])));
                    answers.append("\n");
