...
// InterpRenderer from the layer-4 term of punpckldq_mem_xmm_128__reg_xmm0.low__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(31, 0, v0), Extract(31, 0, v1))
function emu_punpckldq_mem_xmm_128__reg_xmm0.low__javascript(a, b) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_punpckldq_mem_xmm_128__reg_xmm0.low__javascript(...values).toString());
    } catch (problem) {
