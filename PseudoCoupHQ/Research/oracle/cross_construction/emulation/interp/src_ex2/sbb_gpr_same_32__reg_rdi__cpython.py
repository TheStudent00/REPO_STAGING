...
# InterpRenderer from the layer-4 term of sbb_gpr_same_32__reg_rdi__cpython.
...
def emu_sbb_gpr_same_32__reg_rdi__cpython(a, b, c):
    return m(cat(0, mul(((1) if (eq(ext(add(cat(0, b, 32), cat(0, a, 32), 33), 32, 32), 1, 1)) else (0)), 4294967295, 32), 32), 64)
