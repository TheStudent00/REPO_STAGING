...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of sb_gpr_imm_8__mem_MEM_0x3__csharp.
    // The term's layer-5 text, LITERAL:
    //   Concat(Extract(63, 8, v0), Extract(7, 0, v1))
    public static long emu_sb_gpr_imm_8__mem_MEM_0x3__csharp(long a, long b) {
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_sb_gpr_imm_8__mem_MEM_0x3__csharp(values[0], values[1])).ToString());
                    answers.Append("\n");
