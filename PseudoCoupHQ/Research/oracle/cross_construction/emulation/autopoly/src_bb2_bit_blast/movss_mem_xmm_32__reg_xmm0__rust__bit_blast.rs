...
// intermediate per node of the term of movss_mem_xmm_32__reg_xmm0__rust__bit_blast.
//   Extract(31, 0, v0)
#[no_mangle]
pub extern "C" fn emu_movss_mem_xmm_32__reg_xmm0__rust__bit_blast(a: u32) -> f32
{
