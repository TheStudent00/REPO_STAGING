...
theorem RTYPE__OR__cpp_00_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_RTYPE (a) (b) (rop.ADD)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_01_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_RTYPE (a) (b) (rop.SUB)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_02_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_RTYPE (a) (b) (rop.SLL)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_03_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_RTYPE (a) (b) (rop.SLT)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_04_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_RTYPE (a) (b) (rop.SLTU)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_05_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_RTYPE (a) (b) (rop.XOR)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_06_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_RTYPE (a) (b) (rop.SRL)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_07_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_RTYPE (a) (b) (rop.SRA)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_08_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_RTYPE (a) (b) (rop.OR)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_09_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_RTYPE (a) (b) (rop.AND)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_10_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_CLMUL (a) (b) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_11_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_CLMULH (a) (b) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_12_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_CLMULR (a) (b) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_13_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_DIV (a) (b) (false)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_14_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_DIV (a) (b) (true)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_15_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_DIVW (a) (b) (false)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_16_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_DIVW (a) (b) (true)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_17_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_MUL (a) (b) ({ result_part := VectorHalf.High, signed_rs1 := Signedness.Signed, signed_rs2 := Signedness.Signed })) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_18_same_text (a : BitVec 64) (b : BitVec 64) :
...
set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_19_same_text (a : BitVec 64) (b : BitVec 64) :
...
set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_20_same_text (a : BitVec 64) (b : BitVec 64) :
...
set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_25_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_MULW (a) (b) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_26_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_REM (a) (b) (false)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_27_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_REM (a) (b) (true)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_28_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_REMW (a) (b) (false)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_29_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_REMW (a) (b) (true)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_30_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_RTYPEW (a) (b) (ropw.ADDW)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_31_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_RTYPEW (a) (b) (ropw.SUBW)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_32_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_RTYPEW (a) (b) (ropw.SLLW)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_33_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_RTYPEW (a) (b) (ropw.SRLW)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_34_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_RTYPEW (a) (b) (ropw.SRAW)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_35_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_ZBB_RTYPE (a) (b) (brop_zbb.ANDN)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_36_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_ZBB_RTYPE (a) (b) (brop_zbb.ORN)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_37_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_ZBB_RTYPE (a) (b) (brop_zbb.XNOR)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_38_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_ZBB_RTYPE (a) (b) (brop_zbb.MAX)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_39_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_ZBB_RTYPE (a) (b) (brop_zbb.MAXU)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_40_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_ZBB_RTYPE (a) (b) (brop_zbb.MIN)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_41_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_ZBB_RTYPE (a) (b) (brop_zbb.MINU)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_42_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_ZBB_RTYPE (a) (b) (brop_zbb.ROL)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_43_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_ZBB_RTYPE (a) (b) (brop_zbb.ROR)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_44_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_ZBB_RTYPEW (a) (b) (bropw_zbb.ROLW)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_45_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_ZBB_RTYPEW (a) (b) (bropw_zbb.RORW)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_46_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_ZBKB_RTYPE (a) (b) (brop_zbkb.PACK)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_47_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_ZBKB_RTYPE (a) (b) (brop_zbkb.PACKH)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_48_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_ZBS_RTYPE (a) (b) (brop_zbs.BCLR)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_49_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_ZBS_RTYPE (a) (b) (brop_zbs.BEXT)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_50_same_text (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (OR))) = (pure_ZBS_RTYPE (a) (b) (brop_zbs.BINV)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem RTYPE__OR__cpp_51_same_text (a : BitVec 64) (b : BitVec 64) :
