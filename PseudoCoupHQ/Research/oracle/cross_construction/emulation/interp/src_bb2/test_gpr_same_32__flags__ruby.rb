...
# one named local per gate, over the term of test_gpr_same_32__flags__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(Extract(31, 0, v0), 0)
def emu_test_gpr_same_32__flags__ruby(a)
  x0_0 = ext(a, 0, 0)
  x0_1 = ext(a, 1, 1)
  x0_2 = ext(a, 2, 2)
  x0_3 = ext(a, 3, 3)
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_test_gpr_same_32__flags__ruby(*values)
