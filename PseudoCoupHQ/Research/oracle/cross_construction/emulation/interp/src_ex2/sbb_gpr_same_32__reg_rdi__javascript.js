...
// InterpRenderer from the layer-4 term of sbb_gpr_same_32__reg_rdi__javascript.
...
function emu_sbb_gpr_same_32__reg_rdi__javascript(a, b, c) {
    return m(cat(0n, mul(((eq(ext(add(cat(0n, b, 32), cat(0n, a, 32), 33), 32, 32), 1n, 1)) ? (1n) : (0n)), 4294967295n, 32), 32), 64);
}
