/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of E01671__swift_regen_1474.  The term's layer-5 text, LITERAL:
   ~(If(Extract(31, 0, v0) == Extract(31, 0, v1), 254, 255) | If(0 <= Extract(7, 0, v0), 254, 255)) */
#include <stdint.h>

uint8_t
emu_E01671__swift_regen_1474(uint32_t a, uint32_t b, uint64_t c)
{
