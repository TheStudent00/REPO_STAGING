...
/-- c single-opcode row 70, arch mnemonic 'sub', example unit c/op_149, 32 members
...
theorem ModelCheck_c_70 (v0 : BitVec 64) (v1 : BitVec 64) :
    ((((0#32) ++ (v0.extractLsb 31 0)) * (18446744073709551615#64)) + v1)
  = (model_sub_49 (model_mov_22 v1) (model_mov_18 v0)) := by
  simp only [model_mov_22, model_mov_18, model_sub_49]
  bv_decide

#print axioms ModelCheck_c_70
