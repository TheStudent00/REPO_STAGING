...
# InterpRenderer from the layer-4 term of xori_gpr_gpr_imm_64__reg_a0__cpython.
# The term's layer-5 text, LITERAL:
#   Concat(Extract(63, 2, v0), ~Extract(1, 0, v0))
def emu_xori_gpr_gpr_imm_64__reg_a0__cpython(a):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_xori_gpr_gpr_imm_64__reg_a0__cpython(*values)
            sys.stdout.write("%d\n" % answer)
