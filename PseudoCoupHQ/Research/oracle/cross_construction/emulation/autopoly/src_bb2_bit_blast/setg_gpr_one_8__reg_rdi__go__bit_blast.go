...
// intermediate per node of the term of setg_gpr_one_8__reg_rdi__go__bit_blast.
//   Concat(Extract(63, 8, v2), If(And(Not(~(~Extract(7, 0, v0) | ~Extract(7, 0, v1)) == 0), Or(Extract(7, 7, v0) == 0, Extract(7, 7, v1) == 0)), 1, 0))
package main

//go:noinline
func emu_setg_gpr_one_8__reg_rdi__go__bit_blast(a uint8, b uint8, c uint64) uint64 {
	...
	var g25 uint64 = (x0_1 ^ 1)
	var g26 uint64 = (g25 | g24)
	var g27 uint64 = (g26 ^ 1)
	var g28 uint64 = (x1_0 ^ 1)
	var g29 uint64 = (x0_0 ^ 1)
	var g30 uint64 = (g29 | g28)
	var g31 uint64 = (g30 ^ 1)
	var g32 uint64 = (g31 | g27)
	var g33 uint64 = (g32 | g23)
	var g34 uint64 = (g33 | g19)
	var g35 uint64 = (g34 | g15)
	var g36 uint64 = (g35 | g11)
	var g37 uint64 = (g36 | g7)
	var g38 uint64 = (g37 | g3)
...
func main() {
	sink = emu_setg_gpr_one_8__reg_rdi__go__bit_blast(g0, g1, g2)
	_ = sink
}
