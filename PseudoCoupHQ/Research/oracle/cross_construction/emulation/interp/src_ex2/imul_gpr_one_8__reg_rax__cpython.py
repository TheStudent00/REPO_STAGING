...
# InterpRenderer from the layer-4 term of imul_gpr_one_8__reg_rax__cpython.
...
def emu_imul_gpr_one_8__reg_rax__cpython(a, b):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_imul_gpr_one_8__reg_rax__cpython(*values)
            sys.stdout.write("%d\n" % answer)
