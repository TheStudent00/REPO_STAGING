...
// InterpRenderer from the layer-4 term of jal_gpr_imm_64__reg_a0__javascript.
// The term's layer-5 text, LITERAL:
//   v0 + 4
function emu_jal_gpr_imm_64__reg_a0__javascript(a) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_jal_gpr_imm_64__reg_a0__javascript(...values).toString());
    } catch (problem) {
