...
theorem add_gpr_gpr_same_64__reg_a0__rust__all_constructed__REV8_05_integer_level (a : BitVec 64) :
    ((pure_SHIFTIOP (a) ((0x01#6)) (SLLI))) = (pure_REV8 (a) ) := by
  try simp only [pure_SHIFTIOP, pure_REV8, log2_xlen, rev8, shift_bits_right_arith, xlen, zeros, Sail.BitVec.length, Sail.BitVec.updateSubrange, Sail.BitVec.extractLsb]
  grind
