...
// intermediate per node of the term of ITYPE__op_ADDI__rd__rust__all_constructed.
//   
#[no_mangle]
pub extern "C" fn emu_ITYPE__op_ADDI__rd__rust__all_constructed(a: u64, b: u16) -> u64
{
