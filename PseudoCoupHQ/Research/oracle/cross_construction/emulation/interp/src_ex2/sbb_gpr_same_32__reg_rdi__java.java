...
public class Emu {
    ...
    // InterpRenderer from the layer-4 term of sbb_gpr_same_32__reg_rdi__java.
    // The term's layer-5 text, LITERAL:
    //   Concat(0, If(Extract(32, 32, Concat(0, Extract(31, 0, v0)) + Concat(0, Extract(31, 0, v1))) == 1, 1, 0)*4294967295)
    static long emu_sbb_gpr_same_32__reg_rdi__java(long a, long b, long c) {
        return m(cat(0L, mul(((eq(ext(add(cat(0L, b, 32), cat(0L, a, 32), 33), 32, 32), 1L, 1)) ? (1L) : (0L)), 4294967295L, 32), 32), 64);
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_sbb_gpr_same_32__reg_rdi__java(values[0], values[1], values[2])));
                    answers.append("\n");
