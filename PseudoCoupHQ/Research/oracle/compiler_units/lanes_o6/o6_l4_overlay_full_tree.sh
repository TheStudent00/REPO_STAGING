#!/usr/bin/env bash
# task o6 lane 4 (resume): the FULL go/types pass over src/cmd/compile/...,
...
# go_types_sites.json.gz (gzip: ~200k one-line site records would be
# near GitHub's 100 MB file limit uncompressed; the artifact folder is
# auto-committed).
set -uo pipefail
