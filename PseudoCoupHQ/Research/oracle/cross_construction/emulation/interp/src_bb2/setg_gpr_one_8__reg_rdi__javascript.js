...
// one named local per gate, over the term of setg_gpr_one_8__reg_rdi__javascript.
...
function emu_setg_gpr_one_8__reg_rdi__javascript(a, b, c) {
    ...
    const g101 = (g98 | g62);
    const g102 = (g101 ^ 1n);
    const g103 = (g102 | g100);
    const g104 = (g103 | g64);
    const g105 = (g104 ^ 1n);
    const g106 = (g51 ^ x0_5);
    const g107 = (g106 ^ 1n);
    const g108 = (g107 | g105);
    const g109 = (g108 ^ 1n);
    const g110 = (g107 | g8);
    const g111 = (g110 ^ 1n);
    const g112 = (g8 | g105);
    ...
    const g128 = (g0 | g127);
    const g129 = (g128 ^ 1n);
    const g130 = (g127 | g123);
    const g131 = (g130 ^ 1n);
    const g132 = (g131 | g129);
    const g133 = (g132 | g125);
    const g134 = (x1_7 ^ g133);
    const g135 = (g134 ^ 1n);
    const g136 = (g135 ^ g56);
    const g137 = (g136 ^ 1n);
    const g138 = (x1_7 ^ g122);
    const g139 = (g138 ^ 1n);
    const g140 = (g139 ^ g127);
    const g141 = (g140 ^ 1n);
    const g142 = (g141 ^ g137);
    const g143 = (g142 ^ 1n);
    const g144 = (g141 ^ g143);
    const g145 = (g144 ^ 1n);
    const g146 = (g145 & g47);
    const k0 = 0n;
    const w0 = x2_63;
...
for (const line of lines) {
    ...
    try {
        out.push(emu_setg_gpr_one_8__reg_rdi__javascript(...values).toString());
    } catch (problem) {
