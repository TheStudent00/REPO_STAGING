...
/-- cpp single-opcode row 66, arch mnemonic 'shr', example unit cpp/op_745, 58 members
...
theorem ModelCheck_cpp_66 (v0 : BitVec 64) (v1 : BitVec 64) :
    ((v0.extractLsb 31 0) >>> ((0#27) ++ (v1.extractLsb 4 0)))
  = ((model_shr_8 (model_mov_15 v0) (model_mov_19 v1)).extractLsb 31 0) := by
  simp only [model_mov_19, model_mov_15, model_shr_8]
  bv_decide

#print axioms ModelCheck_cpp_66
