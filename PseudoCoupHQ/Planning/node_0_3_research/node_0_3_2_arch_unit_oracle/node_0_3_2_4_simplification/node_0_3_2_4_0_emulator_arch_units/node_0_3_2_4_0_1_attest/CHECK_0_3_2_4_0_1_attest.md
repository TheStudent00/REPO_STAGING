---
id: hq.research.arch_unit_oracle.simplification.emulator_arch_units.attest.check
---

# CHECK — 0_3_2_4_0_1_attest

Node `hq.research.arch_unit_oracle.simplification.emulator_arch_units.attest`. Status `draft`.
