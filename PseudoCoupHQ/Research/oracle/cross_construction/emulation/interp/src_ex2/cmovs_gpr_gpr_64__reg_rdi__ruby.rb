...
# InterpRenderer from the layer-4 term of cmovs_gpr_gpr_64__reg_rdi__ruby.
# The term's layer-5 text, LITERAL:
#   If(0 <= ~(~v0 | ~v1), v2, v3)
def emu_cmovs_gpr_gpr_64__reg_rdi__ruby(a, b, c, d)
  m(((sle(0, bnot(bor(bnot(b, 64), bnot(a, 64), 64), 64), 64)) ? (d) : (c)), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_cmovs_gpr_gpr_64__reg_rdi__ruby(*values)
