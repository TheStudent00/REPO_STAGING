...
# InterpRenderer from the layer-4 term of test_cl_gpr_8__flags__cpython.
# The term's layer-5 text, LITERAL:
#   Concat(~(~Extract(7, 0, v0) | ~Extract(7, 0, v1)), 0)
def emu_test_cl_gpr_8__flags__cpython(a, b):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_test_cl_gpr_8__flags__cpython(*values)
            sys.stdout.write("%d\n" % answer)
