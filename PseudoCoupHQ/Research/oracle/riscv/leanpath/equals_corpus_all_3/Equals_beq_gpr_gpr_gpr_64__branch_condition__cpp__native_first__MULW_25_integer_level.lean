...
theorem beq_gpr_gpr_gpr_64__branch_condition__cpp__native_first__MULW_25_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_ITYPE ((pure_RTYPE (a) (b) (XOR))) (0x001#12) (LeanIM.iop.SLTIU))) = (pure_MULW (a) (b) ) := by
  try simp only [pure_RTYPE, pure_ITYPE, pure_MULW, bool_to_bit, log2_xlen, shift_bits_right_arith, sign_extend, to_bits_truncate, xlenbits, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend]
  grind
