...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of ori_gpr_gpr_imm_64__reg_a0__csharp.
    // The term's layer-5 text, LITERAL:
    //   Concat(Extract(63, 2, v0), 3)
    public static long emu_ori_gpr_gpr_imm_64__reg_a0__csharp(long a) {
        return m(cat(ext(a, 63, 2), 3L, 2), 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_ori_gpr_gpr_imm_64__reg_a0__csharp(values[0])).ToString());
                    answers.Append("\n");
