...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of xori_gpr_gpr_imm_64__reg_a0__csharp.
    // The term's layer-5 text, LITERAL:
    //   Concat(Extract(63, 2, v0), ~Extract(1, 0, v0))
    public static long emu_xori_gpr_gpr_imm_64__reg_a0__csharp(long a) {
        return m(cat(ext(a, 63, 2), bnot(ext(a, 1, 0), 2), 2), 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_xori_gpr_gpr_imm_64__reg_a0__csharp(values[0])).ToString());
                    answers.Append("\n");
