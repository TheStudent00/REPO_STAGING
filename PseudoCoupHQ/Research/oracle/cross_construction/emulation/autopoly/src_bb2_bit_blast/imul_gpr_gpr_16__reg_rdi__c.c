/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of imul_gpr_gpr_16__reg_rdi__c.  The term's layer-5 text, LITERAL:
   Concat(Extract(63, 16, v0), Extract(15, 0, v0)*Extract(15, 0, v1)) */
#include <stdint.h>

uint64_t
emu_imul_gpr_gpr_16__reg_rdi__c(uint64_t a, uint16_t b)
{
