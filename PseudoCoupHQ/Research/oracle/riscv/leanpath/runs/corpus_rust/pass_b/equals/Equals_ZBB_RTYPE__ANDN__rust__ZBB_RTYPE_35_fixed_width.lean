...
theorem ZBB_RTYPE__ANDN__rust__ZBB_RTYPE_35_fixed_width (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) ((pure_ITYPE (b) (0xfff#12) (LeanIM.iop.XORI))) (AND))) = (pure_ZBB_RTYPE (a) (b) (brop_zbb.ANDN)) := by
  try simp only [pure_RTYPE, pure_ITYPE, pure_ZBB_RTYPE, bool_to_bit, log2_xlen, rotate_bits_left, rotate_bits_right, shift_bits_right_arith, sign_extend, xlenbits, zero_extend, zopz0zI_s, zopz0zI_u, zopz0zK_s, zopz0zK_u, bool_bit_forwards, xlen, rotatel, rotater, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend, Sail.BitVec.length, Sail.BitVec.extractLsb, Sail.shift_bits_right, Sail.shift_bits_left]
  all_goals bv_decide
