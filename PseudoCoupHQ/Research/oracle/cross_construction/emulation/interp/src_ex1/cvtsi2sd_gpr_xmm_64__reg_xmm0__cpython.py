...
# InterpRenderer from the layer-4 term of cvtsi2sd_gpr_xmm_64__reg_xmm0__cpython.
# The term's layer-5 text, LITERAL:
#   fp.to_ieee_bv(fpToFP(RNE(), v0))
def emu_cvtsi2sd_gpr_xmm_64__reg_xmm0__cpython(a):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_cvtsi2sd_gpr_xmm_64__reg_xmm0__cpython(*values)
            sys.stdout.write("%d\n" % answer)
