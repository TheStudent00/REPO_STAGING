...
public class Emu {
    ...
    // InterpRenderer from the layer-4 term of fmul_s_fpr_fpr_fpr_32__freg_fa0__java.
    // The term's layer-5 text, LITERAL:
    //   Concat(4294967295, fp.to_ieee_bv(fpToFP(Extract(31, 0, v0)) * fpToFP(Extract(31, 0, v1))))
    static long emu_fmul_s_fpr_fpr_fpr_32__freg_fa0__java(long a, long b) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_fmul_s_fpr_fpr_fpr_32__freg_fa0__java(values[0], values[1])));
                    answers.append("\n");
