...
- **PlanPlan** (`~/Programming/PlanPlan/`, private repo):
...
- **The automation boundary — RESOLVED by the owner's churn-resilience
  ...
  `~/Programming/PseudoCoup_v6/Planning/CORE_0.md`)**: the goal is
...
- **T4 MIN/-1 — RESOLVED (the owner, 2026-07-28): TRAP. IMPLEMENTED
  ...
  `~/Programming/PseudoCoup_v6/Tools/polyfill/wrap_fixed_width.py`
