/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of go_7__go_op_117.  The term's layer-5 text, LITERAL:
...
float
emu_go_7__go_op_117(double a, float b)
{
