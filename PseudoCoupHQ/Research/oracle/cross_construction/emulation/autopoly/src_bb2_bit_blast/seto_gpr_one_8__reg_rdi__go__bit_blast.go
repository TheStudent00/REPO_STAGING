...
// intermediate per node of the term of seto_gpr_one_8__reg_rdi__go__bit_blast.
...
//go:noinline
func emu_seto_gpr_one_8__reg_rdi__go__bit_blast(a uint8, b uint8, c uint64) uint64 {
	...
	var g79 uint64 = (x1_7 ^ g78)
	var g80 uint64 = (g79 ^ 1)
	var g81 uint64 = (x0_7 ^ g80)
	var g82 uint64 = (g81 ^ 1)
	var g83 uint64 = (x1_7 ^ g67)
	var g84 uint64 = (g83 ^ 1)
	var g85 uint64 = (x0_7 ^ g84)
	var g86 uint64 = (g85 ^ 1)
	var g87 uint64 = (g86 ^ g82)
...
func main() {
	sink = emu_seto_gpr_one_8__reg_rdi__go__bit_blast(g0, g1, g2)
	_ = sink
}
