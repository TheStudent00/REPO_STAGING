...
theorem add_gpr_gpr_gpr_64__reg_a0__rust__all_constructed_30_integer_level (a : BitVec 64) (b : BitVec 64) :
  ...
  try simp only [pure_SHIFTIOP, pure_RTYPE, pure_RTYPEW, shift_bits_right_arith, sign_extend, Sail.BitVec.toNatInt, Sail.BitVec.signExtend]
  grind
