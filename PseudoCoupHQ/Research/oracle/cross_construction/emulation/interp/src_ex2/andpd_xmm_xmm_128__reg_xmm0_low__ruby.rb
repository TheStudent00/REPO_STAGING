...
# InterpRenderer from the layer-4 term of andpd_xmm_xmm_128__reg_xmm0_low__ruby.
# The term's layer-5 text, LITERAL:
#   ~(~Extract(63, 0, v0) | ~Extract(63, 0, v1))
def emu_andpd_xmm_xmm_128__reg_xmm0_low__ruby(a, b)
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_andpd_xmm_xmm_128__reg_xmm0_low__ruby(*values)
