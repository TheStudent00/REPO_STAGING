...
# InterpRenderer from the layer-4 term of add_gpr_gpr_64__reg_rdi__cpython.
# The term's layer-5 text, LITERAL:
#   v0 + v1
def emu_add_gpr_gpr_64__reg_rdi__cpython(a, b):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_add_gpr_gpr_64__reg_rdi__cpython(*values)
            sys.stdout.write("%d\n" % answer)
