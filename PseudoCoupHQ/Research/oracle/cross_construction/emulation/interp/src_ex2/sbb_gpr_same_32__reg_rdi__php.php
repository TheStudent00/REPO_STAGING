...
// InterpRenderer from the layer-4 term of sbb_gpr_same_32__reg_rdi__php.
...
function emu_sbb_gpr_same_32__reg_rdi__php($a, $b, $c) {
    return ex_m(ex_cat(0, ex_mul(((ex_eq(ex_ext(ex_add(ex_cat(0, $b, 32), ex_cat(0, $a, 32), 33), 32, 32), 1, 1)) ? (1) : (0)), 4294967295, 32), 32), 64);
}
