...
// InterpRenderer from the layer-4 term of idiv_gpr_one_32__reg_rax__php.
...
function emu_idiv_gpr_one_32__reg_rax__php($a, $b, $c) {
    return ex_m(ex_cat(0, ex_ext(ex_sdiv(ex_cat($a, $b, 32), ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_ext($c, 31, 31), ex_ext($c, 31, 31), 1), ex_ext($c, 31, 31), 1), ex_ext($c, 31, 31), 1), ex_ext($c, 31, 31), 1), ex_ext($c, 31, 31), 1), ex_ext($c, 31, 31), 1), ex_ext($c, 31, 31), 1), ex_ext($c, 31, 31), 1), ex_ext($c, 31, 31), 1), ex_ext($c, 31, 31), 1), ex_ext($c, 31, 31), 1), ex_ext($c, 31, 31), 1), ex_ext($c, 31, 31), 1), ex_ext($c, 31, 31), 1), ex_ext($c, 31, 31), 1), ex_ext($c, 31, 31), 1), ex_ext($c, 31, 31), 1), ex_ext($c, 31, 31), 1), ex_ext($c, 31, 31), 1), ex_ext($c, 31, 31), 1), ex_ext($c, 31, 31), 1), ex_ext($c, 31, 31), 1), ex_ext($c, 31, 31), 1), ex_ext($c, 31, 31), 1), ex_ext($c, 31, 31), 1), ex_ext($c, 31, 31), 1), ex_ext($c, 31, 31), 1), ex_ext($c, 31, 31), 1), ex_ext($c, 31, 31), 1), ex_ext($c, 31, 31), 1), ex_ext($c, 31, 31), 1), $c, 32), 64), 31, 0), 32), 64);
}
...
while (($line = fgets($handle)) !== false) {
    ...
    try {
        $answer = emu_idiv_gpr_one_32__reg_rax__php(...$ints);
        if ($answer < 0) {
            echo sprintf("%s\n", sprintf("%u", $answer));
        } else {
            echo $answer . "\n";
