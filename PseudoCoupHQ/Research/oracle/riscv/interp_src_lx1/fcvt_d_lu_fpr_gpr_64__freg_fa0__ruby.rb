...
# InterpRenderer from the layer-4 term of fcvt_d_lu_fpr_gpr_64__freg_fa0__ruby.
# The term's layer-5 text, LITERAL:
#   fp.to_ieee_bv(fpToFPUnsigned(RNE(), v0))
def emu_fcvt_d_lu_fpr_gpr_64__freg_fa0__ruby(a)
  m(u2f(a, 64, 64), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_fcvt_d_lu_fpr_gpr_64__freg_fa0__ruby(*values)
