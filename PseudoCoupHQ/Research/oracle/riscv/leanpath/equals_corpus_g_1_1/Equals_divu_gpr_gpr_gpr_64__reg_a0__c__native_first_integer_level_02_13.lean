...
theorem divu_gpr_gpr_gpr_64__reg_a0__c__native_first_02_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_DIV (b) (a) (true))) = (pure_CLMUL (a) (b) ) := by
  try simp only [pure_DIV, pure_CLMUL, carryless_mul, xlen, zero_extend, zeros, Sail.BitVec.length, Sail.BitVec.zeroExtend]
  grind

set_option maxHeartbeats 40000 in
theorem divu_gpr_gpr_gpr_64__reg_a0__c__native_first_03_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_DIV (b) (a) (true))) = (pure_CLMULH (a) (b) ) := by
  try simp only [pure_DIV, pure_CLMULH, carryless_mul, xlen, zero_extend, zeros, Sail.BitVec.length, Sail.BitVec.zeroExtend]
  grind

set_option maxHeartbeats 40000 in
theorem divu_gpr_gpr_gpr_64__reg_a0__c__native_first_04_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_DIV (b) (a) (true))) = (pure_CLMULR (a) (b) ) := by
  try simp only [pure_DIV, pure_CLMULR, carryless_mulr, zeros, Sail.BitVec.length]
  grind

set_option maxHeartbeats 40000 in
theorem divu_gpr_gpr_gpr_64__reg_a0__c__native_first_05_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_DIV (b) (a) (true))) = (pure_DIVW (a) (b) (false)) := by
  try simp only [pure_DIV, pure_DIVW, not, sign_extend, to_bits_truncate, Sail.BitVec.signExtend]
  grind

set_option maxHeartbeats 40000 in
theorem divu_gpr_gpr_gpr_64__reg_a0__c__native_first_06_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_DIV (b) (a) (true))) = (pure_DIVW (a) (b) (true)) := by
  try simp only [pure_DIV, pure_DIVW, not, sign_extend, to_bits_truncate, Sail.BitVec.signExtend]
  grind

set_option maxHeartbeats 40000 in
theorem divu_gpr_gpr_gpr_64__reg_a0__c__native_first_07_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_DIV (b) (a) (true))) = (pure_MUL (a) (b) ({ result_part := VectorHalf.High, signed_rs1 := Signedness.Signed, signed_rs2 := Signedness.Signed })) := by
  try simp only [pure_DIV, pure_MUL, mult_to_bits_half, xlen, to_bits_truncate, Sail.BitVec.extractLsb]
  grind

set_option maxHeartbeats 40000 in
theorem divu_gpr_gpr_gpr_64__reg_a0__c__native_first_08_integer_level (a : BitVec 64) (b : BitVec 64) :
...
set_option maxHeartbeats 40000 in
theorem divu_gpr_gpr_gpr_64__reg_a0__c__native_first_09_integer_level (a : BitVec 64) (b : BitVec 64) :
...
set_option maxHeartbeats 40000 in
theorem divu_gpr_gpr_gpr_64__reg_a0__c__native_first_10_integer_level (a : BitVec 64) (b : BitVec 64) :
...
set_option maxHeartbeats 40000 in
theorem divu_gpr_gpr_gpr_64__reg_a0__c__native_first_11_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_DIV (b) (a) (true))) = (pure_MUL (a) (b) ({ result_part := VectorHalf.Low, signed_rs1 := Signedness.Signed, signed_rs2 := Signedness.Signed })) := by
  try simp only [pure_DIV, pure_MUL, mult_to_bits_half, xlen, to_bits_truncate, Sail.BitVec.extractLsb]
  grind

set_option maxHeartbeats 40000 in
theorem divu_gpr_gpr_gpr_64__reg_a0__c__native_first_12_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_DIV (b) (a) (true))) = (pure_MUL (a) (b) ({ result_part := VectorHalf.Low, signed_rs1 := Signedness.Signed, signed_rs2 := Signedness.Unsigned })) := by
  try simp only [pure_DIV, pure_MUL, mult_to_bits_half, xlen, to_bits_truncate, Sail.BitVec.extractLsb]
  grind

set_option maxHeartbeats 40000 in
theorem divu_gpr_gpr_gpr_64__reg_a0__c__native_first_13_integer_level (a : BitVec 64) (b : BitVec 64) :
