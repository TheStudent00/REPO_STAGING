...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of czero_eqz_gpr_gpr_gpr_64__reg_a0__csharp.
    // The term's layer-5 text, LITERAL:
    //   If(v0 == 0, 0, v1)
    public static long emu_czero_eqz_gpr_gpr_gpr_64__reg_a0__csharp(long a, long b) {
        return m(((eq(a, 0L, 64)) ? (0L) : (b)), 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_czero_eqz_gpr_gpr_gpr_64__reg_a0__csharp(values[0], values[1])).ToString());
                    answers.Append("\n");
