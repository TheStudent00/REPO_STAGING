/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of cpp_65__cpp_op_744.  The term's layer-5 text, LITERAL:
   LShR(Extract(31, 0, v0), Concat(0, Extract(4, 0, v1))) */
#include <stdint.h>

uint32_t
emu_cpp_65__cpp_op_744(uint32_t a, uint8_t b)
{
