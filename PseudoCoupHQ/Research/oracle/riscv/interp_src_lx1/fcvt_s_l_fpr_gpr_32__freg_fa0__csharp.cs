...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of fcvt_s_l_fpr_gpr_32__freg_fa0__csharp.
    // The term's layer-5 text, LITERAL:
    //   Concat(4294967295, fp.to_ieee_bv(fpToFP(RNE(), v0)))
    public static long emu_fcvt_s_l_fpr_gpr_32__freg_fa0__csharp(long a) {
        return m(cat(4294967295L, i2f(a, 64, 32), 32), 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_fcvt_s_l_fpr_gpr_32__freg_fa0__csharp(values[0])).ToString());
                    answers.Append("\n");
