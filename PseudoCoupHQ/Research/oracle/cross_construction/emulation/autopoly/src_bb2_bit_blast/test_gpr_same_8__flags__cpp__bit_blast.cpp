/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of test_gpr_same_8__flags__cpp__bit_blast.  The term's text, LITERAL:
   Concat(Extract(7, 0, v0), 0) */
#include <cstdint>

extern "C"
uint16_t
emu_test_gpr_same_8__flags__cpp__bit_blast(uint8_t a)
{
