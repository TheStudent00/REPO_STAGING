...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of or_gpr_gpr_same_64__reg_a0__csharp.
    // The term's layer-5 text, LITERAL:
    //   v0
    public static long emu_or_gpr_gpr_same_64__reg_a0__csharp(long a) {
        return m(a, 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_or_gpr_gpr_same_64__reg_a0__csharp(values[0])).ToString());
                    answers.Append("\n");
