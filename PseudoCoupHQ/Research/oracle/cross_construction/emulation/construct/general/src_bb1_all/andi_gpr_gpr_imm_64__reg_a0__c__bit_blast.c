/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of andi_gpr_gpr_imm_64__reg_a0__c__bit_blast.  The term's text, LITERAL:
   Concat(0, Extract(1, 0, v0)) */
#include <stdint.h>

uint64_t
emu_andi_gpr_gpr_imm_64__reg_a0__c__bit_blast(uint8_t a)
{
