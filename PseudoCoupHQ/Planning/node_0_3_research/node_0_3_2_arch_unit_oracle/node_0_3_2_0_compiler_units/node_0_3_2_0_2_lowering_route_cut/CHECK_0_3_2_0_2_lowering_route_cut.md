---
id: hq.research.arch_unit_oracle.compiler_units.lowering_route_cut.check
---

# CHECK — 0_3_2_0_2_lowering_route_cut

Node `hq.research.arch_unit_oracle.compiler_units.lowering_route_cut`. Status `draft`.
