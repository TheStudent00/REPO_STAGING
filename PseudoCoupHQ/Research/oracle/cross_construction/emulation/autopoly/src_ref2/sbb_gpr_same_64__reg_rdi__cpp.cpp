/* task ex1 emulation -- rendered by cpp_render.py CppRenderer from the layer-4 term of sbb_gpr_same_64__reg_rdi__cpp.  The term's layer-5 text, LITERAL:
   If(Extract(64, 64, Concat(0, v0) + Concat(0, v1)) == 1, 1, 0)*18446744073709551615 */
#include <cstdint>

extern "C"
uint64_t
emu_sbb_gpr_same_64__reg_rdi__cpp(uint64_t a, uint64_t b, uint64_t c)
{
