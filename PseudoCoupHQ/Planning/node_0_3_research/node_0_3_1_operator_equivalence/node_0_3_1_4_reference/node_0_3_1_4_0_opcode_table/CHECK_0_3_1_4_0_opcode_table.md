---
id: hq.research.compiler_graph.reference.opcode_table.check
---

# CHECK — 0_3_1_4_0_opcode_table

Node `hq.research.compiler_graph.reference.opcode_table`. Status `draft`.
