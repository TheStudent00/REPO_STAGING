...
uint64_t f16_to_i64_rm0(uint64_t v_arg)
{
    ...
    const bool v__c13 = (v_i26 && v__n11);
    const uint32_t v__m15 = (uint32_t)((v__c13) ? ~(uint32_t)0 : (uint32_t)0);
    const uint32_t v__a16 = (uint32_t)(v_i30 & v__m15);
    const bool v__n17 = (v_i26 != true);
    const bool v__c19 = (v__n17 && v__n12);
    ...
    const uint64_t v__m46 = (uint64_t)((v_i7) ? ~(uint64_t)0 : (uint64_t)0);
    const uint64_t v__a47 = (uint64_t)(v_i11 & v__m46);
    const bool v__c48 = (v__n26 && v_i17);
    const uint64_t v__m50 = (uint64_t)((v__c48) ? ~(uint64_t)0 : (uint64_t)0);
    const uint64_t v__a51 = (uint64_t)(v_i24 & v__m50);
    const uint64_t v__o52 = (uint64_t)(v__a47 | v__a51);
    const uint32_t v__m27 = (uint32_t)((v__n26) ? ~(uint32_t)0 : (uint32_t)0);
    const uint32_t v__a28 = (uint32_t)(v__o25 & v__m27);
    const uint64_t v__m57 = (uint64_t)((v__n11) ? ~(uint64_t)0 : (uint64_t)0);
    ...
    const uint32_t v_i46 = (uint32_t)(v__a43 | v__a45);
    const uint64_t v_i47 = (uint64_t)(int64_t)(int32_t)(v_i46);
    const uint64_t v__a58 = (uint64_t)(v_i47 & v__m57);
    const uint64_t v__o59 = (uint64_t)(v__o52 | v__a58);
    return v__o59;
}
