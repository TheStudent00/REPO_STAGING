...
# one named local per gate, over the term of cmp_imm_gpr_16__flags__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(Extract(15, 0, v0), Extract(15, 0, v1))
def emu_cmp_imm_gpr_16__flags__ruby(a, b)
  x1_0 = ext(b, 0, 0)
  x1_1 = ext(b, 1, 1)
  x1_2 = ext(b, 2, 2)
  x1_3 = ext(b, 3, 3)
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_cmp_imm_gpr_16__flags__ruby(*values)
