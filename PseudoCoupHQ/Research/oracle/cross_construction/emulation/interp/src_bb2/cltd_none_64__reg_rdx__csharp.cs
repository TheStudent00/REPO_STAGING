...
public static class Emu {
    ...
    // one named local per gate, over the term of cltd_none_64__reg_rdx__csharp.
    // The term's layer-5 text, LITERAL:
    //   Concat(0, Extract(31, 0, v0) >> 31)
    public static long emu_cltd_none_64__reg_rdx__csharp(long a) {
        ...
        long w33 = cat(w32, x0_31, 1);
        long w34 = cat(w33, x0_31, 1);
        long w35 = cat(w34, x0_31, 1);
        long w36 = cat(w35, x0_31, 1);
        long w37 = cat(w36, x0_31, 1);
        long w38 = cat(w37, x0_31, 1);
        long w39 = cat(w38, x0_31, 1);
        long w40 = cat(w39, x0_31, 1);
        long w41 = cat(w40, x0_31, 1);
        long w42 = cat(w41, x0_31, 1);
        long w43 = cat(w42, x0_31, 1);
        long w44 = cat(w43, x0_31, 1);
        long w45 = cat(w44, x0_31, 1);
        long w46 = cat(w45, x0_31, 1);
        long w47 = cat(w46, x0_31, 1);
        long w48 = cat(w47, x0_31, 1);
        long w49 = cat(w48, x0_31, 1);
        long w50 = cat(w49, x0_31, 1);
        long w51 = cat(w50, x0_31, 1);
        long w52 = cat(w51, x0_31, 1);
        long w53 = cat(w52, x0_31, 1);
        long w54 = cat(w53, x0_31, 1);
        long w55 = cat(w54, x0_31, 1);
        long w56 = cat(w55, x0_31, 1);
        long w57 = cat(w56, x0_31, 1);
        long w58 = cat(w57, x0_31, 1);
        long w59 = cat(w58, x0_31, 1);
        long w60 = cat(w59, x0_31, 1);
        long w61 = cat(w60, x0_31, 1);
        long w62 = cat(w61, x0_31, 1);
        long w63 = cat(w62, x0_31, 1);
        return m(w63, 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_cltd_none_64__reg_rdx__csharp(values[0])).ToString());
                    answers.Append("\n");
