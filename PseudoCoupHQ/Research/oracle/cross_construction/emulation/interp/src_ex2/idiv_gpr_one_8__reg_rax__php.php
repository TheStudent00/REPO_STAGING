...
// InterpRenderer from the layer-4 term of idiv_gpr_one_8__reg_rax__php.
...
function emu_idiv_gpr_one_8__reg_rax__php($a, $b) {
    return ex_m(ex_cat(ex_cat(ex_ext($a, 63, 16), ex_ext(ex_srem(ex_ext($a, 15, 0), ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_ext($b, 7, 7), ex_ext($b, 7, 7), 1), ex_ext($b, 7, 7), 1), ex_ext($b, 7, 7), 1), ex_ext($b, 7, 7), 1), ex_ext($b, 7, 7), 1), ex_ext($b, 7, 7), 1), ex_ext($b, 7, 7), 1), $b, 8), 16), 7, 0), 8), ex_ext(ex_sdiv(ex_ext($a, 15, 0), ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_ext($b, 7, 7), ex_ext($b, 7, 7), 1), ex_ext($b, 7, 7), 1), ex_ext($b, 7, 7), 1), ex_ext($b, 7, 7), 1), ex_ext($b, 7, 7), 1), ex_ext($b, 7, 7), 1), ex_ext($b, 7, 7), 1), $b, 8), 16), 7, 0), 8), 64);
}
