...
# InterpRenderer from the layer-4 term of cmovae_gpr_gpr_64__reg_rdi__ruby.
# The term's layer-5 text, LITERAL:
#   If(ULE(v0, v1), v2, v3)
def emu_cmovae_gpr_gpr_64__reg_rdi__ruby(a, b, c, d)
  m(((ule(b, a, 64)) ? (c) : (d)), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_cmovae_gpr_gpr_64__reg_rdi__ruby(*values)
