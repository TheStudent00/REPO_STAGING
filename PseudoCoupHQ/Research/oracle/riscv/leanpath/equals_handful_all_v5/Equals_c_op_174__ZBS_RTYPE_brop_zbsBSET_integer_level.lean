...
theorem c_op_174__ZBS_RTYPE_brop_zbsBSET_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_MULW (b) (a))) = (pure_ZBS_RTYPE (a) (b) (brop_zbs.BSET)) := by
  simp only [pure_MULW, pure_ZBS_RTYPE]
  grind
