; ModuleID = '<scratch>/fl/run/i32_to_f64.rm2.flags/i32_to_f64.rm2.flags.rv.flat.ll'
source_filename = "llvm-link"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128"
target triple = "riscv64-unknown-unknown-elf"

define dso_local [2 x i64] @i32_to_f64_rm2_flags_flat(i32 noundef signext %arg) {
  %i = icmp eq i32 %arg, 0
  %.n7 = xor i1 %i, true
