...
// intermediate per node of the term of imul_gpr_gpr_16__flags__go__bit_blast.
//   Concat(Extract(15, 0, v0), Extract(15, 0, v1))
package main

//go:noinline
func emu_imul_gpr_gpr_16__flags__go__bit_blast(a uint16, b uint16) uint32 {
	...
	var w8 uint32 = w7 | (x1_8 << 8)
	var w9 uint32 = w8 | (x1_9 << 9)
	var w10 uint32 = w9 | (x1_10 << 10)
	var w11 uint32 = w10 | (x1_11 << 11)
	var w12 uint32 = w11 | (x1_12 << 12)
	var w13 uint32 = w12 | (x1_13 << 13)
	var w14 uint32 = w13 | (x1_14 << 14)
	var w15 uint32 = w14 | (x1_15 << 15)
...
func main() {
	sink = emu_imul_gpr_gpr_16__flags__go__bit_blast(g0, g1)
	_ = sink
}
