...
- [node](node_0_0_0_0_0_node/CORE_0_0_0_0_0_node.md) — the UR node — one node shape in four layers, each layer owned by a different writer, none replacing the one beneath it (drafted in `~/Programming/PseudoCoup_v5/DevComms/log_002_ur_brainstorm.md` §7.1).
...
- the prior implementation is
  `~/Programming/PseudoCoup/pseudocoup/core/ur_ast.py` and its two
