...
public class Emu {
    ...
    // InterpRenderer from the layer-4 term of fmv_s_fpr_fpr_32__freg_fa0__java.
    // The term's layer-5 text, LITERAL:
    //   v0
    static long emu_fmv_s_fpr_fpr_32__freg_fa0__java(long a) {
        return m(a, 64);
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_fmv_s_fpr_fpr_32__freg_fa0__java(values[0])));
                    answers.append("\n");
