...
`PRIVATE/PseudoCoupHQ/Planning/node_0_3_research/node_0_3_1_dominant_intentions/CORE_0_3_1_dominant_intentions.md`
and
`PRIVATE/PseudoCoupHQ/Planning/node_0_3_research/node_0_3_2_kind_fuzz_clustering/CORE_0_3_2_kind_fuzz_clustering.md`.
Artifacts: `PRIVATE/PseudoCoupHQ/Research/dominant_intentions/`
and `PRIVATE/PseudoCoupHQ/DevComms/`.
...
- **The census pages predate the campaign that tested them.** The five
  files in `PRIVATE/PseudoCoupHQ/Research/dominant_intentions/`
...
- **Section numbers in these logs are load-bearing.** Other logs, and
  ...
  `PRIVATE/PseudoCoupHQ/Planning/node_0_3_research/node_0_3_2_kind_fuzz_clustering/`,
...
- **The check passes and nothing broke.** `bash
  PRIVATE/PseudoCoupHQ/hq.sh check` reports 0 errors both before
...
- **`bash PRIVATE/PseudoCoupHQ/hq.sh check` reports 0 errors and
...
- **One thing worth knowing about the item labels.** Several references
  ...
  `PRIVATE/PseudoCoupHQ/Planning/node_0_3_research/node_0_3_2_kind_fuzz_clustering/CHECK_0_3_2_kind_fuzz_clustering.md`,
