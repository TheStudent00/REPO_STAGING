...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of lh_gpr_gpr_same_16__reg_a0__csharp.
    ...
    public static long emu_lh_gpr_gpr_same_16__reg_a0__csharp(long a) {
        return m(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(ext(a, 15, 15), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), ext(a, 15, 15), 1), a, 16), 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_lh_gpr_gpr_same_16__reg_a0__csharp(values[0])).ToString());
                    answers.Append("\n");
