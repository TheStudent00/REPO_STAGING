...
// intermediate per node of the term of RTYPE__op_SLTU__rd__rust__all_constructed.
//   
#[no_mangle]
pub extern "C" fn emu_RTYPE__op_SLTU__rd__rust__all_constructed(a: u64, b: u64) -> u64
{
    ...
    let v36: bool = (!(v35));
    let v37: u32 = (if (v36) { ((0x0u32) as u32) } else { ((0x1u32) as u32) });
    let v38: u32 = v37;
    let v39: u64 = 0x0u64;
    let v40: u64 = (((((v39) as u64) << 1) | ((v38) as u64)) as u64);
    ((v40) as u64)
}
