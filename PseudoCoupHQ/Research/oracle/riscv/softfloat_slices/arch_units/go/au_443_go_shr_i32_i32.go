...
func Au_443_go_shr_i32_i32(p0 uint64, p1 uint64) uint64 {
	...
	var v4 uint64 = au_sll(v2, uint64(0x20)); _ = v4
	var v5 uint64 = au_srl(v4, uint64(0x20)); _ = v5
	var v6 uint64 = au_sltu(v5, uint64(0x20)); _ = v6
	var v7 uint64 = au_add(v6, uint64(0xffffffffffffffff)); _ = v7
	var v8 uint64 = au_or(v2, v7); _ = v8
	var v9 uint64 = au_sraw(v1, v8); _ = v9
	// the answer is int32, 32 bits
	return ((v9) & uint64(0xffffffff))
}

func Au_443_go_shr_i32_i32_trap(p0 uint64, p1 uint64) uint64 {
	// a0: operand `a` (int32) sign-extended to XLEN, as the ABI presents it
	var v1 uint64 = au_sext32(p0); _ = v1
	// a1: operand `b` (int32) sign-extended to XLEN, as the ABI presents it
	var v2 uint64 = au_sext32(p1); _ = v2
