...
/-- cpp single-opcode row 53, arch mnemonic 'or', example unit cpp/regen_22681, 28 members
...
theorem ModelCheck_cpp_53 (v0 : BitVec 64) (v1 : BitVec 64) (v2 : BitVec 64) :
    ((v0.extractLsb 63 32) ++ ((v0.extractLsb 31 0) ||| (v1.extractLsb 31 0)))
  = (model_or_52 (model_mov_15 v1) v0) := by
  simp only [model_mov_15, model_or_52, model_mov_19]
  bv_decide

#print axioms ModelCheck_cpp_53
