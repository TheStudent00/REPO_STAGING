...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of sltu_gpr_gpr_same_64__reg_a0__csharp.
    // The term's layer-5 text, LITERAL:
    //   0
    public static long emu_sltu_gpr_gpr_same_64__reg_a0__csharp(long a) {
        return m(0L, 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_sltu_gpr_gpr_same_64__reg_a0__csharp(values[0])).ToString());
                    answers.Append("\n");
