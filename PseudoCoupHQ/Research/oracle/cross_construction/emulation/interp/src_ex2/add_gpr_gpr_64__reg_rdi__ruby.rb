...
# InterpRenderer from the layer-4 term of add_gpr_gpr_64__reg_rdi__ruby.
# The term's layer-5 text, LITERAL:
#   v0 + v1
def emu_add_gpr_gpr_64__reg_rdi__ruby(a, b)
  m(add(a, b, 64), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_add_gpr_gpr_64__reg_rdi__ruby(*values)
