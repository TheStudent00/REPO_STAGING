...
// intermediate per node of the term of cmp_imm_gpr_32__flags__go__bit_blast.
//   Concat(Extract(31, 0, v0), Extract(31, 0, v1))
package main

//go:noinline
func emu_cmp_imm_gpr_32__flags__go__bit_blast(a uint32, b uint32) uint64 {
...
func main() {
	sink = emu_cmp_imm_gpr_32__flags__go__bit_blast(g0, g1)
	_ = sink
}
