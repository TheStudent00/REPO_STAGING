/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of swift_7__swift_op_135.  The term's layer-5 text, LITERAL:
...
float
emu_swift_7__swift_op_135(double a, float b)
{
