...
// InterpRenderer from the layer-4 term of div_gpr_one_8__reg_rax__php.
...
function emu_div_gpr_one_8__reg_rax__php($a, $b) {
    return ex_m(ex_cat(ex_cat(ex_ext($a, 63, 16), ex_ext(ex_urem(ex_ext($a, 15, 0), ex_cat(0, $b, 8), 16), 7, 0), 8), ex_ext(ex_udiv(ex_ext($a, 15, 0), ex_cat(0, $b, 8), 16), 7, 0), 8), 64);
}
