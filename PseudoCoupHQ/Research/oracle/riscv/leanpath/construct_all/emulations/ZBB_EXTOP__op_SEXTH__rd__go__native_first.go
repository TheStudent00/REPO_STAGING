...
// intermediate per node of the term of ZBB_EXTOP__op_SEXTH__rd__go__native_first.
//   
package main

//go:noinline
func emu_ZBB_EXTOP__op_SEXTH__rd__go__native_first(a uint16) uint64 {
...
func main() {
	sink = emu_ZBB_EXTOP__op_SEXTH__rd__go__native_first(g0)
	_ = sink
}
