/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of go_11__go_op_81.  The term's layer-5 text, LITERAL:
...
float
emu_go_11__go_op_81(double a, float b)
{
