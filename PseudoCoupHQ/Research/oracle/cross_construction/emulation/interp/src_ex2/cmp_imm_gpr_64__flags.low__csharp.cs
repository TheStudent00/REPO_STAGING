...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of cmp_imm_gpr_64__flags.low__csharp.
    // The term's layer-5 text, LITERAL:
    //   v0
    public static long emu_cmp_imm_gpr_64__flags.low__csharp(long a) {
        return m(a, 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_cmp_imm_gpr_64__flags.low__csharp(values[0])).ToString());
                    answers.Append("\n");
