...
# InterpRenderer from the layer-4 term of remu_gpr_gpr_same_64__reg_a0__cpython.
# The term's layer-5 text, LITERAL:
#   If(v0 == 0, v0, bvurem_i(v0, v0))
def emu_remu_gpr_gpr_same_64__reg_a0__cpython(a):
    return m(((a) if (eq(a, 0, 64)) else (urem(a, a, 64))), 64)
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_remu_gpr_gpr_same_64__reg_a0__cpython(*values)
            sys.stdout.write("%d\n" % answer)
