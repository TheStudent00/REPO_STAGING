...
// intermediate per node of the term of movss_mem_xmm_32__reg_xmm0__swift__bit_blast.
//   Extract(31, 0, v0)
@_cdecl("emu_movss_mem_xmm_32__reg_xmm0__swift__bit_blast")
public func emu_movss_mem_xmm_32__reg_xmm0__swift__bit_blast(_ a: UInt32) -> Float
{
