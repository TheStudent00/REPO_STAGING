...
// InterpRenderer from the layer-4 term of subw_gpr_gpr_same_32__reg_a0__javascript.
// The term's layer-5 text, LITERAL:
//   0
function emu_subw_gpr_gpr_same_32__reg_a0__javascript(a) {
    return m(0n, 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_subw_gpr_gpr_same_32__reg_a0__javascript(...values).toString());
    } catch (problem) {
