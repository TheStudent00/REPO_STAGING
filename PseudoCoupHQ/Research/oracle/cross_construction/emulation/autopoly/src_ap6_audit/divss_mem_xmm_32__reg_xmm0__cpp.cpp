/* task ex1 emulation -- rendered by cpp_render.py CppRenderer from the layer-4 term of divss_mem_xmm_32__reg_xmm0__cpp.  The term's layer-5 text, LITERAL:
...
extern "C"
float
emu_divss_mem_xmm_32__reg_xmm0__cpp(uint32_t a, float b)
{
