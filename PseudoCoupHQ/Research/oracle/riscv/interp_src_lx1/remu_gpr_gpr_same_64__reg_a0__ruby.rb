...
# InterpRenderer from the layer-4 term of remu_gpr_gpr_same_64__reg_a0__ruby.
# The term's layer-5 text, LITERAL:
#   If(v0 == 0, v0, bvurem_i(v0, v0))
def emu_remu_gpr_gpr_same_64__reg_a0__ruby(a)
  m(((eq(a, 0, 64)) ? (a) : (urem(a, a, 64))), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_remu_gpr_gpr_same_64__reg_a0__ruby(*values)
