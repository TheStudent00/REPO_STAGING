; ModuleID = '<scratch>/fl/run/i64_to_f16.rm0.flags/i64_to_f16.rm0.flags.rv.flat.ll'
source_filename = "llvm-link"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128"
target triple = "riscv64-unknown-unknown-elf"

define dso_local i64 @i64_to_f16_rm0_flags_flat(i64 noundef %arg) {
  ...
  %i57 = icmp eq i8 %i53, 0
  %.m34 = sext i1 %i57 to i64
  %.n35 = xor i64 %.m34, -1
  ...
  %.m38 = sext i1 %i62 to i32
  %.n39 = xor i32 %.m38, -1
  %i65 = and i32 %i64, %.n39
  %i67 = add i32 %i66, %i65
  %i68 = and i32 %i67, 65535
  %i69 = zext i32 %i68 to i64
  %.a52 = and i64 %spec.select, %.m51
  %.o53 = or i64 %.a44, %.a52
  %.a59 = and i64 %i69, %.m51
  %.o60 = or i64 %.o58, %.a59
  %i71 = shl i64 %.o60, 16
