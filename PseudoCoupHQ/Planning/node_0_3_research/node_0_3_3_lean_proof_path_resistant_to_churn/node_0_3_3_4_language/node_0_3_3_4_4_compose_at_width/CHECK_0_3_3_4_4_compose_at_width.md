---
id: hq.research.lean_proof_path_resistant_to_churn.language.compose_at_width.check
---

# CHECK — 0_3_3_4_4_compose_at_width

Node `hq.research.lean_proof_path_resistant_to_churn.language.compose_at_width`. Status `draft`.
