...
// InterpRenderer from the layer-4 term of add_imm_gpr_64__reg_rdi__dart.
// The term's layer-5 text, LITERAL:
//   v0 + v1
int emu_add_imm_gpr_64__reg_rdi__dart(int a, int b) {
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_add_imm_gpr_64__reg_rdi__dart(values[0], values[1]);
