...
// InterpRenderer from the layer-4 term of lui_gpr_imm_32__reg_a0__javascript.
// The term's layer-5 text, LITERAL:
//   12288
function emu_lui_gpr_imm_32__reg_a0__javascript() {
    return m(12288n, 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_lui_gpr_imm_32__reg_a0__javascript(...values).toString());
    } catch (problem) {
