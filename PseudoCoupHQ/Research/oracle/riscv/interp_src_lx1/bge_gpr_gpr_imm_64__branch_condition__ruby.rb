...
# InterpRenderer from the layer-4 term of bge_gpr_gpr_imm_64__branch_condition__ruby.
# The term's layer-5 text, LITERAL:
#   If(v0 <= v1, 1, 0)
def emu_bge_gpr_gpr_imm_64__branch_condition__ruby(a, b)
  m(((sle(b, a, 64)) ? (1) : (0)), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_bge_gpr_gpr_imm_64__branch_condition__ruby(*values)
