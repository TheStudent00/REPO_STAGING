/* task ex1 emulation -- rendered by cpp_render.py CppRenderer from the layer-4 term of cmovne_gpr_gpr_32__reg_rdi__cpp.  The term's layer-5 text, LITERAL:
   Concat(0, If(~(~Extract(31, 0, v0) | ~Extract(31, 0, v1)) == 0, Extract(31, 0, v2), Extract(31, 0, v3))) */
#include <cstdint>

extern "C"
uint64_t
emu_cmovne_gpr_gpr_32__reg_rdi__cpp(uint32_t a, uint32_t b, uint32_t c, uint32_t d)
{
