...
(All recorded in full in `~/Programming/PseudoCoupHQ/CLAUDE.md`.)
...
- artifacts: `~/Programming/PseudoCoupHQ/Research/{kind_signature_clustering,dominant_intentions,kind_fuzz_clustering,data_representation,type_vocabulary}/`
