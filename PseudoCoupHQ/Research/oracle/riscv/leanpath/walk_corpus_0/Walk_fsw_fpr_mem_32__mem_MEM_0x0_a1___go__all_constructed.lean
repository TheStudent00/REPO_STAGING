...
theorem meaning_fsw_fpr_mem_32__mem_MEM_0x0_a1___go__all_constructed (s : St) (a : BitVec 64) (b : BitVec 64) (d : BitVec 64) (h10 : s.regs.get? .x10 = some a) (h11 : s.regs.get? .x11 = some b) (h13 : s.regs.get? .x13 = some d) (hk0 : ∀ {α : Type} (x0 : α) (s : St), (plat_term_write x0) s = EStateM.Result.ok () s) (hk1 : ∀ (x0 : Arch.pa) (x1 : Nat) (s : St), (load_reservation x0 x1) s = EStateM.Result.ok () s) (hk2 : ∀ (x0 : Unit) (s : St), (cancel_reservation x0) s = EStateM.Result.ok () s) :
    runsTo (walk [LeanIM.instruction.C_LI (0x3f#6, LeanIM.regidx.Regidx 0x05#5), LeanIM.instruction.C_SLLI (0x20#6, LeanIM.regidx.Regidx 0x05#5), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x05#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x05#5, LeanIM.rop.AND), LeanIM.instruction.SHIFTIOP (0x20#6, LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x06#5, LeanIM.sop.SLLI), LeanIM.instruction.SHIFTIOP (0x20#6, LeanIM.regidx.Regidx 0x06#5, LeanIM.regidx.Regidx 0x06#5, LeanIM.sop.SRLI), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x06#5, LeanIM.regidx.Regidx 0x05#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.rop.OR)]) s
      ((pure_RTYPE ((pure_RTYPE (a) ((pure_SHIFTIOP ((pure_ITYPE (zero_reg) (((sign_extend (m := 12) (0x3f#6)))) (ADDI))) ((0x20#6)) (SLLI))) (LeanIM.rop.AND))) ((pure_SHIFTIOP ((pure_SHIFTIOP (b) (0x20#6) (LeanIM.sop.SLLI))) (0x20#6) (LeanIM.sop.SRLI))) (LeanIM.rop.OR))) := by
  simp (config := {decide := true}) [runsTo, walk, step, execute, strip_C_LI, strip_C_SLLI, strip_ITYPE, strip_SHIFTIOP, strip_RTYPE, alias_C_LI, alias_C_SLLI,
