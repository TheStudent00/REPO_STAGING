/* task ex1 emulation -- rendered by cpp_render.py CppRenderer from the layer-4 term of shr_cl_gpr_16__reg_rdi__cpp.  The term's layer-5 text, LITERAL:
   Concat(0, LShR(Extract(15, 0, v0), Concat(0, Extract(4, 0, v1)))) */
#include <cstdint>

extern "C"
uint64_t
emu_shr_cl_gpr_16__reg_rdi__cpp(uint16_t a, uint8_t b)
{
