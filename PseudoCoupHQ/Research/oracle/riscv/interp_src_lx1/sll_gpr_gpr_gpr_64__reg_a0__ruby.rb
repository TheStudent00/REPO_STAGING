...
# InterpRenderer from the layer-4 term of sll_gpr_gpr_gpr_64__reg_a0__ruby.
# The term's layer-5 text, LITERAL:
#   v0 << Concat(0, Extract(5, 0, v1))
def emu_sll_gpr_gpr_gpr_64__reg_a0__ruby(a, b)
  m(shl(a, cat(0, ext(b, 5, 0), 6), 64), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_sll_gpr_gpr_gpr_64__reg_a0__ruby(*values)
