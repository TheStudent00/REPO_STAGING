...
// intermediate per node of the term of div_gpr_one_64__reg_rdx__rust__native_first.
//   Extract(63, 0, bvurem_i(Concat(v0, v1), Concat(0, v2)))
#[no_mangle]
pub extern "C" fn emu_div_gpr_one_64__reg_rdx__rust__native_first(a: u64, b: u64, c: u64) -> u64
{
