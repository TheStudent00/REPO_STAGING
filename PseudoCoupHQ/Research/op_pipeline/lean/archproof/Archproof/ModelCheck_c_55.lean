...
/-- c single-opcode row 55, arch mnemonic 'or', example unit c/regen_22712, 4 members
...
theorem ModelCheck_c_55 (v0 : BitVec 64) (v1 : BitVec 64) (v2 : BitVec 64) :
    (v0 ||| v1)
  = (model_or_52 (model_mov_19 v0) v1) := by
  rfl

#print axioms ModelCheck_c_55
