...
public static class Emu {
    ...
    // one named local per gate, over the term of cmp_imm_gpr_64__flags_low__csharp.
    // The term's layer-5 text, LITERAL:
    //   v0
    public static long emu_cmp_imm_gpr_64__flags_low__csharp(long a) {
        long x0_0 = ext(a, 0, 0);
        long x0_1 = ext(a, 1, 1);
        long x0_2 = ext(a, 2, 2);
        long x0_3 = ext(a, 3, 3);
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_cmp_imm_gpr_64__flags_low__csharp(values[0])).ToString());
                    answers.Append("\n");
