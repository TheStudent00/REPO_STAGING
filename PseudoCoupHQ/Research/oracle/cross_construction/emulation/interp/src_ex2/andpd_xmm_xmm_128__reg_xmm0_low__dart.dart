...
// InterpRenderer from the layer-4 term of andpd_xmm_xmm_128__reg_xmm0_low__dart.
// The term's layer-5 text, LITERAL:
//   ~(~Extract(63, 0, v0) | ~Extract(63, 0, v1))
int emu_andpd_xmm_xmm_128__reg_xmm0_low__dart(int a, int b) {
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_andpd_xmm_xmm_128__reg_xmm0_low__dart(values[0], values[1]);
