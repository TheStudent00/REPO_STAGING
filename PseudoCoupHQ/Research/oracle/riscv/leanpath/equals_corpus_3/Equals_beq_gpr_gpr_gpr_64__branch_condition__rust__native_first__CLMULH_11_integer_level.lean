...
theorem beq_gpr_gpr_gpr_64__branch_condition__rust__native_first__CLMULH_11_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_ITYPE ((pure_RTYPE (a) (b) (XOR))) (0x001#12) (LeanIM.iop.SLTIU))) = (pure_CLMULH (a) (b) ) := by
  try simp only [pure_ITYPE, pure_RTYPE, pure_CLMULH, bool_to_bit, carryless_mul, log2_xlen, shift_bits_right_arith, sign_extend, xlen, xlenbits, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, zeros, Sail.BitVec.length, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend]
  grind
