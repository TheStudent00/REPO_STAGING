...
$ cd PseudoCoupHQ/Research/op_pipeline && grep -c exempt guard64_transcript.txt
0
```
...
- `PseudoCoupHQ/Research/op_pipeline/gate.py`
- `PseudoCoupHQ/Research/op_pipeline/term.py` (one loop
