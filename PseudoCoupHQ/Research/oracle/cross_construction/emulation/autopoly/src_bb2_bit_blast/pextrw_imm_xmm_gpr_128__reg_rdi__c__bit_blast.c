/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of pextrw_imm_xmm_gpr_128__reg_rdi__c__bit_blast.  The term's text, LITERAL:
   Concat(0, Extract(31, 16, v0)) */
#include <stdint.h>

uint64_t
emu_pextrw_imm_xmm_gpr_128__reg_rdi__c__bit_blast(float a)
{
