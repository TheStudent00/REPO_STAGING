...
# InterpRenderer from the layer-4 term of idiv_gpr_one_32__reg_rax__cpython.
...
def emu_idiv_gpr_one_32__reg_rax__cpython(a, b, c):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_idiv_gpr_one_32__reg_rax__cpython(*values)
            sys.stdout.write("%d\n" % answer)
