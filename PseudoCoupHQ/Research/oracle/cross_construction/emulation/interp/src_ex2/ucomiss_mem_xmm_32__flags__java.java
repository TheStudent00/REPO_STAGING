...
public class Emu {
    ...
    // InterpRenderer from the layer-4 term of ucomiss_mem_xmm_32__flags__java.
    // The term's layer-5 text, LITERAL:
    //   Concat(fp.to_ieee_bv(fpToFP(Extract(31, 0, v0))), fp.to_ieee_bv(fpToFP(Extract(31, 0, v1))))
    static long emu_ucomiss_mem_xmm_32__flags__java(long a, long b) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_ucomiss_mem_xmm_32__flags__java(values[0], values[1])));
                    answers.append("\n");
