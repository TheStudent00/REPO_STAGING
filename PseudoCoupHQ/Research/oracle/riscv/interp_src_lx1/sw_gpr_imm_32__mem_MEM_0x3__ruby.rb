...
# InterpRenderer from the layer-4 term of sw_gpr_imm_32__mem_MEM_0x3__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(Extract(63, 32, v0), Extract(31, 0, v1))
def emu_sw_gpr_imm_32__mem_MEM_0x3__ruby(a, b)
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_sw_gpr_imm_32__mem_MEM_0x3__ruby(*values)
