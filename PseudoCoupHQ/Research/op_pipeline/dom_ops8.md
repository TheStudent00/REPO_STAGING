...
without the arity fix, the same construction gives nodes 178, edges 1274 before the filter, 351 after, components 29.

the same-language assertion ran over 28 components; 63 collisions found.
...
- weakest the class table itself recorded on the spanned classes: erased-form
- surviving edges: 36
...
- classes spanned (53): A0056, A0057, A0124, A0125, A0126, A0127, A0128, A0129, A0130, A0131, A0132, A0133, A0134, A0135, A0136, A0137, A0138, A0139, A0140, A0141, A0142, A0143, A0146, A0147, A0148, A0149, A0150, A0151, A0152, A0153, A0154, A0155, A0156, A0157, A0158, A0159, A0722, K0136, K0137, K0138
  (and 13 more)
- classes any member touches: 53
- strongest evidence over the member pairs: byte
- weakest over the member pairs: verdicts3b records no ground for this unit pair.  That is a limit of the pair record, not a weak edge: the class this pair sits in was formed by canonical-byte identity or by a z3 edge, and those grounds are recorded on the CLASS, not on the pair.  Read `weakest_evidence_from_the_class_table` beside this.
- weakest the class table itself recorded on the spanned classes: tree-exact
- surviving edges: 48
  ...
  - N0011--N0175: 4 shared classes, 4 shared operand-type keys
  - N0011--N0177: 4 shared classes, 4 shared operand-type keys
  ...
  - N0015--N0175: 4 shared classes, 4 shared operand-type keys
  - N0015--N0177: 4 shared classes, 4 shared operand-type keys
  ...
  - N0054--N0175: 4 shared classes, 4 shared operand-type keys
  - N0054--N0177: 4 shared classes, 4 shared operand-type keys
  ...
  - N0058--N0175: 4 shared classes, 4 shared operand-type keys
  - N0058--N0177: 4 shared classes, 4 shared operand-type keys
  ...
  - N0107--N0175: 4 shared classes, 4 shared operand-type keys
  - N0107--N0177: 4 shared classes, 4 shared operand-type keys
  ...
  - N0109--N0175: 4 shared classes, 4 shared operand-type keys
  - N0109--N0177: 4 shared classes, 4 shared operand-type keys
  - N0131--N0141: 1 shared classes, 1 shared operand-type keys
  - N0131--N0142: 1 shared classes, 1 shared operand-type keys
  - N0131--N0175: 1 shared classes, 1 shared operand-type keys
  - N0131--N0177: 1 shared classes, 1 shared operand-type keys
  - N0141--N0175: 4 shared classes, 4 shared operand-type keys
  - N0141--N0177: 4 shared classes, 4 shared operand-type keys
  - N0142--N0175: 4 shared classes, 4 shared operand-type keys
  - N0142--N0177: 4 shared classes, 4 shared operand-type keys
- bridges: 0
- fences: 15
...
| N0011--N0175 | 4 | byte | core-text |
| N0011--N0177 | 4 | not-recorded-per-pair | not-recorded-per-pair |
...
| N0015--N0175 | 4 | not-recorded-per-pair | not-recorded-per-pair |
| N0015--N0177 | 4 | not-recorded-per-pair | not-recorded-per-pair |
...
| N0054--N0175 | 4 | byte | core-text |
| N0054--N0177 | 4 | not-recorded-per-pair | not-recorded-per-pair |
...
| N0058--N0175 | 4 | not-recorded-per-pair | not-recorded-per-pair |
| N0058--N0177 | 4 | not-recorded-per-pair | not-recorded-per-pair |
...
| N0107--N0175 | 4 | byte | core-text |
| N0107--N0177 | 4 | not-recorded-per-pair | not-recorded-per-pair |
...
| N0109--N0175 | 4 | not-recorded-per-pair | not-recorded-per-pair |
| N0109--N0177 | 4 | not-recorded-per-pair | not-recorded-per-pair |
| N0131--N0141 | 1 | not-recorded-per-pair | not-recorded-per-pair |
| N0131--N0142 | 1 | not-recorded-per-pair | not-recorded-per-pair |
| N0131--N0175 | 1 | not-recorded-per-pair | not-recorded-per-pair |
| N0131--N0177 | 1 | not-recorded-per-pair | not-recorded-per-pair |
| N0141--N0142 | 5 | not-recorded-per-pair | not-recorded-per-pair |
| N0141--N0175 | 4 | byte | core-text |
| N0141--N0177 | 4 | not-recorded-per-pair | not-recorded-per-pair |
| N0142--N0175 | 4 | not-recorded-per-pair | not-recorded-per-pair |
| N0142--N0177 | 4 | not-recorded-per-pair | not-recorded-per-pair |
...
- classes spanned (28): A0072, A0109, A0110, A0111, A0112, A0113, A0114, A0115, A0116, A0117, A0118, A0119, A0120, A0121, A0122, A0123, A0607, A0688, A0689, A0736, A0737, K0266, K0267, K0272, K0278, K0279, K0280, K0281
- classes any member touches: 28
- strongest evidence over the member pairs: byte
- weakest over the member pairs: verdicts3b records no ground for this unit pair.  That is a limit of the pair record, not a weak edge: the class this pair sits in was formed by canonical-byte identity or by a z3 edge, and those grounds are recorded on the CLASS, not on the pair.  Read `weakest_evidence_from_the_class_table` beside this.
- weakest the class table itself recorded on the spanned classes: tree-exact
- surviving edges: 38
  - N0003--N0046: 16 shared classes, 16 shared operand-type keys
  - N0003--N0097: 2 shared classes, 2 shared operand-type keys
  - N0003--N0098: 2 shared classes, 2 shared operand-type keys
  - N0003--N0134: 2 shared classes, 2 shared operand-type keys
  - N0003--N0135: 2 shared classes, 2 shared operand-type keys
  - N0003--N0169: 1 shared classes, 1 shared operand-type keys
  - N0003--N0170: 1 shared classes, 1 shared operand-type keys
  - N0004--N0047: 16 shared classes, 16 shared operand-type keys
  - N0004--N0097: 2 shared classes, 2 shared operand-type keys
  - N0004--N0098: 2 shared classes, 2 shared operand-type keys
  - N0004--N0134: 2 shared classes, 2 shared operand-type keys
  - N0004--N0135: 2 shared classes, 2 shared operand-type keys
  - N0004--N0169: 1 shared classes, 1 shared operand-type keys
  - N0004--N0170: 1 shared classes, 1 shared operand-type keys
  - N0046--N0097: 2 shared classes, 2 shared operand-type keys
  - N0046--N0098: 2 shared classes, 2 shared operand-type keys
  - N0046--N0134: 2 shared classes, 2 shared operand-type keys
  - N0046--N0135: 2 shared classes, 2 shared operand-type keys
  - N0046--N0169: 1 shared classes, 1 shared operand-type keys
  - N0046--N0170: 1 shared classes, 1 shared operand-type keys
  - N0047--N0097: 2 shared classes, 2 shared operand-type keys
  - N0047--N0098: 2 shared classes, 2 shared operand-type keys
  - N0047--N0134: 2 shared classes, 2 shared operand-type keys
  - N0047--N0135: 2 shared classes, 2 shared operand-type keys
  - N0047--N0169: 1 shared classes, 1 shared operand-type keys
  - N0047--N0170: 1 shared classes, 1 shared operand-type keys
  - N0097--N0134: 3 shared classes, 3 shared operand-type keys
  - N0097--N0135: 3 shared classes, 3 shared operand-type keys
  - N0097--N0169: 1 shared classes, 1 shared operand-type keys
  - N0097--N0170: 1 shared classes, 1 shared operand-type keys
  - N0098--N0134: 3 shared classes, 3 shared operand-type keys
  - N0098--N0135: 3 shared classes, 3 shared operand-type keys
  - N0098--N0169: 1 shared classes, 1 shared operand-type keys
  - N0098--N0170: 1 shared classes, 1 shared operand-type keys
  - N0134--N0169: 1 shared classes, 1 shared operand-type keys
  - N0134--N0170: 1 shared classes, 1 shared operand-type keys
  - N0135--N0169: 1 shared classes, 1 shared operand-type keys
  - N0135--N0170: 1 shared classes, 1 shared operand-type keys
- bridges: 0
- fences: 13
...
| pair | unit pairs | strongest | weakest |
| --- | --- | --- | --- |
| N0003--N0004 | 9 | not-recorded-per-pair | not-recorded-per-pair |
| N0003--N0046 | 16 | byte | byte |
| N0003--N0047 | 9 | not-recorded-per-pair | not-recorded-per-pair |
| N0003--N0097 | 2 | core-text | core-text |
| N0003--N0098 | 2 | not-recorded-per-pair | not-recorded-per-pair |
| N0003--N0134 | 2 | core-text | core-text |
| N0003--N0135 | 2 | not-recorded-per-pair | not-recorded-per-pair |
| N0003--N0169 | 1 | core-text | core-text |
| N0003--N0170 | 1 | not-recorded-per-pair | not-recorded-per-pair |
| N0004--N0046 | 9 | not-recorded-per-pair | not-recorded-per-pair |
| N0004--N0047 | 16 | not-recorded-per-pair | not-recorded-per-pair |
| N0004--N0097 | 2 | not-recorded-per-pair | not-recorded-per-pair |
| N0004--N0098 | 2 | not-recorded-per-pair | not-recorded-per-pair |
| N0004--N0134 | 2 | not-recorded-per-pair | not-recorded-per-pair |
| N0004--N0135 | 2 | not-recorded-per-pair | not-recorded-per-pair |
| N0004--N0169 | 1 | not-recorded-per-pair | not-recorded-per-pair |
| N0004--N0170 | 1 | not-recorded-per-pair | not-recorded-per-pair |
| N0046--N0047 | 9 | not-recorded-per-pair | not-recorded-per-pair |
| N0046--N0097 | 2 | core-text | core-text |
| N0046--N0098 | 2 | not-recorded-per-pair | not-recorded-per-pair |
| N0046--N0134 | 2 | core-text | core-text |
| N0046--N0135 | 2 | not-recorded-per-pair | not-recorded-per-pair |
| N0046--N0169 | 1 | core-text | core-text |
| N0046--N0170 | 1 | not-recorded-per-pair | not-recorded-per-pair |
| N0047--N0097 | 2 | not-recorded-per-pair | not-recorded-per-pair |
| N0047--N0098 | 2 | not-recorded-per-pair | not-recorded-per-pair |
| N0047--N0134 | 2 | not-recorded-per-pair | not-recorded-per-pair |
| N0047--N0135 | 2 | not-recorded-per-pair | not-recorded-per-pair |
| N0047--N0169 | 1 | not-recorded-per-pair | not-recorded-per-pair |
| N0047--N0170 | 1 | not-recorded-per-pair | not-recorded-per-pair |
| N0097--N0098 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0097--N0134 | 3 | core-text | core-text |
| N0097--N0135 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0097--N0169 | 1 | core-text | core-text |
| N0097--N0170 | 1 | not-recorded-per-pair | not-recorded-per-pair |
| N0098--N0134 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0098--N0135 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0098--N0169 | 1 | not-recorded-per-pair | not-recorded-per-pair |
| N0098--N0170 | 1 | not-recorded-per-pair | not-recorded-per-pair |
| N0134--N0135 | 5 | not-recorded-per-pair | not-recorded-per-pair |
| N0134--N0169 | 1 | core-text | core-text |
| N0134--N0170 | 1 | not-recorded-per-pair | not-recorded-per-pair |
| N0135--N0169 | 1 | not-recorded-per-pair | not-recorded-per-pair |
| N0135--N0170 | 1 | not-recorded-per-pair | not-recorded-per-pair |
| N0169--N0170 | 3 | not-recorded-per-pair | not-recorded-per-pair |
...
- classes spanned (54): A0056, A0057, A0160, A0161, A0162, A0163, A0164, A0165, A0166, A0167, A0168, A0169, A0170, A0171, A0172, A0173, A0174, A0175, A0176, A0177, A0178, A0179, A0182, A0183, A0184, A0185, A0186, A0187, A0188, A0189, A0190, A0191, A0192, A0193, A0194, A0195, A0726, A0727, K0167, K0168
  (and 14 more)
- classes any member touches: 54
- strongest evidence over the member pairs: byte
- weakest over the member pairs: verdicts3b records no ground for this unit pair.  That is a limit of the pair record, not a weak edge: the class this pair sits in was formed by canonical-byte identity or by a z3 edge, and those grounds are recorded on the CLASS, not on the pair.  Read `weakest_evidence_from_the_class_table` beside this.
- weakest the class table itself recorded on the spanned classes: tree-exact
- surviving edges: 38
  ...
  - N0016--N0178: 3 shared classes, 3 shared operand-type keys
  - N0016--N0180: 3 shared classes, 3 shared operand-type keys
  ...
  - N0020--N0178: 3 shared classes, 3 shared operand-type keys
  - N0020--N0180: 3 shared classes, 3 shared operand-type keys
  ...
  - N0059--N0178: 3 shared classes, 3 shared operand-type keys
  - N0059--N0180: 3 shared classes, 3 shared operand-type keys
  ...
  - N0063--N0178: 3 shared classes, 3 shared operand-type keys
  - N0063--N0180: 3 shared classes, 3 shared operand-type keys
  - N0110--N0143: 5 shared classes, 5 shared operand-type keys
  - N0110--N0145: 5 shared classes, 5 shared operand-type keys
  - N0110--N0178: 3 shared classes, 3 shared operand-type keys
  - N0110--N0180: 3 shared classes, 3 shared operand-type keys
  - N0112--N0143: 5 shared classes, 5 shared operand-type keys
  - N0112--N0145: 5 shared classes, 5 shared operand-type keys
  - N0112--N0178: 3 shared classes, 3 shared operand-type keys
  - N0112--N0180: 3 shared classes, 3 shared operand-type keys
  - N0143--N0178: 3 shared classes, 3 shared operand-type keys
  - N0143--N0180: 3 shared classes, 3 shared operand-type keys
  - N0145--N0178: 3 shared classes, 3 shared operand-type keys
  - N0145--N0180: 3 shared classes, 3 shared operand-type keys
- bridges: 0
- fences: 11
  - in0 - in1 overflows 32 bits (signed) -> None x5
  - in0 - in1 overflows 64 bits (signed) -> None x5
...
| N0016--N0178 | 3 | byte | core-text |
| N0016--N0180 | 3 | not-recorded-per-pair | not-recorded-per-pair |
...
| N0020--N0178 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0020--N0180 | 3 | not-recorded-per-pair | not-recorded-per-pair |
...
| N0059--N0178 | 3 | byte | core-text |
| N0059--N0180 | 3 | not-recorded-per-pair | not-recorded-per-pair |
...
| N0063--N0178 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0063--N0180 | 3 | not-recorded-per-pair | not-recorded-per-pair |
...
| N0110--N0178 | 3 | byte | core-text |
| N0110--N0180 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0112--N0143 | 5 | not-recorded-per-pair | not-recorded-per-pair |
| N0112--N0145 | 5 | not-recorded-per-pair | not-recorded-per-pair |
| N0112--N0178 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0112--N0180 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0143--N0145 | 5 | not-recorded-per-pair | not-recorded-per-pair |
| N0143--N0178 | 3 | byte | core-text |
| N0143--N0180 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0145--N0178 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0145--N0180 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0178--N0180 | 5 | not-recorded-per-pair | not-recorded-per-pair |

## D0008 -- 10 members over c, c, cpp, cpp, go, go, rust, rust, swift, swift
...
- classes spanned (57): A0056, A0057, A0072, A0073, A0074, A0075, A0076, A0077, A0078, A0079, A0080, A0081, A0082, A0083, A0084, A0085, A0086, A0087, A0088, A0089, A0090, A0091, A0094, A0095, A0096, A0097, A0098, A0099, A0100, A0101, A0102, A0103, A0104, A0105, A0106, A0107, A0606, A0607, A0681, A0736
  (and 17 more)
- classes any member touches: 57
- strongest evidence over the member pairs: byte
- weakest over the member pairs: verdicts3b records no ground for this unit pair.  That is a limit of the pair record, not a weak edge: the class this pair sits in was formed by canonical-byte identity or by a z3 edge, and those grounds are recorded on the CLASS, not on the pair.  Read `weakest_evidence_from_the_class_table` beside this.
- weakest the class table itself recorded on the spanned classes: tree-exact
- surviving edges: 38
  - N0021--N0064: 36 shared classes, 36 shared operand-type keys
  - N0021--N0113: 3 shared classes, 3 shared operand-type keys
  - N0021--N0114: 3 shared classes, 3 shared operand-type keys
  - N0021--N0150: 3 shared classes, 3 shared operand-type keys
  - N0021--N0151: 3 shared classes, 3 shared operand-type keys
  - N0021--N0183: 3 shared classes, 3 shared operand-type keys
  - N0021--N0184: 3 shared classes, 3 shared operand-type keys
  - N0022--N0065: 36 shared classes, 36 shared operand-type keys
  - N0022--N0113: 3 shared classes, 3 shared operand-type keys
  - N0022--N0114: 3 shared classes, 3 shared operand-type keys
  - N0022--N0150: 3 shared classes, 3 shared operand-type keys
  - N0022--N0151: 3 shared classes, 3 shared operand-type keys
  - N0022--N0183: 3 shared classes, 3 shared operand-type keys
  - N0022--N0184: 3 shared classes, 3 shared operand-type keys
  - N0064--N0113: 3 shared classes, 3 shared operand-type keys
  - N0064--N0114: 3 shared classes, 3 shared operand-type keys
  - N0064--N0150: 3 shared classes, 3 shared operand-type keys
  - N0064--N0151: 3 shared classes, 3 shared operand-type keys
  - N0064--N0183: 3 shared classes, 3 shared operand-type keys
  - N0064--N0184: 3 shared classes, 3 shared operand-type keys
  - N0065--N0113: 3 shared classes, 3 shared operand-type keys
  - N0065--N0114: 3 shared classes, 3 shared operand-type keys
  - N0065--N0150: 3 shared classes, 3 shared operand-type keys
  - N0065--N0151: 3 shared classes, 3 shared operand-type keys
  - N0065--N0183: 3 shared classes, 3 shared operand-type keys
  - N0065--N0184: 3 shared classes, 3 shared operand-type keys
  - N0113--N0150: 4 shared classes, 4 shared operand-type keys
  - N0113--N0151: 4 shared classes, 4 shared operand-type keys
  - N0113--N0183: 3 shared classes, 3 shared operand-type keys
  - N0113--N0184: 3 shared classes, 3 shared operand-type keys
  - N0114--N0150: 4 shared classes, 4 shared operand-type keys
  - N0114--N0151: 4 shared classes, 4 shared operand-type keys
  - N0114--N0183: 3 shared classes, 3 shared operand-type keys
  - N0114--N0184: 3 shared classes, 3 shared operand-type keys
  - N0150--N0183: 3 shared classes, 3 shared operand-type keys
  - N0150--N0184: 3 shared classes, 3 shared operand-type keys
  - N0151--N0183: 3 shared classes, 3 shared operand-type keys
  - N0151--N0184: 3 shared classes, 3 shared operand-type keys
- bridges: 1
...
| N0021--N0113 | 3 | byte | core-text |
| N0021--N0114 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0021--N0150 | 3 | byte | core-text |
| N0021--N0151 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0021--N0183 | 3 | byte | core-text |
| N0021--N0184 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0022--N0064 | 20 | not-recorded-per-pair | not-recorded-per-pair |
| N0022--N0065 | 36 | not-recorded-per-pair | not-recorded-per-pair |
| N0022--N0113 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0022--N0114 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0022--N0150 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0022--N0151 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0022--N0183 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0022--N0184 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0064--N0065 | 20 | not-recorded-per-pair | not-recorded-per-pair |
| N0064--N0113 | 3 | byte | core-text |
| N0064--N0114 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0064--N0150 | 3 | byte | core-text |
| N0064--N0151 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0064--N0183 | 3 | byte | core-text |
| N0064--N0184 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0065--N0113 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0065--N0114 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0065--N0150 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0065--N0151 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0065--N0183 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0065--N0184 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0113--N0114 | 5 | not-recorded-per-pair | not-recorded-per-pair |
| N0113--N0150 | 4 | byte | core-text |
| N0113--N0151 | 4 | not-recorded-per-pair | not-recorded-per-pair |
| N0113--N0183 | 3 | byte | core-text |
| N0113--N0184 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0114--N0150 | 4 | not-recorded-per-pair | not-recorded-per-pair |
| N0114--N0151 | 4 | not-recorded-per-pair | not-recorded-per-pair |
| N0114--N0183 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0114--N0184 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0150--N0151 | 5 | not-recorded-per-pair | not-recorded-per-pair |
| N0150--N0183 | 3 | byte | core-text |
| N0150--N0184 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0151--N0183 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0151--N0184 | 3 | not-recorded-per-pair | not-recorded-per-pair |
| N0183--N0184 | 5 | not-recorded-per-pair | not-recorded-per-pair |

## D0009 -- 9 members over c, c, c, c, cpp, cpp, cpp, go, swift
...
- strongest evidence over the member pairs: byte
- weakest over the member pairs: verdicts3b records no ground for this unit pair.  That is a limit of the pair record, not a weak edge: the class this pair sits in was formed by canonical-byte identity or by a z3 edge, and those grounds are recorded on the CLASS, not on the pair.  Read `weakest_evidence_from_the_class_table` beside this.
- weakest the class table itself recorded on the spanned classes: canon-text
- surviving edges: 20
...
## D0010 -- 7 members over c, c, cpp, cpp, rust, rust, swift
...
## D0011 -- 6 members over c, cpp, cpp, cpp, go, swift
...
- classes spanned (11): K0035, K0037, K0038, K0258, K0268, K0288, K0292, K0293, K0670, K0672, K0673
...
## D0012 -- 6 members over c, c, cpp, cpp, rust, rust
...
## D0013 -- 6 members over c, cpp, cpp, go, rust, swift
...
- classes spanned (6): K0037, K0041, K0042, K0053, K0105, K0194
- classes any member touches: 8
- strongest evidence over the member pairs: byte
...
- surviving edges: 10
  ...
  - N0017--N0179: 4 shared classes, 4 shared operand-type keys
  - N0060--N0111: 3 shared classes, 3 shared operand-type keys
  - N0060--N0144: 4 shared classes, 4 shared operand-type keys
  - N0060--N0179: 4 shared classes, 4 shared operand-type keys
  - N0111--N0144: 2 shared classes, 2 shared operand-type keys
  - N0111--N0179: 2 shared classes, 2 shared operand-type keys
  - N0144--N0179: 4 shared classes, 4 shared operand-type keys
- bridges: 0
- fences: 10
...
| N0017--N0179 | 4 | byte | core-text |
| N0060--N0111 | 3 | sem | sem |
| N0060--N0144 | 4 | byte | byte |
| N0060--N0179 | 4 | byte | core-text |
| N0111--N0144 | 2 | sem | sem |
| N0111--N0179 | 2 | core-text | core-text |
| N0144--N0179 | 4 | byte | core-text |

## D0015 -- 5 members over c, cpp, go, rust, swift
...
## D0016 -- 5 members over c, c, c, c, cpp
...
## D0017 -- 5 members over cpp, cpp, go, rust, swift
...
- classes spanned (8): K0054, K0055, K0358, K0359, K0360, K0361, K0817, K0822
- classes any member touches: 40
- strongest evidence over the member pairs: byte
- weakest over the member pairs: verdicts3b records no ground for this unit pair.  That is a limit of the pair record, not a weak edge: the class this pair sits in was formed by canonical-byte identity or by a z3 edge, and those grounds are recorded on the CLASS, not on the pair.  Read `weakest_evidence_from_the_class_table` beside this.
- weakest the class table itself recorded on the spanned classes: tree-exact
...
- classes spanned (8): K0054, K0055, K0362, K0363, K0364, K0365, K0757, K0762
- classes any member touches: 40
- strongest evidence over the member pairs: byte
- weakest over the member pairs: verdicts3b records no ground for this unit pair.  That is a limit of the pair record, not a weak edge: the class this pair sits in was formed by canonical-byte identity or by a z3 edge, and those grounds are recorded on the CLASS, not on the pair.  Read `weakest_evidence_from_the_class_table` beside this.
- weakest the class table itself recorded on the spanned classes: tree-exact
...
## D0022 -- 4 members over cpp, go, rust, swift
...
- classes spanned (8): K0054, K0055, K0127, K0128, K0129, K0366, K0787, K0792
- classes any member touches: 40
- strongest evidence over the member pairs: byte
- weakest over the member pairs: verdicts3b records no ground for this unit pair.  That is a limit of the pair record, not a weak edge: the class this pair sits in was formed by canonical-byte identity or by a z3 edge, and those grounds are recorded on the CLASS, not on the pair.  Read `weakest_evidence_from_the_class_table` beside this.
- weakest the class table itself recorded on the spanned classes: tree-exact
...
- languages absent:
  - go: refused by the type checker, or measured and never equal: no accepted unit of this language sits in any class this dominant operator spans
  - rust: no mutual counterpart: the language has units in these classes, but no node of it was chosen back
  - swift: no mutual counterpart: the language has units in these classes, but no node of it was chosen back
  - java: refused by the type checker, or measured and never equal: no accepted unit of this language sits in any class this dominant operator spans
- intention: null; hint proposed only, the owner settles
