/*
 * arch-unit 100  --  c  `a || b`  lhs=float rhs=double
 * symbol op_304   outcome LIFTED
 *
...
uint64_t au_100_c_lor_f32_f64(uint64_t p0, uint64_t p1)
{
    ...
    const uint64_t v6 = au_b2u(f64_eq_rm0(v2, v5));
