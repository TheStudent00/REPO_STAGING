...
theorem c_op_498__ZBKB_RTYPE_47_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (zero_reg) ((pure_RTYPE (a) (b) (XOR))) (LeanIM.rop.SLTU))) = (pure_ZBKB_RTYPE (a) (b) (brop_zbkb.PACKH)) := by
  try simp only [pure_RTYPE, pure_ZBKB_RTYPE, bool_to_bit, log2_xlen, shift_bits_right_arith, xlen_bytes, xlenbits, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.zeroExtend]
  grind
