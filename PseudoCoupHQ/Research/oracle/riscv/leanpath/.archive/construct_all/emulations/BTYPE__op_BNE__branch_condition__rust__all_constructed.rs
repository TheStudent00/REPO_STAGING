...
// intermediate per node of the term of BTYPE__op_BNE__branch_condition__rust__all_constructed.
//   
#[no_mangle]
pub extern "C" fn emu_BTYPE__op_BNE__branch_condition__rust__all_constructed(a: u64, b: u64) -> u64
{
