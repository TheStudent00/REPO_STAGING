...
public class Emu {
    ...
    // InterpRenderer from the layer-4 term of neg_gpr_one_16__reg_rdi__java.
    // The term's layer-5 text, LITERAL:
    //   Concat(0, Extract(15, 0, v0)*65535)
    static long emu_neg_gpr_one_16__reg_rdi__java(long a) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_neg_gpr_one_16__reg_rdi__java(values[0])));
                    answers.append("\n");
