...
# InterpRenderer from the layer-4 term of adc_gpr_gpr_64__reg_rdi__ruby.
# The term's layer-5 text, LITERAL:
#   If(Extract(64, 64, Concat(0, v0) + Concat(0, v1)) == 1, 1, 0) + v2 + v3
def emu_adc_gpr_gpr_64__reg_rdi__ruby(a, b, c, d)
  m(add(add(((eq(ext(add(cat(0, b, 64), cat(0, a, 64), 65), 64, 64), 1, 1)) ? (1) : (0)), c, 64), d, 64), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_adc_gpr_gpr_64__reg_rdi__ruby(*values)
