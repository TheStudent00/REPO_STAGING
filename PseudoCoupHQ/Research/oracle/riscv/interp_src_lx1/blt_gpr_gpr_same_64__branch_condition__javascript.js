...
// InterpRenderer from the layer-4 term of blt_gpr_gpr_same_64__branch_condition__javascript.
// The term's layer-5 text, LITERAL:
//   If(v0 <= v1, 0, 1)
function emu_blt_gpr_gpr_same_64__branch_condition__javascript(a, b) {
    return m(((sle(b, a, 64)) ? (0n) : (1n)), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_blt_gpr_gpr_same_64__branch_condition__javascript(...values).toString());
    } catch (problem) {
