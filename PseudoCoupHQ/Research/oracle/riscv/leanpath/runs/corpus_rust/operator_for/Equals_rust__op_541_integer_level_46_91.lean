...
theorem rust__op_541_46_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (ADD))) = ((a + b)) := by
  try simp only [pure_RTYPE, bool_to_bit, log2_xlen, shift_bits_right_arith, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.zeroExtend, Sail.BitVec.extractLsb, Sail.shift_bits_right, Sail.shift_bits_left]
  all_goals grind

set_option maxHeartbeats 40000 in
theorem rust__op_541_91_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (a) (b) (ADD))) = ((sign_extend (m := 64) ((Sail.BitVec.extractLsb a 31 0) + (Sail.BitVec.extractLsb b 31 0)))) := by
  try simp only [pure_RTYPE, bool_to_bit, log2_xlen, shift_bits_right_arith, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.zeroExtend, Sail.BitVec.extractLsb, Sail.shift_bits_right, Sail.shift_bits_left, sign_extend, Sail.BitVec.signExtend]
  all_goals grind
