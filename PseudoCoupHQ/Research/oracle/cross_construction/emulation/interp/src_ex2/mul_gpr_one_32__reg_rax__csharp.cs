...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of mul_gpr_one_32__reg_rax__csharp.
    // The term's layer-5 text, LITERAL:
    //   Concat(0, Extract(31, 0, v0)*Extract(31, 0, v1))
    public static long emu_mul_gpr_one_32__reg_rax__csharp(long a, long b) {
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_mul_gpr_one_32__reg_rax__csharp(values[0], values[1])).ToString());
                    answers.Append("\n");
