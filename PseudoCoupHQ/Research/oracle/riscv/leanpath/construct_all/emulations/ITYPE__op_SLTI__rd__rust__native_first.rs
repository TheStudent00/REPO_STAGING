...
// intermediate per node of the term of ITYPE__op_SLTI__rd__rust__native_first.
//   
#[no_mangle]
pub extern "C" fn emu_ITYPE__op_SLTI__rd__rust__native_first(a: u64, b: u16) -> u64
{
    ...
    let v3: bool = ((((v2) as i64)) <= ((((a as u64)) as i64)));
