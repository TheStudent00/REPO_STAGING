/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of swift_5__swift_op_171.  The term's layer-5 text, LITERAL:
...
float
emu_swift_5__swift_op_171(double a, float b)
{
