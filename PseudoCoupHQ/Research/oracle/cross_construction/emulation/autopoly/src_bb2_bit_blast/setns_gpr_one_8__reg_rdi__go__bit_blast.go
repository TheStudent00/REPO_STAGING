...
// intermediate per node of the term of setns_gpr_one_8__reg_rdi__go__bit_blast.
//   Concat(Extract(63, 8, v2), If(Or(Extract(7, 7, v0) == 0, Extract(7, 7, v1) == 0), 1, 0))
package main

//go:noinline
func emu_setns_gpr_one_8__reg_rdi__go__bit_blast(a uint8, b uint8, c uint64) uint64 {
	...
	var g0 uint64 = (x1_7 ^ 1)
	var g1 uint64 = (x0_7 ^ 1)
	var g2 uint64 = (g1 | g0)
	var k0 uint64 = 0
	var w0 uint64 = (g2 << 0)
...
func main() {
	sink = emu_setns_gpr_one_8__reg_rdi__go__bit_blast(g0, g1, g2)
	_ = sink
}
