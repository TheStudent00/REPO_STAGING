...
public class Emu {
    ...
    // one named local per gate, over the term of cmovle_gpr_gpr_32__reg_rdi__java.
    ...
    static long emu_cmovle_gpr_gpr_32__reg_rdi__java(long a, long b, long c, long d) {
        long x3_0 = ext(d, 0, 0);
        long x1_9 = ext(a, 9, 9);
        long x0_9 = ext(b, 9, 9);
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_cmovle_gpr_gpr_32__reg_rdi__java(values[0], values[1], values[2], values[3])));
                    answers.append("\n");
