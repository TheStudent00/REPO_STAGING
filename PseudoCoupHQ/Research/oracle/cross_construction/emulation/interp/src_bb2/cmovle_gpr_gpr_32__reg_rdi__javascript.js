...
// one named local per gate, over the term of cmovle_gpr_gpr_32__reg_rdi__javascript.
...
function emu_cmovle_gpr_gpr_32__reg_rdi__javascript(a, b, c, d) {
    ...
    const g160 = (g159 | g3);
    const g161 = (g160 ^ 1n);
    const g162 = (g161 & x3_0);
    const g163 = (g160 & x2_0);
    const g164 = (g163 | g162);
    const g165 = (g161 & x3_1);
    const g166 = (g160 & x2_1);
    const g167 = (g166 | g165);
    const g168 = (g161 & x3_2);
    const g169 = (g160 & x2_2);
    const g170 = (g169 | g168);
    const g171 = (g161 & x3_3);
    const g172 = (g160 & x2_3);
    const g173 = (g172 | g171);
    const g174 = (g161 & x3_4);
    const g175 = (g160 & x2_4);
    const g176 = (g175 | g174);
    const g177 = (g161 & x3_5);
    const g178 = (g160 & x2_5);
    const g179 = (g178 | g177);
    const g180 = (g161 & x3_6);
    const g181 = (g160 & x2_6);
    const g182 = (g181 | g180);
    const g183 = (g161 & x3_7);
    const g184 = (g160 & x2_7);
    const g185 = (g184 | g183);
    const g186 = (g161 & x3_8);
    const g187 = (g160 & x2_8);
    const g188 = (g187 | g186);
    const g189 = (g161 & x3_9);
    const g190 = (g160 & x2_9);
    const g191 = (g190 | g189);
    const g192 = (g161 & x3_10);
    const g193 = (g160 & x2_10);
    const g194 = (g193 | g192);
    const g195 = (g161 & x3_11);
    const g196 = (g160 & x2_11);
    const g197 = (g196 | g195);
    const g198 = (g161 & x3_12);
    const g199 = (g160 & x2_12);
    const g200 = (g199 | g198);
    const g201 = (g161 & x3_13);
    const g202 = (g160 & x2_13);
    const g203 = (g202 | g201);
    const g204 = (g161 & x3_14);
    const g205 = (g160 & x2_14);
    const g206 = (g205 | g204);
    const g207 = (g161 & x3_15);
    const g208 = (g160 & x2_15);
    const g209 = (g208 | g207);
    const g210 = (g161 & x3_16);
    const g211 = (g160 & x2_16);
    const g212 = (g211 | g210);
    const g213 = (g161 & x3_17);
    const g214 = (g160 & x2_17);
    const g215 = (g214 | g213);
    const g216 = (g161 & x3_18);
    const g217 = (g160 & x2_18);
    const g218 = (g217 | g216);
    const g219 = (g161 & x3_19);
    const g220 = (g160 & x2_19);
    const g221 = (g220 | g219);
    const g222 = (g161 & x3_20);
    const g223 = (g160 & x2_20);
    const g224 = (g223 | g222);
    const g225 = (g161 & x3_21);
    const g226 = (g160 & x2_21);
    const g227 = (g226 | g225);
    const g228 = (g161 & x3_22);
    const g229 = (g160 & x2_22);
    const g230 = (g229 | g228);
    const g231 = (g161 & x3_23);
    const g232 = (g160 & x2_23);
    const g233 = (g232 | g231);
    const g234 = (g161 & x3_24);
    const g235 = (g160 & x2_24);
    const g236 = (g235 | g234);
    const g237 = (g161 & x3_25);
    const g238 = (g160 & x2_25);
    const g239 = (g238 | g237);
    const g240 = (g161 & x3_26);
    const g241 = (g160 & x2_26);
    const g242 = (g241 | g240);
    const g243 = (g161 & x3_27);
    const g244 = (g160 & x2_27);
    const g245 = (g244 | g243);
    const g246 = (g161 & x3_28);
    const g247 = (g160 & x2_28);
    const g248 = (g247 | g246);
    const g249 = (g161 & x3_29);
    const g250 = (g160 & x2_29);
    const g251 = (g250 | g249);
    const g252 = (g161 & x3_30);
    const g253 = (g160 & x2_30);
    const g254 = (g253 | g252);
    const g255 = (g161 & x3_31);
    const g256 = (g160 & x2_31);
    ...
    const w32 = cat(w31, g257, 1);
    const w33 = cat(w32, g254, 1);
    const w34 = cat(w33, g251, 1);
    const w35 = cat(w34, g248, 1);
    const w36 = cat(w35, g245, 1);
    const w37 = cat(w36, g242, 1);
    const w38 = cat(w37, g239, 1);
    const w39 = cat(w38, g236, 1);
    const w40 = cat(w39, g233, 1);
    const w41 = cat(w40, g230, 1);
    const w42 = cat(w41, g227, 1);
    const w43 = cat(w42, g224, 1);
    const w44 = cat(w43, g221, 1);
    const w45 = cat(w44, g218, 1);
    const w46 = cat(w45, g215, 1);
    const w47 = cat(w46, g212, 1);
    const w48 = cat(w47, g209, 1);
    const w49 = cat(w48, g206, 1);
    const w50 = cat(w49, g203, 1);
    const w51 = cat(w50, g200, 1);
    const w52 = cat(w51, g197, 1);
    const w53 = cat(w52, g194, 1);
    const w54 = cat(w53, g191, 1);
    const w55 = cat(w54, g188, 1);
    const w56 = cat(w55, g185, 1);
    const w57 = cat(w56, g182, 1);
    const w58 = cat(w57, g179, 1);
    const w59 = cat(w58, g176, 1);
    const w60 = cat(w59, g173, 1);
    const w61 = cat(w60, g170, 1);
    const w62 = cat(w61, g167, 1);
    const w63 = cat(w62, g164, 1);
    return m(w63, 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_cmovle_gpr_gpr_32__reg_rdi__javascript(...values).toString());
    } catch (problem) {
