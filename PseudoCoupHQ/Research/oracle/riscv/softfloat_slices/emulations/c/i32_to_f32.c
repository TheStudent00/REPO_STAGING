...
uint64_t i32_to_f32_rm1(uint32_t v_arg)
{
    ...
    const uint32_t v__sh18 = (uint32_t)((uint32_t)(v_i27) >> ((UINT32_C(0x7)) & 31));
    const bool v_i31 = (v_i27 < UINT32_C(0x80));
    const uint32_t v__m20 = (uint32_t)((v_i31) ? ~(uint32_t)0 : (uint32_t)0);
    const uint32_t v__n21 = (uint32_t)(v__m20 ^ UINT32_C(0xffffffff));
    const uint32_t v_i35 = (uint32_t)(v_i21 & v__n21);
    const uint32_t v_i36 = (uint32_t)(v__sh18 | v_i20);
    const uint32_t v_i37 = (uint32_t)(v_i36 + v_i35);
    ...
    const uint32_t v__a26 = (uint32_t)(v_i37 & v__m25);
    ...
    const uint64_t v_i39 = (uint64_t)(v__a29);
    const uint64_t v__m30 = (uint64_t)((v__n10) ? ~(uint64_t)0 : (uint64_t)0);
    const uint64_t v__a31 = (uint64_t)(v_i39 & v__m30);
