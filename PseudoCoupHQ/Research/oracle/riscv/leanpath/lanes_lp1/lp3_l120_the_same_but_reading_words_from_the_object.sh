#!/bin/bash
# lp3_l120_the_same_but_reading_words_from_the_object.sh
#
...
# ones time out.
#
# Fetches nothing. Writes $A/runs/float_rm0b only. Budget: four hours.
set -uo pipefail
...
SF = "PseudoCoupHQ/Research/oracle/riscv/softfloat_slices"
G  = "PseudoCoupHQ/Research/oracle/riscv/leanpath/runs/float_rm0b"
