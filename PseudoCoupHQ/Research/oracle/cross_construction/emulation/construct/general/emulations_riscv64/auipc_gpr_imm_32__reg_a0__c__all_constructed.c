/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of auipc_gpr_imm_32__reg_a0__c__all_constructed.  The term's text, LITERAL:
   v0 + 12288 */
#include <stdint.h>

uint64_t
emu_auipc_gpr_imm_32__reg_a0__c__all_constructed(uint64_t a)
{
