...
- R2 compiler-source census — **done** 2026-07-28: all five
  ...
  `PRIVATE/PseudoCoup_v6/Research/r2_compiler_source_census/REPORT.md`.
  Subject files (paths relative to `PRIVATE/PseudoCoup_v5/`);
...
- R3 harvest verification — **done** 2026-07-28 (all sources
  ...
  `PRIVATE/PseudoCoup_v6/Research/r3_harvest_verification/REPORT.md`).
