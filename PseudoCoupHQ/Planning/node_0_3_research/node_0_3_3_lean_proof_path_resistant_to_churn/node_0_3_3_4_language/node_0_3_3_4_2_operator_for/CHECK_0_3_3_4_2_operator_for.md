---
id: hq.research.lean_proof_path_resistant_to_churn.language.operator_for.check
---

# CHECK — 0_3_3_4_2_operator_for

Node `hq.research.lean_proof_path_resistant_to_churn.language.operator_for`. Status `draft`.
