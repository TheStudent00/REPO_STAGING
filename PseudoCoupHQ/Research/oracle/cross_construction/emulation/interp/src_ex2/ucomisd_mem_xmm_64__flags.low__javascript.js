...
// InterpRenderer from the layer-4 term of ucomisd_mem_xmm_64__flags.low__javascript.
// The term's layer-5 text, LITERAL:
//   fp.to_ieee_bv(fpToFP(v0))
function emu_ucomisd_mem_xmm_64__flags.low__javascript(a) {
    return m(a, 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_ucomisd_mem_xmm_64__flags.low__javascript(...values).toString());
    } catch (problem) {
