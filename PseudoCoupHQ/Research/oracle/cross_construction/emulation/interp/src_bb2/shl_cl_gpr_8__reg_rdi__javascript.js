...
// one named local per gate, over the term of shl_cl_gpr_8__reg_rdi__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(63, 8, v0), Extract(7, 0, v0) << Concat(0, Extract(4, 0, v1)))
function emu_shl_cl_gpr_8__reg_rdi__javascript(a, b) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_shl_cl_gpr_8__reg_rdi__javascript(...values).toString());
    } catch (problem) {
