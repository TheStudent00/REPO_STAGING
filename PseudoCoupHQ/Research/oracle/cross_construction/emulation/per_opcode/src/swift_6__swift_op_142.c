/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of swift_6__swift_op_142.  The term's layer-5 text, LITERAL:
...
double
emu_swift_6__swift_op_142(double a, double b)
{
