...
# one named local per gate, over the term of movapd_xmm_xmm_128__reg_xmm0_low__cpython.
# The term's layer-5 text, LITERAL:
#   Extract(63, 0, v0)
def emu_movapd_xmm_xmm_128__reg_xmm0_low__cpython(a):
    x0_0 = ext(a, 0, 0)
    x0_1 = ext(a, 1, 1)
    x0_2 = ext(a, 2, 2)
    x0_3 = ext(a, 3, 3)
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_movapd_xmm_xmm_128__reg_xmm0_low__cpython(*values)
            sys.stdout.write("%d\n" % answer)
