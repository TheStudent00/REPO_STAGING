...
// InterpRenderer from the layer-4 term of flw_fpr_gpr_32__freg_fa0__dart.
// The term's layer-5 text, LITERAL:
//   Concat(4294967295, Extract(31, 0, v0))
int emu_flw_fpr_gpr_32__freg_fa0__dart(int a) {
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_flw_fpr_gpr_32__freg_fa0__dart(values[0]);
