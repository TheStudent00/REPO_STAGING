---
id: hq.research.arch_unit_oracle.simplification.matching.gate_rule.check
---

# CHECK — 0_3_2_4_1_3_gate_rule

Node `hq.research.arch_unit_oracle.simplification.matching.gate_rule`. Status `draft`.
