...
// intermediate per node of the term of addi_gpr_gpr_imm_64__reg_a0__go__all_constructed.
//   v0 + 3
package main

//go:noinline
func emu_addi_gpr_gpr_imm_64__reg_a0__go__all_constructed(a uint64) uint64 {
	var v0 uint64 = (uint64((uint64(uint64(a))) & (uint64(uint64(0x3)))))
	var v1 uint64 = (uint64((uint64(v0)) << ((uint64(uint64(0x1))) & uint64(0x3f))))
	var v2 uint64 = (uint64((uint64(uint64(a))) ^ (uint64(uint64(0x3)))))
...
func main() {
	sink = emu_addi_gpr_gpr_imm_64__reg_a0__go__all_constructed(g0)
	_ = sink
}
