...
// intermediate per node of the term of sraiw_gpr_gpr_imm_32__reg_a0__go__native_first.
...
//go:noinline
func emu_sraiw_gpr_gpr_imm_32__reg_a0__go__native_first(a uint32) uint64 {
	var v0 uint32 = uint32(a)
	var v1 uint32 = (uint32(uint32((int32(v0)) >> ((uint32(uint32(0x3))) & uint32(0x1f)))))
...
func main() {
	sink = emu_sraiw_gpr_gpr_imm_32__reg_a0__go__native_first(g0)
	_ = sink
}
