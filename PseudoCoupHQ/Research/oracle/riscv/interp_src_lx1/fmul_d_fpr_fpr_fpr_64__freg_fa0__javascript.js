...
// InterpRenderer from the layer-4 term of fmul_d_fpr_fpr_fpr_64__freg_fa0__javascript.
// The term's layer-5 text, LITERAL:
//   fp.to_ieee_bv(fpToFP(v0) * fpToFP(v1))
function emu_fmul_d_fpr_fpr_fpr_64__freg_fa0__javascript(a, b) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_fmul_d_fpr_fpr_fpr_64__freg_fa0__javascript(...values).toString());
    } catch (problem) {
