...
// one named local per gate, over the term of cmp_gpr_gpr_64__flags_low__javascript.
// The term's layer-5 text, LITERAL:
//   v0
function emu_cmp_gpr_gpr_64__flags_low__javascript(a) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_cmp_gpr_gpr_64__flags_low__javascript(...values).toString());
    } catch (problem) {
