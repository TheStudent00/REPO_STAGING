...
# InterpRenderer from the layer-4 term of sb_gpr_mem_8__mem_MEM_0x0_a1___ruby.
# The term's layer-5 text, LITERAL:
#   Concat(Extract(63, 8, v0), Extract(7, 0, v1))
def emu_sb_gpr_mem_8__mem_MEM_0x0_a1___ruby(a, b)
  m(cat(ext(a, 63, 8), b, 8), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_sb_gpr_mem_8__mem_MEM_0x0_a1___ruby(*values)
