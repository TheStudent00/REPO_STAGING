...
// one named local per gate, over the term of cltd_none_64__reg_rdx__dart.
// The term's layer-5 text, LITERAL:
//   Concat(0, Extract(31, 0, v0) >> 31)
int emu_cltd_none_64__reg_rdx__dart(int a) {
  ...
  int w33 = cat(w32, x0_31, 1);
  int w34 = cat(w33, x0_31, 1);
  int w35 = cat(w34, x0_31, 1);
  int w36 = cat(w35, x0_31, 1);
  int w37 = cat(w36, x0_31, 1);
  int w38 = cat(w37, x0_31, 1);
  int w39 = cat(w38, x0_31, 1);
  int w40 = cat(w39, x0_31, 1);
  int w41 = cat(w40, x0_31, 1);
  int w42 = cat(w41, x0_31, 1);
  int w43 = cat(w42, x0_31, 1);
  int w44 = cat(w43, x0_31, 1);
  int w45 = cat(w44, x0_31, 1);
  int w46 = cat(w45, x0_31, 1);
  int w47 = cat(w46, x0_31, 1);
  int w48 = cat(w47, x0_31, 1);
  int w49 = cat(w48, x0_31, 1);
  int w50 = cat(w49, x0_31, 1);
  int w51 = cat(w50, x0_31, 1);
  int w52 = cat(w51, x0_31, 1);
  int w53 = cat(w52, x0_31, 1);
  int w54 = cat(w53, x0_31, 1);
  int w55 = cat(w54, x0_31, 1);
  int w56 = cat(w55, x0_31, 1);
  int w57 = cat(w56, x0_31, 1);
  int w58 = cat(w57, x0_31, 1);
  int w59 = cat(w58, x0_31, 1);
  int w60 = cat(w59, x0_31, 1);
  int w61 = cat(w60, x0_31, 1);
  int w62 = cat(w61, x0_31, 1);
  int w63 = cat(w62, x0_31, 1);
  return m(w63, 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_cltd_none_64__reg_rdx__dart(values[0]);
