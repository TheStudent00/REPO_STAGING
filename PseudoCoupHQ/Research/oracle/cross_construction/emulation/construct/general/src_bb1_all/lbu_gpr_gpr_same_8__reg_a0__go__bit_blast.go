...
// intermediate per node of the term of lbu_gpr_gpr_same_8__reg_a0__go__bit_blast.
//   Concat(0, Extract(7, 0, v0))
package main

//go:noinline
func emu_lbu_gpr_gpr_same_8__reg_a0__go__bit_blast(a uint8) uint64 {
...
func main() {
	sink = emu_lbu_gpr_gpr_same_8__reg_a0__go__bit_blast(g0)
	_ = sink
}
