...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of slli_gpr_gpr_imm_64__reg_a0__csharp.
    // The term's layer-5 text, LITERAL:
    //   Concat(Extract(60, 0, v0), 0)
    public static long emu_slli_gpr_gpr_imm_64__reg_a0__csharp(long a) {
        return m(cat(ext(a, 60, 0), 0L, 3), 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_slli_gpr_gpr_imm_64__reg_a0__csharp(values[0])).ToString());
                    answers.Append("\n");
