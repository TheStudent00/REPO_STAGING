...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of slliw_gpr_gpr_imm_32__reg_a0__csharp.
    ...
    public static long emu_slliw_gpr_gpr_imm_32__reg_a0__csharp(long a) {
        return m(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(ext(a, 28, 28), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 28), 1), ext(a, 28, 0), 29), 0L, 3), 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_slliw_gpr_gpr_imm_32__reg_a0__csharp(values[0])).ToString());
                    answers.Append("\n");
