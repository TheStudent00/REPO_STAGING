...
theorem probe_mulh__ZBB_RTYPEW_bropw_zbbROR_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_MUL (b) (a) ({ result_part := LeanIM.VectorHalf.High, signed_rs1 := LeanIM.Signedness.Signed, signed_rs2 := LeanIM.Signedness.Signed }))) = (pure_ZBB_RTYPEW (a) (b) (bropw_zbb.RORW)) := by
