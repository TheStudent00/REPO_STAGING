#!/usr/bin/env bash
# t85_l3_all_moments.sh -- TASK 85, lane 3: THE FULL PASS.
#
...
#   lane cap:      6000 MB, abort T85_FULL_MEMORY_ABORT, checked after
#                  every render.
...
#
# Product: /out/t85_all_moments.json
set -uo pipefail
...
LANE_CAP_MB = 6000
LANE_ABORT = "T85_FULL_MEMORY_ABORT"
...
for key in keys:
    ...
    for number in (1, 2, 3, 4, 5):
        ...
        rows.append({
            ...
            "tabs_in_bar": html.count('class="tab '),
        })
...
with open("/out/t85_all_moments.json", "w") as fh:
