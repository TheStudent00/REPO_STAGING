...
// InterpRenderer from the layer-4 term of setnp_gpr_one_8__reg_rdi__dart.
...
int emu_setnp_gpr_one_8__reg_rdi__dart(int a, int b) {
  return m(cat(0, ((eq(ext(add(mul(b, 255, 8), a, 8), 1, 1), ((eq(ext(add(mul(b, 255, 8), a, 8), 2, 2), ((eq(ext(add(mul(b, 255, 8), a, 8), 3, 3), ((eq(ext(add(mul(b, 255, 8), a, 8), 4, 4), ((eq(ext(add(mul(b, 255, 8), a, 8), 5, 5), ((eq(ext(add(mul(b, 255, 8), a, 8), 6, 6), ((eq(ext(add(mul(b, 255, 8), a, 8), 7, 7), ((eq(add(ext(a, 0, 0), 1, 1), ext(b, 0, 0), 1)) ? (1) : (0)), 1)) ? (1) : (0)), 1)) ? (1) : (0)), 1)) ? (1) : (0)), 1)) ? (1) : (0)), 1)) ? (1) : (0)), 1)) ? (1) : (0)), 1)) ? (0) : (1)), 8), 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_setnp_gpr_one_8__reg_rdi__dart(values[0], values[1]);
