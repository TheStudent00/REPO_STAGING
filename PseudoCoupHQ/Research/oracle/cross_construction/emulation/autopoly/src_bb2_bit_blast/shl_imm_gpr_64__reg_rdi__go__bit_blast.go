...
// intermediate per node of the term of shl_imm_gpr_64__reg_rdi__go__bit_blast.
//   Concat(Extract(60, 0, v0), 0)
package main

//go:noinline
func emu_shl_imm_gpr_64__reg_rdi__go__bit_blast(a uint64) uint64 {
...
func main() {
	sink = emu_shl_imm_gpr_64__reg_rdi__go__bit_blast(g0)
	_ = sink
}
