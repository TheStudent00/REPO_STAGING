...
# one named local per gate, over the term of mov_gpr_same_32__reg_rdi__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(0, Extract(31, 0, v0))
def emu_mov_gpr_same_32__reg_rdi__ruby(a)
  x0_0 = ext(a, 0, 0)
  x0_1 = ext(a, 1, 1)
  x0_2 = ext(a, 2, 2)
  x0_3 = ext(a, 3, 3)
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_mov_gpr_same_32__reg_rdi__ruby(*values)
