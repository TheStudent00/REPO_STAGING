/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of fmv_x_w_gpr_fpr_32__reg_a0__c__all_constructed.  The term's text, LITERAL:
...
uint64_t
emu_fmv_x_w_gpr_fpr_32__reg_a0__c__all_constructed(uint32_t a)
{
