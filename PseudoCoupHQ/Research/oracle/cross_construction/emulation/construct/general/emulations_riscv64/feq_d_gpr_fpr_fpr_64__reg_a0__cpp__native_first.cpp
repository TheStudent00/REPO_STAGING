/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of feq_d_gpr_fpr_fpr_64__reg_a0__cpp__native_first.  The term's text, LITERAL:
...
extern "C"
uint64_t
emu_feq_d_gpr_fpr_fpr_64__reg_a0__cpp__native_first(uint64_t a, uint64_t b)
{
