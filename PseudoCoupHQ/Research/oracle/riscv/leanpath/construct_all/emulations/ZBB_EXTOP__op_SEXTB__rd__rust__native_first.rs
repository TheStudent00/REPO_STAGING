...
// intermediate per node of the term of ZBB_EXTOP__op_SEXTB__rd__rust__native_first.
//   
#[no_mangle]
pub extern "C" fn emu_ZBB_EXTOP__op_SEXTB__rd__rust__native_first(a: u8) -> u64
{
    let v0: u32 = (a as u32);
