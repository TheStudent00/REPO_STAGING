...
theorem rust__op_12_25_integer_level (a : BitVec 64) :
    ((pure_ITYPE (a) (0xfff#12) (LeanIM.iop.XORI))) = ((Complement.complement a)) := by
  try simp only [pure_ITYPE, bool_to_bit, sign_extend, xlenbits, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend]
  all_goals grind
