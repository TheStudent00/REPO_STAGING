/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of blt_gpr_gpr_gpr_64__branch_condition__cpp__all_constructed.  The term's text, LITERAL:
   If(v0 <= v1, 0, 1) */
#include <cstdint>

extern "C"
uint64_t
emu_blt_gpr_gpr_gpr_64__branch_condition__cpp__all_constructed(uint64_t a, uint64_t b)
{
