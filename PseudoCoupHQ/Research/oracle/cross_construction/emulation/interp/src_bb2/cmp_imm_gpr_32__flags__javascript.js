...
// one named local per gate, over the term of cmp_imm_gpr_32__flags__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(31, 0, v0), Extract(31, 0, v1))
function emu_cmp_imm_gpr_32__flags__javascript(a, b) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_cmp_imm_gpr_32__flags__javascript(...values).toString());
    } catch (problem) {
