/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of cpp_66__cpp_op_745.  The term's layer-5 text, LITERAL:
   LShR(Extract(31, 0, v0), Concat(0, Extract(4, 0, v1))) */
#include <stdint.h>

uint32_t
emu_cpp_66__cpp_op_745(uint32_t a, uint8_t b)
{
