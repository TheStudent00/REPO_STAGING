...
// intermediate per node of the term of seta_gpr_one_8__reg_rdi__go__bit_blast.
//   Concat(Extract(63, 8, v2), If(And(ULE(Extract(7, 0, v0), Extract(7, 0, v1)), Not(Extract(7, 0, v0) == Extract(7, 0, v1))), 1, 0))
package main

//go:noinline
func emu_seta_gpr_one_8__reg_rdi__go__bit_blast(a uint8, b uint8, c uint64) uint64 {
	...
	var g1 uint64 = (g0 | x0_7)
	var g2 uint64 = (x0_7 ^ 1)
	var g3 uint64 = (x1_7 | g2)
	var g4 uint64 = (x1_6 ^ 1)
	var g5 uint64 = (g4 | x0_6)
	var g6 uint64 = (x0_6 ^ 1)
	var g7 uint64 = (g6 | x1_6)
	var g8 uint64 = (x1_5 ^ 1)
	var g9 uint64 = (x0_5 | g8)
	var g10 uint64 = (x0_5 ^ 1)
	var g11 uint64 = (g10 | x1_5)
	var g12 uint64 = (x1_4 ^ 1)
	var g13 uint64 = (x0_4 | g12)
	var g14 uint64 = (x0_4 ^ 1)
	var g15 uint64 = (g14 | x1_4)
	var g16 uint64 = (x1_3 ^ 1)
	var g17 uint64 = (g16 | x0_3)
	var g18 uint64 = (x0_3 ^ 1)
	var g19 uint64 = (x1_3 | g18)
	var g20 uint64 = (x1_2 ^ 1)
	var g21 uint64 = (x0_2 | g20)
	var g22 uint64 = (x0_2 ^ 1)
	var g23 uint64 = (x1_2 | g22)
	var g24 uint64 = (x1_1 ^ 1)
	var g25 uint64 = (x0_1 | g24)
	var g26 uint64 = (x0_1 ^ 1)
	var g27 uint64 = (x1_1 | g26)
	var g28 uint64 = (x1_0 ^ 1)
	var g29 uint64 = (g28 | x0_0)
	var g30 uint64 = (x0_0 ^ 1)
	var g31 uint64 = (x1_0 | g30)
	var g32 uint64 = (g31 & g29)
	var g33 uint64 = (g32 & g27)
	var g34 uint64 = (g33 & g25)
	var g35 uint64 = (g34 & g23)
	var g36 uint64 = (g35 & g21)
	var g37 uint64 = (g36 & g19)
	var g38 uint64 = (g37 & g17)
	var g39 uint64 = (g38 & g15)
	var g40 uint64 = (g39 & g13)
	var g41 uint64 = (g40 & g11)
	var g42 uint64 = (g41 & g9)
	var g43 uint64 = (g42 & g7)
	var g44 uint64 = (g43 & g5)
	var g45 uint64 = (g44 & g3)
	var g46 uint64 = (g45 & g1)
	var g47 uint64 = (g46 ^ 1)
	var g48 uint64 = (g31 ^ 1)
	var g49 uint64 = (g24 | g48)
	var g50 uint64 = (g49 ^ 1)
	var g51 uint64 = (x0_1 | g48)
	var g52 uint64 = (g51 ^ 1)
	var g53 uint64 = (g25 ^ 1)
	var g54 uint64 = (g53 | g52)
	var g55 uint64 = (g54 | g50)
	var g56 uint64 = (g55 ^ 1)
	var g57 uint64 = (g20 | g56)
	var g58 uint64 = (g57 ^ 1)
	var g59 uint64 = (x0_2 | g56)
	var g60 uint64 = (g59 ^ 1)
	var g61 uint64 = (g21 ^ 1)
	var g62 uint64 = (g61 | g60)
	var g63 uint64 = (g62 | g58)
	var g64 uint64 = (g63 ^ 1)
	var g65 uint64 = (g16 | g64)
	var g66 uint64 = (g65 ^ 1)
	var g67 uint64 = (x0_3 | g64)
	var g68 uint64 = (g67 ^ 1)
	var g69 uint64 = (x0_3 | g16)
	var g70 uint64 = (g69 ^ 1)
	var g71 uint64 = (g70 | g68)
	var g72 uint64 = (g71 | g66)
	var g73 uint64 = (g72 ^ 1)
	var g74 uint64 = (g12 | g73)
	var g75 uint64 = (g74 ^ 1)
	var g76 uint64 = (x0_4 | g73)
	var g77 uint64 = (g76 ^ 1)
	var g78 uint64 = (g13 ^ 1)
	var g79 uint64 = (g78 | g77)
	var g80 uint64 = (g79 | g75)
	var g81 uint64 = (g80 ^ 1)
	var g82 uint64 = (g8 | g81)
	var g83 uint64 = (g82 ^ 1)
	var g84 uint64 = (x0_5 | g81)
	var g85 uint64 = (g84 ^ 1)
	var g86 uint64 = (g9 ^ 1)
	var g87 uint64 = (g86 | g85)
	var g88 uint64 = (g87 | g83)
	var g89 uint64 = (g88 ^ 1)
	var g90 uint64 = (g4 | g89)
	var g91 uint64 = (g90 ^ 1)
	var g92 uint64 = (x0_6 | g89)
	var g93 uint64 = (g92 ^ 1)
	var g94 uint64 = (x0_6 | g4)
	var g95 uint64 = (g94 ^ 1)
	var g96 uint64 = (g95 | g93)
	var g97 uint64 = (g96 | g91)
	var g98 uint64 = (g97 ^ 1)
	var g99 uint64 = (g0 | g98)
	var g100 uint64 = (g99 ^ 1)
	var g101 uint64 = (x0_7 | g98)
	var g102 uint64 = (g101 ^ 1)
	var g103 uint64 = (x0_7 | g0)
	var g104 uint64 = (g103 ^ 1)
	var g105 uint64 = (g104 | g102)
	var g106 uint64 = (g105 | g100)
	var g107 uint64 = (g106 & g47)
	var k0 uint64 = 0
	var w0 uint64 = (g107 << 0)
...
func main() {
	sink = emu_seta_gpr_one_8__reg_rdi__go__bit_blast(g0, g1, g2)
	_ = sink
}
