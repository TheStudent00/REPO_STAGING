...
theorem meaning_emul_au_444_go_shr_i32_i64 (s : St) (a : BitVec 64) (b : BitVec 64) (d : BitVec 64) (h10 : s.regs.get? .x10 = some a) (h11 : s.regs.get? .x11 = some b) (h13 : s.regs.get? .x13 = some d) (hk0 : ∀ {α : Type} (x0 : α) (s : St), (plat_term_write x0) s = EStateM.Result.ok () s) (hk1 : ∀ (x0 : Arch.pa) (x1 : Nat) (s : St), (load_reservation x0 x1) s = EStateM.Result.ok () s) (hk2 : ∀ (x0 : Unit) (s : St), (cancel_reservation x0) s = EStateM.Result.ok () s) :
    runsTo (walk [LeanIM.instruction.C_LI (0x1f#6, LeanIM.regidx.Regidx 0x0c#5), LeanIM.instruction.ZBB_RTYPE (LeanIM.regidx.Regidx 0x0c#5, LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0b#5, LeanIM.brop_zbb.MINU), LeanIM.instruction.ZBA_RTYPEUW (LeanIM.regidx.Regidx 0x00#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0c#5, 0x0#2), LeanIM.instruction.SHIFTIWOP (0x1f#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.sopw.SRAIW), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0c#5, LeanIM.regidx.Regidx 0x0c#5, LeanIM.rop.SRL), LeanIM.instruction.ITYPE (0x01f#12, LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0b#5, LeanIM.iop.XORI), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.rop.SLL), LeanIM.instruction.C_SLLI (0x21#6, LeanIM.regidx.Regidx 0x0a#5), LeanIM.instruction.C_SRLI (0x20#6, LeanIM.cregidx.Cregidx 0x2#3), LeanIM.instruction.C_OR (LeanIM.cregidx.Cregidx 0x2#3, LeanIM.cregidx.Cregidx 0x4#3)]) s
      ((pure_RTYPE ((pure_SHIFTIOP ((pure_SHIFTIOP ((pure_RTYPE ((pure_SHIFTIWOP (a) (0x1f#5) (LeanIM.sopw.SRAIW))) ((pure_ITYPE ((pure_ZBB_RTYPE (b) ((pure_ITYPE (zero_reg) (((sign_extend (m := 12) (0x1f#6)))) (ADDI))) (LeanIM.brop_zbb.MINU))) (0x01f#12) (LeanIM.iop.XORI))) (LeanIM.rop.SLL))) ((0x21#6)) (SLLI))) ((0x20#6)) (SRLI))) ((pure_RTYPE ((pure_ZBA_RTYPEUW (a) (zero_reg) (0x0#2))) ((pure_ZBB_RTYPE (b) ((pure_ITYPE (zero_reg) (((sign_extend (m := 12) (0x1f#6)))) (ADDI))) (LeanIM.brop_zbb.MINU))) (LeanIM.rop.SRL))) (OR))) := by
  simp (config := {decide := true}) [runsTo, walk, step, execute, strip_C_LI, strip_C_SLLI, strip_C_SRLI, strip_C_OR, strip_ITYPE, strip_ZBB_RTYPE, strip_ZBA_RTYPEUW, strip_SHIFTIWOP, strip_RTYPE, strip_SHIFTIOP, alias_C_LI, alias_C_SLLI, alias_C_SRLI, alias_C_OR,
