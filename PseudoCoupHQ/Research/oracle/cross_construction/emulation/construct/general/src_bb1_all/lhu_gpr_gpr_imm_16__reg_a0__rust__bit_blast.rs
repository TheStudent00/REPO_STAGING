...
// intermediate per node of the term of lhu_gpr_gpr_imm_16__reg_a0__rust__bit_blast.
//   Concat(0, Extract(15, 0, v0))
#[no_mangle]
pub extern "C" fn emu_lhu_gpr_gpr_imm_16__reg_a0__rust__bit_blast(a: u16) -> u64
{
