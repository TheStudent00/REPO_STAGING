/* task ex1 emulation -- rendered by cpp_render.py CppRenderer from the layer-4 term of sub_gpr_gpr_16__reg_rdi__cpp.  The term's layer-5 text, LITERAL:
   Concat(Extract(63, 16, v0), Extract(15, 0, v1)*65535 + Extract(15, 0, v0)) */
#include <cstdint>

extern "C"
uint64_t
emu_sub_gpr_gpr_16__reg_rdi__cpp(uint64_t a, uint16_t b)
{
