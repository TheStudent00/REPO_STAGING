---
id: hq.research.arch_unit_oracle.simplification.matching.liveness.check
---

# CHECK — 0_3_2_4_1_1_liveness

Node `hq.research.arch_unit_oracle.simplification.matching.liveness`. Status `draft`.
