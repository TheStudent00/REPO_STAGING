/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of ZBB_RTYPE__op_MAX__rd__cpp__all_constructed.  The term's text, LITERAL:
    */
#include <cstdint>

extern "C"
uint64_t
emu_ZBB_RTYPE__op_MAX__rd__cpp__all_constructed(uint64_t a, uint64_t b)
{
    uint64_t v0 = (uint64_t)(UINT32_C(0x1));
    uint64_t v1 = (uint64_t)((uint64_t)((uint64_t)a) ^ (uint64_t)(UINT64_C(0x8000000000000000)));
    uint64_t v2 = (uint64_t)(~(uint64_t)(v1));
    uint64_t v3 = (uint64_t)((uint64_t)((uint64_t)b) ^ (uint64_t)(UINT64_C(0x8000000000000000)));
    ...
    int v38 = ((!(v37))) ? 1 : 0;
    uint64_t v39 = ((v38) ? (uint64_t)((uint64_t)b) : (uint64_t)((uint64_t)a));
    return (uint64_t)(v39);
}
