---
id: hq.research.compiler_graph.gate.lean.renderer_theorem.check
---

# CHECK — 0_3_1_5_6_2_renderer_theorem

Node `hq.research.compiler_graph.gate.lean.renderer_theorem`. Status `draft`.
