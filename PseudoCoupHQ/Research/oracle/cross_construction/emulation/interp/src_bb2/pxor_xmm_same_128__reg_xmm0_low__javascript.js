...
// one named local per gate, over the term of pxor_xmm_same_128__reg_xmm0_low__javascript.
// The term's layer-5 text, LITERAL:
//   0
function emu_pxor_xmm_same_128__reg_xmm0_low__javascript() {
    const k0 = 0n;
    const w0 = k0;
...
for (const line of lines) {
    ...
    try {
        out.push(emu_pxor_xmm_same_128__reg_xmm0_low__javascript(...values).toString());
    } catch (problem) {
