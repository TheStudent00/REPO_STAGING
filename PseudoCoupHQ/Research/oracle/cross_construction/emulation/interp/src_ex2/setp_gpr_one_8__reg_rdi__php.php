...
// InterpRenderer from the layer-4 term of setp_gpr_one_8__reg_rdi__php.
...
while (($line = fgets($handle)) !== false) {
    ...
    try {
        $answer = emu_setp_gpr_one_8__reg_rdi__php(...$ints);
        if ($answer < 0) {
            echo sprintf("%s\n", sprintf("%u", $answer));
        } else {
            echo $answer . "\n";
