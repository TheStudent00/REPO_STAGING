...
theorem bltu_gpr_gpr_same_64__branch_condition__rust__all_constructed__RTYPE_04_fixed_width (a : BitVec 64) (b : BitVec 64) :
  ...
  try simp only [pure_SHIFTIOP, pure_RTYPE, pure_ITYPE, pure_RTYPE, bool_to_bit, log2_xlen, shift_bits_right_arith, sign_extend, xlenbits, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend]
  bv_decide
