...
# InterpRenderer from the layer-4 term of sub_gpr_gpr_gpr_64__reg_a0__ruby.
# The term's layer-5 text, LITERAL:
#   v0*18446744073709551615 + v1
def emu_sub_gpr_gpr_gpr_64__reg_a0__ruby(a, b)
  m(add(mul(b, 18446744073709551615, 64), a, 64), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_sub_gpr_gpr_gpr_64__reg_a0__ruby(*values)
