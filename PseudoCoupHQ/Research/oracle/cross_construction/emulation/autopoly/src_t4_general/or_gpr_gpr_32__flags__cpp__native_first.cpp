/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of or_gpr_gpr_32__flags__cpp__native_first.  The term's text, LITERAL:
   Concat(Extract(31, 0, v0) | Extract(31, 0, v1), 0) */
#include <cstdint>

extern "C"
uint64_t
emu_or_gpr_gpr_32__flags__cpp__native_first(uint32_t a, uint32_t b)
{
