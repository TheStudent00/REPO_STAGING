; ModuleID = '<scratch>/fl/run/i64_to_f32.rm1.flags/i64_to_f32.rm1.flags.rv.flat.ll'
source_filename = "llvm-link"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128"
target triple = "riscv64-unknown-unknown-elf"

define dso_local i64 @i64_to_f32_rm1_flags_flat(i64 noundef %arg) {
  ...
  %.o30 = or i32 %.a27, %.a29
  %.a32 = and i32 %.o30, %.m31
  %i49 = zext i1 %i41 to i64
  %.a25 = and i64 %i49, %.m24
  %i51 = zext i32 %.a32 to i64
  %i52 = shl i64 %i51, 32
  %i53 = or i64 %i52, %.a25
  ret i64 %i53
}
