...
Scripts authored, all in `~/Programming/SandboxDesign/agent/drop/`
and executed from `~/Programming/Airlock/agent/drop/`:
...
Logs are under `~/Programming/Airlock/agent/logs/`, stamped
`20260829T17*`.
