...
theorem divu_gpr_gpr_gpr_64__reg_a0__c__native_first_14_integer_level (a : BitVec 64) (b : BitVec 64) :
...
set_option maxHeartbeats 40000 in
theorem divu_gpr_gpr_gpr_64__reg_a0__c__native_first_15_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_DIV (b) (a) (true))) = (pure_MULW (a) (b) ) := by
  try simp only [pure_DIV, pure_MULW, sign_extend, to_bits_truncate, Sail.BitVec.signExtend]
  grind

set_option maxHeartbeats 40000 in
theorem divu_gpr_gpr_gpr_64__reg_a0__c__native_first_16_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_DIV (b) (a) (true))) = (pure_REM (a) (b) (false)) := by
  try simp only [pure_DIV, pure_REM, to_bits_truncate]
  grind

set_option maxHeartbeats 40000 in
theorem divu_gpr_gpr_gpr_64__reg_a0__c__native_first_17_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_DIV (b) (a) (true))) = (pure_REM (a) (b) (true)) := by
  try simp only [pure_DIV, pure_REM, to_bits_truncate]
  grind

set_option maxHeartbeats 40000 in
theorem divu_gpr_gpr_gpr_64__reg_a0__c__native_first_18_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_DIV (b) (a) (true))) = (pure_REMW (a) (b) (false)) := by
  try simp only [pure_DIV, pure_REMW, sign_extend, to_bits_truncate, Sail.BitVec.signExtend]
  grind

set_option maxHeartbeats 40000 in
theorem divu_gpr_gpr_gpr_64__reg_a0__c__native_first_19_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_DIV (b) (a) (true))) = (pure_REMW (a) (b) (true)) := by
  try simp only [pure_DIV, pure_REMW, sign_extend, to_bits_truncate, Sail.BitVec.signExtend]
  grind

set_option maxHeartbeats 40000 in
theorem divu_gpr_gpr_gpr_64__reg_a0__c__native_first_20_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_DIV (b) (a) (true))) = (pure_RTYPE (a) (b) (rop.ADD)) := by
  try simp only [pure_DIV, pure_RTYPE, bool_to_bit, log2_xlen, shift_bits_right_arith, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.zeroExtend]
  grind

set_option maxHeartbeats 40000 in
theorem divu_gpr_gpr_gpr_64__reg_a0__c__native_first_21_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_DIV (b) (a) (true))) = (pure_RTYPE (a) (b) (rop.SUB)) := by
  try simp only [pure_DIV, pure_RTYPE, bool_to_bit, log2_xlen, shift_bits_right_arith, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.zeroExtend]
  grind

set_option maxHeartbeats 40000 in
theorem divu_gpr_gpr_gpr_64__reg_a0__c__native_first_22_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_DIV (b) (a) (true))) = (pure_RTYPE (a) (b) (rop.SLL)) := by
  try simp only [pure_DIV, pure_RTYPE, bool_to_bit, log2_xlen, shift_bits_right_arith, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.zeroExtend]
  grind

set_option maxHeartbeats 40000 in
theorem divu_gpr_gpr_gpr_64__reg_a0__c__native_first_23_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_DIV (b) (a) (true))) = (pure_RTYPE (a) (b) (rop.SLT)) := by
  try simp only [pure_DIV, pure_RTYPE, bool_to_bit, log2_xlen, shift_bits_right_arith, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.zeroExtend]
  grind

set_option maxHeartbeats 40000 in
theorem divu_gpr_gpr_gpr_64__reg_a0__c__native_first_24_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_DIV (b) (a) (true))) = (pure_RTYPE (a) (b) (rop.SLTU)) := by
  try simp only [pure_DIV, pure_RTYPE, bool_to_bit, log2_xlen, shift_bits_right_arith, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.zeroExtend]
  grind

set_option maxHeartbeats 40000 in
theorem divu_gpr_gpr_gpr_64__reg_a0__c__native_first_25_integer_level (a : BitVec 64) (b : BitVec 64) :
