...
public class Emu {
    ...
    // InterpRenderer from the layer-4 term of cmovb_gpr_gpr_64__reg_rdi__java.
    // The term's layer-5 text, LITERAL:
    //   If(ULE(v0, v1), v2, v3)
    static long emu_cmovb_gpr_gpr_64__reg_rdi__java(long a, long b, long c, long d) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_cmovb_gpr_gpr_64__reg_rdi__java(values[0], values[1], values[2], values[3])));
                    answers.append("\n");
