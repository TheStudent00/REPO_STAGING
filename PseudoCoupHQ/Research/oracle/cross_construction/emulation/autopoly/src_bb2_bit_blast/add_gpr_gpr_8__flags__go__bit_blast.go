...
// intermediate per node of the term of add_gpr_gpr_8__flags__go__bit_blast.
//   Concat(Extract(7, 0, v0), Extract(7, 0, v1))
package main

//go:noinline
func emu_add_gpr_gpr_8__flags__go__bit_blast(a uint8, b uint8) uint16 {
...
func main() {
	sink = emu_add_gpr_gpr_8__flags__go__bit_blast(g0, g1)
	_ = sink
}
