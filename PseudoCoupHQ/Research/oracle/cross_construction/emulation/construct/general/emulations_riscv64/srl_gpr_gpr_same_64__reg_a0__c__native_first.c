/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of srl_gpr_gpr_same_64__reg_a0__c__native_first.  The term's text, LITERAL:
   LShR(v0, Concat(0, Extract(5, 0, v0))) */
#include <stdint.h>

uint64_t
emu_srl_gpr_gpr_same_64__reg_a0__c__native_first(uint64_t a)
{
