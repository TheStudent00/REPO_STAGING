...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of sub_gpr_gpr_gpr_64__reg_a0__csharp.
    // The term's layer-5 text, LITERAL:
    //   v0*18446744073709551615 + v1
    public static long emu_sub_gpr_gpr_gpr_64__reg_a0__csharp(long a, long b) {
        return m(add(mul(b, -1L, 64), a, 64), 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_sub_gpr_gpr_gpr_64__reg_a0__csharp(values[0], values[1])).ToString());
                    answers.Append("\n");
