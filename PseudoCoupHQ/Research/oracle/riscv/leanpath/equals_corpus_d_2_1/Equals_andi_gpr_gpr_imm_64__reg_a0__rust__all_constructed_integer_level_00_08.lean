...
theorem andi_gpr_gpr_imm_64__reg_a0__rust__all_constructed_00_integer_level (a : BitVec 64) :
...
theorem andi_gpr_gpr_imm_64__reg_a0__rust__all_constructed_01_integer_level (a : BitVec 64) :
    ((pure_ITYPE (a) ((sign_extend (m := 12) (0x03#6))) (ANDI))) = (pure_CLZ (a) ) := by
  try simp only [pure_ITYPE, pure_CLZ, to_bits]
  grind

theorem andi_gpr_gpr_imm_64__reg_a0__rust__all_constructed_02_integer_level (a : BitVec 64) :
    ((pure_ITYPE (a) ((sign_extend (m := 12) (0x03#6))) (ANDI))) = (pure_CLZW (a) ) := by
  try simp only [pure_ITYPE, pure_CLZW, to_bits]
  grind

theorem andi_gpr_gpr_imm_64__reg_a0__rust__all_constructed_03_integer_level (a : BitVec 64) :
    ((pure_ITYPE (a) ((sign_extend (m := 12) (0x03#6))) (ANDI))) = (pure_CTZ (a) ) := by
  try simp only [pure_ITYPE, pure_CTZ, to_bits]
  grind

theorem andi_gpr_gpr_imm_64__reg_a0__rust__all_constructed_04_integer_level (a : BitVec 64) :
    ((pure_ITYPE (a) ((sign_extend (m := 12) (0x03#6))) (ANDI))) = (pure_CTZW (a) ) := by
  try simp only [pure_ITYPE, pure_CTZW, to_bits]
  grind

theorem andi_gpr_gpr_imm_64__reg_a0__rust__all_constructed_05_integer_level (a : BitVec 64) :
...
theorem andi_gpr_gpr_imm_64__reg_a0__rust__all_constructed_06_integer_level (a : BitVec 64) :
...
theorem andi_gpr_gpr_imm_64__reg_a0__rust__all_constructed_07_integer_level (a : BitVec 64) :
    ((pure_ITYPE (a) ((sign_extend (m := 12) (0x03#6))) (ANDI))) = (pure_ZBB_EXTOP (a) (extop_zbb.SEXTH)) := by
  try simp only [pure_ITYPE, pure_ZBB_EXTOP, sign_extend, xlenbits, zero_extend, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend]
  grind

theorem andi_gpr_gpr_imm_64__reg_a0__rust__all_constructed_08_integer_level (a : BitVec 64) :
