...
/-- swift single-opcode row 16, arch mnemonic 'xor', example unit swift/op_473, 9 members
...
theorem ModelCheck_swift_16 (v0 : BitVec 64) (v1 : BitVec 64) :
    ((v0.extractLsb 31 0) ^^^ (v1.extractLsb 31 0))
  = ((model_xor_37 (model_mov_18 v0) v1).extractLsb 31 0) := by
  simp only [model_mov_18, model_xor_37]
  bv_decide

#print axioms ModelCheck_swift_16
