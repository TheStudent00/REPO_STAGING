...
theorem lwu_gpr_gpr_imm_32__reg_a0__cpp__native_first_00_same_text (a : BitVec 64) :
    ((pure_ZBA_RTYPEUW (a) (zero_reg) (0b00#2))) = (pure_BREV8 (a) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem lwu_gpr_gpr_imm_32__reg_a0__cpp__native_first_01_same_text (a : BitVec 64) :
    ((pure_ZBA_RTYPEUW (a) (zero_reg) (0b00#2))) = (pure_CLZ (a) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem lwu_gpr_gpr_imm_32__reg_a0__cpp__native_first_02_same_text (a : BitVec 64) :
    ((pure_ZBA_RTYPEUW (a) (zero_reg) (0b00#2))) = (pure_CLZW (a) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem lwu_gpr_gpr_imm_32__reg_a0__cpp__native_first_03_same_text (a : BitVec 64) :
    ((pure_ZBA_RTYPEUW (a) (zero_reg) (0b00#2))) = (pure_CTZ (a) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem lwu_gpr_gpr_imm_32__reg_a0__cpp__native_first_04_same_text (a : BitVec 64) :
    ((pure_ZBA_RTYPEUW (a) (zero_reg) (0b00#2))) = (pure_CTZW (a) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem lwu_gpr_gpr_imm_32__reg_a0__cpp__native_first_05_same_text (a : BitVec 64) :
    ((pure_ZBA_RTYPEUW (a) (zero_reg) (0b00#2))) = (pure_REV8 (a) ) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem lwu_gpr_gpr_imm_32__reg_a0__cpp__native_first_06_same_text (a : BitVec 64) :
    ((pure_ZBA_RTYPEUW (a) (zero_reg) (0b00#2))) = (pure_ZBB_EXTOP (a) (extop_zbb.SEXTB)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem lwu_gpr_gpr_imm_32__reg_a0__cpp__native_first_07_same_text (a : BitVec 64) :
    ((pure_ZBA_RTYPEUW (a) (zero_reg) (0b00#2))) = (pure_ZBB_EXTOP (a) (extop_zbb.SEXTH)) := by
  with_reducible rfl

set_option maxHeartbeats 10000 in
theorem lwu_gpr_gpr_imm_32__reg_a0__cpp__native_first_08_same_text (a : BitVec 64) :
