...
// intermediate per node of the term of slliw_gpr_gpr_imm_32__reg_a0__go__native_first.
...
func main() {
	sink = emu_slliw_gpr_gpr_imm_32__reg_a0__go__native_first(g0)
	_ = sink
}
