...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of addw_gpr_gpr_same_32__reg_a0__csharp.
    // The term's layer-5 text, LITERAL:
    //   Concat(Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 0, v0)*2)
    public static long emu_addw_gpr_gpr_same_32__reg_a0__csharp(long a) {
        return m(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(ext(mul(a, 2L, 32), 31, 31), ext(mul(a, 2L, 32), 31, 31), 1), ext(mul(a, 2L, 32), 31, 31), 1), ext(mul(a, 2L, 32), 31, 31), 1), ext(mul(a, 2L, 32), 31, 31), 1), ext(mul(a, 2L, 32), 31, 31), 1), ext(mul(a, 2L, 32), 31, 31), 1), ext(mul(a, 2L, 32), 31, 31), 1), ext(mul(a, 2L, 32), 31, 31), 1), ext(mul(a, 2L, 32), 31, 31), 1), ext(mul(a, 2L, 32), 31, 31), 1), ext(mul(a, 2L, 32), 31, 31), 1), ext(mul(a, 2L, 32), 31, 31), 1), ext(mul(a, 2L, 32), 31, 31), 1), ext(mul(a, 2L, 32), 31, 31), 1), ext(mul(a, 2L, 32), 31, 31), 1), ext(mul(a, 2L, 32), 31, 31), 1), ext(mul(a, 2L, 32), 31, 31), 1), ext(mul(a, 2L, 32), 31, 31), 1), ext(mul(a, 2L, 32), 31, 31), 1), ext(mul(a, 2L, 32), 31, 31), 1), ext(mul(a, 2L, 32), 31, 31), 1), ext(mul(a, 2L, 32), 31, 31), 1), ext(mul(a, 2L, 32), 31, 31), 1), ext(mul(a, 2L, 32), 31, 31), 1), ext(mul(a, 2L, 32), 31, 31), 1), ext(mul(a, 2L, 32), 31, 31), 1), ext(mul(a, 2L, 32), 31, 31), 1), ext(mul(a, 2L, 32), 31, 31), 1), ext(mul(a, 2L, 32), 31, 31), 1), ext(mul(a, 2L, 32), 31, 31), 1), ext(mul(a, 2L, 32), 31, 31), 1), mul(a, 2L, 32), 32), 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_addw_gpr_gpr_same_32__reg_a0__csharp(values[0])).ToString());
                    answers.Append("\n");
