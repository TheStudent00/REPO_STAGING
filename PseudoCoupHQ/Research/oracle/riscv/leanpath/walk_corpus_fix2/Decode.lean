...
#eval IO.println ("and_gpr_gpr_same_64__reg_a0__c__all_constructed#0\t" ++ ((match (encdec_compressed_backwards (0x8082#16)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
#eval IO.println ("and_gpr_gpr_same_64__reg_a0__go__all_constructed#0\t" ++ ((match (encdec_backwards (0x00008067#32)) (s0) with | .ok i _ => toString (repr i) | .error _ _ => "ERROR")))
