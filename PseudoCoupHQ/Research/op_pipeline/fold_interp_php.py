...
AIRLOCK_OUT = os.path.expanduser("~/Programming/Airlock/agent/out")
AIRLOCK_LOGS = os.path.expanduser("~/Programming/Airlock/agent/logs")
...
def main():
    ...
    md_lines.append("Folded 2026-08-31 by `fold_interp_php.py`, task "
                     ...
                     "`~/Programming/Airlock/agent/out/interp_php_b/` "
