...
// one named local per gate, over the term of fldz_st_none_80__x87_7__javascript.
// The term's layer-5 text, LITERAL:
//   0
function emu_fldz_st_none_80__x87_7__javascript() {
    const k0 = 0n;
    const w0 = k0;
    ...
    const w64 = cat(w63, k0, 1);
    const w65 = cat(w64, k0, 1);
    const w66 = cat(w65, k0, 1);
    const w67 = cat(w66, k0, 1);
    const w68 = cat(w67, k0, 1);
    const w69 = cat(w68, k0, 1);
    const w70 = cat(w69, k0, 1);
    const w71 = cat(w70, k0, 1);
    const w72 = cat(w71, k0, 1);
    const w73 = cat(w72, k0, 1);
    const w74 = cat(w73, k0, 1);
    const w75 = cat(w74, k0, 1);
    const w76 = cat(w75, k0, 1);
    const w77 = cat(w76, k0, 1);
    const w78 = cat(w77, k0, 1);
    return m(w78, 79);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_fldz_st_none_80__x87_7__javascript(...values).toString());
    } catch (problem) {
