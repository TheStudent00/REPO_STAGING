...
// InterpRenderer from the layer-4 term of movsbl_widen_gpr_gpr_32__reg_rdi__php.
...
function emu_movsbl_widen_gpr_gpr_32__reg_rdi__php($a) {
    return ex_m(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(ex_cat(0, ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), ex_ext($a, 7, 7), 1), $a, 8), 64);
}
