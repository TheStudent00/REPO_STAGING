...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of lwu_gpr_gpr_gpr_32__reg_a0__csharp.
    // The term's layer-5 text, LITERAL:
    //   Concat(0, Extract(31, 0, v0))
    public static long emu_lwu_gpr_gpr_gpr_32__reg_a0__csharp(long a) {
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_lwu_gpr_gpr_gpr_32__reg_a0__csharp(values[0])).ToString());
                    answers.Append("\n");
