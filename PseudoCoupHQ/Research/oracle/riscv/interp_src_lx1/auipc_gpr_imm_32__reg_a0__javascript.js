...
// InterpRenderer from the layer-4 term of auipc_gpr_imm_32__reg_a0__javascript.
// The term's layer-5 text, LITERAL:
//   v0 + 12288
function emu_auipc_gpr_imm_32__reg_a0__javascript(a) {
    return m(add(a, 12288n, 64), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_auipc_gpr_imm_32__reg_a0__javascript(...values).toString());
    } catch (problem) {
