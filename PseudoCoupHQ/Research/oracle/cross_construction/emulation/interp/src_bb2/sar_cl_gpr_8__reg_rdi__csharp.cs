...
public static class Emu {
    ...
    // one named local per gate, over the term of sar_cl_gpr_8__reg_rdi__csharp.
    // The term's layer-5 text, LITERAL:
    //   Concat(Extract(63, 8, v0), Extract(7, 0, v0) >> Concat(0, Extract(4, 0, v1)))
    public static long emu_sar_cl_gpr_8__reg_rdi__csharp(long a, long b) {
        long x0_0 = ext(a, 0, 0);
        long x0_1 = ext(a, 1, 1);
        long x1_0 = ext(b, 0, 0);
        long x0_2 = ext(a, 2, 2);
        ...
        long w57 = cat(w56, g102, 1);
        long w58 = cat(w57, g96, 1);
        long w59 = cat(w58, g90, 1);
        long w60 = cat(w59, g86, 1);
        long w61 = cat(w60, g77, 1);
        long w62 = cat(w61, g60, 1);
        long w63 = cat(w62, g32, 1);
        return m(w63, 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_sar_cl_gpr_8__reg_rdi__csharp(values[0], values[1])).ToString());
                    answers.Append("\n");
