...
public static class Emu {
    ...
    // one named local per gate, over the term of movd_gpr_xmm_32__reg_xmm0__csharp.
    // The term's layer-5 text, LITERAL:
    //   Extract(31, 0, v0)
    public static long emu_movd_gpr_xmm_32__reg_xmm0__csharp(long a) {
        long x0_0 = ext(a, 0, 0);
        long x0_1 = ext(a, 1, 1);
        long x0_2 = ext(a, 2, 2);
        long x0_3 = ext(a, 3, 3);
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_movd_gpr_xmm_32__reg_xmm0__csharp(values[0])).ToString());
                    answers.Append("\n");
