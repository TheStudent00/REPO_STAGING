...
# InterpRenderer from the layer-4 term of slli_gpr_gpr_imm_64__reg_a0__cpython.
# The term's layer-5 text, LITERAL:
#   Concat(Extract(60, 0, v0), 0)
def emu_slli_gpr_gpr_imm_64__reg_a0__cpython(a):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_slli_gpr_gpr_imm_64__reg_a0__cpython(*values)
            sys.stdout.write("%d\n" % answer)
