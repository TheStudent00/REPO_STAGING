...
theorem bge_gpr_gpr_64__branch_condition__c__native_first__CLMUL_10_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_ITYPE ((pure_RTYPE (a) (b) (LeanIM.rop.SLT))) (0x001#12) (LeanIM.iop.XORI))) = (pure_CLMUL (a) (b) ) := by
  try simp only [pure_RTYPE, pure_ITYPE, pure_CLMUL, bool_to_bit, carryless_mul, log2_xlen, shift_bits_right_arith, sign_extend, xlen, xlenbits, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, zeros, Sail.BitVec.length, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend]
  grind
