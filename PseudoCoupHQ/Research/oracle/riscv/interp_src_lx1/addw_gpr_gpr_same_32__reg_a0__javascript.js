...
// InterpRenderer from the layer-4 term of addw_gpr_gpr_same_32__reg_a0__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 31, Extract(31, 0, v0)*2), Extract(31, 0, v0)*2)
function emu_addw_gpr_gpr_same_32__reg_a0__javascript(a) {
    return m(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(cat(ext(mul(a, 2n, 32), 31, 31), ext(mul(a, 2n, 32), 31, 31), 1), ext(mul(a, 2n, 32), 31, 31), 1), ext(mul(a, 2n, 32), 31, 31), 1), ext(mul(a, 2n, 32), 31, 31), 1), ext(mul(a, 2n, 32), 31, 31), 1), ext(mul(a, 2n, 32), 31, 31), 1), ext(mul(a, 2n, 32), 31, 31), 1), ext(mul(a, 2n, 32), 31, 31), 1), ext(mul(a, 2n, 32), 31, 31), 1), ext(mul(a, 2n, 32), 31, 31), 1), ext(mul(a, 2n, 32), 31, 31), 1), ext(mul(a, 2n, 32), 31, 31), 1), ext(mul(a, 2n, 32), 31, 31), 1), ext(mul(a, 2n, 32), 31, 31), 1), ext(mul(a, 2n, 32), 31, 31), 1), ext(mul(a, 2n, 32), 31, 31), 1), ext(mul(a, 2n, 32), 31, 31), 1), ext(mul(a, 2n, 32), 31, 31), 1), ext(mul(a, 2n, 32), 31, 31), 1), ext(mul(a, 2n, 32), 31, 31), 1), ext(mul(a, 2n, 32), 31, 31), 1), ext(mul(a, 2n, 32), 31, 31), 1), ext(mul(a, 2n, 32), 31, 31), 1), ext(mul(a, 2n, 32), 31, 31), 1), ext(mul(a, 2n, 32), 31, 31), 1), ext(mul(a, 2n, 32), 31, 31), 1), ext(mul(a, 2n, 32), 31, 31), 1), ext(mul(a, 2n, 32), 31, 31), 1), ext(mul(a, 2n, 32), 31, 31), 1), ext(mul(a, 2n, 32), 31, 31), 1), ext(mul(a, 2n, 32), 31, 31), 1), mul(a, 2n, 32), 32), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_addw_gpr_gpr_same_32__reg_a0__javascript(...values).toString());
    } catch (problem) {
