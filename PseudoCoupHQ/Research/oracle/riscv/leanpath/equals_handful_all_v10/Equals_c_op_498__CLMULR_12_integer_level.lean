...
theorem c_op_498__CLMULR_12_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (zero_reg) ((pure_RTYPE (a) (b) (XOR))) (LeanIM.rop.SLTU))) = (pure_CLMULR (a) (b) ) := by
  try simp only [pure_RTYPE, pure_CLMULR, bool_to_bit, carryless_mulr, log2_xlen, shift_bits_right_arith, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, zeros, xlen, Sail.BitVec.length, Sail.BitVec.zeroExtend]
  grind
