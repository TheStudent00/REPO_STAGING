#!/bin/bash
# lp3_l54_handful_c_pass_b_render_lower_prove_eye.sh -- plan node
# hq.research.lean_proof_path_resistant_to_churn.system.pass_b_build over c,
# on the handful: every arm of every certified pure form is rendered from
...
head -12 $R/pass_b/eye_table.md | cut -c1-240
echo done
