...
// one named local per gate, over the term of movss_mem_xmm_32__reg_xmm0__javascript.
// The term's layer-5 text, LITERAL:
//   Extract(31, 0, v0)
function emu_movss_mem_xmm_32__reg_xmm0__javascript(a) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_movss_mem_xmm_32__reg_xmm0__javascript(...values).toString());
    } catch (problem) {
