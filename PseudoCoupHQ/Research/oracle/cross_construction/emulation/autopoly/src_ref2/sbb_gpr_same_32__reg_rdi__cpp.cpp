/* task ex1 emulation -- rendered by cpp_render.py CppRenderer from the layer-4 term of sbb_gpr_same_32__reg_rdi__cpp.  The term's layer-5 text, LITERAL:
   Concat(0, If(Extract(32, 32, Concat(0, Extract(31, 0, v0)) + Concat(0, Extract(31, 0, v1))) == 1, 1, 0)*4294967295) */
#include <cstdint>

extern "C"
uint64_t
emu_sbb_gpr_same_32__reg_rdi__cpp(uint32_t a, uint32_t b, uint64_t c)
{
