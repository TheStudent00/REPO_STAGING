...
// intermediate per node of the term of fcvt_s_d_fpr_fpr_32__freg_fa0__go__native_first.
...
//go:noinline
func emu_fcvt_s_d_fpr_fpr_32__freg_fa0__go__native_first(a uint64) uint64 {
...
func main() {
	sink = emu_fcvt_s_d_fpr_fpr_32__freg_fa0__go__native_first(g0)
	_ = sink
}
