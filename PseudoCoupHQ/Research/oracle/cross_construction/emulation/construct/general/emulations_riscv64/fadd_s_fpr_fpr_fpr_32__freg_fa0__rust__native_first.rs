...
// intermediate per node of the term of fadd_s_fpr_fpr_fpr_32__freg_fa0__rust__native_first.
//   Concat(4294967295, fp.to_ieee_bv(fpToFP(Extract(31, 0, v0)) + fpToFP(Extract(31, 0, v1))))
#[no_mangle]
pub extern "C" fn emu_fadd_s_fpr_fpr_fpr_32__freg_fa0__rust__native_first(a: u32, b: u32) -> u64
{
    let v0: u32 = (b as u32);
