...
# InterpRenderer from the layer-4 term of shr_imm_gpr_64__reg_rdi__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(0, Extract(63, 3, v0))
def emu_shr_imm_gpr_64__reg_rdi__ruby(a)
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_shr_imm_gpr_64__reg_rdi__ruby(*values)
