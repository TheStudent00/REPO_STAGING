/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of test_gpr_same_16__flags__cpp__bit_blast.  The term's text, LITERAL:
   Concat(Extract(15, 0, v0), 0) */
#include <cstdint>

extern "C"
uint32_t
emu_test_gpr_same_16__flags__cpp__bit_blast(uint16_t a)
{
