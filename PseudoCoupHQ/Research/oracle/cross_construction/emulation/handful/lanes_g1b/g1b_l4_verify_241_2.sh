#!/usr/bin/env bash
# g1b_l4_verify_241_2.sh -- task g1b: the conventions verifier over
# log 241, the log this closer wrote for task g1.
#
...
echo "[1/1] task g1b: the conventions verifier over log 241, second pass"
python3 /projects/PseudoCoupHQ/Research/op_pipeline/check_conventions_log_claims.py \
    --verify --timeout 20 \
    $D/log_241_task_g1_find_emulation_go_and_swift.md
