...
/-- swift single-opcode row 11, arch mnemonic 'or', example unit swift/op_618, 9 members
...
theorem ModelCheck_swift_11 (v0 : BitVec 64) (v1 : BitVec 64) :
    ((v0.extractLsb 31 0) ||| (v1.extractLsb 31 0))
  = ((model_or_38 (model_mov_15 v0) v1).extractLsb 31 0) := by
  simp only [model_mov_15, model_or_38]
  bv_decide

#print axioms ModelCheck_swift_11
