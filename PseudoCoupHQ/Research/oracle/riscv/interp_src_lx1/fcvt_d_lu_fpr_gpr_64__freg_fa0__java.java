...
public class Emu {
    ...
    // InterpRenderer from the layer-4 term of fcvt_d_lu_fpr_gpr_64__freg_fa0__java.
    // The term's layer-5 text, LITERAL:
    //   fp.to_ieee_bv(fpToFPUnsigned(RNE(), v0))
    static long emu_fcvt_d_lu_fpr_gpr_64__freg_fa0__java(long a) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (line != null) {
            ...
            if (text.length() != 0) {
                ...
                try {
                    answers.append(Long.toUnsignedString(emu_fcvt_d_lu_fpr_gpr_64__freg_fa0__java(values[0])));
                    answers.append("\n");
