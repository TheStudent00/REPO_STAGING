...
# InterpRenderer from the layer-4 term of fcvt_d_w_fpr_gpr_64__freg_fa0__cpython.
# The term's layer-5 text, LITERAL:
#   fp.to_ieee_bv(fpToFP(RNE(), Extract(31, 0, v0)))
def emu_fcvt_d_w_fpr_gpr_64__freg_fa0__cpython(a):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_fcvt_d_w_fpr_gpr_64__freg_fa0__cpython(*values)
            sys.stdout.write("%d\n" % answer)
