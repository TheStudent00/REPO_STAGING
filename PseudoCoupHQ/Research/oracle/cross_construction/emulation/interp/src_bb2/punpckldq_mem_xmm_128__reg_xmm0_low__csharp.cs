...
public static class Emu {
    ...
    // one named local per gate, over the term of punpckldq_mem_xmm_128__reg_xmm0_low__csharp.
    // The term's layer-5 text, LITERAL:
    //   Concat(Extract(31, 0, v0), Extract(31, 0, v1))
    public static long emu_punpckldq_mem_xmm_128__reg_xmm0_low__csharp(long a, long b) {
        long x1_0 = ext(b, 0, 0);
        long x1_1 = ext(b, 1, 1);
        long x1_2 = ext(b, 2, 2);
        long x1_3 = ext(b, 3, 3);
        ...
        long w0 = x0_31;
        long w1 = cat(w0, x0_30, 1);
        long w2 = cat(w1, x0_29, 1);
        long w3 = cat(w2, x0_28, 1);
        long w4 = cat(w3, x0_27, 1);
        long w5 = cat(w4, x0_26, 1);
        long w6 = cat(w5, x0_25, 1);
        long w7 = cat(w6, x0_24, 1);
        long w8 = cat(w7, x0_23, 1);
        long w9 = cat(w8, x0_22, 1);
        long w10 = cat(w9, x0_21, 1);
        long w11 = cat(w10, x0_20, 1);
        long w12 = cat(w11, x0_19, 1);
        long w13 = cat(w12, x0_18, 1);
        long w14 = cat(w13, x0_17, 1);
        long w15 = cat(w14, x0_16, 1);
        long w16 = cat(w15, x0_15, 1);
        long w17 = cat(w16, x0_14, 1);
        long w18 = cat(w17, x0_13, 1);
        long w19 = cat(w18, x0_12, 1);
        long w20 = cat(w19, x0_11, 1);
        long w21 = cat(w20, x0_10, 1);
        long w22 = cat(w21, x0_9, 1);
        long w23 = cat(w22, x0_8, 1);
        long w24 = cat(w23, x0_7, 1);
        long w25 = cat(w24, x0_6, 1);
        long w26 = cat(w25, x0_5, 1);
        long w27 = cat(w26, x0_4, 1);
        long w28 = cat(w27, x0_3, 1);
        long w29 = cat(w28, x0_2, 1);
        long w30 = cat(w29, x0_1, 1);
        long w31 = cat(w30, x0_0, 1);
        ...
        long w48 = cat(w47, x1_15, 1);
        long w49 = cat(w48, x1_14, 1);
        long w50 = cat(w49, x1_13, 1);
        long w51 = cat(w50, x1_12, 1);
        long w52 = cat(w51, x1_11, 1);
        long w53 = cat(w52, x1_10, 1);
        long w54 = cat(w53, x1_9, 1);
        long w55 = cat(w54, x1_8, 1);
        long w56 = cat(w55, x1_7, 1);
        long w57 = cat(w56, x1_6, 1);
        long w58 = cat(w57, x1_5, 1);
        long w59 = cat(w58, x1_4, 1);
        long w60 = cat(w59, x1_3, 1);
        long w61 = cat(w60, x1_2, 1);
        long w62 = cat(w61, x1_1, 1);
        long w63 = cat(w62, x1_0, 1);
        return m(w63, 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_punpckldq_mem_xmm_128__reg_xmm0_low__csharp(values[0], values[1])).ToString());
                    answers.Append("\n");
