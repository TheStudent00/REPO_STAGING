/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of ucomiss_xmm_xmm_32__flags__cpp__native_first.  The term's text, LITERAL:
...
extern "C"
uint64_t
emu_ucomiss_xmm_xmm_32__flags__cpp__native_first(float a, float b)
{
    float v1 = b;
