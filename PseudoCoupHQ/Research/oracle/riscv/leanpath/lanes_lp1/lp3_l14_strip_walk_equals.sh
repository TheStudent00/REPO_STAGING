#!/bin/bash
# lp3_l14_strip_walk_equals.sh -- the three stages in one lane over the
...
S=$A/strip_6266b40c_8eb1fb6b_all_v2; W=$A/walk_handful_all_v2; E=$A/equals_handful_all_v2
...
python3 - <<'PY'
import json
W="PseudoCoupHQ/Research/oracle/riscv/leanpath/walk_handful_all_v2/walk.json"
E="PseudoCoupHQ/Research/oracle/riscv/leanpath/equals_handful_all_v2/equals.json"
try:
    d=json.load(open(W))
