/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of cpp_2__cpp_op_130.  The term's layer-5 text, LITERAL:
...
double
emu_cpp_2__cpp_op_130(double a, double b)
{
