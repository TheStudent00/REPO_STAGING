/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of go_3__go_op_333.  The term's layer-5 text, LITERAL:
...
float
emu_go_3__go_op_333(double a, float b)
{
