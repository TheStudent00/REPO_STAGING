...
// intermediate per node of the term of fld_fpr_mem_64__freg_fa0__go__bit_blast.
//   v0
package main

//go:noinline
func emu_fld_fpr_mem_64__freg_fa0__go__bit_blast(a uint64) uint64 {
...
func main() {
	sink = emu_fld_fpr_mem_64__freg_fa0__go__bit_blast(g0)
	_ = sink
}
