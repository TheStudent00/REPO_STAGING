...
// one named local per gate, over the term of sbb_gpr_gpr_64__reg_rdi__php.
// The term's layer-5 text, LITERAL:
//   If(Extract(64, 64, Concat(0, v0) + Concat(0, v1)) == 1, 1, 0)*18446744073709551615 + v2*18446744073709551615 + v3
function emu_sbb_gpr_gpr_64__reg_rdi__php($a, $b, $c, $d) {
    $x3_0 = ex_ext($c, 0, 0);
    $x2_0 = ex_ext($d, 0, 0);
    $x1_0 = ex_ext($a, 0, 0);
    $x0_0 = ex_ext($b, 0, 0);
...
while (($line = fgets($handle)) !== false) {
    ...
    try {
        $answer = emu_sbb_gpr_gpr_64__reg_rdi__php(...$ints);
        if ($answer < 0) {
            echo sprintf("%s\n", sprintf("%u", $answer));
        } else {
            echo $answer . "\n";
