...
// one named local per gate, over the term of adc_imm_gpr_64__reg_rdi__php.
// The term's layer-5 text, LITERAL:
//   If(Extract(64, 64, Concat(0, v0) + Concat(0, v1)) == 1, 1, 0) + v2 + v3
function emu_adc_imm_gpr_64__reg_rdi__php($a, $b, $c, $d) {
    $x3_0 = ex_ext($c, 0, 0);
    $x2_0 = ex_ext($d, 0, 0);
    $x1_0 = ex_ext($a, 0, 0);
    $x0_0 = ex_ext($b, 0, 0);
    ...
    $g1889 = ($g1888 ^ 1);
    $w0 = $g1889;
    $w1 = ex_cat($w0, $g1870, 1);
    $w2 = ex_cat($w1, $g1851, 1);
    $w3 = ex_cat($w2, $g1832, 1);
    $w4 = ex_cat($w3, $g1813, 1);
    $w5 = ex_cat($w4, $g1794, 1);
    $w6 = ex_cat($w5, $g1775, 1);
    $w7 = ex_cat($w6, $g1756, 1);
    $w8 = ex_cat($w7, $g1737, 1);
    $w9 = ex_cat($w8, $g1718, 1);
    $w10 = ex_cat($w9, $g1699, 1);
    $w11 = ex_cat($w10, $g1680, 1);
    $w12 = ex_cat($w11, $g1661, 1);
    $w13 = ex_cat($w12, $g1642, 1);
    $w14 = ex_cat($w13, $g1623, 1);
    $w15 = ex_cat($w14, $g1604, 1);
    $w16 = ex_cat($w15, $g1585, 1);
    $w17 = ex_cat($w16, $g1566, 1);
    $w18 = ex_cat($w17, $g1547, 1);
    $w19 = ex_cat($w18, $g1528, 1);
    $w20 = ex_cat($w19, $g1509, 1);
    $w21 = ex_cat($w20, $g1490, 1);
    $w22 = ex_cat($w21, $g1471, 1);
    $w23 = ex_cat($w22, $g1452, 1);
    $w24 = ex_cat($w23, $g1433, 1);
    $w25 = ex_cat($w24, $g1414, 1);
    $w26 = ex_cat($w25, $g1395, 1);
    $w27 = ex_cat($w26, $g1376, 1);
    $w28 = ex_cat($w27, $g1357, 1);
    $w29 = ex_cat($w28, $g1338, 1);
    $w30 = ex_cat($w29, $g1319, 1);
    $w31 = ex_cat($w30, $g1300, 1);
    $w32 = ex_cat($w31, $g1281, 1);
    $w33 = ex_cat($w32, $g1262, 1);
    $w34 = ex_cat($w33, $g1243, 1);
    $w35 = ex_cat($w34, $g1224, 1);
    $w36 = ex_cat($w35, $g1205, 1);
    $w37 = ex_cat($w36, $g1186, 1);
    $w38 = ex_cat($w37, $g1167, 1);
    $w39 = ex_cat($w38, $g1148, 1);
    $w40 = ex_cat($w39, $g1129, 1);
    $w41 = ex_cat($w40, $g1110, 1);
    $w42 = ex_cat($w41, $g1091, 1);
    $w43 = ex_cat($w42, $g1072, 1);
    $w44 = ex_cat($w43, $g1053, 1);
    $w45 = ex_cat($w44, $g1034, 1);
    $w46 = ex_cat($w45, $g1015, 1);
    $w47 = ex_cat($w46, $g996, 1);
    $w48 = ex_cat($w47, $g977, 1);
    $w49 = ex_cat($w48, $g958, 1);
    $w50 = ex_cat($w49, $g939, 1);
    $w51 = ex_cat($w50, $g920, 1);
    $w52 = ex_cat($w51, $g901, 1);
    $w53 = ex_cat($w52, $g882, 1);
    $w54 = ex_cat($w53, $g863, 1);
    $w55 = ex_cat($w54, $g844, 1);
    $w56 = ex_cat($w55, $g825, 1);
    $w57 = ex_cat($w56, $g806, 1);
    $w58 = ex_cat($w57, $g787, 1);
    $w59 = ex_cat($w58, $g768, 1);
    $w60 = ex_cat($w59, $g749, 1);
    $w61 = ex_cat($w60, $g730, 1);
    $w62 = ex_cat($w61, $g712, 1);
...
while (($line = fgets($handle)) !== false) {
    ...
    try {
        $answer = emu_adc_imm_gpr_64__reg_rdi__php(...$ints);
        if ($answer < 0) {
            echo sprintf("%s\n", sprintf("%u", $answer));
        } else {
            echo $answer . "\n";
