...
// intermediate per node of the term of movsbq_widen_gpr_gpr_64__reg_rdi__rust__bit_blast.
...
#[no_mangle]
pub extern "C" fn emu_movsbq_widen_gpr_gpr_64__reg_rdi__rust__bit_blast(a: u8) -> u64
{
