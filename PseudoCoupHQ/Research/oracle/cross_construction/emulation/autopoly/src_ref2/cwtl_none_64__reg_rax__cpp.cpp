/* task ex1 emulation -- rendered by cpp_render.py CppRenderer from the layer-4 term of cwtl_none_64__reg_rax__cpp.  The term's layer-5 text, LITERAL:
...
extern "C"
uint64_t
emu_cwtl_none_64__reg_rax__cpp(uint16_t a)
{
