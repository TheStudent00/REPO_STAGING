...
# InterpRenderer from the layer-4 term of orps_xmm_xmm_128__reg_xmm0.low__ruby.
# The term's layer-5 text, LITERAL:
#   Extract(63, 0, v0) | Extract(63, 0, v1)
def emu_orps_xmm_xmm_128__reg_xmm0.low__ruby(a, b)
  m(bor(a, b, 64), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_orps_xmm_xmm_128__reg_xmm0.low__ruby(*values)
