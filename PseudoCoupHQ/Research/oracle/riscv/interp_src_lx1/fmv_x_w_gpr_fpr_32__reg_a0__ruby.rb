...
# InterpRenderer from the layer-4 term of fmv_x_w_gpr_fpr_32__reg_a0__ruby.
...
def emu_fmv_x_w_gpr_fpr_32__reg_a0__ruby(a)
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_fmv_x_w_gpr_fpr_32__reg_a0__ruby(*values)
