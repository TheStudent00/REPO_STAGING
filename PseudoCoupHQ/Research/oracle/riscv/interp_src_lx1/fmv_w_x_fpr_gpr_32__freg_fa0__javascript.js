...
// InterpRenderer from the layer-4 term of fmv_w_x_fpr_gpr_32__freg_fa0__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(4294967295, Extract(31, 0, v0))
function emu_fmv_w_x_fpr_gpr_32__freg_fa0__javascript(a) {
    return m(cat(4294967295n, a, 32), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_fmv_w_x_fpr_gpr_32__freg_fa0__javascript(...values).toString());
    } catch (problem) {
