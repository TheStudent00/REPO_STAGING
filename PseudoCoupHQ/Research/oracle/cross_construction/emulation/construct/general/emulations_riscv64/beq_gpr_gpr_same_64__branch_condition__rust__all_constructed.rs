...
// intermediate per node of the term of beq_gpr_gpr_same_64__branch_condition__rust__all_constructed.
//   If(v0 == v1, 1, 0)
#[no_mangle]
pub extern "C" fn emu_beq_gpr_gpr_same_64__branch_condition__rust__all_constructed(a: u64, b: u64) -> u64
{
    ...
    let v15: bool = (!(v14));
    let v16: u64 = (if (v15) { ((0x1u64) as u64) } else { ((0x0u64) as u64) });
    ((v16) as u64)
}
