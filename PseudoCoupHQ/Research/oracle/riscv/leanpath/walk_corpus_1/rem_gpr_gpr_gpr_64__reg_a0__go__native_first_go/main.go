...
// intermediate per node of the term of rem_gpr_gpr_gpr_64__reg_a0__go__native_first.
...
//go:noinline
func emu_rem_gpr_gpr_gpr_64__reg_a0__go__native_first(a uint64, b uint64) uint64 {
	...
	var v6 uint64 = sel64(v5, uint64(uint64(b)), uint64(v4))
	return uint64(v6)
}
...
func main() {
	sink = emu_rem_gpr_gpr_gpr_64__reg_a0__go__native_first(g0, g1)
	_ = sink
}
