; ModuleID = '<scratch>/fl/run/f32_lt_quiet.rm2.flags/f32_lt_quiet.rm2.flags.rv.flat.ll'
source_filename = "llvm-link"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128"
target triple = "riscv64-unknown-unknown-elf"

define dso_local i64 @f32_lt_quiet_rm2_flags_flat(i64 %arg, i64 %arg1) {
  ...
  %i32 = or i32 %i2, %i
  %i33 = and i32 %i32, 2147483647
  %i34 = icmp ne i32 %i33, 0
  %i35 = and i1 %i31, %i34
  %i37 = icmp ne i32 %i, %i2
