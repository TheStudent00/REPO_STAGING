...
theorem rust__op_368_62_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_ITYPE ((pure_RTYPE (b) (a) (LeanIM.rop.SLTU))) (0x001#12) (LeanIM.iop.XORI))) = ((zero_extend (m := 64) (bool_to_bit (zopz0zI_u a b)))) := by
  try simp only [pure_ITYPE, pure_RTYPE, bool_to_bit, log2_xlen, shift_bits_right_arith, sign_extend, xlenbits, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend, Sail.BitVec.extractLsb, Sail.shift_bits_right, Sail.shift_bits_left]
  all_goals grind
