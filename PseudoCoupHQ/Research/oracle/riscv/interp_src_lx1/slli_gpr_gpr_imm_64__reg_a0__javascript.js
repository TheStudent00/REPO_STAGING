...
// InterpRenderer from the layer-4 term of slli_gpr_gpr_imm_64__reg_a0__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(Extract(60, 0, v0), 0)
function emu_slli_gpr_gpr_imm_64__reg_a0__javascript(a) {
    return m(cat(ext(a, 60, 0), 0n, 3), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_slli_gpr_gpr_imm_64__reg_a0__javascript(...values).toString());
    } catch (problem) {
