...
// one named local per gate, over the term of cltd_none_64__reg_rdx__javascript.
// The term's layer-5 text, LITERAL:
//   Concat(0, Extract(31, 0, v0) >> 31)
function emu_cltd_none_64__reg_rdx__javascript(a) {
    ...
    const w33 = cat(w32, x0_31, 1);
    const w34 = cat(w33, x0_31, 1);
    const w35 = cat(w34, x0_31, 1);
    const w36 = cat(w35, x0_31, 1);
    const w37 = cat(w36, x0_31, 1);
    const w38 = cat(w37, x0_31, 1);
    const w39 = cat(w38, x0_31, 1);
    const w40 = cat(w39, x0_31, 1);
    const w41 = cat(w40, x0_31, 1);
    const w42 = cat(w41, x0_31, 1);
    const w43 = cat(w42, x0_31, 1);
    const w44 = cat(w43, x0_31, 1);
    const w45 = cat(w44, x0_31, 1);
    const w46 = cat(w45, x0_31, 1);
    const w47 = cat(w46, x0_31, 1);
    const w48 = cat(w47, x0_31, 1);
    const w49 = cat(w48, x0_31, 1);
    const w50 = cat(w49, x0_31, 1);
    const w51 = cat(w50, x0_31, 1);
    const w52 = cat(w51, x0_31, 1);
    const w53 = cat(w52, x0_31, 1);
    const w54 = cat(w53, x0_31, 1);
    const w55 = cat(w54, x0_31, 1);
    const w56 = cat(w55, x0_31, 1);
    const w57 = cat(w56, x0_31, 1);
    const w58 = cat(w57, x0_31, 1);
    const w59 = cat(w58, x0_31, 1);
    const w60 = cat(w59, x0_31, 1);
    const w61 = cat(w60, x0_31, 1);
    const w62 = cat(w61, x0_31, 1);
    const w63 = cat(w62, x0_31, 1);
    return m(w63, 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_cltd_none_64__reg_rdx__javascript(...values).toString());
    } catch (problem) {
