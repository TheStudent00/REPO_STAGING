#!/bin/bash
# t2_l13_the_lemmas_c.sh -- task t2, lane 13: lane 10 again, each theorem stated in z3's own simplified print order first and as built second (lanes 11 and 12 measured both causes): the schemas' lemmas, in
