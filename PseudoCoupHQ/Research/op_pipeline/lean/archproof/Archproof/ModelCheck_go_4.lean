...
/-- go single-opcode row 4, arch mnemonic 'and', example unit go/op_240, 9 members
...
theorem ModelCheck_go_4 (v0 : BitVec 64) (v1 : BitVec 64) :
    (~~~((~~~(v0.extractLsb 31 0)) ||| (~~~(v1.extractLsb 31 0))))
  = ((model_and_37 v0 v1).extractLsb 31 0) := by
  simp only [model_and_37]
  bv_decide

#print axioms ModelCheck_go_4
