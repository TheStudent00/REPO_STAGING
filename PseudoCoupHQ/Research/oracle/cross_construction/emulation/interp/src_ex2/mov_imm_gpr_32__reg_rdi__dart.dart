...
// InterpRenderer from the layer-4 term of mov_imm_gpr_32__reg_rdi__dart.
// The term's layer-5 text, LITERAL:
//   Concat(0, Extract(31, 0, v0))
int emu_mov_imm_gpr_32__reg_rdi__dart(int a) {
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_mov_imm_gpr_32__reg_rdi__dart(values[0]);
