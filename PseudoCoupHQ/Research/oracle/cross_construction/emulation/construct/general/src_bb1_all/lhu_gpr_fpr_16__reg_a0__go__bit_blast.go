...
// intermediate per node of the term of lhu_gpr_fpr_16__reg_a0__go__bit_blast.
//   Concat(0, Extract(15, 0, v0))
package main

//go:noinline
func emu_lhu_gpr_fpr_16__reg_a0__go__bit_blast(a uint16) uint64 {
...
func main() {
	sink = emu_lhu_gpr_fpr_16__reg_a0__go__bit_blast(g0)
	_ = sink
}
