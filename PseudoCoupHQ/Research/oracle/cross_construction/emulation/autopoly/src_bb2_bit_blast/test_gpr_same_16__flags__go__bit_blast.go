...
// intermediate per node of the term of test_gpr_same_16__flags__go__bit_blast.
//   Concat(Extract(15, 0, v0), 0)
package main

//go:noinline
func emu_test_gpr_same_16__flags__go__bit_blast(a uint16) uint32 {
...
func main() {
	sink = emu_test_gpr_same_16__flags__go__bit_blast(g0)
	_ = sink
}
