...
// InterpRenderer from the layer-4 term of neg_gpr_one_16__reg_rdi__dart.
// The term's layer-5 text, LITERAL:
//   Concat(0, Extract(15, 0, v0)*65535)
int emu_neg_gpr_one_16__reg_rdi__dart(int a) {
  return m(cat(0, mul(a, 65535, 16), 16), 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_neg_gpr_one_16__reg_rdi__dart(values[0]);
