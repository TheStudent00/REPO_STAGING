...
- The communication protocol was consolidated: canonical now at [LLM_communication_protocol.md](file://~/Programming/DevComms/LLM_communication_protocol.md); live-project copies are symlinks; archive copies frozen.
