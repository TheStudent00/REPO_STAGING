...
/-- rust single-opcode row 38, arch mnemonic 'shr', example unit rust/regen_976, 6 members
...
theorem ModelCheck_rust_38 (v0 : BitVec 64) (v1 : BitVec 64) :
    ((v0.extractLsb 31 0) >>> ((0#27) ++ (v1.extractLsb 4 0)))
  = ((model_shr_8 (model_mov_18 v0) (model_mov_18 v1)).extractLsb 31 0) := by
  simp only [model_mov_18, model_shr_8]
  bv_decide

#print axioms ModelCheck_rust_38
