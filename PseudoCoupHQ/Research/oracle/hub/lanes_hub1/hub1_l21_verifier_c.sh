#!/usr/bin/env bash
# hub1_l20_verifier_b.sh -- task hub1, lane 21, the third pass: the same verifier over the file WITH its own tally section in it: the conventions verifier over
