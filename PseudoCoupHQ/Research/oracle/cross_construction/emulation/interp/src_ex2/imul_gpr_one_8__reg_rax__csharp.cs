...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of imul_gpr_one_8__reg_rax__csharp.
    ...
    public static long emu_imul_gpr_one_8__reg_rax__csharp(long a, long b) {
        return m(cat(ext(a, 63, 16), mul(cat(cat(cat(cat(cat(cat(cat(cat(ext(a, 7, 7), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 7), 1), ext(a, 7, 0), 8), cat(cat(cat(cat(cat(cat(cat(cat(ext(b, 7, 7), ext(b, 7, 7), 1), ext(b, 7, 7), 1), ext(b, 7, 7), 1), ext(b, 7, 7), 1), ext(b, 7, 7), 1), ext(b, 7, 7), 1), ext(b, 7, 7), 1), b, 8), 16), 16), 64);
    }
