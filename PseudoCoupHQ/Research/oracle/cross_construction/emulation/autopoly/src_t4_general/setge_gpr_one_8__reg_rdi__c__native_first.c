/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of setge_gpr_one_8__reg_rdi__c__native_first.  The term's text, LITERAL:
...
uint64_t
emu_setge_gpr_one_8__reg_rdi__c__native_first(uint8_t a, uint8_t b, uint64_t c)
{
