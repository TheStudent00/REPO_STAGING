#!/bin/bash
# lp3_l77_gate_with_the_flag_rule_again.sh -- THE GATE before any long run
...
#
# l77: the gate again, after two more folds: a `match` on a constructor the assignment
# substituted folds to its arm (else a specialized definition kept the whole match and
# refused), and the free form is not an arm of a pure form that has assignments.
#
