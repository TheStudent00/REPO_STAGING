...
// intermediate per node of the term of feq_s_gpr_fpr_fpr_32__reg_a0__rust__native_first.
//   If(fpEQ(fpToFP(Extract(31, 0, v0)), fpToFP(Extract(31, 0, v1))), 1, 0)
#[no_mangle]
pub extern "C" fn emu_feq_s_gpr_fpr_fpr_32__reg_a0__rust__native_first(a: u32, b: u32) -> u64
{
    let v0: u32 = (b as u32);
