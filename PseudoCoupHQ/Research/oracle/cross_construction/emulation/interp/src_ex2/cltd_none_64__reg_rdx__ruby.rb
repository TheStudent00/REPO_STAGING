...
# InterpRenderer from the layer-4 term of cltd_none_64__reg_rdx__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(0, Extract(31, 0, v0) >> 31)
def emu_cltd_none_64__reg_rdx__ruby(a)
  m(cat(0, ashr(a, 31, 32), 32), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_cltd_none_64__reg_rdx__ruby(*values)
