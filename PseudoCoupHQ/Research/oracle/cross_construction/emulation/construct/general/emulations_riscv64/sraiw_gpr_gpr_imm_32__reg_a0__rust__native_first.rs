...
// intermediate per node of the term of sraiw_gpr_gpr_imm_32__reg_a0__rust__native_first.
...
#[no_mangle]
pub extern "C" fn emu_sraiw_gpr_gpr_imm_32__reg_a0__rust__native_first(a: u32) -> u64
{
    let v0: u32 = (a as u32);
    let v1: u32 = (((((v0) as i32)).wrapping_shr((((0x3u32) as u32) as u32))) as u32);
