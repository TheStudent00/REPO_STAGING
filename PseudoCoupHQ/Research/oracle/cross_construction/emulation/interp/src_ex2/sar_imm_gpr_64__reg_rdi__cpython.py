...
# InterpRenderer from the layer-4 term of sar_imm_gpr_64__reg_rdi__cpython.
# The term's layer-5 text, LITERAL:
#   v0 >> 3
def emu_sar_imm_gpr_64__reg_rdi__cpython(a):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_sar_imm_gpr_64__reg_rdi__cpython(*values)
            sys.stdout.write("%d\n" % answer)
