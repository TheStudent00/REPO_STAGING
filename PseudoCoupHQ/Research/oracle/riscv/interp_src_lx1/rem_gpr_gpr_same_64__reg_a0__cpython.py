...
# InterpRenderer from the layer-4 term of rem_gpr_gpr_same_64__reg_a0__cpython.
# The term's layer-5 text, LITERAL:
#   If(v0 == 0, v0, If(And(v0 == 18446744073709551615, v0 == 9223372036854775808), 0, bvsrem_i(v0, v0)))
def emu_rem_gpr_gpr_same_64__reg_a0__cpython(a):
    return m(((a) if (eq(a, 0, 64)) else (((0) if (((eq(a, 18446744073709551615, 64)) and (eq(a, 9223372036854775808, 64)))) else (srem(a, a, 64))))), 64)
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_rem_gpr_gpr_same_64__reg_a0__cpython(*values)
            sys.stdout.write("%d\n" % answer)
