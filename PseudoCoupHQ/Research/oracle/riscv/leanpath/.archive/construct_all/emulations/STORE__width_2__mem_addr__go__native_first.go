...
// intermediate per node of the term of STORE__width_2__mem_addr__go__native_first.
//   
package main

//go:noinline
func emu_STORE__width_2__mem_addr__go__native_first(a uint64, b uint16) uint64 {
...
func main() {
	sink = emu_STORE__width_2__mem_addr__go__native_first(g0, g1)
	_ = sink
}
