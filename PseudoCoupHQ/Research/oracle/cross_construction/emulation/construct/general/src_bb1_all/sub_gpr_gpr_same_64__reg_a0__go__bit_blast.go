...
// intermediate per node of the term of sub_gpr_gpr_same_64__reg_a0__go__bit_blast.
//   0
package main

//go:noinline
func emu_sub_gpr_gpr_same_64__reg_a0__go__bit_blast(a uint64) uint64 {
	var k0 uint64 = 0
	var w0 uint64 = (k0 << 0)
...
func main() {
	sink = emu_sub_gpr_gpr_same_64__reg_a0__go__bit_blast(g0)
	_ = sink
}
