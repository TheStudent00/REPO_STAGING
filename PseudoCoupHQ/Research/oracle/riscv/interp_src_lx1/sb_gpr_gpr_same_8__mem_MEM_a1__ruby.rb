...
# InterpRenderer from the layer-4 term of sb_gpr_gpr_same_8__mem_MEM_a1__ruby.
# The term's layer-5 text, LITERAL:
#   Concat(Extract(63, 8, v0), Extract(7, 0, v1))
def emu_sb_gpr_gpr_same_8__mem_MEM_a1__ruby(a, b)
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_sb_gpr_gpr_same_8__mem_MEM_a1__ruby(*values)
