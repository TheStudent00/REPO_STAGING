/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of czero_nez_gpr_gpr_same_64__reg_a0__cpp__all_constructed.  The term's text, LITERAL:
   If(v0 == 0, v0, 0) */
#include <cstdint>

extern "C"
uint64_t
emu_czero_nez_gpr_gpr_same_64__reg_a0__cpp__all_constructed(uint64_t a)
{
    ...
    int v15 = ((!(v14))) ? 1 : 0;
    uint64_t v16 = ((v15) ? (uint64_t)((uint64_t)a) : (uint64_t)(UINT64_C(0x0)));
    return (uint64_t)(v16);
}
