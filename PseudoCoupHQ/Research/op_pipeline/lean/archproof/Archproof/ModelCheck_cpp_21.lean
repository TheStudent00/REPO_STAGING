...
/-- cpp single-opcode row 21, arch mnemonic 'imul', example unit cpp/op_181, 40 members
...
theorem ModelCheck_cpp_21 (v0 : BitVec 64) (v1 : BitVec 64) :
    (v0 * v1)
  = (model_imul_52 (model_mov_19 v0) v1) := by
  rfl

#print axioms ModelCheck_cpp_21
