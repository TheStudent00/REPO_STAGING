...
public static class Emu {
    ...
    // one named local per gate, over the term of cqto_none_64__reg_rdx__csharp.
    // The term's layer-5 text, LITERAL:
    //   v0 >> 63
    public static long emu_cqto_none_64__reg_rdx__csharp(long a) {
        long x0_63 = ext(a, 63, 63);
        long w0 = x0_63;
        long w1 = cat(w0, x0_63, 1);
        long w2 = cat(w1, x0_63, 1);
        long w3 = cat(w2, x0_63, 1);
        long w4 = cat(w3, x0_63, 1);
        long w5 = cat(w4, x0_63, 1);
        long w6 = cat(w5, x0_63, 1);
        long w7 = cat(w6, x0_63, 1);
        long w8 = cat(w7, x0_63, 1);
        long w9 = cat(w8, x0_63, 1);
        long w10 = cat(w9, x0_63, 1);
        long w11 = cat(w10, x0_63, 1);
        long w12 = cat(w11, x0_63, 1);
        long w13 = cat(w12, x0_63, 1);
        long w14 = cat(w13, x0_63, 1);
        long w15 = cat(w14, x0_63, 1);
        long w16 = cat(w15, x0_63, 1);
        long w17 = cat(w16, x0_63, 1);
        long w18 = cat(w17, x0_63, 1);
        long w19 = cat(w18, x0_63, 1);
        long w20 = cat(w19, x0_63, 1);
        long w21 = cat(w20, x0_63, 1);
        long w22 = cat(w21, x0_63, 1);
        long w23 = cat(w22, x0_63, 1);
        long w24 = cat(w23, x0_63, 1);
        long w25 = cat(w24, x0_63, 1);
        long w26 = cat(w25, x0_63, 1);
        long w27 = cat(w26, x0_63, 1);
        long w28 = cat(w27, x0_63, 1);
        long w29 = cat(w28, x0_63, 1);
        long w30 = cat(w29, x0_63, 1);
        long w31 = cat(w30, x0_63, 1);
        long w32 = cat(w31, x0_63, 1);
        long w33 = cat(w32, x0_63, 1);
        long w34 = cat(w33, x0_63, 1);
        long w35 = cat(w34, x0_63, 1);
        long w36 = cat(w35, x0_63, 1);
        long w37 = cat(w36, x0_63, 1);
        long w38 = cat(w37, x0_63, 1);
        long w39 = cat(w38, x0_63, 1);
        long w40 = cat(w39, x0_63, 1);
        long w41 = cat(w40, x0_63, 1);
        long w42 = cat(w41, x0_63, 1);
        long w43 = cat(w42, x0_63, 1);
        long w44 = cat(w43, x0_63, 1);
        long w45 = cat(w44, x0_63, 1);
        long w46 = cat(w45, x0_63, 1);
        long w47 = cat(w46, x0_63, 1);
        long w48 = cat(w47, x0_63, 1);
        long w49 = cat(w48, x0_63, 1);
        long w50 = cat(w49, x0_63, 1);
        long w51 = cat(w50, x0_63, 1);
        long w52 = cat(w51, x0_63, 1);
        long w53 = cat(w52, x0_63, 1);
        long w54 = cat(w53, x0_63, 1);
        long w55 = cat(w54, x0_63, 1);
        long w56 = cat(w55, x0_63, 1);
        long w57 = cat(w56, x0_63, 1);
        long w58 = cat(w57, x0_63, 1);
        long w59 = cat(w58, x0_63, 1);
        long w60 = cat(w59, x0_63, 1);
        long w61 = cat(w60, x0_63, 1);
        long w62 = cat(w61, x0_63, 1);
        long w63 = cat(w62, x0_63, 1);
        return m(w63, 64);
    }
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_cqto_none_64__reg_rdx__csharp(values[0])).ToString());
                    answers.Append("\n");
