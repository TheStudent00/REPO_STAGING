...
theorem meaning_float_f16_eq (s : St) (a : BitVec 64) (b : BitVec 64) (h10 : s.regs.get? .x10 = some a) (h11 : s.regs.get? .x11 = some b) (hk0 : ∀ {α : Type} (x0 : α) (s : St), (plat_term_write x0) s = EStateM.Result.ok () s) (hk1 : ∀ (x0 : Arch.pa) (x1 : Nat) (s : St), (load_reservation x0 x1) s = EStateM.Result.ok () s) (hk2 : ∀ (x0 : Unit) (s : St), (cancel_reservation x0) s = EStateM.Result.ok () s) :
    runsTo (walk [LeanIM.instruction.ITYPE (0x01f#12, LeanIM.regidx.Regidx 0x00#5, LeanIM.regidx.Regidx 0x0c#5, LeanIM.iop.ADDI), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0d#5, LeanIM.rop.OR), LeanIM.instruction.SHIFTIOP (0x0a#6, LeanIM.regidx.Regidx 0x0c#5, LeanIM.regidx.Regidx 0x0c#5, LeanIM.sop.SLLI), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0c#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0e#5, LeanIM.rop.AND), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0c#5, LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0f#5, LeanIM.rop.AND), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0c#5, LeanIM.regidx.Regidx 0x0e#5, LeanIM.regidx.Regidx 0x0e#5, LeanIM.rop.XOR), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0c#5, LeanIM.regidx.Regidx 0x0f#5, LeanIM.regidx.Regidx 0x0f#5, LeanIM.rop.XOR), LeanIM.instruction.ADDIW (0x3ff#12, LeanIM.regidx.Regidx 0x0c#5, LeanIM.regidx.Regidx 0x0c#5), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0c#5, LeanIM.regidx.Regidx 0x0d#5, LeanIM.regidx.Regidx 0x0c#5, LeanIM.rop.AND), LeanIM.instruction.ITYPE (0x3ff#12, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0d#5, LeanIM.iop.ANDI), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.rop.XOR), LeanIM.instruction.ITYPE (0x3ff#12, LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0b#5, LeanIM.iop.ANDI), LeanIM.instruction.ITYPE (0x001#12, LeanIM.regidx.Regidx 0x0d#5, LeanIM.regidx.Regidx 0x0d#5, LeanIM.iop.SLTIU), LeanIM.instruction.ITYPE (0x001#12, LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0b#5, LeanIM.iop.SLTIU), LeanIM.instruction.SHIFTIOP (0x30#6, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.sop.SLLI), LeanIM.instruction.ITYPE (0x001#12, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.iop.SLTIU), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0e#5, LeanIM.regidx.Regidx 0x00#5, LeanIM.regidx.Regidx 0x0e#5, LeanIM.rop.SLTU), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0f#5, LeanIM.regidx.Regidx 0x00#5, LeanIM.regidx.Regidx 0x0f#5, LeanIM.rop.SLTU), LeanIM.instruction.ITYPE (0x001#12, LeanIM.regidx.Regidx 0x0c#5, LeanIM.regidx.Regidx 0x0c#5, LeanIM.iop.SLTIU), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0d#5, LeanIM.regidx.Regidx 0x0e#5, LeanIM.regidx.Regidx 0x0d#5, LeanIM.rop.OR), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0f#5, LeanIM.regidx.Regidx 0x0b#5, LeanIM.rop.OR), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0d#5, LeanIM.regidx.Regidx 0x0b#5, LeanIM.rop.AND), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0c#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.rop.OR), LeanIM.instruction.RTYPE (LeanIM.regidx.Regidx 0x0b#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.regidx.Regidx 0x0a#5, LeanIM.rop.AND)]) s
      ((pure_RTYPE ((pure_RTYPE ((pure_ITYPE ((pure_SHIFTIOP ((pure_RTYPE (b) (a) (LeanIM.rop.XOR))) (0x30#6) (LeanIM.sop.SLLI))) (0x001#12) (LeanIM.iop.SLTIU))) ((pure_ITYPE ((pure_RTYPE ((pure_RTYPE (b) (a) (LeanIM.rop.OR))) ((pure_ADDIW ((pure_SHIFTIOP ((pure_ITYPE (zero_reg) (0x01f#12) (LeanIM.iop.ADDI))) (0x0a#6) (LeanIM.sop.SLLI))) (0x3ff#12))) (LeanIM.rop.AND))) (0x001#12) (LeanIM.iop.SLTIU))) (LeanIM.rop.OR))) ((pure_RTYPE ((pure_RTYPE ((pure_RTYPE (zero_reg) ((pure_RTYPE ((pure_RTYPE (a) ((pure_SHIFTIOP ((pure_ITYPE (zero_reg) (0x01f#12) (LeanIM.iop.ADDI))) (0x0a#6) (LeanIM.sop.SLLI))) (LeanIM.rop.AND))) ((pure_SHIFTIOP ((pure_ITYPE (zero_reg) (0x01f#12) (LeanIM.iop.ADDI))) (0x0a#6) (LeanIM.sop.SLLI))) (LeanIM.rop.XOR))) (LeanIM.rop.SLTU))) ((pure_ITYPE ((pure_ITYPE (a) (0x3ff#12) (LeanIM.iop.ANDI))) (0x001#12) (LeanIM.iop.SLTIU))) (LeanIM.rop.OR))) ((pure_RTYPE ((pure_RTYPE (zero_reg) ((pure_RTYPE ((pure_RTYPE (b) ((pure_SHIFTIOP ((pure_ITYPE (zero_reg) (0x01f#12) (LeanIM.iop.ADDI))) (0x0a#6) (LeanIM.sop.SLLI))) (LeanIM.rop.AND))) ((pure_SHIFTIOP ((pure_ITYPE (zero_reg) (0x01f#12) (LeanIM.iop.ADDI))) (0x0a#6) (LeanIM.sop.SLLI))) (LeanIM.rop.XOR))) (LeanIM.rop.SLTU))) ((pure_ITYPE ((pure_ITYPE (b) (0x3ff#12) (LeanIM.iop.ANDI))) (0x001#12) (LeanIM.iop.SLTIU))) (LeanIM.rop.OR))) (LeanIM.rop.AND))) (LeanIM.rop.AND))) := by
  simp (config := {decide := true}) [runsTo, walk, step, execute, strip_ITYPE, strip_RTYPE, strip_SHIFTIOP, strip_ADDIW,
