...
// one named local per gate, over the term of cltd_none_64__reg_rdx__php.
// The term's layer-5 text, LITERAL:
//   Concat(0, Extract(31, 0, v0) >> 31)
function emu_cltd_none_64__reg_rdx__php($a) {
    ...
    $w33 = ex_cat($w32, $x0_31, 1);
    $w34 = ex_cat($w33, $x0_31, 1);
    $w35 = ex_cat($w34, $x0_31, 1);
    $w36 = ex_cat($w35, $x0_31, 1);
    $w37 = ex_cat($w36, $x0_31, 1);
    $w38 = ex_cat($w37, $x0_31, 1);
    $w39 = ex_cat($w38, $x0_31, 1);
    $w40 = ex_cat($w39, $x0_31, 1);
    $w41 = ex_cat($w40, $x0_31, 1);
    $w42 = ex_cat($w41, $x0_31, 1);
    $w43 = ex_cat($w42, $x0_31, 1);
    $w44 = ex_cat($w43, $x0_31, 1);
    $w45 = ex_cat($w44, $x0_31, 1);
    $w46 = ex_cat($w45, $x0_31, 1);
    $w47 = ex_cat($w46, $x0_31, 1);
    $w48 = ex_cat($w47, $x0_31, 1);
    $w49 = ex_cat($w48, $x0_31, 1);
    $w50 = ex_cat($w49, $x0_31, 1);
    $w51 = ex_cat($w50, $x0_31, 1);
    $w52 = ex_cat($w51, $x0_31, 1);
    $w53 = ex_cat($w52, $x0_31, 1);
    $w54 = ex_cat($w53, $x0_31, 1);
    $w55 = ex_cat($w54, $x0_31, 1);
    $w56 = ex_cat($w55, $x0_31, 1);
    $w57 = ex_cat($w56, $x0_31, 1);
    $w58 = ex_cat($w57, $x0_31, 1);
    $w59 = ex_cat($w58, $x0_31, 1);
    $w60 = ex_cat($w59, $x0_31, 1);
    $w61 = ex_cat($w60, $x0_31, 1);
    $w62 = ex_cat($w61, $x0_31, 1);
    $w63 = ex_cat($w62, $x0_31, 1);
    return ex_m($w63, 64);
}
...
while (($line = fgets($handle)) !== false) {
    ...
    try {
        $answer = emu_cltd_none_64__reg_rdx__php(...$ints);
        if ($answer < 0) {
            echo sprintf("%s\n", sprintf("%u", $answer));
        } else {
            echo $answer . "\n";
