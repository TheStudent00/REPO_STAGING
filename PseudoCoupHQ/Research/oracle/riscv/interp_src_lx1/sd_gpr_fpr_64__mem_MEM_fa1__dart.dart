...
// InterpRenderer from the layer-4 term of sd_gpr_fpr_64__mem_MEM_fa1__dart.
// The term's layer-5 text, LITERAL:
//   v0
int emu_sd_gpr_fpr_64__mem_MEM_fa1__dart(int a) {
  return m(a, 64);
}
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_sd_gpr_fpr_64__mem_MEM_fa1__dart(values[0]);
