...
// InterpRenderer from the layer-4 term of fmv_x_w_gpr_fpr_32__reg_a0__javascript.
...
function emu_fmv_x_w_gpr_fpr_32__reg_a0__javascript(a) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_fmv_x_w_gpr_fpr_32__reg_a0__javascript(...values).toString());
    } catch (problem) {
