/* task o7 emulation -- rendered by emulate.py Renderer from the layer-4 term of E01656__swift_regen_1035.  The term's layer-5 text, LITERAL:
   If(Extract(15, 0, v0) == Extract(15, 0, v1), 0, 1) | If(0 <= Extract(7, 0, v0), 0, 1) */
#include <stdint.h>

uint8_t
emu_E01656__swift_regen_1035(uint16_t a, uint16_t b, uint64_t c)
{
