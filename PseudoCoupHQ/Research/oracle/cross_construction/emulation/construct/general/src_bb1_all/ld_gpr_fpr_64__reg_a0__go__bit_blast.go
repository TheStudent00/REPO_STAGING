...
// intermediate per node of the term of ld_gpr_fpr_64__reg_a0__go__bit_blast.
//   v0
package main

//go:noinline
func emu_ld_gpr_fpr_64__reg_a0__go__bit_blast(a uint64) uint64 {
...
func main() {
	sink = emu_ld_gpr_fpr_64__reg_a0__go__bit_blast(g0)
	_ = sink
}
