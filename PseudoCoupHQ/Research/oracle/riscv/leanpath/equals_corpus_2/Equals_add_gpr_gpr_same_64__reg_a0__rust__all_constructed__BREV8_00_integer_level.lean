...
theorem add_gpr_gpr_same_64__reg_a0__rust__all_constructed__BREV8_00_integer_level (a : BitVec 64) :
    ((pure_SHIFTIOP (a) ((0x01#6)) (SLLI))) = (pure_BREV8 (a) ) := by
  try simp only [pure_SHIFTIOP, pure_BREV8, brev8, log2_xlen, shift_bits_right_arith, reverse_bits, zeros, xlen, Sail.BitVec.length, Sail.BitVec.updateSubrange, Sail.BitVec.extractLsb]
  grind
