...
// InterpRenderer from the layer-4 term of addsd_xmm_xmm_64__reg_xmm0__dart.
// The term's layer-5 text, LITERAL:
//   fp.to_ieee_bv(fpToFP(Extract(63, 0, v0)) + fpToFP(Extract(63, 0, v1)))
int emu_addsd_xmm_xmm_64__reg_xmm0__dart(int a, int b) {
  ...
  while (line != null) {
    ...
    if (text.isNotEmpty) {
      final List<int> values = text
          ...
          .toList();
      try {
        final int answer = emu_addsd_xmm_xmm_64__reg_xmm0__dart(values[0], values[1]);
