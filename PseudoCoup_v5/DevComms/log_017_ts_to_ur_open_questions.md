...
(`~/Programming/PseudoCoup_v5/Tools/ledgerer/`). The unbuilt trio is
...
rows. `~/Programming/PseudoCoup_v5/DevComms/log_008_kinds_coarse_tagging_draft.md`
...
- re-parse contents under the per-macro shape table —
  `~/Programming/PseudoCoup_v5/DevComms/log_010_token_tree_reparse_coverage.md`:
...
- run the kind-one engine
  (`~/Programming/PseudoCoup_v5/Research/macro_engine.py`, pulled
