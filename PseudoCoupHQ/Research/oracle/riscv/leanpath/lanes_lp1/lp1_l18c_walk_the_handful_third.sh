#!/bin/bash
# lp1_l18c_walk_the_handful_third.sh -- lane 18 a third time: the decoder's printed value as a String (repr gives a Format).
...
OUT=$A/walk_handful_6266b40c_8eb1fb6b_IMZ_c
...
f=$(python3 - <<'PY'
import json
d=json.load(open("PseudoCoupHQ/Research/oracle/riscv/leanpath/walk_handful_6266b40c_8eb1fb6b_IMZ_c/walk.json"))
