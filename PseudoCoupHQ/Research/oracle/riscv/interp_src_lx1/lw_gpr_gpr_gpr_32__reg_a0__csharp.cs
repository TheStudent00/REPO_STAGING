...
public static class Emu {
    ...
    // InterpRenderer from the layer-4 term of lw_gpr_gpr_gpr_32__reg_a0__csharp.
    ...
    public static long emu_lw_gpr_gpr_gpr_32__reg_a0__csharp(long a) {
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_lw_gpr_gpr_gpr_32__reg_a0__csharp(values[0])).ToString());
                    answers.Append("\n");
