; ModuleID = '<scratch>/fl/run/f64_eq.rm3.value/f64_eq.rm3.value.rv.flat.ll'
source_filename = "llvm-link"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128"
target triple = "riscv64-unknown-unknown-elf"

define dso_local zeroext i1 @f64_eq_rm3_value_flat(i64 %arg, i64 %arg1) {
  ...
  %i11 = or i1 %i8, %i10
  %.c1 = and i1 %i5, %i11
  %i13 = icmp eq i64 %arg, %arg1
  %i14 = or i64 %arg1, %arg
  %i15 = and i64 %i14, 9223372036854775807
