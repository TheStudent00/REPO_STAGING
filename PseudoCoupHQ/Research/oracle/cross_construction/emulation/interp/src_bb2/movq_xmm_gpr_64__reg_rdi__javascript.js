...
// one named local per gate, over the term of movq_xmm_gpr_64__reg_rdi__javascript.
// The term's layer-5 text, LITERAL:
//   Extract(63, 0, v0)
function emu_movq_xmm_gpr_64__reg_rdi__javascript(a) {
...
for (const line of lines) {
    ...
    try {
        out.push(emu_movq_xmm_gpr_64__reg_rdi__javascript(...values).toString());
    } catch (problem) {
