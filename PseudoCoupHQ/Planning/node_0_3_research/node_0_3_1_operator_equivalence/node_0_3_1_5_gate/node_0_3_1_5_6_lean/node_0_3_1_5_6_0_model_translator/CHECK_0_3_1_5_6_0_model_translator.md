---
id: hq.research.compiler_graph.gate.lean.model_translator.check
---

# CHECK — 0_3_1_5_6_0_model_translator

Node `hq.research.compiler_graph.gate.lean.model_translator`. Status `draft`.
