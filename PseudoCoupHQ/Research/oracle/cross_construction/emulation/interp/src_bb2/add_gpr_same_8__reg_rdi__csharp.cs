...
public static class Emu {
    ...
    // one named local per gate, over the term of add_gpr_same_8__reg_rdi__csharp.
    // The term's layer-5 text, LITERAL:
    //   Concat(Extract(63, 8, v0), Extract(7, 0, v0)*2)
    public static long emu_add_gpr_same_8__reg_rdi__csharp(long a) {
        long x0_0 = ext(a, 0, 0);
        long x0_1 = ext(a, 1, 1);
        long x0_2 = ext(a, 2, 2);
        long x0_3 = ext(a, 3, 3);
        ...
        long w56 = cat(w55, x0_6, 1);
        long w57 = cat(w56, x0_5, 1);
        long w58 = cat(w57, x0_4, 1);
        long w59 = cat(w58, x0_3, 1);
        long w60 = cat(w59, x0_2, 1);
        long w61 = cat(w60, x0_1, 1);
        long w62 = cat(w61, x0_0, 1);
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_add_gpr_same_8__reg_rdi__csharp(values[0])).ToString());
                    answers.Append("\n");
