...
// InterpRenderer from the layer-4 term of div_gpr_gpr_same_64__reg_a0__javascript.
...
function emu_div_gpr_gpr_same_64__reg_a0__javascript(a) {
    return m(((eq(a, 0n, 64)) ? (18446744073709551615n) : (((((eq(a, 18446744073709551615n, 64)) && (eq(a, 9223372036854775808n, 64)))) ? (9223372036854775808n) : (sdiv(a, a, 64))))), 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_div_gpr_gpr_same_64__reg_a0__javascript(...values).toString());
    } catch (problem) {
