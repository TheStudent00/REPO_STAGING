/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of div_gpr_one_64__reg_rax__cpp__native_first.  The term's text, LITERAL:
   Extract(63, 0, bvudiv_i(Concat(v0, v1), Concat(0, v2))) */
#include <cstdint>

extern "C"
uint64_t
emu_div_gpr_one_64__reg_rax__cpp__native_first(uint64_t a, uint64_t b, uint64_t c)
{
