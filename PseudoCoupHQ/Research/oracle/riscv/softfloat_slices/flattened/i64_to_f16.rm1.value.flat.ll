; ModuleID = '<scratch>/fl/run/i64_to_f16.rm1.value/i64_to_f16.rm1.value.rv.flat.ll'
source_filename = "llvm-link"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128"
target triple = "riscv64-unknown-unknown-elf"

define dso_local i64 @i64_to_f16_rm1_value_flat(i64 noundef %arg) {
  ...
  %i56 = and i32 32768, %.m33
  %i59 = or i32 %i52, %i56
  %i55 = icmp eq i32 %i52, 0
  %.m35 = sext i1 %i55 to i32
  %.n36 = xor i32 %.m35, -1
  ...
  %.c42 = and i1 %.n14, %or.cond
  %.c44 = and i1 %.c42, %.n15
  %.c45 = or i1 %.c41, %.c44
  %.m46 = sext i1 %.c45 to i64
  %.a47 = and i64 %i62, %.m46
  %.o48 = or i64 %.a39, %.a47
  %.n49 = xor i1 %or.cond, true
  %.c50 = and i1 %.n14, %.n49
  %.c51 = and i1 %.c50, %i43
  %.c52 = and i1 %.c51, %.n15
