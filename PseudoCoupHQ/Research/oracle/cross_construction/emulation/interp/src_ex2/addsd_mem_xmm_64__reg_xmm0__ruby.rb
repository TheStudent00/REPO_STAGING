...
# InterpRenderer from the layer-4 term of addsd_mem_xmm_64__reg_xmm0__ruby.
# The term's layer-5 text, LITERAL:
#   fp.to_ieee_bv(fpToFP(Extract(63, 0, v0)) + fpToFP(v1))
def emu_addsd_mem_xmm_64__reg_xmm0__ruby(a, b)
  m(fadd(b, a, 64), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_addsd_mem_xmm_64__reg_xmm0__ruby(*values)
