...
// InterpRenderer from the layer-4 term of sbb_gpr_same_32__reg_rdi__dart.
...
int emu_sbb_gpr_same_32__reg_rdi__dart(int a, int b, int c) {
  return m(cat(0, mul(((eq(ext(add(cat(0, b, 32), cat(0, a, 32), 33), 32, 32), 1, 1)) ? (1) : (0)), 4294967295, 32), 32), 64);
}
