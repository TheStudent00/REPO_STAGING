...
// intermediate per node of the term of sar_imm_gpr_8__reg_rdi__go__bit_blast.
//   Concat(Extract(63, 8, v0), Extract(7, 0, v0) >> 3)
package main

//go:noinline
func emu_sar_imm_gpr_8__reg_rdi__go__bit_blast(a uint64) uint64 {
	...
	var w5 uint64 = w4 | (x0_7 << 5)
	var w6 uint64 = w5 | (x0_7 << 6)
...
func main() {
	sink = emu_sar_imm_gpr_8__reg_rdi__go__bit_blast(g0)
	_ = sink
}
