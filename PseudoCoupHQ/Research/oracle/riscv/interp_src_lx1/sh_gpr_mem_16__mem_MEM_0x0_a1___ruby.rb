...
# InterpRenderer from the layer-4 term of sh_gpr_mem_16__mem_MEM_0x0_a1___ruby.
# The term's layer-5 text, LITERAL:
#   Concat(Extract(63, 16, v0), Extract(15, 0, v1))
def emu_sh_gpr_mem_16__mem_MEM_0x0_a1___ruby(a, b)
  m(cat(ext(a, 63, 16), b, 16), 64)
end
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_sh_gpr_mem_16__mem_MEM_0x0_a1___ruby(*values)
