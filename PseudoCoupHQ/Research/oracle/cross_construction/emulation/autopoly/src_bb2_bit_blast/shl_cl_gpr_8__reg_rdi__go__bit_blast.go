...
// intermediate per node of the term of shl_cl_gpr_8__reg_rdi__go__bit_blast.
//   Concat(Extract(63, 8, v0), Extract(7, 0, v0) << Concat(0, Extract(4, 0, v1)))
package main

//go:noinline
func emu_shl_cl_gpr_8__reg_rdi__go__bit_blast(a uint64, b uint8) uint64 {
	...
	var g3 uint64 = (x1_4 ^ 1)
	var g4 uint64 = (x1_3 ^ 1)
	var g5 uint64 = (g4 & g3)
	var g6 uint64 = (g5 & g2)
	var g7 uint64 = (g6 & g1)
	var g8 uint64 = (g7 & g0)
	...
	var g57 uint64 = (g56 & g4)
	var g58 uint64 = (g57 & g3)
	...
	var g74 uint64 = (g73 & g4)
	var g75 uint64 = (g74 & g3)
	...
	var g88 uint64 = (g87 & g4)
	var g89 uint64 = (g88 & g3)
	...
	var g102 uint64 = (g101 & g4)
	var g103 uint64 = (g102 & g3)
	var w0 uint64 = (g9 << 0)
...
func main() {
	sink = emu_shl_cl_gpr_8__reg_rdi__go__bit_blast(g0, g1)
	_ = sink
}
