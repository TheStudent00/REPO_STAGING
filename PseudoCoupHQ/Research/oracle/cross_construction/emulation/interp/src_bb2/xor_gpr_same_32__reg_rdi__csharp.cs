...
public static class Emu {
    ...
    // one named local per gate, over the term of xor_gpr_same_32__reg_rdi__csharp.
    // The term's layer-5 text, LITERAL:
    //   0
    public static long emu_xor_gpr_same_32__reg_rdi__csharp(long a) {
        long k0 = 0L;
        long w0 = k0;
        long w1 = cat(w0, k0, 1);
        long w2 = cat(w1, k0, 1);
    ...
    public static void Main() {
        ...
        while (line != null) {
            ...
            if (text.Length != 0) {
                ...
                try {
                    answers.Append(((ulong) emu_xor_gpr_same_32__reg_rdi__csharp(values[0])).ToString());
                    answers.Append("\n");
