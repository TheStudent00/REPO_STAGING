...
// intermediate per node of the term of LOAD__is_unsigned_False__width_2__rd__go__all_constructed.
//   
package main

//go:noinline
func emu_LOAD__is_unsigned_False__width_2__rd__go__all_constructed(a uint16) uint64 {
	...
	var v51 uint64 = (uint64(((uint64(v50)) << 16) | (uint64(v2))))
	return uint64(v51)
}
...
func main() {
	sink = emu_LOAD__is_unsigned_False__width_2__rd__go__all_constructed(g0)
	_ = sink
}
