...
// intermediate per node of the term of fsd_fpr_fpr_64__mem_MEM_fa1__go__bit_blast.
//   v0
package main

//go:noinline
func emu_fsd_fpr_fpr_64__mem_MEM_fa1__go__bit_blast(a uint64) uint64 {
...
func main() {
	sink = emu_fsd_fpr_fpr_64__mem_MEM_fa1__go__bit_blast(g0)
	_ = sink
}
