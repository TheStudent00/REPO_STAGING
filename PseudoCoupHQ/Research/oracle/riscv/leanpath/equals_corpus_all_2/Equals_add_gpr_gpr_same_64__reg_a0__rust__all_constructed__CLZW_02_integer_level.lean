...
theorem add_gpr_gpr_same_64__reg_a0__rust__all_constructed__CLZW_02_integer_level (a : BitVec 64) :
    ((pure_SHIFTIOP (a) ((0x01#6)) (SLLI))) = (pure_CLZW (a) ) := by
  try simp only [pure_SHIFTIOP, pure_CLZW, log2_xlen, shift_bits_right_arith, to_bits, xlen]
  grind
