...
#
#   bash PseudoCoup_v5/Research/rust_routing/fetch_sources.sh
#
#   rustc codegen — a sparse checkout of rust-lang/rust (~50 MB, not
#   ~1 GB). Directories are added by
#   PseudoCoup_v5/Research/llvm_trace/fetch_llvm.sh as it
#   needs them.
#
# 2026-08-02: a second step was removed from this script by a standing
# prohibition — see PseudoCoupHQ/CRANELIFT_IS_BANNED.md.
...
# Sources (the owner, 2026-08-02). That folder is filtered out
...
echo
echo "Share this output (or: bash PseudoCoup_v5/Research/rust_routing/fetch_sources.sh > fetch_report.txt)"
