...
# InterpRenderer from the layer-4 term of div_gpr_one_16__reg_rax__cpython.
# The term's layer-5 text, LITERAL:
#   Concat(Extract(63, 16, v1), Extract(15, 0, bvudiv_i(Concat(Extract(15, 0, v0), Extract(15, 0, v1)), Concat(0, Extract(15, 0, v2)))))
def emu_div_gpr_one_16__reg_rax__cpython(a, b, c):
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_div_gpr_one_16__reg_rax__cpython(*values)
            sys.stdout.write("%d\n" % answer)
