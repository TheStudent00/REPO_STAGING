...
/-- c single-opcode row 25, arch mnemonic 'lea', example unit c/op_109, 40 members
...
theorem ModelCheck_c_25 (v0 : BitVec 64) (v1 : BitVec 64) :
    (v0 + v1)
  = (model_lea_1 v0 v1) := by
  simp only [model_lea_1]
  bv_decide

#print axioms ModelCheck_c_25
