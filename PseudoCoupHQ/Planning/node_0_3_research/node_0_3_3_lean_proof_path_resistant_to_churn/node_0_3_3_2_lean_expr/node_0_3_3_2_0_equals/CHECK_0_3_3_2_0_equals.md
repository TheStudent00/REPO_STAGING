---
id: hq.research.lean_proof_path_resistant_to_churn.lean_expr.equals.check
---

# CHECK — 0_3_3_2_0_equals

Node `hq.research.lean_proof_path_resistant_to_churn.lean_expr.equals`. Status `draft`.
