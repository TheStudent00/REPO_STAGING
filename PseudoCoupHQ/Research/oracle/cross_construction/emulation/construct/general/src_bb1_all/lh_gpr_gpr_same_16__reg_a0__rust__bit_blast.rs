...
// intermediate per node of the term of lh_gpr_gpr_same_16__reg_a0__rust__bit_blast.
...
#[no_mangle]
pub extern "C" fn emu_lh_gpr_gpr_same_16__reg_a0__rust__bit_blast(a: u16) -> u64
{
    ...
    let w17: u64 = w16 | (x0_15 << 17);
    let w18: u64 = w17 | (x0_15 << 18);
    let w19: u64 = w18 | (x0_15 << 19);
    let w20: u64 = w19 | (x0_15 << 20);
    let w21: u64 = w20 | (x0_15 << 21);
    let w22: u64 = w21 | (x0_15 << 22);
    let w23: u64 = w22 | (x0_15 << 23);
    let w24: u64 = w23 | (x0_15 << 24);
    let w25: u64 = w24 | (x0_15 << 25);
    let w26: u64 = w25 | (x0_15 << 26);
    let w27: u64 = w26 | (x0_15 << 27);
    let w28: u64 = w27 | (x0_15 << 28);
    let w29: u64 = w28 | (x0_15 << 29);
    let w30: u64 = w29 | (x0_15 << 30);
    let w31: u64 = w30 | (x0_15 << 31);
    let w32: u64 = w31 | (x0_15 << 32);
    let w33: u64 = w32 | (x0_15 << 33);
    let w34: u64 = w33 | (x0_15 << 34);
    let w35: u64 = w34 | (x0_15 << 35);
    let w36: u64 = w35 | (x0_15 << 36);
    let w37: u64 = w36 | (x0_15 << 37);
    let w38: u64 = w37 | (x0_15 << 38);
    let w39: u64 = w38 | (x0_15 << 39);
    let w40: u64 = w39 | (x0_15 << 40);
    let w41: u64 = w40 | (x0_15 << 41);
    let w42: u64 = w41 | (x0_15 << 42);
    let w43: u64 = w42 | (x0_15 << 43);
    let w44: u64 = w43 | (x0_15 << 44);
    let w45: u64 = w44 | (x0_15 << 45);
    let w46: u64 = w45 | (x0_15 << 46);
    let w47: u64 = w46 | (x0_15 << 47);
    let w48: u64 = w47 | (x0_15 << 48);
    let w49: u64 = w48 | (x0_15 << 49);
    let w50: u64 = w49 | (x0_15 << 50);
    let w51: u64 = w50 | (x0_15 << 51);
    let w52: u64 = w51 | (x0_15 << 52);
    let w53: u64 = w52 | (x0_15 << 53);
    let w54: u64 = w53 | (x0_15 << 54);
    let w55: u64 = w54 | (x0_15 << 55);
    let w56: u64 = w55 | (x0_15 << 56);
    let w57: u64 = w56 | (x0_15 << 57);
    let w58: u64 = w57 | (x0_15 << 58);
    let w59: u64 = w58 | (x0_15 << 59);
    let w60: u64 = w59 | (x0_15 << 60);
    let w61: u64 = w60 | (x0_15 << 61);
    let w62: u64 = w61 | (x0_15 << 62);
    let w63: u64 = w62 | (x0_15 << 63);
    ((w63) as u64)
}
