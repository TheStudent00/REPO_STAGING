...
theorem MUL__Low_Signed_Signed__rust_04_integer_level (a : BitVec 64) (b : BitVec 64) :
  ...
  try simp only [pure_MUL, pure_MUL, mult_to_bits_half, xlen, to_bits_truncate, Sail.BitVec.extractLsb, Sail.get_slice_int]
  all_goals grind

set_option maxHeartbeats 40000 in
theorem MUL__Low_Signed_Signed__rust_05_integer_level (a : BitVec 64) (b : BitVec 64) :
...
set_option maxHeartbeats 40000 in
theorem MUL__Low_Signed_Signed__rust_06_integer_level (a : BitVec 64) (b : BitVec 64) :
...
set_option maxHeartbeats 40000 in
theorem MUL__Low_Signed_Signed__rust_07_integer_level (a : BitVec 64) (b : BitVec 64) :
