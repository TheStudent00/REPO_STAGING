...
# InterpRenderer from the layer-4 term of idiv_gpr_one_16__reg_rax__ruby.
...
STDIN.each_line do |line|
  ...
  begin
    puts emu_idiv_gpr_one_16__reg_rax__ruby(*values)
