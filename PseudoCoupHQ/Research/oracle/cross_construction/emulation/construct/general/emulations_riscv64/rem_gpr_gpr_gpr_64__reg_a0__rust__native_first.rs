...
// intermediate per node of the term of rem_gpr_gpr_gpr_64__reg_a0__rust__native_first.
//   If(v0 == 0, v1, If(And(v0 == 18446744073709551615, v1 == 9223372036854775808), 0, bvsrem_i(v1, v0)))
#[no_mangle]
pub extern "C" fn emu_rem_gpr_gpr_gpr_64__reg_a0__rust__native_first(a: u64, b: u64) -> u64
{
    ...
    let v6: u64 = (if (v5) { (((b as u64)) as u64) } else { ((v4) as u64) });
    ((v6) as u64)
}
