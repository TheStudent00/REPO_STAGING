...
// InterpRenderer from the layer-4 term of fmv_d_fpr_fpr_fpr_64__freg_fa0__javascript.
// The term's layer-5 text, LITERAL:
//   v0
function emu_fmv_d_fpr_fpr_fpr_64__freg_fa0__javascript(a) {
    return m(a, 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_fmv_d_fpr_fpr_fpr_64__freg_fa0__javascript(...values).toString());
    } catch (problem) {
