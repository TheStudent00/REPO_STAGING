...
theorem au_407_c_ne_i32_i32_abi_integer_level (a : BitVec 64) (b : BitVec 64) :
  ...
  try simp only [pure_ADDIW, pure_RTYPE, bool_to_bit, log2_xlen, shift_bits_right_arith, sign_extend, zero_extend, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.signExtend, Sail.BitVec.zeroExtend, Sail.BitVec.extractLsb]
  all_goals grind
