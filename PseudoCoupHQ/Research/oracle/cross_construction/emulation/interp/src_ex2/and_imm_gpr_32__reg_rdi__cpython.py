...
# InterpRenderer from the layer-4 term of and_imm_gpr_32__reg_rdi__cpython.
# The term's layer-5 text, LITERAL:
#   Concat(0, ~(~Extract(31, 0, v0) | ~Extract(31, 0, v1)))
def emu_and_imm_gpr_32__reg_rdi__cpython(a, b):
    return m(cat(0, bnot(bor(bnot(b, 32), bnot(a, 32), 32), 32), 32), 64)
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_and_imm_gpr_32__reg_rdi__cpython(*values)
            sys.stdout.write("%d\n" % answer)
