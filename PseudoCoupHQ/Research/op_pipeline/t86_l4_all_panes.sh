#!/usr/bin/env bash
# t86_l4_all_panes.sh -- TASK 86, lane 4: THE FULL PASS.
#
...
#
# Product: /out/t86_all_panes.json
...
with open("/out/t86_all_panes.json", "w") as fh:
...
print("wrote /out/t86_all_panes.json")
if errors:
    raise SystemExit(9)
PY
