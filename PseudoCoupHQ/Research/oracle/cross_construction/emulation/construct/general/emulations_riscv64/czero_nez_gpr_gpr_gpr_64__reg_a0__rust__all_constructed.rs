...
// intermediate per node of the term of czero_nez_gpr_gpr_gpr_64__reg_a0__rust__all_constructed.
//   If(v0 == 0, v1, 0)
#[no_mangle]
pub extern "C" fn emu_czero_nez_gpr_gpr_gpr_64__reg_a0__rust__all_constructed(a: u64, b: u64) -> u64
{
    let v0: u64 = (((((a as u64)) as u64) ^ ((0x0u64) as u64)) as u64);
    ...
    let v15: bool = (!(v14));
    let v16: u64 = (if (v15) { (((b as u64)) as u64) } else { ((0x0u64) as u64) });
    ((v16) as u64)
}
