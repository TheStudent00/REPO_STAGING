/* task t4 emulation -- rendered by render_general.py, one named
   intermediate per node of the term of setae_gpr_one_8__reg_rdi__cpp__native_first.  The term's text, LITERAL:
   Concat(Extract(63, 8, v0), If(ULE(Extract(7, 0, v1), Extract(7, 0, v2)), 1, 0)) */
#include <cstdint>

extern "C"
uint64_t
emu_setae_gpr_one_8__reg_rdi__cpp__native_first(uint8_t a, uint8_t b, uint64_t c)
{
