...
OPS = {
    ...
    "f16_eq": f16_eq_rm0,
    "f16_le": f16_le_rm0,
    "f16_le_quiet": f16_le_quiet_rm0,
    "f16_lt": f16_lt_rm0,
    "f16_lt_quiet": f16_lt_quiet_rm0,
    "f16_mul": f16_mul_rm0,
    "f16_mulAdd": f16_mulAdd_rm0,
    "f16_roundToInt": f16_roundToInt_rm0,
    "f16_sqrt": f16_sqrt_rm0,
    "f16_sub": f16_sub_rm0,
    "f16_to_f32": f16_to_f32_rm0,
    "f16_to_f64": f16_to_f64_rm0,
    "f16_to_i32": f16_to_i32_rm0,
    "f16_to_i64": f16_to_i64_rm0,
    "f16_to_ui32": f16_to_ui32_rm0,
    "f16_to_ui64": f16_to_ui64_rm0,
    "f32_add": f32_add_rm0,
    "f32_div": f32_div_rm0,
    "f32_eq": f32_eq_rm0,
    "f32_le": f32_le_rm0,
    "f32_le_quiet": f32_le_quiet_rm0,
    "f32_lt": f32_lt_rm0,
    "f32_lt_quiet": f32_lt_quiet_rm0,
    "f32_mul": f32_mul_rm0,
    "f32_mulAdd": f32_mulAdd_rm0,
    "f32_roundToInt": f32_roundToInt_rm0,
    "f32_sqrt": f32_sqrt_rm0,
    "f32_sub": f32_sub_rm0,
    "f32_to_bf16": f32_to_bf16_rm0,
    "f32_to_f16": f32_to_f16_rm0,
    "f32_to_f64": f32_to_f64_rm0,
    "f32_to_i32": f32_to_i32_rm0,
    "f32_to_i64": f32_to_i64_rm0,
    "f32_to_ui32": f32_to_ui32_rm0,
    "f32_to_ui64": f32_to_ui64_rm0,
    "f64_add": f64_add_rm0,
    "f64_div": f64_div_rm0,
    "f64_eq": f64_eq_rm0,
    "f64_le": f64_le_rm0,
    "f64_le_quiet": f64_le_quiet_rm0,
    "f64_lt": f64_lt_rm0,
    "f64_lt_quiet": f64_lt_quiet_rm0,
    "f64_mul": f64_mul_rm0,
    "f64_mulAdd": f64_mulAdd_rm0,
    "f64_roundToInt": f64_roundToInt_rm0,
    "f64_sqrt": f64_sqrt_rm0,
    "f64_sub": f64_sub_rm0,
    "f64_to_f16": f64_to_f16_rm0,
    "f64_to_f32": f64_to_f32_rm0,
    "f64_to_i32": f64_to_i32_rm0,
    "f64_to_i64": f64_to_i64_rm0,
    "f64_to_ui32": f64_to_ui32_rm0,
    "f64_to_ui64": f64_to_ui64_rm0,
    "i32_to_f16": i32_to_f16_rm0,
    "i32_to_f32": i32_to_f32_rm0,
    "i32_to_f64": i32_to_f64_rm0,
    "i64_to_f16": i64_to_f16_rm0,
    "i64_to_f32": i64_to_f32_rm0,
    "i64_to_f64": i64_to_f64_rm0,
    "ui32_to_f16": ui32_to_f16_rm0,
    "ui32_to_f32": ui32_to_f32_rm0,
    "ui32_to_f64": ui32_to_f64_rm0,
    "ui64_to_f16": ui64_to_f16_rm0,
    "ui64_to_f32": ui64_to_f32_rm0,
    "ui64_to_f64": ui64_to_f64_rm0,
}
