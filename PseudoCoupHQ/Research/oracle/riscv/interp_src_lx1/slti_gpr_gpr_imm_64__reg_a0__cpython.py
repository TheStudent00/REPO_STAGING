...
# InterpRenderer from the layer-4 term of slti_gpr_gpr_imm_64__reg_a0__cpython.
# The term's layer-5 text, LITERAL:
#   If(3 <= v0, 0, 1)
def emu_slti_gpr_gpr_imm_64__reg_a0__cpython(a):
    return m(((0) if (sle(3, a, 64)) else (1)), 64)
...
def main():
    for line in sys.stdin:
        ...
        try:
            answer = emu_slti_gpr_gpr_imm_64__reg_a0__cpython(*values)
            sys.stdout.write("%d\n" % answer)
