...
theorem c_op_498__ZBS_RTYPE_48_integer_level (a : BitVec 64) (b : BitVec 64) :
    ((pure_RTYPE (zero_reg) ((pure_RTYPE (a) (b) (XOR))) (LeanIM.rop.SLTU))) = (pure_ZBS_RTYPE (a) (b) (brop_zbs.BCLR)) := by
  try simp only [pure_RTYPE, pure_ZBS_RTYPE, bool_to_bit, log2_xlen, shift_bits_right_arith, xlenbits, zero_extend, zeros, zopz0zI_s, zopz0zI_u, bool_bit_forwards, xlen, Sail.BitVec.zeroExtend]
  grind
