...
// intermediate per node of the term of feq_s_gpr_fpr_fpr_32__reg_a0__go__native_first.
...
//go:noinline
func emu_feq_s_gpr_fpr_fpr_32__reg_a0__go__native_first(a uint32, b uint32) uint64 {
...
func main() {
	sink = emu_feq_s_gpr_fpr_fpr_32__reg_a0__go__native_first(g0, g1)
	_ = sink
}
