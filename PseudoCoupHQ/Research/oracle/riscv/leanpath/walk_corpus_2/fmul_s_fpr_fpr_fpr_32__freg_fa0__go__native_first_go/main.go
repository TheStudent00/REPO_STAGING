...
// intermediate per node of the term of fmul_s_fpr_fpr_fpr_32__freg_fa0__go__native_first.
...
//go:noinline
func emu_fmul_s_fpr_fpr_fpr_32__freg_fa0__go__native_first(a uint32, b uint32) uint64 {
...
func main() {
	sink = emu_fmul_s_fpr_fpr_fpr_32__freg_fa0__go__native_first(g0, g1)
	_ = sink
}
