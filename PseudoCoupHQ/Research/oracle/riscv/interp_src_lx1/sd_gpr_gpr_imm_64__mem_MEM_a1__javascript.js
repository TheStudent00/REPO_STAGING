...
// InterpRenderer from the layer-4 term of sd_gpr_gpr_imm_64__mem_MEM_a1__javascript.
// The term's layer-5 text, LITERAL:
//   v0
function emu_sd_gpr_gpr_imm_64__mem_MEM_a1__javascript(a) {
    return m(a, 64);
}
...
for (const line of lines) {
    ...
    try {
        out.push(emu_sd_gpr_gpr_imm_64__mem_MEM_a1__javascript(...values).toString());
    } catch (problem) {
