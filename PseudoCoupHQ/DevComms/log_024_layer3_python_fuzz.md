...
To reproduce:
`bash -c "cd ~/Programming/PseudoCoupHQ/Research/kind_fuzz_clustering && python3 probe_generate.py && python3 lane_build.py"`,
copy `lanes/l3_python.sh` into `~/Programming/SandboxDesign/agent/drop/`,
